...
void func_7(var uParam0, int iParam1, char* sParam2) // Position - 0x14A
{
	if (func_8(&(uParam0->f_85), 7))
		uParam0->f_85.f_14(&uParam0->[iParam1], iParam1, sParam2);
	else
...
void func_11(var uParam0) // Position - 0x219
{
	...
	switch (uParam0->f_85.f_4)
	{
		...
		case 2:
			if (func_50(PLAYER::PLAYER_PED_ID(), &uParam0->[uParam0->f_85.f_2]))
			{
...
Vector3 func_38(var uParam0) // Position - 0xEEA
{
	...
	unk = { uParam0->[uParam0->f_85.f_2].f_8.f_3 };
...
{
	return uParam0->[uParam0->f_85.f_2].f_8;
}
...
{
	uParam0->f_85.f_8 = func_44(uParam0->[uParam0->f_85.f_2]);
...
{
	uParam0->f_85.f_13(!func_8(&(uParam0->f_85), 5), &uParam0->[uParam0->f_85.f_2], uParam0->f_85.f_2);
...
BOOL func_47(var uParam0) // Position - 0x139C
{
	...
	for (i = 0; i < NETWORK::NETWORK_GET_MAX_NUM_PARTICIPANTS(); i = i + 1)
	{
		if (NETWORK::NETWORK_IS_PARTICIPANT_ACTIVE(PLAYER::INT_TO_PARTICIPANTINDEX(i)))
		{
			...
			if (playerIndex != PLAYER::PLAYER_ID() && _NETWORK_IS_PLAYER_VALID(playerIndex, true, true) && func_50(PLAYER::GET_PLAYER_PED(playerIndex), &uParam0->[uParam0->f_85.f_2]))
				return 1;
		}
	}
...
{
	switch (uParam0->[uParam0->f_85.f_2])
	{
		case 12:
		case 10:
		case 6:
...
void func_71() // Position - 0x1845
{
	...
	unk[0] = 0;
	unk[1] = 1;
	func_74(2, &uLocal_96, &unk);
	unk[0] = 2;
	unk[1] = 3;
	func_74(3, &uLocal_96, &unk);
	unk[0] = 4;
	unk[1] = 5;
	func_74(4, &uLocal_96, &unk);
...
void func_74(int iParam0, var uParam1, var uParam2) // Position - 0x18ED
{
	...
	{
		uParam1->[uParam2->[i]] = 2;
		uParam1->[uParam2->[i]].f_8 = { func_77(func_78(i), num) + unk };
		uParam1->[uParam2->[i]].f_8.f_3 = { 0f, 0f, num + 174f };
		uParam1->[uParam2->[i]].f_1 = { func_77(func_76(i), num) + unk };
		uParam1->[uParam2->[i]].f_1.f_3 = { func_77(func_75(i), num) + unk };
		uParam1->[uParam2->[i]].f_1.f_6 = 1.42f;
	}
