...
void main() // Position - 0x0
{
	...
	iLocal_99 = -1;
	uLocal_89 = { uScriptParam_100.f_1[0] };
	fLocal_92 = uScriptParam_100.f_17[0];

	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(11))
		func_37(false);

	if (func_36(G_MissionStats.f_20120, 16384))
		func_37(false);
	...
	while (true)
	{
		...
		if (ENTITY::DOES_ENTITY_EXIST(pedLocal_93))
		{
			...
			{
				func_35(&(G_MissionStats.f_20120), 16384);
				iLocal_97 = 7;
			}
		}
...
void func_20() // Position - 0x22D7
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (_GET_CHARACTER_MODEL(G_MissionStats.f_2366.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_25(character) && !func_21(14) || Global_112760)
			{
