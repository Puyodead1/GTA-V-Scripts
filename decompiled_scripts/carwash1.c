...
void func_328() // Position - 0x2B0EC
{
	...
	while (true)
	{
		...
		else
		{
			...
			{
				offsetFromCoordAndHeadingInWorldCoords = { OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS((uLocal_76.f_7[0] + uLocal_76.f_7[1]) / { 2f, 2f, 2f }, uLocal_76.f_24, uLocal_631) };
