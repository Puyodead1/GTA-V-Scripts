...
void main() // Position - 0x0
{
	...
	if (!ENTITY::DOES_ENTITY_EXIST(uScriptParam_378.f_4))
	{
		if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
		{
			if (iLocal_301 == 2)
			{
				uScriptParam_378 = { unk1771 };
				uScriptParam_378.f_3 = -0.09f;
			}
			else
			{
				uScriptParam_378 = { unk1768 };
				uScriptParam_378.f_3 = 57.783146f;
			}
		
			if (OBJECT::DOES_OBJECT_OF_TYPE_EXIST_AT_COORDS(uScriptParam_378, 5f, joaat("prop_dart_bd_cab_01"), false))
			{
				uScriptParam_378.f_4 = OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(uScriptParam_378, 5f, joaat("prop_dart_bd_cab_01"), true, false, true);
				OBJECT::GET_COORDS_AND_ROTATION_OF_CLOSEST_OBJECT_OF_TYPE(uScriptParam_378, 5f, joaat("prop_dart_bd_cab_01"), &uScriptParam_378, &entityCoords, 0);
				uScriptParam_378.f_3 = entityCoords.f_2;
			}
		}
	}
	else
	{
		entityCoords = { ENTITY::GET_ENTITY_COORDS(uScriptParam_378.f_4, true) };
	}
	...
	while (true)
	{
		...
		if (PED::IS_PED_INJURED(uScriptParam_378.f_5) && !ENTITY::DOES_ENTITY_EXIST(func_506()) || ENTITY::DOES_ENTITY_EXIST(func_506()) && PED::IS_PED_INJURED(func_506()))
			func_477(&num, &unk504, &unk1187);
		...
		if (!PED::IS_PED_INJURED(uLocal_262[0]))
		{
			...
			switch (num)
			{
				case 0:
					HUD::CLEAR_HELP(true);
					func_469(&(num.f_243), &uScriptParam_378);
				...
				case 1:
					...
					{
						MISC::CLEAR_AREA(uScriptParam_378, 0.5f, true, false, false, false);
				...
				case 2:
					for (j = 0; j < 2; j = j + 1)
					{
						for (k = 0; k < 3; k = k + 1)
						{
							func_466(&num.f_5[j][k], j);
						}
					}
				
					for (l = 0; l < 3; l = l + 1)
					{
						func_466(&num.f_164[l], 0);
					}
				...
				case 4:
					if (!CAM::IS_INTERPOLATING_TO_SCRIPT_CAMS())
					{
						...
						func_447(num.f_243.f_4, vector, &sizeAndPeds, &uScriptParam_378);
					...
					if (!PED::IS_PED_INJURED(uLocal_262[1]) && PED::IS_PED_ON_FOOT(uLocal_262[0]) && !PED::IS_PED_IN_ANY_VEHICLE(uLocal_262[0], true) && PED::IS_PED_ON_FOOT(uLocal_262[1]) && !PED::IS_PED_IN_ANY_VEHICLE(uLocal_262[1], true))
					{
						...
						switch (num3)
						{
							case -1:
								...
								{
									iLocal_294 = PED::CREATE_SYNCHRONIZED_SCENE(ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uScriptParam_378.f_4, 0.337842f, -0.243051f, -0.329731f), 0f, 0f, ENTITY::GET_ENTITY_HEADING(uScriptParam_378.f_4) - 3.783146f, 2);
				...
				case 9:
					if (func_340(&num, &scaleform, &unk504))
					{
						...
						if (G_MissionStats.f_18973.f_5 >= 5 && G_MissionStats.f_18973.f_7 >= 0.8f)
							num.f_249.f_4 = 2;
						else if (G_MissionStats.f_18973.f_5 >= 3 && G_MissionStats.f_18973.f_7 >= 0.66f)
							num.f_249.f_4 = 1;
						else
							num.f_249.f_4 = 0;
					
						if (func_339(G_MissionStats.f_18973.f_5, &iLocal_293))
							func_338(&(unk504.f_666), 24, true);
					
						fLocal_88 = func_337(G_MissionStats.f_18973.f_5);
						fLocal_89 = func_336(G_MissionStats.f_18973.f_5);
						fLocal_86 = fLocal_88;
						fLocal_87 = fLocal_89;
...
char* func_23(int iParam0, BOOL bParam1) // Position - 0x38E1
{
	...
	if (!MISC::IS_STRING_NULL_OR_EMPTY(&Global_23390.f_7488[iParam0]))
	{
		...
		{
			return func_24(&Global_23390.f_7488[iParam0]);
		}
	}
...
char* func_26(int iParam0) // Position - 0x3E2C
{
	...
	if (!MISC::IS_STRING_NULL_OR_EMPTY(&Global_23390.f_6463[iParam0]))
	{
		...
		{
			return func_24(&Global_23390.f_6463[iParam0]);
		}
	}
...
void func_44(var uParam0, var uParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x479E
{
	...
	if (bLocal_267)
	{
		...
		else if (PAD::IS_CONTROL_JUST_PRESSED(PLAYER_CONTROL, INPUT_SCRIPT_PAD_LEFT) || PAD::IS_CONTROL_JUST_PRESSED(PLAYER_CONTROL, INPUT_SCRIPT_PAD_RIGHT) && uParam0->f_248 == 1 && flag)
		{
			...
			if (bLocal_266)
			{
				entityCoords = { ENTITY::GET_ENTITY_COORDS(uParam0->f_5[iLocal_28][iLocal_289], true) };
...
void func_60(int iParam0) // Position - 0x5FB7
{
	...
	else if (IS_BIT_SET(G_MissionStats.f_20567.f_471, iParam0) || IS_BIT_SET(Global_2359296[func_62()].f_681.f_10, iParam0))
	{
		flag = true;
		MISC::CLEAR_BIT(&(G_MissionStats.f_20567.f_471), iParam0);
...
void func_93() // Position - 0x6A16
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (_GET_CHARACTER_MODEL(G_MissionStats.f_2366.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			{
				if (G_MissionStats.f_2366.f_539.f_4321 != character && func_94(G_MissionStats.f_2366.f_539.f_4321))
				...
				if (!IS_BIT_SET(uParam1->f_42, 1))
				{
						...
						for (i = 0; i < 12; i = i + 1)
						{
							...
							if (IS_GAMER_HANDLE_VALID(Global_2101867[i].f_32))
							{
								...
								if (!flag3)
								{
									...
									{
										if (func_148(&(Global_2101867[i].f_32), &unk27))
										{
									...
									if (func_199(uParam1->f_44))
									{
										...
										func_147(*uParam0, num, address, Global_2101867[i].f_59, &unk5, &(Global_2101867[i].f_80));
									...
									{
										func_147(*uParam0, num, address, Global_2101867[i].f_59, &Global_2101867[i], &(Global_2101867[i].f_80));
										uParam1->f_246.f_6[i] = num;
										uParam1->f_246.f_6[i].f_1 = address;
										uParam1->f_246.f_6[i].f_2 = { Global_2101867[i].f_32 };
										uParam1->f_246.f_2 = uParam1->f_246.f_2 + 1;
									...
									for (j = 0; j < Global_2097536.f_2708; j = j + 1)
									{
										...
										if (IS_BIT_SET(Global_2097536.f_2770, j))
										{
											...
											if (flag2)
												func_138(Global_2097536.f_2780, j, Global_2101867[i].f_67[j], false, Global_2101867[i].f_58);
											else
												func_138(Global_2097536.f_2780, j, Global_2101867[i].f_67[j], Global_2101867[i].f_74, Global_2101867[i].f_58);
										}
										else
										{
											if (IS_BIT_SET(Global_2097536.f_2768, j))
											...
											if (flag2)
												func_135(Global_2097536.f_2780, j, Global_2101867[i].f_60[j], false);
											else
												func_135(Global_2097536.f_2780, j, Global_2101867[i].f_60[j], Global_2101867[i].f_74);
										}
									}
					...
					if (uParam1->f_246.f_1 == -1 && !flag == true)
					{
						if (Global_2097536.f_2704[0] > 1)
						{
							...
							func_133(*uParam0, uParam1->f_246.f_6[uParam1->f_246.f_1], uParam1->f_246.f_6[uParam1->f_246.f_1].f_1);
						}
					}
				}
				else
	...
	if (uParam1->f_246.f_1 >= 0)
	{
		if (uParam1->f_246.f_1 != num)
		{
			if (num >= 0)
			{
				...
				func_133(*uParam0, uParam1->f_246.f_6[num], uParam1->f_246.f_6[num].f_1);
			}
		...
		for (i = 0; i < cacheNumberOfRows; i = i + 1)
		{
			if (i < 12)
			{
				...
				if (uParam0->[i].f_59 != -1)
				{
					...
					if (func_148(&(uParam0->[i].f_32), &unk))
	...
	switch (uParam0->[0].f_76)
	{
		case 0:
			...
			for (i = 0; i < 12; i = i + 1)
			{
				...
				{
					if (!func_166(&(uParam0->[i].f_32), &Global_2103169))
					{
		...
		case 1:
			if (func_164(&(uParam0->[1].f_76), &(Global_2103169.f_206), &Global_2103169, &(Global_2103169.f_157)))
				uParam0->[0].f_76 = 2;
			break;
...
BOOL func_170(var uParam0) // Position - 0xB7E1
{
	...
	else
	{
		for (i = 0; i < 12; i = i + 1)
		{
			if (!func_171(&(uParam0->[i].f_78), &(uParam0->[i].f_32), &uParam0->[i]))
				return false;
		}
	}
	...
	switch (uParam0->[0].f_78)
	{
		case 0:
			...
			for (i = 0; i < 12; i = i + 1)
			{
				...
				func_107(&Global_2097536.f_3026[i]);
...
BOOL func_173(var uParam0) // Position - 0xBAF6
{
	...
	if (IS_XBOX_PLATFORM() || IS_PLAYSTATION_PLATFORM())
	{
		for (i = 0; i < 12; i = i + 1)
		{
			if (!func_175(&(uParam0->[i].f_77), &(uParam0->[i].f_16), &(uParam0->[i].f_84), &(Global_2097536.f_2833), &(uParam0->[i].f_79)))
				return false;
		}
	}
	else
	{
		for (i = 0; i < 12; i = i + 1)
		{
			if (!func_174(&(uParam0->[i].f_77), uParam0->[i].f_16, &(uParam0->[i].f_84)))
				return false;
		}
	}
					...
					if (unk99.f_3 > 0)
					{
						...
						if (unk.f_96 <= 1)
						{
							if (Global_2097536.f_2704[offset] < 11)
							{
								if (func_188() && num == 0)
								{
									func_184(uParam0, &Global_2097536[offset][Global_2097536.f_2704[offset]], unk.f_96);
						...
						for (k = num2; k <= unk99.f_3 - 1; k = k + 1)
						{
							...
							if (Global_2097536.f_2704[offset] < 11 && unk.f_96 > 1)
							{
								if (func_188() && num == k)
								{
									if (!func_148(&(Global_2097536[offset][0].f_32), &gamerHandle))
									{
										func_184(uParam0, &Global_2097536[offset][Global_2097536.f_2704[offset]], unk.f_96);
								...
								{
									if (IS_GAMER_HANDLE_VALID(unk) && !func_148(&unk, &(Global_2097536[offset][0].f_32)))
									{
										if (func_148(&unk, &gamerHandle))
						...
						if (flag)
						{
							if (Global_2097536.f_2775[offset] == -1 && func_188())
							{
								if (Global_2097536.f_2704[offset] >= 1)
									func_184(uParam0, &Global_2097536[offset][Global_2097536.f_2704[offset]], Global_2097536[offset][Global_2097536.f_2704[offset] - 1].f_59 + 1);
								else
									func_184(uParam0, &Global_2097536[offset][Global_2097536.f_2704[offset]], 1);
	...
	switch (uParam0->[1])
	{
		case 0:
			...
			if (friendCount > 0)
			{
				...
				if (func_190(&(uParam0->f_4), &(uParam0->f_5), &(uParam0->f_44), &(uParam0->f_113), uParam0->f_113[0], flag, 0, 100))
				{
					func_186(&unk99, &(uParam0->f_44));
					...
					if (uParam0->f_5 && STATS::LEADERBOARDS2_READ_GET_ROW_DATA_START(&unk99))
					{
						...
						if (func_188() && num == 0)
						{
							...
							{
								func_184(uParam0, &Global_2097536[num3][Global_2097536.f_2704[num3]], 1);
							...
							else
							{
								...
								if (Global_2097536.f_2775[num3] == -1 && func_188())
								{
									if (Global_2097536.f_2704[num3] >= 1)
										func_184(uParam0, &Global_2097536[num3][Global_2097536.f_2704[num3]], Global_2097536[num3][Global_2097536.f_2704[num3] - 1].f_59 + 1);
									else
										func_184(uParam0, &Global_2097536[num3][Global_2097536.f_2704[num3]], 1);
						...
						for (j = num2; j <= unk99.f_3 - 1; j = j + 1)
						{
							...
							if (Global_2097536.f_2704[num3] < 11 && unk.f_96 > 1)
							{
								if (func_188() && num == j)
								{
									if (!func_148(&(Global_2097536[num3][0].f_32), &unk107))
									{
										func_184(uParam0, &Global_2097536[num3][Global_2097536.f_2704[num3]], unk.f_96);
								...
								{
									if (IS_GAMER_HANDLE_VALID(unk) && !func_148(&unk, &(Global_2097536[num3][0].f_32)))
									{
										if (func_148(&unk, &unk107))
					...
					if (unk112.f_3 > 0)
					{
						...
						if (unk14.f_96 <= 1)
						{
							if (Global_2097536.f_2704[offset] < 11)
							{
								if (func_188() && num == 0)
								{
									func_184(uParam0, &Global_2097536[offset][Global_2097536.f_2704[offset]], unk14.f_96);
									Global_2097536.f_2775[offset] = 0;
									Global_2097536.f_2704[offset] = Global_2097536.f_2704[offset] + 1;
								}
						...
						for (k = num2; k <= unk112.f_3 - 1; k = k + 1)
						{
							...
							if (Global_2097536.f_2704[offset] < 11 && unk14.f_96 > 1)
							{
								if (func_188() && num == k)
								{
									if (!func_148(&(Global_2097536[offset][0].f_32), &unk14))
									{
										func_184(uParam0, &Global_2097536[offset][Global_2097536.f_2704[offset]], unk14.f_96);
										Global_2097536.f_2775[offset] = Global_2097536.f_2704[offset];
										Global_2097536.f_2704[offset] = Global_2097536.f_2704[offset] + 1;
								...
								{
									if (IS_GAMER_HANDLE_VALID(unk14) && !func_148(&(Global_2097536[offset][0].f_32), &unk14))
									{
										if (func_148(&unk14, &unk))
											if (Global_2097536.f_2775[offset] < 0)
												Global_2097536.f_2775[offset] = Global_2097536.f_2704[offset];
...
void func_233(var uParam0, int iParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, BOOL bParam6, BOOL bParam7) // Position - 0x1028E
{
	...
	switch (iParam1)
	{
		...
		case 888:
			...
			Global_2097536.f_2710[2] = 2;
			Global_2097536.f_2710[3] = 3;
			TEXT_LABEL_COPY(&(uParam0->f_44.f_3.f_1[0].f_8), { func_235(iParam4) }, 8);
			Global_2097536.f_2708 = 4;
			MISC::SET_BIT(&(Global_2097536.f_2769), Global_2097536.f_2710[0]);
			MISC::SET_BIT(&(Global_2097536.f_2769), Global_2097536.f_2710[1]);
			MISC::SET_BIT(&(Global_2097536.f_2769), Global_2097536.f_2710[2]);
	...
	switch (uParam0->f_1)
	{
		...
		case 2:
			...
			if (iLocal_28 == 0)
			{
				...
				if (!_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED("DARTS_SHT_USE") && !_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED("DARTS_INSTR_W") && !_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED("DARTS_INSTR_B") && !_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED("DARTS_AIM_HLP") && !_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED("DARTS_STD_HLP") && !_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED("DARTS_FST_HLP"))
				{
					if (func_3(&(uParam3->f_666), 24))
					{
						...
						MISC::SET_BIT(&(G_MissionStats.f_18973.f_6), iLocal_293);
				...
				else if (func_300(&uParam0->f_5[iLocal_28][iLocal_29], &(uParam0->f_243), uParam1, flag, false, false, uParam0->f_248))
				{
					HUD::CLEAR_PRINTS();
			...
			else if (iLocal_29 == 0)
			{
				...
				func_293(&uParam0->f_5[iLocal_28][iLocal_29], &(uParam0->f_243), &(uParam0->f_1), &(uParam0->f_249), false);
			}
		...
		case 3:
			if (func_280(&uParam0->f_5[iLocal_28][iLocal_29], &(uParam0->f_243), uParam0->f_248, false))
			{
		...
		case 4:
			if (!func_3(&(uParam3->f_666), 5))
				func_277(&uParam0->f_5[iLocal_28][iLocal_29], &(uParam0->f_243), uParam0->f_455);
...
void func_254(var uParam0, var uParam1) // Position - 0x15F84
{
	...
	{
		if (uParam0->f_5[iLocal_28][iLocal_29].f_23)
		{
			if (uParam0->f_5[iLocal_28][iLocal_29].f_25)
			{
				iLocal_29 = iLocal_29 + 1;
			}
			else
			{
				func_277(&uParam0->f_5[iLocal_28][iLocal_29], &(uParam0->f_243), false);
				func_262(uParam0, uParam1);
			}
		}
		else if (uParam0->f_5[iLocal_28][iLocal_29].f_24)
		{
			if (bLocal_274)
			{
				if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_5[iLocal_28][iLocal_29]))
					OBJECT::DELETE_OBJECT(&uParam0->f_5[iLocal_28][iLocal_29]);
			}
			else
			{
				uParam0->f_5[iLocal_28][iLocal_29].f_23 = 1;
				uParam0->f_5[iLocal_28][iLocal_29].f_24 = 0;
				offsetFromCoordAndHeadingInWorldCoords = { OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(uParam0->f_243.f_1, uParam0->f_243.f_4, uParam0->f_5[iLocal_28][iLocal_29].f_11, uParam0->f_5[iLocal_28][iLocal_29].f_11.f_1 + fLocal_53, uParam0->f_5[iLocal_28][iLocal_29].f_11.f_2) };
			
				if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_5[iLocal_28][iLocal_29]))
					ENTITY::SET_ENTITY_COORDS(uParam0->f_5[iLocal_28][iLocal_29], offsetFromCoordAndHeadingInWorldCoords, true, false, false, true);
			}
			...
			if (bLocal_274)
			{
				if (bLocal_276)
				{
					uParam0->f_5[iLocal_28][iLocal_29] = OBJECT::CREATE_OBJECT(uParam0->f_5[iLocal_28][iLocal_29].f_1, uLocal_77, true, true, false);
					offsetFromCoordAndHeadingInWorldCoords = { OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(uParam0->f_243.f_1, uParam0->f_243.f_4, uParam0->f_5[iLocal_28][iLocal_29].f_11, uParam0->f_5[iLocal_28][iLocal_29].f_11.f_1 + fLocal_53, uParam0->f_5[iLocal_28][iLocal_29].f_11.f_2) };
					ENTITY::SET_ENTITY_COORDS(uParam0->f_5[iLocal_28][iLocal_29], offsetFromCoordAndHeadingInWorldCoords, true, false, false, true);
					randomFloatInRange = MISC::GET_RANDOM_FLOAT_IN_RANGE(0f, 90f);
					uParam0->f_5[iLocal_28][iLocal_29].f_17 = { 90f, randomFloatInRange, uParam0->f_243.f_4 };
					ENTITY::SET_ENTITY_ROTATION(uParam0->f_5[iLocal_28][iLocal_29], uParam0->f_5[iLocal_28][iLocal_29].f_17, 0, true);
					uParam0->f_5[iLocal_28][iLocal_29].f_23 = 1;
					uParam0->f_5[iLocal_28][iLocal_29].f_24 = 0;
				}
			}
		...
		else
		{
			...
			if (uParam0->f_5[iLocal_28][iLocal_29].f_21 == 2 || uParam0->f_5[iLocal_28][iLocal_29].f_20 == 50 && uParam0->f_422[iLocal_28] == 0)
			{
				if (uParam0->f_5[iLocal_28][iLocal_29].f_20 == 50)
			...
			if (bLocal_274)
			{
				if (bLocal_276)
				{
					...
					{
						if (!uParam0->f_5[iLocal_28][i].f_23)
						{
							uParam0->f_5[iLocal_28][i] = OBJECT::CREATE_OBJECT(uParam0->f_5[iLocal_28][i].f_1, uLocal_77, true, true, false);
							offsetFromCoordAndHeadingInWorldCoords = { OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(uParam0->f_243.f_1, uParam0->f_243.f_4, uParam0->f_5[iLocal_28][i].f_11, uParam0->f_5[iLocal_28][i].f_11.f_1 + fLocal_53, uParam0->f_5[iLocal_28][i].f_11.f_2) };
						
							if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_5[iLocal_28][i]))
								ENTITY::SET_ENTITY_COORDS(uParam0->f_5[iLocal_28][i], offsetFromCoordAndHeadingInWorldCoords, true, false, false, true);
						
							randomFloatInRange2 = MISC::GET_RANDOM_FLOAT_IN_RANGE(0f, 90f);
							uParam0->f_5[iLocal_28][i].f_17 = { 90f, randomFloatInRange2, uParam0->f_243.f_4 };
							ENTITY::SET_ENTITY_ROTATION(uParam0->f_5[iLocal_28][i], uParam0->f_5[iLocal_28][i].f_17, 0, true);
							uParam0->f_5[iLocal_28][i].f_23 = 1;
							uParam0->f_5[iLocal_28][i].f_24 = 0;
						}
					}
				}
			}
	...
	switch (uParam0->f_2)
	{
		case 0:
			...
			if (iLocal_28 == 0)
				if (func_3(&(uParam2->f_666), 3))
					func_260("DARTS_PLR_DUB", uParam0->f_5[iLocal_28][iLocal_29].f_20, 5000, 0);
				else if (func_3(&(uParam2->f_666), 4))
					_SHOW_SUBTITLE_CLEAR_EXISTING("DARTS_ONE_PT", 5000, 0);
				else if (func_3(&(uParam2->f_666), 2))
					func_260("DARTS_PLR_BUST", uParam0->f_5[iLocal_28][iLocal_29].f_20, 5000, 0);
				else
					func_260("DARTS_SWITCH_C", uParam0->f_422[iLocal_28], 5000, 0);
			else if (func_3(&(uParam2->f_666), 3))
				func_260("DARTS_OPP_DUB", uParam0->f_5[iLocal_28][iLocal_29].f_20, 5000, 0);
			else if (func_3(&(uParam2->f_666), 4))
				_SHOW_SUBTITLE_CLEAR_EXISTING("DARTS_ONE_PT", 5000, 0);
			else if (func_3(&(uParam2->f_666), 2))
				func_260("DARTS_OPP_BUST", uParam0->f_5[iLocal_28][iLocal_29].f_20, 5000, 0);
			else
		...
		case 2:
			...
			if (bLocal_265 || SYSTEM::TIMERB() > 2000)
			{
				...
				for (i = 0; i < 3; i = i + 1)
				{
					func_251(&uParam0->f_5[iLocal_28][i]);
				}
...
void func_262(var uParam0, var uParam1) // Position - 0x16CD6
{
	...
	{
		uParam0->f_422[iLocal_28] = uParam0->f_422[iLocal_28] - uParam0->f_5[iLocal_28][iLocal_29].f_20;
		uParam0->f_428 = uParam0->f_428 + uParam0->f_5[iLocal_28][iLocal_29].f_20;
	}
	...
	else
	{
		...
		else if (uParam0->f_422[iLocal_28] == 1 || uParam0->f_422[iLocal_28] < 0 || uParam0->f_422[iLocal_28] == 0 && uParam0->f_5[iLocal_28][iLocal_29].f_21 != 2)
		{
			if (uParam0->f_422[iLocal_28] == 0 && uParam0->f_5[iLocal_28][iLocal_29].f_21 != 2)
			{
				func_260("DARTS_PLR_DUB", uParam0->f_5[iLocal_28][iLocal_29].f_20, 5000, 0);
		...
		else
		{
			...
			if (uParam0->f_5[iLocal_28][iLocal_29].f_20 == 0)
			{
				if (!bLocal_270 && !bLocal_275)
				{
			...
			uParam0->f_5[iLocal_28][iLocal_29].f_25 = 1;
			iLocal_29 = iLocal_29 + 1;
			SYSTEM::SETTIMERA(0);
...
void func_272(int iParam0) // Position - 0x17482
{
	...
	{
		case 0:
			G_MissionStats.f_18973 = G_MissionStats.f_18973 + 1;
			func_273("DARTS_STAT_NUM_BULLSEYES", G_MissionStats.f_18973);
			break;
	
		case 1:
			G_MissionStats.f_18973.f_1 = G_MissionStats.f_18973.f_1 + 1;
			func_273("DARTS_STAT_NUM_180S", G_MissionStats.f_18973.f_1);
			break;
	
		case 2:
			G_MissionStats.f_18973.f_2 = G_MissionStats.f_18973.f_2 + 1;
			func_273("DARTS_STAT_NUM_WINS", G_MissionStats.f_18973.f_2);
			break;
	
		case 3:
			G_MissionStats.f_18973.f_3 = G_MissionStats.f_18973.f_3 + 1;
			func_273("DARTS_STAT_NUM_LOSS", G_MissionStats.f_18973.f_3);
			break;
	
		case 4:
			G_MissionStats.f_18973.f_4 = G_MissionStats.f_18973.f_4 + 1;
			func_273("DARTS_STAT_DARTS_THROWN", G_MissionStats.f_18973.f_4);
			break;
	
		case 5:
			G_MissionStats.f_18973.f_5 = G_MissionStats.f_18973.f_5 + 1;
			func_273("DARTS_STAT_NUM_GAMES", G_MissionStats.f_18973.f_5);
			break;
	
		case 7:
			G_MissionStats.f_18973.f_7 = SYSTEM::TO_FLOAT(G_MissionStats.f_18973.f_2) / SYSTEM::TO_FLOAT(G_MissionStats.f_18973.f_5);
			break;
	
		case 8:
			G_MissionStats.f_18973.f_8 = SYSTEM::TO_FLOAT(G_MissionStats.f_18973.f_4) / SYSTEM::TO_FLOAT(G_MissionStats.f_18973.f_5);
			break;
	}
...
int func_279(var uParam0) // Position - 0x17B2E
{
	...
	{
		if (uParam0->f_5[iLocal_28][iLocal_29].f_8 > uParam0->f_5[iLocal_28][i].f_8 - 0.008f && uParam0->f_5[iLocal_28][iLocal_29].f_8 < uParam0->f_5[iLocal_28][i].f_8 + 0.008f && uParam0->f_5[iLocal_28][iLocal_29].f_8.f_2 > uParam0->f_5[iLocal_28][i].f_8.f_2 - 0.008f && uParam0->f_5[iLocal_28][iLocal_29].f_8.f_2 < uParam0->f_5[iLocal_28][i].f_8.f_2 + 0.008f)
			return 1;
	}
...
BOOL func_339(int iParam0, var uParam1) // Position - 0x1A3EB
{
	if (iParam0 >= 10)
	{
		if (!IS_BIT_SET(G_MissionStats.f_18973.f_6, 12))
		{
			*uParam1 = 12;
			return true;
		}
...
void func_345() // Position - 0x1A5AA
{
	...
	for (i = 0; i < 8; i = i + 1)
	{
		iLocal_162.f_9[i].f_3 = -1f;
		iLocal_162.f_9[i].f_4 = -1f;
		iLocal_162.f_9[i].f_5 = 0;
		iLocal_162.f_9[i].f_6 = 0;
	}
...
void func_347(BOOL bParam0, int iParam1) // Position - 0x1A62E
{
	...
	if (bParam0)
	{
		func_348(&Global_23390.f_6103[num]);
...
void func_374(int iParam0, char* sParam1, int iParam2, BOOL bParam3, int iParam4, BOOL bParam5, int iParam6) // Position - 0x1F088
{
	...
	if (iParam2 == 0)
	{
		num2 = func_376(&Global_23390.f_79[Global_23390.f_5663]);
	...
	if (bParam5)
	{
		if (iParam2 == 0)
		{
			num4 = func_375(&Global_23390.f_79[Global_23390.f_5663]);
			...
			switch (iLocal_29)
			{
				case 0:
					if (*uParam3 == 2)
					{
						...
						*uParam2 = 20;
						uParam2->f_1 = 2;
						func_293(&uParam4->[0], uParam1, uParam3, uParam2, true);
					}
				
					if (*uParam3 == 3)
					{
						if (func_280(&uParam4->[0], uParam1, 0, false))
						{
							AUDIO::PLAY_SOUND_FROM_COORD(-1, "DARTS_HIT_BOARD_MASTER", uParam1->f_1, 0, false, 0, false);
							iLocal_29 = iLocal_29 + 1;
							func_443(piParam5);
				...
				case 0:
					if (!CAM::IS_CAM_INTERPOLATING(caLocal_126))
					{
						if (*uParam3 == 2)
						{
							*uParam2 = 20;
							uParam2->f_1 = 3;
							func_293(&uParam4->[1], uParam1, uParam3, uParam2, true);
						}
					
						if (*uParam3 == 3)
						{
							if (func_280(&uParam4->[1], uParam1, 0, false))
							{
								AUDIO::PLAY_SOUND_FROM_COORD(-1, "DARTS_HIT_BOARD_MASTER", uParam1->f_1, 0, false, 0, false);
								iLocal_29 = iLocal_29 + 1;
								func_443(piParam5);
				...
				case 0:
					if (!CAM::IS_CAM_INTERPOLATING(caLocal_125))
					{
						if (*uParam3 == 2)
						{
							*uParam2 = 50;
							uParam2->f_1 = 1;
							func_293(&uParam4->[2], uParam1, uParam3, uParam2, true);
						}
					
						if (*uParam3 == 3)
						{
							if (func_280(&uParam4->[2], uParam1, 0, false))
							{
								AUDIO::PLAY_SOUND_FROM_COORD(-1, "DARTS_HIT_BOARD_MASTER", uParam1->f_1, 0, false, 0, false);
								iLocal_29 = iLocal_29 + 1;
								func_443(piParam5);
...
BOOL func_458(char* sParam0, int iParam1, BOOL bParam2) // Position - 0x219A5
{
	...
	flag2 = func_459(&Global_23390.f_6103[num]);
	!flag || !flag2;
	return flag && flag2;
}
...
void func_482() // Position - 0x2274F
{
	...
	if (value > 0f && SYSTEM::FLOOR(value) < SYSTEM::FLOOR(G_MissionStats.f_10197.f_3853))
		func_87(13, SYSTEM::FLOOR(G_MissionStats.f_10197.f_3853));
...
BOOL func_497(int iParam0) // Position - 0x230F6
{
	...
	PLAYER::SPECIAL_ABILITY_DEACTIVATE(PLAYER::PLAYER_ID(), 0);
	func_498(&(G_MissionStats.f_2366.f_539), num2);
...
void func_498(var uParam0, int iParam1) // Position - 0x23206
{
	...
	for (i = 0; i < 3; i = i + 1)
	{
		...
		else
		{
			...
			if (!func_500(G_MissionStats.f_18536[i], &unk, &num2))
			{
