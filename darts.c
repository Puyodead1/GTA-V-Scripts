...
void main() // Position - 0x0
{
	...
	fLocal_55 = 0.063f;
	uLocal_56 = Vector3(-0.0035f, 0f, -0.001f);
	hLocal_60 = joaat("prop_target_bull");
	uLocal_85 = Vector3(987.8541f, -98.4173f, 73.8599f);
	fLocal_92 = 0.1f;
	iLocal_103 = 3;
	fLocal_106 = 80f;
	fLocal_107 = 140f;
	...
	uLocal_260 = Vector3( 500f, 500f, 500f );
	bLocal_275 = 1;
	uLocal_340 = Vector3(-573.1373f, 294.0269f, 78.1765f);
	uLocal_343 = Vector3(-574.1169f, 292.7964f, 78.1766f);
	uLocal_346 = Vector3(1995.2952f, 3050.0845f, 46.91535f);
	uLocal_349 = Vector3(1995.488f, 3047.3833f, 46.91535f);
	...
	bLocal_278 = true;
	unk1768 = Vector3(1992.2932f, 3050.5828f, 47.98973f);
	unk1771 = Vector3(-572.04065f, 294.19577f, 79.9374f);
	func_505();
	...
	if (!ENTITY::DOES_ENTITY_EXIST(uScriptParam_379.f_4))
	{
		if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
		{
			if (iLocal_302 == 2)
			{
				uScriptParam_379 = Vector3(unk1771);
				uScriptParam_379.f_3 = -0.09f;
			}
			else
			{
				uScriptParam_379 = Vector3(unk1768);
				uScriptParam_379.f_3 = 57.783146f;
			}
		
			if (OBJECT::DOES_OBJECT_OF_TYPE_EXIST_AT_COORDS(uScriptParam_379, 5f, joaat("prop_dart_bd_cab_01"), false))
			{
				uScriptParam_379.f_4 = OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(uScriptParam_379, 5f, joaat("prop_dart_bd_cab_01"), true, false, true);
				OBJECT::GET_COORDS_AND_ROTATION_OF_CLOSEST_OBJECT_OF_TYPE(uScriptParam_379, 5f, joaat("prop_dart_bd_cab_01"), &uScriptParam_379, &entityCoords, 0);
				uScriptParam_379.f_3 = entityCoords.f_2;
			}
		}
	}
	else
	{
		entityCoords = Vector3(ENTITY::GET_ENTITY_COORDS(uScriptParam_379.f_4, true));
	}
	...
	while (true)
	{
		...
		if (PED::IS_PED_INJURED(uScriptParam_379.f_5) && !ENTITY::DOES_ENTITY_EXIST(func_504()) || ENTITY::DOES_ENTITY_EXIST(func_504()) && PED::IS_PED_INJURED(func_504()))
			func_475(&num, &unk504, &unk1187);
		...
		if (!PED::IS_PED_INJURED(uLocal_263[0]))
		{
			...
			switch (num)
			{
				case 0:
					HUD::CLEAR_HELP(true);
					func_467(&(num.f_243), &uScriptParam_379);
					func_466(num.f_243.f_1, num.f_243.f_4);
				
					if (ENTITY::DOES_ENTITY_EXIST(num.f_243))
					{
						uLocal_334 = Vector3(ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(num.f_243, 0.7792f, -1.138f, 0.1814f));
						uLocal_337 = Vector3(-7.9947f, 0f, num.f_243.f_4 + 36.191757f);
				...
				case 1:
					...
					{
						MISC::CLEAR_AREA(uScriptParam_379, 0.5f, true, false, false, false);
				...
				case 2:
					for (j = 0; j < 2; j = j + 1)
					{
						for (k = 0; k < 3; k = k + 1)
						{
							func_464(&num.f_5[j][k], j);
						}
					}
				
					for (l = 0; l < 3; l = l + 1)
					{
						func_464(&num.f_164[l], 0);
					}
					...
					if (ENTITY::DOES_ENTITY_EXIST(num.f_243))
						entityCoords = Vector3(ENTITY::GET_OFFSET_FROM_ENTITY_GIVEN_WORLD_COORDS(num.f_243, scaleform.f_18));
				...
				case 4:
					if (!CAM::IS_INTERPOLATING_TO_SCRIPT_CAMS())
					{
						...
						func_445(num.f_243.f_4, vector, &sizeAndPeds, &uScriptParam_379);
					...
					if (!PED::IS_PED_INJURED(uLocal_263[1]) && PED::IS_PED_ON_FOOT(uLocal_263[0]) && !PED::IS_PED_IN_ANY_VEHICLE(uLocal_263[0], true) && PED::IS_PED_ON_FOOT(uLocal_263[1]) && !PED::IS_PED_IN_ANY_VEHICLE(uLocal_263[1], true))
					{
						...
						switch (num3)
						{
							case -1:
								...
								{
									iLocal_295 = PED::CREATE_SYNCHRONIZED_SCENE(ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uScriptParam_379.f_4, 0.337842f, -0.243051f, -0.329731f), 0f, 0f, ENTITY::GET_ENTITY_HEADING(uScriptParam_379.f_4) - 3.783146f, 2);
					...
					switch (num3)
					{
						case 0:
							if (func_429(&(num.f_254)) > 0.5f)
							{
								...
								if (aspectRatio > 2f)
								{
									vector3 = Vector3(1992.2941f, 3047.577f, 46.21517f);
									vector4 = Vector3(0f, 0f, 138.74f);
								}
								else
								{
									vector3 = Vector3(1992.3357f, 3047.9243f, 46.21517f);
									vector4 = Vector3(0f, 0f, 136.74f);
								}
...
char* func_23(int iParam0, BOOL bParam1) // Position - 0x38E1
{
	...
	if (!MISC::IS_STRING_NULL_OR_EMPTY(&Global_23270.f_7488[iParam0]))
	{
		...
		{
			return func_24(&Global_23270.f_7488[iParam0]);
		}
	}
...
char* func_26(int iParam0) // Position - 0x3E2C
{
	...
	if (!MISC::IS_STRING_NULL_OR_EMPTY(&Global_23270.f_6463[iParam0]))
	{
		...
		{
			return func_24(&Global_23270.f_6463[iParam0]);
		}
	}
...
void func_27(var uParam0, int iParam1, float fParam2, float fParam3, float fParam4, int iParam5) // Position - 0x3EA1
{
	...
	HUD::SET_TEXT_COLOUR(r, g, b, iParam5);
	func_28(uParam0->f_489[iParam1], uParam0->f_503[iParam1], fParam4, fParam2, &uParam0->f_280[iParam1], uParam0->f_57[iParam1]);
	return;
}
...
void func_44(var uParam0, var uParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x479E
{
	...
	if (bLocal_268)
	{
		...
		else if (PAD::IS_CONTROL_JUST_PRESSED(PLAYER_CONTROL, INPUT_SCRIPT_PAD_LEFT) || PAD::IS_CONTROL_JUST_PRESSED(PLAYER_CONTROL, INPUT_SCRIPT_PAD_RIGHT) && uParam0->f_248 == 1 && flag)
		{
			...
			if (bLocal_267)
			{
				entityCoords = Vector3(ENTITY::GET_ENTITY_COORDS(uParam0->f_5[iLocal_30][iLocal_290], true));
	...
	else if (!uParam0->f_457)
	{
		...
		if (aspectRatio > 2f)
		{
			vector = Vector3(1992.2941f, 3047.577f, 46.21517f);
			vector2 = Vector3(0f, 0f, 138.74f);
		}
		else
		{
			vector = Vector3(1992.3357f, 3047.9243f, 46.21517f);
			vector2 = Vector3(0f, 0f, 136.74f);
		}
...
void func_53(var uParam0, var uParam1, var uParam2) // Position - 0x54FC
{
	...
	vector = Vector3(func_54(uParam0));
...
Vector3 func_54(var uParam0, var uParam1, var uParam2) // Position - 0x554C
{
	...
	unk4 = Vector3(0.3495f, -0.0276f, -0.0114f);
	unk = Vector3(uParam0 - unk4);
	return unk;
}
...
void func_60(int iParam0) // Position - 0x5FB7
{
	...
	else if (IS_BIT_SET(Global_113648.f_20566.f_471, iParam0) || IS_BIT_SET(Global_2359296[func_62()].f_681.f_10, iParam0))
	{
		flag = true;
		MISC::CLEAR_BIT(&(Global_113648.f_20566.f_471), iParam0);
		MISC::CLEAR_BIT(&(Global_2359296[func_62()].f_681.f_10), iParam0);
	}
...
void _MPCHAR_STAT_SET_INT(eMPStat empsParam0, int iParam1, int iParam2, BOOL bParam3, BOOL bParam4) // Position - 0x6247
{
	...
	bParam4;
	statName = Global_2805029[empsParam0][func_64(iParam2)];
...
void _STAT_SET_PACKED_BOOL(int iParam0, BOOL bParam1, int iParam2) // Position - 0x62B7
{
	if (iParam2 == -1)
		iParam2 = func_65();
...
BOOL func_68(int iParam0) // Position - 0x62F5
{
	...
	return IS_BIT_SET(Global_2359296[func_62()].f_681.f_10, iParam0);
}
...
int _MPCHAR_STAT_GET_INT(eMPStat empsParam0, int iParam1, int iParam2) // Position - 0x649B
{
	...
	{
		iParam2 == 0;
		statHash = Global_2805029[empsParam0][func_64(iParam1)];
...
BOOL _STAT_GET_PACKED_BOOL(int iParam0, int iParam1) // Position - 0x64D8
{
	if (iParam1 == -1)
		iParam1 = func_65();
				...
				if (!IS_BIT_SET(uParam1->f_42, 1))
				{
						...
						for (i = 0; i < 12; i = i + 1)
						{
							...
							if (IS_GAMER_HANDLE_VALID(Global_2101867[i].f_32))
							{
								...
								if (!flag3)
								{
									...
									{
										if (func_147(&(Global_2101867[i].f_32), &unk27))
										{
									...
									if (func_198(uParam1->f_44))
									{
										...
										func_146(*uParam0, num, address, Global_2101867[i].f_59, &unk5, &(Global_2101867[i].f_80));
									...
									{
										func_146(*uParam0, num, address, Global_2101867[i].f_59, &Global_2101867[i], &(Global_2101867[i].f_80));
										uParam1->f_246.f_6[i] = num;
										uParam1->f_246.f_6[i].f_1 = address;
										uParam1->f_246.f_6[i].f_2 = Vector3(Global_2101867[i].f_32);
										uParam1->f_246.f_2 = uParam1->f_246.f_2 + 1;
									...
									for (j = 0; j < Global_2097536.f_2708; j = j + 1)
									{
										...
										if (IS_BIT_SET(Global_2097536.f_2770, j))
										{
											...
											if (flag2)
												func_137(Global_2097536.f_2780, j, Global_2101867[i].f_67[j], false, Global_2101867[i].f_58);
											else
												func_137(Global_2097536.f_2780, j, Global_2101867[i].f_67[j], Global_2101867[i].f_74, Global_2101867[i].f_58);
										}
										else
										{
											if (IS_BIT_SET(Global_2097536.f_2768, j))
											...
											if (flag2)
												func_134(Global_2097536.f_2780, j, Global_2101867[i].f_60[j], false);
											else
												func_134(Global_2097536.f_2780, j, Global_2101867[i].f_60[j], Global_2101867[i].f_74);
										}
									}
					...
					if (uParam1->f_246.f_1 == -1 && !flag == true)
					{
						if (Global_2097536.f_2704[0] > 1)
						{
							...
							func_132(*uParam0, uParam1->f_246.f_6[uParam1->f_246.f_1], uParam1->f_246.f_6[uParam1->f_246.f_1].f_1);
						}
					}
				}
				else
	...
	if (uParam1->f_246.f_1 >= 0)
	{
		if (uParam1->f_246.f_1 != num)
		{
			if (num >= 0)
			{
				...
				func_132(*uParam0, uParam1->f_246.f_6[num], uParam1->f_246.f_6[num].f_1);
			}
...
void func_137(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, var uParam19, var uParam20, var uParam21, var uParam22, var uParam23, var uParam24, var uParam25, var uParam26, var uParam27, var uParam28, var uParam29, var uParam30, var uParam31, var uParam32, var uParam33, var uParam34, var uParam35, var uParam36, var uParam37, var uParam38, var uParam39, var uParam40, var uParam41, var uParam42, int iParam43, Hash hParam44, BOOL bParam45, BOOL bParam46) // Position - 0x9114
{
	...
	switch (uParam0.f_29[iParam43])
	{
		...
		case 21:
			...
			{
				componentType = Vector3(func_141(hParam44));
...
void func_146(int iParam0, int iParam1, int iParam2, int iParam3, const char* sParam4, const char* sParam5) // Position - 0xA6E2
{
		...
		for (i = 0; i < cacheNumberOfRows; i = i + 1)
		{
			if (i < 12)
			{
				...
				if (uParam0->[i].f_59 != -1)
				{
					...
					if (func_147(&(uParam0->[i].f_32), &unk))
...
void func_156(int iParam0, int iParam1, int iParam2, const char* sParam3) // Position - 0xAF6B
{
	...
	switch (uParam0->[0].f_76)
	{
		case 0:
			...
			for (i = 0; i < 12; i = i + 1)
			{
				...
				{
					if (!func_165(&(uParam0->[i].f_32), &Global_2103169))
					{
		...
		case 1:
			if (func_163(&(uParam0->[1].f_76), &(Global_2103169.f_206), &Global_2103169, &(Global_2103169.f_157)))
				uParam0->[0].f_76 = 2;
			break;
...
BOOL IS_XBOX_PLATFORM() // Position - 0xB718
{
	return MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION();
}

BOOL IS_PLAYSTATION_PLATFORM() // Position - 0xB72E
{
...
BOOL func_169(var uParam0) // Position - 0xB7B5
{
	...
	else
	{
		for (i = 0; i < 12; i = i + 1)
		{
			if (!func_170(&(uParam0->[i].f_78), &(uParam0->[i].f_32), &uParam0->[i]))
				return false;
		}
	}
	...
	switch (uParam0->[0].f_78)
	{
		case 0:
			...
			for (i = 0; i < 12; i = i + 1)
			{
				...
				func_106(&Global_2097536.f_3026[i]);
...
BOOL func_172(var uParam0) // Position - 0xBACA
{
	...
	if (IS_XBOX_PLATFORM() || IS_PLAYSTATION_PLATFORM())
	{
		for (i = 0; i < 12; i = i + 1)
		{
			if (!func_174(&(uParam0->[i].f_77), &(uParam0->[i].f_16), &(uParam0->[i].f_84), &(Global_2097536.f_2833), &(uParam0->[i].f_79)))
				return false;
		}
	}
	else
	{
		for (i = 0; i < 12; i = i + 1)
		{
			if (!func_173(&(uParam0->[i].f_77), uParam0->[i].f_16, &(uParam0->[i].f_84)))
				return false;
		}
	}
					...
					if (unk99.f_3 > 0)
					{
						...
						if (unk.f_96 <= 1)
						{
							if (Global_2097536.f_2704[offset] < 11)
							{
								if (func_187() && num == 0)
								{
									func_183(uParam0, &Global_2097536[offset][Global_2097536.f_2704[offset]], unk.f_96);
						...
						for (k = num2; k <= unk99.f_3 - 1; k = k + 1)
						{
							...
							if (Global_2097536.f_2704[offset] < 11 && unk.f_96 > 1)
							{
								if (func_187() && num == k)
								{
									if (!func_147(&(Global_2097536[offset][0].f_32), &gamerHandle))
									{
										func_183(uParam0, &Global_2097536[offset][Global_2097536.f_2704[offset]], unk.f_96);
								...
								{
									if (IS_GAMER_HANDLE_VALID(unk) && !func_147(&unk, &(Global_2097536[offset][0].f_32)))
									{
										if (func_147(&unk, &gamerHandle))
						...
						if (flag)
						{
							if (Global_2097536.f_2775[offset] == -1 && func_187())
							{
								if (Global_2097536.f_2704[offset] >= 1)
									func_183(uParam0, &Global_2097536[offset][Global_2097536.f_2704[offset]], Global_2097536[offset][Global_2097536.f_2704[offset] - 1].f_59 + 1);
								else
									func_183(uParam0, &Global_2097536[offset][Global_2097536.f_2704[offset]], 1);
...
BOOL func_177(var uParam0, var uParam1, Any* panParam2, int iParam3, int iParam4) // Position - 0xCCD9
{
	switch (*uParam0)
	{
		case 0:
...
BOOL func_186(var uParam0, var uParam1, Any* panParam2, int iParam3, Any* panParam4, BOOL bParam5, BOOL bParam6, int iParam7, int iParam8) // Position - 0xD066
{
	int any;
	float num;
	...
	switch (uParam0->[1])
	{
		case 0:
			...
			if (friendCount > 0)
			{
				...
				if (func_189(&(uParam0->f_4), &(uParam0->f_5), &(uParam0->f_44), &(uParam0->f_113), uParam0->f_113[0], flag, 0, 100))
				{
					func_185(&unk99, &(uParam0->f_44));
					...
					if (uParam0->f_5 && STATS::LEADERBOARDS2_READ_GET_ROW_DATA_START(&unk99))
					{
						...
						if (func_187() && num == 0)
						{
							...
							{
								func_183(uParam0, &Global_2097536[num3][Global_2097536.f_2704[num3]], 1);
							...
							else
							{
								...
								if (Global_2097536.f_2775[num3] == -1 && func_187())
								{
									if (Global_2097536.f_2704[num3] >= 1)
										func_183(uParam0, &Global_2097536[num3][Global_2097536.f_2704[num3]], Global_2097536[num3][Global_2097536.f_2704[num3] - 1].f_59 + 1);
									else
										func_183(uParam0, &Global_2097536[num3][Global_2097536.f_2704[num3]], 1);
						...
						for (j = num2; j <= unk99.f_3 - 1; j = j + 1)
						{
							...
							if (Global_2097536.f_2704[num3] < 11 && unk.f_96 > 1)
							{
								if (func_187() && num == j)
								{
									if (!func_147(&(Global_2097536[num3][0].f_32), &unk107))
									{
										func_183(uParam0, &Global_2097536[num3][Global_2097536.f_2704[num3]], unk.f_96);
								...
								{
									if (IS_GAMER_HANDLE_VALID(unk) && !func_147(&unk, &(Global_2097536[num3][0].f_32)))
									{
										if (func_147(&unk, &unk107))
					...
					if (unk112.f_3 > 0)
					{
						...
						if (unk14.f_96 <= 1)
						{
							if (Global_2097536.f_2704[offset] < 11)
							{
								if (func_187() && num == 0)
								{
									func_183(uParam0, &Global_2097536[offset][Global_2097536.f_2704[offset]], unk14.f_96);
									Global_2097536.f_2775[offset] = 0;
									Global_2097536.f_2704[offset] = Global_2097536.f_2704[offset] + 1;
								}
						...
						for (k = num2; k <= unk112.f_3 - 1; k = k + 1)
						{
							...
							if (Global_2097536.f_2704[offset] < 11 && unk14.f_96 > 1)
							{
								if (func_187() && num == k)
								{
									if (!func_147(&(Global_2097536[offset][0].f_32), &unk14))
									{
										func_183(uParam0, &Global_2097536[offset][Global_2097536.f_2704[offset]], unk14.f_96);
										Global_2097536.f_2775[offset] = Global_2097536.f_2704[offset];
										Global_2097536.f_2704[offset] = Global_2097536.f_2704[offset] + 1;
								...
								{
									if (IS_GAMER_HANDLE_VALID(unk14) && !func_147(&(Global_2097536[offset][0].f_32), &unk14))
									{
										if (func_147(&unk14, &unk))
											if (Global_2097536.f_2775[offset] < 0)
												Global_2097536.f_2775[offset] = Global_2097536.f_2704[offset];
...
void func_195(int iParam0, var uParam1, int iParam2, BOOL bParam3, BOOL bParam4) // Position - 0xEBAE
{
	char* componentType;
	var clanDesc;
	var unk;
...
void func_197(int iParam0, char* sParam1, const char* sParam2, char* sParam3, BOOL bParam4, int iParam5) // Position - 0xEEC8
{
...
int func_210(int* piParam0, BOOL bParam1) // Position - 0xF11D
{
	...
	if (IS_PLAYSTATION_PLATFORM() && npUnavailableReason == 4 || npUnavailableReason == 2 || npUnavailableReason == 1 || npUnavailableReason == 5 || !func_216() && NETWORK::NETWORK_IS_SIGNED_ONLINE())
	{
...
void func_228(int iParam0, BOOL bParam1) // Position - 0xFEF9
{
	...
	unk = 1;
	unk8 = 1;
	TEXT_LABEL_ASSIGN_STRING(&unk8[0], "GameType", 32);

	if (bParam1)
		TEXT_LABEL_ASSIGN_STRING(&unk[0], "MP", 24);
	else
...
void func_232(var uParam0, int iParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, BOOL bParam6, BOOL bParam7) // Position - 0x10262
{
	...
	switch (iParam1)
	{
		...
		case 209:
			...
			TEXT_LABEL_COPY(&(Global_2097536.f_2780.f_9), Vector3(func_240(iParam1)), 16);
			Global_2097536.f_2780.f_25 = 0;
		...
		case 888:
			...
			Global_2097536.f_2710[2] = 2;
			Global_2097536.f_2710[3] = 3;
			TEXT_LABEL_COPY(&(uParam0->f_44.f_3.f_1[0].f_8), Vector3(func_234(iParam4)), 8);
			Global_2097536.f_2708 = 4;
			MISC::SET_BIT(&(Global_2097536.f_2769), Global_2097536.f_2710[0]);
			MISC::SET_BIT(&(Global_2097536.f_2769), Global_2097536.f_2710[1]);
			MISC::SET_BIT(&(Global_2097536.f_2769), Global_2097536.f_2710[2]);
...
{
	pobParam0->f_2 = Vector3(0f, -2.3685f, -0.2f);
	pobParam0->f_5 = Vector3( 0f, 0f, 0f );
	pobParam0->f_8 = Vector3( 0f, 0f, 0f );
	pobParam0->f_20 = 0;
	pobParam0->f_23 = 0;
	pobParam0->f_24 = 0;
	pobParam0->f_25 = 0;
...
void func_252(var uParam0, var uParam1, var uParam2, var uParam3, int* piParam4) // Position - 0x15B01
{
	...
	switch (uParam0->f_1)
	{
		...
		case 2:
			if (PAD::IS_CONTROL_PRESSED(FRONTEND_CONTROL, INPUT_SCRIPT_LT) && iLocal_30 == 0)
				uParam0->f_1 = 1;
			...
			if (iLocal_30 == 0)
			{
				...
				else if (func_299(&uParam0->f_5[iLocal_30][iLocal_31], &(uParam0->f_243), uParam1, flag, false, false, uParam0->f_248))
				{
					HUD::CLEAR_PRINTS();
			...
			else if (iLocal_31 == 0)
			{
				...
				func_292(&uParam0->f_5[iLocal_30][iLocal_31], &(uParam0->f_243), &(uParam0->f_1), &(uParam0->f_249), false);
			}
		...
		case 3:
			if (func_279(&uParam0->f_5[iLocal_30][iLocal_31], &(uParam0->f_243), uParam0->f_248, false))
			{
		...
		case 4:
			if (!func_3(&(uParam3->f_666), 5))
				func_276(&uParam0->f_5[iLocal_30][iLocal_31], &(uParam0->f_243), uParam0->f_455);
...
void func_253(var uParam0, var uParam1) // Position - 0x15F5B
{
	...
	{
		if (uParam0->f_5[iLocal_30][iLocal_31].f_23)
		{
			if (uParam0->f_5[iLocal_30][iLocal_31].f_25)
			{
				iLocal_31 = iLocal_31 + 1;
			}
			else
			{
				func_276(&uParam0->f_5[iLocal_30][iLocal_31], &(uParam0->f_243), false);
				func_261(uParam0, uParam1);
			}
		}
		else if (uParam0->f_5[iLocal_30][iLocal_31].f_24)
		{
			if (bLocal_275)
			{
				if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_5[iLocal_30][iLocal_31]))
					OBJECT::DELETE_OBJECT(&uParam0->f_5[iLocal_30][iLocal_31]);
			}
			else
			{
				uParam0->f_5[iLocal_30][iLocal_31].f_23 = 1;
				uParam0->f_5[iLocal_30][iLocal_31].f_24 = 0;
				offsetFromCoordAndHeadingInWorldCoords = Vector3(OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(uParam0->f_243.f_1, uParam0->f_243.f_4, uParam0->f_5[iLocal_30][iLocal_31].f_11, uParam0->f_5[iLocal_30][iLocal_31].f_11.f_1 + fLocal_55, uParam0->f_5[iLocal_30][iLocal_31].f_11.f_2));
			
				if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_5[iLocal_30][iLocal_31]))
					ENTITY::SET_ENTITY_COORDS(uParam0->f_5[iLocal_30][iLocal_31], offsetFromCoordAndHeadingInWorldCoords, true, false, false, true);
			}
			...
			if (bLocal_275)
			{
				if (bLocal_277)
				{
					uParam0->f_5[iLocal_30][iLocal_31] = OBJECT::CREATE_OBJECT(uParam0->f_5[iLocal_30][iLocal_31].f_1, uLocal_79, true, true, false);
					offsetFromCoordAndHeadingInWorldCoords = Vector3(OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(uParam0->f_243.f_1, uParam0->f_243.f_4, uParam0->f_5[iLocal_30][iLocal_31].f_11, uParam0->f_5[iLocal_30][iLocal_31].f_11.f_1 + fLocal_55, uParam0->f_5[iLocal_30][iLocal_31].f_11.f_2));
					ENTITY::SET_ENTITY_COORDS(uParam0->f_5[iLocal_30][iLocal_31], offsetFromCoordAndHeadingInWorldCoords, true, false, false, true);
					randomFloatInRange = MISC::GET_RANDOM_FLOAT_IN_RANGE(0f, 90f);
					uParam0->f_5[iLocal_30][iLocal_31].f_17 = Vector3(90f, randomFloatInRange, uParam0->f_243.f_4);
					ENTITY::SET_ENTITY_ROTATION(uParam0->f_5[iLocal_30][iLocal_31], uParam0->f_5[iLocal_30][iLocal_31].f_17, 0, true);
					uParam0->f_5[iLocal_30][iLocal_31].f_23 = 1;
					uParam0->f_5[iLocal_30][iLocal_31].f_24 = 0;
				}
			}
		...
		else
		{
			...
			if (uParam0->f_5[iLocal_30][iLocal_31].f_21 == 2 || uParam0->f_5[iLocal_30][iLocal_31].f_20 == 50 && uParam0->f_422[iLocal_30] == 0)
			{
				if (uParam0->f_5[iLocal_30][iLocal_31].f_20 == 50)
			...
			if (bLocal_275)
			{
				if (bLocal_277)
				{
					...
					{
						if (!uParam0->f_5[iLocal_30][i].f_23)
						{
							uParam0->f_5[iLocal_30][i] = OBJECT::CREATE_OBJECT(uParam0->f_5[iLocal_30][i].f_1, uLocal_79, true, true, false);
							offsetFromCoordAndHeadingInWorldCoords = Vector3(OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(uParam0->f_243.f_1, uParam0->f_243.f_4, uParam0->f_5[iLocal_30][i].f_11, uParam0->f_5[iLocal_30][i].f_11.f_1 + fLocal_55, uParam0->f_5[iLocal_30][i].f_11.f_2));
						
							if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_5[iLocal_30][i]))
								ENTITY::SET_ENTITY_COORDS(uParam0->f_5[iLocal_30][i], offsetFromCoordAndHeadingInWorldCoords, true, false, false, true);
						
							randomFloatInRange2 = MISC::GET_RANDOM_FLOAT_IN_RANGE(0f, 90f);
							uParam0->f_5[iLocal_30][i].f_17 = Vector3(90f, randomFloatInRange2, uParam0->f_243.f_4);
							ENTITY::SET_ENTITY_ROTATION(uParam0->f_5[iLocal_30][i], uParam0->f_5[iLocal_30][i].f_17, 0, true);
							uParam0->f_5[iLocal_30][i].f_23 = 1;
							uParam0->f_5[iLocal_30][i].f_24 = 0;
						}
					}
				}
			}
	...
	switch (uParam0->f_2)
	{
		case 0:
			...
			if (iLocal_30 == 0)
				if (func_3(&(uParam2->f_666), 3))
					func_259("DARTS_PLR_DUB", uParam0->f_5[iLocal_30][iLocal_31].f_20, 5000, 0);
				else if (func_3(&(uParam2->f_666), 4))
					_SHOW_SUBTITLE_CLEAR_EXISTING("DARTS_ONE_PT", 5000, 0);
				else if (func_3(&(uParam2->f_666), 2))
					func_259("DARTS_PLR_BUST", uParam0->f_5[iLocal_30][iLocal_31].f_20, 5000, 0);
				else
					func_259("DARTS_SWITCH_C", uParam0->f_422[iLocal_30], 5000, 0);
			else if (func_3(&(uParam2->f_666), 3))
				func_259("DARTS_OPP_DUB", uParam0->f_5[iLocal_30][iLocal_31].f_20, 5000, 0);
			else if (func_3(&(uParam2->f_666), 4))
				_SHOW_SUBTITLE_CLEAR_EXISTING("DARTS_ONE_PT", 5000, 0);
			else if (func_3(&(uParam2->f_666), 2))
				func_259("DARTS_OPP_BUST", uParam0->f_5[iLocal_30][iLocal_31].f_20, 5000, 0);
			else
		...
		case 2:
			...
			if (bLocal_266 || SYSTEM::TIMERB() > 2000)
			{
				...
				for (i = 0; i < 3; i = i + 1)
				{
					func_250(&uParam0->f_5[iLocal_30][i]);
				}
...
void func_261(var uParam0, var uParam1) // Position - 0x16CAD
{
	...
	{
		uParam0->f_422[iLocal_30] = uParam0->f_422[iLocal_30] - uParam0->f_5[iLocal_30][iLocal_31].f_20;
		uParam0->f_428 = uParam0->f_428 + uParam0->f_5[iLocal_30][iLocal_31].f_20;
	}
	...
	else
	{
		...
		else if (uParam0->f_422[iLocal_30] == 1 || uParam0->f_422[iLocal_30] < 0 || uParam0->f_422[iLocal_30] == 0 && uParam0->f_5[iLocal_30][iLocal_31].f_21 != 2)
		{
			if (uParam0->f_422[iLocal_30] == 0 && uParam0->f_5[iLocal_30][iLocal_31].f_21 != 2)
			{
				func_259("DARTS_PLR_DUB", uParam0->f_5[iLocal_30][iLocal_31].f_20, 5000, 0);
		...
		else
		{
			...
			if (uParam0->f_5[iLocal_30][iLocal_31].f_20 == 0)
			{
				if (!bLocal_271 && !bLocal_276)
				{
			...
			uParam0->f_5[iLocal_30][iLocal_31].f_25 = 1;
			iLocal_31 = iLocal_31 + 1;
			SYSTEM::SETTIMERA(0);
...
int func_278(var uParam0) // Position - 0x17B05
{
	...
	{
		if (uParam0->f_5[iLocal_30][iLocal_31].f_8 > uParam0->f_5[iLocal_30][i].f_8 - 0.008f && uParam0->f_5[iLocal_30][iLocal_31].f_8 < uParam0->f_5[iLocal_30][i].f_8 + 0.008f && uParam0->f_5[iLocal_30][iLocal_31].f_8.f_2 > uParam0->f_5[iLocal_30][i].f_8.f_2 - 0.008f && uParam0->f_5[iLocal_30][iLocal_31].f_8.f_2 < uParam0->f_5[iLocal_30][i].f_8.f_2 + 0.008f)
			return 1;
	}
...
BOOL func_279(var uParam0, var uParam1, int iParam2, BOOL bParam3) // Position - 0x17BCB
{
	...
	if (uParam0->f_2.f_1 > uParam0->f_8.f_1 - 0.04f)
	{
		uParam0->f_23 = 1;
		uParam0->f_24 = 0;
		offsetFromCoordAndHeadingInWorldCoords = Vector3(OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(uParam1->f_1, uParam1->f_4, uParam0->f_11, uParam0->f_11.f_1 + fLocal_55, uParam0->f_11.f_2));
		ENTITY::SET_ENTITY_COORDS(*uParam0, offsetFromCoordAndHeadingInWorldCoords, true, false, false, true);
		return true;
	}

	offsetFromCoordAndHeadingInWorldCoords = Vector3(OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(uParam1->f_1, uParam1->f_4, uParam0->f_2, uParam0->f_2.f_1 + fLocal_55, uParam0->f_2.f_2));
	ENTITY::SET_ENTITY_COORDS(*uParam0, offsetFromCoordAndHeadingInWorldCoords, true, false, false, true);
...
void func_292(var uParam0, var uParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x17F16
{
	...
	else
	{
		...
		*uParam0 = OBJECT::CREATE_OBJECT(uParam0->f_1, uLocal_79, false, false, false);
		randomFloatInRange2 = MISC::GET_RANDOM_FLOAT_IN_RANGE(0f, 90f);
		offsetFromCoordAndHeadingInWorldCoords = Vector3(OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(uParam1->f_1, uParam1->f_4, uLocal_82));
		offsetFromCoordAndHeadingInWorldCoords2 = Vector3(OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(uParam1->f_1, uParam1->f_4, uParam0->f_8, uParam0->f_8.f_1 + fLocal_55, uParam0->f_8.f_2));
		...
		uParam0->f_17 = Vector3(90f, randomFloatInRange2, headingFromVector2d);
		ENTITY::SET_ENTITY_ROTATION(*uParam0, uParam0->f_17, 0, true);
		uParam0->f_2 = Vector3(uLocal_82);
		*uParam2 = 3;
...
void func_293(var uParam0) // Position - 0x18270
{
	...
	uParam0->f_11 = Vector3(uParam0->f_8);
...
void func_304(var uParam0, var uParam1, BOOL bParam2, int iParam3) // Position - 0x18988
{
	...
	offsetFromCoordAndHeadingInWorldCoords = Vector3(OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(uParam1->f_1, uParam1->f_4, uParam0->f_14, uParam0->f_14.f_1 + fLocal_55, uParam0->f_14.f_2));
...
void func_305(var uParam0, int iParam1) // Position - 0x18A37
{
	...
	uParam0->f_14 = Vector3(uParam0->f_8);
...
BOOL func_308(var uParam0, var uParam1, BOOL bParam2) // Position - 0x18F8C
{
	...
	func_293(uParam0);
	randomFloatInRange = MISC::GET_RANDOM_FLOAT_IN_RANGE(0f, 90f);
	offsetFromCoordAndHeadingInWorldCoords2 = Vector3(OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(uParam1->f_1, uParam1->f_4, uLocal_82));
	offsetFromCoordAndHeadingInWorldCoords3 = Vector3(OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(uParam1->f_1, uParam1->f_4, uParam0->f_14 + 0.0035f, uParam0->f_14.f_1 + fLocal_55, uParam0->f_14.f_2));
	...
	headingFromVector2d = headingFromVector2d - 180f;
	num = 90f;
	uParam0->f_17 = Vector3(num, randomFloatInRange, headingFromVector2d);
	ENTITY::SET_ENTITY_ROTATION(*uParam0, uParam0->f_17, 0, true);
	bLocal_98 = false;
	bLocal_100 = false;
	...
	offsetFromCoordAndHeadingInWorldCoords = Vector3(OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(uParam1->f_1, uParam1->f_4, uParam0->f_8, uParam0->f_8.f_1 + fLocal_55, uParam0->f_8.f_2));
...
BOOL func_311(int iParam0, var uParam1, var uParam2, var uParam3) // Position - 0x1921F
{
	...
	{
		case 0:
			vector = Vector3(func_314(iParam0));
			*uParam3 = Vector3(ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(*uParam1, vector));
			func_313(*uParam3);
			SYSTEM::SETTIMERB(0);
			*uParam2 = 1;
			break;
...
void func_313(Vector3 vParam0, var uParam1, var uParam2) // Position - 0x192AC
{
	...
	vector = Vector3(-5.5606f, -0.0106f, -131.6781f);
...
void func_329(var uParam0) // Position - 0x19D4C
{
	...
	if (iLocal_30 == 1 && iLocal_31 < 3 && *uParam0 != 5)
		if (PAD::IS_CONTROL_PRESSED(FRONTEND_CONTROL, INPUT_FRONTEND_ACCEPT) || PAD::IS_CONTROL_JUST_PRESSED(FRONTEND_CONTROL, INPUT_SCRIPT_RDOWN) && bLocal_99)
			*uParam0 = 6;
...
int func_331(var uParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0x1A060
{
	...
	if (num < 8)
	{
		uParam0->f_2[num] = sParam1;
		uParam0->f_2[num].f_1 = 0;
		uParam0->f_2[num].f_2 = iParam5;
		uParam0->f_2[num].f_12 = 0;
		uParam0->f_2[num].f_13 = 0;
		uParam0->f_2[num].f_14 = 0;
		uParam0->f_2[num].f_3[0] = iParam2;
		uParam0->f_2[num].f_3[0].f_1 = iParam3;
		MISC::SET_BIT(&(uParam0->f_2[num].f_12), 0);
	
		if (iParam4 == 1)
			MISC::SET_BIT(&(uParam0->f_2[num].f_13), 0);
	
		uParam0->f_2[num].f_14 = uParam0->f_2[num].f_14 + 1;
		uParam0->f_123 = uParam0->f_123 + 1;
		return 1;
	}
...
void func_344() // Position - 0x1A587
{
	...
	for (i = 0; i < 8; i = i + 1)
	{
		iLocal_164.f_9[i].f_3 = -1f;
		iLocal_164.f_9[i].f_4 = -1f;
		iLocal_164.f_9[i].f_5 = 0;
		iLocal_164.f_9[i].f_6 = 0;
	}
...
void func_346(BOOL bParam0, int iParam1) // Position - 0x1A60B
{
	...
	if (bParam0)
	{
		func_347(&Global_23270.f_6103[num]);
...
void func_372(int iParam0, char* sParam1, int iParam2, BOOL bParam3, int iParam4, BOOL bParam5, int iParam6) // Position - 0x1F035
{
	...
	if (iParam2 == 0)
	{
		num2 = func_374(&Global_23270.f_79[Global_23270.f_5663]);
	...
	if (bParam5)
	{
		if (iParam2 == 0)
		{
			num4 = func_373(&Global_23270.f_79[Global_23270.f_5663]);
			...
			switch (iLocal_31)
			{
				case 0:
					if (*uParam3 == 2)
					{
						...
						*uParam2 = 20;
						uParam2->f_1 = 2;
						func_292(&uParam4->[0], uParam1, uParam3, uParam2, true);
					}
				
					if (*uParam3 == 3)
					{
						if (func_279(&uParam4->[0], uParam1, 0, false))
						{
							AUDIO::PLAY_SOUND_FROM_COORD(-1, "DARTS_HIT_BOARD_MASTER", uParam1->f_1, 0, false, 0, false);
							iLocal_31 = iLocal_31 + 1;
							func_441(piParam5);
				...
				case 0:
					if (!CAM::IS_CAM_INTERPOLATING(caLocal_128))
					{
						if (*uParam3 == 2)
						{
							*uParam2 = 20;
							uParam2->f_1 = 3;
							func_292(&uParam4->[1], uParam1, uParam3, uParam2, true);
						}
					
						if (*uParam3 == 3)
						{
							if (func_279(&uParam4->[1], uParam1, 0, false))
							{
								AUDIO::PLAY_SOUND_FROM_COORD(-1, "DARTS_HIT_BOARD_MASTER", uParam1->f_1, 0, false, 0, false);
								iLocal_31 = iLocal_31 + 1;
								func_441(piParam5);
				...
				case 0:
					if (!CAM::IS_CAM_INTERPOLATING(caLocal_127))
					{
						if (*uParam3 == 2)
						{
							*uParam2 = 50;
							uParam2->f_1 = 1;
							func_292(&uParam4->[2], uParam1, uParam3, uParam2, true);
						}
					
						if (*uParam3 == 3)
						{
							if (func_279(&uParam4->[2], uParam1, 0, false))
							{
								AUDIO::PLAY_SOUND_FROM_COORD(-1, "DARTS_HIT_BOARD_MASTER", uParam1->f_1, 0, false, 0, false);
								iLocal_31 = iLocal_31 + 1;
								func_441(piParam5);
...
void func_414(Object* pobParam0) // Position - 0x20975
{
	...
	vector = Vector3(-1668.0444f, -1056.4501f, 13.1063f);
...
void func_415(Vector3 vParam0, var uParam1, var uParam2, float fParam3, Vector3 vParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, int iParam10) // Position - 0x209B5
{
	...
	CAM::SET_CAM_ROT(caLocal_128, Vector3(fParam3, 0f, 0f) - uParam7, 2);
...
void func_421(Vector3 vParam0, var uParam1, var uParam2, float fParam3, Vector3 vParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, int iParam10, BOOL bParam11) // Position - 0x20CA8
{
	...
	CAM::SET_CAM_ROT(caLocal_127, Vector3(fParam3, 0f, 0f) - uParam7, 2);
...
void func_452(var uParam0, var uParam1, var uParam2, BOOL bParam3) // Position - 0x21779
{
	...
	uLocal_82 = Vector3(0f, -2.3685f + fLocal_55, 0.1f);
	uLocal_82 = Vector3(uLocal_82 + uLocal_56);
	uLocal_79 = Vector3(OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(uParam0->f_1, uParam0->f_4, uLocal_82));
...
{
	uParam0->f_3 = Vector3(0f, -0.15f, 0f);
	uParam0->f_3 = Vector3(uParam0->f_3 + uLocal_56);
	*uParam0 = Vector3(OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(uParam1->f_1, uParam1->f_4, 0f, 0f, 0f));
	return;
}

void func_454(var uParam0, var uParam1) // Position - 0x2181C
{
	*uParam0 = Vector3(OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(uParam1->f_1, uParam1->f_4, -0.4f, -2.4f + fLocal_55, -1.7272f));
	uParam0->f_3 = Vector3(OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(uParam1->f_1, uParam1->f_4, 0.5f, -2.4f + fLocal_55, -1.7272f));
	return;
}
...
BOOL func_456(char* sParam0, int iParam1, BOOL bParam2) // Position - 0x21952
{
	...
	flag2 = func_457(&Global_23270.f_6103[num]);
	!flag || !flag2;
	return flag && flag2;
}

BOOL func_457(int iParam0) // Position - 0x21A48
{
	switch (iParam0->f_9)
	{
		case 0:
...
void func_461(var uParam0, int iParam1, Vector3 vParam2, var uParam3, var uParam4, float fParam5) // Position - 0x21B78
{
	...
	if (iParam1 == 0)
	{
		uParam0->f_18 = Vector3(989.399f, -99.674f, 75.925f);
		uParam0->f_21 = Vector3(180f, 0f, 252.555f);
		uParam0->f_24 = Vector3(1.82f, 1.328f, 1f);
	}
	else
	{
		uParam0->f_18 = Vector3(1992.223f, 3049.814f, 48.333f);
		uParam0->f_21 = Vector3(180f, 0f, 87.77f);
		uParam0->f_24 = Vector3(1.82f, 1.328f, 1f);
	}

	if (!_IS_NULL_VECTOR(vParam2) && fParam5 != 0f)
	{
		uParam0->f_18 = Vector3(OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vParam2, fParam5, -0.687645f, -0.350352f, 0.343273f));
		uParam0->f_21 = Vector3(180f, 0f, fParam5 - -29.98685f);
	}
...
void func_466(Vector3 vParam0, var uParam1, var uParam2, float fParam3) // Position - 0x21DE1
{
	...
	float unk7;
	Vector3 unk8;
	float offsetFromCoordAndHeadingInWorldCoords3;
	float unk9;
	Vector3 unk10;
	Vector3 vector3;
	Vector3 unk11;
	...
	vector5 = Vector3(-0.192784f, -1.73287f, 0.0262985f);
	num = 1.7939f;
	num2 = -1.3346f;

	if (GRAPHICS::GET_IS_WIDESCREEN())
	{
		vector6 = Vector3(-0.0974819f, -1.65968f, 0.335098f);
		num3 = -1.3023f;
		num4 = -12.4139f;
	}
	else
	{
		vector6 = Vector3(-0.112635f, -1.86963f, 0.45417f);
		num3 = -3.7542f;
		num4 = -14.4576f;
	}

	vector7 = Vector3(0.261599f, -0.750354f, -0.392929f);
	vector8 = Vector3(0.281314f, -0.573735f, -0.39603f);
	offsetFromCoordAndHeadingInWorldCoords2 = Vector3(OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vParam0, fParam3, vector5));
	vector2 = Vector3(num2, 0f, fParam3 - num);
	offsetFromCoordAndHeadingInWorldCoords = Vector3(OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vParam0, fParam3, vector6));
	vector = Vector3(num4, 0f, fParam3 - num3);
	offsetFromCoordAndHeadingInWorldCoords3 = Vector3(OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vParam0, fParam3, vector7));
	vector3 = Vector3(0.8351f, -0.0048f, fParam3 - 186.50734f);
	offsetFromCoordAndHeadingInWorldCoords4 = Vector3(OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vParam0, fParam3, vector8));
	vector4 = Vector3(0.8351f, -0.0048f, fParam3 - 186.50734f);
