...
void main() // Position - 0x0
{
	...
	iLocal_896 = 1;
	iLocal_897 = 1000;
	uLocal_916 = Vector3(1358.8215f, -1547.3961f, 53.7793f);
	uLocal_919 = Vector3(1358.8215f, -1547.3961f, 53.7793f);
	uLocal_922 = Vector3(-694.2758f, -1119.4468f, 13.525f);
	uLocal_925 = Vector3(-683.1272f, -1102.1846f, 13.5257f);
	uLocal_928 = Vector3(410.2629f, -1399.1598f, 28.4017f);
	uLocal_931 = Vector3(371.3834f, -1482.9553f, 28.3418f);
	uLocal_934 = Vector3(404.8026f, -1416.2942f, 28.435f);
	uLocal_937 = Vector3(406.612f, -1419.9369f, 29.003754f);
	uLocal_940 = Vector3(-682.5392f, -1109.0822f, 13.6729f);
	uLocal_943 = Vector3(-688.6727f, -1117.512f, 13.52498f);
	uLocal_946 = Vector3(-667.136f, -1046.0604f, 15.9174f);
	uLocal_949 = Vector3(-703.1228f, -1142.4324f, 9.8127f);
	uLocal_955 = Vector3(-701.2533f, -1080.285f, 12.2884f);
	uLocal_958 = Vector3(-687.8794f, -1108.0731f, 13.5257f);
	uLocal_961 = Vector3(-703.0013f, -1084.073f, 12.1105f);
	fLocal_970 = 25.0227f;
	...
	uLocal_1044 = Vector3(-727.111f, -1046.3568f, 11.439257f);
	uLocal_1047 = Vector3(-642.60974f, -1085.5381f, 28.429213f);
	fLocal_1050 = 76.75f;
	iLocal_1123 = 786468;
	iLocal_1124 = 1;
		...
		switch (caLocal_423.f_410)
		{
			...
			case 1:
				if (func_311())
				{
					func_310();
					func_290();
					func_289(&uLocal_409[0], "TAXI_SC_BN_04", 100);
					...
					caLocal_423.f_14 = Vector3(uLocal_916);
			...
			case 6:
				if (func_258(&caLocal_423))
				{
					...
					caLocal_423.f_17 = Vector3(485.2039f, -1418.0643f, 28.2112f);
					func_252();
			...
			case 21:
				...
				{
					HUD::REMOVE_BLIP(&(hLocal_853.f_4));
					caLocal_423.f_17 = Vector3(uLocal_925);
				}
...
void func_10(var uParam0, BOOL bParam1) // Position - 0x125A
{
	...
	STATS::PLAYSTATS_ODDJOB_DONE(SYSTEM::ROUND(func_11(&uLocal_90) * 1000f), 12, false);
	return;
}
...
void func_15(var uParam0) // Position - 0x145C
{
	...
	if (uLocal_57[0] != 0)
	{
		TEXT_LABEL_COPY(&unk, Vector3(func_16(uParam0)), 6);
...
void func_37(var uParam0, var uParam1, var uParam2, BOOL bParam3) // Position - 0x19E3
{
	...
	{
		vector = Vector3(func_38(uParam0, 1f, -30f, -30f, -10f));
		vector2 = Vector3(func_38(uParam0, 1f, 30f, 30f, 10f));
		...
		if (Global_97614[i] && !Global_97614[i].f_1)
			if (Global_97614[i].f_3 == 0)
				if (Global_97614[i].f_5 != 88 && Global_97614[i].f_5 != 89 && Global_97614[i].f_5 != 92)
					func_47(Global_97614[i].f_5, true);
	}
...
void _STAT_SET_PACKED_BOOL(int iParam0, BOOL bParam1, int iParam2) // Position - 0x28FA
{
	if (iParam2 == -1)
		iParam2 = func_27();
...
void func_89(int iParam0) // Position - 0x37A6
{
	...
	else if (IS_BIT_SET(Global_113648.f_20566.f_471, iParam0) || IS_BIT_SET(Global_2359296[func_91()].f_681.f_10, iParam0))
	{
		flag = true;
		MISC::CLEAR_BIT(&(Global_113648.f_20566.f_471), iParam0);
		MISC::CLEAR_BIT(&(Global_2359296[func_91()].f_681.f_10), iParam0);
	}
...
void _MPCHAR_STAT_SET_INT(eMPStat empsParam0, int iParam1, int iParam2, BOOL bParam3, BOOL bParam4) // Position - 0x3A36
{
	...
	bParam4;
	statName = Global_2805029[empsParam0][func_93(iParam2)];
...
BOOL func_95(int iParam0) // Position - 0x3ABA
{
	...
	return IS_BIT_SET(Global_2359296[func_91()].f_681.f_10, iParam0);
}
...
int _MPCHAR_STAT_GET_INT(eMPStat empsParam0, int iParam1, int iParam2) // Position - 0x3C60
{
	...
	{
		iParam2 == 0;
		statHash = Global_2805029[empsParam0][func_93(iParam1)];
...
BOOL _STAT_GET_PACKED_BOOL(int iParam0, int iParam1) // Position - 0x3C9D
{
	if (iParam1 == -1)
		iParam1 = func_27();
...
{
	if (!func_14(&uParam0->f_146[iParam1]))
		func_117(&uParam0->f_146[iParam1]);
...
Blip func_130(Vector3 vParam0, var uParam1, var uParam2, BOOL bParam3) // Position - 0x4787
{
	Blip blip;
...
BOOL func_134() // Position - 0x4981
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(pedLocal_890))
		if (!PED::IS_PED_INJURED(pedLocal_890))
			entityCoords = Vector3(ENTITY::GET_ENTITY_COORDS(pedLocal_890, true));
...
Vector3 func_138(int iParam0) // Position - 0x4E01
{
	...
	{
		case 0:
			unk = Vector3(1.9027f, 0f, 170.5764f);
			break;
	}
...
Vector3 func_139(int iParam0) // Position - 0x4E2C
{
	...
	{
		case 0:
			unk = Vector3(-686.0368f, -1073.2203f, 16.1762f);
			break;
	}
...
void func_140(Vector3 vParam0, var uParam1, var uParam2, int iParam3, BOOL bParam4) // Position - 0x4E5B
{
	...
	vector = Vector3(func_38(outPosition, func_141(outHeading), iParam3, iParam3, 5f));
	vector2 = Vector3(func_38(outPosition, outHeading, iParam3, iParam3, -5f));
...
void func_147(var uParam0) // Position - 0x50AC
{
	...
	for (i = 0; i < 5; i = i + 1)
	{
		uParam0->[i].f_6 = 0;
		uParam0->[i].f_7 = 0;
		TEXT_LABEL_ASSIGN_STRING(&uParam0->[i], func_148(), 24);
	}
...
{
	return func_14(&uParam0->f_146[iParam1]);
}
...
void func_210() // Position - 0x730F
{
	...
	num = Vector3(402.42f, -1457.19f, 28.82f);
	num2 = Vector3(-701.25f, -1080.29f, 12.29f);
...
Vector3 func_216(int iParam0) // Position - 0x7AAC
{
	...
	{
		case 0:
			unk = Vector3(-0.7535f, -0.0475f, 91.9877f);
			break;
	
		case 1:
			unk = Vector3(4.2328f, 0f, 165.0072f);
			break;
	
		case 2:
			unk = Vector3(-0.3221f, 0f, 68.7635f);
			break;
	
		case 3:
			unk = Vector3(-0.3614f, 0f, -145.1533f);
			break;
	
		case 4:
			unk = Vector3(-5.4284f, 0f, 1.8065f);
			break;
	
		case 5:
			unk = Vector3(1.2038f, 0f, 68.7635f);
			break;
	
		case 6:
			unk = Vector3(-2.1877f, 0f, 71.1648f);
			break;
	}
...
Vector3 func_217(int iParam0) // Position - 0x7B6B
{
	...
	{
		case 0:
			unk = Vector3(495.4f, -1416.8f, 30.2f);
			break;
	
		case 1:
			unk = Vector3(429.6911f, -1385.4146f, 29.7266f);
			break;
	
		case 2:
			unk = Vector3(417.9f, -1419.4f, 30.6f);
			break;
	
		case 3:
			unk = Vector3(426.754f, -1386.5096f, 29.6201f);
			break;
	
		case 4:
			unk = Vector3(493.7f, -1416.9f, 30.2f);
			break;
	
		case 5:
			unk = Vector3(450.0146f, -1414.5232f, 34.4507f);
			break;
	
		case 6:
			unk = Vector3(448.2621f, -1413.842f, 34.4501f);
			break;
	}
...
void func_251(float fParam0, float fParam1, float fParam2, BOOL bParam3, int iParam4) // Position - 0x8CF0
{
	...
	vector = Vector3(func_38(fParam0, 1f, -iParam4, -iParam4, -iParam4));
	vector2 = Vector3(func_38(fParam0, 1f, iParam4, iParam4, iParam4));
	vector.f_2 = vector.f_2 - 22f;
	vector2.f_2 = vector2.f_2 + 22f;
...
float func_264(var uParam0) // Position - 0x9A3E
{
	...
	num = 0f;
	offsetFromEntityInWorldCoords = Vector3(func_40());
...
BOOL IS_PLAYSTATION_PLATFORM() // Position - 0xAD04
{
	return MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION();
}

BOOL IS_XBOX_PLATFORM() // Position - 0xAD1A
{
...
void func_307(int iParam0, int iParam1, BOOL bParam2) // Position - 0xB116
{
	...
	func_68(&iLocal_343.f_1[iLocal_343], 1);

	if (bParam2)
		func_68(&iLocal_343.f_1[iLocal_343], 2);
...
void func_321(var uParam0, int iParam1, BOOL bParam2) // Position - 0xB992
{
	...
	{
		if (!func_14(&(uLocal_190[5].f_6)))
		{
			func_117(&(uLocal_190[5].f_6));
		}
		else if (func_107(&(uLocal_190[5].f_6)) > 6f)
		{
			if (func_344(uParam0))
			{
				if (uParam0->f_113)
				...
				{
					func_254(uParam0, uLocal_190[5].f_9, 1, false, false);
				}
	...
	{
		if (!func_14(&(uLocal_190[0].f_6)))
		{
			func_117(&(uLocal_190[0].f_6));
		}
		else if (func_107(&(uLocal_190[0].f_6)) > 5f)
		{
			if (func_339(uParam0))
			{
				func_343(uParam0, 1);
				...
				{
					func_254(uParam0, uLocal_190[0].f_9, 1, false, false);
				}
	...
	{
		if (!func_14(&(uLocal_190[1].f_6)))
		{
			func_117(&(uLocal_190[1].f_6));
		}
		else if (func_107(&(uLocal_190[1].f_6)) > 5f)
		{
			if (func_338(uParam0))
			{
				func_343(uParam0, 1);
				...
				{
					func_254(uParam0, uLocal_190[1].f_9, 1, false, false);
				}
	...
	{
		if (!func_14(&(uLocal_190[8].f_6)))
		{
			if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_4))
			{
				uParam0->f_46 = ENTITY::GET_ENTITY_HEALTH(uParam0->f_4);
				func_117(&(uLocal_190[8].f_6));
			}
		}
		else if (func_107(&(uLocal_190[8].f_6)) > 7f || uLocal_190[8].f_1 == 0)
		{
			if (func_337(uParam0))
			{
				func_343(uParam0, 1);
	...
	{
		if (!func_14(&(uLocal_190[6].f_6)))
		{
			func_117(&(uLocal_190[6].f_6));
		}
		else if (func_107(&(uLocal_190[6].f_6)) > 5f)
		{
			if (func_336(uParam0))
			{
				func_343(uParam0, 1);
				...
				{
					func_254(uParam0, uLocal_190[6].f_9, 1, false, false);
				}
	...
	{
		if (!func_14(&(uLocal_190[4].f_6)))
		{
			func_117(&(uLocal_190[4].f_6));
		}
		else if (func_107(&(uLocal_190[4].f_6)) > 4f)
		{
			if (func_335(uParam0))
			{
				func_343(uParam0, 1);
				...
				{
					func_254(uParam0, uLocal_190[4].f_9, 1, false, false);
				}
	...
	{
		if (!func_14(&(uLocal_190[7].f_6)))
		{
			func_117(&(uLocal_190[7].f_6));
		}
		else if (func_107(&(uLocal_190[7].f_6)) > 5f || uLocal_190[7].f_1 == 0)
		{
			if (func_334(uParam0))
			{
				func_341(7, uParam0);
				...
				{
					func_254(uParam0, uLocal_190[7].f_9, 1, false, true);
				}
	...
	{
		if (!func_14(&(uLocal_190[9].f_6)))
		{
			func_117(&(uLocal_190[9].f_6));
		}
		else if (func_107(&(uLocal_190[9].f_6)) <= 7f)
		{
			PLAYER::CLEAR_PLAYER_HAS_DAMAGED_AT_LEAST_ONE_PED(PLAYER::PLAYER_ID());
		}
		else if (func_107(&(uLocal_190[9].f_6)) > 7f || uLocal_190[9].f_1 == 0)
		{
			if (func_333(uParam0))
			{
				func_343(uParam0, 1);
				...
				{
					func_254(uParam0, uLocal_190[9].f_9, 1, false, true);
				}
	...
	{
		if (!func_14(&(uLocal_190[13].f_6)))
		{
			func_117(&(uLocal_190[13].f_6));
		}
		else if (func_107(&(uLocal_190[13].f_6)) > 10f)
		{
			if (func_327(uParam0))
			{
				func_343(uParam0, 1);
				...
				{
					func_254(uParam0, uLocal_190[13].f_9, 1, false, false);
				}
	...
	{
		if (!func_14(&(uLocal_190[14].f_6)))
		{
			func_117(&(uLocal_190[14].f_6));
		}
		else if (func_107(&(uLocal_190[14].f_6)) > 7f)
		{
			if (func_326(uParam0))
			{
				func_343(uParam0, 1);
				...
				{
					func_254(uParam0, uLocal_190[14].f_9, 1, false, false);
				}
	...
	{
		if (!func_14(&(uLocal_190[11].f_6)))
		{
			func_117(&(uLocal_190[11].f_6));
		}
		else if (func_107(&(uLocal_190[11].f_6)) > 8f)
		{
			if (func_325(uParam0))
			{
				func_343(uParam0, 1);
				...
				{
					func_254(uParam0, uLocal_190[11].f_9, 1, false, false);
				}
	...
	{
		if (!func_14(&(uLocal_190[12].f_6)))
		{
			func_117(&(uLocal_190[12].f_6));
		}
		else if (func_107(&(uLocal_190[12].f_6)) > 5f)
		{
			if (func_324(uParam0))
			{
				func_343(uParam0, 1);
				...
				{
					func_254(uParam0, uLocal_190[12].f_9, 1, false, false);
				}
	...
	{
		if (!func_14(&(uLocal_190[2].f_6)))
		{
			func_323(&(uLocal_190[2].f_6), 0f);
		}
		else if (func_107(&(uLocal_190[2].f_6)) > 5f)
		{
			if (func_322(uParam0))
			{
				if (uParam0->f_113)
				...
				{
					func_254(uParam0, uLocal_190[2].f_9, 1, false, false);
				}
...
BOOL func_322(var uParam0) // Position - 0xC18F
{
	...
	{
		if (!PED::IS_PED_STOPPED(uParam0->f_2) && !func_14(&(uLocal_190[0].f_3)) && !func_14(&(uLocal_190[1].f_3)))
		{
			if (!func_14(&(uLocal_190[2].f_3)))
			{
				uParam0->f_37 = ENTITY::GET_ENTITY_SPEED(uParam0->f_2);
			
				if (uParam0->f_37 > 10f)
					func_117(&(uLocal_190[2].f_3));
			}
			else if (func_107(&(uLocal_190[2].f_3)) > 0.9f)
			{
				uParam0->f_38 = uParam0->f_37;
				uParam0->f_37 = ENTITY::GET_ENTITY_SPEED(uParam0->f_2);
				num = uParam0->f_38 - uParam0->f_37;
				func_106(&(uLocal_190[2].f_3));
...
BOOL func_324(var uParam0) // Position - 0xC28C
{
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(uParam0->f_4, false))
	{
		...
		if (entitySpeedVector.f_1 < -10f && !func_14(&(uLocal_190[0].f_3)))
		{
			if (!func_14(&(uLocal_190[12].f_3)))
			{
				func_117(&(uLocal_190[12].f_3));
			}
			else if (func_107(&(uLocal_190[12].f_3)) > 5f)
			{
				func_106(&(uLocal_190[12].f_3));
				return true;
			}
		}
		else
...
BOOL func_325(var uParam0) // Position - 0xC31B
{
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(uParam0->f_4, false) && !func_14(&(uLocal_190[0].f_3)) && !func_14(&(uLocal_190[1].f_3)) && !func_14(&(uLocal_190[5].f_3)) && !func_14(&(uLocal_190[9].f_3)) && !func_14(&(uLocal_190[7].f_3)) && !func_14(&(uLocal_190[8].f_3)))
	{
		entitySpeedVector = Vector3(ENTITY::GET_ENTITY_SPEED_VECTOR(uParam0->f_4, true));
	
		if (MISC::ABSF(entitySpeedVector) > 2.5f && !func_14(&(uLocal_190[0].f_3)))
		{
			if (!func_14(&(uLocal_190[11].f_3)))
			{
				func_117(&(uLocal_190[11].f_3));
				fLocal_342 = entitySpeedVector;
			}
			else if (func_107(&(uLocal_190[11].f_3)) < 1.5f && MISC::ABSF(fLocal_342) - MISC::ABSF(entitySpeedVector) < 0f)
			{
				func_106(&(uLocal_190[11].f_3));
				return true;
			}
			else if (func_107(&(uLocal_190[11].f_3)) >= 1.5f)
			{
				func_106(&(uLocal_190[11].f_3));
				return false;
			}
...
{
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(uParam0->f_4, false) && !func_14(&(uLocal_190[0].f_3)) && !func_14(&(uLocal_190[8].f_3)) && !func_14(&(uLocal_190[5].f_3)) && !func_14(&(uLocal_190[9].f_3)) && !func_14(&(uLocal_190[7].f_3)))
	{
		if (!func_14(&(uLocal_190[14].f_3)))
		{
			...
			if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_5))
				if (ENTITY::GET_ENTITY_SPEED(uParam0->f_4) > 15f && func_51(uParam0->f_5, uParam0->f_4, true) < 3f && !ENTITY::IS_ENTITY_DEAD(uParam0->f_5, false) && !VEHICLE::IS_VEHICLE_SEAT_FREE(uParam0->f_5, -1, false))
					func_117(&(uLocal_190[14].f_3));
		}
		else if (func_107(&(uLocal_190[14].f_3)) < 1.5f && func_51(uParam0->f_5, uParam0->f_4, true) > 4.5f && !ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ANY_VEHICLE(uParam0->f_5))
		{
			func_106(&(uLocal_190[14].f_3));
			return true;
		}
		else if (func_107(&(uLocal_190[14].f_3)) >= 1.5f)
		{
			func_106(&(uLocal_190[14].f_3));
			return false;
		}
...
{
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(uParam0->f_4, false) && !func_14(&(uLocal_190[9].f_3)) && !func_14(&(uLocal_190[7].f_3)) && !func_14(&(uLocal_190[4].f_3)))
	{
		if (!func_328(uParam0->f_4) && ENTITY::GET_ENTITY_SPEED(uParam0->f_4) > 15f)
		{
			if (!func_14(&(uLocal_190[13].f_3)))
			{
				func_117(&(uLocal_190[13].f_3));
			}
			else if (func_107(&(uLocal_190[13].f_3)) > 5f)
			{
				func_106(&(uLocal_190[13].f_3));
				return true;
			}
		}
		else
...
BOOL func_329(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11) // Position - 0xC770
{
	...
	uParam6.f_2 = 0f;
	uParam9.f_2 = 0f;
	unk = Vector3(func_332(uParam6 - uParam3));
	unk4 = Vector3(func_332(uParam9 - uParam3));
...
BOOL func_335(var uParam0) // Position - 0xC9E2
{
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(uParam0->f_4, false))
	{
		...
		{
			if (!func_14(&(uLocal_190[4].f_3)))
			{
				func_117(&(uLocal_190[4].f_3));
			}
			else if (func_107(&(uLocal_190[4].f_3)) > 2f)
			{
				func_106(&(uLocal_190[4].f_3));
				return true;
			}
		}
		else
...
BOOL func_336(var uParam0) // Position - 0xCA54
{
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(uParam0->f_4, false))
	{
		...
		{
			if (!func_14(&(uLocal_190[6].f_3)))
			{
				func_117(&(uLocal_190[6].f_3));
			}
			else if (func_107(&(uLocal_190[6].f_3)) > 3.5f)
			{
				func_106(&(uLocal_190[6].f_3));
				return true;
			}
		}
		else
...
BOOL func_338(var uParam0) // Position - 0xCB4B
{
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(uParam0->f_4, false))
	{
		...
		if (MISC::ABSF(entitySpeedVector) > 3f && !func_14(&(uLocal_190[0].f_3)))
		{
			if (!func_14(&(uLocal_190[1].f_3)))
			{
				func_117(&(uLocal_190[1].f_3));
			}
			else if (func_107(&(uLocal_190[1].f_3)) > 1.2f)
			{
				func_106(&(uLocal_190[1].f_3));
				return true;
			}
		}
		else
...
BOOL func_339(var uParam0) // Position - 0xCBD7
{
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(uParam0->f_4, false))
	{
		...
		{
			if (!func_14(&(uLocal_190[0].f_3)))
			{
				func_117(&(uLocal_190[0].f_3));
			}
			else if (func_107(&(uLocal_190[0].f_3)) > 0.7f)
			{
				func_106(&(uLocal_190[0].f_3));
				func_109(&(uLocal_190[1].f_6));
				return true;
			}
		}
		else
...
void func_340(var uParam0) // Position - 0xCC61
{
	...
	for (i = 0; i < 15; i = i + 1)
	{
		if (func_14(&(uLocal_190[i].f_6)))
			func_109(&(uLocal_190[i].f_6));
	}
...
void func_341(int iParam0, var uParam1) // Position - 0xCCA9
{
	...
	func_106(&(uLocal_190[iParam0].f_6));
	uParam1->f_112 = 1;
	return;
}
...
BOOL func_344(var uParam0) // Position - 0xCD06
{
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(uParam0->f_4, false))
	{
		...
		{
			if (!func_14(&(uLocal_190[5].f_3)))
			{
				func_117(&(uLocal_190[5].f_3));
			}
			else if (func_107(&(uLocal_190[5].f_3)) > 3.5f)
			{
				func_106(&(uLocal_190[5].f_3));
				return true;
			}
		}
		else
	...
	switch (iLocal_1142)
	{
		case 0:
			if (!ENTITY::IS_ENTITY_DEAD(hLocal_853.f_2, false) && !ENTITY::IS_ENTITY_DEAD(caLocal_423.f_3, false) && !ENTITY::IS_ENTITY_DEAD(pedLocal_890, false))
			{
				...
				PED::SET_PED_DIES_WHEN_INJURED(hLocal_853.f_2, true);
				TASK::CLEAR_PED_TASKS(hLocal_853.f_2);
				PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(pedLocal_890, true);
				...
				PED::SET_PED_DIES_WHEN_INJURED(pedLocal_890, true);
				TASK::CLEAR_PED_TASKS(pedLocal_890);
				iLocal_1142 = 1;
			}
			break;
		...
		case 7:
			...
			{
				entityCoords = Vector3(ENTITY::GET_ENTITY_COORDS(hLocal_853.f_2, false));
				TASK::OPEN_SEQUENCE_TASK(&iLocal_416);
	...
	if (!uParam0->f_109)
	{
		switch (*uParam2)
		{
			case 1:
				if (!func_377(uParam0))
				{
					uParam2->f_7 = Vector3(func_376(uParam1));
...
void func_374(var uParam0) // Position - 0xEC30
{
	...
	if (num > -1)
	{
		func_20(&(uParam0->[num].f_7), 2);
		func_20(&(uParam0->[num].f_7), 4);
		func_67(&(uParam0->[num].f_7), 8);
		TEXT_LABEL_ASSIGN_STRING(&uParam0->[num], func_148(), 24);
	}
...
struct<6> func_376(var uParam0) // Position - 0xECAA
{
	...
	for (i = 0; i < 5; i = i + 1)
	{
		if (func_22(uParam0->[i].f_7, 2))
		{
			unk = Vector3(uParam0->[i]);
			func_67(&(uParam0->[i].f_7), 4);
		}
	}
...
void func_403(var uParam0) // Position - 0x133C0
{
	...
	if (uParam0->f_410 >= 5)
	{
		if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_4))
		{
			if (iLocal_343 > 0 && !func_297(iLocal_343.f_1[4], 4))
			{
				i = 0;
			
				for (i = 0; i <= iLocal_343 - 1; i = i + 1)
				{
					if (func_297(iLocal_343.f_1[i], 2))
					{
						iLocal_343.f_1[i].f_2(uParam0);
					
						if (StackVal)
						{
							if (!func_297(iLocal_343.f_1[i], 4))
							{
								func_68(&iLocal_343.f_1[i], 4);
								iLocal_343.f_1[i].f_1 = MISC::GET_GAME_TIMER();
							}
						}
						else
						{
							func_21(&iLocal_343.f_1[i], 12);
						}
					
						if (func_297(iLocal_343.f_1[i], 4) && !func_297(iLocal_343.f_1[i], 8))
						{
							iLocal_343.f_1[i].f_3(uParam0, iLocal_343.f_1[i].f_1);
						
							if (StackVal)
								func_68(&iLocal_343.f_1[i], 8);
						}
					}
				}
			}
...
void func_444() // Position - 0x147D3
{
	...
	caLocal_423.f_23 = Vector3(1412.3242f, -1518.3154f, 58.4644f);
	caLocal_423.f_33 = 114.1f;
	caLocal_423.f_26 = Vector3(uLocal_925);
...
void func_456(var uParam0) // Position - 0x14D78
{
	...
	uParam0->f_3 = 0;
	uParam0->f_4 = 0;
	uParam0->f_14 = Vector3(func_40());
	uParam0->f_17 = Vector3(func_40());
	uParam0->f_35 = 0f;
	uParam0->f_76 = 0;
	uParam0->f_49 = 0;
	uParam0->f_109 = 0;
