...
void main() // Position - 0x0
{
	...
	while (true)
	{
		...
		if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && _NETWORK_IS_PLAYER_VALID(PLAYER::PLAYER_ID(), true, true) && !Global_1836387 && Global_32283 == 0)
			func_113();
...
void func_9() // Position - 0x3F6
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (_GET_CHARACTER_MODEL(G_MissionStats.f_2366.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_10(character) && !func_15(14) || Global_112760)
			{
...
BOOL func_18(Hash hParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4) // Position - 0x63A
{
	...
	unk[0] = { vParam1 };
	unk[1] = { OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vParam1, fParam4, -xOffset, -xOffset.f_1, -xOffset.f_2) };
	unk[2] = { OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vParam1, fParam4, xOffset, -xOffset.f_1, -xOffset.f_2) };
	unk[3] = { OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vParam1, fParam4, xOffset, xOffset.f_1, -xOffset.f_2) };
	unk[4] = { OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vParam1, fParam4, -xOffset, xOffset.f_1, -xOffset.f_2) };
	unk[5] = { OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vParam1, fParam4, -xOffset, -xOffset.f_1, xOffset.f_2) };
	unk[6] = { OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vParam1, fParam4, xOffset, -xOffset.f_1, xOffset.f_2) };
	unk[7] = { OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vParam1, fParam4, xOffset, xOffset.f_1, xOffset.f_2) };
	unk[8] = { OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(vParam1, fParam4, -xOffset, xOffset.f_1, xOffset.f_2) };
	...
	shapeTestHandle = SHAPETEST::START_EXPENSIVE_SYNCHRONOUS_SHAPE_TEST_LOS_PROBE(unk[1], unk[3], 87, PLAYER::PLAYER_PED_ID(), 0);
	SHAPETEST::GET_SHAPE_TEST_RESULT(shapeTestHandle, &hit, &endCoords, &surfaceNormal, &entityHit);

	if (hit != 0)
		return false;

	shapeTestHandle2 = SHAPETEST::START_EXPENSIVE_SYNCHRONOUS_SHAPE_TEST_LOS_PROBE(unk[2], unk[4], 87, PLAYER::PLAYER_PED_ID(), 0);
	SHAPETEST::GET_SHAPE_TEST_RESULT(shapeTestHandle2, &hit, &endCoords, &surfaceNormal, &entityHit);

	if (hit != 0)
		return false;

	shapeTestHandle3 = SHAPETEST::START_EXPENSIVE_SYNCHRONOUS_SHAPE_TEST_LOS_PROBE(unk[5], unk[7], 87, PLAYER::PLAYER_PED_ID(), 0);
	SHAPETEST::GET_SHAPE_TEST_RESULT(shapeTestHandle3, &hit, &endCoords, &surfaceNormal, &entityHit);

	if (hit != 0)
		return false;

	shapeTestHandle4 = SHAPETEST::START_EXPENSIVE_SYNCHRONOUS_SHAPE_TEST_LOS_PROBE(unk[6], unk[8], 87, PLAYER::PLAYER_PED_ID(), 0);
	SHAPETEST::GET_SHAPE_TEST_RESULT(shapeTestHandle4, &hit, &endCoords, &surfaceNormal, &entityHit);

	if (hit != 0)
		return false;

	shapeTestHandle5 = SHAPETEST::START_EXPENSIVE_SYNCHRONOUS_SHAPE_TEST_LOS_PROBE(unk[1], unk[8], 87, PLAYER::PLAYER_PED_ID(), 0);
	SHAPETEST::GET_SHAPE_TEST_RESULT(shapeTestHandle5, &hit, &endCoords, &surfaceNormal, &entityHit);

	if (hit != 0)
		return false;

	shapeTestHandle6 = SHAPETEST::START_EXPENSIVE_SYNCHRONOUS_SHAPE_TEST_LOS_PROBE(unk[2], unk[7], 87, PLAYER::PLAYER_PED_ID(), 0);
...
{
	if (IS_BIT_SET(Global_32532, iParam0))
		return true;
...
{
	if (IS_BIT_SET(Global_32533, iParam0))
		return true;
...
{
	if (IS_BIT_SET(Global_32535, iParam0))
	{
		if (iParam1 != 0)
		{
			if (iParam1 == Global_32536)
			{
				MISC::CLEAR_BIT(&Global_32535, iParam0);
				bLocal_91 = true;
				return true;
			}
			else
