	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (num != -1)
		{
			if (Global_112897[num].f_9 != -1)
			{
				...
				func_269(&(Global_112897[num].f_9));
			}
		}
...
BOOL func_217(Ped pedParam0, Ped pedParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xE00F
{
	...
	flag = func_218(&iLocal_35[num], pedBoneCoords, pedParam1, &(iLocal_35[num].f_3), pedParam0, iParam5);
...
{
	uParam0->f_16 = 5;
	uParam0->f_17[0] = { 1973.3237f, 3815.594f, 31.42936f };
	uParam0->f_17[1] = { 1974.9358f, 3812.7473f, 34.438004f };
	uParam0->f_24 = 6.5f;
	uParam0->f_27 = 0;
