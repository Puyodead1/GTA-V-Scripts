...
void main() // Position - 0x0
{
	...
	func_266(&num);
	vector = Vector3(uScriptParam_94.f_1[0]);
	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (num != -1)
		{
			if (Global_112735[num].f_9 != -1)
			{
				...
				func_264(&(Global_112735[num].f_9));
			}
		}
	...
	func_236(&num);
	iLocal_92 = PED::ADD_SCENARIO_BLOCKING_AREA(vector - Vector3(20f, 20f, 20f), vector + Vector3(20f, 20f, 20f), false, true, true, true);
...
BOOL IS_PLAYSTATION_PLATFORM() // Position - 0x8CB3
{
	return MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION();
}

BOOL IS_XBOX_PLATFORM() // Position - 0x8CC9
{
	return MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION();
}

void func_112(char* sParam0, Any anParam1, int iParam2) // Position - 0x8CDF
{
...
BOOL func_212(Ped pedParam0, Ped pedParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xDF28
{
	...
	flag = func_213(&iLocal_37[num], pedBoneCoords, pedParam1, &(iLocal_37[num].f_3), pedParam0, iParam5);
...
BOOL func_213(var uParam0, Vector3 vParam1, var uParam2, var uParam3, Ped pedParam4, var uParam5, Ped pedParam6, int iParam7) // Position - 0xDFE9
{
	...
	if (*uParam0 == 0)
	{
		endCoords = Vector3(func_214(pedParam4, iParam7));
...
BOOL func_216(Ped pedParam0, Ped pedParam1, int iParam2, int iParam3) // Position - 0xE224
{
	...
	unk = Vector3(func_218(ENTITY::GET_ENTITY_COORDS(pedParam1, true) - ENTITY::GET_ENTITY_COORDS(pedParam0, true)));
	...
	if (iParam3 == 0)
		...
		entityForwardVector = Vector3(func_218(PED::GET_PED_BONE_COORDS(pedParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(pedParam0, 31086, 0f, 0f, 0f)));
...
BOOL func_225(Ped pedParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0xE633
{
	...
	unk = Vector3(func_218(uParam1 - ENTITY::GET_ENTITY_COORDS(pedParam0, true)));
...
{
	uParam0->f_16 = 5;
	uParam0->f_17[0] = Vector3(1973.3237f, 3815.594f, 31.42936f);
	uParam0->f_17[1] = Vector3(1974.9358f, 3812.7473f, 34.438004f);
	uParam0->f_24 = 6.5f;
	uParam0->f_27 = 0;
