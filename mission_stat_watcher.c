			...
			if (Global_63478 || bLocal_636)
			{
				...
				if (!(bLocal_635 == Global_63479))
				{
					...
					if (Global_63488)
					{
						...
						value = 2;
						func_97(&uLocal_43, "HISHPA", &Global_63500, 0);
					
						if (num == 69 || num == 70)
							func_96(&uLocal_43, 3, "ACTATAKE_AG", "", G_MissionStats.f_1.f_126[Global_63489], 0, 0, 0);
						else
							func_96(&uLocal_43, 3, "POTATAKE", "", G_MissionStats.f_1.f_126[Global_63489], 0, 0, 0);
					
						j = 0;
					
						for (j = 0; j < Global_97043[Global_63489].f_37; j = j + 1)
						{
							if (Global_97043[Global_63489].f_31[j] > 0)
								func_96(&uLocal_43, 3, AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM_0(Global_97043[Global_63489].f_25[j]), "", -1 * Global_97043[Global_63489].f_31[j], 0, 0, 0);
						}
					
						if (G_MissionStats.f_1.f_126[Global_63489].f_2[0] > 0 || num == 74 || num == 75 || num == 69 || num == 70)
							func_96(&uLocal_43, 3, "ACTATAKE_M", "", G_MissionStats.f_1.f_126[Global_63489].f_2[0], 0, 0, 0);
					
						if (G_MissionStats.f_1.f_126[Global_63489].f_2[1] > 0 || num == 74 || num == 75)
							func_96(&uLocal_43, 3, "ACTATAKE_F", "", G_MissionStats.f_1.f_126[Global_63489].f_2[1], 0, 0, 0);
					
						if (G_MissionStats.f_1.f_126[Global_63489].f_2[2] > 0 || num == 74 || num == 75)
							func_96(&uLocal_43, 3, "ACTATAKE_T", "", G_MissionStats.f_1.f_126[Global_63489].f_2[2], 0, 0, 0);
					
						if (Global_97033.f_7 > 0)
							func_96(&uLocal_43, 3, "ACTATAKE_L", "", Global_97033.f_7, 0, 0, 0);
					
						num2 = func_93(func_94(Global_63489));
						num3 = 0;
						value2 = 0;
					
						for (j = 0; j < Global_96842[num2]; j = j + 1)
						{
							if (!func_92(G_MissionStats.f_1.f_12[num2][j]))
								num3 = num3 + G_MissionStats.f_1.f_126[Global_63489].f_17[j];
							else
								value2 = value2 + G_MissionStats.f_1.f_126[Global_63489].f_17[j];
						}
					...
					{
						func_97(&uLocal_43, "MISHPA", &Global_63500, 0);
					}
...
char* func_34(int iParam0, BOOL bParam1) // Position - 0x266B
{
	...
	if (!MISC::IS_STRING_NULL_OR_EMPTY(&Global_23390.f_7488[iParam0]))
	{
		...
		{
			return func_35(&Global_23390.f_7488[iParam0]);
		}
	}
...
char* func_37(int iParam0) // Position - 0x2BB4
{
	...
	if (!MISC::IS_STRING_NULL_OR_EMPTY(&Global_23390.f_6463[iParam0]))
	{
		...
		{
			return func_35(&Global_23390.f_6463[iParam0]);
		}
	}
...
void func_38(var uParam0, int iParam1, float fParam2, float fParam3, float fParam4, int iParam5) // Position - 0x2C29
{
	...
	HUD::SET_TEXT_COLOUR(r, g, b, iParam5);
	func_39(uParam0->f_489[iParam1], uParam0->f_503[iParam1], fParam4, fParam2, &uParam0->f_280[iParam1], uParam0->f_57[iParam1]);
	return;
}
...
BOOL func_62() // Position - 0x36C1
{
	...
	{
		if (Global_75581[i] > 0)
			if (Global_63710[Global_75581[i]].f_7 == false)
				return 1;
	}
...
void func_65() // Position - 0x3791
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (_GET_CHARACTER_MODEL(G_MissionStats.f_2366.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_54(character) && !func_66(14) || Global_112760)
			{
				if (G_MissionStats.f_2366.f_539.f_4321 != character && func_54(G_MissionStats.f_2366.f_539.f_4321))
...
void func_71() // Position - 0x3C86
{
	...
	{
		num3 = Global_75581[i];
		flag = !Global_63710[num3].f_7;
		flag2 = Global_63710[num3].f_8;
		unk = Global_63710[num3].f_12;
		unk2 = Global_63710[num3].f_9;
		flag3 = false;
		flag3 = false;
	
		if (func_76(num3, Global_75581[i].f_1))
			flag3 = true;
	...
	{
		if (Global_75730 == false)
		{
			num6 = Global_75731;
		
			if (num6 == 90)
			{
				if (G_MissionStats.f_9088.f_99.f_205[func_75(0)] == 2)
				{
					num7.f_2.f_1 = 4;
					num7 = 716;
			...
			G_MissionStats.f_9088.f_330[num6].f_4 = Global_75726;
		}
		else
		{
...
int func_74(int iParam0) // Position - 0xB8EA
{
	...
	switch (iParam0)
	{
		...
		case 676:
			for (i = 0; i < 5; i = i + 1)
			{
				if (G_MissionStats.f_1.f_126[Global_63489].f_11[i] == 1)
					num = num + G_MissionStats.f_1.f_126[Global_63489].f_17[i];
			}
...
BOOL func_76(int iParam0, int iParam1) // Position - 0xB9D9
{
	...
	if (iParam0 == 881 || iParam0 == 889 || iParam0 == 897 && G_MissionStats.f_24907[4] == _GET_CURRENT_PLAYER_CHARACTER())
		Global_63710[iParam0].f_2 = 0;

	if (Global_63710[iParam0].f_3)
		if (iParam1 < Global_63710[iParam0].f_2)
			return true;
	else if (iParam1 >= Global_63710[iParam0].f_2)
		return true;
...
void func_78(float fParam0, BOOL bParam1) // Position - 0xBC16
{
	...
	if (Global_75730)
	{
		...
		if (num < 100f)
			if (fParam0 >= 100f)
				G_MissionStats.f_10019.f_22 = G_MissionStats.f_10019.f_22 + 1;
...
{
	if (bParam2)
		G_MissionStats.f_9088.f_330[iParam0].f_5 = 50f;
	else
		G_MissionStats.f_9088.f_330[iParam0].f_5 = fParam1;
...
{
	return G_MissionStats.f_9088.f_330[iParam0].f_5;
}

void func_81(int iParam0, float fParam1, BOOL bParam2) // Position - 0xBD1A
{
	if (bParam2)
		G_MissionStats.f_18577[iParam0].f_5 = 50f;
	else
		G_MissionStats.f_18577[iParam0].f_5 = fParam1;
...
{
	return G_MissionStats.f_18577[iParam0].f_5;
}
...
BOOL func_88(var uParam0, int iParam1) // Position - 0xBF5B
{
	...
	num3 = { Global_63710[Global_75581[iParam1]] };

	if (num3 == 15)
		Global_75581[iParam1].f_1 = iLocal_633;

	if (num3 == 9)
		Global_75581[iParam1].f_2 = fLocal_632;

	if (num3 == 14)
		Global_75581[iParam1].f_1 = SYSTEM::FLOOR(Global_75581[iParam1].f_2);

	if (func_76(Global_75581[iParam1], Global_75581[iParam1].f_1))
		num = 1f;

	if (Global_75581[iParam1].f_3 != 0)
		num = 0f;

	if (!(num3.f_2 == 0))
	{
		num2 = SYSTEM::TO_FLOAT(SYSTEM::FLOOR((SYSTEM::TO_FLOAT(Global_75581[iParam1].f_1) / SYSTEM::TO_FLOAT(num3.f_2)) * 100f));
	...
	if (Global_75581[iParam1].f_3 == 0 || flag)
		if (num3.f_3)
			if (num4 > Global_75581[iParam1].f_1 || num4 < 0 || num4 == -1)
				func_90(Global_75581[iParam1].f_1, Global_75581[iParam1]);
		else if (Global_75581[iParam1].f_1 > num4 || num4 < 0 || num4 == -1)
			func_90(Global_75581[iParam1].f_1, Global_75581[iParam1]);

	num5 = Global_75581[iParam1].f_1;
	...
	str = AUDIO_SPEECH_GET_PARAM_STRING_FROM_ENUM(Global_75581[iParam1]);

	if (Global_75581[iParam1].f_3 != 0)
	{
		if (!_IS_MISSION_REPEAT_ACTIVE(false))
			func_90(-1, Global_75581[iParam1]);
	
		str2 = "MTPHPERRET" /*Checkpoint*/;
	
		switch (Global_75581[iParam1].f_3)
		{
			case 4:
		...
		if (iLocal_630 == Global_75581[iParam1].f_3)
			str2 = "";
	
		iLocal_630 = Global_75581[iParam1].f_3;
		func_96(uParam0, 6, str, str2, Global_75581[iParam1].f_1, 0, 3, 0);
	}
	else
	{
		iLocal_630 = 0;
		...
		{
			case 1:
				func_96(uParam0, 8, str, "", Global_75581[iParam1].f_1, 0, num6, 0);
				break;
		
			case 2:
				func_96(uParam0, 9, str, "", Global_75581[iParam1].f_1, 0, num6, 0);
				break;
		
			case 3:
				func_96(uParam0, 0, str, "", Global_75581[iParam1].f_1, 0, num6, 0);
				break;
			...
			case 5:
				func_96(uParam0, 11, str, "", SYSTEM::CEIL((SYSTEM::TO_FLOAT(Global_75581[iParam1].f_1) / SYSTEM::TO_FLOAT(num3.f_2)) * 100f), 0, num6, 0);
				break;
			...
			case 9:
				func_96(uParam0, 11, str, "", SYSTEM::ROUND(Global_75581[iParam1].f_2), 0, num6, 0);
				break;
		
			case 10:
			case 15:
			case 16:
				func_96(uParam0, 1, str, "", Global_75581[iParam1].f_1, 0, num6, 0);
				break;
		
			case 11:
				func_96(uParam0, 11, str, "", Global_75581[iParam1].f_1, 0, num6, 0);
				break;
		
			case 14:
				func_96(uParam0, 12, str, "", Global_75581[iParam1].f_1, 0, num6, 0);
				break;
		
			case 12:
			case 13:
				func_96(uParam0, 3, str, "", Global_75581[iParam1].f_1, 0, num6, 0);
				break;
...
void func_90(int iParam0, int iParam1) // Position - 0xD60D
{
	...
	statName = Global_63710[iParam1].f_4;

	if (statName == 0)
		return;

	Global_63710[iParam1].f_1 = iParam0;
	value = iParam0 + 1;
	STATS::STAT_SET_INT(statName, value, true);

	if (_IS_MISSION_REPEAT_ACTIVE(false) && Global_63477)
	{
...
void func_98(int iParam0) // Position - 0xD824
{
	...
	{
		case 4:
			G_MissionStats.f_1.f_126[iParam0].f_1 = 201600000;
			G_MissionStats.f_1.f_126[iParam0] = 201600000;
			break;
	
		case 3:
			G_MissionStats.f_1.f_126[iParam0].f_1 = 331985;
			G_MissionStats.f_1.f_126[iParam0] = 331985;
			break;
	
		case 1:
			G_MissionStats.f_1.f_126[iParam0] = 20000000;
			G_MissionStats.f_1.f_126[iParam0].f_1 = 20000000;
			break;
	}

	num = func_93(func_75(iParam0));
	num2 = G_MissionStats.f_1.f_126[iParam0].f_1;
	...
	for (i = 0; i < 5; i = i + 1)
	{
		G_MissionStats.f_1.f_126[iParam0].f_17[i] = 0;
	}

	i = 0;
	num3 = 0;

	for (i = 0; i < Global_97043[iParam0].f_37; i = i + 1)
	{
		if (Global_97043[iParam0].f_31[i] > 0)
		{
			num3 = num3 + Global_97043[iParam0].f_31[i];
			G_MissionStats.f_1.f_126[iParam0].f_1 = G_MissionStats.f_1.f_126[iParam0].f_1 - Global_97043[iParam0].f_31[i];
		}
	}
	...
	if (iParam0 == 2)
	{
		num4 = SYSTEM::FLOOR(SYSTEM::TO_FLOAT(G_MissionStats.f_1.f_126[iParam0].f_1) * 0.78f);
		func_100(iParam0, 3, num4);
		G_MissionStats.f_1.f_126[iParam0].f_1 = G_MissionStats.f_1.f_126[iParam0].f_1 - num4;
		num2 = num2 - num4;
	}

	for (i = 0; i < 5; i = i + 1)
	{
		num5 = G_MissionStats.f_1.f_12[num][i];
	
		switch (G_MissionStats.f_1.f_126[iParam0].f_11[i])
		{
			case 1:
			case 2:
			case 0:
				G_MissionStats.f_1.f_126[iParam0].f_17[i] = SYSTEM::CEIL(SYSTEM::TO_FLOAT(Global_96688[num5].f_1) * 0.01f * (float)G_MissionStats.f_1.f_126[iParam0].f_1);
				break;
		
			case 3:
				G_MissionStats.f_1.f_126[iParam0].f_17[i] = SYSTEM::CEIL(SYSTEM::TO_FLOAT(Global_96688[num5].f_1) * 0.015f * (float)G_MissionStats.f_1.f_126[iParam0].f_1);
				break;
		}
	}
	...
	{
		num2 = num2 - G_MissionStats.f_1.f_126[iParam0].f_17[i];
	}

	G_MissionStats.f_1.f_126[0].f_2[0] = 0;
	G_MissionStats.f_1.f_126[0].f_2[1] = 0;
	G_MissionStats.f_1.f_126[0].f_2[2] = 0;
	Global_97033.f_7 = 0;

	switch (iParam0)
	{
		case 0:
			G_MissionStats.f_1.f_126[0].f_6[0] = 0f;
			G_MissionStats.f_1.f_126[0].f_6[1] = 0f;
			G_MissionStats.f_1.f_126[0].f_6[2] = -1f;
			G_MissionStats.f_1.f_126[0].f_2[1] = SYSTEM::CEIL(0.12f * (float)G_MissionStats.f_1.f_126[iParam0].f_1);
			num2 = num2 - G_MissionStats.f_1.f_126[0].f_2[1];
			Global_97033.f_7 = SYSTEM::CEIL(0.14f * (float)G_MissionStats.f_1.f_126[iParam0].f_1);
			num2 = num2 - Global_97033.f_7;
			Global_97033.f_6 = 14f;
			G_MissionStats.f_1.f_126[0].f_2[0] = num2;
			break;
	
		case 1:
			G_MissionStats.f_1.f_126[1].f_6[0] = 0f;
			G_MissionStats.f_1.f_126[1].f_6[1] = 0f;
			G_MissionStats.f_1.f_126[1].f_6[2] = 0f;
			G_MissionStats.f_1.f_126[1].f_2[0] = 0;
			G_MissionStats.f_1.f_126[1].f_2[1] = 0;
			G_MissionStats.f_1.f_126[1].f_2[2] = 0;
			Global_97033.f_6 = -1f;
			break;
	
		case 2:
			G_MissionStats.f_1.f_126[2].f_6[0] = 0f;
			G_MissionStats.f_1.f_126[2].f_6[1] = 0f;
			G_MissionStats.f_1.f_126[2].f_6[2] = 0f;
			Global_97033.f_7 = SYSTEM::CEIL(0.12f * (float)G_MissionStats.f_1.f_126[iParam0].f_1);
			num2 = num2 - Global_97033.f_7;
			Global_97033.f_6 = 12f;
			G_MissionStats.f_1.f_126[2].f_2[0] = num2 / 3;
			G_MissionStats.f_1.f_126[2].f_2[1] = num2 / 3;
			G_MissionStats.f_1.f_126[2].f_2[2] = num2 / 3;
			Global_97033.f_6 = 0f;
			break;
	
		case 3:
			G_MissionStats.f_1.f_126[3].f_6[0] = -1f;
			G_MissionStats.f_1.f_126[3].f_6[1] = 0f;
			G_MissionStats.f_1.f_126[3].f_6[2] = 0f;
			Global_97033.f_7 = SYSTEM::CEIL(0.12f * (float)G_MissionStats.f_1.f_126[iParam0].f_1);
			num2 = num2 - Global_97033.f_7;
			Global_97033.f_6 = 12f;
			G_MissionStats.f_1.f_126[3].f_2[1] = num2;
			break;
	
		case 4:
			G_MissionStats.f_1.f_126[4].f_6[0] = 0f;
			G_MissionStats.f_1.f_126[4].f_6[1] = 0f;
			G_MissionStats.f_1.f_126[4].f_6[2] = 0f;
			Global_97033.f_7 = SYSTEM::CEIL(0.12f * (float)G_MissionStats.f_1.f_126[iParam0].f_1);
			num2 = num2 - Global_97033.f_7;
			Global_97033.f_6 = 12f;
			G_MissionStats.f_1.f_126[4].f_2[0] = num2 / 3;
			G_MissionStats.f_1.f_126[4].f_2[1] = num2 / 3;
			G_MissionStats.f_1.f_126[4].f_2[2] = num2 / 3;
			Global_97033.f_6 = 0f;
			break;
	}

	value = G_MissionStats.f_1.f_126[iParam0].f_1;

	if (G_MissionStats.f_1.f_126[iParam0].f_6[0] != -1f)
		G_MissionStats.f_1.f_126[iParam0].f_6[0] = (SYSTEM::TO_FLOAT(G_MissionStats.f_1.f_126[iParam0].f_2[0]) / SYSTEM::TO_FLOAT(value)) * 100f;

	if (G_MissionStats.f_1.f_126[iParam0].f_6[1] != -1f)
		G_MissionStats.f_1.f_126[iParam0].f_6[1] = (SYSTEM::TO_FLOAT(G_MissionStats.f_1.f_126[iParam0].f_2[1]) / SYSTEM::TO_FLOAT(value)) * 100f;

	if (G_MissionStats.f_1.f_126[iParam0].f_6[2] != -1f)
		G_MissionStats.f_1.f_126[iParam0].f_6[2] = (SYSTEM::TO_FLOAT(G_MissionStats.f_1.f_126[iParam0].f_2[2]) / SYSTEM::TO_FLOAT(value)) * 100f;

	if (Global_97033.f_6 != -1f)
		Global_97033.f_6 = (SYSTEM::TO_FLOAT(Global_97033.f_7) / SYSTEM::TO_FLOAT(value)) * 100f;

	switch (iParam0)
	{
		case 0:
			STATS::STAT_SET_INT(joaat("JEWEL_HEIST_RAW_TAKE"), G_MissionStats.f_1.f_126[iParam0], true);
			break;
	}
	...
	for (j = 0; j < 3; j = j + 1)
	{
		num6 = num6 + G_MissionStats.f_1.f_126[iParam0].f_2[j];
	}

	switch (iParam0)
	{
		case 0:
			func_99(810, G_MissionStats.f_1.f_126[iParam0].f_1, true);
		...
		case 1:
			...
			{
				case 3:
					func_99(610, G_MissionStats.f_1.f_126[iParam0].f_1, true);
					func_99(611, num6, true);
					break;
			
				case 4:
					func_99(622, G_MissionStats.f_1.f_126[iParam0].f_1, true);
		...
		case 2:
			func_99(734, G_MissionStats.f_1.f_126[iParam0].f_1, true);
		...
		case 4:
			...
			{
				case 8:
					func_99(664, G_MissionStats.f_1.f_126[iParam0].f_1, true);
					func_99(671, num6, true);
					break;
			
				case 9:
					func_99(674, G_MissionStats.f_1.f_126[iParam0].f_1, true);
...
void func_100(int iParam0, int iParam1, int iParam2) // Position - 0xE1CF
{
	...
	if (Global_97043[iParam0].f_37 == 5)
		flag = true;

	num2 = Global_97043[iParam0].f_37;
	i = 0;

	for (i = 0; i < num2; i = i + 1)
	{
		if (Global_97043[iParam0].f_25[i] == iParam1)
		{
			Global_97043[iParam0].f_25[i] = iParam1;
			Global_97043[iParam0].f_31[i] = num;
			return;
		}
	}
	...
	Global_97043[iParam0].f_25[Global_97043[iParam0].f_37] = iParam1;
	Global_97043[iParam0].f_31[Global_97043[iParam0].f_37] = num;
	Global_97043[iParam0].f_37 = Global_97043[iParam0].f_37 + 1;
	return;
}
...
void func_102() // Position - 0xE3AF
{
	...
	{
		if (Global_75581[i].f_1 == 0)
			if (Global_75581[i].f_2 != 0f)
				Global_75581[i].f_1 = SYSTEM::FLOOR(Global_75581[i].f_2);
	
		num = Global_75581[i];
	
		if (num > 0)
		{
			if (Global_63710[num] == 9)
				Global_75581[i].f_1 = SYSTEM::ROUND(fLocal_632);
		
			if (Global_63710[num] == 15)
				Global_75581[i].f_1 = iLocal_633;
		}
	}
...
void func_103() // Position - 0xE456
{
	...
	value = 0;
	value2 = 0;
	value = func_7(joaat("SP0_SHOTS")) - Global_63508;
	value2 = func_7(joaat("SP0_HITS")) - Global_63507;
	value = value + (func_7(joaat("SP1_SHOTS")) - Global_63510);
	value2 = value2 + (func_7(joaat("SP1_HITS")) - Global_63509);
	value = value + (func_7(joaat("SP2_SHOTS")) - Global_63512);
	value2 = value2 + (func_7(joaat("SP2_HITS")) - Global_63511);
	SYSTEM::WAIT(0);
	num = 100f;
...
void func_107() // Position - 0xE5B1
{
	...
	for (i = 0; i < Global_75580; i = i + 1)
	{
		if (Global_75581[i] >= 0)
		{
			num = Global_63710[Global_75581[i]];
		
			switch (num)
			{
				case 6:
					if (Global_75581[i].f_6 != 0)
					{
						if (Global_75581[i].f_7 == 1)
						{
							Global_75581[i].f_8 = 0;
							Global_75581[i].f_1 = 0;
							Global_75581[i].f_7 = 0;
						}
						else if (ENTITY::DOES_ENTITY_EXIST(Global_75581[i].f_6))
						{
							if (!ENTITY::IS_ENTITY_DEAD(Global_75581[i].f_6, false))
							{
								iLocal_628 = Global_75581[i].f_8;
								iLocal_627 = ENTITY::GET_ENTITY_HEALTH(Global_75581[i].f_6);
								iLocal_629 = iLocal_628 - iLocal_627;
							
								if (iLocal_629 > 0)
								{
									Global_75581[i].f_1 = Global_75581[i].f_1 + iLocal_629;
								
									if (Global_75581[i].f_1 < 0)
										Global_75581[i].f_1 = Global_75581[i].f_1 * -1;
								}
							
								Global_75581[i].f_8 = iLocal_627;
							}
						}
						else
						{
							Global_75581[i].f_6 = 0;
						}
					}
					break;
			
				case 1:
					Global_75581[i].f_1 = Global_75581[i].f_1 + iLocal_624;
					break;
				...
				case 4:
					if (Global_63493)
						if (Global_63495 == -1 || Global_75581[i] == Global_63495)
							if (Global_75581[i] == 339 || Global_75581[i] == 179 || Global_75581[i] == 342 || Global_75581[i] == 234)
								Global_75581[i].f_1 = Global_75581[i].f_1 + SYSTEM::ROUND(MISC::GET_FRAME_TIME() * 1000f);
							else
								Global_75581[i].f_1 = Global_75581[i].f_1 + iLocal_624;
					break;
				...
				case 5:
					if (flag2)
					{
						if (Global_63497 == -1 || Global_63497 == Global_75581[i])
						{
							if (!(Global_63496 == 0))
							{
								if (ENTITY::DOES_ENTITY_EXIST(Global_63496))
								{
									if (!ENTITY::IS_ENTITY_DEAD(Global_63496, false))
									{
										...
										{
											entitySpeed = ENTITY::GET_ENTITY_SPEED(Global_63496);
										
											if (entitySpeed > Global_75581[i].f_2)
												Global_75581[i].f_2 = entitySpeed;
										}
									}
								}
							}
...
void func_108() // Position - 0xE98C
{
	...
	if (Global_63514 > 0)
	{
		...
		for (i = 0; i < 64; i = i + 1)
		{
			if (Global_63515[i] != 0)
			{
				if (!ENTITY::DOES_ENTITY_EXIST(Global_63515[i]))
				{
					Global_63515[i] = 0;
			...
			case EVENT_ENTITY_DESTROYED:
				...
				if (ENTITY::DOES_ENTITY_EXIST(eventData))
				{
					...
					if (Global_63644 > 0)
					{
						...
						for (j = 0; j < Global_63644; j = j + 1)
						{
							if (Global_63645[j] == entityModel)
								num2 = num2 + Global_63645[j].f_1;
						}
					}
						...
						if (ENTITY::IS_ENTITY_A_PED(pedSourceOfDeath) && PLAYER::GET_PLAYER_PED(PLAYER::GET_PLAYER_INDEX()) == ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(pedSourceOfDeath) || flag2)
						{
							if (ENTITY::IS_ENTITY_A_PED(pedSourceOfDeath))
							{
								...
								if (Global_63514 > 0)
								{
									...
									if (num3 != -1)
									{
										PED::GET_PED_LAST_DAMAGE_BONE(ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(Global_63515[num3]), &iLocal_631);
								...
								if (Global_75776 > 0)
								{
									...
									for (j = 0; j < Global_75776; j = j + 1)
									{
										if (Global_75767[j] == pedCauseOfDeath)
											func_99(Global_75767[j].f_1, 1, false);
									}
								}
							}
							...
							if (Global_75766 > 0)
							{
								...
								while (!flag)
								{
									if (Global_75733[j] != 0)
									{
										if (ENTITY::DOES_ENTITY_EXIST(Global_75733[j]))
										{
											if (ENTITY::IS_ENTITY_DEAD(Global_75733[j], false))
											{
												if (Global_75733[j] == eventData)
												{
													func_99(Global_75733[j].f_1, 1, false);
													Global_75733[j] = 0;
												}
											}
										}
								...
								if (Global_75766 > 0)
								{
									while (Global_75733[Global_75766 - 1] == 0 && Global_75766 > 1)
									{
										if (Global_75766 > 1)
		...
		if (MISC::GET_REPLAY_STAT_MISSION_ID() == 33)
		{
			if (MISC::GET_REPLAY_STAT_MISSION_TYPE() == 33)
			{
				...
				if ((replayStatCount - 4) % 3 == 0)
				{
					...
					Global_75730 = flag2;
					Global_75731 = replayStatAtIndex3;
		...
		if (MISC::GET_REPLAY_STAT_MISSION_ID() == 13)
		{
			if (MISC::GET_REPLAY_STAT_MISSION_TYPE() == 37)
			{
				...
				if (replayStatCount2 == 3)
				{
					...
					G_MissionStats.f_2355[replayStatAtIndex5] = replayStatAtIndex6;
					G_MissionStats.f_2355[replayStatAtIndex5].f_1 = replayStatAtIndex7;
					func_114();
				}
			}
		}
