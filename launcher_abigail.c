	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (num != -1)
		{
			if (Global_112897[num].f_9 != -1)
			{
				...
				func_302(&(Global_112897[num].f_9));
			}
		}
...
BOOL func_263(var uParam0) // Position - 0xFC2D
{
	...
	switch (iLocal_89)
	{
		case 0:
			uParam0->f_16 = 5;
			uParam0->f_17[0] = { -1588.6636f, 5210.4404f, 2.488135f };
			uParam0->f_17[1] = { -1596.9752f, 5228.6836f, 5.966843f };
			uParam0->f_24 = 8f;
			uParam0->f_27 = 0;
			uParam0->f_25 = 1;
...
BOOL func_271(var uParam0) // Position - 0x1005B
{
	...
	switch (iLocal_89)
	{
		case 0:
			uParam0->f_16 = 5;
			uParam0->f_17[0] = { -1598.5696f, 5231.605f, 1.969029f };
			uParam0->f_17[1] = { -1610.4132f, 5257.687f, 5.965584f };
			uParam0->f_24 = 8f;
			uParam0->f_27 = 0;
			uParam0->f_25 = 1;
