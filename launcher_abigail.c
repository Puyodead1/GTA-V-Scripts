...
void main() // Position - 0x0
{
	...
	uLocal_92 = Vector3(-1593.813f, 5221.2354f, 1.94482f);
	uLocal_95 = Vector3(-1603.9861f, 5243.6235f, 4.940323f);
	...
	num2.f_1 = 16;
	func_299(&num);
	vector = Vector3(uScriptParam_102.f_1[0]);
	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (num != -1)
		{
			if (Global_112735[num].f_9 != -1)
			{
				...
				func_297(&(Global_112735[num].f_9));
			}
		}
...
BOOL func_258(var uParam0) // Position - 0xFB3E
{
	...
	switch (iLocal_91)
	{
		case 0:
			uParam0->f_16 = 5;
			uParam0->f_17[0] = Vector3(-1588.6636f, 5210.4404f, 2.488135f);
			uParam0->f_17[1] = Vector3(-1596.9752f, 5228.6836f, 5.966843f);
			uParam0->f_24 = 8f;
			uParam0->f_27 = 0;
			uParam0->f_25 = 1;
...
BOOL func_266(var uParam0) // Position - 0xFF6B
{
	...
	switch (iLocal_91)
	{
		case 0:
			uParam0->f_16 = 5;
			uParam0->f_17[0] = Vector3(-1598.5696f, 5231.605f, 1.969029f);
			uParam0->f_17[1] = Vector3(-1610.4132f, 5257.687f, 5.965584f);
			uParam0->f_24 = 8f;
			uParam0->f_27 = 0;
			uParam0->f_25 = 1;
