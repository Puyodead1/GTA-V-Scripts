...
void main() // Position - 0x0
{
	...
	fLocal_25 = -0.0375f;
	fLocal_26 = 0.17f;
	fLocal_116 = Vector3(27.7189f, -608.7927f, 30.6293f);
	uLocal_132 = Vector3(903.1f, -1548.8f, 29.8f);
	fLocal_135 = 0f;
...
BOOL IS_PLAYSTATION_PLATFORM() // Position - 0x648A
{
	return MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION();
}

BOOL IS_XBOX_PLATFORM() // Position - 0x64A0
{
...
BOOL func_73(var uParam0, int iParam1) // Position - 0x6CA2
{
	...
	*uParam0 = Vector3(0f, 0f, 0f);
	...
	if (IS_BIT_SET(uParam0->f_9, 10))
	{
		...
		if (!func_112(Global_113648.f_32751.f_1864[uParam0->f_14], 0f, 0f, 0f, false))
	...
	{
		if (!func_112(Global_113648.f_2365.f_539.f_3588[1][uParam0->f_12], 0f, 0f, 0f, false))
		{
	...
	{
		if (!func_112(Global_113648.f_2365.f_539.f_3588[0][uParam0->f_12], 0f, 0f, 0f, false))
		{
...
Blip func_133(Vector3 vParam0, var uParam1, var uParam2, BOOL bParam3) // Position - 0xB38B
{
	Blip blip;
...
void func_202() // Position - 0xF52B
{
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			fLocal_119 = Vector3(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true));

	if (ENTITY::DOES_ENTITY_EXIST(uLocal_43[0]))
		if (!PED::IS_PED_INJURED(uLocal_43[0]))
			uLocal_125[0] = Vector3(ENTITY::GET_ENTITY_COORDS(uLocal_43[0], true));

	if (ENTITY::DOES_ENTITY_EXIST(uLocal_43[1]))
		if (!PED::IS_PED_INJURED(uLocal_43[1]))
			uLocal_125[1] = Vector3(ENTITY::GET_ENTITY_COORDS(uLocal_43[1], true));
			...
			if (uLocal_404[0] == 1)
			{
				if (uLocal_404[1] == 1)
				{
					if (func_189(PLAYER::PLAYER_PED_ID(), uLocal_43[0], true) < func_189(PLAYER::PLAYER_PED_ID(), uLocal_43[1], true))
					{
						...
						else if (fLocal_119 < uLocal_125[0])
						{
							iLocal_31 = 0;
							uLocal_459[0] = 0;
							uLocal_462[0] = 0;
					...
					{
						if (fLocal_119 > uLocal_125[1] && !PED::IS_PED_FACING_PED(PLAYER::PLAYER_PED_ID(), uLocal_43[1], 90f) && !ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 936.7849f, -1569.3374f, 31.496609f, 936.3553f, -1581.9734f, 27.778118f, 8.25f, false, true, 0))
						{
							iLocal_31 = 0;
							uLocal_459[0] = 0;
							uLocal_462[0] = 0;
					...
					else if (fLocal_119 > uLocal_125[1])
					{
						iLocal_31 = 0;
						uLocal_459[0] = 0;
						uLocal_462[0] = 0;
				...
				else if (func_189(PLAYER::PLAYER_PED_ID(), uLocal_43[0], true) < func_189(PLAYER::PLAYER_PED_ID(), uLocal_43[1], true))
				{
					if (func_189(PLAYER::PLAYER_PED_ID(), uLocal_43[0], true) < 15f)
					{
						if (fLocal_119 < uLocal_125[0] && !PED::IS_PED_FACING_PED(PLAYER::PLAYER_PED_ID(), uLocal_43[0], 90f) && !ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 868.5617f, -1579.4764f, 33.304478f, 866.56354f, -1560.9844f, 28.904823f, 8.25f, false, true, 0))
						{
							iLocal_31 = 0;
							uLocal_459[0] = 0;
							uLocal_462[0] = 0;
		...
		if (iLocal_31 != 2)
		{
				...
				if (func_189(PLAYER::PLAYER_PED_ID(), uLocal_43[0], true) < 20f)
				{
					if (func_201(PLAYER::PLAYER_PED_ID()) == joaat("WEAPON_UNARMED") || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false) || func_200(0))
					{
						if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 860.4606f, -1563.5804f, 28.817883f, 865.0807f, -1575.0884f, 30.933239f, 5.75f, false, true, 0))
							if (fLocal_119 > uLocal_125[0] || PED::IS_PED_FACING_PED(PLAYER::PLAYER_PED_ID(), uLocal_43[0], 90f))
								iLocal_31 = 1;
			...
			if (uLocal_404[1] == 1)
				if (func_189(PLAYER::PLAYER_PED_ID(), uLocal_43[1], true) < 15f)
					if (func_201(PLAYER::PLAYER_PED_ID()) == joaat("WEAPON_UNARMED") || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false) || func_200(0))
						if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 939.88617f, -1575.6354f, 28.597832f, 952.9254f, -1575.4835f, 33.194588f, 13.75f, false, true, 0))
							if (fLocal_119 < uLocal_125[1] || PED::IS_PED_FACING_PED(PLAYER::PLAYER_PED_ID(), uLocal_43[1], 90f))
								iLocal_31 = 1;
		}
	}
	...
	if (iLocal_31 != 2)
	{
		...
		if (uLocal_404[0] == 1)
			if (func_189(PLAYER::PLAYER_PED_ID(), uLocal_43[0], true) < 20f)
				if (fLocal_119 > uLocal_125[0] && ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 868.5617f, -1579.4764f, 33.304478f, 866.56354f, -1560.9844f, 28.904823f, 8.25f, false, true, 0))
					if (PED::CAN_PED_SEE_HATED_PED(uLocal_43[0], PLAYER::PLAYER_PED_ID()) || PLAYER::CAN_PED_HEAR_PLAYER(PLAYER::PLAYER_ID(), uLocal_43[0]))
						iLocal_31 = 2;
	
		if (uLocal_404[1] == 1)
			if (func_189(PLAYER::PLAYER_PED_ID(), uLocal_43[1], true) < 20f)
				if (fLocal_119 < uLocal_125[1] && ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 936.7849f, -1569.3374f, 31.496609f, 936.3553f, -1581.9734f, 27.778118f, 8.25f, false, true, 0))
		...
		if (!PED::IS_PED_INJURED(pedLocal_46))
		{
			...
			else
			{
				...
				if (iLocal_470 == 1)
				{
					...
					{
						fLocal_122 = Vector3(ENTITY::GET_ENTITY_COORDS(pedLocal_46, true));
		...
		if (!PED::IS_PED_INJURED(pedLocal_48))
		{
			...
			else
			{
				...
				if (iLocal_471 == 1)
				{
					...
					{
						fLocal_122 = Vector3(ENTITY::GET_ENTITY_COORDS(pedLocal_48, true));
						PATHFIND::REQUEST_PATH_NODES_IN_AREA_THIS_FRAME(fLocal_122, fLocal_122.f_1, fLocal_116, fLocal_116.f_1);
		...
		if (!PED::IS_PED_INJURED(pedLocal_47))
		{
			...
			else
			{
				...
				if (iLocal_472 == 1)
				{
					...
					{
						fLocal_122 = Vector3(ENTITY::GET_ENTITY_COORDS(pedLocal_47, true));
						PATHFIND::REQUEST_PATH_NODES_IN_AREA_THIS_FRAME(fLocal_122, fLocal_122.f_1, fLocal_116, fLocal_116.f_1);
