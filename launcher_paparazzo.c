...
void main() // Position - 0x0
{
	...
	func_289(&num);
	vector = Vector3(uScriptParam_98.f_1[0]);
	unk63 = 6;
	unk63[0] = 46;
	unk63[1] = 47;
	unk63[2] = 48;
	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (num != -1)
		{
			if (Global_112735[num].f_9 != -1)
			{
				...
				func_287(&(Global_112735[num].f_9));
			}
		}
...
BOOL IS_PLAYSTATION_PLATFORM() // Position - 0x8CF9
{
	return MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION();
}

BOOL IS_XBOX_PLATFORM() // Position - 0x8D0F
{
	return MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION();
}

void func_112(char* sParam0, Any anParam1, int iParam2) // Position - 0x8D25
{
...
BOOL func_164(int iParam0) // Position - 0xB70B
{
	...
	num = func_166(&(Global_112735[iParam0].f_9), 1, 4, false, 0);
...
BOOL func_220(Vehicle veParam0, Ped pedParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xE6F5
{
	...
	flag = func_221(&iLocal_37[num], pedBoneCoords, pedParam1, &(iLocal_37[num].f_3), veParam0, iParam5);
...
BOOL func_221(var uParam0, Vector3 vParam1, var uParam2, var uParam3, Ped pedParam4, var uParam5, Vehicle veParam6, int iParam7) // Position - 0xE7B6
{
	...
	if (*uParam0 == 0)
	{
		endCoords = Vector3(func_222(pedParam4, iParam7));
...
BOOL func_224(Vehicle veParam0, Ped pedParam1, int iParam2, int iParam3) // Position - 0xE9F1
{
	...
	unk = Vector3(func_226(ENTITY::GET_ENTITY_COORDS(pedParam1, true) - ENTITY::GET_ENTITY_COORDS(veParam0, true)));
	...
	if (iParam3 == 0)
		...
		entityForwardVector = Vector3(func_226(PED::GET_PED_BONE_COORDS(veParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(veParam0, 31086, 0f, 0f, 0f)));
...
BOOL func_233(Vehicle veParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0xEE00
{
	...
	unk = Vector3(func_226(uParam1 - ENTITY::GET_ENTITY_COORDS(veParam0, true)));
...
BOOL func_246(var uParam0) // Position - 0xF23C
{
	...
	switch (iLocal_91)
	{
		case 0:
			uParam0->f_16 = 5;
			uParam0->f_17[0] = Vector3(-476.36862f, 229.57437f, 82.07077f);
			uParam0->f_17[1] = Vector3(-513.6883f, 234.2165f, 87.28937f);
			uParam0->f_24 = 25f;
			uParam0->f_27 = 0;
			uParam0->f_26 = 1;
			uParam0->f_25 = 1;
...
{
	uParam0->f_16 = 3;
	uParam0->f_17[0] = Vector3(1040.96f, -534.42f, 60.17f);
	uParam0->f_15 = 90f;
	uParam0->f_27 = 1;
	return true;
}
...
BOOL func_257(var uParam0) // Position - 0xFAFD
{
	...
	switch (iLocal_91)
	{
		case 0:
			uParam0->f_16 = 3;
			uParam0->f_17[0] = Vector3(301.85f, 138.16f, 102.84f);
			uParam0->f_15 = 90f;
			uParam0->f_27 = 1;
...
BOOL func_259(var uParam0) // Position - 0x10129
{
	...
	switch (iLocal_91)
	{
		case 0:
			uParam0->f_16 = 5;
			uParam0->f_17[0] = Vector3(-82.641426f, 302.73065f, 104.63494f);
			uParam0->f_17[1] = Vector3(-68.78405f, 296.6317f, 107.89578f);
			uParam0->f_24 = 11f;
			uParam0->f_27 = 0;
			uParam0->f_26 = 1;
			uParam0->f_25 = 1;
...
BOOL func_260(var uParam0) // Position - 0x1046B
{
	...
	switch (iLocal_91)
	{
		case 0:
			uParam0->f_16 = 5;
			uParam0->f_17[0] = Vector3(-154.98163f, 287.04315f, 96.63823f);
			uParam0->f_17[1] = Vector3(-155.49458f, 274.40674f, 90.82359f);
			uParam0->f_24 = 15f;
			uParam0->f_27 = 0;
			uParam0->f_25 = 1;
			uParam0->f_26 = 0;
