	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (num != -1)
		{
			if (Global_112897[num].f_9 != -1)
			{
				...
				func_292(&(Global_112897[num].f_9));
			}
		}
...
BOOL func_169(int iParam0) // Position - 0xB7F4
{
	...
	num = func_171(&(Global_112897[iParam0].f_9), 1, 4, false, 0);
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					...
					case 1:
						if (PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_197() || Global_32286 || func_196() || func_195(8, -1) || func_193() || func_100() || func_194() || func_192() || G_MissionStats.f_7691.f_919[character] == 5)
							return false;
						break;
				
					case 2:
						if (!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_197() || Global_112857 || Global_32286 || func_196() || func_195(8, -1) || func_193() || func_100() || func_194() || func_192() || G_MissionStats.f_7691.f_919[character] == 5 || Global_43924 != -1)
							return false;
						break;
				
					case 3:
						if (PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_197() || Global_112857 || Global_32286 || func_196() || func_195(8, -1) || func_100() || func_194() || func_192() || G_MissionStats.f_7691.f_919[character] == 5)
							return false;
						break;
				
					case 4:
						if (func_197() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0 || func_195(8, -1) || func_192() || func_191() || G_MissionStats.f_7691.f_919[character] == 5)
							return false;
						break;
...
BOOL func_225(Vehicle veParam0, Ped pedParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xE7DE
{
	...
	flag = func_226(&iLocal_35[num], pedBoneCoords, pedParam1, &(iLocal_35[num].f_3), veParam0, iParam5);
...
{
	uParam0->f_16 = 3;
	uParam0->f_17[0] = { 1040.96f, -534.42f, 60.17f };
	uParam0->f_15 = 90f;
	uParam0->f_27 = 1;
	return true;
}
...
BOOL func_262(var uParam0) // Position - 0xFBE6
{
	...
	switch (iLocal_89)
	{
		case 0:
			uParam0->f_16 = 3;
			uParam0->f_17[0] = { 301.85f, 138.16f, 102.84f };
			uParam0->f_15 = 90f;
			uParam0->f_27 = 1;
...
BOOL func_264(var uParam0) // Position - 0x10213
{
	...
	switch (iLocal_89)
	{
		case 0:
			uParam0->f_16 = 5;
			uParam0->f_17[0] = { -82.641426f, 302.73065f, 104.63494f };
			uParam0->f_17[1] = { -68.78405f, 296.6317f, 107.89578f };
			uParam0->f_24 = 11f;
			uParam0->f_27 = 0;
			uParam0->f_26 = 1;
			uParam0->f_25 = 1;
...
BOOL func_265(var uParam0) // Position - 0x10555
{
	...
	switch (iLocal_89)
	{
		case 0:
			uParam0->f_16 = 5;
			uParam0->f_17[0] = { -154.98163f, 287.04315f, 96.63823f };
			uParam0->f_17[1] = { -155.49458f, 274.40674f, 90.82359f };
			uParam0->f_24 = 15f;
			uParam0->f_27 = 0;
			uParam0->f_25 = 1;
			uParam0->f_26 = 0;
