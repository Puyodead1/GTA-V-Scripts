...
void main() // Position - 0x0
{
	...
	uLocal_94 = { uScriptParam_343.f_1[0] };
...
BOOL func_30(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9) // Position - 0xDD4
{
	...
	else
	{
		...
		num2 = 0;
		func_36(&num2);
		num3 = func_35(unk10, G_MissionStats.f_7691.f_765[num2]);
	
		if (num3 == 2)
		{
			func_33(G_MissionStats.f_7691.f_765[num2]);
		...
		else if (num3 == 1)
		{
			...
			{
				if (!func_31(G_MissionStats.f_7691.f_765[num2]))
				{
					G_MissionStats.f_7691.f_765[num2] = { unk10 };
					func_32(&unk10);
					return true;
...
void func_36(var uParam0) // Position - 0x10A8
{
	...
	*uParam0 = 0;
	...
	{
		if (func_35(G_MissionStats.f_7691.f_765[i], G_MissionStats.f_7691.f_765[*uParam0]) == 0)
			*uParam0 = i;
	}
...
void func_41() // Position - 0x13AB
{
	...
	if (value > 0f && SYSTEM::FLOOR(value) < SYSTEM::FLOOR(G_MissionStats.f_10197.f_3853))
		func_43(13, SYSTEM::FLOOR(G_MissionStats.f_10197.f_3853));
...
BOOL func_82(Ped pedParam0, Ped pedParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0x2DA9
{
	...
	if (num == -1)
	{
		...
		iLocal_42[num].f_1 = pedParam0;
		iLocal_42[num].f_2 = pedParam1;
	}

	pedBoneCoords = { PED::GET_PED_BONE_COORDS(pedParam0, 31086, 0f, 0f, 0f) };
	flag = func_83(&iLocal_42[num], pedBoneCoords, pedParam1, &(iLocal_42[num].f_3), pedParam0, iParam5);
	return flag || MISC::GET_GAME_TIMER() - iLocal_42[num].f_3 < iParam4;
}
...
int func_85() // Position - 0x305B
{
	...
	{
		if (iLocal_42[i] == 0 && iLocal_42[i].f_1 == 0 && iLocal_42[i].f_2 == 0)
			return i;
	}
...
int func_90(Ped pedParam0, Ped pedParam1) // Position - 0x31B1
{
	...
	for (i = 0; i < iLocal_42; i = i + 1)
	{
		if (iLocal_42[i].f_1 == pedParam0 && iLocal_42[i].f_2 == pedParam1)
			return i;
	}
...
BOOL func_186(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6) // Position - 0x8056
{
	...
	if (!flag)
	{
		...
		if (!func_220(G_MissionStats.f_24998.f_43[iParam3]))
			return false;
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_218() || Global_112857 || Global_32286 || func_217() || func_22(8, -1) || func_216() || func_215() || func_214() || func_213() || G_MissionStats.f_7691.f_919[character] == 5)
							return false;
						break;
				
					case 1:
						if (PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_218() || Global_32286 || func_217() || func_22(8, -1) || func_214() || func_216() || func_215() || func_213() || G_MissionStats.f_7691.f_919[character] == 5)
							return false;
						break;
				
					case 2:
						if (!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_218() || Global_112857 || Global_32286 || func_217() || func_22(8, -1) || func_214() || func_216() || func_215() || func_213() || G_MissionStats.f_7691.f_919[character] == 5 || Global_43924 != -1)
							return false;
						break;
				
					case 3:
						if (PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_218() || Global_112857 || Global_32286 || func_217() || func_22(8, -1) || func_216() || func_215() || func_213() || G_MissionStats.f_7691.f_919[character] == 5)
							return false;
						break;
				
					case 4:
						if (func_218() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0 || func_22(8, -1) || func_213() || func_212() || G_MissionStats.f_7691.f_919[character] == 5)
							return false;
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
							if (PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0 || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || func_218() || Global_32286 || func_217() || func_22(8, -1) || func_215() || func_214() || func_213() || G_MissionStats.f_7691.f_919[character] == 5)
								return false;
						break;
				
					case 7:
						if (PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || !CAM::IS_SCREEN_FADED_IN() || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_218() || func_215() || Global_112857 || Global_32286 || func_217() || Global_44569 || func_22(8, -1) || func_214() || func_212() || func_213() || G_MissionStats.f_7691.f_919[character] == 5)
							return false;
						break;
