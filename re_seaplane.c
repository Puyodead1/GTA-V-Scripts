...
void main() // Position - 0x0
{
	...
	{
		if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_116[0]))
			VEHICLE::SET_VEHICLE_DOORS_LOCKED(uLocal_116[0], 2);
	...
	switch (iLocal_48)
	{
		...
		case 1:
			switch (iLocal_148)
			{
				...
				case 9:
					if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_116[0]))
						if (func_38(PLAYER::PLAYER_PED_ID(), uLocal_145, true) >= 200f && func_38(uLocal_116[0], uLocal_145, true) >= 200f)
							iLocal_48 = 2;
					else
						func_37();
					break;
...
BOOL func_39(int iParam0, BOOL bParam1) // Position - 0x19D8
{
	...
	{
		if (func_41(uLocal_49[iParam0], PLAYER::PLAYER_PED_ID(), true) >= 400f)
		{
		...
		if (bParam1)
		{
			...
			if (num >= 7 && !HUD::DOES_BLIP_EXIST(uLocal_49[iParam0].f_1))
				return true;
		}
	}
...
{
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_116[0]) && PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), uLocal_116[0], false))
		return true;
...
int func_55(int iParam0, BOOL bParam1, var uParam2, var uParam3, var uParam4, int iParam5) // Position - 0x211B
{
	...
	if (!ENTITY::DOES_ENTITY_EXIST(uLocal_49[iParam0]))
	{
		...
		{
			uLocal_49[iParam0] = PED::CREATE_PED_INSIDE_VEHICLE(vehicle, PED_TYPE_MISSION, model, seat, true, true);
		}
		else
		{
			uLocal_49[iParam0] = PED::CREATE_PED(PED_TYPE_MISSION, model, offsetFromEntityInWorldCoords, heading, true, true);
		...
		if (flag2)
			ENTITY::SET_ENTITY_COORDS_NO_OFFSET(uLocal_49[iParam0], offsetFromEntityInWorldCoords, false, false, true);
	
		if (bParam1)
			if (hash == hLocal_171)
				uLocal_49[iParam0].f_1 = func_60(uLocal_49[iParam0], true, 145);
			else
				uLocal_49[iParam0].f_1 = func_60(uLocal_49[iParam0], false, 145);
	
		WEAPON::SET_PED_DROPS_WEAPONS_WHEN_DEAD(uLocal_49[iParam0], toggle11);
		PED::SET_PED_CONFIG_FLAG(uLocal_49[iParam0], 213, value3);
		PED::SET_PED_CONFIG_FLAG(uLocal_49[iParam0], 212, value4);
		...
		PED::SET_PED_CONFIG_FLAG(uLocal_49[iParam0], 188, value8);
		...
		PED::SET_PED_CONFIG_FLAG(uLocal_49[iParam0], 342, value9);
		...
		PED::SET_PED_CONFIG_FLAG(uLocal_49[iParam0], 118, value5);
		PED::SET_PED_CONFIG_FLAG(uLocal_49[iParam0], 115, value6);
		...
		PED::SET_PED_CONFIG_FLAG(uLocal_49[iParam0], 185, value7);
		...
		PED::SET_PED_COMBAT_ATTRIBUTES(uLocal_49[iParam0], BF_AlwaysFight, enabled13);
		PED::SET_PED_COMBAT_ATTRIBUTES(uLocal_49[iParam0], BF_CanFightArmedPedsWhenNotArmed, enabled14);
		AUDIO::DISABLE_PED_PAIN_AUDIO(uLocal_49[iParam0], toggle12);
		AUDIO::STOP_PED_SPEAKING(uLocal_49[iParam0], shaking);
		func_59(uLocal_49[iParam0], num, num2, num3, num4, num5);
		ENTITY::FREEZE_ENTITY_POSITION(uLocal_49[iParam0], toggle13);
		PED::SET_PED_CONFIG_FLAG(uLocal_49[iParam0], 203, value10);
		PED::SET_PED_IS_AVOIDED_BY_OTHERS(uLocal_49[iParam0], !value10);
		...
		if (value2 >= 0f)
			PED::SET_PED_HEARING_RANGE(uLocal_49[iParam0], value2);
	
		if (xBias > 0f || yBias > 0f)
			WEAPON::SET_PED_CHANCE_OF_FIRING_BLANKS(uLocal_49[iParam0], xBias, yBias);
	
		if (flag7)
			PED::SET_PED_SPHERE_DEFENSIVE_AREA(uLocal_49[iParam0], offsetFromEntityInWorldCoords, 5f, false, false);
	
		if (flag8)
			PED::STOP_PED_WEAPON_FIRING_WHEN_DROPPED(uLocal_49[iParam0]);
	
		PED::SET_PED_RELATIONSHIP_GROUP_HASH(uLocal_49[iParam0], hash);
	
		if (ENTITY::DOES_ENTITY_EXIST(entity2))
		{
			ENTITY::ATTACH_ENTITY_TO_ENTITY(uLocal_49[iParam0], entity2, -1, vector, vector2, true, true, true, false, 2, true, 0);
...
void func_57(int iParam0) // Position - 0x2881
{
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_49[iParam0]))
	{
		switch (iParam0)
		{
			...
			case 3:
				PED::SET_PED_COMPONENT_VARIATION(uLocal_49[iParam0], PV_COMP_HEAD, 1, 0, 0);
			...
			case 4:
				...
				PED::SET_PED_COMPONENT_VARIATION(uLocal_49[iParam0], PV_COMP_UPPR, 0, 1, 0);
				PED::SET_PED_COMPONENT_VARIATION(uLocal_49[iParam0], PV_COMP_LOWR, 1, 0, 0);
				break;
		
			case 7:
				PED::SET_PED_COMPONENT_VARIATION(uLocal_49[iParam0], PV_COMP_HEAD, 0, 2, 0);
				PED::SET_PED_COMPONENT_VARIATION(uLocal_49[iParam0], PV_COMP_UPPR, 1, 2, 0);
				PED::SET_PED_COMPONENT_VARIATION(uLocal_49[iParam0], PV_COMP_LOWR, 1, 2, 0);
				break;
...
int func_64(int iParam0, var uParam1, var uParam2, var uParam3, int iParam4, BOOL bParam5) // Position - 0x2C06
{
	...
	if (!ENTITY::DOES_ENTITY_EXIST(uLocal_116[iParam0]))
	{
		doorLockStatus = 0;
		toggle = true;
		toggle2 = true;
		...
		uLocal_116[iParam0] = VEHICLE::CREATE_VEHICLE(model, vector, heading, true, true, false);
		func_67(iParam0);
		func_66(iParam0);
		ENTITY::SET_ENTITY_VISIBLE(uLocal_116[iParam0], toggle2, false);
	
		if (ENTITY::DOES_ENTITY_EXIST(entity2))
			ENTITY::ATTACH_ENTITY_TO_ENTITY(uLocal_116[iParam0], entity2, -1, vector2, vector3, false, false, false, false, 2, true, 0);
		else
			ENTITY::SET_ENTITY_COLLISION(uLocal_116[iParam0], toggle, false);
	
		VEHICLE::SET_VEHICLE_STRONG(uLocal_116[iParam0], toggle3);
		ENTITY::FREEZE_ENTITY_POSITION(uLocal_116[iParam0], toggle4);
		VEHICLE::SET_VEHICLE_TYRES_CAN_BURST(uLocal_116[iParam0], toggle5);
	
		if (value)
			VEHICLE::SET_VEHICLE_ENGINE_ON(uLocal_116[iParam0], value, true, false);
	
		ENTITY::SET_ENTITY_INVINCIBLE(uLocal_116[iParam0], toggle6);
		ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(uLocal_116[iParam0], toggle7, 1);
		VEHICLE::SET_VEHICLE_CAN_BE_TARGETTED(uLocal_116[iParam0], flag3);
		VEHICLE::SET_FORCE_VEHICLE_ENGINE_DAMAGE_BY_BULLET(uLocal_116[iParam0], flag4);
		VEHICLE::SET_VEHICLE_AUTOMATICALLY_ATTACHES(uLocal_116[iParam0], flag5, 0);
		VEHICLE::SET_VEHICLE_DISABLE_TOWING(uLocal_116[iParam0], toggle8);
		ENTITY::SET_ENTITY_ONLY_DAMAGED_BY_PLAYER(uLocal_116[iParam0], toggle9);
		VEHICLE::SET_VEHICLE_IS_CONSIDERED_BY_PLAYER(uLocal_116[iParam0], toggle10);
	
		if (!MISC::IS_STRING_NULL_OR_EMPTY(plateText))
			VEHICLE::SET_VEHICLE_NUMBER_PLATE_TEXT(uLocal_116[iParam0], plateText);
	
		if (speed > 0f)
			VEHICLE::SET_VEHICLE_FORWARD_SPEED(uLocal_116[iParam0], speed);
	
		if (flag)
			VEHICLE::SET_HELI_BLADES_FULL_SPEED(uLocal_116[iParam0]);
	
		if (multiplier >= 0f)
			VEHICLE::SET_PLANE_TURBULENCE_MULTIPLIER(uLocal_116[iParam0], multiplier);
	
		if (num >= 0f)
			VEHICLE::SET_HELI_TURBULENCE_SCALAR(uLocal_116[iParam0], num);
	
		if (flag6)
			VEHICLE::SET_BOAT_ANCHOR(uLocal_116[iParam0], true);
	
		if (doorLockStatus != 0)
			VEHICLE::SET_VEHICLE_DOORS_LOCKED(uLocal_116[iParam0], doorLockStatus);
	
		if (bParam5)
			uLocal_116[iParam0].f_1 = func_65(uLocal_116[iParam0], flag2, false);
	
		if (iParam0 == 0)
			VEHICLE::CONTROL_LANDING_GEAR(uLocal_116[iParam0], 3);
	}
...
{
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_116[iParam0]))
	{
		switch (iParam0)
		{
			case 2:
			case 3:
				VEHICLE::SET_VEHICLE_EXTRA(uLocal_116[iParam0], 1, true);
				VEHICLE::SET_VEHICLE_EXTRA(uLocal_116[iParam0], 2, true);
				VEHICLE::SET_VEHICLE_EXTRA(uLocal_116[iParam0], 3, true);
				VEHICLE::SET_VEHICLE_EXTRA(uLocal_116[iParam0], 4, true);
				VEHICLE::SET_VEHICLE_EXTRA(uLocal_116[iParam0], 5, false);
				break;
			...
			case 4:
				...
				VEHICLE::SET_VEHICLE_EXTRA(uLocal_116[iParam0], 2, true);
				VEHICLE::SET_VEHICLE_EXTRA(uLocal_116[iParam0], 3, true);
				VEHICLE::SET_VEHICLE_EXTRA(uLocal_116[iParam0], 4, false);
				VEHICLE::SET_VEHICLE_EXTRA(uLocal_116[iParam0], 5, true);
				break;
		}
	}
...
void func_67(int iParam0) // Position - 0x3009
{
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_116[iParam0]))
	{
		...
		{
			case 1:
				VEHICLE::SET_VEHICLE_COLOURS(uLocal_116[iParam0], 111, 28);
				VEHICLE::SET_VEHICLE_EXTRA_COLOURS(uLocal_116[iParam0], 111, 156);
				break;
		
			case 2:
				VEHICLE::SET_VEHICLE_COLOURS(uLocal_116[iParam0], 121, 20);
				VEHICLE::SET_VEHICLE_EXTRA_COLOURS(uLocal_116[iParam0], 0, 156);
				break;
		
			case 3:
				VEHICLE::SET_VEHICLE_COLOURS(uLocal_116[iParam0], 121, 46);
				VEHICLE::SET_VEHICLE_EXTRA_COLOURS(uLocal_116[iParam0], 0, 156);
				break;
		
			case 4:
				VEHICLE::SET_VEHICLE_COLOURS(uLocal_116[iParam0], 111, 54);
				VEHICLE::SET_VEHICLE_EXTRA_COLOURS(uLocal_116[iParam0], 112, 156);
				break;
		}
	}
	...
	for (i = 0; i < 11; i = i + 1)
	{
		if (ENTITY::DOES_ENTITY_EXIST(uLocal_49[i]) && HUD::DOES_BLIP_EXIST(uLocal_49[i].f_1))
		{
			...
			if (PED::IS_PED_INJURED(uLocal_49[i]))
				func_43(&(uLocal_49[i].f_1));
		}
	}

	for (i = 0; i < 5; i = i + 1)
	{
		if (ENTITY::DOES_ENTITY_EXIST(uLocal_116[i]) && HUD::DOES_BLIP_EXIST(uLocal_116[i].f_1))
			if (!VEHICLE::IS_VEHICLE_DRIVEABLE(uLocal_116[i], false))
				func_43(&(uLocal_116[i].f_1));
	}
...
BOOL func_87(int iParam0) // Position - 0x3CF6
{
	...
	if (iParam0 == 4)
		if (!_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_49[2]) && !_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_49[3]))
			return false;

	if (iParam0 == 8)
		if (!_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_49[7]))
			return false;

	if (iParam0 == 10)
		if (!_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_49[9]))
			return false;
...
void func_90() // Position - 0x3E1C
{
	...
	for (i = 0; i < 5; i = i + 1)
	{
		if (ENTITY::DOES_ENTITY_EXIST(uLocal_116[i]))
			func_91(i);
	}
...
{
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_116[iParam0]) || iParam0 == 0)
	{
		switch (iParam0)
		{
			case 1:
			...
			case 3:
			case 4:
				switch (uLocal_116[iParam0].f_2)
				{
					case 0:
						if (!_DOES_ENTITY_EXIST_AND_IS_ALIVE(VEHICLE::GET_PED_IN_VEHICLE_SEAT(uLocal_116[iParam0], -1, false)) && !_DOES_ENTITY_EXIST_AND_IS_ALIVE(VEHICLE::GET_PED_IN_VEHICLE_SEAT(uLocal_116[iParam0], 0, false)) && !_DOES_ENTITY_EXIST_AND_IS_ALIVE(VEHICLE::GET_PED_IN_VEHICLE_SEAT(uLocal_116[iParam0], 1, false)) && !_DOES_ENTITY_EXIST_AND_IS_ALIVE(VEHICLE::GET_PED_IN_VEHICLE_SEAT(uLocal_116[iParam0], 2, false)))
						{
							VEHICLE::SET_VEHICLE_IS_CONSIDERED_BY_PLAYER(uLocal_116[iParam0], true);
							VEHICLE::SET_BOAT_ANCHOR(uLocal_116[iParam0], false);
							uLocal_116[iParam0].f_2 = uLocal_116[iParam0].f_2 + 1;
						}
						break;
	...
	else if (ENTITY::IS_ENTITY_VISIBLE(uLocal_116[iParam0]))
	{
...
void func_92(int iParam0, BOOL bParam1) // Position - 0x3F48
{
	if (ENTITY::DOES_ENTITY_EXIST(uLocal_116[iParam0]))
	{
		func_43(&(uLocal_116[iParam0].f_1));
	
		if (VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(uLocal_116[iParam0]))
			VEHICLE::STOP_PLAYBACK_RECORDED_VEHICLE(uLocal_116[iParam0]);
	
		if (func_93(&uLocal_116[iParam0]))
			if (bParam1)
				VEHICLE::DELETE_VEHICLE(&uLocal_116[iParam0]);
			else
				ENTITY::SET_VEHICLE_AS_NO_LONGER_NEEDED(&uLocal_116[iParam0]);
	
		uLocal_116[iParam0] = 0;
		uLocal_116[iParam0].f_2 = 0;
		uLocal_116[iParam0].f_3 = 0f;
	}
...
void func_95(int iParam0) // Position - 0x400C
{
	...
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_49[iParam0]))
	{
		switch (iParam0)
		{
			case 0:
			case 2:
				if (uLocal_49[iParam0].f_3 >= 2 && uLocal_49[iParam0].f_3 < 5)
				{
					if (PED::IS_PED_IN_ANY_VEHICLE(uLocal_49[iParam0], false) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(PED::GET_VEHICLE_PED_IS_IN(uLocal_49[iParam0], false)) && FIRE::IS_ENTITY_ON_FIRE(PED::GET_VEHICLE_PED_IS_IN(uLocal_49[iParam0], false)))
					{
						func_105();
						...
						func_103(uLocal_49[iParam0]);
						PED::SET_PED_COMBAT_ATTRIBUTES(uLocal_49[iParam0], BF_CanUseVehicles, false);
						uLocal_49[iParam0].f_3 = 5;
					}
				}
				...
				switch (uLocal_49[iParam0].f_3)
				{
					case 0:
						if (iParam0 == 0)
							if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_49[3]))
								PED::SET_IK_TARGET(uLocal_49[iParam0], 1, uLocal_49[3], 31086, uLocal_139, 0, -1, -1);
						else if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_49[1]))
							PED::SET_IK_TARGET(uLocal_49[iParam0], 1, uLocal_49[1], 31086, uLocal_139, 0, -1, -1);
					
						if (func_121(1) || PED::IS_PED_IN_COMBAT(uLocal_49[iParam0], PLAYER::PLAYER_PED_ID()) || func_102() || func_101())
						{
							func_100(iParam0);
					...
					case 1:
						if (iParam0 == 0)
							if (!_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_49[1]) || _DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_116[1]) && PED::IS_PED_IN_VEHICLE(uLocal_49[1], uLocal_116[1], true))
								flag = true;
						else if (!_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_49[3]) || _DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_116[2]) && PED::IS_PED_IN_VEHICLE(uLocal_49[3], uLocal_116[2], true) && !_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_49[4]) || _DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_116[2]) && PED::IS_PED_IN_VEHICLE(uLocal_49[4], uLocal_116[2], true))
							flag = true;
					...
					case 2:
						...
						TASK::WAYPOINT_RECORDING_GET_CLOSEST_WAYPOINT(name, ENTITY::GET_ENTITY_COORDS(uLocal_49[iParam0], true), &point2);
						...
						if (iParam0 == 0 && iLocal_151 != point && point > point2 || iParam0 == 2 && iLocal_152 != point && point > point2 && _DOES_ENTITY_EXIST_AND_IS_ALIVE(PED::GET_VEHICLE_PED_IS_USING(uLocal_49[iParam0])) && !PED::IS_PED_BEING_STUNNED(uLocal_49[iParam0], 0))
						{
							if (iParam0 == 0)
								iLocal_151 = point;
							else
							...
							if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(PED::GET_VEHICLE_PED_IS_USING(uLocal_49[iParam0])))
							{
								VEHICLE::SET_BOAT_ANCHOR(PED::GET_VEHICLE_PED_IS_USING(uLocal_49[iParam0]), false);
								func_86(iParam0, 5);
							}
						
							TASK::TASK_VEHICLE_FOLLOW_WAYPOINT_RECORDING(uLocal_49[iParam0], PED::GET_VEHICLE_PED_IS_USING(uLocal_49[iParam0]), name, 786469, 0, num, point, -1f, false, 6f);
						}
					
						if (!func_98(uLocal_49[iParam0], SCRIPT_TASK_VEHICLE_FOLLOW_WAYPOINT_RECORDING, true) && TASK::GET_SCRIPT_TASK_STATUS(uLocal_49[iParam0], SCRIPT_TASK_VEHICLE_FOLLOW_WAYPOINT_RECORDING) == 7 && !func_98(uLocal_49[iParam0], SCRIPT_TASK_VEHICLE_SHOOT_AT_ENTITY, true))
						{
							TASK::TASK_VEHICLE_SHOOT_AT_PED(uLocal_49[iParam0], PLAYER::PLAYER_PED_ID(), 1101004800);
						
							if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(PED::GET_VEHICLE_PED_IS_USING(uLocal_49[iParam0])) && VEHICLE::CAN_ANCHOR_BOAT_HERE(PED::GET_VEHICLE_PED_IS_USING(uLocal_49[iParam0])))
							{
								VEHICLE::SET_BOAT_ANCHOR(PED::GET_VEHICLE_PED_IS_USING(uLocal_49[iParam0]), true);
								func_58(iParam0, 5);
							}
						}
						...
						{
							if (PED::IS_PED_BEING_STUNNED(uLocal_49[iParam0], 0))
							{
								func_58(iParam0, 4);
								TASK::CLEAR_PED_TASKS(uLocal_49[iParam0]);
							
								if (!func_89(iParam0, 5) && VEHICLE::CAN_ANCHOR_BOAT_HERE(PED::GET_VEHICLE_PED_IS_USING(uLocal_49[iParam0])))
									VEHICLE::SET_BOAT_ANCHOR(PED::GET_VEHICLE_PED_IS_USING(uLocal_49[iParam0]), true);
							}
						}
						else if (!PED::IS_PED_BEING_STUNNED(uLocal_49[iParam0], 0))
						{
							func_86(iParam0, 4);
						...
						if (TASK::GET_SCRIPT_TASK_STATUS(uLocal_49[iParam0], SCRIPT_TASK_VEHICLE_FOLLOW_WAYPOINT_RECORDING) == 1 && !VEHICLE::IS_VEHICLE_STOPPED(PED::GET_VEHICLE_PED_IS_USING(uLocal_49[iParam0])) && !TASK::IS_DRIVEBY_TASK_UNDERNEATH_DRIVING_TASK(uLocal_49[iParam0]))
							TASK::TASK_DRIVE_BY(uLocal_49[iParam0], PLAYER::PLAYER_PED_ID(), 0, uLocal_139, 500f, 100, true, joaat("FIRING_PATTERN_BURST_FIRE"));
					
						TASK::WAYPOINT_RECORDING_GET_COORD(name, points - 1, &coord);
					
						if (ENTITY::IS_ENTITY_AT_COORD(uLocal_49[iParam0], coord, 8f, 8f, 8f, false, true, 0))
						{
							PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uLocal_49[iParam0], true);
							TASK::TASK_BOAT_MISSION(uLocal_49[iParam0], PED::GET_VEHICLE_PED_IS_USING(uLocal_49[iParam0]), 0, PLAYER::PLAYER_PED_ID(), uLocal_139, 7, 20f, 786469, 5f, 7);
							func_68(5);
					...
					case 3:
						if (PED::IS_PED_IN_ANY_VEHICLE(uLocal_49[iParam0], false) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(PED::GET_VEHICLE_PED_IS_IN(uLocal_49[iParam0], false)))
						{
							if (VEHICLE::IS_VEHICLE_STUCK_TIMER_UP(PED::GET_VEHICLE_PED_IS_IN(uLocal_49[iParam0], false), 3, 6000) || func_97(iParam0, 5000))
							{
								TASK::TASK_GET_OFF_BOAT(uLocal_49[iParam0], -1);
								PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uLocal_49[iParam0], true);
								PED::SET_PED_COMBAT_ATTRIBUTES(uLocal_49[iParam0], BF_CanUseVehicles, false);
								uLocal_49[iParam0].f_3 = uLocal_49[iParam0].f_3 + 1;
							}
							else if (TASK::GET_SCRIPT_TASK_STATUS(uLocal_49[iParam0], SCRIPT_TASK_VEHICLE_MISSION) == 1 && !TASK::IS_DRIVEBY_TASK_UNDERNEATH_DRIVING_TASK(uLocal_49[iParam0]))
							{
								TASK::TASK_DRIVE_BY(uLocal_49[iParam0], PLAYER::PLAYER_PED_ID(), 0, uLocal_139, 500f, 100, true, joaat("FIRING_PATTERN_BURST_FIRE"));
							}
						}
					...
					case 4:
						if (!func_98(uLocal_49[iParam0], SCRIPT_TASK_GET_OFF_BOAT, true))
						{
							if (!PED::IS_PED_ON_VEHICLE(uLocal_49[iParam0]))
							{
			...
			case 4:
				...
				{
					case 0:
						if (iParam0 == 1 && func_98(uLocal_49[iParam0], SCRIPT_TASK_START_SCENARIO_IN_PLACE, true) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_49[3]))
							PED::SET_IK_TARGET(uLocal_49[iParam0], 1, uLocal_49[3], 31086, uLocal_139, 0, -1, -1);
					
						if (iParam0 == 3 || iParam0 == 4 && _DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_49[1]) && func_98(uLocal_49[iParam0], SCRIPT_TASK_START_SCENARIO_IN_PLACE, true))
							PED::SET_IK_TARGET(uLocal_49[iParam0], 1, uLocal_49[1], 31086, uLocal_139, 0, -1, -1);
					
						if (func_121(1) || PED::IS_PED_IN_COMBAT(uLocal_49[iParam0], PLAYER::PLAYER_PED_ID()) || func_102() || func_101())
						{
							func_100(iParam0);
							uLocal_49[iParam0].f_4 = MISC::GET_GAME_TIMER() + MISC::GET_RANDOM_INT_IN_RANGE(1250, 1501);
							uLocal_49[iParam0].f_3 = uLocal_49[iParam0].f_3 + 1;
						}
						break;
				
					case 1:
						if (MISC::GET_GAME_TIMER() >= uLocal_49[iParam0].f_4)
						{
							if (iParam0 == 1 && _DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_116[1]) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(VEHICLE::GET_PED_IN_VEHICLE_SEAT(uLocal_116[1], -1, false)))
							{
								TASK::CLEAR_PED_TASKS(uLocal_49[iParam0]);
								TASK::TASK_ENTER_VEHICLE(uLocal_49[iParam0], uLocal_116[1], 20000, 0, 3f, 1, 0);
								PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uLocal_49[iParam0], true);
							}
						
							if (iParam0 == 3 && _DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_116[2]) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(VEHICLE::GET_PED_IN_VEHICLE_SEAT(uLocal_116[2], -1, false)))
							{
								TASK::CLEAR_PED_TASKS(uLocal_49[iParam0]);
								TASK::TASK_ENTER_VEHICLE(uLocal_49[iParam0], uLocal_116[2], 20000, 0, 3f, 1, 0);
								PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uLocal_49[iParam0], true);
							}
						
							if (iParam0 == 4 && _DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_116[2]) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(VEHICLE::GET_PED_IN_VEHICLE_SEAT(uLocal_116[2], -1, false)))
							{
								TASK::CLEAR_PED_TASKS(uLocal_49[iParam0]);
								TASK::TASK_ENTER_VEHICLE(uLocal_49[iParam0], uLocal_116[2], 20000, 1, 3f, 1, 0);
								PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uLocal_49[iParam0], true);
							}
					...
					case 2:
						...
						if (PED::IS_PED_IN_ANY_VEHICLE(uLocal_49[iParam0], true) || !_DOES_ENTITY_EXIST_AND_IS_ALIVE(VEHICLE::GET_PED_IN_VEHICLE_SEAT(uLocal_116[num2], -1, false)))
						{
							PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uLocal_49[iParam0], false);
							TASK::TASK_COMBAT_PED(uLocal_49[iParam0], PLAYER::PLAYER_PED_ID(), 0, 16);
							uLocal_49[iParam0].f_3 = uLocal_49[iParam0].f_3 + 1;
						}
						else if (!func_98(uLocal_49[iParam0], SCRIPT_TASK_ENTER_VEHICLE, true))
						{
							if (iParam0 == 1 || iParam0 == 3 && _DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_116[num2]))
								TASK::TASK_ENTER_VEHICLE(uLocal_49[iParam0], uLocal_116[num2], 20000, 0, 3f, 1, 0);
						
							if (iParam0 == 4 && _DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_116[num2]))
								TASK::TASK_ENTER_VEHICLE(uLocal_49[iParam0], uLocal_116[num2], 20000, 1, 3f, 1, 0);
						}
						break;
					...
					case 3:
						if (PED::IS_PED_IN_ANY_VEHICLE(uLocal_49[iParam0], false) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(PED::GET_VEHICLE_PED_IS_IN(uLocal_49[iParam0], false)))
						{
							if (FIRE::IS_ENTITY_ON_FIRE(PED::GET_VEHICLE_PED_IS_IN(uLocal_49[iParam0], false)))
							{
								func_105();
								TASK::TASK_SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(0, true);
								TASK::TASK_LEAVE_ANY_VEHICLE(0, MISC::GET_RANDOM_INT_IN_RANGE(500, 1501), 4096);
							...
							if (uLocal_49[iParam0].f_3 == 3)
							{
								if (VEHICLE::IS_VEHICLE_STUCK_TIMER_UP(PED::GET_VEHICLE_PED_IS_IN(uLocal_49[iParam0], false), 3, 6000) || func_97(iParam0, 5000) && func_121(5))
								{
									TASK::TASK_GET_OFF_BOAT(uLocal_49[iParam0], 20000);
									PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uLocal_49[iParam0], true);
									PED::SET_PED_COMBAT_ATTRIBUTES(uLocal_49[iParam0], BF_CanUseVehicles, false);
									uLocal_49[iParam0].f_3 = 5;
								}
								else if (!_DOES_ENTITY_EXIST_AND_IS_ALIVE(VEHICLE::GET_PED_IN_VEHICLE_SEAT(PED::GET_VEHICLE_PED_IS_IN(uLocal_49[iParam0], false), -1, false)))
								{
									PED::SET_PED_COMBAT_ATTRIBUTES(uLocal_49[iParam0], BF_CanLeaveVehicle, true);
									TASK::TASK_COMBAT_PED(uLocal_49[iParam0], PLAYER::PLAYER_PED_ID(), 0, 16);
									uLocal_49[iParam0].f_3 = uLocal_49[iParam0].f_3 + 1;
								}
							}
			...
			case 7:
				if (uLocal_49[iParam0].f_3 >= 1 && uLocal_49[iParam0].f_3 < 3)
				{
					if (PED::IS_PED_IN_ANY_VEHICLE(uLocal_49[iParam0], false) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(PED::GET_VEHICLE_PED_IS_IN(uLocal_49[iParam0], false)) && FIRE::IS_ENTITY_ON_FIRE(PED::GET_VEHICLE_PED_IS_IN(uLocal_49[iParam0], false)))
					{
						func_105();
				...
				{
					case 0:
						if (func_44() && func_41(PLAYER::PLAYER_PED_ID(), uLocal_49[iParam0], true) <= 125f || PED::IS_PED_ON_FOOT(PLAYER::PLAYER_PED_ID()) && !ENTITY::IS_ENTITY_IN_WATER(PLAYER::PLAYER_PED_ID()) && func_41(PLAYER::PLAYER_PED_ID(), uLocal_49[iParam0], true) <= 150f || PED::IS_PED_ON_FOOT(PLAYER::PLAYER_PED_ID()) && !ENTITY::IS_ENTITY_OCCLUDED(uLocal_49[iParam0]) || func_121(6))
						{
							if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_116[3]))
							{
								VEHICLE::SET_BOAT_ANCHOR(PED::GET_VEHICLE_PED_IS_USING(uLocal_49[iParam0]), false);
								entitySpeed = ENTITY::GET_ENTITY_SPEED(PLAYER::PLAYER_PED_ID());
								entitySpeed = func_96(entitySpeed, 10f, 40f);
								VEHICLE::SET_VEHICLE_FORWARD_SPEED(uLocal_116[3], entitySpeed);
							}
						
							WEAPON::SET_CURRENT_PED_WEAPON(uLocal_49[iParam0], joaat("WEAPON_PISTOL"), false);
							TASK::TASK_BOAT_MISSION(uLocal_49[iParam0], PED::GET_VEHICLE_PED_IS_USING(uLocal_49[iParam0]), 0, PLAYER::PLAYER_PED_ID(), uLocal_139, 7, 20f, 786469, 5f, 7);
							PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uLocal_49[iParam0], true);
							uLocal_49[iParam0].f_1 = func_60(uLocal_49[iParam0], true, 145);
							func_68(6);
			...
			case 9:
				...
				switch (uLocal_49[iParam0].f_3)
				{
					case 0:
						if (func_44() && func_41(PLAYER::PLAYER_PED_ID(), uLocal_49[iParam0], true) <= 125f || PED::IS_PED_ON_FOOT(PLAYER::PLAYER_PED_ID()) && !ENTITY::IS_ENTITY_IN_WATER(PLAYER::PLAYER_PED_ID()) && func_41(PLAYER::PLAYER_PED_ID(), uLocal_49[iParam0], true) <= 150f || PED::IS_PED_ON_FOOT(PLAYER::PLAYER_PED_ID()) && !ENTITY::IS_ENTITY_OCCLUDED(uLocal_49[iParam0]) || func_121(6))
						{
							if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_116[4]))
							{
								VEHICLE::SET_BOAT_ANCHOR(PED::GET_VEHICLE_PED_IS_USING(uLocal_49[iParam0]), false);
								entitySpeed2 = ENTITY::GET_ENTITY_SPEED(PLAYER::PLAYER_PED_ID());
								entitySpeed2 = func_96(entitySpeed2, 10f, 40f);
								VEHICLE::SET_VEHICLE_FORWARD_SPEED(uLocal_116[4], entitySpeed2);
							}
			...
			case 10:
				...
				{
					case 0:
						if (func_44() && func_41(PLAYER::PLAYER_PED_ID(), uLocal_49[iParam0], true) <= 125f || PED::IS_PED_ON_FOOT(PLAYER::PLAYER_PED_ID()) && !ENTITY::IS_ENTITY_IN_WATER(PLAYER::PLAYER_PED_ID()) && func_41(PLAYER::PLAYER_PED_ID(), uLocal_49[iParam0], true) <= 150f || PED::IS_PED_ON_FOOT(PLAYER::PLAYER_PED_ID()) && !ENTITY::IS_ENTITY_OCCLUDED(uLocal_49[iParam0]))
						{
							uLocal_49[iParam0].f_1 = func_60(uLocal_49[iParam0], true, 145);
							HUD::SET_BLIP_ALPHA(uLocal_49[iParam0].f_1, 0);
							HUD::SET_BLIP_HIDDEN_ON_LEGEND(uLocal_49[iParam0].f_1, true);
							uLocal_49[iParam0].f_3 = uLocal_49[iParam0].f_3 + 1;
						}
						break;
				
					case 1:
						if (PED::IS_PED_IN_ANY_VEHICLE(uLocal_49[iParam0], false))
						{
							if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(PED::GET_VEHICLE_PED_IS_IN(uLocal_49[iParam0], false)))
							{
								if (VEHICLE::IS_VEHICLE_STUCK_TIMER_UP(PED::GET_VEHICLE_PED_IS_IN(uLocal_49[iParam0], false), 3, 6000) || func_97(iParam0, 5000))
								{
									TASK::TASK_GET_OFF_BOAT(uLocal_49[iParam0], -1);
...
BOOL func_97(int iParam0, int iParam1) // Position - 0x5529
{
	...
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_116[num]))
		if (!ENTITY::IS_ENTITY_IN_WATER(uLocal_116[num]))
			uLocal_116[num].f_3 = uLocal_116[num].f_3 + MISC::GET_FRAME_TIME();
		else
			uLocal_116[num].f_3 = 0f;

	if (uLocal_116[num].f_3 >= (float)iParam1)
		return true;
...
void func_100(int iParam0) // Position - 0x5644
{
	...
	uLocal_49[iParam0].f_1 = func_60(uLocal_49[iParam0], true, 145);
	PED::SET_PED_SEEING_RANGE(uLocal_49[iParam0], 200f);

	if (PED::IS_PED_IN_ANY_VEHICLE(uLocal_49[iParam0], false))
	{
		if (_GET_VEHICLE_SEAT_PED_IS_IN(uLocal_49[iParam0], false) != -1)
		{
			HUD::SET_BLIP_ALPHA(uLocal_49[iParam0].f_1, 0);
			HUD::SET_BLIP_HIDDEN_ON_LEGEND(uLocal_49[iParam0].f_1, true);
		}
...
void func_106() // Position - 0x57BF
{
	...
	{
		if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_116[0]) && func_41(PLAYER::PLAYER_PED_ID(), uLocal_116[0], true) >= 250f)
		{
			flag = true;
	...
	if (ENTITY::DOES_ENTITY_EXIST(uLocal_116[0]) && !_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_116[0]))
	{
		flag = true;
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_159() || Global_112695 || Global_32166 || func_158() || func_157(8, -1) || func_156() || func_155() || func_154() || func_153() || G_SomeGlobalState.MessageCallStates.f_919[character] == 5)
							return false;
						break;
				
					case 1:
						if (PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_159() || Global_32166 || func_158() || func_157(8, -1) || func_154() || func_156() || func_155() || func_153() || G_SomeGlobalState.MessageCallStates.f_919[character] == 5)
							return false;
						break;
				
					case 2:
						if (!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_159() || Global_112695 || Global_32166 || func_158() || func_157(8, -1) || func_154() || func_156() || func_155() || func_153() || G_SomeGlobalState.MessageCallStates.f_919[character] == 5 || LastDispatchedMessageOrCall != -1)
							return false;
						break;
				
					case 3:
						if (PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_159() || Global_112695 || Global_32166 || func_158() || func_157(8, -1) || func_156() || func_155() || func_153() || G_SomeGlobalState.MessageCallStates.f_919[character] == 5)
							return false;
						break;
				
					case 4:
						if (func_159() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0 || func_157(8, -1) || func_153() || func_152() || G_SomeGlobalState.MessageCallStates.f_919[character] == 5)
							return false;
						break;
