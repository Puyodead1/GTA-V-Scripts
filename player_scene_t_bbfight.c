		...
		if (!PED::IS_PED_INJURED(uParam0->[i]))
		{
			switch (uParam1->[i])
			{
				...
				case 202:
					if (STREAMING::HAS_ANIM_DICT_LOADED(&uLocal_371) && ENTITY::IS_ENTITY_PLAYING_ANIM(uParam0->[i], &uLocal_371, &uLocal_420[i], 1))
					{
						...
						if (iLocal_113 == 108 || iLocal_113 == 109)
						{
							...
							{
								if (iLocal_113 == 108)
									uLocal_303[i] = { Vector3(224.5948f, 1213.4664f, 199.6328f) - uLocal_299 };
								else if (iLocal_113 == 109)
									uLocal_303[i] = { Vector3(5.9049f, -717.1404f, -1908.2874f) - uLocal_299 };
				...
				case 0:
					...
					vector = { uLocal_299 + uLocal_303[i] + Vector3(1f, 0f, 0f) };
				...
				case 1:
					...
					vector2 = { uLocal_299 + uLocal_303[i] + Vector3(1f, 0f, 0f) };
...
void func_57() // Position - 0x22CC
{
	...
	switch (iLocal_113)
	{
		...
		case 166:
			uLocal_303[0] = { Vector3(36.037f, -476.663f, -1050.724f) - uLocal_299 };
		...
		case 246:
			uLocal_303[0] = { (Vector3(4.6f, -1570.9237f, -1194.7703f) - uLocal_299) + Vector3(-1f, 0f, 0f) };
		...
		case 257:
			uLocal_303[0] = { Vector3(7.1578f, -978.6192f, -1666.3738f) - uLocal_299 };
		...
		case 239:
			uLocal_303[0] = { (Vector3(113.05f, 354.39f, -52.2f) - uLocal_299) + Vector3(-1f, 0f, 0f) };
			uLocal_303[1] = { (Vector3(113.05f, 354.08f, -53.18f) - uLocal_299) + Vector3(-1f, 0f, 0f) };
			uLocal_310[0] = -100f;
			uLocal_310[1] = -100f;
			iLocal_286[0] = joaat("A_M_M_Business_01");
			iLocal_286[1] = joaat("A_M_M_Business_01");
