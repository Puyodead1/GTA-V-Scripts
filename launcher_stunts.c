...
void main() // Position - 0x0
{
	...
	fLocal_117 = 4f;
	fLocal_119 = 0f;
	uLocal_90 = { uScriptParam_125.f_1[0] };
	uLocal_90 = { uLocal_90 };
	...
	while (true)
	{
		...
		if (ENTITY::DOES_ENTITY_EXIST(pedLocal_85) && !ENTITY::IS_ENTITY_DEAD(pedLocal_85, false))
		{
			...
			fLocal_93 = SYSTEM::VDIST2(uLocal_87, uScriptParam_125.f_1[0]);
			fLocal_93 = fLocal_93;
			uLocal_111 = { uLocal_87 };
			uLocal_114 = { uScriptParam_125.f_1[0] };
			uLocal_111.f_2 = 0f;
			uLocal_114.f_2 = 0f;
			...
			switch (iLocal_95)
			{
				case 0:
					...
					else
					{
						...
						uLocal_87.f_2 - uScriptParam_125.f_1[0].f_2 > 500f;
					}
					break;
				...
				case 3:
					...
					if (!ENTITY::DOES_ENTITY_EXIST(veLocal_86) && fLocal_93 > 10f * 10f && !CAM::IS_SPHERE_VISIBLE(uScriptParam_125.f_1[0], 5f) || fLocal_93 > 80f * 80f || !ENTITY::DOES_ENTITY_EXIST(veLocal_86) && CAM::IS_SCREEN_FADED_OUT())
					{
						MISC::CLEAR_AREA_OF_VEHICLES(uScriptParam_125.f_1[0], 8f, false, false, false, false, false, false, 0);
						veLocal_86 = VEHICLE::CREATE_VEHICLE(hLocal_118, uScriptParam_125.f_1[0], fLocal_119, true, true, false);
						func_96();
						...
						if (flag4)
						{
							...
							else
							{
								...
								if (flag4)
								{
									...
									{
										if (!ENTITY::IS_ENTITY_AT_COORD(pedLocal_85, uScriptParam_125.f_1[0], 4f, 4f, 2f, false, true, 0))
										{
											func_93(&iLocal_94, 128);
											flag4 = false;
										}
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_85() || Global_112695 || Global_32166 || func_84() || func_72(8, -1) || func_83() || func_82() || func_81() || func_74() || G_SomeGlobalState.MessageCallStates.f_919[character] == 5)
							return false;
						break;
				
					case 1:
						if (PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_85() || Global_32166 || func_84() || func_72(8, -1) || func_81() || func_83() || func_82() || func_74() || G_SomeGlobalState.MessageCallStates.f_919[character] == 5)
							return false;
						break;
				
					case 2:
						if (!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_85() || Global_112695 || Global_32166 || func_84() || func_72(8, -1) || func_81() || func_83() || func_82() || func_74() || G_SomeGlobalState.MessageCallStates.f_919[character] == 5 || LastDispatchedMessageOrCall != -1)
							return false;
						break;
				
					case 3:
						if (PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_85() || Global_112695 || Global_32166 || func_84() || func_72(8, -1) || func_83() || func_82() || func_74() || G_SomeGlobalState.MessageCallStates.f_919[character] == 5)
							return false;
						break;
				
					case 4:
						if (func_85() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0 || func_72(8, -1) || func_74() || func_80() || G_SomeGlobalState.MessageCallStates.f_919[character] == 5)
							return false;
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
							if (PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0 || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || func_85() || Global_32166 || func_84() || func_72(8, -1) || func_82() || func_81() || func_74() || G_SomeGlobalState.MessageCallStates.f_919[character] == 5)
								return false;
						break;
				
					case 7:
						if (PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || !CAM::IS_SCREEN_FADED_IN() || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_85() || func_82() || Global_112695 || Global_32166 || func_84() || Global_44446 || func_72(8, -1) || func_81() || func_80() || func_74() || G_SomeGlobalState.MessageCallStates.f_919[character] == 5)
							return false;
						break;
