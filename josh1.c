...
void main() // Position - 0x0
{
	...
	uLocal_150 = Vector3(-1106.999f, 288.96f, 63.4f);
	uLocal_153 = Vector3(0f, 0f, 12.06f);
	uLocal_83 = Vector3(uScriptParam_329);
	func_346(&uLocal_83);
	...
	switch (iLocal_145)
	{
		...
		case 1:
			...
			else if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_149))
			{
				...
				if (PED::IS_PED_INJURED(uLocal_83.f_28[0]) || FIRE::IS_ENTITY_ON_FIRE(uLocal_83.f_28[0]) || FIRE::IS_EXPLOSION_IN_SPHERE(-1, ENTITY::GET_ENTITY_COORDS(uLocal_83.f_28[0], true), 5f))
				{
					if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_83.f_28[0]))
					{
						ENTITY::STOP_SYNCHRONIZED_ENTITY_ANIM(uLocal_83.f_28[0], -8f, true);
...
BOOL IS_PLAYSTATION_PLATFORM() // Position - 0x21CCE
{
	return MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION();
}

BOOL IS_XBOX_PLATFORM() // Position - 0x21CE4
{
		...
		case 0:
			if (func_263(1, 1093140480, 0))
			{
				...
				if (func_262(playersLastVehicle))
				{
					...
					{
						unk = Vector3(-1098.87f, 280.88f, 63.47f);
						num = 85.98f;
					}
					else
					{
						unk = Vector3(-1095.2307f, 279.3389f, 62.7919f);
						num = 84.67f;
					}
				}
				else
...
BOOL func_257(Vehicle veParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, float fParam7) // Position - 0x29239
{
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(veParam0, false))
	{
		...
		if (func_258(unk18[0], unk18[1], unk6, unk9) || func_258(unk18[0], unk18[1], unk9, unk15) || func_258(unk18[0], unk18[1], unk12, unk15) || func_258(unk18[0], unk18[1], unk6, unk12) || func_258(unk18[1], unk18[3], unk6, unk9) || func_258(unk18[1], unk18[3], unk9, unk15) || func_258(unk18[1], unk18[3], unk12, unk15) || func_258(unk18[1], unk18[3], unk6, unk12) || func_258(unk18[3], unk18[2], unk6, unk9) || func_258(unk18[3], unk18[2], unk9, unk15) || func_258(unk18[3], unk18[2], unk12, unk15) || func_258(unk18[3], unk18[2], unk6, unk12) || func_258(unk18[2], unk18[0], unk6, unk9) || func_258(unk18[2], unk18[0], unk9, unk15) || func_258(unk18[2], unk18[0], unk12, unk15) || func_258(unk18[2], unk18[0], unk6, unk12))
			return true;
	}
	...
	if (Global_78813 != 6)
	{
		...
		else
		{
			...
			if (value < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				text = Vector3(func_282(Global_78814, Global_78816, iParam10));
				y == -0.014f;
...
struct<2> func_282(int iParam0, int iParam1, int iParam2) // Position - 0x2A2DC
{
	...
	switch (iParam1)
	{
		...
		case 3:
			...
			{
				case 0:
					unk = Vector3(func_289(iParam2));
					break;
			
				case 8:
					unk = Vector3(func_288(iParam2));
					break;
			
				case 7:
					unk = Vector3(func_287(iParam2));
					break;
			
				case 10:
					unk = Vector3(func_286(iParam2));
					break;
			
				case 5:
					unk = Vector3(func_285(iParam2));
					break;
			
				case 4:
					unk = Vector3(func_284(iParam2));
					break;
...
{
	if (!func_293(0) || G_TextMessageConfig || Global_78817 == 1 || !CAM::IS_SCREEN_FADED_IN())
		return false;
