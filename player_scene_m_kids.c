...
BOOL func_49(Ped pedParam0, int iParam1, int iParam2) // Position - 0x5D3F
{
	...
	entityModel = ENTITY::GET_ENTITY_MODEL(pedParam0);
	Global_78341[1] = { func_70(entityModel, iParam1, iParam2, -1) };
			...
			if (unk[i] != -99 && i != 12 && i != 14)
			{
				if (!func_49(pedParam0, i, unk[i]))
				{
					if (i == 13)
					{
						...
						for (j = 0; j <= 8; j = j + 1)
						{
							if (!func_49(pedParam0, 14, unk18[j]))
							{
								for (k = 0; k <= 19; k = k + 1)
								{
									Global_78341[2] = { func_70(entityModel, 14, k, -1) };
					...
					else
					{
						...
						Global_78341[2] = { func_70(entityModel, i, num, -1) };
...
int func_139(Ped pedParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x21663
{
	...
	if (iParam1 == 12)
	{
		...
		for (i = 0; i <= 14; i = i + 1)
		{
			if (unk[i] != -99)
			{
				Global_78341[1] = { func_70(entityModel, i, unk[i], -1) };
				...
				if (IS_BIT_SET(Global_78341[1].f_6, 0))
				{
					if (i == 13)
					{
						...
						for (j = 0; j <= 8; j = j + 1)
						{
							Global_78341[1] = { func_70(entityModel, 14, unk18[j], -1) };
			...
			{
				Global_78341[1] = { func_70(entityModel, i, func_146(pedParam0, i, PV_COMP_INVALID), -1) };
	...
	else if (iParam1 == 13)
	{
		...
		for (j = 0; j <= 8; j = j + 1)
		{
			Global_78341[1] = { func_70(entityModel, 14, unk59[j], -1) };
			func_156(pedParam0, Global_78341[1].f_12, Global_78341[1].f_3, Global_78341[1].f_4);
			func_162(14);
...
{
	Global_78341[1] = { func_70(hParam0, iParam1, iParam2, -1) };
...
void func_177() // Position - 0x25F35
{
	...
	{
		case 86:
			uLocal_339[0] = { MISC::GET_RANDOM_FLOAT_IN_RANGE(-1f, 1f), MISC::GET_RANDOM_FLOAT_IN_RANGE(-1f, 1f), 0f };
		...
		case 168:
			uLocal_339[0] = { MISC::GET_RANDOM_FLOAT_IN_RANGE(-1f, 1f), MISC::GET_RANDOM_FLOAT_IN_RANGE(-1f, 1f), 0f };
			uLocal_346[0] = MISC::GET_RANDOM_FLOAT_IN_RANGE(-180f, 180f);
			uLocal_339[1] = { MISC::GET_RANDOM_FLOAT_IN_RANGE(-1f, 1f), MISC::GET_RANDOM_FLOAT_IN_RANGE(-1f, 1f), 0f };
		...
		case 173:
			...
			uLocal_259[0] = { MISC::GET_RANDOM_FLOAT_IN_RANGE(-1f, 1f), MISC::GET_RANDOM_FLOAT_IN_RANGE(-1f, 1f), 0f };
		...
		default:
			uLocal_339[0] = { MISC::GET_RANDOM_FLOAT_IN_RANGE(-10f, 10f), MISC::GET_RANDOM_FLOAT_IN_RANGE(-10f, 10f), 0f };
			uLocal_339[1] = { MISC::GET_RANDOM_FLOAT_IN_RANGE(-10f, 10f), MISC::GET_RANDOM_FLOAT_IN_RANGE(-10f, 10f), 0f };
			uLocal_346[0] = MISC::GET_RANDOM_FLOAT_IN_RANGE(-180f, 180f);
			uLocal_346[1] = MISC::GET_RANDOM_FLOAT_IN_RANGE(-180f, 180f);
			iLocal_240[0] = 145;
			iLocal_240[1] = 145;
