...
void main() // Position - 0x0
{
	...
	uLocal_118 = Vector3(-1034.6f, 4918.6f, 205.9f);
	iLocal_135 = -1;
	uLocal_51 = Vector3(uScriptParam_320.f_1[0]);
...
void func_1() // Position - 0x4AB
{
	...
	if (bLocal_150 && !bLocal_149)
	{
		...
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_121[8]))
		{
			pkLocal_133 = OBJECT::CREATE_PICKUP_ROTATE(joaat("PICKUP_WEAPON_GOLFCLUB"), ENTITY::GET_ENTITY_COORDS(iLocal_121[8], true), ENTITY::GET_ENTITY_ROTATION(iLocal_121[8], 2) + Vector3(2.8157f, -159.5768f, -14.1956f), 0, -1, 2, true, 0);
			OBJECT::DELETE_OBJECT(&iLocal_121[8]);
		}
	
		VEHICLE::SET_ALL_VEHICLE_GENERATORS_ACTIVE_IN_AREA(uLocal_63 - Vector3(10f, 10f, 10f), uLocal_63 + Vector3(10f, 10f, 10f), true, true);
...
void _STAT_SET_PACKED_BOOL(int iParam0, BOOL bParam1, int iParam2) // Position - 0x146C
{
	if (iParam2 == -1)
		iParam2 = func_8();
...
void func_57(BOOL bParam0) // Position - 0x23F7
{
	...
	{
		uLocal_78 = Vector3(func_61());
		uLocal_72 = Vector3(func_60());
		func_58();
		bLocal_71 = true;
	}
...
BOOL func_63(char* sParam0) // Position - 0x2568
{
	...
	if (_CONVERSATION_IS_DIALOGUE_IN_PROGRESS())
	{
		TEXT_LABEL_COPY(&string2, Vector3(func_61()), 4);
...
BOOL _STAT_GET_PACKED_BOOL(int iParam0, int iParam1) // Position - 0x3EFC
{
	if (iParam1 == -1)
		iParam1 = func_8();
...
Blip func_121(Vector3 vParam0, var uParam1, var uParam2, BOOL bParam3) // Position - 0x4F8C
{
	Blip blip;
	...
	switch (iLocal_69)
	{
		...
		case 3:
			if (!PED::IS_PED_INJURED(pedLocal_58) && ENTITY::DOES_ENTITY_EXIST(iLocal_121[8]))
			{
				TASK::OPEN_SEQUENCE_TASK(&iLocal_95);
				iLocal_68 > 18;
				TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, ENTITY::GET_ENTITY_COORDS(iLocal_121[8], true) + Vector3(0f, 0.39f, 0.35f), 1f, -1, 0f, 512, func_133(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(iLocal_121[8], true)));
...
BOOL func_134(char* sParam0) // Position - 0x5974
{
	...
	if (_CONVERSATION_IS_DIALOGUE_IN_PROGRESS())
	{
		TEXT_LABEL_COPY(&string2, Vector3(func_60()), 4);
...
void func_150() // Position - 0x6972
{
	...
	VEHICLE::SET_ALL_VEHICLE_GENERATORS_ACTIVE_IN_AREA(uLocal_63 - Vector3(10f, 10f, 10f), uLocal_63 + Vector3(10f, 10f, 10f), false, true);
	PATHFIND::SET_ROADS_IN_ANGLED_AREA(-499.9164f, 575.6557f, 124.5584f, -346.8641f, 483.3948f, 111.7201f, 74.0625f, false, false, true);
	PED::ADD_SCENARIO_BLOCKING_AREA(uLocal_63 - Vector3(10f, 10f, 10f), uLocal_63 + Vector3(10f, 10f, 10f), false, true, true, true);
	PED::ADD_SCENARIO_BLOCKING_AREA(uLocal_112 - Vector3(3f, 2f, 2f), uLocal_112 + Vector3(3f, 2f, 2f), false, true, true, true);
	PED::ADD_SCENARIO_BLOCKING_AREA(Vector3(53.1038f, 56.6649f, -1366.4806f) - Vector3(1f, 1f, 1f), Vector3(53.1038f, 56.6649f, -1366.4806f) + Vector3(1f, 1f, 1f), false, true, true, true);
...
{
	uLocal_106 = Vector3(-470.4934f, 540.0073f, 120.3715f);
	...
	uLocal_60 = Vector3(-472.6554f, 536.469f, 123.3555f);
	fLocal_66 = 348.9152f;
	uLocal_63 = Vector3(-470.1328f, 542.9949f, 119.6873f);
	fLocal_67 = 156.0666f;
	uLocal_109 = Vector3(-469.082f, 535.0479f, 123.3553f);
	uLocal_112 = Vector3(-1378.2733f, 40.2254f, 52.6774f);
	uLocal_115 = Vector3(-1368.1881f, 57.2309f, 52.7045f);
	bLocal_59 = true;
	return;
}
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_217() || Global_112695 || Global_32166 || func_216() || func_77(8, -1) || func_215() || func_214() || func_213() || func_212() || G_SomeGlobalState.MessageCallStates.f_919[character] == 5)
							return false;
						break;
				
					case 1:
						if (PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_217() || Global_32166 || func_216() || func_77(8, -1) || func_213() || func_215() || func_214() || func_212() || G_SomeGlobalState.MessageCallStates.f_919[character] == 5)
							return false;
						break;
				
					case 2:
						if (!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_217() || Global_112695 || Global_32166 || func_216() || func_77(8, -1) || func_213() || func_215() || func_214() || func_212() || G_SomeGlobalState.MessageCallStates.f_919[character] == 5 || LastDispatchedMessageOrCall != -1)
							return false;
						break;
				
					case 3:
						if (PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_217() || Global_112695 || Global_32166 || func_216() || func_77(8, -1) || func_215() || func_214() || func_212() || G_SomeGlobalState.MessageCallStates.f_919[character] == 5)
							return false;
						break;
				
					case 4:
						if (func_217() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0 || func_77(8, -1) || func_212() || func_211() || G_SomeGlobalState.MessageCallStates.f_919[character] == 5)
							return false;
						break;
