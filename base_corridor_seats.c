...
void func_7(var uParam0, int iParam1, char* sParam2) // Position - 0x14A
{
	if (func_8(&(uParam0->f_57), 7))
		uParam0->f_57.f_14(&uParam0->[iParam1], iParam1, sParam2);
	else
...
void func_11(var uParam0) // Position - 0x219
{
	...
	num = Vector3(uParam0->[uParam0->f_57.f_2]);
...
Vector3 func_38(var uParam0) // Position - 0xEEA
{
	...
	unk = Vector3(uParam0->[uParam0->f_57.f_2].f_8.f_3);
...
{
	uParam0->f_57.f_13(!func_8(&(uParam0->f_57), 5), &uParam0->[uParam0->f_57.f_2], uParam0->f_57.f_2);
...
BOOL func_47(var uParam0) // Position - 0x139C
{
	...
	for (i = 0; i < NETWORK::NETWORK_GET_MAX_NUM_PARTICIPANTS(); i = i + 1)
	{
		if (NETWORK::NETWORK_IS_PARTICIPANT_ACTIVE(PLAYER::INT_TO_PARTICIPANTINDEX(i)))
		{
			...
			if (playerIndex != PLAYER::PLAYER_ID() && _NETWORK_IS_PLAYER_VALID(playerIndex, true, true) && func_50(PLAYER::GET_PLAYER_PED(playerIndex), &uParam0->[uParam0->f_57.f_2]))
				return 1;
		}
	}
...
void func_72(int iParam0, var uParam1, var uParam2) // Position - 0x187C
{
	...
	{
		uParam1->[uParam2->[i]] = 2;
		uParam1->[uParam2->[i]].f_8 = Vector3(func_75(func_76(i), num) + unk);
		uParam1->[uParam2->[i]].f_8.f_3 = Vector3(0f, 0f, num + 174f);
		uParam1->[uParam2->[i]].f_1 = Vector3(func_75(func_74(i), num) + unk);
		uParam1->[uParam2->[i]].f_1.f_3 = Vector3(func_75(func_73(i), num) + unk);
...
Vector3 func_76(int iParam0) // Position - 0x1A0B
{
	...
	{
		case 0:
			return Vector3(-59.42f, 4832.75f, 391.558f) - func_77();
	
		case 1:
			return Vector3(-59.42f, 4832.75f, 392.858f) - func_77();
...
{
	return func_78() + Vector3(0f, -8.946f, 47.215f);
}
...
void func_79(int iParam0, var uParam1, var uParam2) // Position - 0x1A86
{
	...
	*uParam1 = Vector3(*uParam1 + func_78());
	return;
}
