...
Vector3 func_38(var uParam0) // Position - 0xEEA
{
	...
	unk = { uParam0->[uParam0->f_57.f_2].f_8.f_3 };
...
void func_71() // Position - 0x1845
{
	...
	unk[0] = 0;
	unk[1] = 1;
	func_72(5, &uLocal_96, &unk);
	unk[0] = 2;
	unk[1] = 3;
	func_72(6, &uLocal_96, &unk);
	return;
}
...
void func_72(int iParam0, var uParam1, var uParam2) // Position - 0x187C
{
	...
	{
		uParam1->[uParam2->[i]] = 2;
		uParam1->[uParam2->[i]].f_8 = { func_75(func_76(i), num) + unk };
		uParam1->[uParam2->[i]].f_8.f_3 = { 0f, 0f, num + 174f };
		uParam1->[uParam2->[i]].f_1 = { func_75(func_74(i), num) + unk };
		uParam1->[uParam2->[i]].f_1.f_3 = { func_75(func_73(i), num) + unk };
