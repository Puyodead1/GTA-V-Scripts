...
void main() // Position - 0x0
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(obScriptParam_300))
	{
		obLocal_39 = obScriptParam_300;
...
char* func_31() // Position - 0x1058
{
	...
	distanceBetweenCoords = MISC::GET_DISTANCE_BETWEEN_COORDS(gameplayCamCoord, uLocal_271[0], true);
	distanceBetweenCoords2 = MISC::GET_DISTANCE_BETWEEN_COORDS(gameplayCamCoord, uLocal_271[1], true);
...
{
	uLocal_271[0] = { -10.1749f, 517.8317f, 175.192f };
	uLocal_271[1] = { -7.694f, 516.4619f, 175.2034f };
	uLocal_271[2] = { -8.0344f, 518.4184f, 175.1866f };
	uLocal_271[3] = { -9.7451f, 515.6803f, 175.1711f };
	return;
}
...
BOOL func_42(Player plParam0, int iParam1) // Position - 0x1865
{
	BOOL flag;
...
int func_43(int iParam0, BOOL bParam1) // Position - 0x18BE
{
	int num;
	int num2;
...
int func_44() // Position - 0x18FF
{
	return Global_1574918;
}

BOOL func_45(Player plParam0) // Position - 0x190B
{
	Player player;
...
BOOL func_46(Player plParam0) // Position - 0x192D
{
...
BOOL func_47() // Position - 0x196C
{
	return IS_BIT_SET(Global_2621446, 3);
}

int func_48(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x197A
{
	int num;
...
void func_49(int iParam0) // Position - 0x19AD
{
	if (iParam0 == 1)
...
BOOL func_50(BOOL bParam0, BOOL bParam1, BOOL bParam2) // Position - 0x19D0
{
...
void func_51(char* sParam0) // Position - 0x1AB5
{
...
BOOL func_53(Vector3 vParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5) // Position - 0x1BA6
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false) && !FIRE::IS_ENTITY_ON_FIRE(PLAYER::PLAYER_PED_ID()) && PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()))
		{
			if (!FIRE::IS_EXPLOSION_IN_SPHERE(-1, vParam0, 2f))
			{
				...
				{
					if (Global_97741 && Global_97742 || func_55())
						return false;
...
BOOL func_54(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, BOOL bParam7) // Position - 0x1C59
{
	if (fParam6 < 0f)
		fParam6 = 0f;
...
BOOL func_57(int iParam0) // Position - 0x1DAD
{
	if (iParam0 == 1)
		if (Global_20500.f_1 > 3)
...
Vector3 func_58() // Position - 0x1E04
{
	var unk;
...
BOOL func_63(Entity eParam0) // Position - 0x20A7
{
	if (Global_78689)
		return true;
...
BOOL func_64() // Position - 0x214A
{
	switch (hLocal_38)
	{
		...
		case joaat("prop_rolled_sock_02"):
			if (_GET_CURRENT_PLAYER_CHARACTER() == CHAR_TREVOR || Global_78689)
				return true;
			break;
	
		case joaat("prop_mr_raspberry_01"):
			if (G_MissionStats.f_7264.f_227[145] == 1)
				if (_GET_CURRENT_PLAYER_CHARACTER() == CHAR_TREVOR)
					if (Global_95819[13] != 127 && Global_95819[13] != 135 && Global_95835 != 127 && Global_95835 != 135 && !func_66() && !func_68())
						return true;
			break;
...
BOOL func_65(int iParam0) // Position - 0x247F
{
...
BOOL func_67(int iParam0) // Position - 0x24C6
{
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, Ped pedParam2, char* sParam3, int iParam4, int iParam5) // Position - 0x250E
{
...
BOOL func_72(int iParam0) // Position - 0x25E9
{
	if (Global_43377 == 15)
		return false;
...
BOOL _CAN_ENTER_FREEROAM_STATE(int iParam0) // Position - 0x260B
{
	return func_74(iParam0, Global_43377);
}

BOOL func_74(int iParam0, int iParam1) // Position - 0x261C
{
	if (iParam1 == 15)
		return 1;
