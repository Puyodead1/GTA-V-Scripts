...
void main() // Position - 0x0
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(obScriptParam_302))
	{
		obLocal_41 = obScriptParam_302;
...
void func_1() // Position - 0x171
{
	...
	switch (iLocal_293)
	{
		...
		case 2:
			...
			{
				caLocal_295 = CAM::CREATE_CAM("DEFAULT_ANIMATED_CAMERA", true);
