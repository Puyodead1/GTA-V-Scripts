...
void main() // Position - 0x0
{
	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (num != -1)
		{
			if (Global_112735[num].f_9 != -1)
			{
				...
				func_294(&(Global_112735[num].f_9));
			}
		}
	...
	if (num == 32)
	{
		VEHICLE::SET_ALL_VEHICLE_GENERATORS_ACTIVE_IN_AREA(Vector3(35f, 3409f, 322f) - Vector3(20f, 20f, 20f), Vector3(35f, 3409f, 322f) + Vector3(20f, 20f, 20f), false, true);
		VEHICLE::REMOVE_VEHICLES_FROM_GENERATORS_IN_AREA(Vector3(35f, 3409f, 322f) - Vector3(20f, 20f, 20f), Vector3(35f, 3409f, 322f) + Vector3(20f, 20f, 20f), 0);
...
BOOL IS_PLAYSTATION_PLATFORM() // Position - 0x8DD9
{
	return MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION();
}

BOOL IS_XBOX_PLATFORM() // Position - 0x8DEF
{
	return MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION();
}

void func_112(char* sParam0, Any anParam1, int iParam2) // Position - 0x8E05
{
...
BOOL func_227(Ped pedParam0, Ped pedParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xEA7A
{
	...
	flag = func_228(&iLocal_37[num], pedBoneCoords, pedParam1, &(iLocal_37[num].f_3), pedParam0, iParam5);
...
BOOL func_228(var uParam0, Vector3 vParam1, var uParam2, var uParam3, Ped pedParam4, var uParam5, Ped pedParam6, int iParam7) // Position - 0xEB3B
{
	...
	if (*uParam0 == 0)
	{
		endCoords = Vector3(func_229(pedParam4, iParam7));
...
BOOL func_231(Ped pedParam0, Ped pedParam1, int iParam2, int iParam3) // Position - 0xED76
{
	...
	unk = Vector3(func_233(ENTITY::GET_ENTITY_COORDS(pedParam1, true) - ENTITY::GET_ENTITY_COORDS(pedParam0, true)));
	...
	if (iParam3 == 0)
		...
		entityForwardVector = Vector3(func_233(PED::GET_PED_BONE_COORDS(pedParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(pedParam0, 31086, 0f, 0f, 0f)));
...
BOOL func_240(Ped pedParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0xF185
{
	...
	unk = Vector3(func_233(uParam1 - ENTITY::GET_ENTITY_COORDS(pedParam0, true)));
...
BOOL func_252(var uParam0) // Position - 0xF4DF
{
	...
	switch (iLocal_91)
	{
		case 0:
			...
			uParam0->f_25 = 1;
			uParam0->f_17[0] = Vector3(-303.51196f, 6211.8096f, 30.487585f);
			uParam0->f_17[1] = Vector3(20f, 20f, 3f);
			func_261(&(uParam0->f_48), "rcmminute3base", "base", "beckon");
			uParam0->f_48.f_5 = Vector3(-303.73f, 6211.56f, 31.49f);
			uParam0->f_48.f_8 = Vector3(0f, 0f, -2.8f);
...
void func_278(var uParam0, BOOL bParam1) // Position - 0x10497
{
	...
	if (*uParam0 == 32)
		VEHICLE::SET_ALL_VEHICLE_GENERATORS_ACTIVE_IN_AREA(Vector3(35f, 3409f, 322f) - Vector3(20f, 20f, 20f), Vector3(35f, 3409f, 322f) + Vector3(20f, 20f, 20f), true, true);
	else if (*uParam0 == 34)
