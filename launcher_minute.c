	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (num != -1)
		{
			if (Global_112897[num].f_9 != -1)
			{
				...
				func_299(&(Global_112897[num].f_9));
			}
		}
...
BOOL func_232(Ped pedParam0, Ped pedParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xEB69
{
	...
	flag = func_233(&iLocal_35[num], pedBoneCoords, pedParam1, &(iLocal_35[num].f_3), pedParam0, iParam5);
...
BOOL func_257(var uParam0) // Position - 0xF5CE
{
	...
	switch (iLocal_89)
	{
		case 0:
			...
			uParam0->f_25 = 1;
			uParam0->f_17[0] = { -303.51196f, 6211.8096f, 30.487585f };
			uParam0->f_17[1] = { 20f, 20f, 3f };
