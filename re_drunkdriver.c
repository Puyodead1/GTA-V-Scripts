...
void main() // Position - 0x0
{
	...
	uLocal_87 = Vector3(-1034.6f, 4918.6f, 205.9f);
	iLocal_124 = -1;
	TEXT_LABEL_ASSIGN_STRING(&uLocal_137, "", 24);
	iLocal_165 = -1;
	uLocal_339 = Vector3(-1017.3451f, -1354.1962f, 4.4568f);
	uLocal_342 = Vector3(2003.4564f, 3071.1018f, 46.0499f);
	uLocal_57 = Vector3(uScriptParam_348.f_1[0]);
	func_280();
	...
	if (iLocal_54 == 1 && iLocal_55 == 7 && iLocal_64 == 5 && bLocal_110)
	{
		...
		if (func_2())
			if (VEHICLE::IS_VEHICLE_DRIVEABLE(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false), false))
				uLocal_160 = Vector3(ENTITY::GET_ENTITY_SPEED_VECTOR(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false), false));
	}
...
void func_5(BOOL bParam0) // Position - 0x8CB
{
	...
	{
		uLocal_143 = Vector3(func_9());
		uLocal_137 = Vector3(func_8());
		func_6();
		bLocal_136 = true;
	}
...
BOOL func_33(char* sParam0) // Position - 0x12B8
{
	...
	if (_CONVERSATION_IS_DIALOGUE_IN_PROGRESS())
	{
		TEXT_LABEL_COPY(&string2, Vector3(func_9()), 4);
...
BOOL func_74() // Position - 0x27D2
{
	...
	if (MISC::IS_BULLET_IN_AREA(uLocal_152, 40f, true) || MISC::IS_BULLET_IN_AREA(_GET_PLAYER_COORDS(PLAYER::PLAYER_ID()), 10f, false) || MISC::IS_PROJECTILE_IN_AREA(uLocal_152 - Vector3(40f, 40f, 40f), uLocal_152 + Vector3(40f, 40f, 40f), false))
		return true;
...
BOOL _STAT_GET_PACKED_BOOL(int iParam0, int iParam1) // Position - 0x5A2A
{
	if (iParam1 == -1)
		iParam1 = func_47();
		...
		case 2:
			...
			if (iLocal_125 - 1000 < MISC::GET_GAME_TIMER())
			{
				if (!PED::IS_PED_INJURED(uLocal_91[0]))
				{
					...
					{
						TASK::OPEN_SEQUENCE_TASK(&iLocal_99);
						TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, uLocal_84 - Vector3(0f, 0f, 1f), 1f, -1, 1048576000, 0, 1193033728);
						TASK::CLOSE_SEQUENCE_TASK(iLocal_99);
						TASK::TASK_PERFORM_SEQUENCE(uLocal_91[0], iLocal_99);
						TASK::CLEAR_SEQUENCE_TASK(&iLocal_99);
						PED::SET_PED_KEEP_TASK(uLocal_91[0], true);
...
BOOL func_130(int iParam0) // Position - 0x7AB1
{
	int num;
	int num2;
...
void func_135(var uParam0, var uParam1, var uParam2, int iParam3) // Position - 0x7E55
{
	...
	if (func_2())
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false), false))
			entitySpeedVector = Vector3(ENTITY::GET_ENTITY_SPEED_VECTOR(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false), false));

	num = Vector3(entitySpeedVector - uParam0);
	num = Vector3(func_136(num, iParam3));
...
Blip func_142(Vector3 vParam0, var uParam1, var uParam2, BOOL bParam3) // Position - 0x8872
{
	Blip blip;
...
void func_172() // Position - 0x96FB
{
	if (!bLocal_61)
	{
		...
		PED::ADD_SCENARIO_BLOCKING_AREA(uLocal_68 - Vector3(8f, 8f, 8f), uLocal_68 + Vector3(8f, 8f, 8f), false, true, true, true);
		VEHICLE::SET_ALL_VEHICLE_GENERATORS_ACTIVE_IN_AREA(uLocal_76 - Vector3(10f, 15f, 15f), uLocal_76 + Vector3(10f, 15f, 15f), false, true);
		VEHICLE::SET_ALL_VEHICLE_GENERATORS_ACTIVE_IN_AREA(uLocal_81 - Vector3(10f, 15f, 15f), uLocal_81 + Vector3(10f, 15f, 15f), false, true);
		...
		if (iLocal_54 == 2)
		{
			PED::ADD_SCENARIO_BLOCKING_AREA(uLocal_81 - Vector3(10f, 50f, 30f), uLocal_81 + Vector3(10f, 50f, 30f), false, true, true, true);
...
void func_180() // Position - 0xA2EA
{
	if (iLocal_54 == 1)
	{
		uLocal_152 = Vector3(-1018.2382f, -1350.1014f, 4.475f);
		iLocal_90 = 2;
		hLocal_96 = joaat("A_M_Y_BeachVesp_01");
		hLocal_97 = joaat("A_M_Y_BeachVesp_02");
		uLocal_68 = Vector3(-1016.7623f, -1356.459f, 4.5531f);
		fLocal_71 = 247.8087f;
		uLocal_72 = Vector3(-1015.572f, -1357.081f, 4.552f);
		fLocal_75 = 66.3861f;
		uLocal_76 = Vector3(-1027.7618f, -1341.6439f, 4.4614f);
		fLocal_79 = 76.9418f;
		hLocal_98 = joaat("baller2");
		uLocal_81 = Vector3(160.8892f, -111.4167f, 61.2999f);
		uLocal_84 = Vector3(159.2191f, -117.0664f, 61.2999f);
		bLocal_60 = true;
	}

	if (iLocal_54 == 2)
	{
		uLocal_152 = Vector3(1893.8561f, 3714.3457f, 31.7771f);
		iLocal_90 = 2;
		hLocal_96 = joaat("A_M_Y_GenStreet_01");
		hLocal_97 = joaat("A_F_Y_Hipster_03");
		uLocal_68 = Vector3(1893.8561f, 3714.3457f, 31.7771f);
		fLocal_71 = 252.0142f;
		uLocal_72 = Vector3(1894.7627f, 3714.1604f, 31.7605f);
		fLocal_75 = 86.1102f;
		uLocal_76 = Vector3(1888.2565f, 3717.1892f, 31.8394f);
		fLocal_79 = 299.4672f;
		hLocal_98 = joaat("emperor");
		uLocal_81 = Vector3(1120.5507f, 2647.3071f, 36.9963f);
		uLocal_84 = Vector3(1121.8657f, 2641.7068f, 37.1487f);
		bLocal_60 = true;
	}
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_232() || Global_112695 || Global_32166 || func_231() || func_30(8, -1) || func_230() || func_229() || func_228() || func_227() || G_SomeGlobalState.MessageCallStates.f_919[character] == 5)
							return false;
						break;
				
					case 1:
						if (PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_232() || Global_32166 || func_231() || func_30(8, -1) || func_228() || func_230() || func_229() || func_227() || G_SomeGlobalState.MessageCallStates.f_919[character] == 5)
							return false;
						break;
				
					case 2:
						if (!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_232() || Global_112695 || Global_32166 || func_231() || func_30(8, -1) || func_228() || func_230() || func_229() || func_227() || G_SomeGlobalState.MessageCallStates.f_919[character] == 5 || LastDispatchedMessageOrCall != -1)
							return false;
						break;
				
					case 3:
						if (PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_232() || Global_112695 || Global_32166 || func_231() || func_30(8, -1) || func_230() || func_229() || func_227() || G_SomeGlobalState.MessageCallStates.f_919[character] == 5)
							return false;
						break;
				
					case 4:
						if (func_232() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0 || func_30(8, -1) || func_227() || func_226() || G_SomeGlobalState.MessageCallStates.f_919[character] == 5)
							return false;
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
							if (PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0 || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || func_232() || Global_32166 || func_231() || func_30(8, -1) || func_229() || func_228() || func_227() || G_SomeGlobalState.MessageCallStates.f_919[character] == 5)
								return false;
						break;
				
					case 7:
						if (PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || !CAM::IS_SCREEN_FADED_IN() || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_232() || func_229() || Global_112695 || Global_32166 || func_231() || Global_44446 || func_30(8, -1) || func_228() || func_226() || func_227() || G_SomeGlobalState.MessageCallStates.f_919[character] == 5)
							return false;
						break;
...
void func_240() // Position - 0xD760
{
	...
	if (bLocal_172)
	{
		...
		VEHICLE::SET_ALL_VEHICLE_GENERATORS_ACTIVE_IN_AREA(uLocal_76 - Vector3(10f, 15f, 15f), uLocal_76 + Vector3(10f, 15f, 15f), true, true);
		VEHICLE::SET_ALL_VEHICLE_GENERATORS_ACTIVE_IN_AREA(uLocal_81 - Vector3(10f, 15f, 15f), uLocal_81 + Vector3(10f, 15f, 15f), true, true);
		func_156(false);
...
BOOL IS_PLAYSTATION_PLATFORM() // Position - 0x1254A
{
	return MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION();
}

BOOL IS_XBOX_PLATFORM() // Position - 0x12560
{
