	...
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2657704[plParam0].f_321.f_7 != -1)
				return func_83(Global_2657704[plParam0].f_321.f_7) == 15;
...
BOOL func_91(Ped pedParam0) // Position - 0x2C03
{
...
void func_92(BOOL bParam0, Ped pedParam1, int iParam2) // Position - 0x2C34
{
	int num;
	eViewModeContext i;
...
void _MPPLY_STAT_SET_BOOL(Hash hParam0, BOOL bParam1) // Position - 0x2D04
{
	Hash statName;
...
BOOL func_95(Player plParam0) // Position - 0x2D78
{
...
BOOL func_97(Player plParam0, int iParam1) // Position - 0x2DC5
{
	BOOL flag;
...
BOOL func_100(Player plParam0) // Position - 0x2E6B
{
	Player player;
...
void func_104(int iParam0, var uParam1, int iParam2, int iParam3) // Position - 0x2FC3
{
	...
	uParam1->f_16[iParam2].f_6.f_1 = { func_106(func_108(), func_107(iParam3, num)) + unk };
	uParam1->f_16[iParam2].f_6.f_4 = { func_106(func_105(), func_107(iParam3, num)) + unk };
...
Vector3 func_106(float fParam0, var uParam1, var uParam2, float fParam3) // Position - 0x3067
{
	float num;
	float unk;
	float unk2;
