...
void main() // Position - 0x0
{
	...
	uLocal_52 = Vector3(-343.37607f, -2633.535f, 5.00103f);
	iLocal_396 = -1;
	uLocal_411 = Vector3(327.263f, -2968.799f, -3f);
	fLocal_414 = 358.5f;
	hLocal_415 = joaat("prop_dock_crane_02_ld");
	uLocal_416 = Vector3(305.053f, -2971.395f, 4.99f);
	fLocal_419 = 90f;
	hLocal_420 = joaat("prop_dock_crane_02_cab");
	uLocal_421 = Vector3(0f, 0f, 19.907f);
	fLocal_424 = 0f;
	hLocal_425 = joaat("prop_dock_crane_02_hook");
	uLocal_426 = Vector3(-0.005f, -22.139f, -15f);
	fLocal_429 = 0f;
...
void func_8() // Position - 0x3D9
{
	switch (iLocal_2134)
	{
		case 0:
			...
			if (func_107(uLocal_55[0]))
				ENTITY::SET_ENTITY_PROOFS(uLocal_55[0], false, false, false, true, false, false, false, false);
		
			VEHICLE::SET_VEHICLE_CAN_BE_VISIBLY_DAMAGED(uLocal_55[0], false);
			VEHICLE::SET_VEHICLE_CAN_BE_VISIBLY_DAMAGED(uLocal_55[1], false);
			...
			ENTITY::SET_CAN_CLIMB_ON_ENTITY(uLocal_55[0], false);
			VEHICLE::SET_VEHICLE_IS_CONSIDERED_BY_PLAYER(uLocal_55[0], false);
		...
		case 1:
			if (func_107(PLAYER::PLAYER_PED_ID()) && func_107(uLocal_55[0]))
				if (MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(uLocal_55[0], true), true) > 400f && !ENTITY::IS_ENTITY_ON_SCREEN(uLocal_55[0]))
					func_93(9);
		
			if (func_92(PLAYER::PLAYER_PED_ID(), 324.76532f, -2974.4946f, -1.5f, true) > 150f)
			{
				func_91(&uLocal_169[7], false);
				func_91(&uLocal_169[8], false);
				func_91(&uLocal_169[6], false);
			...
			else if (bLocal_453)
			{
				if (func_92(PLAYER::PLAYER_PED_ID(), uLocal_52, true) > 220f)
				{
					...
					if (ENTITY::DOES_ENTITY_EXIST(uLocal_55[3]))
						VEHICLE::DELETE_VEHICLE(&uLocal_55[3]);
				}
				else if (func_92(PLAYER::PLAYER_PED_ID(), uLocal_52, true) < 200f)
				{
					if (bLocal_454 && STREAMING::HAS_MODEL_LOADED(joaat("bison")))
					{
						if (!ENTITY::DOES_ENTITY_EXIST(uLocal_55[3]))
						{
							uLocal_55[3] = VEHICLE::CREATE_VEHICLE(joaat("bison"), -317.0741f, -2594.1404f, 5.0004f, 316.2352f, true, true, false);
							VEHICLE::SET_VEHICLE_IS_CONSIDERED_BY_PLAYER(uLocal_55[3], false);
						}
			...
			if (ENTITY::IS_ENTITY_ATTACHED_TO_ENTITY(uLocal_55[1], PLAYER::GET_PLAYERS_LAST_VEHICLE()) || ENTITY::IS_ENTITY_IN_ANGLED_AREA(uLocal_55[2], -333.6057f, -2623.681f, 5.00103f, -350.12717f, -2640.339f, 12.65742f, 15f, false, true, 0) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(uLocal_64[3], -333.6057f, -2623.681f, 5.00103f, -350.12717f, -2640.339f, 12.65742f, 15f, false, true, 0) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(uLocal_55[0], -333.6057f, -2623.681f, 5.00103f, -350.12717f, -2640.339f, 12.65742f, 15f, false, true, 0))
			{
				if (func_107(uLocal_55[1]))
					VEHICLE::SET_TRAILER_INVERSE_MASS_SCALE(uLocal_55[1], 0.5f);
				...
				if (func_48(&uLocal_188, uLocal_52, 0.1f, 0.1f, 2f, true, uLocal_64[3], 0, 0, PLAYER::GET_PLAYERS_LAST_VEHICLE(), "dkp1_tk2", "DKP1_ABFLD", "", "", "", "DKP1_TRUCK", "DKP1_TRUCKBK", false, true, true, INVALID) || HUD::DOES_BLIP_EXIST(uLocal_188.f_5) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::GET_PLAYERS_LAST_VEHICLE(), -340.13245f, -2630.2427f, 5.001461f, -346.55075f, -2636.8076f, 12.688959f, 14.9375f, false, true, 0))
				{
					...
					VEHICLE::SET_VEHICLE_IS_CONSIDERED_BY_PLAYER(uLocal_55[0], false);
					VEHICLE::SET_VEHICLE_DOORS_LOCKED(uLocal_55[0], 10);
			...
			else if (!ENTITY::IS_ENTITY_ATTACHED_TO_ENTITY(uLocal_55[1], PLAYER::GET_PLAYERS_LAST_VEHICLE()))
			{
				func_41(&uLocal_188);
			
				if (!HUD::DOES_BLIP_EXIST(blLocal_378))
					blLocal_378 = func_38(uLocal_55[0], false, false);
		...
		case 2:
			if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
			{
				...
				{
					PED::SET_PED_KEEP_TASK(uLocal_64[3], true);
					TASK::TASK_LOOK_AT_ENTITY(uLocal_64[3], PLAYER::PLAYER_PED_ID(), -1, SLF_WHILE_NOT_IN_FOV, 2);
					...
					TASK::TASK_PERFORM_SEQUENCE(uLocal_64[3], iLocal_379);
					TASK::CLEAR_SEQUENCE_TASK(&iLocal_379);
					iLocal_2134 = iLocal_2134 + 1;
				}
			}
		...
		case 3:
			...
			{
				if (func_107(uLocal_55[3]))
				{
					TASK::CLEAR_PED_TASKS(uLocal_64[3]);
					TASK::CLEAR_SEQUENCE_TASK(&iLocal_379);
					TASK::OPEN_SEQUENCE_TASK(&iLocal_379);
					TASK::TASK_ENTER_VEHICLE(0, uLocal_55[3], -1, -1, 2f, 1, 0);
					TASK::TASK_VEHICLE_MISSION_COORS_TARGET(0, uLocal_55[3], -189.8985f, -2622.707f, 5.0001f, 14, 30f, 786468, 5f, 1f, true);
					TASK::TASK_VEHICLE_MISSION_PED_TARGET(0, uLocal_55[3], PLAYER::PLAYER_PED_ID(), 8, 30f, 786468, 1000f, 10f, true);
					TASK::CLOSE_SEQUENCE_TASK(iLocal_379);
					TASK::TASK_PERFORM_SEQUENCE(uLocal_64[3], iLocal_379);
					TASK::CLEAR_SEQUENCE_TASK(&iLocal_379);
				}
				...
				{
					TASK::CLEAR_PED_TASKS(uLocal_64[3]);
					TASK::TASK_SMART_FLEE_COORD(uLocal_64[3], uLocal_52, 300f, -1, false, false);
				}
		...
		case 4:
			if (func_10(uLocal_64[3], PLAYER::PLAYER_PED_ID(), true) > 70f || MISC::GET_GAME_TIMER() - iLocal_452 > 20000)
			{
				func_9(&uLocal_64[3], true, 0, 1);
				func_3();
			}
			break;
	}
	...
	if (num == 1)
	{
		...
		else
		{
			...
			if (num4 != -1)
			{
				...
				TEXT_LABEL_COPY(&unk3, Vector3(func_186(num4)), 4);
...
BOOL func_133(int iParam0, int iParam1) // Position - 0x73B5
{
	...
	statHash = Global_2848282[iParam0][func_131(iParam1)];
...
void func_137(Ped pedParam0, BOOL bParam1) // Position - 0x7B84
{
	...
	if (func_26(character) && !PED::IS_PED_INJURED(pedParam0))
	{
		if (pedParam0 == PLAYER::PLAYER_PED_ID())
		{
			func_138(pedParam0, &Global_113648.f_2365.f_539.f_298[character]);
...
BOOL func_161(int iParam0, int iParam1, var uParam2, int iParam3, BOOL bParam4) // Position - 0xAECF
{
	...
	if (!bParam4)
		unk12 = Vector3(func_164(iParam0));
	else
		unk12 = Vector3(func_163(iParam0));

	vector2 = Vector3(unk12 - unk);
	vector2 = Vector3(func_162(vector2, -unk.f_3.f_2));
	vector2 = Vector3(func_162(vector2, vector.f_3.f_2));
...
void func_197() // Position - 0xE4BC
{
	...
	switch (iLocal_2134)
	{
		case 0:
			...
			func_228(&uLocal_188, 324.76532f, -2974.4946f, -1f, 0.1f, 0.1f, 2f, true, uLocal_55[0], "dkp1_tk1", "", "DKP1_SUBBK", true, 0, true, INVALID);
			...
			if (STREAMING::HAS_MODEL_LOADED(joaat("packer")) && STREAMING::HAS_MODEL_LOADED(joaat("armytrailer")))
			{
				...
				func_225(6, 0);
				uLocal_55[2] = VEHICLE::CREATE_VEHICLE(joaat("packer"), 298.2343f, -2942.7698f, 5.0003f, 0f, true, true, false);
				VEHICLE::SET_VEHICLE_IS_CONSIDERED_BY_PLAYER(uLocal_55[2], false);
				VEHICLE::SET_VEHICLE_HAS_STRONG_AXLES(uLocal_55[2], true);
				VEHICLE::SET_VEHICLE_COLOUR_COMBINATION(uLocal_55[2], 0);
				VEHICLE::SET_VEHICLE_TYRES_CAN_BURST(uLocal_55[2], false);
				uLocal_55[1] = VEHICLE::CREATE_VEHICLE(joaat("armytrailer"), 298.27f, -2951.27f, 7.86f, 0f, true, true, false);
				VEHICLE::ATTACH_VEHICLE_TO_TRAILER(uLocal_55[2], uLocal_55[1], 0.5f);
				VEHICLE::SET_TRAILER_LEGS_RAISED(uLocal_55[1]);
				VEHICLE::SET_VEHICLE_TYRES_CAN_BURST(uLocal_55[1], false);
				VEHICLE::SET_VEHICLE_HAS_STRONG_AXLES(uLocal_55[1], true);
				bLocal_383 = false;
		...
		case 2:
			if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), uLocal_55[0], false))
			{
				switch (iLocal_397)
				{
					case 0:
			...
			if (VEHICLE::IS_VEHICLE_STUCK_TIMER_UP(uLocal_55[0], 3, 10000))
				func_93(1);
			...
			if (func_107(uLocal_64[6]))
			{
				if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 1240.5132f, -2880.3557f, 2.10339f, 1240.5594f, -3057.2708f, 17.4f, 29.45f, false, true, 0) || PED::IS_PED_FLEEING(uLocal_64[6]) || func_10(PLAYER::PLAYER_PED_ID(), uLocal_64[6], true) > 100f)
				{
					TASK::CLEAR_PED_TASKS(uLocal_64[6]);
					func_9(&uLocal_64[6], true, 0, 1);
				}
			}
		
			if (func_107(uLocal_64[7]))
			{
				if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 1240.5132f, -2880.3557f, 2.10339f, 1240.5594f, -3057.2708f, 17.4f, 29.45f, false, true, 0) || PED::IS_PED_FLEEING(uLocal_64[7]) || func_10(PLAYER::PLAYER_PED_ID(), uLocal_64[7], true) > 100f)
				{
					TASK::CLEAR_PED_TASKS(uLocal_64[7]);
					func_9(&uLocal_64[7], true, 0, 1);
				}
			}
		
			if (func_107(uLocal_64[4]))
			{
				if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 1240.5132f, -2880.3557f, 2.10339f, 1240.5594f, -3057.2708f, 17.4f, 29.45f, false, true, 0) || PED::IS_PED_FLEEING(uLocal_64[4]) || func_10(PLAYER::PLAYER_PED_ID(), uLocal_64[4], true) > 100f)
				{
					TASK::CLEAR_PED_TASKS(uLocal_64[4]);
					func_9(&uLocal_64[4], true, 0, 1);
				}
			}
		
			if (func_107(uLocal_64[5]))
			{
				if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 1240.5132f, -2880.3557f, 2.10339f, 1240.5594f, -3057.2708f, 17.4f, 29.45f, false, true, 0) || PED::IS_PED_FLEEING(uLocal_64[5]) || func_10(PLAYER::PLAYER_PED_ID(), uLocal_64[5], true) > 100f)
				{
					TASK::CLEAR_PED_TASKS(uLocal_64[5]);
					func_9(&uLocal_64[5], true, 0, 1);
				}
			}
		
			if (func_228(&uLocal_188, 324.76532f, -2974.4946f, -1.5f, 0.1f, 0.1f, 2f, false, uLocal_55[0], "dkp1_tk1", "", "DKP1_SUBBK", true, 0, true, INVALID) || HUD::DOES_BLIP_EXIST(uLocal_188.f_5) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(uLocal_55[0], 312.8557f, -2974.0032f, 1.19166f, 339.16544f, -2974.3477f, -6.70078f, 15f, false, true, 0) && func_220(PLAYER::PLAYER_PED_ID(), uLocal_55[0]))
			{
				if (func_107(uLocal_55[2]) && func_107(uLocal_55[1]))
				{
		...
		case 3:
			if (func_82(uLocal_55[0]) || MISC::GET_GAME_TIMER() - iLocal_452 > 3500)
			{
				...
				ENTITY::SET_ENTITY_COORDS(uLocal_55[0], uLocal_411, true, false, false, true);
				ENTITY::SET_ENTITY_HEADING(uLocal_55[0], fLocal_414);
				iLocal_452 = MISC::GET_GAME_TIMER();
				iLocal_410 = 0;
			...
			{
				func_46(uLocal_55[0], 7f, 1, 1056964608, false, true, false);
			}
			break;
		...
		case 5:
			...
			{
				CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(uLocal_55[2], "DockHeist_truck", 0, 0, 0);
				CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(uLocal_55[0], "submarine", 0, joaat("submersible"), 0);
				CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(uLocal_55[1], "dockheist_trailer", 0, joaat("armytrailer"), 0);
				...
				VEHICLE::SET_VEHICLE_LIGHTS(uLocal_55[2], 1);
				VEHICLE::SET_VEHICLE_IS_CONSIDERED_BY_PLAYER(uLocal_55[2], true);
				func_201(0);
		...
		case 6:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uLocal_64[3]))
			{
				if (ENTITY::DOES_ENTITY_EXIST(CUTSCENE::GET_ENTITY_INDEX_OF_REGISTERED_ENTITY("Floyd", 0)))
				{
					uLocal_64[3] = ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(CUTSCENE::GET_ENTITY_INDEX_OF_REGISTERED_ENTITY("Floyd", 0));
					_CONVERSATION_INITIALIZE_ACTOR(&uLocal_213, 1, uLocal_64[3], "FLOYD", 0, 1);
					PED::SET_PED_RELATIONSHIP_GROUP_HASH(uLocal_64[3], hLocal_394);
				}
			}
			...
			{
				VEHICLE::SET_VEHICLE_USE_CUTSCENE_WHEEL_COMPRESSION(uLocal_55[2], true, false, false);
				VEHICLE::SET_VEHICLE_DOORS_SHUT(uLocal_55[2], true);
				bLocal_448 = true;
			}
		
			if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("DockHeist_trailer", 0))
			{
				VEHICLE::SET_VEHICLE_USE_CUTSCENE_WHEEL_COMPRESSION(uLocal_55[1], true, false, false);
				bLocal_451 = true;
			}
			...
			if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("sub_cover", 0))
				bLocal_450 = true;
			else if (!ENTITY::DOES_ENTITY_EXIST(uLocal_169[4]))
				if (ENTITY::DOES_ENTITY_EXIST(CUTSCENE::GET_ENTITY_INDEX_OF_REGISTERED_ENTITY("sub_cover", joaat("prop_sub_cover_01"))))
					uLocal_169[4] = ENTITY::GET_OBJECT_INDEX_FROM_ENTITY_INDEX(CUTSCENE::GET_ENTITY_INDEX_OF_REGISTERED_ENTITY("sub_cover", joaat("prop_sub_cover_01")));
		
			if (VEHICLE::GET_VEHICLE_LIGHTS_STATE(uLocal_55[2], &lightsOn, &highbeamsOn))
				if (lightsOn == 0)
					if (CUTSCENE::GET_CUTSCENE_TIME() >= 14200)
						VEHICLE::SET_VEHICLE_LIGHTS(uLocal_55[2], 3);
		
			if (iLocal_446 && iLocal_447 && bLocal_448 && bLocal_449 && bLocal_450 && bLocal_451)
			{
				if (CAM::IS_SCREEN_FADED_IN() || PED::HAVE_ALL_STREAMING_REQUESTS_COMPLETED(uLocal_64[3]))
				{
					PED::SET_PED_INTO_VEHICLE(uLocal_64[3], uLocal_55[2], 0);
					PED::SET_PED_INTO_VEHICLE(PLAYER::PLAYER_PED_ID(), uLocal_55[2], -1);
					VEHICLE::ATTACH_VEHICLE_ON_TO_TRAILER(uLocal_55[0], uLocal_55[1], 0f, -4f, -0.7f, 0f, 0f, 0f, 0f, 0f, 0f, -1f);
					VEHICLE::SET_VEHICLE_IS_CONSIDERED_BY_PLAYER(uLocal_55[0], false);
					VEHICLE::SET_VEHICLE_DOORS_SHUT(uLocal_55[0], true);
					VEHICLE::SET_VEHICLE_DOORS_LOCKED(uLocal_55[0], 10);
					VEHICLE::SET_VEHICLE_ENGINE_ON(uLocal_55[0], false, true, false);
					VEHICLE::SET_VEHICLE_LIGHTS(uLocal_55[0], 1);
					AUDIO::SET_VEHICLE_RADIO_ENABLED(uLocal_55[0], false);
					ENTITY::ATTACH_ENTITY_TO_ENTITY(uLocal_169[4], uLocal_55[1], -1, uLocal_440, 0f, 0f, 0f, false, false, false, false, 2, true, 0);
					uLocal_169[5] = OBJECT::CREATE_OBJECT(joaat("prop_tarp_strap"), -332.8449f, -2622.1572f, 8.7838f, true, true, false);
					ENTITY::ATTACH_ENTITY_TO_ENTITY(uLocal_169[5], uLocal_55[1], -1, uLocal_440, 0f, 0f, 0f, false, false, false, false, 2, true, 0);
...
BOOL func_202() // Position - 0xF069
{
	...
	switch (iLocal_410)
	{
		case 0:
			...
			ENTITY::SET_ENTITY_COORDS(uLocal_55[0], uLocal_411, true, false, false, true);
			ENTITY::SET_ENTITY_HEADING(uLocal_55[0], fLocal_414);
			ENTITY::FREEZE_ENTITY_POSITION(uLocal_55[0], true);
			iLocal_380 = GRAPHICS::START_PARTICLE_FX_LOOPED_ON_ENTITY("scr_pls_sub_water_drips", uLocal_55[0], 0f, 0f, 0f, 0f, 0f, 0f, 1065353216, false, false, false);
			...
			func_209(&uLocal_460, 298.9806f, -2977.643f, 6.101f, Vector3(7.886f, -2964.6653f, 298.5479f) - Vector3(6.101f, -2977.643f, 298.9806f), 3000f, 0);
			iLocal_410 = iLocal_410 + 1;
			break;
	
		case 1:
			uLocal_430 = Vector3(ENTITY::GET_ENTITY_COORDS(uLocal_169[8], true));
		
			if (uLocal_430.f_2 <= 1f)
			{
				ENTITY::FREEZE_ENTITY_POSITION(uLocal_55[0], false);
				...
				ENTITY::ATTACH_ENTITY_TO_ENTITY(uLocal_55[0], uLocal_169[8], -1, 2.47f, 0f, -1.96f, 0f, 0f, -90f, false, false, false, false, 2, true, 0);
				iLocal_410 = iLocal_410 + 1;
			}
			else
			{
		...
		case 3:
			if (fLocal_424 >= 40f)
			{
				...
				fLocal_424 = 80f;
				ENTITY::DETACH_ENTITY(uLocal_169[7], true, true);
				ENTITY::ATTACH_ENTITY_TO_ENTITY(uLocal_169[7], uLocal_169[6], -1, uLocal_421, 0f, 0f, fLocal_424, false, false, false, false, 2, true, 0);
				ENTITY::SET_ENTITY_COORDS_NO_OFFSET(uLocal_169[8], ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uLocal_169[7], uLocal_426), false, false, true);
		...
		case 5:
			...
			{
				ENTITY::DETACH_ENTITY(uLocal_55[0], true, true);
				iLocal_410 = iLocal_410 + 1;
			}
			else
			{
		...
		case 6:
			if (ENTITY::HAS_ENTITY_COLLIDED_WITH_ANYTHING(uLocal_55[0]))
			{
		...
		case 7:
			...
			{
				ENTITY::FREEZE_ENTITY_POSITION(uLocal_169[8], true);
				iLocal_410 = iLocal_410 + 1;
			}
			else
			{
	...
	else if (CAM::IS_SCREEN_FADED_OUT())
	{
		...
		GRAPHICS::REMOVE_PARTICLE_FX_IN_RANGE(ENTITY::GET_ENTITY_COORDS(uLocal_55[0], true), 30f);
		iLocal_2138 = 2;
		bLocal_2137 = true;
	}
...
int func_209(var uParam0, float fParam1, float fParam2, float fParam3, Vector3 vParam4, var uParam5, var uParam6, float fParam7, int iParam8) // Position - 0xF75F
{
	...
	else
	{
		...
		uParam0->f_898.f_4 = Vector3(fParam1);
		uParam0->f_898.f_7 = Vector3(vParam4);
...
void func_210() // Position - 0xF845
{
	if (bLocal_383)
	{
		PHYSICS::DELETE_ROPE(&iLocal_145[0]);
		PHYSICS::DELETE_ROPE(&iLocal_145[1]);
		PHYSICS::DELETE_ROPE(&iLocal_145[2]);
		PHYSICS::DELETE_ROPE(&iLocal_145[3]);
		bLocal_383 = false;
	}
...
{
	if (!ENTITY::DOES_ENTITY_EXIST(uLocal_169[6]))
	{
		uLocal_169[6] = OBJECT::CREATE_OBJECT(hLocal_415, uLocal_416, true, true, false);
		ENTITY::SET_ENTITY_COORDS(uLocal_169[6], uLocal_416, true, false, false, true);
		ENTITY::SET_ENTITY_HEADING(uLocal_169[6], fLocal_419);
		ENTITY::FREEZE_ENTITY_POSITION(uLocal_169[6], true);
	}

	if (!ENTITY::DOES_ENTITY_EXIST(uLocal_169[7]))
		uLocal_169[7] = OBJECT::CREATE_OBJECT(hLocal_420, ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uLocal_169[6], uLocal_421), true, true, false);

	if (!ENTITY::IS_ENTITY_ATTACHED_TO_ENTITY(uLocal_169[7], uLocal_169[6]))
		ENTITY::ATTACH_ENTITY_TO_ENTITY(uLocal_169[7], uLocal_169[6], -1, uLocal_421, 0f, 0f, fLocal_424, false, false, false, false, 2, true, 0);

	if (!ENTITY::DOES_ENTITY_EXIST(uLocal_169[8]))
	{
		uLocal_169[8] = OBJECT::CREATE_OBJECT(hLocal_425, ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uLocal_169[7], uLocal_426), true, true, false);
		ENTITY::SET_ENTITY_SHOULD_FREEZE_WAITING_ON_COLLISION(uLocal_169[8], false);
		ENTITY::ATTACH_ENTITY_TO_ENTITY(uLocal_169[8], uLocal_169[7], -1, uLocal_426, 0f, 0f, fLocal_429, false, false, false, false, 2, true, 0);
		ENTITY::DETACH_ENTITY(uLocal_169[8], true, false);
		ENTITY::FREEZE_ENTITY_POSITION(uLocal_169[8], true);
	}

	if (!bLocal_384)
	{
		if (ENTITY::DOES_ENTITY_HAVE_PHYSICS(uLocal_169[7]) && ENTITY::DOES_ENTITY_HAVE_PHYSICS(uLocal_169[8]))
		{
			iLocal_439 = PHYSICS::ADD_ROPE(ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uLocal_169[7], uLocal_433), 0f, 0f, 0f, 70f, 0, -1f, 4f, 1.4f, false, false, true, 1065353216, false, 0);
			...
			PHYSICS::ATTACH_ENTITIES_TO_ROPE(iLocal_439, uLocal_169[7], uLocal_169[8], ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uLocal_169[7], uLocal_433), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uLocal_169[8], uLocal_436), 70f, false, false, 0, 0);
			bLocal_384 = true;
			return true;
		}
	
		!ENTITY::DOES_ENTITY_HAVE_PHYSICS(uLocal_169[7]);
		!ENTITY::DOES_ENTITY_HAVE_PHYSICS(uLocal_169[8]);
	}
...
void func_231() // Position - 0xFFF6
{
	...
	switch (iLocal_2134)
	{
		case 0:
			...
			if (func_107(uLocal_55[0]))
			{
				if (!HUD::DOES_BLIP_EXIST(uLocal_55[0].f_1))
					uLocal_55[0].f_1 = func_38(uLocal_55[0], false, false);
			
				uLocal_166 = Vector3(PHYSICS::GET_CGOFFSET(uLocal_55[0]));
			}
		
			if (ENTITY::DOES_ENTITY_EXIST(uLocal_169[2]) && !HUD::DOES_BLIP_EXIST(blLocal_378))
				blLocal_378 = func_281(uLocal_169[2]);
			...
			if (func_107(uLocal_64[4]))
			{
				PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uLocal_64[4], true);
				TASK::SET_PED_PATH_CAN_USE_CLIMBOVERS(uLocal_64[4], false);
			}
		...
		case 1:
			if (bLocal_383)
			{
				if (!PHYSICS::IS_ROPE_ATTACHED_AT_BOTH_ENDS(&iLocal_145[0]) && !PHYSICS::IS_ROPE_ATTACHED_AT_BOTH_ENDS(&iLocal_145[1]) && !PHYSICS::IS_ROPE_ATTACHED_AT_BOTH_ENDS(&iLocal_145[2]) && !PHYSICS::IS_ROPE_ATTACHED_AT_BOTH_ENDS(&iLocal_145[3]))
				{
					PHYSICS::ROPE_CONVERT_TO_SIMPLE(uLocal_169[0]);
					PHYSICS::ROPE_CONVERT_TO_SIMPLE(uLocal_169[1]);
				
					if (func_107(uLocal_55[0]))
						PHYSICS::SET_CGOFFSET(uLocal_55[0], uLocal_166);
		...
		case 2:
			if (!PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_381) || PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_381) == 1f)
			{
				...
				PHYSICS::DETACH_ROPE_FROM_ENTITY(iLocal_145[0], uLocal_55[0]);
				PHYSICS::DETACH_ROPE_FROM_ENTITY(iLocal_145[1], uLocal_55[0]);
				PHYSICS::DETACH_ROPE_FROM_ENTITY(iLocal_145[2], uLocal_55[0]);
				PHYSICS::DETACH_ROPE_FROM_ENTITY(iLocal_145[3], uLocal_55[0]);
				PHYSICS::ROPE_CONVERT_TO_SIMPLE(uLocal_169[0]);
				PHYSICS::ROPE_CONVERT_TO_SIMPLE(uLocal_169[1]);
				...
				{
					PHYSICS::SET_CGOFFSET(uLocal_55[0], uLocal_166);
					PHYSICS::ACTIVATE_PHYSICS(uLocal_55[0]);
				}
		...
		case 5:
			entityCoords = Vector3(ENTITY::GET_ENTITY_COORDS(uLocal_55[0], true));
		
			if (ENTITY::GET_ENTITY_SUBMERGED_LEVEL(uLocal_55[0]) > 0f || entityCoords.f_2 < -0.5f)
			{
				PHYSICS::DELETE_CHILD_ROPE(iLocal_145[0]);
				PHYSICS::DELETE_CHILD_ROPE(iLocal_145[1]);
				PHYSICS::DELETE_CHILD_ROPE(iLocal_145[2]);
				PHYSICS::DELETE_CHILD_ROPE(iLocal_145[3]);
			...
			if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), uLocal_55[0], false))
			{
				...
				{
					uLocal_64[6] = PED::CREATE_PED(PED_TYPE_MISSION, joaat("S_M_M_Security_01"), 1229.5575f, -3002.8818f, 8.31909f, -30.33f, true, true);
					WEAPON::GIVE_WEAPON_TO_PED(uLocal_64[6], joaat("WEAPON_PISTOL"), -1, false, true);
					PED::SET_PED_CONFIG_FLAG(uLocal_64[6], 330, true);
					PED::SET_PED_AS_COP(uLocal_64[6], true);
					TASK::CLEAR_SEQUENCE_TASK(&iLocal_379);
					TASK::OPEN_SEQUENCE_TASK(&iLocal_379);
					...
					TASK::CLOSE_SEQUENCE_TASK(iLocal_379);
					TASK::TASK_PERFORM_SEQUENCE(uLocal_64[6], iLocal_379);
					TASK::CLEAR_SEQUENCE_TASK(&iLocal_379);
					uLocal_64[7] = PED::CREATE_PED(PED_TYPE_MISSION, joaat("S_M_M_Security_01"), 1229.5575f, -3002.8818f, 8.31909f, -30.33f, true, true);
					PED::SET_PED_CONFIG_FLAG(uLocal_64[7], 330, true);
					WEAPON::GIVE_WEAPON_TO_PED(uLocal_64[7], joaat("WEAPON_PISTOL"), -1, false, true);
					PED::SET_PED_AS_COP(uLocal_64[7], true);
					TASK::CLEAR_SEQUENCE_TASK(&iLocal_379);
					TASK::OPEN_SEQUENCE_TASK(&iLocal_379);
					...
					TASK::TASK_COMBAT_PED(0, PLAYER::PLAYER_PED_ID(), 0, 16);
					TASK::CLOSE_SEQUENCE_TASK(iLocal_379);
					TASK::TASK_PERFORM_SEQUENCE(uLocal_64[7], iLocal_379);
					TASK::CLEAR_SEQUENCE_TASK(&iLocal_379);
					func_89(&uLocal_460, joaat("S_M_M_Security_01"));
				}
				else
				{
					uLocal_64[5] = PED::CREATE_PED(PED_TYPE_MISSION, joaat("S_M_M_DockWork_01"), 1228.9293f, -3015.008f, 8.31909f, 0, true, true);
					PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uLocal_64[5], true);
					TASK::CLEAR_SEQUENCE_TASK(&iLocal_379);
					TASK::OPEN_SEQUENCE_TASK(&iLocal_379);
					...
					TASK::CLOSE_SEQUENCE_TASK(iLocal_379);
					TASK::TASK_PERFORM_SEQUENCE(uLocal_64[5], iLocal_379);
					TASK::CLEAR_SEQUENCE_TASK(&iLocal_379);
					func_89(&uLocal_460, joaat("S_M_M_Security_01"));
				}
				...
				{
					TASK::CLEAR_PED_TASKS(uLocal_64[4]);
					ENTITY::SET_ENTITY_COORDS(uLocal_64[4], 1229.5575f, -3002.8818f, 8.31909f, true, false, false, true);
				}
				else
				{
					uLocal_64[4] = PED::CREATE_PED(PED_TYPE_MISSION, joaat("S_M_M_DockWork_01"), 1229.5575f, -3002.8818f, 8.31909f, -99f, true, true);
				}
			
				PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uLocal_64[4], true);
				AUDIO::STOP_PED_SPEAKING(uLocal_64[4], true);
				TASK::CLEAR_SEQUENCE_TASK(&iLocal_379);
				TASK::OPEN_SEQUENCE_TASK(&iLocal_379);
				TASK::TASK_LOOK_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1, SLF_WIDEST_YAW_LIMIT | 32 | 2048, 2);
				...
				TASK::CLOSE_SEQUENCE_TASK(iLocal_379);
				TASK::TASK_PERFORM_SEQUENCE(uLocal_64[4], iLocal_379);
				TASK::CLEAR_SEQUENCE_TASK(&iLocal_379);
				...
				if (HUD::DOES_BLIP_EXIST(uLocal_55[0].f_1))
					HUD::REMOVE_BLIP(&(uLocal_55[0].f_1));
			
				ENTITY::SET_OBJECT_AS_NO_LONGER_NEEDED(&uLocal_169[3]);
				ENTITY::SET_OBJECT_AS_NO_LONGER_NEEDED(&uLocal_169[0]);
				ENTITY::SET_OBJECT_AS_NO_LONGER_NEEDED(&uLocal_169[1]);
			...
			else if (MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(uLocal_55[0], true), true) < 5f && !bLocal_388)
			{
	...
	if (!bLocal_398 && func_107(uLocal_55[0]) && ENTITY::IS_ENTITY_IN_WATER(uLocal_55[0]))
	{
		AUDIO::PLAY_SOUND_FROM_ENTITY(-1, "SUB_SPLASH", uLocal_55[0], "DOCKS_HEIST_PREP_1_SOUNDSET", false, 0);
		bLocal_398 = true;
	}

	if (!bLocal_383 && ENTITY::DOES_ENTITY_EXIST(uLocal_169[0]) && ENTITY::DOES_ENTITY_EXIST(uLocal_169[1]) && func_107(uLocal_55[0]))
	{
		if (ENTITY::DOES_ENTITY_HAVE_PHYSICS(uLocal_169[0]) && ENTITY::DOES_ENTITY_HAVE_PHYSICS(uLocal_169[1]))
		{
			PHYSICS::SET_CG_AT_BOUNDCENTER(uLocal_55[0]);
			iLocal_145[0] = PHYSICS::ADD_ROPE(1260.6915f, -3008.286f, 23.73365f, 0f, 0f, 0f, fLocal_2139, 1, fLocal_2139, 0.5f, 0.5f, false, false, false, 10f, true, 0);
			PHYSICS::ATTACH_ENTITIES_TO_ROPE(iLocal_145[0], uLocal_169[0], uLocal_55[0], ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uLocal_169[0], 0f, 0f, 0f), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uLocal_55[0], 1.8f, 1.02f, 1.11f), fLocal_2139, false, false, 0, 0);
			iLocal_145[1] = PHYSICS::ADD_ROPE(1260.6915f, -3008.286f, 23.73365f, 0f, 0f, 0f, fLocal_2139, 1, fLocal_2139, 0.5f, 0.5f, false, false, false, 10f, true, 0);
			PHYSICS::ATTACH_ENTITIES_TO_ROPE(iLocal_145[1], uLocal_169[0], uLocal_55[0], ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uLocal_169[0], 0f, 0f, 0f), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uLocal_55[0], -1.8f, 1.02f, 1.11f), fLocal_2139, false, false, 0, 0);
			iLocal_145[2] = PHYSICS::ADD_ROPE(1260.6915f, -3008.286f, 23.73365f, 0f, 0f, 0f, fLocal_2139, 1, fLocal_2139, 0.5f, 0.5f, false, false, false, 10f, true, 0);
			PHYSICS::ATTACH_ENTITIES_TO_ROPE(iLocal_145[2], uLocal_169[1], uLocal_55[0], ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uLocal_169[1], 0f, 0f, 0f), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uLocal_55[0], 1.8f, -3.07f, 1.11f), fLocal_2139, false, false, 0, 0);
			iLocal_145[3] = PHYSICS::ADD_ROPE(1260.7521f, -3004.9941f, 22.68315f, 0f, 0f, 0f, fLocal_2139, 1, fLocal_2139, 0.5f, 0.5f, false, false, false, 10f, true, 0);
			PHYSICS::ATTACH_ENTITIES_TO_ROPE(iLocal_145[3], uLocal_169[1], uLocal_55[0], ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uLocal_169[1], 0f, 0f, 0f), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uLocal_55[0], -1.8f, -3.07f, 1.11f), fLocal_2139, false, false, 0, 0);
			bLocal_383 = true;
			bLocal_385 = false;
			PHYSICS::ACTIVATE_PHYSICS(uLocal_55[0]);
			ENTITY::APPLY_FORCE_TO_ENTITY_CENTER_OF_MASS(uLocal_55[0], 1, 0f, 0f, 0.01f, false, false, true, false);
		}
	}
	else if (func_107(uLocal_55[0]))
	{
		if (!bLocal_385)
		{
			PHYSICS::ACTIVATE_PHYSICS(uLocal_55[0]);
	...
	if (!bLocal_386)
	{
		if (ENTITY::DOES_ENTITY_EXIST(uLocal_169[3]))
		{
			if (ENTITY::DOES_ENTITY_HAVE_PHYSICS(uLocal_169[3]))
			{
				ENTITY::ATTACH_ENTITY_TO_ENTITY(uLocal_169[3], uLocal_64[4], PED::GET_PED_BONE_INDEX(uLocal_64[4], 28422), 0f, 0f, 0f, 0f, 0f, 0f, false, false, false, false, 2, true, 0);
				bLocal_386 = true;
			}
		}
	}

	if (ENTITY::DOES_ENTITY_EXIST(uLocal_169[3]) && func_107(uLocal_64[4]) && PED::IS_PED_FLEEING(uLocal_64[4]) || !func_107(uLocal_64[4]))
	{
		if (func_107(uLocal_64[4]) && ENTITY::IS_ENTITY_PLAYING_ANIM(uLocal_64[4], sLocal_50, "cellphone_call_listen_c", 3))
			TASK::STOP_ANIM_TASK(uLocal_64[4], sLocal_50, "cellphone_call_listen_c", -1056964608);
	
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(uLocal_169[3]))
			ENTITY::DETACH_ENTITY(uLocal_169[3], true, true);
	}

	if (_GET_CURRENT_PLAYER_CHARACTER() == CHAR_TREVOR)
		if (func_107(uLocal_55[0]))
			VEHICLE::SET_VEHICLE_IS_CONSIDERED_BY_PLAYER(uLocal_55[0], true);
	else if (func_107(uLocal_55[0]))
		VEHICLE::SET_VEHICLE_IS_CONSIDERED_BY_PLAYER(uLocal_55[0], false);
...
void func_234(int iParam0, Vehicle veParam1, int iParam2) // Position - 0x112EC
{
	...
	if (!func_253(&Global_77348.f_555[0], iParam0))
		return;
...
BOOL IS_PLAYSTATION_PLATFORM() // Position - 0x1512A
{
	return MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION();
}

BOOL IS_XBOX_PLATFORM() // Position - 0x15140
{
...
BOOL func_253(var uParam0, int iParam1) // Position - 0x15428
{
	...
	*uParam0 = Vector3( 0f, 0f, 0f );
	...
	if (IS_BIT_SET(uParam0->f_9, 10))
	{
		...
		if (!func_95(Global_113648.f_32751.f_1864[uParam0->f_14], 0f, 0f, 0f, false))
	...
	{
		if (!func_95(Global_113648.f_2365.f_539.f_3588[1][uParam0->f_12], 0f, 0f, 0f, false))
		{
	...
	{
		if (!func_95(Global_113648.f_2365.f_539.f_3588[0][uParam0->f_12], 0f, 0f, 0f, false))
		{
...
void func_254(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, float fParam5, eCharacter echParam6) // Position - 0x16B16
{
	if (func_253(&Global_77348.f_555[0], iParam0))
	{
		...
		{
			func_259(iParam0);
			func_258(uParam1, &Global_113648.f_32751.f_69[Global_77348.f_555[0].f_14]);
...
BOOL func_266(var uParam0, var uParam1, int iParam2, BOOL bParam3) // Position - 0x17060
{
	...
	if (Global_21725 == 0 || Global_21727 == 2)
	{
		...
		if (Global_21721 > 0)
		{
			...
			{
				TEXT_LABEL_ASSIGN_STRING(&Global_21344.f_6[i], uParam0->[i], 24);
				TEXT_LABEL_ASSIGN_STRING(&Global_21344.f_187[i], uParam1->[i], 24);
			}
		}
...
void func_274() // Position - 0x1755C
{
	...
	{
		if (!PHYSICS::IS_ROPE_ATTACHED_AT_BOTH_ENDS(&iLocal_145[iLocal_382]))
		{
			if (!iLocal_145[iLocal_382].f_4)
				flag = true;
	...
	if (flag)
	{
		if (!PHYSICS::IS_ROPE_ATTACHED_AT_BOTH_ENDS(&iLocal_145[0]) && !PHYSICS::IS_ROPE_ATTACHED_AT_BOTH_ENDS(&iLocal_145[1]) && !iLocal_145[0].f_4 || !iLocal_145[1].f_4 || !PHYSICS::IS_ROPE_ATTACHED_AT_BOTH_ENDS(&iLocal_145[2]) && !PHYSICS::IS_ROPE_ATTACHED_AT_BOTH_ENDS(&iLocal_145[3]) && !iLocal_145[2].f_4 || !iLocal_145[3].f_4 || num == 3 && num < 4)
		{
			if (iLocal_2146 > 0)
...
void func_282() // Position - 0x17B3A
{
	...
	{
		if (ENTITY::DOES_ENTITY_EXIST(uLocal_64[iLocal_382]))
		{
			if (uLocal_64[iLocal_382] != uLocal_64[3])
				if (iLocal_2133 == 0)
					func_297(uLocal_64[iLocal_382], &(uLocal_64[iLocal_382].f_2), -1, 0, false, false, -1082130432, 0, -1, -1, true, false, false);
				else if (HUD::DOES_BLIP_EXIST(uLocal_64[iLocal_382].f_2))
					HUD::REMOVE_BLIP(&(uLocal_64[iLocal_382].f_2));
		
			if (PED::IS_PED_INJURED(uLocal_64[iLocal_382]))
			{
				if (uLocal_64[iLocal_382] == uLocal_64[3])
					func_93(7);
			
				func_9(&uLocal_64[iLocal_382], true, 0, 1);
			}
			else if (iLocal_2133 == 2 && uLocal_64[iLocal_382] == uLocal_64[3])
			{
				if (func_10(uLocal_64[3], PLAYER::PLAYER_PED_ID(), true) > 300f)
					func_93(11);
			}
		}
	}
	...
	{
		if (ENTITY::DOES_ENTITY_EXIST(uLocal_55[iLocal_382]))
		{
			if (!VEHICLE::IS_VEHICLE_DRIVEABLE(uLocal_55[iLocal_382], false))
			{
				if (uLocal_55[iLocal_382] == uLocal_55[0])
					func_93(1);
				else if (uLocal_55[iLocal_382] == uLocal_55[2] || uLocal_55[iLocal_382] == uLocal_55[1])
					func_93(2);
				else if (iLocal_382 == 3)
					func_93(8);
			
				func_296(&uLocal_55[iLocal_382]);
			}
			else if (bLocal_392)
			{
				if (uLocal_55[iLocal_382] == uLocal_55[0] || uLocal_55[iLocal_382] == uLocal_55[1])
					if (iLocal_2133 == 2)
						if (ENTITY::GET_ENTITY_SUBMERGED_LEVEL(uLocal_55[iLocal_382]) > 0.5f)
							func_93(5);
			
				if (uLocal_55[iLocal_382] == uLocal_55[2] || uLocal_55[iLocal_382] == uLocal_55[1])
				{
					if (func_295(&uLocal_55[iLocal_382]))
					{
						func_93(3);
						func_296(&uLocal_55[iLocal_382]);
					}
	...
	if (func_107(uLocal_55[0]) && func_107(PLAYER::PLAYER_PED_ID()))
	{
		if (MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(uLocal_55[0], true), true) > 750f)
		{
			func_93(10);
		}
		else if (MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(uLocal_55[0], true), true) > 700f)
		{
	...
	{
		if (func_107(uLocal_55[2]))
		{
			if (!bLocal_2142)
			{
				func_284(uLocal_55[2], 590);
				bLocal_2142 = true;
			}
		}
		else if (bLocal_2142)
	...
	if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 1240.4019f, -2880.3962f, 8.25003f, 1240.3844f, -2924.5127f, 40.819088f, 28.875f, false, true, 0) || ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 1240.2216f, -3035.4695f, 16.026249f, 1240.409f, -2924.1592f, 8.06909f, 28.875f, false, true, 0) || ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 1240.4644f, -3035.1272f, 13.006976f, 1240.6168f, -3057.122f, 16.971334f, 27.6875f, false, true, 0) || ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 1240.5375f, -2967.8215f, 32.94558f, 1240.7922f, -2943.657f, 10.006589f, 12.1875f, false, true, 0) || ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 1261.5248f, -3006.2754f, 29.21641f, 1237.7876f, -3006.8262f, 12.877231f, 8.1875f, false, true, 0))
	{
		...
		if (!ENTITY::IS_ENTITY_IN_AIR(vehiclePedIsIn) && !ENTITY::IS_ENTITY_IN_WATER(vehiclePedIsIn) && !ENTITY::DOES_ENTITY_EXIST(uLocal_55[0]) || !ENTITY::IS_ENTITY_TOUCHING_ENTITY(vehiclePedIsIn, uLocal_55[0]))
		{
			if (!bLocal_391)
			{
				func_283(593);
	...
	if (CAM::IS_AIM_CAM_ACTIVE())
		CAM::SET_GAMEPLAY_CAM_ENTITY_TO_LIMIT_FOCUS_OVER_BOUNDING_SPHERE_THIS_UPDATE(uLocal_55[0]);
...
void func_284(int iParam0, int iParam1) // Position - 0x180F5
{
	...
	for (i = 0; i < Global_75457; i = i + 1)
	{
		...
		{
			if (Global_75458[i].f_6 != iParam0)
			{
				Global_75458[i].f_6 = iParam0;
	...
	switch (iLocal_399)
	{
		case 0:
			if (func_107(uLocal_64[4]))
			{
				if (bLocal_404)
				{
					TASK::TASK_PLAY_ANIM(uLocal_64[4], sLocal_50, "cellphone_call_listen_c", 8f, -8f, -1, 49, 0, false, false, false);
				
					if (TASK::GET_IS_WAYPOINT_RECORDING_LOADED("docksprep1"))
						TASK::TASK_FOLLOW_WAYPOINT_RECORDING(uLocal_64[4], "docksprep1", 0, 8, -1);
					else
		...
		case 1:
			if (!bLocal_404)
			{
				if (MISC::GET_GAME_TIMER() - iLocal_403 > 2000 || MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(uLocal_64[4], true), true) < 10f)
				{
					bLocal_404 = true;
					iLocal_399 = 0;
				}
			...
			if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 1240.5132f, -2880.3557f, 2.10339f, 1240.5594f, -3057.2708f, 17.4f, 29.45f, false, true, 0))
			{
				if (func_107(uLocal_64[4]))
				{
					if (PED::CAN_PED_SEE_HATED_PED(uLocal_64[4], PLAYER::PLAYER_PED_ID()))
					{
						TASK::CLEAR_PED_TASKS(uLocal_64[4]);
						AUDIO::STOP_CURRENT_PLAYING_AMBIENT_SPEECH(uLocal_64[4]);
						_CONVERSATION_INITIALIZE_ACTOR(&uLocal_213, 3, uLocal_64[4], "CONSTRUCTION2", 0, 1);
						iLocal_399 = 2;
					}
					else if (MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(uLocal_64[4], true), true) < 12f && PLAYER::GET_PLAYER_CURRENT_STEALTH_NOISE(PLAYER::PLAYER_ID()) > 8.5f)
					{
						AUDIO::STOP_CURRENT_PLAYING_AMBIENT_SPEECH(uLocal_64[4]);
					
						if (!func_287(uLocal_64[4], SCRIPT_TASK_TURN_PED_TO_FACE_COORD, true))
						{
							TASK::TASK_TURN_PED_TO_FACE_COORD(uLocal_64[4], ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), 4000);
							TASK::TASK_PLAY_ANIM(uLocal_64[4], "MISSHEISTDOCKSPREP1HOLD_CELLPHONE", "HOLD_CELLPHONE", 4f, -8f, -1, 49, 0, false, false, false);
						}
					}
					else if (MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(uLocal_64[4], true), true) < 12f && PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
					{
						if (!func_287(uLocal_64[4], SCRIPT_TASK_TURN_PED_TO_FACE_COORD, true))
						{
							TASK::TASK_TURN_PED_TO_FACE_COORD(uLocal_64[4], ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), 4000);
					...
					else if (WEAPON::IS_FLASH_LIGHT_ON(PLAYER::PLAYER_PED_ID()) && CLOCK::GET_CLOCK_HOURS() >= 19 || CLOCK::GET_CLOCK_HOURS() < 6 && func_10(PLAYER::PLAYER_PED_ID(), uLocal_64[4], true) < 25f && PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), uLocal_64[4]) || PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(PLAYER::PLAYER_ID(), uLocal_64[4]))
					{
						if (!func_287(uLocal_64[4], SCRIPT_TASK_TURN_PED_TO_FACE_COORD, true))
						{
							TASK::TASK_TURN_PED_TO_FACE_COORD(uLocal_64[4], ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), 4000);
				...
				if (iLocal_2134 > 1)
				{
					if (func_107(uLocal_64[4]))
					{
						if (ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY_IN_FRONT(uLocal_64[4], uLocal_55[0]))
						{
							AUDIO::STOP_CURRENT_PLAYING_AMBIENT_SPEECH(uLocal_64[4]);
							_CONVERSATION_INITIALIZE_ACTOR(&uLocal_213, 3, uLocal_64[4], "CONSTRUCTION2", 0, 1);
							iLocal_399 = 3;
							iLocal_401 = 3;
							TASK::CLEAR_PED_TASKS_IMMEDIATELY(uLocal_64[4]);
							TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(uLocal_64[4], 1252.5581f, -3004.8457f, 8.31909f, 2f, -1, 0.25f, 0, -122.93f);
							iLocal_403 = MISC::GET_GAME_TIMER();
							bLocal_404 = false;
						}
					}
			...
			if (func_107(uLocal_64[4]))
			{
				if (!TASK::IS_WAYPOINT_PLAYBACK_GOING_ON_FOR_PED(uLocal_64[4]))
				{
					if (bLocal_404)
					{
						if (TASK::GET_SCRIPT_TASK_STATUS(uLocal_64[4], SCRIPT_TASK_PERFORM_SEQUENCE) != 1 && TASK::GET_SCRIPT_TASK_STATUS(uLocal_64[4], SCRIPT_TASK_FOLLOW_NAV_MESH_TO_COORD) != 1 && TASK::GET_SCRIPT_TASK_STATUS(uLocal_64[4], SCRIPT_TASK_TURN_PED_TO_FACE_COORD) != 1)
						{
							if (!ENTITY::IS_ENTITY_PLAYING_ANIM(uLocal_64[4], sLocal_50, "cellphone_call_listen_c", 3))
								TASK::TASK_PLAY_ANIM(uLocal_64[4], sLocal_50, "cellphone_call_listen_c", 8f, -8f, -1, 49, 0, false, false, false);
						
							if (ENTITY::IS_ENTITY_AT_COORD(uLocal_64[4], 1228.0559f, -3000.4275f, 8.4424f, 2f, 2f, 2f, false, true, 0))
								if (TASK::GET_IS_WAYPOINT_RECORDING_LOADED("docksprep1"))
									TASK::TASK_FOLLOW_WAYPOINT_RECORDING(uLocal_64[4], "docksprep1", 0, 0, -1);
				...
				else
				{
					...
					{
						if (!TASK::WAYPOINT_PLAYBACK_GET_IS_PAUSED(uLocal_64[4]))
						{
							if (ENTITY::IS_ENTITY_AT_COORD(uLocal_64[4], 1251.6254f, -3003.3384f, 8.31909f, 2f, 2f, 2f, false, true, 0))
								TASK::WAYPOINT_PLAYBACK_PAUSE(uLocal_64[4], false, false);
							else if (ENTITY::IS_ENTITY_AT_COORD(uLocal_64[4], 1228.8485f, -2986.284f, 8.31909f, 2f, 2f, 2f, false, true, 0))
								TASK::WAYPOINT_PLAYBACK_PAUSE(uLocal_64[4], false, false);
						}
						else
						{
							iLocal_407 = MISC::GET_GAME_TIMER();
							TASK::WAYPOINT_PLAYBACK_RESUME(uLocal_64[4], true, -1, 3000);
						}
					}
				
					if (!AUDIO::IS_AMBIENT_SPEECH_PLAYING(uLocal_64[4]) && MISC::GET_GAME_TIMER() - iLocal_408 > 4000)
					{
						func_286(uLocal_64[4], "Sol1_EFAA", "CONSTRUCTION2", 3);
						iLocal_408 = MISC::GET_GAME_TIMER();
					}
				}
			
				if (PED::HAS_PED_RECEIVED_EVENT(uLocal_64[4], 124) || PED::HAS_PED_RECEIVED_EVENT(uLocal_64[4], 125) || PED::HAS_PED_RECEIVED_EVENT(uLocal_64[4], 126) || PED::HAS_PED_RECEIVED_EVENT(uLocal_64[4], 118))
				{
					AUDIO::STOP_CURRENT_PLAYING_AMBIENT_SPEECH(uLocal_64[4]);
					_CONVERSATION_INITIALIZE_ACTOR(&uLocal_213, 3, uLocal_64[4], "CONSTRUCTION2", 0, 1);
					iLocal_399 = 3;
					iLocal_401 = 1;
					TASK::TASK_PLAY_ANIM(uLocal_64[4], "MISSHEISTDOCKSPREP1HOLD_CELLPHONE", "HOLD_CELLPHONE", 1000f, -8f, -1, 49, 0, false, false, false);
					TASK::TASK_HANDS_UP(uLocal_64[4], -1, PLAYER::PLAYER_PED_ID(), -1, 1);
				}
				else if (PED::HAS_PED_RECEIVED_EVENT(uLocal_64[4], 23))
				{
					AUDIO::STOP_CURRENT_PLAYING_AMBIENT_SPEECH(uLocal_64[4]);
					_CONVERSATION_INITIALIZE_ACTOR(&uLocal_213, 3, uLocal_64[4], "CONSTRUCTION2", 0, 1);
					iLocal_399 = 3;
					...
					TASK::CLEAR_PED_TASKS(uLocal_64[4]);
					TASK::TASK_PLAY_ANIM(uLocal_64[4], "MISSHEISTDOCKSPREP1HOLD_CELLPHONE", "HOLD_CELLPHONE", 1000f, -8f, -1, 49, 0, false, false, false);
					TASK::TASK_COWER(uLocal_64[4], -1);
				}
				else if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(uLocal_64[4], PLAYER::PLAYER_PED_ID(), true))
				{
					AUDIO::STOP_CURRENT_PLAYING_AMBIENT_SPEECH(uLocal_64[4]);
					TASK::TASK_PLAY_ANIM(uLocal_64[4], "MISSHEISTDOCKSPREP1HOLD_CELLPHONE", "HOLD_CELLPHONE", 1000f, -8f, -1, 49, 0, false, false, false);
					_CONVERSATION_INITIALIZE_ACTOR(&uLocal_213, 3, uLocal_64[4], "CONSTRUCTION2", 0, 1);
		...
		case 2:
			if (func_107(uLocal_64[4]))
				if (!PED::IS_PED_HEADTRACKING_PED(uLocal_64[4], PLAYER::PLAYER_PED_ID()))
					TASK::TASK_LOOK_AT_ENTITY(uLocal_64[4], PLAYER::PLAYER_PED_ID(), -1, SLF_WIDEST_PITCH_LIMIT | 1024 | 2048, 2);
			...
			if (!ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 1240.5132f, -2880.3557f, 2.10339f, 1240.5594f, -3057.2708f, 17.4f, 29.45f, false, true, 0) || !func_107(uLocal_64[4]))
				iLocal_399 = 0;
			...
			if (func_107(uLocal_64[4]))
			{
				if (PED::HAS_PED_RECEIVED_EVENT(uLocal_64[4], 124) || PED::HAS_PED_RECEIVED_EVENT(uLocal_64[4], 125) || PED::HAS_PED_RECEIVED_EVENT(uLocal_64[4], 126))
				{
					_CONVERSATION_INITIALIZE_ACTOR(&uLocal_213, 3, uLocal_64[4], "CONSTRUCTION2", 0, 1);
					iLocal_399 = 3;
					iLocal_401 = 1;
				...
				else if (PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(PLAYER::PLAYER_ID(), uLocal_64[4]) || PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), uLocal_64[4]))
				{
					if (WEAPON::GET_WEAPONTYPE_GROUP(hLocal_406) != joaat("GROUP_MELEE") && hLocal_406 != joaat("WEAPON_UNARMED"))
					{
						...
						iLocal_401 = 1;
						TASK::CLEAR_PED_TASKS_IMMEDIATELY(uLocal_64[4]);
						TASK::TASK_HANDS_UP(uLocal_64[4], -1, PLAYER::PLAYER_PED_ID(), -1, 0);
					}
				}
				else if (PED::HAS_PED_RECEIVED_EVENT(uLocal_64[4], 23))
				{
		...
		case 3:
			switch (iLocal_401)
			{
				...
				case 3:
					if (func_107(uLocal_64[4]))
					{
						if (ENTITY::IS_ENTITY_AT_COORD(uLocal_64[4], 1252.5581f, -3004.8457f, 8.31909f, 2f, 2f, 2f, false, true, 0))
						{
						...
						if (!PED::IS_PED_HEADTRACKING_ENTITY(uLocal_64[4], uLocal_55[0]))
							TASK::TASK_LOOK_AT_ENTITY(uLocal_64[4], uLocal_55[0], -1, SLF_WIDEST_YAW_LIMIT | 32 | 2048, 2);
					}
					else
					{
						bLocal_404 = true;
				...
				case 4:
					if (func_107(uLocal_64[4]))
					{
						if (!PED::IS_PED_RAGDOLL(uLocal_64[4]) && !TASK::IS_PED_GETTING_UP(uLocal_64[4]))
						{
				...
				case 5:
					if (MISC::GET_GAME_TIMER() - iLocal_402 > 8000)
					{
						...
						if (func_107(uLocal_64[4]))
							if (bLocal_405)
								if (!PED::IS_PED_FLEEING(uLocal_64[4]))
									TASK::TASK_SMART_FLEE_PED(uLocal_64[4], PLAYER::PLAYER_PED_ID(), 200f, -1, false, false);
							else if (TASK::GET_SCRIPT_TASK_STATUS(uLocal_64[4], SCRIPT_TASK_WANDER_IN_AREA) != 1)
								TASK::TASK_WANDER_IN_AREA(uLocal_64[4], 1183.2872f, -2947.8699f, 4.8986f, 100f, 1077936128, 1086324736);
					}
					...
					if (!bLocal_405)
					{
						...
						if (func_107(uLocal_64[4]))
						{
							...
							else if (PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(PLAYER::PLAYER_ID(), uLocal_64[4]) || PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), uLocal_64[4]) && PED::IS_PED_FACING_PED(uLocal_64[4], PLAYER::PLAYER_PED_ID(), 160f))
							{
								if (WEAPON::GET_WEAPONTYPE_GROUP(hLocal_406) != joaat("GROUP_MELEE") && hLocal_406 != joaat("WEAPON_UNARMED"))
								{
									_CONVERSATION_INITIALIZE_ACTOR(&uLocal_213, 4, uLocal_64[4], "CONSTRUCTION2", 0, 1);
...
void func_288() // Position - 0x19231
{
	switch (iLocal_459)
	{
		case 0:
			switch (iLocal_458)
			{
				case 0:
					if (func_107(uLocal_55[0]))
					{
						if (!HUD::IS_MESSAGE_BEING_DISPLAYED() && PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), uLocal_55[0], false) && PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) == 0)
						{
							func_293();
							iLocal_456 = MISC::GET_GAME_TIMER();
							iLocal_458 = 1;
				...
				case 1:
					if (MISC::GET_GAME_TIMER() - iLocal_456 > 6000 && PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), uLocal_55[0], false))
					{
						_CONVERSATION_INITIALIZE_ACTOR(&uLocal_213, 1, 0, "FLOYD", 0, 1);
		...
		case 2:
			...
			{
				case 0:
					if (!HUD::IS_MESSAGE_BEING_DISPLAYED() && PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), uLocal_55[0], false) && MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), 324.76532f, -2974.4946f, -1f, true) < 110f)
					{
						func_293();
						iLocal_458 = 1;
					}
		...
		case 3:
			if (func_107(uLocal_55[2]) && func_107(uLocal_64[3]))
			{
				switch (iLocal_458)
				{
					case 0:
						if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), uLocal_55[2], false) && PED::IS_PED_IN_VEHICLE(uLocal_64[3], uLocal_55[2], false))
							if (_CONVERSATION_IS_DIALOGUE_IN_PROGRESS())
								func_293();
							else
								iLocal_458 = 1;
					...
					case 1:
						func_286(uLocal_64[3], "DHP1_AIAA", "FLOYD", 24);
						iLocal_458 = 2;
						break;
				
					case 2:
						if (!AUDIO::IS_AMBIENT_SPEECH_PLAYING(uLocal_64[3]))
							iLocal_458 = 3;
						break;
		...
		case 4:
			if (func_107(uLocal_55[2]) && func_107(uLocal_64[3]))
			{
				...
				{
					case 0:
						if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false) && PED::IS_PED_IN_VEHICLE(uLocal_64[3], PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false), false) && ENTITY::IS_ENTITY_ATTACHED_TO_ENTITY(uLocal_55[1], PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false)) && !HUD::IS_MESSAGE_BEING_DISPLAYED())
						{
							func_293();
							iLocal_456 = MISC::GET_GAME_TIMER();
							iLocal_458 = 1;
					...
					case 2:
						if (_CONVERSATION_IS_DIALOGUE_IN_PROGRESS())
							if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false) && PED::IS_PED_IN_VEHICLE(uLocal_64[3], PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false), false) && ENTITY::IS_ENTITY_ATTACHED_TO_ENTITY(uLocal_55[1], PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false)))
								if (func_37())
									func_292(0);
							else if (!func_37())
								func_292(1);
				...
				if (MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(uLocal_55[0], true), -323.73004f, -2613.7017f, 5f, true) < 60f)
				{
					func_291();
					iLocal_458 = 3;
				}
...
void func_299() // Position - 0x19CE8
{
	if (!func_107(uLocal_55[0]))
	{
		uLocal_55[0] = VEHICLE::CREATE_VEHICLE(joaat("submersible"), -337.7228f, -2623.8347f, 8.6595f, 135.24f, true, true, false);
		VEHICLE::SET_VEHICLE_IS_CONSIDERED_BY_PLAYER(uLocal_55[0], false);
		VEHICLE::SET_VEHICLE_ENGINE_ON(uLocal_55[0], false, true, false);
		VEHICLE::SET_VEHICLE_LIGHTS(uLocal_55[0], 1);
		AUDIO::SET_VEHICLE_RADIO_ENABLED(uLocal_55[0], true);
		ENTITY::SET_CAN_CLIMB_ON_ENTITY(uLocal_55[0], false);
	}

	if (!func_107(uLocal_55[2]))
	{
		uLocal_55[2] = VEHICLE::CREATE_VEHICLE(joaat("packer"), -337.7228f, -2627.0376f, 5.001f, 134.9894f, true, true, false);
		VEHICLE::SET_VEHICLE_IS_CONSIDERED_BY_PLAYER(uLocal_55[2], false);
		VEHICLE::SET_VEHICLE_COLOUR_COMBINATION(uLocal_55[2], 0);
		VEHICLE::SET_VEHICLE_TYRES_CAN_BURST(uLocal_55[2], false);
		VEHICLE::SET_VEHICLE_HAS_STRONG_AXLES(uLocal_55[2], true);
	...
	if (!func_107(uLocal_55[1]))
	{
		uLocal_55[1] = VEHICLE::CREATE_VEHICLE(joaat("armytrailer"), -331.728f, -2621.0059f, 7.8828f, 135.24f, true, true, false);
		VEHICLE::SET_VEHICLE_HAS_STRONG_AXLES(uLocal_55[1], true);
	}
	...
	if (!ENTITY::DOES_ENTITY_EXIST(uLocal_169[4]))
	{
		uLocal_169[4] = OBJECT::CREATE_OBJECT(joaat("prop_sub_cover_01"), 297.5948f, -2950.3545f, 5.0008f, true, true, false);
		ENTITY::ATTACH_ENTITY_TO_ENTITY(uLocal_169[4], uLocal_55[1], -1, uLocal_440, 0f, 0f, 0f, false, false, false, false, 2, true, 0);
	}

	if (!ENTITY::DOES_ENTITY_EXIST(uLocal_169[5]))
	{
		uLocal_169[5] = OBJECT::CREATE_OBJECT(joaat("prop_tarp_strap"), -332.8449f, -2622.1572f, 8.7838f, true, true, false);
		ENTITY::ATTACH_ENTITY_TO_ENTITY(uLocal_169[5], uLocal_55[1], -1, uLocal_440, 0f, 0f, 0f, false, false, false, false, 2, true, 0);
	}
...
void func_303() // Position - 0x19FE9
{
	if (!func_107(uLocal_55[0]))
	{
		uLocal_55[0] = VEHICLE::CREATE_VEHICLE(joaat("submersible"), 320.4211f, -2975.9927f, -11.1896f, 2.5159f, true, true, false);
		VEHICLE::SET_VEHICLE_CAN_BE_VISIBLY_DAMAGED(uLocal_55[0], false);
		VEHICLE::SET_VEHICLE_ENGINE_ON(uLocal_55[0], false, true, false);
		VEHICLE::SET_VEHICLE_LIGHTS(uLocal_55[0], 1);
		AUDIO::SET_VEHICLE_RADIO_ENABLED(uLocal_55[0], true);
	...
	if (!func_107(uLocal_55[2]))
	{
		uLocal_55[2] = VEHICLE::CREATE_VEHICLE(joaat("packer"), 297.5948f, -2950.3545f, 5.0008f, 359.1976f, true, true, false);
		VEHICLE::SET_VEHICLE_COLOUR_COMBINATION(uLocal_55[2], 0);
		VEHICLE::SET_VEHICLE_TYRES_CAN_BURST(uLocal_55[2], false);
		VEHICLE::SET_VEHICLE_HAS_STRONG_AXLES(uLocal_55[2], true);
	}
	...
	if (!func_107(uLocal_55[1]))
	{
		uLocal_55[1] = VEHICLE::CREATE_VEHICLE(joaat("armytrailer"), 297.2917f, -2970.2456f, 4.8884f, 359.0483f, true, true, false);
		VEHICLE::SET_VEHICLE_CAN_BE_VISIBLY_DAMAGED(uLocal_55[1], false);
		VEHICLE::SET_VEHICLE_HAS_STRONG_AXLES(uLocal_55[1], true);
	}
	...
	while (!func_304(&uLocal_64[3], CHAR_FLOYD, uLocal_55[2], 0, true))
	{
		SYSTEM::WAIT(0);
	}
...
void func_307() // Position - 0x1A31F
{
	...
	{
		uLocal_55[0] = VEHICLE::CREATE_VEHICLE(joaat("submersible"), 1272.3978f, -2982.072f, -3.2414f, 201.5542f, true, true, false);
		AUDIO::SET_VEHICLE_RADIO_ENABLED(uLocal_55[0], true);
	}

	if (func_314())
	{
		func_300(uLocal_55[0], -1, 1);
	}
	else
	{
		ENTITY::FREEZE_ENTITY_POSITION(PLAYER::PLAYER_PED_ID(), false);
		PED::SET_PED_INTO_VEHICLE(PLAYER::PLAYER_PED_ID(), uLocal_55[0], -1);
	}
...
void func_308() // Position - 0x1A3AD
{
	if (!ENTITY::DOES_ENTITY_EXIST(uLocal_55[0]))
	{
		uLocal_55[0] = VEHICLE::CREATE_VEHICLE(joaat("submersible"), 1260.8022f, -3006.417f, 18.3289f, 178.9076f, true, true, false);
		func_309(uLocal_55[0], 0);
		ENTITY::FREEZE_ENTITY_POSITION(uLocal_55[0], true);
		ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(uLocal_55[0], true, 1);
		ENTITY::SET_ENTITY_SHOULD_FREEZE_WAITING_ON_COLLISION(uLocal_55[0], false);
		AUDIO::SET_VEHICLE_RADIO_ENABLED(uLocal_55[0], true);
	}

	if (!ENTITY::DOES_ENTITY_EXIST(uLocal_64[4]))
	{
		uLocal_64[4] = PED::CREATE_PED(PED_TYPE_MISSION, joaat("S_M_M_DockWork_01"), 1229.3217f, -3002.8792f, 8.31861f, 270f, true, true);
		TASK::TASK_PLAY_ANIM(uLocal_64[4], sLocal_50, "cellphone_call_listen_c", 8f, -8f, -1, 49, 0, false, false, false);
		PED::SET_PED_FLEE_ATTRIBUTES(uLocal_64[4], 512, false);
		PED::SET_PED_COMBAT_ATTRIBUTES(uLocal_64[4], BF_AlwaysFlee, true);
		PED::SET_PED_RELATIONSHIP_GROUP_HASH(uLocal_64[4], hLocal_395);
		PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uLocal_64[4], true);
		PED::SET_PED_VISUAL_FIELD_CENTER_ANGLE(uLocal_64[4], 45f);
		PED::SET_PED_VISUAL_FIELD_MAX_ANGLE(uLocal_64[4], 50f);
		PED::SET_PED_VISUAL_FIELD_MIN_ANGLE(uLocal_64[4], -50f);
		AUDIO::STOP_PED_SPEAKING(uLocal_64[4], true);
	}

	if (!ENTITY::DOES_ENTITY_EXIST(uLocal_169[0]))
	{
		uLocal_169[0] = OBJECT::CREATE_OBJECT(joaat("prop_ld_test_01"), 1260.6915f, -3008.286f, 23.73365f, true, true, false);
		ENTITY::FREEZE_ENTITY_POSITION(uLocal_169[0], true);
	}

	if (!ENTITY::DOES_ENTITY_EXIST(uLocal_169[1]))
	{
		uLocal_169[1] = OBJECT::CREATE_OBJECT(joaat("prop_ld_test_01"), 1260.7521f, -3004.9941f, 22.68315f, true, true, false);
		ENTITY::FREEZE_ENTITY_POSITION(uLocal_169[1], true);
	}

	if (!ENTITY::DOES_ENTITY_EXIST(uLocal_169[2]))
	{
		uLocal_169[2] = OBJECT::CREATE_OBJECT(joaat("prop_sub_release"), 1249.1055f, -3007.9678f, 9.68718f, true, true, false);
		ENTITY::SET_ENTITY_ROTATION(uLocal_169[2], 0f, 0f, 90f, 2, true);
		ENTITY::FREEZE_ENTITY_POSITION(uLocal_169[2], true);
	}

	if (!ENTITY::DOES_ENTITY_EXIST(uLocal_169[3]))
		uLocal_169[3] = OBJECT::CREATE_OBJECT(joaat("p_amb_phone_01"), 1229.3217f, -3002.8792f, 8.31861f, true, true, false);
...
int func_312(var uParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0x1B010
{
	...
	uParam0->f_898 = 1;
	uParam0->f_898.f_3 = MISC::GET_GAME_TIMER();
	uParam0->f_898.f_4 = Vector3(vParam1);
	uParam0->f_898.f_7 = Vector3( 0f, 0f, 0f );
...
void func_313(int iParam0, var uParam1, var uParam2) // Position - 0x1B0C8
{
	...
	{
		case 0:
			*uParam1 = Vector3(1219.1857f, -2977.9f, 4.8653f);
			*uParam2 = 178.1887f;
			break;
	
		case 1:
			*uParam1 = Vector3(1272.3978f, -2982.072f, -3.2414f);
			*uParam2 = 201.5542f;
			break;
	
		case 2:
			*uParam1 = Vector3(297.5948f, -2950.3545f, 5.0008f);
			*uParam2 = 359.1976f;
			break;
	
		case 3:
			*uParam1 = Vector3(-317.3936f, -2610.7983f, 5.0003f);
			*uParam2 = 328.0017f;
			break;
	}
...
void func_316() // Position - 0x1B3D0
{
	...
	for (iLocal_382 = 0; iLocal_382 <= 8 - 1; iLocal_382 = iLocal_382 + 1)
	{
		func_324(&(uLocal_64[iLocal_382].f_2));
	
		if (ENTITY::DOES_ENTITY_EXIST(uLocal_64[iLocal_382]) && !PED::IS_PED_INJURED(uLocal_64[iLocal_382]))
		{
			if (PED::IS_PED_IN_ANY_VEHICLE(uLocal_64[iLocal_382], false))
				PED::SET_PED_COORDS_NO_GANG(uLocal_64[iLocal_382], ENTITY::GET_ENTITY_COORDS(PED::GET_VEHICLE_PED_IS_IN(uLocal_64[iLocal_382], false), true) + Vector3( 0f, -2f, 0f ));
		
			func_323(&uLocal_64[iLocal_382]);
		}
	}
	...
	for (iLocal_382 = 0; iLocal_382 <= 4 - 1; iLocal_382 = iLocal_382 + 1)
	{
		if (ENTITY::DOES_ENTITY_EXIST(uLocal_55[iLocal_382]))
		{
			func_322(uLocal_55[iLocal_382]);
			func_319(&uLocal_55[iLocal_382]);
		}
	}

	for (iLocal_382 = 0; iLocal_382 <= 9 - 1; iLocal_382 = iLocal_382 + 1)
	{
		if (ENTITY::DOES_ENTITY_EXIST(uLocal_169[iLocal_382]))
			func_318(&uLocal_169[iLocal_382]);
	}
...
void func_329() // Position - 0x1BAB9
{
	...
	if (!ENTITY::DOES_ENTITY_EXIST(uLocal_64[4]))
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_97178.f_9[0]))
		{
			...
			uLocal_64[4] = Global_97178.f_9[0];
			PED::SET_PED_RELATIONSHIP_GROUP_HASH(uLocal_64[4], hLocal_395);
			PED::SET_PED_CONFIG_FLAG(uLocal_64[4], 208, true);
			PED::SET_PED_VISUAL_FIELD_CENTER_ANGLE(uLocal_64[4], 45f);
			PED::SET_PED_VISUAL_FIELD_MAX_ANGLE(uLocal_64[4], 50f);
			PED::SET_PED_VISUAL_FIELD_MIN_ANGLE(uLocal_64[4], -50f);
		}
	...
	if (!ENTITY::DOES_ENTITY_EXIST(uLocal_169[0]))
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_97178.f_28[0]))
		{
			...
			uLocal_169[0] = Global_97178.f_28[0];
		}
	}
	...
	if (!ENTITY::DOES_ENTITY_EXIST(uLocal_169[1]))
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_97178.f_28[1]))
		{
			...
			uLocal_169[1] = Global_97178.f_28[1];
		}
	}
	...
	if (!ENTITY::DOES_ENTITY_EXIST(uLocal_169[2]))
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_97178.f_28[2]))
		{
			...
			uLocal_169[2] = Global_97178.f_28[2];
		}
	}
	...
	if (!ENTITY::DOES_ENTITY_EXIST(uLocal_169[3]))
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_97178.f_28[3]))
		{
			...
			uLocal_169[3] = Global_97178.f_28[3];
		}
	}
	...
	if (Global_97178.f_357)
	{
		if (PHYSICS::DOES_ROPE_EXIST(&Global_97178.f_37[0]))
		{
			...
			iLocal_145[0] = Global_97178.f_37[0];
		...
		if (PHYSICS::DOES_ROPE_EXIST(&Global_97178.f_37[1]))
		{
			...
			iLocal_145[1] = Global_97178.f_37[1];
		...
		if (PHYSICS::DOES_ROPE_EXIST(&Global_97178.f_37[2]))
		{
			...
			iLocal_145[2] = Global_97178.f_37[2];
		...
		if (PHYSICS::DOES_ROPE_EXIST(&Global_97178.f_37[3]))
		{
			...
			iLocal_145[3] = Global_97178.f_37[3];
...
void func_334() // Position - 0x1C01E
{
	...
	if (func_107(PLAYER::PLAYER_PED_ID()))
		if (func_107(uLocal_55[0]))
			if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), uLocal_55[0], false))
				PED::SET_PED_COORDS_NO_GANG(PLAYER::PLAYER_PED_ID(), ENTITY::GET_ENTITY_COORDS(uLocal_55[0], true) + Vector3( 2f, 0f, 0f ));
	...
	for (iLocal_382 = 0; iLocal_382 <= 8 - 1; iLocal_382 = iLocal_382 + 1)
	{
		if (func_107(uLocal_64[iLocal_382]))
		{
			func_324(&(uLocal_64[iLocal_382].f_2));
		
			if (HUD::DOES_BLIP_EXIST(uLocal_64[iLocal_382].f_1))
				HUD::REMOVE_BLIP(&(uLocal_64[iLocal_382].f_1));
		
			if (PED::IS_PED_IN_GROUP(uLocal_64[iLocal_382]))
				PED::REMOVE_PED_FROM_GROUP(uLocal_64[iLocal_382]);
		
			if (uLocal_64[iLocal_382] != PLAYER::PLAYER_PED_ID())
				func_9(&uLocal_64[iLocal_382], true, 0, 1);
		}
	}
	...
	for (iLocal_382 = 0; iLocal_382 <= 4 - 1; iLocal_382 = iLocal_382 + 1)
	{
		if (HUD::DOES_BLIP_EXIST(uLocal_55[iLocal_382].f_1))
			HUD::REMOVE_BLIP(&(uLocal_55[iLocal_382].f_1));
	
		if (func_107(uLocal_55[iLocal_382]))
			if (iLocal_382 != 0)
				func_296(&uLocal_55[iLocal_382]);
	}
	...
	{
		if (ENTITY::DOES_ENTITY_EXIST(uLocal_169[iLocal_382]))
			if (uLocal_169[iLocal_382] == uLocal_169[4] || uLocal_169[iLocal_382] == uLocal_169[5])
				func_91(&uLocal_169[iLocal_382], true);
			else
				func_318(&uLocal_169[iLocal_382]);
	}
