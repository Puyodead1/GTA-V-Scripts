...
BOOL func_202() // Position - 0xF069
{
	...
	switch (iLocal_410)
	{
		...
		case 1:
			uLocal_430 = { ENTITY::GET_ENTITY_COORDS(uLocal_169[8], true) };
	...
	switch (iLocal_2134)
	{
		case 0:
			...
			if (func_107(uLocal_55[0]))
			{
				...
				uLocal_166 = { PHYSICS::GET_CGOFFSET(uLocal_55[0]) };
			}
		...
		case 5:
			entityCoords = { ENTITY::GET_ENTITY_COORDS(uLocal_55[0], true) };
...
void func_254(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, float fParam5, eCharacter echParam6) // Position - 0x16B16
{
	if (func_253(&Global_77348.f_555[0], iParam0))
	{
		if (IS_BIT_SET(Global_77348.f_555[0].f_9, 10))
		{
			...
			{
				Global_113648.f_32751.f_1864[Global_77348.f_555[0].f_14] = { uParam2 };
