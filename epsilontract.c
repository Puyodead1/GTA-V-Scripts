...
void func_1() // Position - 0xCE
{
	...
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(PLAYER::PLAYER_PED_ID()) && !func_44(14) && !CAM::IS_SCREEN_FADED_OUT())
	{
		if (iLocal_39 < 10)
		{
			...
			if (uLocal_47[iLocal_39].f_10)
			{
				if (OBJECT::HAS_PICKUP_BEEN_COLLECTED(uLocal_47[iLocal_39].f_1) || func_40(uLocal_47[iLocal_39].f_1))
				{
					if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
						TASK::TASK_CLEAR_LOOK_AT(PLAYER::PLAYER_PED_ID());
				
					func_39(&(uLocal_47[iLocal_39].f_1));
					uLocal_47[iLocal_39].f_10 = 0;
				...
				else if (OBJECT::DOES_PICKUP_EXIST(uLocal_47[iLocal_39].f_1))
				{
					func_33(uLocal_47[iLocal_39].f_3);
					func_32(&(uLocal_47[iLocal_39].f_1), &(uLocal_47[iLocal_39].f_10));
				}
			}
			else
			{
				...
				if (num2 == iLocal_39)
					func_29(&uLocal_47[iLocal_39], hLocal_38, joaat("PICKUP_CUSTOM_SCRIPT"), false, false, 2);
			}
		}
...
int func_4(int iParam0) // Position - 0x44B
{
	...
	if (iParam0 == 2)
	{
		...
		{
			if (IS_BIT_SET(G_MissionStats.f_10052.f_108, func_8(func_9(iParam0), i)))
				outValue = outValue + 1;
		}
	}
	else if (iParam0 == 6)
...
int func_13(int iParam0, int iParam1, BOOL bParam2) // Position - 0x67D
{
	...
	for (i = 0; i < Global_53888[num].f_3; i = i + 1)
	{
		...
		if (num3 < 3)
			func_14(Global_53888[num].f_4[i], Global_53888[num].f_1, true, bParam2, false);
	}
...
void func_14(int iParam0, int iParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x879
{
	...
	if (!bParam2)
	{
		...
		num3 = num5;
		unk = { func_25(Global_44588[num5].f_1) };
	...
	else
	{
		...
		if (Global_53888[num6].f_10[Global_53888[num6].f_9 - 1].f_1)
			...
			unk = { func_25(Global_44588[num8].f_1) };
	}
...
void func_20() // Position - 0x15A9
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (_GET_CHARACTER_MODEL(G_MissionStats.f_2366.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_21(character) && !func_44(14) || Global_112760)
			{
...
int func_42(int iParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8) // Position - 0x1DDE
{
	...
	TEXT_LABEL_ASSIGN_STRING(&G_MissionStats.f_14144[num], sParam2, 64);
	G_MissionStats.f_14144[num].f_17 = iParam1;

	if (iParam3 == 0)
		return 0;
	else
		G_MissionStats.f_14144[num].f_24 = iParam3;

	G_MissionStats.f_14144[num].f_25 = iParam4;
	G_MissionStats.f_14144[num].f_26 = iParam5;
	G_MissionStats.f_14144[num].f_29 = iParam6;
	G_MissionStats.f_14144[num].f_30 = iParam8;
	G_MissionStats.f_14144[num].f_31 = iParam7;
	G_MissionStats.f_14144[num].f_28 = 0;
	return 1;
}
...
void func_46() // Position - 0x1F1E
{
	...
	if (G_MissionStats.f_18577.f_388)
	{
