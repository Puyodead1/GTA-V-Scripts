...
void func_7(var uParam0, int iParam1, char* sParam2) // Position - 0x142
{
	if (func_8(&(uParam0->f_421), 7))
		uParam0->f_421.f_14(&uParam0->[iParam1], iParam1, sParam2);
	else
...
void func_11() // Position - 0x213
{
	...
	if (Global_1853830 == PLAYER::PLAYER_ID() && !IS_BIT_SET(Global_1890739[PLAYER::NETWORK_PLAYER_ID_TO_INT()].f_38.f_27, 5))
	{
		...
		if (func_18(&uLocal_45, false, false))
		{
			...
			if (iLocal_482 == 0 && !IS_BIT_SET(Global_1890739[PLAYER::NETWORK_PLAYER_ID_TO_INT()].f_38.f_27, 3) && !func_16() && !HUD::IS_PAUSE_MENU_ACTIVE() && !func_15(0) && !func_14() && PAD::IS_DISABLED_CONTROL_JUST_PRESSED(PLAYER_CONTROL, INPUT_SCRIPT_RRIGHT))
				func_12(&uLocal_45);
		}
		else
		{
...
void func_19(var uParam0) // Position - 0x428
{
	...
	switch (uParam0->f_421.f_4)
	{
		...
		case 2:
			if (func_56(PLAYER::PLAYER_PED_ID(), &uParam0->[uParam0->f_421.f_2]))
			{
...
{
	return uParam0->[uParam0->f_421.f_2].f_8;
}
...
{
	uParam0->f_421.f_8 = func_50(uParam0->[uParam0->f_421.f_2]);
...
{
	uParam0->f_421.f_13(!func_8(&(uParam0->f_421), 5), &uParam0->[uParam0->f_421.f_2], uParam0->f_421.f_2);
...
BOOL func_53(var uParam0) // Position - 0x15A0
{
	...
	for (i = 0; i < NETWORK::NETWORK_GET_MAX_NUM_PARTICIPANTS(); i = i + 1)
	{
		if (NETWORK::NETWORK_IS_PARTICIPANT_ACTIVE(PLAYER::INT_TO_PARTICIPANTINDEX(i)))
		{
			...
			if (playerIndex != PLAYER::PLAYER_ID() && _NETWORK_IS_PLAYER_VALID(playerIndex, true, true) && func_56(PLAYER::GET_PLAYER_PED(playerIndex), &uParam0->[uParam0->f_421.f_2]))
				return 1;
		}
	}
...
{
	switch (uParam0->[uParam0->f_421.f_2])
	{
		case 12:
		case 10:
		case 6:
...
BOOL func_81(Player plParam0) // Position - 0x2082
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (IS_BIT_SET(Global_1890739[plParam0].f_38.f_27, 3))
				return true;
...
{
	uLocal_45[iParam0] = 3;
	uLocal_45[iParam0].f_1 = { uParam1 + func_83(uParam5, fParam4 - 180f) };
	uLocal_45[iParam0].f_1.f_3 = { uParam1 + func_83(uParam8, fParam4 - 180f) };
	uLocal_45[iParam0].f_1.f_6 = 1f;
	uLocal_45[iParam0].f_8 = { uParam1 };
	uLocal_45[iParam0].f_8.f_3 = { 0f, 0f, fParam4 };
	return;
}
