...
void main() // Position - 0x0
{
	...
	uLocal_60 = { uScriptParam_628.f_1[0] };
	func_402();
...
void func_18() // Position - 0xA22
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (_GET_CHARACTER_MODEL(G_MissionStats.f_2366.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			{
				if (G_MissionStats.f_2366.f_539.f_4321 != character && func_19(G_MissionStats.f_2366.f_539.f_4321))
...
void func_37() // Position - 0x1001
{
	if (iLocal_64 == 1)
	{
		...
		func_38(uLocal_98[0], &uLocal_137[0], -1, 0, false, false, -1082130432, 0, -1, -1, true, false, false);
		func_38(uLocal_98[1], &uLocal_137[1], -1, 0, false, false, -1082130432, 0, -1, -1, true, false, false);
		func_38(uLocal_101[0], &uLocal_154[0], -1, 0, false, false, -1082130432, 0, -1, -1, true, false, false);
		func_38(uLocal_101[1], &uLocal_154[1], -1, 0, false, false, -1082130432, 0, -1, -1, true, false, false);
	}
...
void func_45(int iParam0) // Position - 0x2287
{
	...
	else if (IS_BIT_SET(G_MissionStats.f_20567.f_471, iParam0) || IS_BIT_SET(Global_2359296[func_47()].f_681.f_10, iParam0))
	{
		flag = true;
		MISC::CLEAR_BIT(&(G_MissionStats.f_20567.f_471), iParam0);
		MISC::CLEAR_BIT(&(Global_2359296[func_47()].f_681.f_10), iParam0);
	}
...
BOOL func_54(int iParam0) // Position - 0x25C5
{
	...
	return IS_BIT_SET(Global_2359296[func_47()].f_681.f_10, iParam0);
}
...
int func_103(Ped pedParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x35E1
{
	...
	if (iParam1 == 12)
	{
		...
		for (i = 0; i <= 14; i = i + 1)
		{
				...
				if (IS_BIT_SET(Global_78472[1].f_6, 0))
				{
					if (i == 13)
					{
						...
						for (j = 0; j <= 8; j = j + 1)
						{
							...
							func_123(pedParam0, Global_78472[1].f_12, Global_78472[1].f_3, Global_78472[1].f_4);
							func_146(14);
					...
					else if (i != 14 && i != 12)
					{
						...
						if (iParam4 == -1)
							PED::SET_PED_COMPONENT_VARIATION(pedParam0, func_113(i), Global_78472[1].f_3, Global_78472[1].f_4, PED::GET_PED_PALETTE_VARIATION(pedParam0, func_113(i)));
						else
							PED::SET_PED_COMPONENT_VARIATION(pedParam0, func_113(i), Global_78472[1].f_3, Global_78472[1].f_4, iParam4);
			...
			{
				Global_78472[1] = { func_151(entityModel, i, func_112(pedParam0, i, PV_COMP_INVALID), -1) };
	...
	{
		if (iParam4 == -1)
			PED::SET_PED_COMPONENT_VARIATION(pedParam0, func_113(iParam1), Global_78472[1].f_3, Global_78472[1].f_4, PED::GET_PED_PALETTE_VARIATION(pedParam0, func_113(iParam1)));
		else
			PED::SET_PED_COMPONENT_VARIATION(pedParam0, func_113(iParam1), Global_78472[1].f_3, Global_78472[1].f_4, iParam4);
	...
	switch (hParam0)
	{
		case joaat("Player_Zero"):
			switch (iParam1)
			{
				...
				case 5:
					func_139(&unk, -99, -99, G_MissionStats.f_2366.f_539.f_196[0], G_MissionStats.f_2366.f_539.f_200[0], 6, 3, 0, 0, 0, -99, 0, 0, 3);
					break;
		...
		case joaat("Player_One"):
			switch (iParam1)
			{
				...
				case 2:
					func_139(&unk, -99, -99, G_MissionStats.f_2366.f_539.f_196[1], G_MissionStats.f_2366.f_539.f_200[1], 17, 2, 26, 0, 0, -99, 0, 45, 31);
					break;
		...
		case joaat("Player_Two"):
			switch (iParam1)
			{
				...
				case 4:
					func_139(&unk, -99, -99, G_MissionStats.f_2366.f_539.f_196[2], G_MissionStats.f_2366.f_539.f_200[2], 8, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
...
void func_146(int iParam0) // Position - 0xA540
{
	if (IS_BIT_SET(Global_78472[1].f_6, 1) && !IS_BIT_SET(Global_78472[1].f_6, 6))
		func_149(iParam0, Global_78472[1].f_5, Global_78472[1].f_2, 2, Global_78472[1].f_1, 1, 0);
...
BOOL func_215(Ped pedParam0, int iParam1, int iParam2) // Position - 0x21ABC
{
			...
			if (unk[i] != -99 && i != 12 && i != 14)
			{
				if (!func_215(pedParam0, i, unk[i]))
				{
								...
								for (k = 0; k <= 19; k = k + 1)
								{
									...
									if (Global_78472[2].f_12 == j)
										if (func_215(pedParam0, 14, k))
											if (!func_109(entityModel, iParam2, 14, k, &unk, &Global_78472[2]))
												return false;
								}
							}
						}
					...
					else
					{
						...
						if (!func_109(entityModel, iParam2, i, num, &unk, &Global_78472[2]))
							return false;
					}
				}
			}
	...
	else if (Global_78472[1].f_3 == PED::GET_PED_DRAWABLE_VARIATION(pedParam0, func_113(iParam1)) && Global_78472[1].f_4 == PED::GET_PED_TEXTURE_VARIATION(pedParam0, func_113(iParam1)))
	{
		return true;
	}
...
void func_337() // Position - 0x27C48
{
	...
	if (iLocal_201 == 2)
	{
		...
		unk4 = 2;
		unk11 = 2;
		unk4[0] = { 381.5702f, -867.3578f, 28.1573f };
		unk4[1] = { 379.5334f, -867.1062f, 28.1713f };
		unk11[0] = 236.3457f;
		unk11[1] = 232.1922f;
	
		for (iLocal_186 = 0; iLocal_186 <= 1; iLocal_186 = iLocal_186 + 1)
		{
			unk[iLocal_186] = VEHICLE::CREATE_VEHICLE(hLocal_222, unk4[iLocal_186], unk11[iLocal_186], true, true, false);
...
BOOL func_361(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6) // Position - 0x28E11
{
	...
	if (!flag)
	{
		...
		if (!func_395(G_MissionStats.f_24998.f_43[iParam3]))
			return false;
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_393() || Global_112857 || Global_32286 || func_392() || func_25(8, -1) || func_391() || func_390() || func_389() || func_388() || G_MissionStats.f_7691.f_919[character] == 5)
							return false;
						break;
				
					case 1:
						if (PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_393() || Global_32286 || func_392() || func_25(8, -1) || func_389() || func_391() || func_390() || func_388() || G_MissionStats.f_7691.f_919[character] == 5)
							return false;
						break;
				
					case 2:
						if (!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_393() || Global_112857 || Global_32286 || func_392() || func_25(8, -1) || func_389() || func_391() || func_390() || func_388() || G_MissionStats.f_7691.f_919[character] == 5 || Global_43924 != -1)
							return false;
						break;
				
					case 3:
						if (PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_393() || Global_112857 || Global_32286 || func_392() || func_25(8, -1) || func_391() || func_390() || func_388() || G_MissionStats.f_7691.f_919[character] == 5)
							return false;
						break;
				
					case 4:
						if (func_393() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0 || func_25(8, -1) || func_388() || func_387() || G_MissionStats.f_7691.f_919[character] == 5)
							return false;
						break;
...
void func_426() // Position - 0x2B2EB
{
	...
	if (value > 0f && SYSTEM::FLOOR(value) < SYSTEM::FLOOR(G_MissionStats.f_10197.f_3853))
		func_71(13, SYSTEM::FLOOR(G_MissionStats.f_10197.f_3853));
