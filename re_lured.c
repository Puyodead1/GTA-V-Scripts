...
void main() // Position - 0x0
{
	...
	iLocal_41 = 49;
	iLocal_42 = 64;
	uLocal_49 = Vector3(uScriptParam_252.f_1[0]);
...
BOOL func_56() // Position - 0x2003
{
	...
	vector = Vector3(30f, 30f, 30f);
	vector2 = Vector3(-30f, -30f, -30f);
	...
	if (!PED::IS_PED_INJURED(pedLocal_69) && !PED::IS_PED_INJURED(pedLocal_70))
	{
		...
		vector = Vector3(vector + PED::GET_PED_BONE_COORDS(pedLocal_69, 31086, 0f, 0f, 0f));
		vector2 = Vector3(vector2 + PED::GET_PED_BONE_COORDS(pedLocal_69, 31086, 0f, 0f, 0f));
...
BOOL _STAT_GET_PACKED_BOOL(int iParam0, int iParam1) // Position - 0x33CB
{
	if (iParam1 == -1)
		iParam1 = func_14();
...
void func_117() // Position - 0x48F0
{
	...
	PED::ADD_SCENARIO_BLOCKING_AREA(uLocal_49 - Vector3(10f, 30f, 30f), uLocal_49 + Vector3(10f, 30f, 30f), false, true, true, true);
...
{
	uLocal_52 = Vector3(879.8144f, -1047.4327f, 32.0067f);
	fLocal_67 = 237.0934f;
	uLocal_58 = Vector3(862.9633f, -1049.8569f, 28.5362f);
	uLocal_55 = Vector3(15f, 15f, 15f);
	uLocal_61 = Vector3(881.1367f, -1050.706f, 32.0067f);
	uLocal_64 = Vector3(876.7977f, -1052.5198f, 32.0067f);
	return;
}
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_171() || Global_112695 || Global_32166 || func_170() || func_51(8, -1) || func_169() || func_168() || func_167() || func_166() || G_SomeGlobalState.MessageCallStates.f_919[character] == 5)
							return false;
						break;
				
					case 1:
						if (PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_171() || Global_32166 || func_170() || func_51(8, -1) || func_167() || func_169() || func_168() || func_166() || G_SomeGlobalState.MessageCallStates.f_919[character] == 5)
							return false;
						break;
				
					case 2:
						if (!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_171() || Global_112695 || Global_32166 || func_170() || func_51(8, -1) || func_167() || func_169() || func_168() || func_166() || G_SomeGlobalState.MessageCallStates.f_919[character] == 5 || LastDispatchedMessageOrCall != -1)
							return false;
						break;
				
					case 3:
						if (PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_171() || Global_112695 || Global_32166 || func_170() || func_51(8, -1) || func_169() || func_168() || func_166() || G_SomeGlobalState.MessageCallStates.f_919[character] == 5)
							return false;
						break;
				
					case 4:
						if (func_171() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0 || func_51(8, -1) || func_166() || func_165() || G_SomeGlobalState.MessageCallStates.f_919[character] == 5)
							return false;
						break;
