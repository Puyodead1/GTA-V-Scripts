...
BOOL IS_PLAYSTATION_PLATFORM() // Position - 0x8D3A
{
	return MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION();
}

BOOL IS_XBOX_PLATFORM() // Position - 0x8D50
{
	return MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION();
}

void func_112(char* sParam0, Any anParam1, int iParam2) // Position - 0x8D66
{
...
BOOL func_226(Ped pedParam0, Ped pedParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xEA9B
{
	...
	flag = func_227(&iLocal_37[num], pedBoneCoords, pedParam1, &(iLocal_37[num].f_3), pedParam0, iParam5);
...
BOOL func_227(var uParam0, Vector3 vParam1, var uParam2, var uParam3, Ped pedParam4, var uParam5, Ped pedParam6, int iParam7) // Position - 0xEB5C
{
	...
	if (*uParam0 == 0)
	{
		endCoords = Vector3(func_228(pedParam4, iParam7));
...
BOOL func_230(Ped pedParam0, Ped pedParam1, int iParam2, int iParam3) // Position - 0xED97
{
	...
	unk = Vector3(func_232(ENTITY::GET_ENTITY_COORDS(pedParam1, true) - ENTITY::GET_ENTITY_COORDS(pedParam0, true)));
	...
	if (iParam3 == 0)
		...
		entityForwardVector = Vector3(func_232(PED::GET_PED_BONE_COORDS(pedParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(pedParam0, 31086, 0f, 0f, 0f)));
...
BOOL func_239(Ped pedParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0xF1A6
{
	...
	unk = Vector3(func_232(uParam1 - ENTITY::GET_ENTITY_COORDS(pedParam0, true)));
...
BOOL func_252(var uParam0) // Position - 0xF5C4
{
	...
	switch (iLocal_91)
	{
		...
		case 2:
			...
			{
				vector = Vector3(-916.6389f, 6137.046f, 4.7157f);
			...
			{
				vector = Vector3(-917.7f, 6138.89f, 4.72f);
			...
			{
				vector = Vector3(-915.6122f, 6137.662f, 4.6129f);
			...
			{
				vector = Vector3(-915.4199f, 6137.8555f, 4.6221f);
