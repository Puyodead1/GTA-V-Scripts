...
void main() // Position - 0x0
{
	...
	fLocal_1249 = 0f;
	fLocal_1251 = 0f;
	uLocal_1297 = Vector3(-1162.985f, -161.715f, -38.221f);
	uLocal_1300 = Vector3(-1327.63f, -266.202f, 38.221f);
	uLocal_1303 = Vector3(-1236.6611f, -197.316f, 39.6313f);
	uLocal_1306 = Vector3(-1266.0273f, -218.98291f, 41.44594f);
	uLocal_1312 = Vector3(-1237.7314f, -189.54518f, 40.63728f);
	fLocal_1315 = 40f;
	...
	uLocal_1669 = Vector3(-1263.6769f, -222.2767f, 41.446f);
	fLocal_1672 = 304.201f;
	uLocal_1673 = Vector3(-1507.2521f, -934.3307f, 8.6562f);
	fLocal_1676 = 137.9228f;
	uLocal_1679 = Vector3(-1510.7333f, -935.95996f, 10.902136f);
	uLocal_1682 = Vector3(15.074911f, -0.024198f, -71.861885f);
	uLocal_1685 = Vector3(-1510.8776f, -936.1155f, 9.798549f);
	uLocal_1688 = Vector3(4.686822f, -0.024198f, -72.45972f);
	...
	func_537();
	iLocal_269 = 0;
	uLocal_57 = Vector3(func_535(iLocal_269));
...
BOOL func_71(BOOL bParam0, BOOL bParam1, BOOL bParam2) // Position - 0x2D40
{
	...
	if (func_78() || func_77(*Global_MissionData1.missionGenAdverm) || func_76())
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
		{
...
void func_109() // Position - 0x45FC
{
	...
	for (i = 0; i < 3; i = i + 1)
	{
		if (ENTITY::DOES_ENTITY_EXIST(uLocal_1054[i]))
			if (bLocal_1138 && !bLocal_1171)
				func_149(uLocal_1054[i], &uLocal_1064[i], -1, 0, false, false, 150f, 0, -1, -1, true, false, false);
	}
	...
	for (i = 0; i < 2; i = i + 1)
	{
		if (ENTITY::DOES_ENTITY_EXIST(uLocal_1058[i]))
			if (bLocal_1138 && !bLocal_1171)
				func_149(uLocal_1058[i], &uLocal_1089[i], -1, 0, false, false, 150f, 0, -1, -1, true, false, false);
	}
	...
	for (i = 0; i < 2; i = i + 1)
	{
		...
		{
			if (bLocal_1138 && !bLocal_1171)
				func_149(uLocal_1051[i], &uLocal_1106[i], -1, 0, false, false, 150f, 0, -1, -1, true, false, false);
	...
	switch (uLocal_1041[iParam0])
	{
		...
		case 2:
			if (VEHICLE::IS_VEHICLE_DRIVEABLE(veLocal_1317, false))
			{
				if (!TASK::IS_WAYPOINT_PLAYBACK_GOING_ON_FOR_VEHICLE(veLocal_1317))
				{
					entityCoords = Vector3(ENTITY::GET_ENTITY_COORDS(veLocal_1317, true));
...
Vector3 func_128() // Position - 0x5A16
{
	...
	{
		case 0:
			unk = Vector3(-1270.2063f, -200.3586f, 40.8333f);
			break;
	
		case 1:
			unk = Vector3(-1268.439f, -215.9683f, 59.654f);
			break;
	
		case 2:
			unk = Vector3(-1241.5585f, -239.3237f, 38.7884f);
			break;
	}
...
BOOL func_132() // Position - 0x5C88
{
	...
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		...
		if (!ENTITY::IS_ENTITY_DEAD(veLocal_1316, false))
			entityCoords2 = Vector3(ENTITY::GET_ENTITY_COORDS(veLocal_1316, true));
	...
	switch (uLocal_1037[iParam0])
	{
		case 0:
			if (!PED::IS_PED_INJURED(driver))
			{
				TASK::CLEAR_SEQUENCE_TASK(&iLocal_1328);
				TASK::OPEN_SEQUENCE_TASK(&iLocal_1328);
				TASK::TASK_GO_TO_COORD_ANY_MEANS(0, uLocal_1272[iParam0], 1f, 0, false, 786603, -1082130432);
				...
				if (!ENTITY::IS_ENTITY_DEAD(driver, false))
					if (!bLocal_1173)
						if (TASK::GET_SCRIPT_TASK_STATUS(driver, SCRIPT_TASK_PLAY_ANIM) != 1 && TASK::GET_SCRIPT_TASK_STATUS(driver, SCRIPT_TASK_PERFORM_SEQUENCE) != 1)
							if (ENTITY::IS_ENTITY_AT_COORD(driver, uLocal_1272[iParam0], 3f, 3f, 3f, false, true, 0))
		...
		case 3:
			...
			else if (!PED::IS_PED_INJURED(uLocal_1051[iParam0]))
			{
				...
				else
				{
					if (ENTITY::DOES_ENTITY_EXIST(veLocal_1316) && VEHICLE::IS_VEHICLE_DRIVEABLE(veLocal_1316, false))
					{
						worldPositionOfEntityBone = Vector3(ENTITY::GET_WORLD_POSITION_OF_ENTITY_BONE(veLocal_1316, ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(veLocal_1316, "wheel_lr")));
						entityCoords = Vector3(ENTITY::GET_ENTITY_COORDS(veLocal_1316, true));
						entityCoords = Vector3(worldPositionOfEntityBone - entityCoords);
...
void func_150() // Position - 0x74B5
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(pedLocal_1050))
		uLocal_1309 = Vector3(ENTITY::GET_ENTITY_COORDS(pedLocal_1050, false));
...
void func_166(int iParam0) // Position - 0x88ED
{
	...
	else if (IS_BIT_SET(Global_113648.f_20566.f_471, iParam0) || IS_BIT_SET(Global_2359296[func_168()].f_681.f_10, iParam0))
	{
		flag = true;
		MISC::CLEAR_BIT(&(Global_113648.f_20566.f_471), iParam0);
...
void _MPCHAR_STAT_SET_INT(eMPStat empsParam0, int iParam1, int iParam2, BOOL bParam3, BOOL bParam4) // Position - 0x8B7B
{
	...
	bParam4;
	statName = Global_2805029[empsParam0][func_170(iParam2)];
...
void _STAT_SET_PACKED_BOOL(int iParam0, BOOL bParam1, int iParam2) // Position - 0x8BEB
{
	if (iParam2 == -1)
		iParam2 = func_171();
...
int _MPCHAR_STAT_GET_INT(eMPStat empsParam0, int iParam1, int iParam2) // Position - 0x8DCF
{
	...
	{
		iParam2 == 0;
		statHash = Global_2805029[empsParam0][func_170(iParam1)];
...
BOOL _STAT_GET_PACKED_BOOL(int iParam0, int iParam1) // Position - 0x8E0C
{
	if (iParam1 == -1)
		iParam1 = func_171();
...
char* func_220(int iParam0, BOOL bParam1) // Position - 0xAFFC
{
	...
	if (!MISC::IS_STRING_NULL_OR_EMPTY(&Global_23270.f_7488[iParam0]))
	{
		...
		{
			return func_221(&Global_23270.f_7488[iParam0]);
		}
	}
...
char* func_223(int iParam0) // Position - 0xB545
{
	...
	if (!MISC::IS_STRING_NULL_OR_EMPTY(&Global_23270.f_6463[iParam0]))
	{
		...
		{
			return func_221(&Global_23270.f_6463[iParam0]);
		}
	}
...
void func_224(var uParam0, int iParam1, float fParam2, float fParam3, float fParam4, int iParam5) // Position - 0xB5BA
{
	...
	HUD::SET_TEXT_COLOUR(r, g, b, iParam5);
	func_225(uParam0->f_489[iParam1], uParam0->f_503[iParam1], fParam4, fParam2, &uParam0->f_280[iParam1], uParam0->f_57[iParam1]);
	return;
}
...
void func_276() // Position - 0xD393
{
	...
	{
		entityCoords = Vector3(ENTITY::GET_ENTITY_COORDS(pedLocal_1050, true));
		entityHeading = ENTITY::GET_ENTITY_HEADING(pedLocal_1050);
	}

	unk[0] = Vector3(OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(entityCoords, entityHeading, 1f, -1f, 0f));
	unk[1] = Vector3(OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(entityCoords, entityHeading, -1f, -1f, 0f));

	for (i = 0; i < 2; i = i + 1)
	{
		if (i == 0)
			uLocal_1051[i] = PED::CREATE_PED(PED_TYPE_MISSION, hLocal_1331, unk[0], unk[0].f_1, 38.3253f, uLocal_1243[iLocal_1206], true, true);
		else
			uLocal_1051[i] = PED::CREATE_PED(PED_TYPE_MISSION, hLocal_1332, unk[1], unk[1].f_1, 38.3253f, uLocal_1243[iLocal_1206], true, true);
...
void func_278() // Position - 0xD554
{
	...
	pedLocal_1050 = PED::CREATE_PED(PED_TYPE_MISSION, hLocal_1329, uLocal_1262[iLocal_1206], uLocal_1243[iLocal_1206], true, true);
...
void func_280() // Position - 0xD66D
{
	...
	for (i = 0; i < 3; i = i + 1)
	{
		if (!CAM::IS_SPHERE_VISIBLE(uLocal_1252[i], 5f) && !func_284(i, 6f))
		{
			uLocal_1262[iLocal_1199] = Vector3(uLocal_1252[i]);
	...
	if (iLocal_1199 == 0)
	{
		if (func_104())
		{
			uLocal_1262[0] = Vector3(uLocal_1252[1]);
			uLocal_1243[0] = uLocal_1239[1];
			iLocal_1199 = iLocal_1199 + 1;
		}
		else if (func_283())
		{
			uLocal_1262[0] = Vector3(uLocal_1252[0]);
		...
		else
		{
			for (i = 0; i < 3; i = i + 1)
			{
				if (func_282(uLocal_1252[i], true) > 30f && !func_284(i, 6f))
				{
					uLocal_1262[iLocal_1199] = Vector3(uLocal_1252[i]);
					uLocal_1243[iLocal_1199] = uLocal_1239[i];
					iLocal_1199 = iLocal_1199 + 1;
...
void func_281() // Position - 0xD7A5
{
	...
	for (i = 0; i < 3; i = i + 1)
	{
		num = SYSTEM::VDIST(entityCoords, uLocal_1252[i]);
	...
	uLocal_1262[0] = Vector3(uLocal_1252[iLocal_1250]);
...
{
	if (VEHICLE::IS_ANY_VEHICLE_NEAR_POINT(uLocal_1252[iParam0], fParam1))
		return true;
	...
	*uParam0 = VEHICLE::GET_CLOSEST_VEHICLE(-1221.954f, -210.746f, 38.638f, 27f, 0, 4);
	...
	if (veLocal_1323 != 0)
	{
		if (ENTITY::DOES_ENTITY_EXIST(veLocal_1323) && !ENTITY::IS_ENTITY_DEAD(veLocal_1323, false))
		{
			...
			{
				entityCoords = Vector3(ENTITY::GET_ENTITY_COORDS(veLocal_1323, true));
				return true;
			}
		}
	}
...
void func_293() // Position - 0xDBE0
{
	...
	for (i = 0; i < 3; i = i + 1)
	{
		if (!ENTITY::DOES_ENTITY_EXIST(uLocal_1054[i]))
		{
			...
			uLocal_1054[i] = PED::CREATE_PED(PED_TYPE_MISSION, modelHash, uLocal_1272[i], uLocal_1225[i], true, true);
	...
	if (num == 1)
	{
		...
		else
		{
			...
			if (num4 != -1)
			{
				...
				TEXT_LABEL_COPY(&unk3, Vector3(func_373(num4)), 4);
...
void func_313(var uParam0, const char* sParam1, int iParam2, char* sParam3, int iParam4, Ped pedParam5) // Position - 0xEB85
{
	...
	*uParam0 = _GET_CURRENT_PLAYER_CHARACTER();
	...
	for (j = CHAR_MICHAEL; j < CHAR_MULTIPLAYER; j = j + 1)
	{
		...
		{
			func_319(PLAYER::PLAYER_PED_ID(), &uParam0->f_616[j], 1, -1);
		}
		else
		{
			for (i = 0; i < 12; i = i + 1)
...
BOOL func_320(int iParam0, int iParam1) // Position - 0xFECD
{
	...
	statHash = Global_2848282[iParam0][func_170(iParam1)];
...
void func_324(Ped pedParam0, BOOL bParam1) // Position - 0x1069D
{
	...
	if (func_20(character) && !PED::IS_PED_INJURED(pedParam0))
	{
		if (pedParam0 == PLAYER::PLAYER_PED_ID())
		{
			func_325(pedParam0, &Global_113648.f_2365.f_539.f_298[character]);
...
BOOL func_348(int iParam0, int iParam1, var uParam2, int iParam3, BOOL bParam4) // Position - 0x13999
{
	...
	if (!bParam4)
		unk12 = Vector3(func_351(iParam0));
	else
		unk12 = Vector3(func_350(iParam0));

	vector2 = Vector3(unk12 - unk);
	vector2 = Vector3(func_349(vector2, -unk.f_3.f_2));
	vector2 = Vector3(func_349(vector2, vector.f_3.f_2));
						...
						for (iLocal_1196 = 0; iLocal_1196 < 3; iLocal_1196 = iLocal_1196 + 1)
						{
							if (!ENTITY::IS_ENTITY_DEAD(uLocal_1054[iLocal_1196], false))
							{
								...
								if (TASK::GET_SCRIPT_TASK_STATUS(uLocal_1054[iLocal_1196], SCRIPT_TASK_PERFORM_SEQUENCE) != 1)
								{
									...
									TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, uLocal_1252[iLocal_1196], 1f, 20000, 1048576000, 0, 1193033728);
									TASK::CLOSE_SEQUENCE_TASK(iLocal_1328);
...
BOOL func_403(Vehicle veParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, float fParam7) // Position - 0x17C87
{
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(veParam0, false))
	{
		...
		num = Vector3(func_405(uParam1 - uParam4));
		unk3 = Vector3(num);
		unk18 = 4;
		num = -unk3.f_1;
		num.f_1 = unk3;
		...
		if (func_404(unk18[0], unk18[1], unk6, unk9) || func_404(unk18[0], unk18[1], unk9, unk15) || func_404(unk18[0], unk18[1], unk12, unk15) || func_404(unk18[0], unk18[1], unk6, unk12) || func_404(unk18[1], unk18[3], unk6, unk9) || func_404(unk18[1], unk18[3], unk9, unk15) || func_404(unk18[1], unk18[3], unk12, unk15) || func_404(unk18[1], unk18[3], unk6, unk12) || func_404(unk18[3], unk18[2], unk6, unk9) || func_404(unk18[3], unk18[2], unk9, unk15) || func_404(unk18[3], unk18[2], unk12, unk15) || func_404(unk18[3], unk18[2], unk6, unk12) || func_404(unk18[2], unk18[0], unk6, unk9) || func_404(unk18[2], unk18[0], unk9, unk15) || func_404(unk18[2], unk18[0], unk12, unk15) || func_404(unk18[2], unk18[0], unk6, unk12))
			return true;
	}
...
Blip func_426(Vector3 vParam0, var uParam1, var uParam2, BOOL bParam3) // Position - 0x189BB
{
	Blip blip;
...
void func_448(BOOL bParam0) // Position - 0x196A1
{
	if (bParam0)
	{
		VEHICLE::SET_ALL_VEHICLE_GENERATORS_ACTIVE_IN_AREA(Vector3(39.1642f, -193.934f, -1237.3966f) - Vector3(150f, 150f, 150f), Vector3(39.1642f, -193.934f, -1237.3966f) + Vector3(150f, 150f, 150f), false, true);
...
void func_449() // Position - 0x19760
{
	...
	unk = Vector3(-1220.344f, -193.4014f, 38.1754f);
	unk4 = Vector3(-1279.6578f, -222.0533f, 41.446f);
	...
	iLocal_1132 = PED::ADD_SCENARIO_BLOCKING_AREA(unk - Vector3(15f, 15f, 15f), unk + Vector3(15f, 15f, 15f), false, true, true, true);
	iLocal_1133 = PED::ADD_SCENARIO_BLOCKING_AREA(unk4 - Vector3(45f, 35f, 35f), unk4 + Vector3(45f, 35f, 35f), false, true, true, true);
	return;
}
...
void func_450() // Position - 0x1988C
{
	...
	TEXT_LABEL_COPY(&(uLocal_969.f_6), Vector3(Global_63377), 6);
...
{
	uLocal_1288 = Vector3(-1343.4927f, -153.199f, 47.1825f);
	fLocal_1237 = 260.3612f;
	uLocal_1291 = Vector3(-1242.2126f, -241.5975f, 38.71f);
	fLocal_1223 = 96.8755f;
	uLocal_1294 = Vector3(-1221.6313f, -186.88194f, 38.799603f);
	fLocal_1224 = 201.0763f;
	fLocal_1238 = 40f;
	uLocal_360.f_2 = 40f;
	uLocal_1252[0] = Vector3(-1221.1538f, -170.9907f, 38.3253f);
	uLocal_1252[1] = Vector3(-1210.5562f, -192.882f, 38.3253f);
	uLocal_1252[2] = Vector3(-1216.3691f, -203.6806f, 38.3253f);
	uLocal_1239[0] = 157.3177f;
	uLocal_1239[1] = 58.3594f;
	uLocal_1239[2] = 65.6443f;
	uLocal_1272[0] = Vector3(-1220.3773f, -169.407f, 38.3253f);
	uLocal_1272[1] = Vector3(-1208.963f, -193.8791f, 38.3253f);
	uLocal_1272[2] = Vector3(-1214.9547f, -205.0824f, 38.3253f);
	uLocal_1272[3] = Vector3(-1217.5182f, -197.13f, 38.3254f);
	uLocal_1272[4] = Vector3(-1231.8916f, -194.382f, 38.1753f);
		...
		case 6:
			...
			if (CUTSCENE::HAS_CUTSCENE_FINISHED() && !CUTSCENE::IS_CUTSCENE_PLAYING())
			{
				...
				if (!PED::IS_PED_INJURED(pedLocal_1062))
				{
					...
					PED::SET_PED_CAN_RAGDOLL(pedLocal_1062, true);
				}
...
BOOL IS_PLAYSTATION_PLATFORM() // Position - 0x1EAED
{
	return MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION();
}

BOOL IS_XBOX_PLATFORM() // Position - 0x1EB03
{
...
void func_490(int iParam0) // Position - 0x1EEA3
{
	...
	if (func_494(&Global_77348.f_555[0], iParam0))
	{
		...
		{
			if (iParam0 == 24 && func_489(iParam0, 0) && Global_78257.f_66 == 0 && Global_113648.f_32751.f_1958[Global_77348.f_555[0].f_14] != 0 && Global_113648.f_32751.f_1958[Global_77348.f_555[0].f_14] > 3 && !func_492(0, Global_77348.f_555[0].f_12) || !func_492(1, Global_77348.f_555[0].f_12))
			{
				func_491(&Global_113648.f_32751.f_69[Global_77348.f_555[0].f_14], &Global_78257);
...
BOOL func_492(int iParam0, int iParam1) // Position - 0x1F0DE
{
	...
	if (iParam0 < 0 || iParam0 >= func_493(&Global_113648.f_32751.f_5038[num]))
		return false;

	return func_472(Global_113648.f_32751.f_5038[num][iParam0].f_66, false, -1);
}
...
BOOL func_494(var uParam0, int iParam1) // Position - 0x1F15C
{
	...
	*uParam0 = Vector3(0f, 0f, 0f);
	...
	if (IS_BIT_SET(uParam0->f_9, 10))
	{
		...
		if (!func_50(Global_113648.f_32751.f_1864[uParam0->f_14], 0f, 0f, 0f, false))
	...
	{
		if (!func_50(Global_113648.f_2365.f_539.f_3588[1][uParam0->f_12], 0f, 0f, 0f, false))
		{
	...
	{
		if (!func_50(Global_113648.f_2365.f_539.f_3588[0][uParam0->f_12], 0f, 0f, 0f, false))
		{
...
void func_527(Vector3 vParam0, var uParam1, var uParam2, float fParam3, BOOL bParam4) // Position - 0x2204B
{
	...
	for (i = 0; i < 68; i = i + 1)
	{
		if (func_494(&Global_77348.f_555[0], i))
...
void func_542() // Position - 0x2285B
{
	...
	for (i = 0; i < 3; i = i + 1)
	{
		if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false) && !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
		{
			if (func_282(uLocal_1252[i], true) < 5f)
			{
