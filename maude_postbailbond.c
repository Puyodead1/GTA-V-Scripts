...
BOOL func_35(Object obParam0, Ped pedParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xDDC
{
	...
	if (num == -1)
	{
		...
		iLocal_35[num].f_1 = obParam0;
		iLocal_35[num].f_2 = pedParam1;
	}

	pedBoneCoords = { PED::GET_PED_BONE_COORDS(obParam0, 31086, 0f, 0f, 0f) };
	flag = func_36(&iLocal_35[num], pedBoneCoords, pedParam1, &(iLocal_35[num].f_3), obParam0, iParam5);
...
int func_41(Object obParam0, Ped pedParam1) // Position - 0x1184
{
	...
	for (i = 0; i < iLocal_35; i = i + 1)
	{
		if (iLocal_35[i].f_1 == obParam0 && iLocal_35[i].f_2 == pedParam1)
			return i;
	}
