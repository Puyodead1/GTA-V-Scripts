...
void func_176(Vehicle veParam0, var uParam1, float fParam2, float fParam3) // Position - 0xB571
{
	...
	vector = { func_179(uParam1->[0], uParam1->[1], fParam2, false) };
	...
	vector = { func_179(uParam1->[0], uParam1->[1], 1.1f, false) };
...
int func_213(Ped pedParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0xCDCA
{
	...
	if (iParam5 == 0)
	{
		Global_78341[1] = { func_261(entityModel, iParam1, iParam2, -1) };
	...
	if (iParam1 == 12)
	{
		...
		for (i = 0; i <= 14; i = i + 1)
		{
			if (unk[i] != -99)
			{
				Global_78341[1] = { func_261(entityModel, i, unk[i], -1) };
				...
				if (IS_BIT_SET(Global_78341[1].f_6, 0))
				{
					if (i == 13)
					{
						...
						for (j = 0; j <= 8; j = j + 1)
						{
							Global_78341[1] = { func_261(entityModel, 14, unk18[j], -1) };
			...
			{
				Global_78341[1] = { func_261(entityModel, i, func_222(pedParam0, i, PV_COMP_INVALID), -1) };
	...
	else if (iParam1 == 13)
	{
		...
		for (j = 0; j <= 8; j = j + 1)
		{
			Global_78341[1] = { func_261(entityModel, 14, unk59[j], -1) };
			func_233(pedParam0, Global_78341[1].f_12, Global_78341[1].f_3, Global_78341[1].f_4);
			func_256(14);
...
{
	Global_78341[1] = { func_261(hParam0, iParam1, iParam2, -1) };
			...
			if (unk[i] != -99 && i != 12 && i != 14)
			{
				if (!func_325(pedParam0, i, unk[i]))
				{
					if (i == 13)
					{
						...
						for (j = 0; j <= 8; j = j + 1)
						{
							if (!func_325(pedParam0, 14, unk18[j]))
							{
								for (k = 0; k <= 19; k = k + 1)
								{
									Global_78341[2] = { func_261(entityModel, 14, k, -1) };
					...
					else
					{
						...
						Global_78341[2] = { func_261(entityModel, i, num, -1) };
...
void func_328() // Position - 0x2B0EC
{
	...
	while (true)
	{
		...
		else
		{
			...
			{
				offsetFromCoordAndHeadingInWorldCoords = { OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS((uLocal_76.f_7[0] + uLocal_76.f_7[1]) / Vector3( 2f, 2f, 2f ), uLocal_76.f_24, uLocal_631) };
				vector = { fLocal_634, SYSTEM::VDIST(uLocal_76.f_7[0], uLocal_76.f_7[1]), fLocal_635 };
				rotZ = uLocal_76.f_24;
...
void func_329(Vehicle veParam0, var uParam1, int iParam2) // Position - 0x2B4C3
{
	...
	if (func_327(veParam0))
	{
		...
		{
			func_177(veParam0, MISC::GET_CLOSEST_POINT_ON_LINE(ENTITY::GET_ENTITY_COORDS(veParam0, true), uParam1->[0], uParam1->[1], false) + { 0.1f, 0f, 0f });
...
struct<8> func_343(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, float fParam8) // Position - 0x2C1A2
{
	...
	unk = 2;
	unk9 = { func_37(uParam0[1] - uParam0[0]) * { fParam8, fParam8, fParam8 } };
...
{
	uParam0->f_12 = { func_37(uParam1 * Vector3( 5f, 5f, 5f )) };
