...
void func_36(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5, float fParam6, BOOL bParam7) // Position - 0x1898
{
	...
	while (num < distanceBetweenCoords)
	{
		...
		vector = { vector + (unk3 * Vector3(fParam6 / 2f, fParam6 / 2f, fParam6 / 2f)) };
		num = num + (fParam6 / 2f);
	}
			...
			else
			{
				...
				if (shapeTestResult == 2)
				{
					if (func_97(entityHit, true))
					{
						...
						{
							offsetFromEntityInWorldCoords = { ENTITY::GET_OFFSET_FROM_ENTITY_GIVEN_WORLD_COORDS(uParam0->f_1, endCoords + (ENTITY::GET_ENTITY_FORWARD_VECTOR(uParam0->f_1) * Vector3(-offsetY2, -offsetY2, -offsetY2))) };
							uParam0->f_17 = 1.5f;
						}
					...
					for (i = 0; i < uParam0->f_3; i = i + 1)
					{
						...
						else
						{
							...
							if (shapeTestResult == 2)
							{
								...
								if (func_97(entityHit, true))
								{
									offsetFromEntityInWorldCoords = { ENTITY::GET_OFFSET_FROM_ENTITY_GIVEN_WORLD_COORDS(uParam0->f_1, endCoords + (ENTITY::GET_ENTITY_FORWARD_VECTOR(uParam0->f_1) * Vector3(-offsetY3, -offsetY3, -offsetY3))) };
									uParam0->f_46[i] = 1;
...
struct<8> func_343(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, float fParam8) // Position - 0x2C1A2
{
	...
	unk = 2;
	unk9 = { func_37(uParam0[1] - uParam0[0]) * Vector3(fParam8, fParam8, fParam8) };
