	...
	switch (iLocal_428)
	{
		case 0:
			if (_NETWORK_IS_PLAYER_VALID(PLAYER::PLAYER_ID(), true, true) && !Global_1574582.f_6)
			{
				...
				uLocal_315 = { ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uLocal_290[uLocal_1406[NETWORK::PARTICIPANT_ID_TO_INT()].f_3], 0f, 0f, 0f) };
		...
		case 3:
			...
			offsetFromEntityGivenWorldCoords = { ENTITY::GET_OFFSET_FROM_ENTITY_GIVEN_WORLD_COORDS(uLocal_290[uLocal_1406[NETWORK::PARTICIPANT_ID_TO_INT()].f_3], ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true)) };
