...
void func_24() // Position - 0x10EE
{
	...
	for (j = 0; j < 3; j = j + 1)
	{
		...
		Global_107196.f_25[0][j] = { Global_104212.f_25[0][j] };
		Global_107196.f_25[1][j] = { Global_104212.f_25[1][j] };
		...
		for (i = 0; i < 44; i = i + 1)
		{
			Global_107196.f_812[j][i] = { Global_104212.f_812[j][i] };
		}
	
		for (i = 0; i < 51; i = i + 1)
		{
			Global_107196.f_812[j].f_221[i] = { Global_104212.f_812[j].f_221[i] };
		}
...
int func_210(Ped pedParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0xD8D9
{
	...
	if (iParam5 == 0)
	{
		Global_78341[1] = { func_259(entityModel, iParam1, iParam2, -1) };
	...
	if (iParam1 == 12)
	{
		...
		for (i = 0; i <= 14; i = i + 1)
		{
			if (unk[i] != -99)
			{
				Global_78341[1] = { func_259(entityModel, i, unk[i], -1) };
				...
				if (IS_BIT_SET(Global_78341[1].f_6, 0))
				{
					if (i == 13)
					{
						...
						for (j = 0; j <= 8; j = j + 1)
						{
							Global_78341[1] = { func_259(entityModel, 14, unk18[j], -1) };
			...
			{
				Global_78341[1] = { func_259(entityModel, i, func_220(pedParam0, i, PV_COMP_INVALID), -1) };
	...
	else if (iParam1 == 13)
	{
		...
		for (j = 0; j <= 8; j = j + 1)
		{
			Global_78341[1] = { func_259(entityModel, 14, unk59[j], -1) };
			func_231(pedParam0, Global_78341[1].f_12, Global_78341[1].f_3, Global_78341[1].f_4);
			func_254(14);
			...
			if (unk[i] != -99 && i != 12 && i != 14)
			{
				if (!func_212(pedParam0, i, unk[i]))
				{
					if (i == 13)
					{
						...
						for (j = 0; j <= 8; j = j + 1)
						{
							if (!func_212(pedParam0, 14, unk18[j]))
							{
								for (k = 0; k <= 19; k = k + 1)
								{
									Global_78341[2] = { func_259(entityModel, 14, k, -1) };
					...
					else
					{
						...
						Global_78341[2] = { func_259(entityModel, i, num, -1) };
...
{
	Global_78341[1] = { func_259(hParam0, iParam1, iParam2, -1) };
...
void func_365(var uParam0) // Position - 0x2DD8B
{
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_28[0]))
	{
		switch (iLocal_272)
		{
			case 0:
				iLocal_273 = 0;
				uLocal_274[0] = { -2887.15f, 3197.88f, 10.17f };
				uLocal_274[1] = { -2888.92f, 3203.76f, 10.6f };
				uLocal_274[2] = { -2895.37f, 3199.37f, 10.03f };
