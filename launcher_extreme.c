...
void main() // Position - 0x0
{
	...
	func_291(&num);
	vector = Vector3(uScriptParam_99.f_1[0]);
	unk63 = 4;
	unk63[0] = 17;
	unk63[1] = 18;
	unk63[2] = 19;
	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (num != -1)
		{
			if (Global_112735[num].f_9 != -1)
			{
				...
				func_289(&(Global_112735[num].f_9));
			}
		}
	...
	if (num == 17)
	{
		iLocal_97 = PED::ADD_SCENARIO_BLOCKING_AREA(vector - Vector3(40f, 40f, 40f), vector + Vector3(40f, 40f, 40f), false, true, true, true);
...
BOOL IS_PLAYSTATION_PLATFORM() // Position - 0x8E47
{
	return MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION();
}

BOOL IS_XBOX_PLATFORM() // Position - 0x8E5D
{
	return MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION();
}

void func_112(char* sParam0, Any anParam1, int iParam2) // Position - 0x8E73
{
...
BOOL func_162(int iParam0) // Position - 0xB816
{
	...
	num = func_164(&(Global_112735[iParam0].f_9), 1, 4, false, 0);
...
BOOL func_224(Ped pedParam0, Ped pedParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xE961
{
	...
	flag = func_225(&iLocal_37[num], pedBoneCoords, pedParam1, &(iLocal_37[num].f_3), pedParam0, iParam5);
...
BOOL func_225(var uParam0, Vector3 vParam1, var uParam2, var uParam3, Ped pedParam4, var uParam5, Ped pedParam6, int iParam7) // Position - 0xEA22
{
	...
	if (*uParam0 == 0)
	{
		endCoords = Vector3(func_226(pedParam4, iParam7));
...
BOOL func_228(Ped pedParam0, Ped pedParam1, int iParam2, int iParam3) // Position - 0xEC5D
{
	...
	unk = Vector3(func_230(ENTITY::GET_ENTITY_COORDS(pedParam1, true) - ENTITY::GET_ENTITY_COORDS(pedParam0, true)));
	...
	if (iParam3 == 0)
		...
		entityForwardVector = Vector3(func_230(PED::GET_PED_BONE_COORDS(pedParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(pedParam0, 31086, 0f, 0f, 0f)));
...
BOOL func_237(Ped pedParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0xF06C
{
	...
	unk = Vector3(func_230(uParam1 - ENTITY::GET_ENTITY_COORDS(pedParam0, true)));
...
BOOL func_256(var uParam0) // Position - 0xF67B
{
	...
	switch (iLocal_91)
	{
		case 0:
			uParam0->f_16 = 5;
			uParam0->f_17[0] = Vector3(-63.191788f, -808.91675f, 320.24774f);
			uParam0->f_17[1] = Vector3(-68.8908f, -813.6761f, 324.29004f);
			uParam0->f_24 = 10f;
			uParam0->f_27 = 0;
			uParam0->f_25 = 1;
