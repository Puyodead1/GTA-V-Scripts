	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (num != -1)
		{
			if (Global_112897[num].f_9 != -1)
			{
				...
				func_294(&(Global_112897[num].f_9));
			}
		}
...
BOOL func_167(int iParam0) // Position - 0xB902
{
	...
	num = func_169(&(Global_112897[iParam0].f_9), 1, 4, false, 0);
...
BOOL func_229(Ped pedParam0, Ped pedParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xEA4E
{
	...
	flag = func_230(&iLocal_35[num], pedBoneCoords, pedParam1, &(iLocal_35[num].f_3), pedParam0, iParam5);
...
BOOL func_261(var uParam0) // Position - 0xF768
{
	...
	switch (iLocal_89)
	{
		case 0:
			uParam0->f_16 = 5;
			uParam0->f_17[0] = { -63.191788f, -808.91675f, 320.24774f };
			uParam0->f_17[1] = { -68.8908f, -813.6761f, 324.29004f };
			uParam0->f_24 = 10f;
			uParam0->f_27 = 0;
			uParam0->f_25 = 1;
