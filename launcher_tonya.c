...
void main() // Position - 0x0
{
	...
	num.f_41 = 6;
	func_290(&num);
	uLocal_92 = Vector3(uScriptParam_270.f_1[0]);
...
BOOL IS_PLAYSTATION_PLATFORM() // Position - 0x8D1F
{
	return MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION();
}

BOOL IS_XBOX_PLATFORM() // Position - 0x8D35
{
	return MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION();
}

void func_112(char* sParam0, Any anParam1, int iParam2) // Position - 0x8D4B
{
...
BOOL func_234(Ped pedParam0, Ped pedParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xF655
{
	...
	flag = func_235(&iLocal_37[num], pedBoneCoords, pedParam1, &(iLocal_37[num].f_3), pedParam0, iParam5);
...
BOOL func_235(var uParam0, Vector3 vParam1, var uParam2, var uParam3, Ped pedParam4, var uParam5, Ped pedParam6, int iParam7) // Position - 0xF716
{
	...
	if (*uParam0 == 0)
	{
		endCoords = Vector3(func_236(pedParam4, iParam7));
...
BOOL func_238(Ped pedParam0, Ped pedParam1, int iParam2, int iParam3) // Position - 0xF951
{
	...
	unk = Vector3(func_240(ENTITY::GET_ENTITY_COORDS(pedParam1, true) - ENTITY::GET_ENTITY_COORDS(pedParam0, true)));
	...
	if (iParam3 == 0)
		...
		entityForwardVector = Vector3(func_240(PED::GET_PED_BONE_COORDS(pedParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(pedParam0, 31086, 0f, 0f, 0f)));
...
BOOL func_247(Ped pedParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0xFD60
{
	...
	unk = Vector3(func_240(uParam1 - ENTITY::GET_ENTITY_COORDS(pedParam0, true)));
...
BOOL func_258(var uParam0) // Position - 0x100CE
{
	...
	iLocal_95 = PED::ADD_SCENARIO_BLOCKING_AREA(uLocal_92 - Vector3(10f, 10f, 10f), uLocal_92 + Vector3(10f, 10f, 10f), false, true, true, true);
	bLocal_97 = true;
