...
void func_6(int iParam0) // Position - 0x25E
{
	...
	player = Global_1890001.f_7[iParam0].f_2;

	if (Global_1890001.f_7[iParam0].f_1 == 1 && plLocal_111 == player)
	{
		func_26(player, Global_1890001.f_7[iParam0].f_6);
		func_13(iParam0);
	}
...
void func_13(int iParam0) // Position - 0x44C
{
	...
	if (iParam0 != -1)
	{
		if (Global_1890001.f_7[iParam0].f_1 == 1)
		{
			if (IS_BIT_SET(Global_1890001.f_7[iParam0].f_5, 0))
			{
				func_25();
			
				if (Global_1890001.f_7[iParam0].f_7 == 0)
				{
					func_25();
				}
				else
			...
			MISC::CLEAR_BIT(&(Global_1894573[PLAYER::PLAYER_ID()].f_10.f_22), Global_1890001.f_7[iParam0].f_2);
			HUD::THEFEED_REMOVE_ITEM(Global_1890001.f_7[iParam0].f_4);
			func_17();
			func_15(0);
		}
		...
		Global_1890001.f_7[9].f_2 = _INVALID_PLAYER_INDEX();
	}
				...
				if (iParam0 == Global_8260[num].f_11)
				{
					if (i == Global_8260[num].f_4)
					{
						if (Global_8822[i] == 0)
						{
							...
							if (Global_2694521)
								if (num == 14)
									func_21(Global_20364, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(i), SYSTEM::TO_FLOAT(Global_8260[num].f_10), SYSTEM::TO_FLOAT(Global_22788), -1f, &Global_8260[num], 0, 0, 0, 0);
					...
					if (i == Global_8260[num].f_4)
					{
						if (Global_8822[i] == 0)
						{
							...
							if (num == 1)
							{
								...
								func_21(Global_20364, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(i), SYSTEM::TO_FLOAT(Global_8260[num].f_10), SYSTEM::TO_FLOAT(Global_22793), -1f, &Global_8260[num], 0, 0, 0, 0);
							}
							else if (num == 7)
							{
								if (Global_78558)
								{
									...
									func_21(Global_20364, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(i), SYSTEM::TO_FLOAT(Global_8260[num].f_10), SYSTEM::TO_FLOAT(value2), -1f, &Global_8260[num], 0, 0, 0, 0);
								}
								else
								{
									switch (Global_20383)
									...
									func_21(Global_20364, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(i), SYSTEM::TO_FLOAT(Global_8260[num].f_10), SYSTEM::TO_FLOAT(value3), -1f, &Global_8260[num], 0, 0, 0, 0);
								}
							}
							else if (num == 14)
							{
							...
							else if (Global_8260[num].f_10 == 57 && num == 23)
							{
								...
								func_21(Global_20364, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(i), SYSTEM::TO_FLOAT(Global_8260[num].f_10), SYSTEM::TO_FLOAT(value6), -1f, &Global_8260[num], 0, 0, 0, 0);
							}
							else
							{
								func_21(Global_20364, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(i), SYSTEM::TO_FLOAT(Global_8260[num].f_10), SYSTEM::TO_FLOAT(0), -1f, &Global_8260[num], 0, 0, 0, 0);
							}
...
{
	if (Global_1894573[PLAYER::PLAYER_ID()].f_10.f_26 == _INVALID_PLAYER_INDEX())
	{
		if (NETWORK::NETWORK_IS_PLAYER_ACTIVE(plParam0))
		{
			Global_1894573[PLAYER::PLAYER_ID()].f_10.f_26 = plParam0;
...
int func_29(int iParam0, int iParam1) // Position - 0xD3E
{
	...
	{
		if (Global_1890001.f_7[i].f_7 == iParam1)
		{
			iParam0 = iParam0 - 1;
...
void func_31() // Position - 0xD8A
{
	...
	player = Global_1890001.f_7[num].f_2;
	...
	if (func_34(&uLocal_113))
	{
		...
		else if (Global_1890001.f_7[num] == 0)
		{
			func_6(num);
		}
		else if (Global_1890001.f_7[num] == 1)
		{
			func_32(num);
		}
		else
...
void func_47() // Position - 0x117B
{
	...
	if (func_34(&uLocal_113))
	{
		...
		switch (Global_1890001.f_7[num].f_1)
		{
			case 0:
				return;
	...
	if (func_38(&uLocal_113))
	{
		...
		switch (Global_1890001.f_7[num2].f_1)
		{
			case 0:
				return;
...
void func_49() // Position - 0x12A4
{
	...
	flag = false;
	num2 = func_29(iLocal_110, 0);
	plLocal_111 = Global_1890001.f_7[num2].f_2;
	player = Global_1890001.f_7[num2].f_2;
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(Global_20364, "SET_DATA_SLOT");
	...
	if (Global_1890001.f_7[num2] == 0)
	{
		if (Global_262145.f_15419)
		{
			...
			for (i = 0; i < 3; i = i + 1)
			{
				if (num3 < 3)
				{
					if (Global_1894573[player].f_10.f_11[i] != _INVALID_PLAYER_INDEX())
					{
						if (_NETWORK_IS_PLAYER_VALID(Global_1894573[player].f_10.f_11[i], false, true))
						{
							unk16[num3] = Global_1894573[player].f_10.f_11[i];
							num3 = num3 + 1;
						}
					}
				}
		...
		{
			if (Global_1890001.f_88[num2].f_1)
				if (Global_1890001.f_88[num2].f_2)
			...
			else if (Global_1890001.f_88[num2].f_2)
			...
			HUD::ADD_TEXT_COMPONENT_INTEGER(Global_1890001.f_88[num2]);
			HUD::ADD_TEXT_COMPONENT_INTEGER(func_74(player));
			HUD::ADD_TEXT_COMPONENT_INTEGER(Global_1890001.f_88[num2].f_3);
			HUD::ADD_TEXT_COMPONENT_INTEGER(Global_1890001.f_88[num2].f_4);
			GRAPHICS::END_TEXT_COMMAND_SCALEFORM_STRING();
		}
	}
	else if (Global_1890001.f_7[num2] == 1)
	{
		...
		HUD::SET_COLOUR_OF_NEXT_TEXT_COMPONENT(func_76(Global_1890001.f_7[num2].f_2));
		HUD::ADD_TEXT_COMPONENT_SUBSTRING_PLAYER_NAME(func_61(Global_1890001.f_7[num2].f_2));
		GRAPHICS::END_TEXT_COMMAND_SCALEFORM_STRING();
	}

	if (flag)
	{
		num = func_55(Global_1890001.f_7[num2].f_2);
...
void func_54(int iParam0, char* sParam1, char* sParam2, const char* sParam3, const char* sParam4, const char* sParam5, const char* sParam6) // Position - 0x170C
{
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iParam0, sParam1);
	func_22(sParam2);
...
const char* func_61(Player plParam0) // Position - 0x199D
{
	...
	{
		str = func_73(&(Global_1894573[plParam0].f_10.f_105));
		return str;
	}
	...
	if (player != _INVALID_PLAYER_INDEX())
	{
		str = func_73(&(Global_1894573[player].f_10.f_105));
...
BOOL IS_XBOX_PLATFORM() // Position - 0x1AA4
{
...
void func_86() // Position - 0x1FD8
{
	...
	for (i = 0; i < func_30(); i = i + 1)
	{
		if (Global_1890001.f_7[i].f_1 == 1 && Global_1890001.f_7[i].f_7 == 0)
		{
			switch (Global_1890001.f_7[i])
			{
				case 0:
					if (func_90(i, num))
						num = num + 1;
...
BOOL func_88(int iParam0, int iParam1) // Position - 0x20EB
{
	...
	if (Global_1890001.f_7[iParam0].f_2 == _INVALID_PLAYER_INDEX() || !_NETWORK_IS_PLAYER_VALID(Global_1890001.f_7[iParam0].f_2, false, true))
		return false;
	...
	num = func_79(Global_1890001.f_7[iParam0].f_2);
...
void func_95(int iParam0, char* sParam1, float fParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x248E
{
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iParam0, sParam1);
	GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(SYSTEM::ROUND(fParam2));
