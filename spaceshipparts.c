...
void func_5() // Position - 0x451
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (_GET_CHARACTER_MODEL(G_MissionStats.f_2366.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_7(character) && !func_6(14) || Global_112760)
			{
				if (G_MissionStats.f_2366.f_539.f_4321 != character && func_7(G_MissionStats.f_2366.f_539.f_4321))
		...
		for (i = 0; i < 1; i = i + 1)
		{
			...
			if (!uParam1->[uParam0->f_10].f_10)
			{
				if (!flag)
				{
					...
					{
						func_43(&uParam1->[uParam0->f_10], uParam0->f_7, joaat("PICKUP_CUSTOM_SCRIPT"), true, false, 2);
					
						if (OBJECT::DOES_PICKUP_EXIST(uParam1->[uParam0->f_10].f_1))
							INTERIOR::ADD_PICKUP_TO_INTERIOR_ROOM_BY_NAME(uParam1->[uParam0->f_10].f_1, "GtaMloRoomTun5");
					}
					else if (uParam0->f_10 == 6 || uParam0->f_10 == 14 || uParam0->f_10 == 21 || uParam0->f_10 == 34 || uParam0->f_10 == 39)
					{
						func_43(&uParam1->[uParam0->f_10], uParam0->f_7, joaat("PICKUP_CUSTOM_SCRIPT"), false, true, 2);
					}
					else
					{
						func_43(&uParam1->[uParam0->f_10], uParam0->f_7, joaat("PICKUP_CUSTOM_SCRIPT"), false, false, 2);
					}
				}
			}
			else if (!flag)
...
int func_19(int iParam0) // Position - 0xBE4
{
	...
	if (iParam0 == 2)
	{
		...
		{
			if (IS_BIT_SET(G_MissionStats.f_10052.f_108, func_23(func_24(iParam0), i)))
				outValue = outValue + 1;
		}
	}
	else if (iParam0 == 6)
...
int func_26(var uParam0, var uParam1, Vector3 vParam2, var uParam3, var uParam4) // Position - 0xD9D
{
	...
	if (uParam1->[num].f_10)
	{
		...
		{
			if (OBJECT::HAS_PICKUP_BEEN_COLLECTED(uParam1->[num].f_1) || func_41(uParam1->[num].f_1))
			{
	...
	{
		if (SYSTEM::VDIST2(vParam2, OBJECT::GET_PICKUP_COORDS(uParam1->[num].f_1)) > 60f * 60f || func_6(13) || func_6(14))
		{
			func_27(&(uParam1->[num].f_1));
			uParam1->[num].f_1 = 0;
			uParam1->[num].f_10 = 0;
		}
	}
...
void func_28(var uParam0, var uParam1, int iParam2) // Position - 0xE73
{
	...
	func_27(&(uParam1->[iParam2].f_1));
	func_40(&(uParam1->[iParam2].f_2));
...
void func_50() // Position - 0x167B
{
	...
	iLocal_605 = 0;
	G_MissionStats.f_10052.f_125.f_2 = 1;

	for (i = 0; i < 50; i = i + 1)
	{
		iLocal_53[i].f_3 = { func_51(i, 0) };
		iLocal_53[i].f_10 = 0;
	}

	iLocal_53[0].f_9 = 179.4746f;
	iLocal_53[1].f_9 = 198f;
	iLocal_53[2].f_9 = 104f;
	iLocal_53[3].f_9 = 321.5f;
	iLocal_53[4].f_9 = 256.25f;
	iLocal_53[5].f_9 = 286.5f;
	iLocal_53[6].f_9 = 0f;
	iLocal_53[6].f_6 = { 0f, 0f, 1f };
	iLocal_53[7].f_9 = -165.6051f;
	iLocal_53[8].f_9 = 91.5f;
	iLocal_53[9].f_9 = 116f;
	iLocal_53[10].f_9 = 15f;
	iLocal_53[11].f_9 = 305.5f;
	iLocal_53[12].f_9 = 0f;
	iLocal_53[13].f_9 = 95f;
	iLocal_53[14].f_9 = 40f;
	iLocal_53[15].f_9 = 40f;
	iLocal_53[16].f_9 = 40f;
	iLocal_53[17].f_9 = 40f;
	iLocal_53[18].f_9 = 40f;
	iLocal_53[19].f_9 = 40f;
	iLocal_53[20].f_9 = 40f;
	iLocal_53[21].f_6 = { 90f, 0f, 57f };
	iLocal_53[22].f_9 = 40f;
	iLocal_53[23].f_9 = 40f;
	iLocal_53[24].f_9 = 40f;
	iLocal_53[25].f_9 = 40f;
	iLocal_53[26].f_9 = 40f;
	iLocal_53[27].f_9 = 40f;
	iLocal_53[28].f_9 = 40f;
	iLocal_53[29].f_9 = 40f;
	iLocal_53[29].f_6 = { -24.35f, 15.74f, 14.31f };
	iLocal_53[30].f_9 = 40f;
	iLocal_53[31].f_9 = 40f;
	iLocal_53[32].f_9 = 40f;
	iLocal_53[33].f_9 = 40f;
	iLocal_53[34].f_6 = { 0f, 0f, -15f };
	iLocal_53[35].f_9 = 40f;
	iLocal_53[36].f_9 = 40f;
	iLocal_53[37].f_9 = 40f;
	iLocal_53[38].f_9 = 40f;
	iLocal_53[38].f_6 = { 20.18f, -0.87f, 20.46f };
	iLocal_53[39].f_6 = { 0f, 0f, -4.39f };
	iLocal_53[40].f_9 = 40f;
	iLocal_53[41].f_9 = 80f;
	iLocal_53[42].f_9 = 198f;
	iLocal_53[43].f_9 = 198f;
	iLocal_53[44].f_9 = 198f;
	iLocal_53[45].f_9 = 198f;
	iLocal_53[46].f_9 = 198f;
	iLocal_53[47].f_9 = 198f;
	iLocal_53[48].f_9 = 198f;
	iLocal_53[49].f_9 = 198f;
	return;
}
...
void func_53() // Position - 0x222B
{
	...
	G_MissionStats.f_10052.f_125.f_2 = 0;

	for (i = 0; i < iLocal_53; i = i + 1)
	{
		func_40(&(iLocal_53[i].f_2));
		func_27(&(iLocal_53[i].f_1));
	}
