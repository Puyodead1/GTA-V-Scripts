	...
	if (ENTITY::DOES_ENTITY_EXIST(pedParam0))
	{
		switch (iLocal_82[iParam1])
		{
			...
			case 1:
				...
				if (!MISC::IS_STRING_NULL_OR_EMPTY(&uLocal_87[iParam1]))
				{
					SYSTEM::START_NEW_SCRIPT_WITH_ARGS(&uLocal_87[iParam1], &iLocal_72[iParam1], 1, DEFAULT);
					iLocal_82[iParam1] = 4;
					return 0;
				}
...
void func_21() // Position - 0x769
{
	...
	while (!flag && num < 400)
	{
		...
		for (i = 0; i < iLocal_77; i = i + 1)
		{
			...
			if (!MISC::IS_STRING_NULL_OR_EMPTY(&uLocal_87[i]))
			{
				SCRIPT::REQUEST_SCRIPT(&uLocal_87[i]);
			
				if (!SCRIPT::HAS_SCRIPT_LOADED(&uLocal_87[i]))
					flag = false;
			}
		}
	...
	for (i = 0; i < iLocal_72; i = i + 1)
	{
		if (iLocal_77[i] != 0)
		{
			iLocal_72[i] = PED::CREATE_PED(PED_TYPE_CIVMALE, iLocal_77[i], uLocal_104 + uLocal_108[i], 0, true, true);
...
void func_22() // Position - 0x896
{
	...
	{
		case 97:
			uLocal_108[0] = Vector3(Vector3(45.5004f, -205.8167f, -1416.5402f) - uLocal_104);
			uLocal_108[1] = Vector3(Vector3(45.5004f, -207.5375f, -1423.8984f) - uLocal_104);
			uLocal_108[2] = Vector3(Vector3(45.5004f, -210.4254f, -1428.5013f) - uLocal_104);
			uLocal_108[3] = Vector3(Vector3(45.5004f, MISC::GET_RANDOM_FLOAT_IN_RANGE(-205.8167f, -210.4254f), MISC::GET_RANDOM_FLOAT_IN_RANGE(-1416.5402f, -1428.5013f)) - uLocal_104);
			...
			TEXT_LABEL_ASSIGN_STRING(&uLocal_87[0], "", 16);
			iLocal_77[1] = joaat("A_M_Y_Hipster_01");
			TEXT_LABEL_ASSIGN_STRING(&uLocal_87[1], "", 16);
			iLocal_77[2] = joaat("A_M_M_BevHills_01");
			TEXT_LABEL_ASSIGN_STRING(&uLocal_87[2], "", 16);
			iLocal_77[3] = joaat("A_M_M_GenFat_01");
			TEXT_LABEL_ASSIGN_STRING(&uLocal_87[3], "", 16);
			iLocal_82[0] = 0;
			iLocal_82[1] = 0;
			iLocal_82[2] = 0;
			iLocal_82[3] = 0;
		...
		case 158:
			uLocal_108[0] = Vector3(1.2712f, 6.071f, -0.75f);
			uLocal_108[1] = Vector3(3.8061f, 5.7599f, -0.5f);
			uLocal_108[2] = Vector3(4.541f, 7.8487f, -0.4f);
			uLocal_108[3] = Vector3(3.1051f, 13.7474f, -0.3463f);
			uLocal_121[0] = 123.059f;
			uLocal_121[1] = 134.0498f;
			uLocal_121[2] = 58.663f;
			uLocal_121[3] = 89.5592f;
			iLocal_77[0] = joaat("S_F_Y_Hooker_01");
			TEXT_LABEL_ASSIGN_STRING(&uLocal_87[0], "pb_prostitute", 16);
			iLocal_77[1] = joaat("S_F_Y_Hooker_01");
			TEXT_LABEL_ASSIGN_STRING(&uLocal_87[1], "pb_prostitute", 16);
			iLocal_77[2] = joaat("S_F_Y_Hooker_01");
			TEXT_LABEL_ASSIGN_STRING(&uLocal_87[2], "pb_prostitute", 16);
			iLocal_77[3] = joaat("S_F_Y_Hooker_01");
			TEXT_LABEL_ASSIGN_STRING(&uLocal_87[3], "pb_prostitute", 16);
			iLocal_82[0] = 1;
			iLocal_82[1] = 1;
			iLocal_82[2] = 1;
			iLocal_82[3] = 1;
		...
		default:
			uLocal_108[0] = Vector3(0f, 0f, 0f);
			uLocal_108[1] = Vector3(0f, 0f, 0f);
			uLocal_108[2] = Vector3(0f, 0f, 0f);
			uLocal_108[3] = Vector3(0f, 0f, 0f);
			uLocal_121[0] = 0f;
			uLocal_121[1] = 0f;
			uLocal_121[2] = 0f;
			uLocal_121[3] = 0f;
