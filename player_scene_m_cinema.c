...
void func_22() // Position - 0x896
{
	...
	{
		case 97:
			uLocal_108[0] = { Vector3(45.5004f, -205.8167f, -1416.5402f) - uLocal_104 };
			uLocal_108[1] = { Vector3(45.5004f, -207.5375f, -1423.8984f) - uLocal_104 };
			uLocal_108[2] = { Vector3(45.5004f, -210.4254f, -1428.5013f) - uLocal_104 };
			uLocal_108[3] = { Vector3(45.5004f, MISC::GET_RANDOM_FLOAT_IN_RANGE(-205.8167f, -210.4254f), MISC::GET_RANDOM_FLOAT_IN_RANGE(-1416.5402f, -1428.5013f)) - uLocal_104 };
