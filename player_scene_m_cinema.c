	...
	if (ENTITY::DOES_ENTITY_EXIST(pedParam0))
	{
		switch (iLocal_81[iParam1])
		{
			...
			case 1:
				...
				if (!MISC::IS_STRING_NULL_OR_EMPTY(&uLocal_86[iParam1]))
				{
					SYSTEM::START_NEW_SCRIPT_WITH_ARGS(&uLocal_86[iParam1], &iLocal_71[iParam1], 1, DEFAULT);
					iLocal_81[iParam1] = 4;
					return 0;
				}
...
int func_7(int iParam0, Entity eParam1) // Position - 0x431
{
	...
	if (!STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS())
	{
		...
		else if (eParam1 == func_8(Global_100554) && eParam1 != 0)
		{
			Global_100554 = 0;
		}
	}
...
void func_11() // Position - 0x574
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (_GET_CHARACTER_MODEL(G_MissionStats.f_2366.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_12(character) && !func_16(14) || Global_112760)
			{
...
void func_21() // Position - 0x769
{
	...
	while (!flag && num < 400)
	{
		...
		for (i = 0; i < iLocal_76; i = i + 1)
		{
			...
			if (!MISC::IS_STRING_NULL_OR_EMPTY(&uLocal_86[i]))
			{
				SCRIPT::REQUEST_SCRIPT(&uLocal_86[i]);
			
				if (!SCRIPT::HAS_SCRIPT_LOADED(&uLocal_86[i]))
					flag = false;
			}
		}
	...
	for (i = 0; i < iLocal_71; i = i + 1)
	{
		if (iLocal_76[i] != 0)
		{
			iLocal_71[i] = PED::CREATE_PED(PED_TYPE_CIVMALE, iLocal_76[i], uLocal_103 + uLocal_107[i], 0, true, true);
...
void func_22() // Position - 0x896
{
	...
	{
		case 97:
			uLocal_107[0] = { { 45.5004f, -205.8167f, -1416.5402f } - uLocal_103 };
			uLocal_107[1] = { { 45.5004f, -207.5375f, -1423.8984f } - uLocal_103 };
			uLocal_107[2] = { { 45.5004f, -210.4254f, -1428.5013f } - uLocal_103 };
			uLocal_107[3] = { { 45.5004f, MISC::GET_RANDOM_FLOAT_IN_RANGE(-205.8167f, -210.4254f), MISC::GET_RANDOM_FLOAT_IN_RANGE(-1416.5402f, -1428.5013f) } - uLocal_103 };
			...
			TEXT_LABEL_ASSIGN_STRING(&uLocal_86[0], "", 16);
			iLocal_76[1] = joaat("A_M_Y_Hipster_01");
			TEXT_LABEL_ASSIGN_STRING(&uLocal_86[1], "", 16);
			iLocal_76[2] = joaat("A_M_M_BevHills_01");
			TEXT_LABEL_ASSIGN_STRING(&uLocal_86[2], "", 16);
			iLocal_76[3] = joaat("A_M_M_GenFat_01");
			TEXT_LABEL_ASSIGN_STRING(&uLocal_86[3], "", 16);
			iLocal_81[0] = 0;
			iLocal_81[1] = 0;
			iLocal_81[2] = 0;
			iLocal_81[3] = 0;
		...
		case 158:
			uLocal_107[0] = { 1.2712f, 6.071f, -0.75f };
			uLocal_107[1] = { 3.8061f, 5.7599f, -0.5f };
			uLocal_107[2] = { 4.541f, 7.8487f, -0.4f };
			uLocal_107[3] = { 3.1051f, 13.7474f, -0.3463f };
			uLocal_120[0] = 123.059f;
			uLocal_120[1] = 134.0498f;
			uLocal_120[2] = 58.663f;
			uLocal_120[3] = 89.5592f;
			iLocal_76[0] = joaat("S_F_Y_Hooker_01");
			TEXT_LABEL_ASSIGN_STRING(&uLocal_86[0], "pb_prostitute", 16);
			iLocal_76[1] = joaat("S_F_Y_Hooker_01");
			TEXT_LABEL_ASSIGN_STRING(&uLocal_86[1], "pb_prostitute", 16);
			iLocal_76[2] = joaat("S_F_Y_Hooker_01");
			TEXT_LABEL_ASSIGN_STRING(&uLocal_86[2], "pb_prostitute", 16);
			iLocal_76[3] = joaat("S_F_Y_Hooker_01");
			TEXT_LABEL_ASSIGN_STRING(&uLocal_86[3], "pb_prostitute", 16);
			iLocal_81[0] = 1;
			iLocal_81[1] = 1;
			iLocal_81[2] = 1;
			iLocal_81[3] = 1;
		...
		default:
			uLocal_107[0] = { 0f, 0f, 0f };
			uLocal_107[1] = { 0f, 0f, 0f };
			uLocal_107[2] = { 0f, 0f, 0f };
			uLocal_107[3] = { 0f, 0f, 0f };
			uLocal_120[0] = 0f;
			uLocal_120[1] = 0f;
			uLocal_120[2] = 0f;
			uLocal_120[3] = 0f;
