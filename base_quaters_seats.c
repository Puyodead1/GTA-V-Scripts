...
void func_7(var uParam0, int iParam1, char* sParam2) // Position - 0x14A
{
	if (func_8(&(uParam0->f_29), 7))
		uParam0->f_29.f_14(&uParam0->[iParam1], iParam1, sParam2);
	else
...
void func_11(var uParam0) // Position - 0x219
{
	...
	switch (uParam0->f_29.f_4)
	{
		...
		case 2:
			if (func_50(PLAYER::PLAYER_PED_ID(), &uParam0->[uParam0->f_29.f_2]))
			{
...
Vector3 func_38(var uParam0) // Position - 0xEEA
{
	...
	unk = { uParam0->[uParam0->f_29.f_2].f_8.f_3 };
...
{
	uParam0->f_29.f_13(!func_8(&(uParam0->f_29), 5), &uParam0->[uParam0->f_29.f_2], uParam0->f_29.f_2);
...
BOOL func_47(var uParam0) // Position - 0x139C
{
	...
	for (i = 0; i < NETWORK::NETWORK_GET_MAX_NUM_PARTICIPANTS(); i = i + 1)
	{
		if (NETWORK::NETWORK_IS_PARTICIPANT_ACTIVE(PLAYER::INT_TO_PARTICIPANTINDEX(i)))
		{
			...
			if (playerIndex != PLAYER::PLAYER_ID() && _NETWORK_IS_PLAYER_VALID(playerIndex, true, true) && func_50(PLAYER::GET_PLAYER_PED(playerIndex), &uParam0->[uParam0->f_29.f_2]))
				return 1;
		}
	}
...
void func_74(int iParam0, var uParam1, int iParam2) // Position - 0x18A2
{
	...
	uParam1->[iParam2] = 8;
	uParam1->[iParam2].f_8 = { func_77(func_78(), num) + unk };
	uParam1->[iParam2].f_8.f_3 = { 0f, 0f, num + 0f };
	uParam1->[iParam2].f_1 = { func_77(func_76(), num) + unk };
	uParam1->[iParam2].f_1.f_3 = { func_77(func_75(), num) + unk };
...
void func_82(int iParam0, var uParam1, int iParam2) // Position - 0x1AA9
{
	...
	uParam1->[iParam2] = 5;
	uParam1->[iParam2].f_8 = { func_77(func_85(), num) + unk };
	uParam1->[iParam2].f_8.f_3 = { 0f, 0f, num + 3f };
	uParam1->[iParam2].f_1 = { func_77(func_84(), num) + unk };
	uParam1->[iParam2].f_1.f_3 = { func_77(func_83(), num) + unk };
	uParam1->[iParam2].f_1.f_6 = 0.73f;
	return;
}
...
{
	return IS_BIT_SET(Global_1853988[plParam0].f_267.f_300.f_1, 0);
}
