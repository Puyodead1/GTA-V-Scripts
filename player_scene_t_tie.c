...
int func_6(int iParam0, Entity eParam1) // Position - 0x217
{
	...
	if (!STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS())
	{
		...
		else if (eParam1 == func_7(Global_100554) && eParam1 != 0)
		{
			Global_100554 = 0;
		}
	}
...
void func_10() // Position - 0x35A
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (_GET_CHARACTER_MODEL(G_MissionStats.f_2366.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_11(character) && !func_15(14) || Global_112760)
			{
...
void func_20() // Position - 0x54F
{
	...
	for (i = 0; i < iLocal_71; i = i + 1)
	{
		if (iLocal_76[i] != 0)
		{
			iLocal_71[i] = PED::CREATE_PED(PED_TYPE_MISSION, iLocal_76[i], uLocal_81 + uLocal_85[i], 0, true, true);
			ENTITY::SET_ENTITY_ROTATION(iLocal_71[i], { fLocal_84, 0f, 0f } + uLocal_98[i], 2, true);
			...
			TASK::TASK_PLAY_ANIM_ADVANCED(iLocal_71[i], &uLocal_116, &uLocal_124[i], uLocal_81 + uLocal_85[i], { fLocal_84, 0f, 0f } + uLocal_98[i], 1000f, -8f, -1, iLocal_157, 0, 2, 0);
	...
	for (i = 0; i < iLocal_158; i = i + 1)
	{
		if (uLocal_165[i] > 0)
		{
			...
			opacity = 1f;
			timeout = -1f;
			iLocal_158[i] = GRAPHICS::ADD_DECAL(uLocal_165[i], uLocal_81 + uLocal_172[i], unk, unk4, width, height, rCoef, gCoef, bCoef, opacity, timeout, false, false, false);
			SYSTEM::WAIT(0);
		}
	}
...
void func_22() // Position - 0x916
{
	...
	switch (iLocal_69)
	{
		case 280:
			...
			TEXT_LABEL_ASSIGN_STRING(&uLocal_124[0], "Dead_A", 32);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_124[1], "Dead_D", 32);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_124[2], "Dead_E", 32);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_124[3], "Dead_G", 32);
			uLocal_85[0] = { 14.613f, 8.4563f, 0.9751f };
			uLocal_85[1] = { 10.6489f, 8.6708f, 0.7701f };
			uLocal_85[2] = { 6.3982f, 1.4604f, 1.1f };
			uLocal_85[3] = { 4.2327f, 5.864f, 0.9f - 0.15f };
			uLocal_98[0] = { 0f, 0f, 23.047f };
			uLocal_98[1] = { 0f, 0f, 97.2582f };
			uLocal_98[2] = { 0f, 0f, 34.2158f };
			uLocal_98[3] = { 0f, 0f, 61.2158f };
			...
			uLocal_165[2] = 1110;
			uLocal_165[3] = 1110;
			uLocal_172[0] = { ({ 0.37364f, -1445.5344f, 2803.7603f } - uLocal_81) + { 0.1f, 0f, 0f } };
			uLocal_172[1] = { ({ 0.28778f, -1444.8633f, 2800.022f } - uLocal_81) + { 0.1f, 0f, 0f } };
			uLocal_172[2] = { ({ 0.6045f, -1452.4043f, 2795.9336f } - uLocal_81) + { 0.1f, 0f, 0f } };
			uLocal_172[3] = { ({ 0.28483f, -1448.0331f, 2794.3005f } - uLocal_81) + { 0.1f, 0f, 0f } };
			uLocal_165[4] = joaat("XMAS_LIVERY_8");
			uLocal_165[5] = joaat("XMAS_LIVERY_8");
			uLocal_172[4] = { ((uLocal_172[0] + uLocal_172[2]) / { 2f, 2f, 2f }) + { 0f, MISC::GET_RANDOM_FLOAT_IN_RANGE(0.5f, 0.5f), MISC::GET_RANDOM_FLOAT_IN_RANGE(0.5f, 0.5f) } };
			uLocal_172[5] = { ((uLocal_172[1] + uLocal_172[2]) / { 2f, 2f, 2f }) + { 0f, MISC::GET_RANDOM_FLOAT_IN_RANGE(0.5f, 0.5f), MISC::GET_RANDOM_FLOAT_IN_RANGE(0.5f, 0.5f) } };
			break;
	
		default:
			TEXT_LABEL_ASSIGN_STRING(&uLocal_116, "", 32);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_124[0], "", 32);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_124[1], "", 32);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_124[2], "", 32);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_124[3], "", 32);
			iLocal_76[0] = 0;
			uLocal_85[0] = { 0f, 0f, 0f };
			uLocal_98[0] = { 0f, 0f, 0f };
			iLocal_76[1] = 0;
			uLocal_85[1] = { 0f, 0f, 0f };
			uLocal_98[1] = { 0f, 0f, 0f };
			iLocal_76[2] = 0;
			uLocal_85[2] = { 0f, 0f, 0f };
			uLocal_98[2] = { 0f, 0f, 0f };
			iLocal_76[3] = 0;
			uLocal_85[3] = { 0f, 0f, 0f };
			uLocal_98[3] = { 0f, 0f, 0f };
			iLocal_157 = 0;
			uLocal_111[0] = -1;
			uLocal_111[1] = -1;
			uLocal_111[2] = -1;
	...
	switch (iParam0)
	{
		...
		case 5:
			*uParam1 = G_MissionStats.f_2366.f_539.f_2310[0];
			TEXT_LABEL_ASSIGN_STRING(sParam2, func_33(G_MissionStats.f_2366.f_539.f_2314[0]), 32);
			return true;
	
		case 6:
			*uParam1 = G_MissionStats.f_2366.f_539.f_2310[1];
			TEXT_LABEL_ASSIGN_STRING(sParam2, func_33(G_MissionStats.f_2366.f_539.f_2314[1]), 32);
			return true;
	
		case 7:
			*uParam1 = G_MissionStats.f_2366.f_539.f_2310[2];
			TEXT_LABEL_ASSIGN_STRING(sParam2, func_33(G_MissionStats.f_2366.f_539.f_2314[2]), 32);
			return true;
