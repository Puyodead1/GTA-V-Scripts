...
void func_22() // Position - 0x916
{
	...
	switch (iLocal_70)
	{
		case 280:
			...
			uLocal_166[2] = 1110;
			uLocal_166[3] = 1110;
			uLocal_173[0] = { (Vector3(0.37364f, -1445.5344f, 2803.7603f) - uLocal_82) + Vector3(0.1f, 0f, 0f) };
			uLocal_173[1] = { (Vector3(0.28778f, -1444.8633f, 2800.022f) - uLocal_82) + Vector3(0.1f, 0f, 0f) };
			uLocal_173[2] = { (Vector3(0.6045f, -1452.4043f, 2795.9336f) - uLocal_82) + Vector3(0.1f, 0f, 0f) };
			uLocal_173[3] = { (Vector3(0.28483f, -1448.0331f, 2794.3005f) - uLocal_82) + Vector3(0.1f, 0f, 0f) };
			uLocal_166[4] = joaat("XMAS_LIVERY_8");
			uLocal_166[5] = joaat("XMAS_LIVERY_8");
			uLocal_173[4] = { ((uLocal_173[0] + uLocal_173[2]) / Vector3(2f, 2f, 2f)) + Vector3(0f, MISC::GET_RANDOM_FLOAT_IN_RANGE(0.5f, 0.5f), MISC::GET_RANDOM_FLOAT_IN_RANGE(0.5f, 0.5f)) };
			uLocal_173[5] = { ((uLocal_173[1] + uLocal_173[2]) / Vector3(2f, 2f, 2f)) + Vector3(0f, MISC::GET_RANDOM_FLOAT_IN_RANGE(0.5f, 0.5f), MISC::GET_RANDOM_FLOAT_IN_RANGE(0.5f, 0.5f)) };
			break;
