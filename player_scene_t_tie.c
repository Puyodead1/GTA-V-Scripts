...
void func_20() // Position - 0x54F
{
	...
	for (i = 0; i < iLocal_72; i = i + 1)
	{
		if (iLocal_77[i] != 0)
		{
			iLocal_72[i] = PED::CREATE_PED(PED_TYPE_MISSION, iLocal_77[i], uLocal_82 + uLocal_86[i], 0, true, true);
			ENTITY::SET_ENTITY_ROTATION(iLocal_72[i], Vector3(fLocal_85, 0f, 0f) + uLocal_99[i], 2, true);
			...
			TASK::TASK_PLAY_ANIM_ADVANCED(iLocal_72[i], &uLocal_117, &uLocal_125[i], uLocal_82 + uLocal_86[i], Vector3(fLocal_85, 0f, 0f) + uLocal_99[i], 1000f, -8f, -1, iLocal_158, 0, 2, 0);
	...
	for (i = 0; i < iLocal_159; i = i + 1)
	{
		if (uLocal_166[i] > 0)
		{
			...
			opacity = 1f;
			timeout = -1f;
			iLocal_159[i] = GRAPHICS::ADD_DECAL(uLocal_166[i], uLocal_82 + uLocal_173[i], unk, unk4, width, height, rCoef, gCoef, bCoef, opacity, timeout, false, false, false);
			SYSTEM::WAIT(0);
		}
	}
...
void func_22() // Position - 0x916
{
	...
	switch (iLocal_70)
	{
		case 280:
			...
			TEXT_LABEL_ASSIGN_STRING(&uLocal_125[0], "Dead_A", 32);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_125[1], "Dead_D", 32);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_125[2], "Dead_E", 32);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_125[3], "Dead_G", 32);
			uLocal_86[0] = Vector3(14.613f, 8.4563f, 0.9751f);
			uLocal_86[1] = Vector3(10.6489f, 8.6708f, 0.7701f);
			uLocal_86[2] = Vector3(6.3982f, 1.4604f, 1.1f);
			uLocal_86[3] = Vector3(4.2327f, 5.864f, 0.9f - 0.15f);
			uLocal_99[0] = Vector3(0f, 0f, 23.047f);
			uLocal_99[1] = Vector3(0f, 0f, 97.2582f);
			uLocal_99[2] = Vector3(0f, 0f, 34.2158f);
			uLocal_99[3] = Vector3(0f, 0f, 61.2158f);
			...
			uLocal_166[2] = 1110;
			uLocal_166[3] = 1110;
			uLocal_173[0] = Vector3((Vector3(0.37364f, -1445.5344f, 2803.7603f) - uLocal_82) + Vector3(0.1f, 0f, 0f));
			uLocal_173[1] = Vector3((Vector3(0.28778f, -1444.8633f, 2800.022f) - uLocal_82) + Vector3(0.1f, 0f, 0f));
			uLocal_173[2] = Vector3((Vector3(0.6045f, -1452.4043f, 2795.9336f) - uLocal_82) + Vector3(0.1f, 0f, 0f));
			uLocal_173[3] = Vector3((Vector3(0.28483f, -1448.0331f, 2794.3005f) - uLocal_82) + Vector3(0.1f, 0f, 0f));
			uLocal_166[4] = joaat("XMAS_LIVERY_8");
			uLocal_166[5] = joaat("XMAS_LIVERY_8");
			uLocal_173[4] = Vector3(((uLocal_173[0] + uLocal_173[2]) / Vector3(2f, 2f, 2f)) + Vector3(0f, MISC::GET_RANDOM_FLOAT_IN_RANGE(0.5f, 0.5f), MISC::GET_RANDOM_FLOAT_IN_RANGE(0.5f, 0.5f)));
			uLocal_173[5] = Vector3(((uLocal_173[1] + uLocal_173[2]) / Vector3(2f, 2f, 2f)) + Vector3(0f, MISC::GET_RANDOM_FLOAT_IN_RANGE(0.5f, 0.5f), MISC::GET_RANDOM_FLOAT_IN_RANGE(0.5f, 0.5f)));
			break;
	
		default:
			TEXT_LABEL_ASSIGN_STRING(&uLocal_117, "", 32);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_125[0], "", 32);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_125[1], "", 32);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_125[2], "", 32);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_125[3], "", 32);
			iLocal_77[0] = 0;
			uLocal_86[0] = Vector3(0f, 0f, 0f);
			uLocal_99[0] = Vector3(0f, 0f, 0f);
			iLocal_77[1] = 0;
			uLocal_86[1] = Vector3(0f, 0f, 0f);
			uLocal_99[1] = Vector3(0f, 0f, 0f);
			iLocal_77[2] = 0;
			uLocal_86[2] = Vector3(0f, 0f, 0f);
			uLocal_99[2] = Vector3(0f, 0f, 0f);
			iLocal_77[3] = 0;
			uLocal_86[3] = Vector3(0f, 0f, 0f);
			uLocal_99[3] = Vector3(0f, 0f, 0f);
			iLocal_158 = 0;
			uLocal_112[0] = -1;
			uLocal_112[1] = -1;
			uLocal_112[2] = -1;
	...
	switch (uParam0.f_2)
	{
		...
		case 80:
			*uParam109 = Vector3(uParam0);
			uParam109->f_109 = joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE");
			uParam109->f_110 = joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE");
			func_24(uParam109, 17, joaat("SCRIPT_TASK_PLAY_ANIM"), joaat("SCRIPT_TASK_PLAY_ANIM"), Vector3(2.6407f, 8.164f, -14.1564f) + Vector3(-1f, 0.03f, -2.16f), -66f + -56f);
