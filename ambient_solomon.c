...
void main() // Position - 0x0
{
	...
	while (true)
	{
		...
		uLocal_250 = Vector3(ENTITY::GET_ENTITY_FORWARD_VECTOR(PLAYER::PLAYER_PED_ID()));
...
void func_9(int iParam0) // Position - 0x1463
{
	...
	vector = Vector3(func_30(iParam0));
...
void func_16(int iParam0, var uParam1) // Position - 0x1C5F
{
	...
	switch (iParam0)
	{
		...
		case 71:
		case 72:
			if (!func_17(iParam0) && SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(Global_91469[26].f_6) == 0)
			{
				Global_113648.f_7263[iParam0] = 1;
				OBJECT::DOOR_SYSTEM_SET_DOOR_STATE(uParam1->f_5, Global_113648.f_7263[iParam0], true, true);
			}
...
BOOL func_57(Vehicle veParam0, float fParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6, float fParam7) // Position - 0x5FFF
{
	...
	offsetFromEntityInWorldCoords = Vector3(ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(veParam0, minimum, maximum.f_1, 0f));

	if (OBJECT::IS_POINT_IN_ANGLED_AREA(offsetFromEntityInWorldCoords, fParam1, fParam4, fParam7, false, true))
		return true;

	offsetFromEntityInWorldCoords = Vector3(ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(veParam0, 0f, maximum.f_1, 0f));

	if (OBJECT::IS_POINT_IN_ANGLED_AREA(offsetFromEntityInWorldCoords, fParam1, fParam4, fParam7, false, true))
		return true;

	offsetFromEntityInWorldCoords = Vector3(ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(veParam0, maximum, maximum.f_1, 0f));

	if (OBJECT::IS_POINT_IN_ANGLED_AREA(offsetFromEntityInWorldCoords, fParam1, fParam4, fParam7, false, true))
		return true;

	offsetFromEntityInWorldCoords = Vector3(ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(veParam0, minimum, minimum.f_1, 0f));

	if (OBJECT::IS_POINT_IN_ANGLED_AREA(offsetFromEntityInWorldCoords, fParam1, fParam4, fParam7, false, true))
		return true;

	offsetFromEntityInWorldCoords = Vector3(ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(veParam0, 0f, minimum.f_1, 0f));

	if (OBJECT::IS_POINT_IN_ANGLED_AREA(offsetFromEntityInWorldCoords, fParam1, fParam4, fParam7, false, true))
		return true;

	offsetFromEntityInWorldCoords = Vector3(ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(veParam0, maximum, minimum.f_1, 0f));
