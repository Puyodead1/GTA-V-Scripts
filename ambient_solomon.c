...
void main() // Position - 0x0
{
	...
	if (func_75(PLAYER::PLAYER_PED_ID()))
	{
		while (flag == false)
		{
			flag = MISC::GET_MISSION_FLAG() == false && _GET_CURRENT_PLAYER_CHARACTER() == CHAR_MICHAEL && func_69(PLAYER::PLAYER_PED_ID(), uLocal_63, fLocal_66, true);
			func_67();
		}
	}
	...
	switch (*uParam0)
	{
		...
		case 1:
			...
			if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
			{
				...
				value = MISC::ACOS(func_56(uLocal_249, 0.73f, 0.683f, -0.013f));
...
void func_16(int iParam0, var uParam1) // Position - 0x1C5F
{
	...
	switch (iParam0)
	{
		...
		case 71:
		case 72:
			if (!func_17(iParam0) && SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(Global_91601[26].f_6) == 0)
			{
				G_MissionStats.f_7264[iParam0] = 1;
				OBJECT::DOOR_SYSTEM_SET_DOOR_STATE(uParam1->f_5, G_MissionStats.f_7264[iParam0], true, true);
			}
...
void func_63(var uParam0) // Position - 0x6281
{
	...
	switch (*uParam0)
	{
		...
		case 1:
			...
			{
				vehiclePedIsIn = PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false);
				value = MISC::ACOS(func_56(uLocal_249, -0.37f, -0.927f, -0.053f));
...
void func_67() // Position - 0x6662
{
	...
	if (!func_69(PLAYER::PLAYER_PED_ID(), uLocal_63, fLocal_66 + 30f, true))
		func_77();
...
void func_71() // Position - 0x6753
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (_GET_CHARACTER_MODEL(G_MissionStats.f_2366.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_13(character) && !func_11(14) || Global_112760)
			{
