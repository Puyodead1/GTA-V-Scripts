...
BOOL func_35(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9) // Position - 0x46C5
{
	...
	else
	{
		...
		num2 = 0;
		func_41(&num2);
		num3 = func_40(unk10, Global_113648.f_7690.f_765[num2]);
	
		if (num3 == 2)
		{
			func_38(Global_113648.f_7690.f_765[num2]);
		...
		else if (num3 == 1)
		{
			...
			{
				if (!func_36(Global_113648.f_7690.f_765[num2]))
				{
					Global_113648.f_7690.f_765[num2] = { unk10 };
					func_37(&unk10);
					return true;
...
void func_41(var uParam0) // Position - 0x4999
{
	...
	*uParam0 = 0;
	...
	{
		if (func_40(Global_113648.f_7690.f_765[i], Global_113648.f_7690.f_765[*uParam0]) == 0)
			*uParam0 = i;
	}
