	...
	if (ENTITY::DOES_ENTITY_EXIST(*pedParam0))
	{
		...
		switch (uLocal_270[iParam1])
		{
			case 0:
				if (ENTITY::IS_ENTITY_PLAYING_ANIM(*pedParam0, &uLocal_361, &uLocal_442[iParam1], 2))
				{
					...
					if (PED::GET_SYNCHRONIZED_SCENE_PHASE(Global_98011) > num)
					{
						...
						{
							entityCoords = { ENTITY::GET_ENTITY_COORDS(*pedParam0, true) };
							uLocal_291[iParam1] = { (entityCoords - uLocal_277) * { 4f, 4f, 4f } };
						...
						if (PED::IS_PED_INJURED(*pedParam0))
						{
							...
							TASK::TASK_GO_STRAIGHT_TO_COORD(*pedParam0, uLocal_277 + (uLocal_291[iParam1] * { 0.1f, 0.1f, 0.1f }), 1f, -1, 1193033728, 1056964608);
			...
			case 1:
				...
				num4 = SYSTEM::VMAG(uLocal_291[iParam1] * { 0.05f, 0.05f, 0.05f });
			...
			case 4:
				...
				else
				{
					...
					vector = { func_126(uLocal_277 + uLocal_291[iParam1], func_129(uLocal_308[iParam1] * 0.9f, 10f, 100f), 0f) };
...
void func_147() // Position - 0x5F1F
{
	...
	{
		case 218:
			uLocal_281[0] = { MISC::GET_RANDOM_FLOAT_IN_RANGE(-10f, 10f), MISC::GET_RANDOM_FLOAT_IN_RANGE(-10f, 10f), 0f };
			uLocal_281[1] = { MISC::GET_RANDOM_FLOAT_IN_RANGE(-10f, 10f), MISC::GET_RANDOM_FLOAT_IN_RANGE(-10f, 10f), 0f };
			uLocal_291[0] = { -77.3f, -4.1f, 1f };
			uLocal_291[1] = { uLocal_291[0] };
			uLocal_291[iLocal_262] = { 66.7f, -7.299f, 1f };
		...
		case 219:
			uLocal_281[0] = { -0.2331f, 0.0497f, 0.0041f };
			uLocal_281[1] = { 0.6908f, -0.4534f, 0.0042f };
			uLocal_291[0] = { -0.6f, -144.3f, 0f };
			uLocal_291[1] = { uLocal_291[0] };
			uLocal_291[iLocal_262] = { 112.2308f, 43.129f, 3.188f };
			uLocal_304[0] = 180f;
			uLocal_304[1] = 180f;
			uLocal_308[0] = 40f;
			uLocal_308[1] = uLocal_308[0];
		...
		case 220:
			uLocal_281[0] = { 1.7097f, -1.8585f, -0.052f };
			uLocal_281[1] = { 2.7011f, -1.5f, -0.052f };
			uLocal_291[0] = { { 21.5656f, -1890.5951f, 59.4395f } - uLocal_277 };
			uLocal_291[1] = { uLocal_291[0] };
			uLocal_291[iLocal_262] = { { -4.6336f, -54.7307f, 67.5391f } * { -1f, -1f, -1f } };
		...
		case 225:
			uLocal_281[0] = { 3.8209f, 1.0394f, 0f };
			uLocal_281[1] = { 4.0994f, -0.0922f, 0f };
			uLocal_291[0] = { { 27.9565f, -1650.5173f, 278.2831f } - uLocal_277 };
			uLocal_291[1] = { uLocal_291[0] };
			uLocal_291[iLocal_262] = { -{ 0f, 62.7f, 54.673f } };
		...
		default:
			uLocal_281[0] = { MISC::GET_RANDOM_FLOAT_IN_RANGE(-10f, 10f), MISC::GET_RANDOM_FLOAT_IN_RANGE(-10f, 10f), 0f };
			uLocal_281[1] = { MISC::GET_RANDOM_FLOAT_IN_RANGE(-10f, 10f), MISC::GET_RANDOM_FLOAT_IN_RANGE(-10f, 10f), 0f };
			uLocal_291[0] = { 0f, 0f, 0f };
			uLocal_291[1] = { 0f, 0f, 0f };
			uLocal_291[iLocal_262] = { 0f, 0f, 0f };
			uLocal_304[0] = MISC::GET_RANDOM_FLOAT_IN_RANGE(-180f, 180f);
			uLocal_304[1] = MISC::GET_RANDOM_FLOAT_IN_RANGE(-180f, 180f);
			uLocal_308[0] = 0f;
			uLocal_308[1] = 0f;
