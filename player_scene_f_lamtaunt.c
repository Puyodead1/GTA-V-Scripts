			...
			case 0:
				if (ENTITY::IS_ENTITY_PLAYING_ANIM(*pedParam0, &uLocal_361, &uLocal_442[iParam1], 2))
				{
					...
					if (PED::GET_SYNCHRONIZED_SCENE_PHASE(Global_98011) > num)
					{
						...
						{
							entityCoords = Vector3(ENTITY::GET_ENTITY_COORDS(*pedParam0, true));
							uLocal_291[iParam1] = { (entityCoords - uLocal_277) * Vector3(4f, 4f, 4f) };
...
void func_147() // Position - 0x5F1F
{
	...
	switch (iLocal_71)
	{
		...
		case 220:
			...
			uLocal_291[0] = { Vector3(21.5656f, -1890.5951f, 59.4395f) - uLocal_277 };
			uLocal_291[1] = Vector3(uLocal_291[0]);
			uLocal_291[iLocal_262] = { Vector3(-4.6336f, -54.7307f, 67.5391f) * Vector3(-1f, -1f, -1f) };
		...
		case 225:
			...
			uLocal_291[0] = { Vector3(27.9565f, -1650.5173f, 278.2831f) - uLocal_277 };
			uLocal_291[1] = Vector3(uLocal_291[0]);
			uLocal_291[iLocal_262] = { -Vector3(0f, 62.7f, 54.673f) };
