...
void main() // Position - 0x0
{
	...
	pedLocal_240 = PED::CREATE_PED(PED_TYPE_SPECIAL, hLocal_36, uLocal_242, uScriptParam_508.f_17[0], false, true);
	func_103();
	...
	while (num == 1)
	{
		...
		switch (iLocal_250)
		{
			...
			case 5:
				...
				{
					TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(pedLocal_240, uLocal_242, 1f, -1, 1f, 1024, uScriptParam_508.f_17[0]);
					iLocal_250 = 6;
				}
				break;
