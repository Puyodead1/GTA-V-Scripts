...
BOOL func_49(Ped pedParam0, int iParam1, int iParam2) // Position - 0x1DA9
{
	...
	Global_78341[1] = { func_101(entityModel, iParam1, iParam2, -1) };
	...
	else
	{
		...
		Global_78341[1] = { func_101(entityModel, iParam1, unk28[iParam1], -1) };
...
int func_52(Ped pedParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x202D
{
	...
	if (iParam1 == 12)
	{
		...
		for (i = 0; i <= 14; i = i + 1)
		{
			if (unk[i] != -99)
			{
				Global_78341[1] = { func_101(entityModel, i, unk[i], -1) };
				...
				if (IS_BIT_SET(Global_78341[1].f_6, 0))
				{
					if (i == 13)
					{
						...
						for (j = 0; j <= 8; j = j + 1)
						{
							Global_78341[1] = { func_101(entityModel, 14, unk18[j], -1) };
			...
			{
				Global_78341[1] = { func_101(entityModel, i, func_58(pedParam0, i, PV_COMP_INVALID), -1) };
	...
	else if (iParam1 == 13)
	{
		...
		for (j = 0; j <= 8; j = j + 1)
		{
			Global_78341[1] = { func_101(entityModel, 14, unk59[j], -1) };
			func_68(pedParam0, Global_78341[1].f_12, Global_78341[1].f_3, Global_78341[1].f_4);
			func_84(14);
...
{
	Global_78341[1] = { func_101(hParam0, iParam1, iParam2, -1) };
			...
			if (unk[i] != -99 && i != 12 && i != 14)
			{
				if (!func_166(pedParam0, i, unk[i]))
				{
					if (i == 13)
					{
						...
						for (j = 0; j <= 8; j = j + 1)
						{
							if (!func_166(pedParam0, 14, unk18[j]))
							{
								for (k = 0; k <= 19; k = k + 1)
								{
									Global_78341[2] = { func_101(entityModel, 14, k, -1) };
					...
					else
					{
						...
						Global_78341[2] = { func_101(entityModel, i, num, -1) };
	...
	if (iLocal_772.f_3 == 1)
	{
		...
		if (iLocal_353 == 0)
		{
			...
			if (func_350(uLocal_606[1]))
			{
				...
				entityCoords = { ENTITY::GET_ENTITY_COORDS(uLocal_606[1], true) };
...
void func_397(float fParam0, float fParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6) // Position - 0x30E71
{
	...
	num = iLocal_536 - 1;
	num < 0;
	uLocal_363[num].f_25 = { fParam0 };
	uLocal_363[num].f_25 = { fParam3 };
...
void func_400(float fParam0, float fParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6) // Position - 0x30F02
{
	...
	num = iLocal_536 - 1;
	num < 0;
	uLocal_363[num].f_8 = { fParam0 };
	uLocal_363[num].f_11 = { fParam3 };
...
void func_401(int iParam0, float fParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6) // Position - 0x30F40
{
	...
	uLocal_363[num].f_2 = { fParam1 };
	uLocal_363[num].f_5 = { fParam4 };
