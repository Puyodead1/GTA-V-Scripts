#region Local Var
	...
	var uScriptParam_159 = -1;
	var uScriptParam_160 = 0;
	var uScriptParam_161 = 0;
	var uScriptParam_162 = -1;
...
{
	return IS_BIT_SET(Global_1894573[plParam0].f_10.f_6, iParam1);
}
...
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (func_70(plParam0) && Global_2657589[plParam0].f_321.f_10 == plParam0)
			return true;
	...
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2657589[plParam0].f_321.f_7 != -1)
				return func_71(Global_2657589[plParam0].f_321.f_7) == 22;
...
{
	if (!func_95() && VEHICLE::IS_VEHICLE_MOD_GEN9_EXCLUSIVE(veParam0, iParam1, iParam2))
		return true;
...
{
	return Global_1894573[func_17()].f_10.f_304;
}
...
BOOL func_115(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, Hash hParam6, int iParam7, var uParam8, var uParam9, var uParam10) // Position - 0x9F6F
{
	...
	if (Global_2635559.f_676 == 0)
	{
		...
		if (!uParam10->f_27 || func_238(fParam0, true, 1133903872) && !uParam10->f_28 && !Global_2793046.f_936 && !Global_2793046.f_925 && !Global_2793046.f_933 && !Global_2793046.f_937 && !Global_2793046.f_954 && !Global_2793046.f_966 && !Global_2793046.f_938 && !Global_2793046.f_988)
...
BOOL _ARE_PLAYERS_IN_SAME_ORGANIZATION(Player plParam0, Player plParam1) // Position - 0xB123
{
	Player player;
		...
		if (!(plParam5 == i) || iParam6 == 1)
		{
			...
			if (_NETWORK_IS_PLAYER_VALID(player, false, true) && _NETWORK_IS_PLAYER_VALID(plParam5, false, true))
				if (Global_2648605.f_261[i])
					if (func_118(Global_2648605.f_131[i], uParam0, iParam3, hParam4, 1036831949))
						return true;
...
BOOL func_138(var uParam0, var uParam1, var uParam2, int iParam3, Hash hParam4, BOOL bParam5, int iParam6) // Position - 0xB43E
{
	...
	else
	{
		...
		for (i = 0; i < 3; i = i + 1)
		{
			...
			{
				func_119(uParam0, iParam3, hParam4, &vector, &vector2, &unk5, iParam6);
						...
						if (uParam2->f_13 || flags & 64 == 0 || uParam2->f_33 == 1)
						{
							if (uParam2->f_14 || flags & 16 == 0)
							{
								if (flags & 128 == 0 && flags & 256 == 0 && flags & 512 == 0)
								{
									...
									{
										outPosition = Vector3(func_168(outPosition, &outPosition2, outHeading, uParam2->f_9, *uParam2, flag, uParam2->f_11, uParam2->f_34, &flag2, flag3, true, uParam2->f_51, uParam2->f_60));
...
void func_143(var uParam0, var uParam1, int iParam2, Vector3 vParam3, var uParam4, var uParam5) // Position - 0xC04B
{
	...
	for (i = 0; i < *uParam0; i = i + 1)
	{
		...
		if (num2 < num)
		{
			if (!func_144(uParam0->[i], 5f, PLAYER::PLAYER_ID(), 0, 0))
			{
				num = num2;
				num3 = i;
			}
		...
		if (!(plParam3 == i) || iParam4 == 1)
		{
			...
			for (j = 0; j < 2; j = j + 1)
			{
				if (!(Global_2648605.f_461[i][j].f_4 == 0))
					if (func_118(uParam0, Global_2648605.f_461[i][j], Global_2648605.f_461[i][j].f_3, Global_2648605.f_461[i][j].f_4, 1036831949))
	...
	for (i = 0; i < 30; i = i + 1)
	{
		*uParam4 = MISC::GET_RANDOM_INT_IN_RANGE(1 + iParam0, 40 + iParam0);
		...
		if (PATHFIND::GET_NTH_CLOSEST_VEHICLE_NODE_WITH_HEADING(vParam1, *uParam4, pvParam5, pfParam6, &iParam9, iParam10, fParam11, fParam12))
		{
			...
			{
				*pvParam5 = Vector3(func_168(*pvParam5, pfParam6, iParam9, uParam7->f_9, *uParam7, bParam8, uParam7->f_11, uParam7->f_34, &bParam13, false, false, uParam7->f_51, uParam7->f_60));
...
BOOL func_154(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0xC8F0
{
	...
	for (i = 0; i <= 31; i = i + 1)
	{
		...
		if (!_NETWORK_IS_PLAYER_VALID(player, true, true) || _NETWORK_IS_PLAYER_IN_SCTV(player, 0) || IS_BIT_SET(Global_2657589[player].f_199, 2) || func_155(player))
		{
		}
		...
		if (*Global_4980736.missionPropCount > 0)
		{
			for (i = 0; i < *Global_4980736.missionPropCount; i = i + 1)
			{
				if (Global_4980736.f_39173[i].f_7 != 0)
					if (func_118(uParam0, Global_4980736.f_39173[i], Global_4980736.f_39173[i].f_6, Global_4980736.f_39173[i].f_7, fParam3))
						return true;
			}
		}
		...
		if (Global_4980736.missionObjectCount > 0)
		{
			for (i = 0; i < Global_4980736.missionObjectCount; i = i + 1)
			{
				if (Global_4980736.f_5994[i].f_15 != 0)
					if (func_118(uParam0, Global_4980736.f_5994[i], Global_4980736.f_5994[i].f_3, Global_4980736.f_5994[i].f_15, 0.5f))
						return true;
			}
		}
		...
		if (*Global_4980736.missionVehicleCount > 0)
		{
			for (i = 0; i < *Global_4980736.missionVehicleCount; i = i + 1)
			{
				if (Global_4980736.f_84919[i].f_12 != 0)
					if (func_118(uParam0, Global_4980736.f_84919[i], Global_4980736.f_84919[i].f_3, Global_4980736.f_84919[i].f_12, 0.5f))
						return true;
			}
		}
...
BOOL func_173(var uParam0, var uParam1, var uParam2) // Position - 0xD61A
{
	...
	{
		if (func_174(uParam0, &Global_2642126[num][i]))
			return true;
	}

	for (i = 0; i < Global_2642829[8]; i = i + 1)
	{
		if (func_174(uParam0, &Global_2642126[8][i]))
			return true;
	}
...
BOOL func_177(var uParam0, var uParam1, var uParam2, var uParam3) // Position - 0xD7E8
{
	...
	for (i = 0; i < num; i = i + 1)
	{
		...
		{
			if (func_178(uParam0, &Global_2635559.f_368[i], 1008981770, false, false))
			{
				*uParam3 = i;
				return true;
			}
...
BOOL func_178(Vector3 vParam0, var uParam1, var uParam2, var uParam3, int iParam4, BOOL bParam5, BOOL bParam6) // Position - 0xD84C
{
	switch (uParam3->f_10)
	{
		...
		case 1:
			return func_164(vParam0, *uParam3 + Vector3(iParam4 * -1f, iParam4 * -1f, iParam4 * -1f), uParam3->f_3 + Vector3(iParam4, iParam4, iParam4), bParam5, bParam6);
...
BOOL func_183(var uParam0, BOOL bParam1) // Position - 0xDAD0
{
	...
	if (Global_2635559.f_26.f_18)
	{
		...
		if (flag)
			if (bParam1)
				*uParam0 = Vector3(func_184(*uParam0, Global_2635559.f_26.f_10, Global_2635559.f_26.f_13, Global_2635559.f_26.f_16, Global_2635559.f_26.f_17, 1036831949, false));
	}
...
void func_185(var uParam0, float fParam1, var uParam2, var uParam3, float fParam4, var uParam5, var uParam6, float fParam7, int iParam8, BOOL bParam9) // Position - 0xDCC5
{
	...
	if (num < fParam7 * 0.5f)
	{
		...
		x22.f_2 = 0f;
		vector = Vector3(func_186(0f, 0f, 1f, x12));
		vector = Vector3(vector / F2V(SYSTEM::VMAG(vector)));
...
BOOL func_188(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, BOOL bParam6, BOOL bParam7) // Position - 0xE0CC
{
	...
	for (i = 0; i < *uParam4; i = i + 1)
	{
		...
		{
			if (bParam6)
				func_181(uParam3, uParam4->[i], uParam5->[i], 1036831949, false, 0);
...
BOOL func_189(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0xE188
{
	...
	if (func_177(*uParam0, &num))
	{
		...
		{
			unk2 = Vector3(*uParam0);
			func_190(&unk2, &Global_2635559.f_368[num], 1036831949, false, bParam2);
		
			if (func_177(unk2, &unk) || func_182(unk2))
			{
				unk2 = Vector3(*uParam0);
				func_190(&unk2, &Global_2635559.f_368[num], 1036831949, true, bParam2);
			}
...
void func_190(var uParam0, var uParam1, int iParam2, BOOL bParam3, BOOL bParam4) // Position - 0xE20C
{
	if (bParam4)
	{
		...
		{
			case 0:
				*uParam0 = Vector3(func_184(*uParam0, *uParam1, 0f, 0f, 0f, uParam1->f_6 + ((float)Global_2635559.f_2735 * uParam1->f_8), 0, iParam2, bParam3));
				break;
		
			case 1:
				*uParam0 = Vector3(func_184(*uParam0, *uParam1, uParam1->f_3, 0f, 1, iParam2, bParam3));
				break;
		
			case 2:
				*uParam0 = Vector3(func_184(*uParam0, *uParam1, uParam1->f_3, uParam1->f_6, 2, iParam2, bParam3));
				break;
		}
	}
	else
...
BOOL func_191(var uParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xE316
{
	...
	for (i = 0; i < 12; i = i + 1)
	{
		if (Global_2640505[i].f_9 == 1)
		{
			...
			{
				if (func_178(*uParam0, &Global_2640505[i], 1008981770, bParam4, false))
				{
					if (bParam1)
					{
						...
						{
							unk = Vector3(*uParam0);
							func_190(&unk, &Global_2640505[i], 1036831949, false, bParam3);
						
							if (func_191(&unk, false, false, false, true))
							{
								unk = Vector3(*uParam0);
								func_190(&unk, &Global_2640505[i], 1036831949, true, false);
							}
...
BOOL func_197(var uParam0, var uParam1, var uParam2, int iParam3, Hash hParam4, Player plParam5, int iParam6) // Position - 0xEBEB
{
	...
	for (i = 0; i < 32; i = i + 1)
	{
		if (!(plParam5 == i) || iParam6 == 1)
		{
			...
			for (j = 0; j < 2; j = j + 1)
			{
				if (func_198(uParam0, hParam4, Global_2648605.f_461[i][j], Global_2648605.f_461[i][j].f_4))
					if (func_127(uParam0, iParam3, hParam4, Global_2648605.f_461[i][j], Global_2648605.f_461[i][j].f_3, Global_2648605.f_461[i][j].f_4, 0))
						if (_NETWORK_IS_PLAYER_VALID(player, false, true) && _NETWORK_IS_PLAYER_VALID(plParam5, false, true))
							return true;
						else
							return true;
	...
	for (i = 0; i < 32; i = i + 1)
	{
		...
		if (_NETWORK_IS_PLAYER_VALID(player, true, true))
		{
			if (!_NETWORK_IS_PLAYER_IN_SCTV(player, 0) && NETWORK::NETWORK_ARE_PLAYERS_IN_SAME_TUTORIAL_SESSION(PLAYER::PLAYER_ID(), player))
			{
				...
				{
					if (func_133(player) || !bParam10 && !Global_2657589[player].f_270)
					{
						num = iParam6;
...
Vector3 func_201(Player plParam0) // Position - 0xEFCF
{
	...
	if (func_203() && Global_1853910[player].f_832 && !_IS_NULL_VECTOR(Global_1853910[player].f_833))
...
BOOL func_205(var uParam0, var uParam1, var uParam2) // Position - 0xF15E
{
	...
	if (Global_2793046.f_936 && func_206(uParam0, &unk))
		return true;
	...
	*uParam3 = -1;
	...
	if (!(num2 == -1))
	{
		for (i = 83; i <= 87; i = i + 1)
		{
			...
			if (func_207(num))
			{
				if (func_218(Global_1950108.f_542[i], 0) == num2)
				{
					*uParam3 = i + 1000;
					return true;
				}
...
int func_218(var uParam0, var uParam1, var uParam2, int iParam3) // Position - 0xF647
{
	...
	for (i = 0; i < 12; i = i + 1)
	{
		if (Global_2640505[i].f_9 == 1 || iParam3 == 0)
			if (func_178(uParam0, &Global_2640505[i], 0.1f, false, false))
				return i;
	}
	...
	if (!func_237())
	{
		...
		if (num > -1)
		{
			...
			switch (num)
			{
				...
				case 30:
					if (func_232(hParam3))
						func_233(Global_1853910[PLAYER::PLAYER_ID()].f_267.f_33);
					break;
...
int func_236(Vector3 vParam0, var uParam1, var uParam2) // Position - 0x1772D
{
	...
	for (i = 0; i < 32; i = i + 1)
	{
		...
		if (func_174(vParam0, &Global_2642883[i]))
		{
...
BOOL func_240(var uParam0, BOOL bParam1) // Position - 0x178A4
{
	...
	for (i = 0; i < 2; i = i + 1)
	{
		...
		if (func_174(unk, &Global_2642839[i]))
		{
			if (bParam1)
			{
				func_185(&unk, Global_2642839[i], Global_2642839[i].f_3, Global_2642839[i].f_6, 1036831949, false);
				*uParam0 = Vector3(unk);
			}
	...
	if (!Global_2635559.f_515 && !Global_2635559.f_516)
	{
		if (!Global_2635559.f_45.f_317)
		{
			...
			else
			{
				...
				if (num > -1)
				{
					unk = Vector3(func_242(&Global_2635559.f_45[num]));
...
int func_243(var uParam0, var uParam1, var uParam2, int iParam3) // Position - 0x17A4A
{
	...
	for (i = 0; i < 4; i = i + 1)
	{
		if (Global_2635559.f_45[i].f_9)
			if (func_178(uParam0, &Global_2635559.f_45[i], iParam3, false, false))
				return i;
	}
...
BOOL func_244(var uParam0, var uParam1, var uParam2, int iParam3) // Position - 0x17A92
{
	...
	{
		if (Global_2635559.f_45[i].f_9)
			if (func_178(uParam0, &Global_2635559.f_45[i], iParam3, false, 0))
				return true;
	}
...
{
	uLocal_93[NETWORK::PARTICIPANT_ID_TO_INT()].f_1 = iParam0;
	return;
}

int func_260(Player plParam0) // Position - 0x17DD1
{
	return uLocal_93[plParam0].f_1;
}
...
{
	MISC::CLEAR_BIT(&(Global_1894573[PLAYER::PLAYER_ID()].f_10.f_6), iParam0);
	return;
}
...
{
	MISC::SET_BIT(&(Global_1894573[PLAYER::PLAYER_ID()].f_10.f_6), iParam0);
	return;
}
...
BOOL func_268(Player plParam0, int iParam1) // Position - 0x17EDD
{
	...
	num = iParam1 / 32;
	num2 = iParam1 % 32;
	return IS_BIT_SET(uLocal_93[plParam0].f_2[num], num2);
}

void func_269(int iParam0) // Position - 0x17F02
{
	Global_1894573[PLAYER::PLAYER_ID()].f_10.f_303 = iParam0;
	return;
}

int func_270() // Position - 0x17F1C
{
	return Global_1894573[PLAYER::PLAYER_ID()].f_10.f_303;
}
...
void func_278(int iParam0) // Position - 0x180EA
{
	...
	num = iParam0 / 32;
	offset = iParam0 % 32;
	MISC::CLEAR_BIT(&uLocal_93[NETWORK::PARTICIPANT_ID_TO_INT()].f_2[num], offset);
	return;
}
...
void func_279(int iParam0) // Position - 0x18114
{
	...
	num = iParam0 / 32;
	offset = iParam0 % 32;
	MISC::SET_BIT(&uLocal_93[NETWORK::PARTICIPANT_ID_TO_INT()].f_2[num], offset);
	return;
}
...
{
	uLocal_93[NETWORK::PARTICIPANT_ID_TO_INT()] = iParam0;
	return;
}
...
{
	func_263(9);
	Global_1894573[PLAYER::PLAYER_ID()].f_10.f_304 = 0;
	return;
}
