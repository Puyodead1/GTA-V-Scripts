...
void func_192() // Position - 0x10C4B
{
	if (!bLocal_80)
	{
		iLocal_79 = PED::ADD_SCENARIO_BLOCKING_AREA({ 40.073f, 4788.5586f, 2157.109f } - Vector3( 25f, 25f, 25f ), { 40.073f, 4788.5586f, 2157.109f } + Vector3( 25f, 25f, 25f ), false, true, true, true);
		bLocal_80 = true;
	}
