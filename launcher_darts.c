...
void main() // Position - 0x0
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(obScriptParam_166))
	{
		uLocal_90 = Vector3(ENTITY::GET_ENTITY_COORDS(obScriptParam_166, true));
		obLocal_156 = obScriptParam_166;
		unk.f_1[0] = Vector3(uLocal_90);
	...
	while (true)
	{
		...
		if (ENTITY::DOES_ENTITY_EXIST(pedLocal_85) && !ENTITY::IS_ENTITY_DEAD(pedLocal_85, false))
		{
			...
			fLocal_93 = SYSTEM::VDIST2(uLocal_87, unk.f_1[0]);
			fLocal_93 = fLocal_93;
			uLocal_111 = Vector3(uLocal_87);
			uLocal_114 = Vector3(unk.f_1[0]);
			uLocal_111.f_2 = 0f;
			uLocal_114.f_2 = 0f;
			...
			switch (iLocal_95)
			{
				case 0:
					...
					else
					{
						...
						uLocal_87.f_2 - unk.f_1[0].f_2 > 500f;
					}
					break;
				...
				case 3:
					...
					else
					{
						...
						if (flag3)
						{
							if (!ENTITY::IS_ENTITY_AT_COORD(pedLocal_85, unk.f_1[0], fLocal_117, fLocal_117, 2f, false, true, iLocal_103))
								flag3 = false;
							...
							{
								uLocal_137 = Vector3(ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(obLocal_156, uLocal_134));
...
int func_25() // Position - 0xF5E
{
	...
	entityRotation = Vector3(ENTITY::GET_ENTITY_ROTATION(obLocal_156, 2));
	uLocal_149 = Vector3(ENTITY::GET_ENTITY_COORDS(obLocal_156, true));
...
void func_42(int iParam0) // Position - 0x1B98
{
	...
	vector = Vector3(func_67(iParam0));
...
void func_53(int iParam0, var uParam1) // Position - 0x250D
{
	...
	switch (iParam0)
	{
		...
		case 71:
		case 72:
			if (!func_54(iParam0) && SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(Global_91469[26].f_6) == 0)
			{
				Global_113648.f_7263[iParam0] = 1;
				OBJECT::DOOR_SYSTEM_SET_DOOR_STATE(uParam1->f_5, Global_113648.f_7263[iParam0], true, true);
			}
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_98() || Global_112695 || Global_32166 || func_97() || func_83(8, -1) || func_96() || func_95() || func_94() || func_85() || G_SomeGlobalState.MessageCallStates.f_919[character] == 5)
							return false;
						break;
				
					case 1:
						if (PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_98() || Global_32166 || func_97() || func_83(8, -1) || func_94() || func_96() || func_95() || func_85() || G_SomeGlobalState.MessageCallStates.f_919[character] == 5)
							return false;
						break;
				
					case 2:
						if (!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_98() || Global_112695 || Global_32166 || func_97() || func_83(8, -1) || func_94() || func_96() || func_95() || func_85() || G_SomeGlobalState.MessageCallStates.f_919[character] == 5 || LastDispatchedMessageOrCall != -1)
							return false;
						break;
				
					case 3:
						if (PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_98() || Global_112695 || Global_32166 || func_97() || func_83(8, -1) || func_96() || func_95() || func_85() || G_SomeGlobalState.MessageCallStates.f_919[character] == 5)
							return false;
						break;
				
					case 4:
						if (func_98() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0 || func_83(8, -1) || func_85() || func_93() || G_SomeGlobalState.MessageCallStates.f_919[character] == 5)
							return false;
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
							if (PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0 || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || func_98() || Global_32166 || func_97() || func_83(8, -1) || func_95() || func_94() || func_85() || G_SomeGlobalState.MessageCallStates.f_919[character] == 5)
								return false;
						break;
				
					case 7:
						if (PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || !CAM::IS_SCREEN_FADED_IN() || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_98() || func_95() || Global_112695 || Global_32166 || func_97() || Global_44446 || func_83(8, -1) || func_94() || func_93() || func_85() || G_SomeGlobalState.MessageCallStates.f_919[character] == 5)
							return false;
						break;
...
void func_104() // Position - 0x6D09
{
	...
	if (bLocal_146)
	{
		vector = Vector3(func_73(iLocal_148));
		entityCoords = Vector3(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true));
		...
		if (num > 45f || Global_113610 && !ENTITY::DOES_ENTITY_EXIST(pedLocal_143))
		{
			...
			unk5 = Vector3(-573.1373f, 294.0269f, 78.1765f);
			unk8 = Vector3(-574.1169f, 292.7964f, 78.1766f);
			unk11 = Vector3(1995.6138f, 3049.8774f, 46.2153f);
			unk14 = Vector3(1995.488f, 3047.3833f, 46.2153f);
			num2 = 172.6813f;
			num3 = 274.5094f;
			num4 = 142.6717f;
			num5 = 44.8785f;
