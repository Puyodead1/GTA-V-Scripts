		...
		if (NETWORK::NETWORK_IS_PLAYER_ACTIVE(plParam0) && PLAYER::IS_PLAYER_PLAYING(plParam0) || bParam3 == true)
		{
			...
			else
			{
				if (!func_8(playerPed) && !ENTITY::IS_ENTITY_ATTACHED_TO_ANY_VEHICLE(playerPed))
				{
					...
					if (func_5(*Global_MissionData1.missionGenAdverm))
...
void func_24(var uParam0) // Position - 0x9AC
{
	...
	switch (uParam0->f_13)
	{
		...
		case 2:
			if (func_76(PLAYER::PLAYER_PED_ID(), &uParam0->f_16[uParam0->f_9]) && func_75(PLAYER::PLAYER_PED_ID(), uParam0->f_16[uParam0->f_9].f_3, uParam0->f_16[uParam0->f_9].f_13))
			{
...
BOOL func_69(var uParam0) // Position - 0x238B
{
	...
	for (i = 0; i < 10; i = i + 1)
	{
		if (ENTITY::DOES_ENTITY_EXIST(sizeAndPeds[i]) && !PED::IS_PED_INJURED(sizeAndPeds[i]) && ENTITY::IS_ENTITY_VISIBLE(sizeAndPeds[i]) && func_76(sizeAndPeds[i], &uParam0->f_16[uParam0->f_9]))
			return true;
	}
	...
	for (i = 0; i < NETWORK::NETWORK_GET_MAX_NUM_PARTICIPANTS(); i = i + 1)
	{
		if (NETWORK::NETWORK_IS_PARTICIPANT_ACTIVE(PLAYER::INT_TO_PARTICIPANTINDEX(i)))
		{
			...
			if (playerIndex != PLAYER::PLAYER_ID() && _NETWORK_IS_PLAYER_VALID(playerIndex, true, true))
				if (func_76(PLAYER::GET_PLAYER_PED(playerIndex), &uParam0->f_16[uParam0->f_9]) || func_71(playerIndex) == uParam0->f_9)
					return 1;
		}
	}
	...
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2657589[plParam0].f_321.f_7 != -1)
				return func_98(Global_2657589[plParam0].f_321.f_7) == 22;
...
BOOL func_99() // Position - 0x2E1D
{
	...
	{
		if (NETWORK::NETWORK_IS_SCRIPT_ACTIVE("auto_shop_seating", Global_2657589[PLAYER::PLAYER_ID()].f_321.f_10, true, 0))
			return false;
...
void func_101(int iParam0, var uParam1, int iParam2, int iParam3) // Position - 0x2EC6
{
	...
	{
		uParam1->f_16[iParam2].f_6.f_1 = Vector3(func_105(func_103(), func_106(iParam3, num)) + unk);
		uParam1->f_16[iParam2].f_6.f_4 = Vector3(func_105(func_102(), func_106(iParam3, num)) + unk);
	}
...
void func_108(int iParam0, var uParam1, var uParam2) // Position - 0x3067
{
	if (func_27())
	{
		...
		{
			case 0:
				*uParam1 = Vector3(-1356.109f, 137.168f, -96.12f);
				*uParam2 = 180f;
				break;
		
			case 1:
				*uParam1 = Vector3(-1353.853f, 138.379f, -96.12f);
				*uParam2 = -92.52f;
				break;
		
			case 2:
				*uParam1 = Vector3(-1354.324f, 147.343f, -100.194f);
				*uParam2 = 90f;
				break;
		
			case 3:
				*uParam1 = Vector3(-1354.025f, 146.018f, -100.194f);
				*uParam2 = 125f;
				break;
		
			case 4:
				*uParam1 = Vector3(-1353.006f, 145.343f, -100.194f);
				*uParam2 = 173.36f;
				break;
		}
	}
