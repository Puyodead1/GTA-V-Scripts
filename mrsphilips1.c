...
void main() // Position - 0x0
{
	...
	fLocal_32 = 180f;
	iLocal_35 = 3;
	uLocal_79 = Vector3(uScriptParam_144);
	func_293(&uLocal_79);
...
void _STAT_SET_PACKED_BOOL(int iParam0, BOOL bParam1, int iParam2) // Position - 0xA68
{
	if (iParam2 == -1)
		iParam2 = func_11();
	...
	if (Global_78813 != 6)
	{
		...
		else
		{
			...
			if (value < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				text = Vector3(func_238(Global_78814, Global_78816, iParam10));
				y == -0.014f;
...
struct<2> func_238(int iParam0, int iParam1, int iParam2) // Position - 0x2799C
{
	...
	switch (iParam1)
	{
		...
		case 3:
			...
			{
				case 0:
					unk = Vector3(func_245(iParam2));
					break;
			
				case 8:
					unk = Vector3(func_244(iParam2));
					break;
...
{
	if (!func_250(0) || G_TextMessageConfig || Global_78817 == 1 || !CAM::IS_SCREEN_FADED_IN())
		return false;
