...
BOOL func_108(Vehicle veParam0, Any* panParam1) // Position - 0x8958
{
	...
	{
		num = Global_2359296[func_115()].f_681.f_2;
...
BOOL func_125(Player plParam0) // Position - 0x902B
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (func_126(plParam0) && Global_2657704[plParam0].f_321.f_10 == plParam0)
			return true;
	...
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2657704[plParam0].f_321.f_7 != -1)
				return func_127(Global_2657704[plParam0].f_321.f_7) == 22;
...
BOOL func_165(var uParam0) // Position - 0xB354
{
	...
	else
	{
		...
		func_166(uParam0->f_23, &Global_1887945[player], false, -1);
	}
...
BOOL func_197(Ped pedParam0, int iParam1, int iParam2) // Position - 0x12ECD
{
	...
	entityModel = ENTITY::GET_ENTITY_MODEL(pedParam0);
	Global_78472[1] = { func_213(entityModel, iParam1, iParam2, -1) };
	hash = Global_2883588;
			...
			if (unk[num2] != -99)
			{
				if (!func_197(pedParam0, num2, unk[num2]))
				{
					...
					if (num2 == 13)
					{
						...
						for (i = 0; i <= 8; i = i + 1)
						{
							if (!func_197(pedParam0, 14, unk18[i]))
							{
								for (j = 0; j <= 19; j = j + 1)
								{
									Global_78472[2] = { func_213(entityModel, 14, j, -1) };
								
									if (Global_78472[2].f_12 == i)
									{
										if (func_197(pedParam0, 14, j))
										{
											if (!func_201(entityModel, iParam2, 14, j, &unk, &Global_78472[2]))
											{
												Global_2883588 = hash;
												Global_2883589 = hash2;
												return false;
					...
					else
					{
						...
						Global_78472[2] = { func_213(entityModel, num2, num, -1) };
					
						if (!func_201(entityModel, iParam2, num2, num, &unk, &Global_78472[2]))
						{
							Global_2883588 = hash;
							Global_2883589 = hash2;
							return false;
	...
	{
		if (Global_78472[1].f_3 == PED::GET_PED_DRAWABLE_VARIATION(pedParam0, func_186(iParam1)) && Global_78472[1].f_4 == PED::GET_PED_TEXTURE_VARIATION(pedParam0, func_186(iParam1)))
			return true;
	...
	switch (hParam0)
	{
		case joaat("Player_Zero"):
			switch (iParam1)
			{
				...
				case 5:
					func_212(&unk, -99, -99, G_MissionStats.f_2366.f_539.f_196[0], G_MissionStats.f_2366.f_539.f_200[0], 6, 3, 0, 0, 0, -99, 0, 0, 3);
					break;
		...
		case joaat("Player_One"):
			switch (iParam1)
			{
				...
				case 2:
					func_212(&unk, -99, -99, G_MissionStats.f_2366.f_539.f_196[1], G_MissionStats.f_2366.f_539.f_200[1], 17, 2, 26, 0, 0, -99, 0, 45, 31);
					break;
		...
		case joaat("Player_Two"):
			switch (iParam1)
			{
				...
				case 4:
					func_212(&unk, -99, -99, G_MissionStats.f_2366.f_539.f_196[2], G_MissionStats.f_2366.f_539.f_200[2], 8, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
...
void func_215(int iParam0) // Position - 0x17241
{
	...
	func_216(&Global_78472[0], num6, iParam0, &unk, num2, num3, num, flag, num4, num5, false);
	return;
}
...
void func_226(int iParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0x1BD8C
{
	...
	if (iParam0 == 12)
	{
		...
		if (outfitIndex >= 0)
		{
			...
			if (num3 > outfitIndex)
			{
				...
				func_216(&Global_78472[0], iParam0, iParam1, &(outfit.f_7), 0, 0, outfit.f_2, false, -1, 2, true);
				return;
			}
		}
	}
	...
	{
		func_216(&Global_78472[0], iParam0, iParam1, "NO_LABEL", 0, 0, 0, true, -1, 2, true);
	}
	else if (iParam0 == 14)
	{
		FILES::INIT_SHOP_PED_PROP(&outProp);
		...
		if (componentId >= 0)
		{
			...
			if (num5 > componentId)
			{
				...
				func_216(&Global_78472[0], iParam0, iParam1, &(outProp.f_9), outProp.f_3, outProp.f_4, outProp.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(outProp.f_1, joaat("OUTFIT_ONLY"), 0), num4, 2, outProp.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (hParam3 != -1 && Global_78670)
		{
			...
			func_216(&Global_78472[0], iParam0, iParam1, &(outComponent.f_9), outComponent.f_3, outComponent.f_4, outComponent.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(outComponent.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, outComponent.f_1 != 0);
			return;
		}
...
void func_229(int iParam0, Hash hParam1) // Position - 0x1C3F8
{
	...
	{
		func_216(&Global_78472[0], num5, iParam0, &unk, num, num2, value, flag, num3, num4, false);
	}
			...
			switch (pedDrawableVariation)
			{
				...
				case 5:
					if (!bParam1)
					{
						...
						else if (func_117(PLAYER::PLAYER_ID(), true) && Global_1895156[PLAYER::PLAYER_ID()].f_10.f_76.f_21 != 0)
						{
							return 1;
						}
					}
