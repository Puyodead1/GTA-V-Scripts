...
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (func_123(plParam0) && Global_2657589[plParam0].f_321.f_10 == plParam0)
			return true;
	...
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2657589[plParam0].f_321.f_7 != -1)
				return func_124(Global_2657589[plParam0].f_321.f_7) == 22;
...
BOOL func_161(var uParam0) // Position - 0xB036
{
	...
	else
	{
		...
		func_162(uParam0->f_23, &Global_1887707[player], false, -1);
	}
...
BOOL func_193(Ped pedParam0, int iParam1, int iParam2) // Position - 0x12B6D
{
	...
	entityModel = ENTITY::GET_ENTITY_MODEL(pedParam0);
	Global_78341[1] = Vector3(func_209(entityModel, iParam1, iParam2, -1));
	hash = Global_2883588;
	...
	if (iParam1 == 12)
	{
		unk = Vector3(func_205(entityModel, iParam2));
		...
		for (k = 0; k < 7; k = k + 1)
		{
			...
			if (unk[num2] != -99)
			{
				if (!func_193(pedParam0, num2, unk[num2]))
				{
					...
					if (num2 == 13)
					{
						unk18 = Vector3(func_202(entityModel, unk[num2]));
						...
						for (i = 0; i <= 8; i = i + 1)
						{
							if (!func_193(pedParam0, 14, unk18[i]))
							{
								for (j = 0; j <= 19; j = j + 1)
								{
									Global_78341[2] = Vector3(func_209(entityModel, 14, j, -1));
								
									if (Global_78341[2].f_12 == i)
									{
										if (func_193(pedParam0, 14, j))
										{
											if (!func_197(entityModel, iParam2, 14, j, &unk, &Global_78341[2]))
											{
												Global_2883588 = hash;
												Global_2883589 = hash2;
												return false;
					...
					else
					{
						...
						Global_78341[2] = Vector3(func_209(entityModel, num2, num, -1));
					
						if (!func_197(entityModel, iParam2, num2, num, &unk, &Global_78341[2]))
						{
							Global_2883588 = hash;
							Global_2883589 = hash2;
							return false;
	...
	{
		unk28 = Vector3(func_202(entityModel, iParam2));
	...
	{
		if (Global_78341[1].f_3 == PED::GET_PED_DRAWABLE_VARIATION(pedParam0, func_182(iParam1)) && Global_78341[1].f_4 == PED::GET_PED_TEXTURE_VARIATION(pedParam0, func_182(iParam1)))
			return true;
...
BOOL func_197(Hash hParam0, int iParam1, int iParam2, int iParam3, var uParam4, int iParam5) // Position - 0x1316D
{
	...
	if (iParam2 == 14)
	{
		unk = Vector3(func_202(hParam0, uParam4->[13]));
...
void func_211(int iParam0) // Position - 0x16EE1
{
	...
	func_212(&Global_78341[0], num6, iParam0, &unk, num2, num3, num, flag, num4, num5, false);
	return;
}
...
void func_222(int iParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0x1B831
{
	...
	if (iParam0 == 12)
	{
		...
		if (outfitIndex >= 0)
		{
			...
			if (num3 > outfitIndex)
			{
				...
				func_212(&Global_78341[0], iParam0, iParam1, &(outfit.f_7), 0, 0, outfit.f_2, false, -1, 2, true);
				return;
			}
		}
	}
	...
	{
		func_212(&Global_78341[0], iParam0, iParam1, "NO_LABEL", 0, 0, 0, true, -1, 2, true);
	}
	else if (iParam0 == 14)
	{
		FILES::INIT_SHOP_PED_PROP(&outProp);
		...
		if (componentId >= 0)
		{
			...
			if (num5 > componentId)
			{
				...
				func_212(&Global_78341[0], iParam0, iParam1, &(outProp.f_9), outProp.f_3, outProp.f_4, outProp.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(outProp.f_1, joaat("OUTFIT_ONLY"), 0), num4, 2, outProp.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (hParam3 != -1 && Global_78539)
		{
			...
			func_212(&Global_78341[0], iParam0, iParam1, &(outComponent.f_9), outComponent.f_3, outComponent.f_4, outComponent.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(outComponent.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, outComponent.f_1 != 0);
			return;
		}
		...
		if (componentId2 >= 0)
		{
			num6 = FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(num2, 10, -1, false, -1, func_182(iParam0));
...
void func_225(int iParam0, Hash hParam1) // Position - 0x1BE9A
{
	...
	{
		func_212(&Global_78341[0], num5, iParam0, &unk, num, num2, value, flag, num3, num4, false);
	}
...
BOOL func_234(int iParam0, int iParam1) // Position - 0x23C3A
{
	...
	if (func_236(iParam0) == MP_STAT_INVALID)
		return false;
...
{
	if (bParam0)
		return IS_BIT_SET(*Global_MissionData1.missionGenIntop2, 12) && func_263();
			...
			switch (pedDrawableVariation)
			{
				...
				case 5:
					if (!bParam1)
					{
						...
						else if (func_114(PLAYER::PLAYER_ID(), true) && Global_1894573[PLAYER::PLAYER_ID()].f_10.f_76.f_21 != 0)
						{
							return 1;
						}
					}
...
void _STAT_SET_PACKED_BOOL(int iParam0, BOOL bParam1, int iParam2) // Position - 0x339E2
{
	if (iParam2 == -1)
		iParam2 = func_10();
