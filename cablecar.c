...
void func_11(var uParam0) // Position - 0xCB9
{
	...
	if (!CAM::IS_SCREEN_FADED_OUT())
	{
		...
		vector = { func_14(&uLocal_74[uParam0->f_15], 0, &num) };
	...
	if (num != 0f)
	{
		...
		if (uParam0->f_19 < 0f)
		{
			...
			if (uParam0->f_18 < 0)
			{
				...
				uParam0->f_16 = 0f;
				uParam0->f_9 = 0;
				uParam0->f_12 = { uLocal_74[uParam0->f_15][uParam0->f_18] };
		...
		{
			uParam0->f_12 = { func_15(uLocal_74[uParam0->f_15][uParam0->f_18], uLocal_74[uParam0->f_15][uParam0->f_18 + 1], uParam0->f_19, true) };
			func_19(uParam0);
		}
...
int func_22(var uParam0) // Position - 0x1A5A
{
	...
	if (num != 0f)
	{
		...
		if (uParam0->f_18 < uLocal_74[uParam0->f_15].f_46 - 1)
		{
			uParam0->f_12 = { func_14(&uLocal_74[uParam0->f_15], uParam0->f_18, &(uParam0->f_19)) };
			func_19(uParam0);
		}
...
{
	uParam0->f_12 = { func_14(&uLocal_74[uParam0->f_15], iParam1, &fParam2) };
...
int func_115(Ped pedParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x49AC
{
	...
	if (iParam1 == 12)
	{
		...
		for (i = 0; i <= 14; i = i + 1)
		{
			...
			{
				Global_78341[1] = { func_163(entityModel, i, func_124(pedParam0, i, PV_COMP_INVALID), -1) };
...
struct<8> func_238(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, float fParam8) // Position - 0x231A0
{
	...
	unk = 2;
	unk9 = { func_239(uParam0[1] - uParam0[0]) * { fParam8, fParam8, fParam8 } };
...
void func_287(var uParam0, int iParam1, int iParam2, float fParam3, int iParam4) // Position - 0x25737
{
	...
	uParam0->f_12 = { func_14(&uLocal_74[iParam1], iParam2, &fParam3) };
