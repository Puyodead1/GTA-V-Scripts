...
void main() // Position - 0x0
{
	...
	iLocal_453 = 49;
	iLocal_454 = 64;
	uLocal_242 = Vector3(uScriptParam_506.f_1[0]);
	func_120();
	...
	pedLocal_240 = PED::CREATE_PED(PED_TYPE_SPECIAL, hLocal_36, uLocal_242, uScriptParam_506.f_17[0], false, true);
	func_103();
	...
	while (num == 1)
	{
		...
		switch (iLocal_250)
		{
			...
			case 5:
				...
				{
					TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(pedLocal_240, uLocal_242, 1f, -1, 1f, 1024, uScriptParam_506.f_17[0]);
					iLocal_250 = 6;
				}
				break;
...
{
	if (IS_BIT_SET(Global_113648.f_18576[58], 0) && !IS_BIT_SET(Global_113648.f_18576[58], 3))
		return true;
...
{
	if (IS_BIT_SET(Global_113648.f_18576[60], 0) && !IS_BIT_SET(Global_113648.f_18576[60], 3))
		return false;

	if (IS_BIT_SET(Global_113648.f_18576[61], 0) && !IS_BIT_SET(Global_113648.f_18576[61], 3))
		return false;

	if (IS_BIT_SET(Global_113648.f_18576[62], 3))
		return false;

	if (IS_BIT_SET(Global_113648.f_18576[58], 2) || IS_BIT_SET(Global_113648.f_18576[59], 2) || IS_BIT_SET(Global_113648.f_18576[62], 2))
		return true;
...
void func_115(int iParam0) // Position - 0x3438
{
	...
	if (bLocal_241)
	{
		TEXT_LABEL_COPY(&string1, Vector3(func_117()), 4);
