...
void main() // Position - 0x0
{
	...
	iLocal_39 = 49;
	iLocal_40 = 64;
	uLocal_48 = { uScriptParam_249.f_1[0] };
...
void _STAT_SET_PACKED_BOOL(int iParam0, BOOL bParam1, int iParam2) // Position - 0x1351
{
	if (iParam2 == -1)
		iParam2 = func_21();
...
void func_29() // Position - 0x1AB1
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (_GET_CHARACTER_MODEL(G_MissionStats.f_2366.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_31(character) && !func_30(14) || Global_112760)
			{
				if (G_MissionStats.f_2366.f_539.f_4321 != character && func_31(G_MissionStats.f_2366.f_539.f_4321))
...
void func_64() // Position - 0x32AB
{
	if (!PED::IS_PED_INJURED(pedLocal_66))
	{
		...
		{
			ENTITY::SET_ENTITY_HEALTH(pedLocal_66, 101, 0);
			ENTITY::SET_ENTITY_ONLY_DAMAGED_BY_PLAYER(pedLocal_66, false);
...
int func_70(BOOL bParam0) // Position - 0x397B
{
	if (func_74())
	{
		...
		if (bParam0 && func_23(Global_113799))
...
{
	switch (func_75(&Global_32343, 0, 5, false, SCRIPT::GET_ID_OF_THIS_THREAD()))
	{
		case 1:
			return true;
...
BOOL func_85() // Position - 0x454C
{
	...
	if (!ENTITY::DOES_ENTITY_EXIST(pedLocal_66) && !ENTITY::DOES_ENTITY_EXIST(iLocal_67[0]) && !ENTITY::DOES_ENTITY_EXIST(iLocal_67[1]) && !ENTITY::DOES_ENTITY_EXIST(veLocal_74) && !ENTITY::DOES_ENTITY_EXIST(iLocal_75[0]) && !ENTITY::DOES_ENTITY_EXIST(iLocal_75[1]))
	{
		...
		if (STREAMING::HAS_MODEL_LOADED(joaat("A_M_M_Skidrow_01")) && STREAMING::HAS_MODEL_LOADED(joaat("G_M_Y_Lost_01")) && STREAMING::HAS_MODEL_LOADED(joaat("G_M_Y_Lost_02")) && STREAMING::HAS_MODEL_LOADED(joaat("picador")) && STREAMING::HAS_MODEL_LOADED(joaat("hexer")) && STREAMING::HAS_ANIM_DICT_LOADED("random@countryside_gang_fight") && STREAMING::HAS_ANIM_DICT_LOADED("veh@drivebystd_ds_grenades") && STREAMING::HAS_ANIM_SET_LOADED("move_m@gangster@var_i"))
		{
			...
			PED::ADD_SCENARIO_BLOCKING_AREA(uLocal_48 - { 20f, 50f, 80f }, uLocal_48 + { 20f, 50f, 70f }, false, true, true, true);
...
BOOL func_104(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6) // Position - 0x66F8
{
	...
	if (!flag)
	{
		...
		if (!func_140(G_MissionStats.f_24998.f_43[iParam3]))
			return false;
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_138() || Global_112857 || Global_32286 || func_137() || func_56(8, -1) || func_136() || func_135() || func_134() || func_133() || G_MissionStats.f_7691.f_919[character] == 5)
							return false;
						break;
				
					case 1:
						if (PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_138() || Global_32286 || func_137() || func_56(8, -1) || func_134() || func_136() || func_135() || func_133() || G_MissionStats.f_7691.f_919[character] == 5)
							return false;
						break;
				
					case 2:
						if (!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_138() || Global_112857 || Global_32286 || func_137() || func_56(8, -1) || func_134() || func_136() || func_135() || func_133() || G_MissionStats.f_7691.f_919[character] == 5 || Global_43924 != -1)
							return false;
						break;
				
					case 3:
						if (PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_138() || Global_112857 || Global_32286 || func_137() || func_56(8, -1) || func_136() || func_135() || func_133() || G_MissionStats.f_7691.f_919[character] == 5)
							return false;
						break;
				
					case 4:
						if (func_138() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0 || func_56(8, -1) || func_133() || func_132() || G_MissionStats.f_7691.f_919[character] == 5)
							return false;
						break;
...
void func_147(int iParam0) // Position - 0x7F2C
{
	...
	if (func_99())
	{
		...
		func_150(30000);
		TEXT_LABEL_ASSIGN_STRING(&name, func_149(Global_113799, true), 64);
