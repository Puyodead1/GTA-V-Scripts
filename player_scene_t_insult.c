...
BOOL func_2() // Position - 0x12E
{
	...
	for (i = 0; i < iLocal_237; i = i + 1)
	{
		...
		{
			entityCoords2 = Vector3(ENTITY::GET_ENTITY_COORDS(iLocal_237[i], true));
...
void func_26(Ped pedParam0, int iParam1) // Position - 0xAF9
{
	...
	if (!PED::IS_PED_INJURED(pedParam0))
	{
		...
		{
			case 0:
				if (ENTITY::IS_ENTITY_PLAYING_ANIM(pedParam0, &uLocal_345, &uLocal_394[iParam1], 2))
				{
					num = -1f;
					num2 = -1f;
				
					if (ENTITY::FIND_ANIM_EVENT_PHASE(&uLocal_345, &uLocal_394[iParam1], "WalkInterruptible", &num, &num2) || func_35(&uLocal_345, &uLocal_394[iParam1], "WalkInterruptible", &num, &num2))
					{
						synchronizedScenePhase = PED::GET_SYNCHRONIZED_SCENE_PHASE(Global_98011);
						...
						if (synchronizedScenePhase > num)
						{
							...
							TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(pedParam0, uLocal_273 + uLocal_284[iParam1], moveBlendRatio, -1, uLocal_294[iParam1] * 0.1f, 0, 1193033728);
				...
				else
				{
					...
					if (MISC::IS_STRING_NULL_OR_EMPTY(&uLocal_427[iParam1]))
					{
						if (func_32(uLocal_284[iParam1], 0f, 0f, 0f, false))
						{
							entityCoords = Vector3(ENTITY::GET_ENTITY_COORDS(pedParam0, true));
							uLocal_284[iParam1] = Vector3((entityCoords - uLocal_273) * Vector3(4f, 4f, 4f));
						}
					
						if (!MISC::IS_STRING_NULL_OR_EMPTY(&uLocal_691[iParam1]))
							PED::SET_PED_MOVEMENT_CLIPSET(pedParam0, &uLocal_691[iParam1], 1048576000);
					
						TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(pedParam0, uLocal_273 + uLocal_284[iParam1], 1f, -1, 1048576000, 0, 1193033728);
						iLocal_240[iParam1] = 1;
					}
					else
					{
						...
						TASK::TASK_SYNCHRONIZED_SCENE(iLocal_237[iParam1], iLocal_724, &uLocal_345, &uLocal_427[iParam1], 1000f, -1000f, flags, ragdollBlockingFlags, 1000f, ikFlags);
					
						for (i = 0; i < iLocal_253; i = i + 1)
						{
							if (iLocal_256[i] != 0)
								if (!MISC::IS_STRING_NULL_OR_EMPTY(&uLocal_592[i]))
									ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_253[i], iLocal_724, &uLocal_592[i], &uLocal_345, 8f, 1090519040, 0, 1148846080);
						}
					
						uLocal_284[iParam1] = Vector3(uLocal_277[iParam1]);
			...
			case 1:
				...
				if (TASK::GET_SCRIPT_TASK_STATUS(pedParam0, SCRIPT_TASK_FOLLOW_NAV_MESH_TO_COORD) != 1)
				{
					if (uLocal_294[iParam1] == 0f)
						uLocal_294[iParam1] = SYSTEM::VMAG(uLocal_284[iParam1]) * 0.75f;
				
					TASK::TASK_WANDER_IN_AREA(pedParam0, uLocal_273 + uLocal_284[iParam1], uLocal_294[iParam1], 1077936128, 1086324736);
			...
			case 10:
				...
				if (ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_237[iParam1], &uLocal_345, &uLocal_427[iParam1], 2))
				{
					if (iLocal_70 == 288)
					{
						if (iLocal_731 <= 0)
				...
				else
				{
					...
					TASK::TASK_SYNCHRONIZED_SCENE(iLocal_237[iParam1], iLocal_724, &uLocal_345, &uLocal_427[iParam1], 1000f, -1000f, flags2, ragdollBlockingFlags2, 1000f, ikFlags2);
				
					for (k = 0; k < iLocal_253; k = k + 1)
					{
						if (iLocal_256[k] != 0)
							if (!MISC::IS_STRING_NULL_OR_EMPTY(&uLocal_592[k]))
								ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_253[k], iLocal_724, &uLocal_592[k], &uLocal_345, 8f, 1090519040, 0, 1148846080);
					}
				}
				...
				if (flag)
				{
					...
					ikFlags3 = 0;
					TASK::TASK_SYNCHRONIZED_SCENE(iLocal_237[iParam1], iLocal_724, &uLocal_345, &uLocal_460[iParam1], 8f, -1000f, flags3, ragdollBlockingFlags3, 8f, ikFlags3);
					...
					for (l = 0; l < iLocal_253; l = l + 1)
					{
						if (iLocal_256[l] != 0)
						{
							if (!MISC::IS_STRING_NULL_OR_EMPTY(&uLocal_625[l]))
							{
								ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_253[l], iLocal_724, &uLocal_625[l], &uLocal_345, 8f, 1090519040, 0, 1148846080);
			...
			case 11:
				...
				if (!flag2)
				{
					...
					ikFlags4 = 0;
					TASK::TASK_SYNCHRONIZED_SCENE(iLocal_237[iParam1], iLocal_724, &uLocal_345, &uLocal_493[iParam1], 1000f, -1000f, flags4, ragdollBlockingFlags4, 1000f, ikFlags4);
				
					for (m = 0; m < iLocal_253; m = m + 1)
					{
						if (iLocal_256[m] != 0)
							if (!MISC::IS_STRING_NULL_OR_EMPTY(&uLocal_658[m]))
								ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_253[m], iLocal_724, &uLocal_658[m], &uLocal_345, 8f, 1090519040, 0, 1148846080);
					}
			...
			case 12:
				...
				if (!ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_237[iParam1], &uLocal_345, &uLocal_493[iParam1], 2))
				{
					if (!PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_724))
						iLocal_724 = PED::CREATE_SYNCHRONIZED_SCENE(uLocal_273, 0f, 0f, fLocal_276, 2);
				
					TASK::TASK_SYNCHRONIZED_SCENE(iLocal_237[iParam1], iLocal_724, &uLocal_345, &uLocal_493[iParam1], 1000f, -1000f, 0, 0, 1148846080, 0);
				
					for (n = 0; n < iLocal_253; n = n + 1)
					{
						if (iLocal_256[n] != 0)
							if (!MISC::IS_STRING_NULL_OR_EMPTY(&uLocal_658[n]))
								ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_253[n], iLocal_724, &uLocal_658[n], &uLocal_345, 8f, 1090519040, 0, 1148846080);
					}
				}
				break;
		...
		if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(Global_98011))
		{
			for (i = 0; i < iLocal_237; i = i + 1)
			{
				if (!PED::IS_PED_INJURED(iLocal_237[i]))
				{
					...
					if (ENTITY::FIND_ANIM_EVENT_PHASE(&uLocal_345, &uLocal_394[i], "WalkInterruptible", &num, &num2) || func_35(&uLocal_345, &uLocal_394[i], "WalkInterruptible", &num, &num2))
					{
						blendOut = -8f;
						flags = 2;
						ragdollBlockingFlags = 0;
					...
					TASK::TASK_SYNCHRONIZED_SCENE(iLocal_237[i], Global_98011, &uLocal_345, &uLocal_394[i], 1000f, blendOut, flags, ragdollBlockingFlags, moverBlendDelta, ikFlags);
					iLocal_240[i] = 0;
				}
			}
			...
			for (i = 0; i < iLocal_253; i = i + 1)
			{
				if (ENTITY::DOES_ENTITY_EXIST(iLocal_253[i]))
					if (!MISC::IS_STRING_NULL_OR_EMPTY(&uLocal_559[i]))
						ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_253[i], Global_98011, &uLocal_559[i], &uLocal_345, 8f, -1000f, 0, 1148846080);
			}
...
BOOL func_38() // Position - 0x1C6C
{
	...
	if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(Global_98010))
	{
		...
		{
			if (!PED::IS_PED_INJURED(iLocal_237[i]))
				TASK::TASK_SYNCHRONIZED_SCENE(iLocal_237[i], Global_98010, &uLocal_345, &uLocal_361[i], 8f, -1000f, 0, 0, 1148846080, 0);
		}
	
		for (i = 0; i < iLocal_253; i = i + 1)
		{
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_253[i]))
				if (!MISC::IS_STRING_NULL_OR_EMPTY(&uLocal_526[i]))
					ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_253[i], Global_98010, &uLocal_526[i], &uLocal_345, 8f, -1000f, 0, 1148846080);
		}
...
int func_39(int iParam0, Entity eParam1) // Position - 0x1D68
{
	...
	if (!STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS())
	{
		...
		{
			entityCoords = Vector3(ENTITY::GET_ENTITY_COORDS(eParam1, false));
...
void func_47() // Position - 0x1F18
{
	...
	while (!flag && num < 400)
	{
		...
		for (i = 0; i < iLocal_243; i = i + 1)
		{
			...
			if (!MISC::IS_STRING_NULL_OR_EMPTY(&uLocal_691[i]))
			{
				STREAMING::REQUEST_CLIP_SET(&uLocal_691[i]);
			
				if (!STREAMING::HAS_CLIP_SET_LOADED(&uLocal_691[i]))
					flag = false;
			}
		}
	...
	for (i = 0; i < iLocal_237; i = i + 1)
	{
		if (iLocal_243[i] != 0)
		{
			iLocal_237[i] = PED::CREATE_PED(PED_TYPE_MISSION, iLocal_243[i], uLocal_273 + uLocal_277[i], 0, true, true);
			...
			TASK::TASK_PLAY_ANIM(iLocal_237[i], &uLocal_345, &uLocal_361[i], 8f, -8f, -1, 1, 0f, false, false, false);
		}
	}
	...
	for (i = 0; i < iLocal_253; i = i + 1)
	{
		if (iLocal_256[i] != 0)
		{
			iLocal_253[i] = OBJECT::CREATE_OBJECT(iLocal_256[i], uLocal_273 + uLocal_277[i] + uLocal_259[i], true, true, false);
			ENTITY::SET_ENTITY_ROTATION(iLocal_253[i], Vector3(fLocal_276 + uLocal_291[i], 0f, 0f) + uLocal_266[i], 2, true);
		
			if (!MISC::IS_STRING_NULL_OR_EMPTY(&uLocal_526[i]))
				ENTITY::PLAY_ENTITY_ANIM(iLocal_253[i], &uLocal_526[i], &uLocal_345, 8f, true, false, false, 0, 0);
		}
	}
...
void func_48() // Position - 0x217F
{
	...
	TEXT_LABEL_ASSIGN_STRING(&uLocal_691[0], "", 64);
	TEXT_LABEL_ASSIGN_STRING(&uLocal_691[1], "", 64);
	iLocal_256[0] = 0;
	iLocal_256[1] = 0;
	...
	switch (iLocal_70)
	{
		case 237:
			...
			TEXT_LABEL_ASSIGN_STRING(&uLocal_361[0], "LOOP_STRIPPER_01", 64);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_394[0], "EXIT_STRIPPER_01", 64);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_427[0], "", 64);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_361[1], "LOOP_STRIPPER_02", 64);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_394[1], "EXIT_STRIPPER_02", 64);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_427[1], "", 64);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_725, "TRVS_IG_35", 16);
			fLocal_729 = 0.15f;
			uLocal_277[0] = Vector3(MISC::GET_RANDOM_FLOAT_IN_RANGE(-10f, 10f), MISC::GET_RANDOM_FLOAT_IN_RANGE(-10f, 10f), 0f);
			uLocal_277[1] = Vector3(MISC::GET_RANDOM_FLOAT_IN_RANGE(-10f, 10f), MISC::GET_RANDOM_FLOAT_IN_RANGE(-10f, 10f), 0f);
			uLocal_284[0] = Vector3(8.2284f, -35.8652f, -1.0334f);
			uLocal_284[1] = Vector3(28.4066f, -23.8848f, -0.7887f);
		...
		case 235:
			...
			TEXT_LABEL_ASSIGN_STRING(&uLocal_361[0], "001443_01_TRVS_28_IDLE_STRIPPER", 64);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_394[0], "001443_01_TRVS_28_EXIT_STRIPPER", 64);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_427[0], "001443_01_TRVS_28_IDLE_STRIPPER", 64);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_361[1], "001443_01_TRVS_28_IDLE_MAN", 64);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_394[1], "001443_01_TRVS_28_EXIT_MAN", 64);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_427[1], "001443_01_TRVS_28_IDLE_MAN", 64);
			uLocal_277[0] = Vector3(-1.5421f, 0.8274f, -1.0288f);
			uLocal_277[1] = Vector3(-0.9636f, 1.1757f, -1.0243f);
			uLocal_284[0] = Vector3(0f, 0f, 0f);
			uLocal_284[1] = Vector3(0f, 0f, 0f);
			uLocal_291[0] = -130f;
			uLocal_291[1] = -130f;
			uLocal_294[0] = 0f;
			uLocal_294[1] = 0f;
		...
		case 247:
			...
			TEXT_LABEL_ASSIGN_STRING(&uLocal_361[0], "trev_annoys_sunbathers_loop_girl", 64);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_394[0], "trev_annoys_sunbathers_exit_girl", 64);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_427[0], "", 64);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_691[0], "move_f@scared", 64);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_361[1], "trev_annoys_sunbathers_loop_guy", 64);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_394[1], "trev_annoys_sunbathers_exit_guy", 64);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_427[1], "", 64);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_691[1], "move_m@hurry_Butch@A", 64);
			uLocal_277[0] = Vector3(-0.3866f, 0.1726f, 1f);
			uLocal_277[1] = Vector3(-0.0726f, -0.4742f, 1f);
			uLocal_284[0] = Vector3(Vector3(1.5806f, -1719.6064f, -1291.4749f) - uLocal_273);
			uLocal_284[1] = Vector3(uLocal_284[0]);
			uLocal_291[0] = 0f;
			uLocal_291[1] = 0f;
			uLocal_294[0] = 20f;
			...
			uLocal_259[0] = Vector3(0f, 0f, -1f);
			uLocal_266[0] = Vector3(0f, 0f, 2.16f);
			iLocal_256[1] = joaat("prop_cs_beachtowel_01");
			uLocal_259[1] = Vector3(0f, 0f, -1f);
			uLocal_266[1] = Vector3(0f, 0f, -4.32f);
			break;
	
		case 286:
			TEXT_LABEL_ASSIGN_STRING(&uLocal_345, "SWITCH@TREVOR@RUDE_AT_CAFE", 64);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_361[0], "001218_03_TRVS_23_RUDE_AT_CAFE_IDLE_FEMALE", 64);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_394[0], "001218_03_TRVS_23_RUDE_AT_CAFE_EXIT_FEMALE", 64);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_427[0], "", 64);
			uLocal_277[0] = Vector3(4.261f, -2.388f, 0.5f);
			uLocal_284[0] = Vector3(10.5918f, -34.5146f, 0f);
			uLocal_291[0] = 57.695f;
			uLocal_294[0] = 30f;
			iLocal_243[0] = joaat("A_F_Y_Hipster_03");
			uLocal_246[0] = -1;
			TEXT_LABEL_ASSIGN_STRING(&uLocal_361[1], "", 64);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_394[1], "", 64);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_427[1], "", 64);
			uLocal_284[1] = Vector3(0f, 0f, 0f);
			uLocal_294[1] = 0f;
			iLocal_243[1] = 0;
		...
		case 263:
			...
			TEXT_LABEL_ASSIGN_STRING(&uLocal_361[0], "trev_scares_tramp_idle_tramp", 64);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_394[0], "trev_scares_tramp_exit_tramp", 64);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_427[0], "", 64);
			uLocal_277[0] = Vector3(2.0921f, -1.5872f, 0f);
			uLocal_284[0] = Vector3(Vector3(10.9545f, -1419.5369f, -605.8271f) - uLocal_273);
			uLocal_291[0] = MISC::GET_RANDOM_FLOAT_IN_RANGE(-180f, 180f);
			uLocal_294[0] = 40f;
		...
		case 244:
			...
			TEXT_LABEL_ASSIGN_STRING(&uLocal_361[0], "LOOP_Ped", 64);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_394[0], "EXIT_Ped", 64);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_427[0], "", 64);
			uLocal_277[0] = Vector3(MISC::GET_RANDOM_FLOAT_IN_RANGE(-5f, 5f), MISC::GET_RANDOM_FLOAT_IN_RANGE(-5f, 5f), 0f);
			uLocal_284[0] = Vector3(Vector3(28.2925f, -1451.7279f, 507.6885f) - uLocal_273);
			uLocal_291[0] = MISC::GET_RANDOM_FLOAT_IN_RANGE(-180f, 180f);
			uLocal_294[0] = 40f;
		...
		case 288:
			...
			TEXT_LABEL_ASSIGN_STRING(&uLocal_361[0], "LOOP_Ped", 64);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_394[0], "EXIT_Ped", 64);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_427[0], "EXIT_LOOP_Ped", 64);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_460[0], "DEATH_Ped", 64);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_493[0], "DEATH_LOOP_Ped", 64);
			uLocal_277[0] = Vector3(MISC::GET_RANDOM_FLOAT_IN_RANGE(-10f, 10f), MISC::GET_RANDOM_FLOAT_IN_RANGE(-10f, 10f), 0f);
			uLocal_284[0] = Vector3(0f, 0f, 0f);
			uLocal_291[0] = MISC::GET_RANDOM_FLOAT_IN_RANGE(-180f, 180f);
			uLocal_294[0] = 0f;
			...
			uLocal_259[0] = Vector3(0f, 0f, 0f);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_526[0], "LOOP_Rope", 64);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_559[0], "EXIT_Rope", 64);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_592[0], "EXIT_LOOP_Rope", 64);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_625[0], "DEATH_Rope", 64);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_658[0], "DEATH_LOOP_Rope", 64);
			iLocal_256[1] = joaat("prop_rolled_sock_01");
			uLocal_259[1] = Vector3(0f, 0f, 0f);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_526[1], "LOOP_Sock", 64);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_559[1], "EXIT_Sock", 64);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_592[1], "EXIT_LOOP_Sock", 64);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_625[1], "DEATH_Sock", 64);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_658[1], "DEATH_LOOP_Sock", 64);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_361[1], "", 64);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_394[1], "", 64);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_427[1], "", 64);
			uLocal_284[1] = Vector3(0f, 0f, 0f);
		...
		default:
			...
			TEXT_LABEL_ASSIGN_STRING(&uLocal_361[0], "", 64);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_394[0], "", 64);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_427[0], "", 64);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_361[1], "", 64);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_394[1], "", 64);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_427[1], "", 64);
