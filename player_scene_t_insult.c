...
void func_26(Ped pedParam0, int iParam1) // Position - 0xAF9
{
	...
	if (!PED::IS_PED_INJURED(pedParam0))
	{
		...
		{
			case 0:
				if (ENTITY::IS_ENTITY_PLAYING_ANIM(pedParam0, &uLocal_344, &uLocal_393[iParam1], 2))
				{
					num = -1f;
					num2 = -1f;
				
					if (ENTITY::FIND_ANIM_EVENT_PHASE(&uLocal_344, &uLocal_393[iParam1], "WalkInterruptible", &num, &num2) || func_35(&uLocal_344, &uLocal_393[iParam1], "WalkInterruptible", &num, &num2))
					{
						synchronizedScenePhase = PED::GET_SYNCHRONIZED_SCENE_PHASE(Global_98143);
						...
						if (synchronizedScenePhase > num)
						{
							...
							TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(pedParam0, uLocal_272 + uLocal_283[iParam1], moveBlendRatio, -1, uLocal_293[iParam1] * 0.1f, 0, 1193033728);
				...
				else
				{
					...
					if (MISC::IS_STRING_NULL_OR_EMPTY(&uLocal_426[iParam1]))
					{
						if (func_32(uLocal_283[iParam1], 0f, 0f, 0f, false))
						{
							entityCoords = { ENTITY::GET_ENTITY_COORDS(pedParam0, true) };
							uLocal_283[iParam1] = { (entityCoords - uLocal_272) * { 4f, 4f, 4f } };
						}
					
						if (!MISC::IS_STRING_NULL_OR_EMPTY(&uLocal_690[iParam1]))
							PED::SET_PED_MOVEMENT_CLIPSET(pedParam0, &uLocal_690[iParam1], 1048576000);
					
						TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(pedParam0, uLocal_272 + uLocal_283[iParam1], 1f, -1, 1048576000, 0, 1193033728);
						iLocal_239[iParam1] = 1;
					}
					else
					{
						...
						if (iLocal_255[0] == joaat("p_trev_rope_01_s") || iLocal_255[1] == joaat("p_trev_rope_01_s"))
						{
							...
							for (i = 0; i < iLocal_252; i = i + 1)
							{
								...
								OBJECT::SET_OBJECT_TARGETTABLE(iLocal_252[i], false);
							}
						}
						...
						TASK::TASK_SYNCHRONIZED_SCENE(iLocal_236[iParam1], iLocal_723, &uLocal_344, &uLocal_426[iParam1], 1000f, -1000f, flags, ragdollBlockingFlags, 1000f, ikFlags);
					
						for (i = 0; i < iLocal_252; i = i + 1)
						{
							if (iLocal_255[i] != 0)
								if (!MISC::IS_STRING_NULL_OR_EMPTY(&uLocal_591[i]))
									ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_252[i], iLocal_723, &uLocal_591[i], &uLocal_344, 8f, 1090519040, 0, 1148846080);
						}
					
						uLocal_283[iParam1] = { uLocal_276[iParam1] };
			...
			case 1:
				...
				if (TASK::GET_SCRIPT_TASK_STATUS(pedParam0, SCRIPT_TASK_FOLLOW_NAV_MESH_TO_COORD) != 1)
				{
					if (uLocal_293[iParam1] == 0f)
						uLocal_293[iParam1] = SYSTEM::VMAG(uLocal_283[iParam1]) * 0.75f;
				
					TASK::TASK_WANDER_IN_AREA(pedParam0, uLocal_272 + uLocal_283[iParam1], uLocal_293[iParam1], 1077936128, 1086324736);
			...
			case 10:
				...
				if (ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_236[iParam1], &uLocal_344, &uLocal_426[iParam1], 2))
				{
					if (iLocal_69 == 288)
					{
						if (iLocal_730 <= 0)
				...
				else
				{
					...
					TASK::TASK_SYNCHRONIZED_SCENE(iLocal_236[iParam1], iLocal_723, &uLocal_344, &uLocal_426[iParam1], 1000f, -1000f, flags2, ragdollBlockingFlags2, 1000f, ikFlags2);
				
					for (k = 0; k < iLocal_252; k = k + 1)
					{
						if (iLocal_255[k] != 0)
							if (!MISC::IS_STRING_NULL_OR_EMPTY(&uLocal_591[k]))
								ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_252[k], iLocal_723, &uLocal_591[k], &uLocal_344, 8f, 1090519040, 0, 1148846080);
					}
				}
				...
				if (flag)
				{
					...
					ikFlags3 = 0;
					TASK::TASK_SYNCHRONIZED_SCENE(iLocal_236[iParam1], iLocal_723, &uLocal_344, &uLocal_459[iParam1], 8f, -1000f, flags3, ragdollBlockingFlags3, 8f, ikFlags3);
					...
					for (l = 0; l < iLocal_252; l = l + 1)
					{
						if (iLocal_255[l] != 0)
						{
							if (!MISC::IS_STRING_NULL_OR_EMPTY(&uLocal_624[l]))
							{
								ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_252[l], iLocal_723, &uLocal_624[l], &uLocal_344, 8f, 1090519040, 0, 1148846080);
			...
			case 11:
				...
				if (!flag2)
				{
					...
					ikFlags4 = 0;
					TASK::TASK_SYNCHRONIZED_SCENE(iLocal_236[iParam1], iLocal_723, &uLocal_344, &uLocal_492[iParam1], 1000f, -1000f, flags4, ragdollBlockingFlags4, 1000f, ikFlags4);
				
					for (m = 0; m < iLocal_252; m = m + 1)
					{
						if (iLocal_255[m] != 0)
							if (!MISC::IS_STRING_NULL_OR_EMPTY(&uLocal_657[m]))
								ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_252[m], iLocal_723, &uLocal_657[m], &uLocal_344, 8f, 1090519040, 0, 1148846080);
					}
			...
			case 12:
				...
				if (!ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_236[iParam1], &uLocal_344, &uLocal_492[iParam1], 2))
				{
					if (!PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_723))
						iLocal_723 = PED::CREATE_SYNCHRONIZED_SCENE(uLocal_272, 0f, 0f, fLocal_275, 2);
				
					TASK::TASK_SYNCHRONIZED_SCENE(iLocal_236[iParam1], iLocal_723, &uLocal_344, &uLocal_492[iParam1], 1000f, -1000f, 0, 0, 1148846080, 0);
				
					for (n = 0; n < iLocal_252; n = n + 1)
					{
						if (iLocal_255[n] != 0)
							if (!MISC::IS_STRING_NULL_OR_EMPTY(&uLocal_657[n]))
								ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_252[n], iLocal_723, &uLocal_657[n], &uLocal_344, 8f, 1090519040, 0, 1148846080);
					}
				}
				break;
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, Ped pedParam2, char* sParam3, int iParam4, int iParam5) // Position - 0x15E2
{
...
BOOL func_28(Ped pedParam0) // Position - 0x167D
{
	int i;
...
BOOL func_29(Ped pedParam0) // Position - 0x1719
{
	int i;
	float num;
...
void func_30(var uParam0, int iParam1) // Position - 0x17C4
{
...
BOOL func_32(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, BOOL bParam6) // Position - 0x17E4
{
	if (bParam6)
...
void func_33(Ped pedParam0, char* sParam1, char* sParam2, int iParam3) // Position - 0x182B
{
	AUDIO::PLAY_PED_AMBIENT_SPEECH_WITH_VOICE_NATIVE(pedParam0, sParam1, sParam2, func_34(iParam3), false);
	return;
}

char* func_34(int iParam0) // Position - 0x1844
{
	char* str;
...
BOOL func_35(const char* sParam0, const char* sParam1, char* sParam2, var uParam3, var uParam4) // Position - 0x1A33
{
		...
		if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(Global_98143))
		{
			for (i = 0; i < iLocal_236; i = i + 1)
			{
				if (!PED::IS_PED_INJURED(iLocal_236[i]))
				{
					...
					if (ENTITY::FIND_ANIM_EVENT_PHASE(&uLocal_344, &uLocal_393[i], "WalkInterruptible", &num, &num2) || func_35(&uLocal_344, &uLocal_393[i], "WalkInterruptible", &num, &num2))
					{
						blendOut = -8f;
						flags = 2;
						ragdollBlockingFlags = 0;
					...
					TASK::TASK_SYNCHRONIZED_SCENE(iLocal_236[i], Global_98143, &uLocal_344, &uLocal_393[i], 1000f, blendOut, flags, ragdollBlockingFlags, moverBlendDelta, ikFlags);
					iLocal_239[i] = 0;
				}
			}
			...
			for (i = 0; i < iLocal_252; i = i + 1)
			{
				if (ENTITY::DOES_ENTITY_EXIST(iLocal_252[i]))
					if (!MISC::IS_STRING_NULL_OR_EMPTY(&uLocal_558[i]))
						ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_252[i], Global_98143, &uLocal_558[i], &uLocal_344, 8f, -1000f, 0, 1148846080);
			}
...
BOOL func_38() // Position - 0x1C61
{
	...
	if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(Global_98142))
	{
		...
		{
			if (!PED::IS_PED_INJURED(iLocal_236[i]))
				TASK::TASK_SYNCHRONIZED_SCENE(iLocal_236[i], Global_98142, &uLocal_344, &uLocal_360[i], 8f, -1000f, 0, 0, 1148846080, 0);
		}
	
		for (i = 0; i < iLocal_252; i = i + 1)
		{
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_252[i]))
				if (!MISC::IS_STRING_NULL_OR_EMPTY(&uLocal_525[i]))
					ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_252[i], Global_98142, &uLocal_525[i], &uLocal_344, 8f, -1000f, 0, 1148846080);
		}
...
int func_39(int iParam0, Entity eParam1) // Position - 0x1D5D
{
	Vector3 entityCoords;
	float unk;
	...
	if (!STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS())
	{
		...
		else if (eParam1 == func_40(Global_100554) && eParam1 != 0)
		{
			Global_100554 = 0;
		}
	}
...
Entity func_40(var uParam0) // Position - 0x1E41
{
	return uParam0;
}

BOOL func_41(int iParam0, int iParam1) // Position - 0x1E4B
{
	return iParam0 && iParam1 != false;
}
...
void func_47() // Position - 0x1F0D
{
	...
	while (!flag && num < 400)
	{
		...
		for (i = 0; i < iLocal_242; i = i + 1)
		{
			...
			if (!MISC::IS_STRING_NULL_OR_EMPTY(&uLocal_690[i]))
			{
				STREAMING::REQUEST_CLIP_SET(&uLocal_690[i]);
			
				if (!STREAMING::HAS_CLIP_SET_LOADED(&uLocal_690[i]))
					flag = false;
			}
		}
	...
	for (i = 0; i < iLocal_236; i = i + 1)
	{
		if (iLocal_242[i] != 0)
		{
			iLocal_236[i] = PED::CREATE_PED(PED_TYPE_MISSION, iLocal_242[i], uLocal_272 + uLocal_276[i], 0, true, true);
			...
			TASK::TASK_PLAY_ANIM(iLocal_236[i], &uLocal_344, &uLocal_360[i], 8f, -8f, -1, 1, 0f, false, false, false);
		}
	}
	...
	for (i = 0; i < iLocal_252; i = i + 1)
	{
		if (iLocal_255[i] != 0)
		{
			iLocal_252[i] = OBJECT::CREATE_OBJECT(iLocal_255[i], uLocal_272 + uLocal_276[i] + uLocal_258[i], true, true, false);
			ENTITY::SET_ENTITY_ROTATION(iLocal_252[i], { fLocal_275 + uLocal_290[i], 0f, 0f } + uLocal_265[i], 2, true);
		
			if (!MISC::IS_STRING_NULL_OR_EMPTY(&uLocal_525[i]))
				ENTITY::PLAY_ENTITY_ANIM(iLocal_252[i], &uLocal_525[i], &uLocal_344, 8f, true, false, false, 0, 0);
		}
	}
...
void func_48() // Position - 0x216D
{
	...
	TEXT_LABEL_ASSIGN_STRING(&uLocal_690[0], "", 64);
	TEXT_LABEL_ASSIGN_STRING(&uLocal_690[1], "", 64);
	iLocal_255[0] = 0;
	iLocal_255[1] = 0;
	...
	switch (iLocal_69)
	{
		case 237:
			...
			TEXT_LABEL_ASSIGN_STRING(&uLocal_360[0], "LOOP_STRIPPER_01", 64);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_393[0], "EXIT_STRIPPER_01", 64);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_426[0], "", 64);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_360[1], "LOOP_STRIPPER_02", 64);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_393[1], "EXIT_STRIPPER_02", 64);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_426[1], "", 64);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_724, "TRVS_IG_35", 16);
			fLocal_728 = 0.15f;
			uLocal_276[0] = { MISC::GET_RANDOM_FLOAT_IN_RANGE(-10f, 10f), MISC::GET_RANDOM_FLOAT_IN_RANGE(-10f, 10f), 0f };
			uLocal_276[1] = { MISC::GET_RANDOM_FLOAT_IN_RANGE(-10f, 10f), MISC::GET_RANDOM_FLOAT_IN_RANGE(-10f, 10f), 0f };
			uLocal_283[0] = { 8.2284f, -35.8652f, -1.0334f };
			uLocal_283[1] = { 28.4066f, -23.8848f, -0.7887f };
		...
		case 235:
			...
			TEXT_LABEL_ASSIGN_STRING(&uLocal_360[0], "001443_01_TRVS_28_IDLE_STRIPPER", 64);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_393[0], "001443_01_TRVS_28_EXIT_STRIPPER", 64);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_426[0], "001443_01_TRVS_28_IDLE_STRIPPER", 64);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_360[1], "001443_01_TRVS_28_IDLE_MAN", 64);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_393[1], "001443_01_TRVS_28_EXIT_MAN", 64);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_426[1], "001443_01_TRVS_28_IDLE_MAN", 64);
			uLocal_276[0] = { -1.5421f, 0.8274f, -1.0288f };
			uLocal_276[1] = { -0.9636f, 1.1757f, -1.0243f };
			uLocal_283[0] = { 0f, 0f, 0f };
			uLocal_283[1] = { 0f, 0f, 0f };
			uLocal_290[0] = -130f;
			uLocal_290[1] = -130f;
			uLocal_293[0] = 0f;
			uLocal_293[1] = 0f;
		...
		case 247:
			...
			TEXT_LABEL_ASSIGN_STRING(&uLocal_360[0], "trev_annoys_sunbathers_loop_girl", 64);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_393[0], "trev_annoys_sunbathers_exit_girl", 64);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_426[0], "", 64);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_690[0], "move_f@scared", 64);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_360[1], "trev_annoys_sunbathers_loop_guy", 64);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_393[1], "trev_annoys_sunbathers_exit_guy", 64);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_426[1], "", 64);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_690[1], "move_m@hurry_Butch@A", 64);
			uLocal_276[0] = { -0.3866f, 0.1726f, 1f };
			uLocal_276[1] = { -0.0726f, -0.4742f, 1f };
			uLocal_283[0] = { { 1.5806f, -1719.6064f, -1291.4749f } - uLocal_272 };
			uLocal_283[1] = { uLocal_283[0] };
			uLocal_290[0] = 0f;
			uLocal_290[1] = 0f;
			uLocal_293[0] = 20f;
			...
			uLocal_258[0] = { 0f, 0f, -1f };
			uLocal_265[0] = { 0f, 0f, 2.16f };
			iLocal_255[1] = joaat("prop_cs_beachtowel_01");
			uLocal_258[1] = { 0f, 0f, -1f };
			uLocal_265[1] = { 0f, 0f, -4.32f };
			break;
	
		case 286:
			TEXT_LABEL_ASSIGN_STRING(&uLocal_344, "SWITCH@TREVOR@RUDE_AT_CAFE", 64);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_360[0], "001218_03_TRVS_23_RUDE_AT_CAFE_IDLE_FEMALE", 64);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_393[0], "001218_03_TRVS_23_RUDE_AT_CAFE_EXIT_FEMALE", 64);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_426[0], "", 64);
			uLocal_276[0] = { 4.261f, -2.388f, 0.5f };
			uLocal_283[0] = { 10.5918f, -34.5146f, 0f };
			uLocal_290[0] = 57.695f;
			uLocal_293[0] = 30f;
			iLocal_242[0] = joaat("A_F_Y_Hipster_03");
			uLocal_245[0] = -1;
			TEXT_LABEL_ASSIGN_STRING(&uLocal_360[1], "", 64);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_393[1], "", 64);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_426[1], "", 64);
			uLocal_283[1] = { 0f, 0f, 0f };
			uLocal_293[1] = 0f;
			iLocal_242[1] = 0;
		...
		case 263:
			...
			TEXT_LABEL_ASSIGN_STRING(&uLocal_360[0], "trev_scares_tramp_idle_tramp", 64);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_393[0], "trev_scares_tramp_exit_tramp", 64);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_426[0], "", 64);
			uLocal_276[0] = { 2.0921f, -1.5872f, 0f };
			uLocal_283[0] = { { 10.9545f, -1419.5369f, -605.8271f } - uLocal_272 };
			uLocal_290[0] = MISC::GET_RANDOM_FLOAT_IN_RANGE(-180f, 180f);
			uLocal_293[0] = 40f;
		...
		case 244:
			...
			TEXT_LABEL_ASSIGN_STRING(&uLocal_360[0], "LOOP_Ped", 64);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_393[0], "EXIT_Ped", 64);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_426[0], "", 64);
			uLocal_276[0] = { MISC::GET_RANDOM_FLOAT_IN_RANGE(-5f, 5f), MISC::GET_RANDOM_FLOAT_IN_RANGE(-5f, 5f), 0f };
			uLocal_283[0] = { { 28.2925f, -1451.7279f, 507.6885f } - uLocal_272 };
			uLocal_290[0] = MISC::GET_RANDOM_FLOAT_IN_RANGE(-180f, 180f);
			uLocal_293[0] = 40f;
		...
		case 288:
			...
			TEXT_LABEL_ASSIGN_STRING(&uLocal_360[0], "LOOP_Ped", 64);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_393[0], "EXIT_Ped", 64);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_426[0], "EXIT_LOOP_Ped", 64);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_459[0], "DEATH_Ped", 64);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_492[0], "DEATH_LOOP_Ped", 64);
			uLocal_276[0] = { MISC::GET_RANDOM_FLOAT_IN_RANGE(-10f, 10f), MISC::GET_RANDOM_FLOAT_IN_RANGE(-10f, 10f), 0f };
			uLocal_283[0] = { 0f, 0f, 0f };
			uLocal_290[0] = MISC::GET_RANDOM_FLOAT_IN_RANGE(-180f, 180f);
			uLocal_293[0] = 0f;
			...
			uLocal_258[0] = { 0f, 0f, 0f };
			TEXT_LABEL_ASSIGN_STRING(&uLocal_525[0], "LOOP_Rope", 64);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_558[0], "EXIT_Rope", 64);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_591[0], "EXIT_LOOP_Rope", 64);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_624[0], "DEATH_Rope", 64);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_657[0], "DEATH_LOOP_Rope", 64);
			iLocal_255[1] = joaat("prop_rolled_sock_01");
			uLocal_258[1] = { 0f, 0f, 0f };
			TEXT_LABEL_ASSIGN_STRING(&uLocal_525[1], "LOOP_Sock", 64);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_558[1], "EXIT_Sock", 64);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_591[1], "EXIT_LOOP_Sock", 64);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_624[1], "DEATH_Sock", 64);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_657[1], "DEATH_LOOP_Sock", 64);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_360[1], "", 64);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_393[1], "", 64);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_426[1], "", 64);
			uLocal_283[1] = { 0f, 0f, 0f };
		...
		default:
			...
			TEXT_LABEL_ASSIGN_STRING(&uLocal_360[0], "", 64);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_393[0], "", 64);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_426[0], "", 64);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_360[1], "", 64);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_393[1], "", 64);
			TEXT_LABEL_ASSIGN_STRING(&uLocal_426[1], "", 64);
...
BOOL func_53(int iParam0, var uParam1, char* sParam2) // Position - 0x441F
{
	var unk;
	int unk2;
	var unk3;
	...
	switch (iParam0)
	{
		...
		case 5:
			*uParam1 = G_MissionStats.f_2366.f_539.f_2310[0];
			TEXT_LABEL_ASSIGN_STRING(sParam2, func_57(G_MissionStats.f_2366.f_539.f_2314[0]), 32);
			return true;
	
		case 6:
			*uParam1 = G_MissionStats.f_2366.f_539.f_2310[1];
			TEXT_LABEL_ASSIGN_STRING(sParam2, func_57(G_MissionStats.f_2366.f_539.f_2314[1]), 32);
			return true;
	
		case 7:
			*uParam1 = G_MissionStats.f_2366.f_539.f_2310[2];
			TEXT_LABEL_ASSIGN_STRING(sParam2, func_57(G_MissionStats.f_2366.f_539.f_2314[2]), 32);
			return true;
...
BOOL func_54(int iParam0, int iParam1, var uParam2, var uParam3) // Position - 0x682B
{
	switch (iParam1)
	{
		case 0:
...
BOOL _GET_RANDOM_BOOL() // Position - 0x877B
{
...
BOOL func_56(int iParam0, var uParam1, var uParam2) // Position - 0x8799
{
	switch (iParam0)
	{
		case 11:
