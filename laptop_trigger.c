...
void main() // Position - 0x0
{
	...
	iLocal_111 = -1;
	uLocal_125 = Vector3(0f, 0f, 0f);
	obLocal_122 = obScriptParam_135;
	...
	while (flag2)
	{
		if (ENTITY::DOES_ENTITY_EXIST(obLocal_122))
		{
			...
			if (Global_1853760)
			{
				if (!flag)
				{
					...
					{
						ENTITY::CREATE_MODEL_HIDE(ENTITY::GET_ENTITY_COORDS(obScriptParam_135, true), 1f, joaat("prop_laptop_01a"), false);
						entityRotation = Vector3(ENTITY::GET_ENTITY_ROTATION(obLocal_122, 2));
		...
		if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false) && ENTITY::DOES_ENTITY_EXIST(obLocal_122) && !CUTSCENE::IS_CUTSCENE_PLAYING() && PLAYER::IS_PLAYER_PLAYING(PLAYER::GET_PLAYER_INDEX()))
		{
			if (INTERIOR::GET_INTERIOR_FROM_ENTITY(PLAYER::PLAYER_PED_ID()) == INTERIOR::GET_INTERIOR_FROM_ENTITY(obLocal_122))
			{
				...
				vector2 = Vector3(0.6f, 0.6f, 0.8f);
			
				if (func_231() || func_230(PLAYER::PLAYER_ID()) || func_240(PLAYER::PLAYER_ID()) || func_229())
					vector2 = Vector3(1f, 1f, 0.9f);
				else if (func_228())
					vector2 = Vector3(0.75f, 0.55f, 1.25f);
				...
				else
				{
					...
					if (ENTITY::DOES_ENTITY_EXIST(obScriptParam_135))
						if (func_1())
							flag2 = false;
				}
			}
	...
	if (ENTITY::DOES_ENTITY_EXIST(obLocal_122))
	{
		...
		if (func_3(entityModel))
		{
			if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(PLAYER::PLAYER_PED_ID()))
			{
				...
				entityCoords2 = Vector3(ENTITY::GET_ENTITY_COORDS(obLocal_122, true));
	...
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2657589[plParam0].f_321.f_7 != -1)
				return func_9(Global_2657589[plParam0].f_321.f_7) == 13;
...
{
	if (!_IS_FMMC_ACTIVE() && !func_24() && Global_2684800)
				...
				if (iParam0 == Global_8260[num].f_11)
				{
					if (i == Global_8260[num].f_4)
					{
						if (Global_8822[i] == 0)
						{
							...
							if (Global_2694521)
								if (num == 14)
									func_41(Global_20364, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(i), SYSTEM::TO_FLOAT(Global_8260[num].f_10), SYSTEM::TO_FLOAT(Global_22788), -1f, &Global_8260[num], 0, 0, 0, 0);
					...
					if (i == Global_8260[num].f_4)
					{
						if (Global_8822[i] == 0)
						{
							...
							if (num == 1)
							{
								...
								func_41(Global_20364, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(i), SYSTEM::TO_FLOAT(Global_8260[num].f_10), SYSTEM::TO_FLOAT(Global_22793), -1f, &Global_8260[num], 0, 0, 0, 0);
							}
							else if (num == 7)
							{
								if (Global_78558)
								{
									...
									func_41(Global_20364, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(i), SYSTEM::TO_FLOAT(Global_8260[num].f_10), SYSTEM::TO_FLOAT(value2), -1f, &Global_8260[num], 0, 0, 0, 0);
								}
								else
								{
									switch (Global_20383)
									...
									func_41(Global_20364, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(i), SYSTEM::TO_FLOAT(Global_8260[num].f_10), SYSTEM::TO_FLOAT(value3), -1f, &Global_8260[num], 0, 0, 0, 0);
								}
							}
							else if (num == 14)
							{
							...
							else if (Global_8260[num].f_10 == 57 && num == 23)
							{
								...
								func_41(Global_20364, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(i), SYSTEM::TO_FLOAT(Global_8260[num].f_10), SYSTEM::TO_FLOAT(value6), -1f, &Global_8260[num], 0, 0, 0, 0);
							}
							else
							{
								func_41(Global_20364, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(i), SYSTEM::TO_FLOAT(Global_8260[num].f_10), SYSTEM::TO_FLOAT(0), -1f, &Global_8260[num], 0, 0, 0, 0);
							}
...
void func_41(int iParam0, char* sParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6, const char* sParam7, const char* sParam8, const char* sParam9, const char* sParam10, const char* sParam11) // Position - 0x2139
{
...
void func_43(int iParam0, char* sParam1, float fParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x21FE
{
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iParam0, sParam1);
	GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(SYSTEM::ROUND(fParam2));
...
void func_47() // Position - 0x231E
{
	...
	while (num3 < num2)
	{
		if (!func_48(Global_113648.f_14143[num3].f_18, Global_113648.f_14143[Global_22792].f_18))
			Global_22792 = num3;
...
int func_49() // Position - 0x24D4
{
	...
	while (i < num2)
	{
		if (Global_113648.f_14143[i].f_24 == 0 || Global_113648.f_14143[i].f_24 == 1)
			if (!func_48(Global_113648.f_14143[i].f_18, Global_113648.f_14143[Global_22792].f_18))
				Global_22792 = i;
...
BOOL func_86() // Position - 0x2F94
{
	...
	for (i = 0; i < 7; i = i + 1)
	{
		if (Global_1894573[PLAYER::PLAYER_ID()].f_10.f_11[i] == _INVALID_PLAYER_INDEX())
		{
			...
			string1 = Vector3(func_87(func_88(i)));
...
void func_89(struct<14> Param0, int iParam1) // Position - 0x305C
{
	Param0 = 2041805809;
...
void func_93() // Position - 0x313A
{
	...
	unk = Vector3(func_107(65, 67, -1));
	num = 0;

	if (func_85(true))
	{
		unk = Vector3(func_107(47, 48, -1));
		num = 1;
	}
	...
	if (!IS_XBOX_PLATFORM() && NETWORK::NETWORK_CHECK_USER_CONTENT_PRIVILEGES(0, -1, true) || func_96())
		func_95(28);
	else
		func_94(28);
...
BOOL IS_PLAYSTATION_PLATFORM() // Position - 0x3257
{
	return MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION();
}

BOOL IS_XBOX_PLATFORM() // Position - 0x326D
{
...
void func_102(int iParam0, int iParam1, const char* sParam2, int iParam3, BOOL bParam4) // Position - 0x3439
{
	...
	if (func_104())
	{
		statName = Global_2849801[iParam0][func_103(iParam3)];
		statName2 = Global_2849801[iParam1][func_103(iParam3)];
...
struct<16> func_107(int iParam0, int iParam1, int iParam2) // Position - 0x355B
{
	...
	statHash = Global_2849801[iParam0][func_103(iParam2)];
	statHash2 = Global_2849801[iParam1][func_103(iParam2)];
...
void func_108() // Position - 0x35A8
{
	...
	for (i = 0; i <= 3; i = i + 1)
	{
		if (Global_2672505.f_2514[i].f_2 != 0)
		{
			...
			func_109(&(Global_2672505.f_2514[i].f_69), 1);
		}
	}
...
void func_112(BOOL bParam0, BOOL bParam1, int iParam2) // Position - 0x362B
{
	...
	if (Global_1894573[PLAYER::PLAYER_ID()].f_10 != PLAYER::PLAYER_ID())
	{
		...
		if (iParam2 == 1)
			STATS::PLAYSTATS_CHANGE_MC_ROLE(func_116(_GET_BOSS_OF_LOCAL_PLAYER()), func_115(_GET_BOSS_OF_LOCAL_PLAYER()), func_114(), func_113(), Global_1894573[PLAYER::PLAYER_ID()].f_10.f_429, 4, Global_1894573[PLAYER::PLAYER_ID()].f_10.f_467);
	}
...
void func_148(int iParam0) // Position - 0x4360
{
	...
	if (_MPCHAR_STAT_GET_INT(MP_STAT_BOSS_END_TIME, -1, 0) != func_149(PLAYER::PLAYER_ID()))
		_MPCHAR_STAT_SET_INT(MP_STAT_BOSS_END_TIME, func_149(PLAYER::PLAYER_ID()), -1, true, false);
...
void func_156(int iParam0, BOOL bParam1, int iParam2, BOOL bParam3) // Position - 0x44A9
{
	...
	if (func_104())
	{
		statName = Global_2848282[iParam0][func_103(iParam2)];
...
void func_170() // Position - 0x46B3
{
	...
	{
		WEAPON::SET_CURRENT_PED_WEAPON(PLAYER::PLAYER_PED_ID(), joaat("WEAPON_UNARMED"), true);
		offsetFromEntityInWorldCoords = Vector3(ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(obLocal_122, 0.0328f, -0.8f, 0.3f));
		flag = false;
		_STOPWATCH_DESTROY(&uLocal_118);
...
int func_193(Player plParam0) // Position - 0x52B3
{
	if (func_207(plParam0))
		return func_194(Global_2657589[plParam0].f_321.f_7);
...
{
	if (func_208(Global_1853910[plParam0].f_267.f_33, -1))
		return 1;
	...
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2657589[plParam0].f_321.f_7 != -1 && Global_2657589[plParam0].f_321.f_10 != _INVALID_PLAYER_INDEX())
				return func_9(Global_2657589[plParam0].f_321.f_7) == 25;
...
{
	if (func_208(Global_1853910[plParam0].f_267.f_33, -1) && !IS_BIT_SET(Global_1853910[plParam0].f_267.f_31, 1))
		return 1;
...
BOOL func_207(Player plParam0) // Position - 0x59A4
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2657589[plParam0].f_321.f_7 != -1)
				return func_9(Global_2657589[plParam0].f_321.f_7) == 1;
...
BOOL func_240(Player plParam0) // Position - 0x60DC
{
	...
	if (plParam0 != _INVALID_PLAYER_INDEX())
	{
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
		{
			if (Global_2657589[plParam0].f_321.f_7 != -1)
			{
				num = func_9(Global_2657589[plParam0].f_321.f_7);
				return num == 2 || num == 25;
			}
		}
	}
...
BOOL func_241(Player plParam0) // Position - 0x6131
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2657589[plParam0].f_321.f_7 != -1)
				return func_9(Global_2657589[plParam0].f_321.f_7) == 0;
