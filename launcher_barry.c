...
void main() // Position - 0x0
{
	...
	func_317(&num);
	vector = Vector3(uScriptParam_272.f_1[0]);
	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (num != -1)
		{
			if (Global_112735[num].f_9 != -1)
			{
				...
				func_315(&(Global_112735[num].f_9));
			}
		}
...
BOOL IS_PLAYSTATION_PLATFORM() // Position - 0x8D8A
{
	return MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION();
}

BOOL IS_XBOX_PLATFORM() // Position - 0x8DA0
{
	return MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION();
}

void func_112(char* sParam0, Any anParam1, int iParam2) // Position - 0x8DB6
{
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					...
					case 1:
						if (PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_191() || Global_32166 || func_190() || func_189(8, -1) || func_187() || func_96() || func_188() || func_186() || G_SomeGlobalState.MessageCallStates.f_919[character] == 5)
							return false;
						break;
					...
					case 4:
						if (func_191() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0 || func_189(8, -1) || func_186() || func_185() || G_SomeGlobalState.MessageCallStates.f_919[character] == 5)
							return false;
						break;
					...
					case 7:
						if (PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || !CAM::IS_SCREEN_FADED_IN() || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_191() || func_188() || Global_112695 || Global_32166 || func_190() || Global_44446 || func_189(8, -1) || func_187() || func_185() || func_186() || G_SomeGlobalState.MessageCallStates.f_919[character] == 5)
							return false;
						break;
...
BOOL func_233(Ped pedParam0, Ped pedParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xEE83
{
	...
	flag = func_234(&iLocal_37[num], pedBoneCoords, pedParam1, &(iLocal_37[num].f_3), pedParam0, iParam5);
...
BOOL func_234(var uParam0, Vector3 vParam1, var uParam2, var uParam3, Ped pedParam4, var uParam5, Ped pedParam6, int iParam7) // Position - 0xEF44
{
	...
	if (*uParam0 == 0)
	{
		endCoords = Vector3(func_235(pedParam4, iParam7));
...
BOOL func_237(Ped pedParam0, Ped pedParam1, int iParam2, int iParam3) // Position - 0xF17F
{
	...
	unk = Vector3(func_239(ENTITY::GET_ENTITY_COORDS(pedParam1, true) - ENTITY::GET_ENTITY_COORDS(pedParam0, true)));
	...
	if (iParam3 == 0)
		...
		entityForwardVector = Vector3(func_239(PED::GET_PED_BONE_COORDS(pedParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(pedParam0, 31086, 0f, 0f, 0f)));
...
BOOL func_246(Ped pedParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0xF58E
{
	...
	unk = Vector3(func_239(uParam1 - ENTITY::GET_ENTITY_COORDS(pedParam0, true)));
...
void func_257() // Position - 0xF8F9
{
	...
	unk = Vector3(190.2424f, -956.479f, 29.08f);
	num = 12f;
...
BOOL func_267(var uParam0) // Position - 0xFC8F
{
	...
	num = 3;
	unk4 = Vector3(-468.9f, -1713.06f, 18.21f);
	unk7 = Vector3(-426.56f, -1717.89f, 18.2f);
	vector = Vector3(-0.1f, -0.85f, 0.23f);
	vector2 = Vector3(8f, 0.5f, 0f);
	num2 = -76.2f;
	num3 = 43.5f;
	...
	switch (iLocal_91)
	{
		case 0:
			uParam0->f_16 = 5;
			uParam0->f_17[0] = Vector3(-480.99292f, -1712.6495f, 17.452402f);
			uParam0->f_17[1] = Vector3(-443.61295f, -1705.8864f, 27.622137f);
			uParam0->f_24 = 31f;
			uParam0->f_27 = 1;
			uParam0->f_26 = 1;
...
BOOL func_272(var uParam0) // Position - 0x1004C
{
	...
	num = 4;
	unk5 = Vector3(1199.8f, -1259.22f, 34.23f);
	vector = Vector3(0f, -1f, 0.64f);
	unk10 = Vector3(1195.3f, -1312.74f, 34.75f);
	num2 = 174.7f;
	num3 = 282.4f;
	num[0] = joaat("dloader");
	...
	switch (iLocal_91)
	{
		case 0:
			uParam0->f_16 = 5;
			uParam0->f_17[0] = Vector3(1198.3666f, -1326.095f, 33.968296f);
			uParam0->f_17[1] = Vector3(1202.2368f, -1235.3735f, 43.976414f);
			uParam0->f_24 = 31f;
			uParam0->f_27 = 1;
			uParam0->f_26 = 1;
...
BOOL func_275(var uParam0) // Position - 0x103FE
{
	...
	switch (iLocal_91)
	{
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_41[0]))
			{
				func_268(&uParam0->f_41[0], num[1], unk3 + Vector3(0f, 0f, 5f), -115.18f);
...
BOOL func_281(var uParam0) // Position - 0x1078C
{
	...
	num = 5;
	vector = Vector3(190.2424f, -956.479f, 29.08f);
	heading = 69.171f;
	num[0] = iLocal_92;
	...
	switch (iLocal_91)
	{
		case 0:
			...
			uParam0->f_25 = 1;
			uParam0->f_27 = 0;
			uParam0->f_17[0] = Vector3(190.03151f, -956.3355f, 29.091919f);
			uParam0->f_17[1] = Vector3(178.04579f, -950.6594f, 31.093576f);
			uParam0->f_24 = 23f;
...
void func_282(Object* pobParam0, Hash hParam1) // Position - 0x10B2B
{
	...
	unk = Vector3(192.4462f, -953.5946f, 29.0919f);
	num = 23.45f;
...
BOOL func_284(var uParam0) // Position - 0x10B6B
{
	...
	num = 7;
	vector = Vector3(190.2424f, -956.379f, 28.63f);
