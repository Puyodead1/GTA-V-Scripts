	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (num != -1)
		{
			if (Global_112897[num].f_9 != -1)
			{
				...
				func_320(&(Global_112897[num].f_9));
			}
		}
...
BOOL func_168(int iParam0) // Position - 0xB866
{
	...
	num = func_170(&(Global_112897[iParam0].f_9), 1, 4, false, 0);
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					...
					case 1:
						if (PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_196() || Global_32286 || func_195() || func_194(8, -1) || func_192() || func_100() || func_193() || func_191() || G_MissionStats.f_7691.f_919[character] == 5)
							return false;
						break;
				
					case 2:
						if (!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_196() || Global_112857 || Global_32286 || func_195() || func_194(8, -1) || func_192() || func_100() || func_193() || func_191() || G_MissionStats.f_7691.f_919[character] == 5 || Global_43924 != -1)
							return false;
						break;
				
					case 3:
						if (PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_196() || Global_112857 || Global_32286 || func_195() || func_194(8, -1) || func_100() || func_193() || func_191() || G_MissionStats.f_7691.f_919[character] == 5)
							return false;
						break;
				
					case 4:
						if (func_196() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0 || func_194(8, -1) || func_191() || func_190() || G_MissionStats.f_7691.f_919[character] == 5)
							return false;
						break;
					...
					case 7:
						if (PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || !CAM::IS_SCREEN_FADED_IN() || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_196() || func_193() || Global_112857 || Global_32286 || func_195() || Global_44569 || func_194(8, -1) || func_192() || func_190() || func_191() || G_MissionStats.f_7691.f_919[character] == 5)
							return false;
						break;
...
BOOL func_272(var uParam0) // Position - 0xFD76
{
	...
	switch (iLocal_89)
	{
		case 0:
			uParam0->f_16 = 5;
			uParam0->f_17[0] = { -480.99292f, -1712.6495f, 17.452402f };
			uParam0->f_17[1] = { -443.61295f, -1705.8864f, 27.622137f };
			uParam0->f_24 = 31f;
			uParam0->f_27 = 1;
			uParam0->f_26 = 1;
...
BOOL func_277(var uParam0) // Position - 0x10136
{
	...
	switch (iLocal_89)
	{
		case 0:
			uParam0->f_16 = 5;
			uParam0->f_17[0] = { 1198.3666f, -1326.095f, 33.968296f };
			uParam0->f_17[1] = { 1202.2368f, -1235.3735f, 43.976414f };
			uParam0->f_24 = 31f;
			uParam0->f_27 = 1;
			uParam0->f_26 = 1;
...
BOOL func_286(var uParam0) // Position - 0x10876
{
	...
	switch (iLocal_89)
	{
		case 0:
			...
			uParam0->f_25 = 1;
			uParam0->f_27 = 0;
			uParam0->f_17[0] = { 190.03151f, -956.3355f, 29.091919f };
			uParam0->f_17[1] = { 178.04579f, -950.6594f, 31.093576f };
			uParam0->f_24 = 23f;
