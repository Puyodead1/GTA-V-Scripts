...
int func_63(Player plParam0, BOOL bParam1, int iParam2, BOOL bParam3) // Position - 0x1C98
{
	...
	{
		if (iParam2 > -1)
			if (func_68(playerTeam, iParam2, 0, -1) && !IS_BIT_SET(Global_4718592.missionGenMenubs5, 18))
...
int func_78(Player plParam0, Player plParam1, int iParam2, BOOL bParam3, BOOL bParam4) // Position - 0x2563
{
	...
	if (!flag)
	{
		if (playerTeam != -1)
		{
			...
			if (func_80(plParam1, plParam0, playerTeam, 0) && !IS_BIT_SET(Global_4718592.missionGenMenubs5, 18) || func_68(PLAYER::GET_PLAYER_TEAM(plParam1), PLAYER::GET_PLAYER_TEAM(plParam0), 0, -1) && IS_BIT_SET(Global_4718592.missionGenMenubs5, 23) && !IS_BIT_SET(Global_4718592.missionGenMenubs5, 18))
				return func_67(true);
...
int func_96(int iParam0, Player plParam1, BOOL bParam2) // Position - 0x2A4E
{
	...
	if (iParam0 > -1 && plParam1 != _INVALID_PLAYER_INDEX())
	{
		...
		if (IS_BIT_SET(Global_4718592.missionGenMenubs5, 26) && !func_68(iParam0, PLAYER::GET_PLAYER_TEAM(plParam1), 0, -1))
			num = func_79(true);
	}
	else
	{
