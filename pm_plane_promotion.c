...
void func_82(int iParam0, Vehicle veParam1, int iParam2) // Position - 0x3CDB
{
	...
	if (!func_114(&Global_77348.f_555[0], iParam0))
		return;
...
BOOL IS_PLAYSTATION_PLATFORM() // Position - 0x7B19
{
	return MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION();
}

BOOL IS_XBOX_PLATFORM() // Position - 0x7B2F
{
...
BOOL func_114(var uParam0, int iParam1) // Position - 0x8247
{
	...
	*uParam0 = { 0f, 0f, 0f };
	...
	if (IS_BIT_SET(uParam0->f_9, 10))
	{
		...
		if (!func_124(Global_113648.f_32751.f_1864[uParam0->f_14], 0f, 0f, 0f, false))
	...
	{
		if (!func_124(Global_113648.f_2365.f_539.f_3588[1][uParam0->f_12], 0f, 0f, 0f, false))
		{
	...
	{
		if (!func_124(Global_113648.f_2365.f_539.f_3588[0][uParam0->f_12], 0f, 0f, 0f, false))
		{
...
void func_117(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, float fParam5, int iParam6) // Position - 0x9BD3
{
	if (func_114(&Global_77348.f_555[0], iParam0))
	{
		...
		{
			func_122(iParam0);
			func_121(uParam1, &Global_113648.f_32751.f_69[Global_77348.f_555[0].f_14]);
...
void func_145() // Position - 0xAA91
{
	...
	iLocal_242[0] = { -1039.556f, -1071.2635f, 150f };
	iLocal_242[0].f_3 = 200f;
	iLocal_242[1] = { -1014.9763f, 450.128f, 150f };
	iLocal_242[1].f_3 = 200f;
	iLocal_242[2] = { -598.1714f, -310.67f, 150f };
	iLocal_242[2].f_3 = 200f;
	iLocal_242[3] = { -392.5704f, 514.8138f, 150f };
	iLocal_242[3].f_3 = 200f;
	iLocal_242[4] = { 127.7632f, -135.7758f, 150f };
	iLocal_242[4].f_3 = 200f;
	iLocal_242[5] = { 1033.4686f, -570.8278f, 150f };
	iLocal_242[5].f_3 = 200f;
	iLocal_242[6] = { 246.5894f, -890.811f, 150f };
	iLocal_242[6].f_3 = 200f;
	iLocal_242[7] = { 1231.3933f, -1694.3479f, 150f };
	iLocal_242[7].f_3 = 200f;
	iLocal_242[8] = { 424.9531f, -1904.325f, 150f };
	iLocal_242[8].f_3 = 200f;
	iLocal_242[9] = { -22.4342f, -1414.275f, 160f };
	iLocal_242[9].f_3 = 200f;

	for (i = 0; i <= 9; i = i + 1)
	{
		if (!_IS_NULL_VECTOR(iLocal_242[i]))
		{
			groundZ = 0f;
			MISC::GET_GROUND_Z_FOR_3D_COORD(iLocal_242[i], &groundZ, false, false);
			iLocal_242[i].f_2 = groundZ;
		}
	}
...
void func_150() // Position - 0xADA3
{
	...
	if (HUD::DOES_BLIP_EXIST(iLocal_242[0].f_4))
		HUD::REMOVE_BLIP(&(iLocal_242[0].f_4));

	if (HUD::DOES_BLIP_EXIST(iLocal_242[0].f_5))
		HUD::REMOVE_BLIP(&(iLocal_242[0].f_5));

	if (HUD::DOES_BLIP_EXIST(iLocal_242[1].f_4))
		HUD::REMOVE_BLIP(&(iLocal_242[1].f_4));

	if (HUD::DOES_BLIP_EXIST(iLocal_242[1].f_5))
		HUD::REMOVE_BLIP(&(iLocal_242[1].f_5));
