...
void main() // Position - 0x0
{
	...
	iLocal_41 = 49;
	iLocal_42 = 64;
	uLocal_51 = Vector3(2194.1345f, 5593.2783f, 53.703827f);
	uLocal_73 = Vector3(2203.2703f, 5549.918f, 93.09485f);
	uLocal_76 = Vector3(2199.6294f, 5640.293f, 52.23926f);
	fLocal_79 = 81.5f;
	uLocal_48 = Vector3(uScriptParam_296.f_1[0]);
...
BOOL func_95() // Position - 0x3522
{
	...
	for (i = 0; i < iLocal_103; i = i + 1)
	{
		if (!PED::IS_PED_INJURED(iLocal_103[i]))
		{
			...
			if (MISC::IS_BULLET_IN_AREA(ENTITY::GET_ENTITY_COORDS(iLocal_103[i], true), 5f, true) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_103[i], PLAYER::PLAYER_PED_ID(), true) || ENTITY::IS_ENTITY_TOUCHING_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_103[i]) || MISC::IS_PROJECTILE_TYPE_IN_AREA(ENTITY::GET_ENTITY_COORDS(iLocal_103[i], true) - Vector3(15f, 15f, 15f), ENTITY::GET_ENTITY_COORDS(iLocal_103[i], true) + Vector3(15f, 15f, 15f), joaat("WEAPON_SMOKEGRENADE"), true) || MISC::IS_PROJECTILE_TYPE_IN_AREA(ENTITY::GET_ENTITY_COORDS(iLocal_103[i], true) - Vector3(15f, 15f, 15f), ENTITY::GET_ENTITY_COORDS(iLocal_103[i], true) + Vector3(15f, 15f, 15f), joaat("WEAPON_GRENADE"), true) || MISC::IS_PROJECTILE_TYPE_IN_AREA(ENTITY::GET_ENTITY_COORDS(iLocal_103[i], true) - Vector3(15f, 15f, 15f), ENTITY::GET_ENTITY_COORDS(iLocal_103[i], true) + Vector3(15f, 15f, 15f), joaat("WEAPON_GRENADELAUNCHER"), true) || MISC::IS_PROJECTILE_TYPE_IN_AREA(ENTITY::GET_ENTITY_COORDS(iLocal_103[i], true) - Vector3(15f, 15f, 15f), ENTITY::GET_ENTITY_COORDS(iLocal_103[i], true) + Vector3(15f, 15f, 15f), joaat("WEAPON_STICKYBOMB"), true))
				return true;
		}
	}
...
void func_96() // Position - 0x3795
{
	...
	{
		PED::ADD_SCENARIO_BLOCKING_AREA(uLocal_48 - Vector3(20f, 50f, 50f), uLocal_48 + Vector3(20f, 50f, 50f), false, true, true, true);
		...
		uLocal_54[0] = Vector3(2205.769f, 5631.985f, 55.553f);
		uLocal_80[0] = 352.2203f;
		uLocal_54[1] = Vector3(2210.5842f, 5580.6836f, 52.8132f);
		uLocal_80[1] = 300.5012f;
		uLocal_54[2] = Vector3(2201.3025f, 5589.2793f, 52.9354f);
		uLocal_80[2] = 53.1602f;
		uLocal_54[3] = Vector3(2202.5352f, 5613.3667f, 52.6781f);
		uLocal_80[3] = 70f;
		uLocal_54[4] = Vector3(2200.764f, 5614.076f, 52.6852f);
		uLocal_80[4] = 53f;
		uLocal_54[5] = Vector3(2193.714f, 5595.456f, 52.7615f);
		...
		for (iLocal_125 = 0; iLocal_125 < 6; iLocal_125 = iLocal_125 + 1)
		{
			iLocal_103[iLocal_125] = PED::CREATE_PED(PED_TYPE_MISSION, joaat("G_M_Y_SalvaGoon_01"), uLocal_54[iLocal_125], uLocal_80[iLocal_125], true, true);
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_134() || Global_112695 || Global_32166 || func_133() || func_88(8, -1) || func_132() || func_131() || func_130() || func_129() || G_SomeGlobalState.MessageCallStates.f_919[character] == 5)
							return false;
						break;
				
					case 1:
						if (PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_134() || Global_32166 || func_133() || func_88(8, -1) || func_130() || func_132() || func_131() || func_129() || G_SomeGlobalState.MessageCallStates.f_919[character] == 5)
							return false;
						break;
				
					case 2:
						if (!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_134() || Global_112695 || Global_32166 || func_133() || func_88(8, -1) || func_130() || func_132() || func_131() || func_129() || G_SomeGlobalState.MessageCallStates.f_919[character] == 5 || LastDispatchedMessageOrCall != -1)
							return false;
						break;
				
					case 3:
						if (PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_134() || Global_112695 || Global_32166 || func_133() || func_88(8, -1) || func_132() || func_131() || func_129() || G_SomeGlobalState.MessageCallStates.f_919[character] == 5)
							return false;
						break;
				
					case 4:
						if (func_134() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0 || func_88(8, -1) || func_129() || func_128() || G_SomeGlobalState.MessageCallStates.f_919[character] == 5)
							return false;
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
							if (PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0 || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || func_134() || Global_32166 || func_133() || func_88(8, -1) || func_131() || func_130() || func_129() || G_SomeGlobalState.MessageCallStates.f_919[character] == 5)
								return false;
						break;
				
					case 7:
						if (PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || !CAM::IS_SCREEN_FADED_IN() || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_134() || func_131() || Global_112695 || Global_32166 || func_133() || Global_44446 || func_88(8, -1) || func_130() || func_128() || func_129() || G_SomeGlobalState.MessageCallStates.f_919[character] == 5)
							return false;
						break;
