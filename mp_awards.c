...
void func_15(var uParam0) // Position - 0xED6
{
	...
	if (HUD::HAS_ADDITIONAL_TEXT_LOADED(8))
	{
		if (GRAPHICS::HAS_STREAMED_TEXTURE_DICT_LOADED("MPAwards1") && GRAPHICS::HAS_STREAMED_TEXTURE_DICT_LOADED("MPAwards2") && GRAPHICS::HAS_STREAMED_TEXTURE_DICT_LOADED("MPAwards3") && GRAPHICS::HAS_STREAMED_TEXTURE_DICT_LOADED("MPAwards4") && GRAPHICS::HAS_STREAMED_TEXTURE_DICT_LOADED("MPAwards5") && GRAPHICS::HAS_STREAMED_TEXTURE_DICT_LOADED("MPAwards6") && flag && flag2)
		{
			...
			func_25(16, "DLC222AWDPAGE" /*Los Santos Drug Wars*/, &Global_1653480);
	...
	if (*uParam0 == 0)
	{
		...
		for (i = 0; i <= 17; i = i + 1)
		{
			if (uParam0->f_1[i] == 1)
			{
				...
				if (uParam0->f_424)
					func_22(&uParam0->f_20[i]);
				else
					func_21(&uParam0->f_20[i]);
...
{
	TEXT_LABEL_ASSIGN_STRING(&uParam2->f_20[iParam0], sParam1, 64);
		...
		if (func_39(uParam0))
		{
			for (i = 0; i <= 11; i = i + 1)
			{
				...
				if (uParam0->f_1[i] == 1)
				{
					...
					GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(0);
					GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(1);
					func_22(&uParam0->f_14[i]);
					func_22(&uParam0->f_111[i]);
					func_21(&uParam0->f_331[i]);
					func_21(&uParam0->f_234[i]);
...
BOOL func_39(var uParam0) // Position - 0x48F4
{
	...
	for (i = 0; i <= 11; i = i + 1)
	{
		if (uParam0->f_1[i] == 1)
		{
			if (!MISC::IS_STRING_NULL_OR_EMPTY(&uParam0->f_331[i]))
			{
				GRAPHICS::REQUEST_STREAMED_TEXTURE_DICT(&uParam0->f_331[i], false);
			
				if (!GRAPHICS::HAS_STREAMED_TEXTURE_DICT_LOADED(&uParam0->f_331[i]))
					return false;
			}
		}
	}
...
void _MPCHAR_STAT_SET_INT(eMPStat empsParam0, int iParam1, int iParam2, BOOL bParam3, BOOL bParam4) // Position - 0x49D0
{
	...
	bParam4;
	statName = Global_2805029[empsParam0][func_45(iParam2)];
...
int func_48(int iParam0, int iParam1) // Position - 0x4A8F
{
	...
	statHash = Global_2850194[iParam0][func_45(iParam1)];
...
{
	TEXT_LABEL_ASSIGN_STRING(&uParam5->f_14[iParam0], sParam1, 32);
	TEXT_LABEL_ASSIGN_STRING(&uParam5->f_111[iParam0], sParam2, 32);
...
{
	TEXT_LABEL_ASSIGN_STRING(&uParam5->f_234[iParam0], sParam1, 32);
	TEXT_LABEL_ASSIGN_STRING(&uParam5->f_331[iParam0], sParam2, 32);
...
BOOL func_105(int iParam0, int iParam1) // Position - 0xB437
{
	...
	statHash = Global_2850651[iParam0][func_45(iParam1)];
