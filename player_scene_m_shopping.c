...
void func_52(int iParam0) // Position - 0x2F22
{
	...
	else if (IS_BIT_SET(G_MissionStats.f_20567.f_471, iParam0) || IS_BIT_SET(Global_2359296[func_54()].f_681.f_10, iParam0))
	{
		flag = true;
		MISC::CLEAR_BIT(&(G_MissionStats.f_20567.f_471), iParam0);
...
int func_90(eCharacter echParam0, char* sParam1, int iParam2, int iParam3, char* sParam4, char* sParam5, int iParam6, int iParam7, int iParam8, int iParam9, BOOL bParam10, int iParam11, int iParam12, int iParam13, char* sParam14, char* sParam15, int iParam16) // Position - 0x3B58
{
	...
	if (!Global_20705)
	{
		...
		{
			func_96(G_Scaleform, "SET_DATA_SLOT_EMPTY", 1f, -1082130432, -1082130432, -1082130432, -1082130432);
			func_93(1);
			func_96(G_Scaleform, "DISPLAY_VIEW", 1f, SYSTEM::TO_FLOAT(Global_20480), -1082130432, -1082130432, -1082130432);
		}
	}
				...
				if (iParam0 == Global_8377[num].f_11)
				{
					if (i == Global_8377[num].f_4)
					{
						if (Global_8939[i] == 0)
						{
							...
							if (Global_2694571)
								if (num == 14)
									func_94(G_Scaleform, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(i), SYSTEM::TO_FLOAT(Global_8377[num].f_10), SYSTEM::TO_FLOAT(Global_22908), -1f, &Global_8377[num], 0, 0, 0, 0);
					...
					if (i == Global_8377[num].f_4)
					{
						if (Global_8939[i] == 0)
						{
							...
							if (num == 1)
							{
								...
								func_94(G_Scaleform, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(i), SYSTEM::TO_FLOAT(Global_8377[num].f_10), SYSTEM::TO_FLOAT(Global_22913), -1f, &Global_8377[num], 0, 0, 0, 0);
							}
							else if (num == 7)
							{
								if (Global_78689)
								{
									...
									func_94(G_Scaleform, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(i), SYSTEM::TO_FLOAT(Global_8377[num].f_10), SYSTEM::TO_FLOAT(value2), -1f, &Global_8377[num], 0, 0, 0, 0);
								}
								else
								{
									switch (Global_20500)
									...
									func_94(G_Scaleform, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(i), SYSTEM::TO_FLOAT(Global_8377[num].f_10), SYSTEM::TO_FLOAT(value3), -1f, &Global_8377[num], 0, 0, 0, 0);
								}
							}
							else if (num == 14)
							{
							...
							else if (Global_8377[num].f_10 == 57 && num == 23)
							{
								...
								func_94(G_Scaleform, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(i), SYSTEM::TO_FLOAT(Global_8377[num].f_10), SYSTEM::TO_FLOAT(value6), -1f, &Global_8377[num], 0, 0, 0, 0);
							}
							else
							{
								func_94(G_Scaleform, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(i), SYSTEM::TO_FLOAT(Global_8377[num].f_10), SYSTEM::TO_FLOAT(0), -1f, &Global_8377[num], 0, 0, 0, 0);
							}
...
void func_100() // Position - 0x4866
{
	...
	while (num3 < num2)
	{
		if (!func_101(G_MissionStats.f_14144[num3].f_18, G_MissionStats.f_14144[Global_22912].f_18))
			Global_22912 = num3;
...
int func_102() // Position - 0x4A1C
{
	...
	while (i < num2)
	{
		if (G_MissionStats.f_14144[i].f_24 == 0 || G_MissionStats.f_14144[i].f_24 == 1)
			if (!func_101(G_MissionStats.f_14144[i].f_18, G_MissionStats.f_14144[Global_22912].f_18))
				Global_22912 = i;
...
BOOL func_103(int iParam0, int iParam1, int iParam2, var uParam3) // Position - 0x4B84
{
	...
	else
	{
		...
		if (iParam2 == -1)
		{
			...
			if (func_104(&unk5[0], num))
				iParam2 = 1;
			else if (func_104(&unk5[1], num))
				iParam2 = 0;
			else
	...
	while (num < 35)
	{
		if (!MISC::IS_STRING_NULL(&G_MissionStats.f_14144[num]))
			if (MISC::ARE_STRINGS_EQUAL(&G_MissionStats.f_14144[num], sParam0))
				if (G_MissionStats.f_14144[num].f_99[iParam1])
					num2 = 1;
...
BOOL func_111(int iParam0, int iParam1, int iParam2, var uParam3, var uParam4) // Position - 0x5090
{
	...
	else
	{
		...
		if (iParam2 == -1)
		{
			...
			if (func_103(iParam0, iParam1, 0, &unk[0]) && func_103(iParam0, iParam1, 1, &unk[1]))
			{
				num = func_105(iParam0);
			
				if (func_104(&unk[0], num))
					iParam2 = 1;
				else if (func_104(&unk[1], num))
					iParam2 = 0;
				else
					iParam2 = MISC::GET_RANDOM_INT_IN_RANGE(0, 2);
			}
...
void func_114(int iParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0x5277
{
	...
	Global_43378[iParam0] = { uParam1 };
	Global_43378[iParam0].f_3 = fParam4;
	Global_43378[iParam0].f_4 = iParam5;
	return;
}
...
int func_116(int iParam0, int iParam1) // Position - 0x5376
{
	...
	if (flag)
		if (num.f_3 < G_MissionStats.f_7691.f_919[_GET_CURRENT_PLAYER_CHARACTER_0()])
			return 5;
...
int func_154(int iParam0, var uParam1, int iParam2) // Position - 0xA0B4
{
	...
	if (!func_155(Global_100237[iParam0], false, -1))
	{
		func_153(iParam0, uParam1, iParam2);
		uParam1->f_91 = iParam2;
		return 1;
	...
	switch (iParam0)
	{
		...
		case 5:
			*uParam1 = G_MissionStats.f_2366.f_539.f_2310[0];
			TEXT_LABEL_ASSIGN_STRING(sParam2, func_174(G_MissionStats.f_2366.f_539.f_2314[0]), 32);
			return true;
	
		case 6:
			*uParam1 = G_MissionStats.f_2366.f_539.f_2310[1];
			TEXT_LABEL_ASSIGN_STRING(sParam2, func_174(G_MissionStats.f_2366.f_539.f_2314[1]), 32);
			return true;
	
		case 7:
			*uParam1 = G_MissionStats.f_2366.f_539.f_2310[2];
			TEXT_LABEL_ASSIGN_STRING(sParam2, func_174(G_MissionStats.f_2366.f_539.f_2314[2]), 32);
			return true;
