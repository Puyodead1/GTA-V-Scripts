...
void func_4() // Position - 0x493
{
	...
	{
		case 0:
			uLocal_59[0] = { -1542.1127f, -3023.8025f, 23.2538f };
			uLocal_59[1] = { -3089.888f, -1960.0751f, 313.559f };
			uLocal_59[2] = { -1037.6381f, -3316.1196f, 23.2475f };
			uLocal_59[3] = { 451.174f, -4009.4602f, 135.1171f };
		...
		case 2:
			...
			if (bLocal_80)
			{
				if (!CAM::IS_SPHERE_VISIBLE(uLocal_59[0], 50f) && !CAM::IS_SPHERE_VISIBLE(uLocal_72, 50f))
				{
					iLocal_86 = 3;
				}
				else
				{
					CAM::IS_SPHERE_VISIBLE(uLocal_59[0], 50f);
		...
		case 3:
			uLocal_47[0] = VEHICLE::CREATE_VEHICLE(joaat("jet"), uLocal_59[0], 0, true, true, false);
			ENTITY::SET_ENTITY_HEADING(uLocal_47[0], 240.3179f);
			VEHICLE::SET_VEHICLE_GENERATES_ENGINE_SHOCKING_EVENTS(uLocal_47[0], false);
			uLocal_47[1] = VEHICLE::CREATE_VEHICLE(joaat("jet"), uLocal_59[1], 0, true, true, false);
			VEHICLE::SET_VEHICLE_GENERATES_ENGINE_SHOCKING_EVENTS(uLocal_47[1], false);
			uLocal_47[2] = VEHICLE::CREATE_VEHICLE(joaat("jet"), uLocal_59[2], 0, true, true, false);
			VEHICLE::SET_VEHICLE_GENERATES_ENGINE_SHOCKING_EVENTS(uLocal_47[2], false);
			uLocal_47[3] = VEHICLE::CREATE_VEHICLE(joaat("jet"), uLocal_59[3], 0, true, true, false);
			...
			switch (iLocal_85)
			{
				case 0:
					if (!bLocal_75)
					{
						if (bLocal_76)
						{
							if (ENTITY::DOES_ENTITY_EXIST(uLocal_47[0]) && !ENTITY::IS_ENTITY_DEAD(uLocal_47[0], false))
							{
								if (ENTITY::IS_ENTITY_OCCLUDED(uLocal_47[0]) && !CAM::IS_SPHERE_VISIBLE(uLocal_59[0], 50f))
								{
									if (VEHICLE::HAS_VEHICLE_RECORDING_BEEN_LOADED(101, "AirportJetTakeOff"))
									{
										VEHICLE::START_PLAYBACK_RECORDED_VEHICLE_WITH_FLAGS(uLocal_47[0], 101, "AirportJetTakeOff", 2, 5, 786603);
				...
				case 3:
					if (ENTITY::DOES_ENTITY_EXIST(uLocal_47[2]) && !ENTITY::IS_ENTITY_DEAD(uLocal_47[2], false))
					{
						...
						{
							if (!CAM::IS_SPHERE_VISIBLE(uLocal_59[2], 50f))
							{
								if (!VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(uLocal_47[2]))
								{
				...
				case 4:
					...
					if (fLocal_84 > 1100f)
					{
						if (ENTITY::DOES_ENTITY_EXIST(uLocal_47[3]) && !ENTITY::IS_ENTITY_DEAD(uLocal_47[3], false))
						{
							...
							{
								if (!CAM::IS_SPHERE_VISIBLE(uLocal_59[3], 50f))
								{
