...
void main() // Position - 0x0
{
	...
	uLocal_19[0] = Vector3(1169.9758f, 3592.5715f, 32.6481f);
	uLocal_19[1] = Vector3(1215.738f, 3586.6077f, 33.5131f);
	...
	veLocal_18 = VEHICLE::CREATE_VEHICLE(joaat("cuban800"), uLocal_19[0], uLocal_26[0], true, true, false);
