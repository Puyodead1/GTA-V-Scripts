...
{
	uParam0->f_43.f_13(!func_32(&(uParam0->f_43), 5), &uParam0->[uParam0->f_43.f_2], uParam0->f_43.f_2);
	...
	for (i = 0; i < NETWORK::NETWORK_GET_MAX_NUM_PARTICIPANTS(); i = i + 1)
	{
		if (NETWORK::NETWORK_IS_PARTICIPANT_ACTIVE(PLAYER::INT_TO_PARTICIPANTINDEX(i)))
		{
			...
			if (playerIndex != PLAYER::PLAYER_ID() && _NETWORK_IS_PLAYER_VALID(playerIndex, true, true))
				if (func_63(PLAYER::GET_PLAYER_PED(playerIndex), &uParam0->[uParam0->f_43.f_2]) || func_58(playerIndex) == uParam0->f_43.f_2)
					return 1;
		}
	}
...
{
	return IS_BIT_SET(Global_1950844.f_4, 10);
}
...
BOOL func_83() // Position - 0x23E7
{
	if (Global_2657704[PLAYER::PLAYER_ID()].f_321.f_10 != _INVALID_PLAYER_INDEX())
	{
		if (NETWORK::NETWORK_IS_SCRIPT_ACTIVE("arena_workshop_seats", Global_2657704[PLAYER::PLAYER_ID()].f_321.f_10, true, 0))
			return false;
