...
BOOL func_98(Ped pedParam0, int iParam1, int iParam2) // Position - 0x3D7E
{
	...
	entityModel = ENTITY::GET_ENTITY_MODEL(pedParam0);
	Global_78341[1] = { func_150(entityModel, iParam1, iParam2, -1) };
	...
	else
	{
		...
		Global_78341[1] = { func_150(entityModel, iParam1, unk28[iParam1], -1) };
...
int func_101(Ped pedParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x4003
{
	...
	if (iParam1 == 12)
	{
		...
		for (i = 0; i <= 14; i = i + 1)
		{
			if (unk[i] != -99)
			{
				Global_78341[1] = { func_150(entityModel, i, unk[i], -1) };
				...
				if (IS_BIT_SET(Global_78341[1].f_6, 0))
				{
					if (i == 13)
					{
						...
						for (j = 0; j <= 8; j = j + 1)
						{
							Global_78341[1] = { func_150(entityModel, 14, unk18[j], -1) };
			...
			{
				Global_78341[1] = { func_150(entityModel, i, func_107(pedParam0, i, PV_COMP_INVALID), -1) };
	...
	else if (iParam1 == 13)
	{
		...
		for (j = 0; j <= 8; j = j + 1)
		{
			Global_78341[1] = { func_150(entityModel, 14, unk59[j], -1) };
			func_117(pedParam0, Global_78341[1].f_12, Global_78341[1].f_3, Global_78341[1].f_4);
			func_133(14);
...
{
	Global_78341[1] = { func_150(hParam0, iParam1, iParam2, -1) };
			...
			if (unk[i] != -99 && i != 12 && i != 14)
			{
				if (!func_214(pedParam0, i, unk[i]))
				{
					if (i == 13)
					{
						...
						for (j = 0; j <= 8; j = j + 1)
						{
							if (!func_214(pedParam0, 14, unk18[j]))
							{
								for (k = 0; k <= 19; k = k + 1)
								{
									Global_78341[2] = { func_150(entityModel, 14, k, -1) };
					...
					else
					{
						...
						Global_78341[2] = { func_150(entityModel, i, num, -1) };
...
void func_330() // Position - 0x2C917
{
	if (!_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_576[0]))
	{
		...
		if (STREAMING::HAS_MODEL_LOADED(hLocal_625) && STREAMING::HAS_MODEL_LOADED(joaat("A_M_Y_Beach_01")) && STREAMING::HAS_MODEL_LOADED(joaat("A_F_Y_Beach_01")))
		{
			...
			{
				uLocal_576[0].f_2 = { -1951.48f, -556.16f, 11.71f };
				uLocal_576[0].f_11 = -121.42f;
				uLocal_576[0].f_5 = { -1910.1f, -591.56f, 10.67f };
				uLocal_576[0].f_8 = { -1843.73f, -649.16f, 9.53f };
			...
			{
				uLocal_576[1].f_2 = { -1953.85f, -555.66f, 11f };
				uLocal_576[1].f_11 = -121.42f;
				uLocal_576[1].f_5 = { -1911.54f, -591.7f, 10.61f };
				uLocal_576[1].f_8 = { -1839.87f, -651.49f, 9.53f };
			...
			{
				uLocal_576[2].f_2 = { -1999.4f, -508.02f, 11f };
				uLocal_576[2].f_11 = 167.3f;
				uLocal_576[2].f_5 = { -1997.21f, -517.17f, 10.73f };
				uLocal_576[2].f_8 = { -1961.31f, -547.96f, 10.7f };
			...
			{
				uLocal_576[3].f_2 = { -2000.19f, -507.37f, 11f };
				uLocal_576[3].f_11 = 83.65f;
				uLocal_576[3].f_5 = { -1998.27f, -517.46f, 10.67f };
				uLocal_576[3].f_8 = { -1962.75f, -549.56f, 10.62f };
...
int func_400(int iParam0) // Position - 0x30A19
{
	...
	else if (iParam0 == 0)
	{
		...
		unk4 = { uLocal_678[iParam0 + 1] };
	}
	else
	{
		unk7 = { uLocal_678[iParam0 - 1] };
		unk4 = { uLocal_678[iParam0 + 1] };
	}
...
void func_440() // Position - 0x32AA0
{
	...
	uLocal_678[0] = { -1868.36f, -447.84f, 45.2f };
	uLocal_678[1] = { -1835.81f, -468.73f, 43.45f };
	uLocal_678[2] = { -1753.45f, -523.3f, 37.35f };
	uLocal_678[3] = { uLocal_663 };
	uLocal_678[4] = { -1755.65f, -558.99f, 36.11f };
	uLocal_678[5] = { -1828.99f, -516.33f, 27.87f };
	uLocal_678[6] = { -1819.2f, -555.86f, 15.77f };
	uLocal_678[7] = { uLocal_666 };
	uLocal_678[8] = { -1918.04f, -583.45f, 10.76f };
	uLocal_678[9] = { uLocal_669 };
