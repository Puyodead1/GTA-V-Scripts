...
void func_24(var uParam0) // Position - 0x9AC
{
	...
	switch (uParam0->f_13)
	{
		...
		case 2:
			if (func_78(PLAYER::PLAYER_PED_ID(), &uParam0->f_16[uParam0->f_9]) && func_77(PLAYER::PLAYER_PED_ID(), uParam0->f_16[uParam0->f_9].f_3, uParam0->f_16[uParam0->f_9].f_13) && !(func_75() && uParam0->f_9 == 8))
			{
				if (func_74(uParam0) || func_70(uParam0) || func_69(uParam0) || !func_68(uParam0) || func_66(PLAYER::PLAYER_ID()) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), true) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PED::IS_PED_IN_MELEE_COMBAT(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_PERFORMING_MELEE_ACTION(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) || IS_BIT_SET(Global_1950108.f_4, 2) || func_65(uParam0->f_16[uParam0->f_9].f_13))
				{
		...
		case 4:
			...
			animInitialOffsetPosition = Vector3(PED::GET_ANIM_INITIAL_OFFSET_POSITION(&animDict, &animName, func_53(uParam0), func_52(uParam0), 0, 2));
			animInitialOffsetRotation = Vector3(PED::GET_ANIM_INITIAL_OFFSET_ROTATION(&animDict, &animName, func_53(uParam0), func_52(uParam0), 0, 2));
		...
		case 5:
			...
			animInitialOffsetRotation2 = Vector3(PED::GET_ANIM_INITIAL_OFFSET_ROTATION(&animDict, &animName, func_53(uParam0), func_52(uParam0), 0, 2));
...
void func_58(int iParam0) // Position - 0x206E
{
	...
	for (i = 0; i < 3; i = i + 1)
	{
		if (Global_2359296[func_59()].f_681.f_4242[i] == iParam0)
		{
...
{
	uParam0->f_1.f_1 = func_62(uParam0->f_16[uParam0->f_9].f_13);
...
{
	*uParam0(!func_55(&(uParam0->f_7), 5), &uParam0->f_16[uParam0->f_9], uParam0->f_9);
	...
	for (i = 0; i < NETWORK::NETWORK_GET_MAX_NUM_PARTICIPANTS(); i = i + 1)
	{
		if (NETWORK::NETWORK_IS_PARTICIPANT_ACTIVE(PLAYER::INT_TO_PARTICIPANTINDEX(i)))
		{
			...
			if (playerIndex != PLAYER::PLAYER_ID() && _NETWORK_IS_PLAYER_VALID(playerIndex, true, true))
				if (func_78(PLAYER::GET_PLAYER_PED(playerIndex), &uParam0->f_16[uParam0->f_9]) || func_71(playerIndex) == uParam0->f_9)
					return 1;
		}
	}
	...
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2657589[plParam0].f_321.f_7 != -1)
				return func_100(Global_2657589[plParam0].f_321.f_7) == 21;
...
void func_103(int iParam0, var uParam1, int iParam2, int iParam3) // Position - 0x2F6D
{
	...
	uParam1->f_16[iParam2].f_6.f_1 = Vector3(func_105(func_107(), func_106(iParam3, num)) + unk);
	uParam1->f_16[iParam2].f_6.f_4 = Vector3(func_105(func_104(), func_106(iParam3, num)) + unk);
...
void func_108(int iParam0, var uParam1, var uParam2) // Position - 0x30A1
{
	if (func_27())
	{
		...
		{
			case 0:
				*uParam1 = Vector3(-1017.25f, -90.296f, -100.388f);
				*uParam2 = -90f;
				break;
		
			case 1:
				*uParam1 = Vector3(-1017.25f, -91.034f, -100.388f);
				*uParam2 = -90f;
				break;
		
			case 2:
				*uParam1 = Vector3(-1018.919f, -88.779f, -100.416f);
				*uParam2 = 5.76f;
				break;
		
			case 3:
				*uParam1 = Vector3(-1006.604f, -75.716f, -100.001f);
				*uParam2 = 0f;
				break;
		
			case 4:
				*uParam1 = Vector3(-1002.706f, -75.829f, -100.001f);
				*uParam2 = -45f;
				break;
		
			case 5:
				*uParam1 = Vector3(-1003.631f, -65.468f, -100.001f);
				*uParam2 = 65.88f;
				break;
		
			case 6:
				*uParam1 = Vector3(-1003.241f, -64.703f, -100.001f);
				*uParam2 = 54.72f;
				break;
		
			case 7:
				*uParam1 = Vector3(-1002.81f, -64.054f, -100.001f);
				*uParam2 = 65.16f;
				break;
		
			case 8:
				*uParam1 = Vector3(-1002.294f, -63.104f, -100.001f);
				*uParam2 = 60.84f;
				break;
		
			case 9:
				*uParam1 = Vector3(-998.893f, -80.68f, -100.001f);
				*uParam2 = 141.12f;
				break;
		
			case 10:
				*uParam1 = Vector3(-999.73f, -80.017f, -100.001f);
				*uParam2 = 147.96f;
				break;
		
			case 11:
				*uParam1 = Vector3(-997.339f, -61.701f, -100.001f);
				*uParam2 = -36.72f;
				break;
		
			case 12:
				*uParam1 = Vector3(-984.732f, -65.988f, -100.001f);
				*uParam2 = -25.65f;
				break;
		
			case 13:
				*uParam1 = Vector3(-983.832f, -66.376f, -100.001f);
				*uParam2 = -26f;
				break;
		
			case 14:
				*uParam1 = Vector3(-979.469f, -73.513f, -100.001f);
				*uParam2 = -122.76f;
				break;
		
			case 15:
				*uParam1 = Vector3(-990.732f, -77.676f, -100.001f);
				*uParam2 = 166.68f;
				break;
		
			case 16:
				*uParam1 = Vector3(-985.745f, -71.501f, -99.426f);
				*uParam2 = 44.28f;
				break;
		
			case 17:
				*uParam1 = Vector3(-1002.362f, -78.16f, -99.98f);
				*uParam2 = -89.64f;
				break;
		}
	}
