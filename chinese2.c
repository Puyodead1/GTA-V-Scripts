			...
			switch (iLocal_2515[i])
			{
					...
					switch (iLocal_2515[i].f_2)
					{
						...
						case -15:
							if (STREAMING::HAS_MODEL_LOADED(joaat("dubsta")))
							{
								func_32(22, 0);
								func_32(8, 0);
								PATHFIND::SET_ROADS_IN_AREA({ 44.8113f, 4961.045f, 2469.9854f } - Vector3( 100f, 100f, 100f ), { 44.8113f, 4961.045f, 2469.9854f } + Vector3( 100f, 100f, 100f ), false, true);
								iLocal_2515[i].f_2 = 1;
							}
							break;
						...
						case 1:
							...
							if (MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), 2460.0728f, 4964.176f, 46.2405f, true) > 300f)
							{
								...
								PATHFIND::SET_ROADS_IN_AREA({ 44.8113f, 4961.045f, 2469.9854f } - Vector3( 100f, 100f, 100f ), { 44.8113f, 4961.045f, 2469.9854f } + Vector3( 100f, 100f, 100f ), true, true);
								func_31(22, true);
								func_31(8, true);
				...
				case 8:
					switch (iLocal_2515[i].f_2)
					{
						...
						case 0:
							PED::ADD_SCENARIO_BLOCKING_AREA({ 58.617897f, 4972.8975f, 2445.654f } - Vector3( 100f, 100f, 100f ), { 58.617897f, 4972.8975f, 2445.654f } + Vector3( 100f, 100f, 100f ), false, true, true, true);
							iLocal_2515[i].f_2 = iLocal_2515[i].f_2 + 1;
							break;
							...
							case 2:
								...
								switch (iLocal_755[i].f_5)
								{
									...
									case 2:
										...
										{
											iLocal_755[i].f_6 = { 2466.9026f, 4996.254f, 45.5443f };
											iLocal_755[i].f_5 = iLocal_755[i].f_5 + 1;
										}
										break;
									...
									case 3:
										...
										{
											iLocal_755[i].f_6 = { 2461.3323f, 4998.94f, 45.359f };
											iLocal_755[i].f_5 = iLocal_755[i].f_5 + 1;
										}
										break;
									...
									case 4:
										if (ENTITY::IS_ENTITY_AT_COORD(iLocal_755[i], iLocal_755[i].f_6, 1.5f, 1.5f, 2f, false, true, 0))
										{
											iLocal_755[i].f_6 = { 2455.9841f, 4997.4043f, 45.2645f };
											iLocal_755[i].f_5 = iLocal_755[i].f_5 + 1;
										}
										break;
									...
									case 5:
										if (ENTITY::IS_ENTITY_AT_COORD(iLocal_755[i], iLocal_755[i].f_6, 1.5f, 1.5f, 2f, false, true, 0))
										{
											...
											{
												iLocal_755[i].f_6 = { 2452.0906f, 4993.674f, 45.1404f };
												iLocal_755[i].f_5 = iLocal_755[i].f_5 + 1;
											}
											else
											{
												iLocal_755[i].f_6 = { 2454.0906f, 4995.674f, 45.1404f };
												iLocal_755[i].f_5 = iLocal_755[i].f_5 + 1;
											}
										}
										break;
							...
							if (i != iLocal_58)
							{
								if (uParam0->[i].f_3 <= 4)
								{
									if (func_4(uParam0->[i], uParam0->[iLocal_58], true) < 8f)
									{
										...
										{
											entityCoords = { ENTITY::GET_ENTITY_COORDS(uParam0->[i], true) };
											entityCoords2 = { ENTITY::GET_ENTITY_COORDS(uParam0->[iLocal_58], false) };
...
void func_127(int iParam0, BOOL bParam1) // Position - 0x100AB
{
	...
	if (iParam0 >= 0)
	{
		if (iParam0 % 2 == 1)
		{
			...
			if (num + 1 < 61)
				func_128(((iLocal_444[iParam0 / 2] + iLocal_444[(iParam0 / 2) + 1]) / Vector3( 2f, 2f, 2f )) + { fLocal_273, fLocal_273, fLocal_273 }, bParam1);
		}
		else if (iParam0 / 2 < 61)
		{
			func_128(iLocal_444[iParam0 / 2] + { fLocal_273, fLocal_273, fLocal_273 }, bParam1);
		}
	}
...
void func_128(Vector3 vParam0, var uParam1, var uParam2, BOOL bParam3) // Position - 0x10119
{
	...
	iLocal_281[iLocal_441].f_1 = { vParam0 };
	...
	for (i = 0; i < iLocal_444; i = i + 1)
	{
		if (!func_168(iLocal_444[i], 0f, 0f, 0f, false))
		{
			...
			for (j = 0; j < iLocal_755; j = j + 1)
			{
				...
				{
					entityCoords = { ENTITY::GET_ENTITY_COORDS(iLocal_755[j], false) };
...
void func_169(BOOL bParam0) // Position - 0x16585
{
	...
	for (i = 0; i < iLocal_444; i = i + 1)
	{
		...
		{
			iLocal_444[i] = { HUD::GET_BLIP_COORDS(iLocal_444[i].f_3) };
...
void func_181() // Position - 0x1787F
{
	...
	switch (iLocal_2512)
	{
		case 0:
			...
			for (i = 49; i <= 55; i = i + 1)
			{
				iLocal_444[i] = { iLocal_444[i] + { 0.6f, 0f, 0f } };
			}
	...
	for (k = 0; k < iLocal_2380; k = k + 1)
	{
		...
		{
			uLocal_2455[k] = 0;
			iLocal_2380[k] = { CAM::GET_CAM_COORD(CAM::GET_RENDERING_CAM()) };
			iLocal_2380[k].f_3 = { CAM::GET_CAM_ROT(CAM::GET_RENDERING_CAM(), 2) };
		...
		{
			uLocal_2460[k] = 0;
			iLocal_2380[k].f_6 = { CAM::GET_CAM_COORD(CAM::GET_RENDERING_CAM()) };
			iLocal_2380[k].f_9 = { CAM::GET_CAM_ROT(CAM::GET_RENDERING_CAM(), 2) };
				...
				else
				{
					switch (iLocal_2512)
					{
						...
						case 5:
							...
							CAM::ADD_CAM_SPLINE_NODE(caLocal_2637, { 45.7f, 4934.8f, 2493.4f } + Vector3( 0f, 1f, -1f ), 5.2f, 0f, 48f, 6000, 3, 2);
							CAM::SET_CAM_FOV(caLocal_2637, 28.5f);
							CAM::SET_CAM_SPLINE_SMOOTHING_STYLE(caLocal_2637, 0);
							break;
	...
	switch (iLocal_2512)
	{
		case 0:
			...
			if (func_210())
			{
				...
				PED::ADD_SCENARIO_BLOCKING_AREA({ 50.277412f, 3054.8843f, 1991.2196f } - Vector3( 40f, 40f, 40f ), { 50.277412f, 3054.8843f, 1991.2196f } + Vector3( 40f, 40f, 40f ), false, true, true, true);
				PED::SET_PED_NON_CREATION_AREA({ 50.277412f, 3054.8843f, 1991.2196f } - Vector3( 40f, 40f, 40f ), { 50.277412f, 3054.8843f, 1991.2196f } + Vector3( 0f, 40f, 40f ));
				func_32(0, 0);
				func_32(26, 0);
				iLocal_3689 = 0;
				iLocal_2512 = iLocal_2512 + 1;
...
void func_272() // Position - 0x1E126
{
	...
	switch (iLocal_2512)
	{
		case 0:
			...
			iLocal_2889[0] = { 2428.47f, 4968.91f, 42.11f };
			iLocal_2889[1] = { 2431.14f, 4972.06f, 42.19f };
			iLocal_2889[2] = { 2433.05f, 4969.22f, 42.26f };
			iLocal_2889[3] = { 2437.71f, 4968.13f, 42.45f };
			iLocal_2889[4] = { 2436.12f, 4964.76f, 42.19f };
			iLocal_2889[5] = { 2432.13f, 4961.97f, 41.35f };
			iLocal_2889[6] = { 2430.07f, 4963.78f, 41.35f };
			iLocal_2889[7] = { 2434f, 4963.04f, 41.53f };
			iLocal_2889[8] = { 2435.6372f, 4969.699f, 42.19639f };
			iLocal_444[0] = { 2450.3765f, 4955.8296f, 43.9394f };
			iLocal_444[1] = { 2449.815f, 4956.678f, 43.9894f };
			iLocal_444[2] = { 2449.606f, 4957.6753f, 44.0646f };
			iLocal_444[48] = { 2430.5747f, 4961.5737f, 45.5917f };
			iLocal_444[49] = { 2429.8887f, 4962.028f, 44.9345f };
			iLocal_444[50] = { 2429.26f, 4962.5947f, 44.2774f };
			iLocal_444[51] = { 2428.6914f, 4963.2793f, 43.6202f };
			iLocal_444[52] = { 2428.073f, 4963.9106f, 42.9631f };
			iLocal_444[53] = { 2428.2388f, 4964.922f, 42.9631f };
			iLocal_444[54] = { 2428.9614f, 4965.4546f, 42.3059f };
			iLocal_444[55] = { 2429.45f, 4966.2236f, 41.8679f };
			iLocal_444[56] = { 2430.0728f, 4966.82f, 41.3476f };
			iLocal_444[57] = { 2431.097f, 4967.043f, 41.3476f };
			iLocal_444[58] = { 2431.8904f, 4966.403f, 41.3476f };
			iLocal_444[59] = { 2432.7676f, 4965.902f, 41.3476f };
			iLocal_444[60] = { 2433.7761f, 4965.6133f, 41.3476f };
			...
			iLocal_2380[0] = { 2454.83f, 4974.96f, 46.4489f };
			iLocal_2380[0].f_3 = { 2.9627f, 0.077f, 115.874f };
			iLocal_2380[0].f_14 = 39.703f;
			iLocal_2380[0].f_6 = { 2454.41f, 4974.93f, 46.4691f };
			iLocal_2380[0].f_9 = { 2.6238f, 0.077f, 114.001f };
			iLocal_2380[0].f_15 = 39.703f;
			iLocal_2380[0].f_12 = 2500f;
			iLocal_2380[0].f_13 = 2500f;
			iLocal_2380[0].f_16 = 0;
			iLocal_2380[0].f_17 = 18;
			iLocal_2380[1] = { 2435.41f, 4960.94f, 45.9568f };
			iLocal_2380[1].f_3 = { 6.677f, 0f, -49.4853f };
			iLocal_2380[1].f_14 = 58.9114f;
			iLocal_2380[1].f_6 = { 2435.11f, 4960.62f, 45.9441f };
			iLocal_2380[1].f_9 = { 6.3596f, 0f, -44.8248f };
			iLocal_2380[1].f_15 = 58.9114f;
			iLocal_2380[1].f_12 = 3200f;
			iLocal_2380[1].f_13 = 1900f;
			iLocal_2380[1].f_16 = 0;
			iLocal_2380[1].f_17 = 34;
			iLocal_2380[2] = { 2434.77f, 4969.56f, 42.3654f };
			iLocal_2380[2].f_3 = { 5.2773f, -0.1511f, 132.167f };
			iLocal_2380[2].f_14 = 35.1297f;
			iLocal_2380[2].f_6 = { 2434.66f, 4969.68f, 42.3657f };
			iLocal_2380[2].f_9 = { 5.2773f, -0.1511f, 132.167f };
			iLocal_2380[2].f_15 = 35.1297f;
			iLocal_2380[2].f_12 = 3500f;
			iLocal_2380[2].f_13 = 4500f;
			iLocal_2380[2].f_16 = 3;
			iLocal_2380[2].f_17 = 49;
			iLocal_2380[3] = { 2472.1f, 4943.1f, 45.3f };
			iLocal_2380[3].f_3 = { 6f, 0f, 25.3f };
			iLocal_2380[3].f_14 = 33.1297f;
			iLocal_2380[3].f_6 = { 2472.1f, 4943.1f, 45.3f };
			iLocal_2380[3].f_9 = { 5.5f, 0f, 35.6f };
			...
			fLocal_2639 = 0.06f;
			func_172(true);
			uLocal_2465[0] = { 2432.74f, 4963.43f, 41.35f };
			uLocal_2465[1] = { 2432.02f, 4962.61f, 41.35f };
			uLocal_2465[2] = { 2431.06f, 4961.83f, 41.35f };
			uLocal_2465[3] = { 2430.84f, 4961.08f, 42.09f };
			uLocal_2465[4] = { 2430.53f, 4962.47f, 42f };
			uLocal_2465[5] = { 2430.81f, 4961.1f, 42.8f };
			uLocal_2465[6] = { 2429.74f, 4961.98f, 42.32f };
			uLocal_2465[7] = { 2433.5f, 4966.76f, 41.35f };
			uLocal_2465[8] = { 2433.24f, 4967.42f, 41.35f };
			uLocal_2465[9] = { 2433.15f, 4967.43f, 42.19f };
			uLocal_2465[10] = { 2432.53f, 4967.89f, 42.4f };
			uLocal_2465[11] = { 2432.48f, 4969.07f, 42.19f };
			uLocal_2465[12] = { 2433.36f, 4969.44f, 42.31f };
			uLocal_2274[0] = { 2552.6924f, 4978.5664f, 45.32309f };
			uLocal_2274[1] = { 2562.5337f, 5013.502f, 47.463024f };
			uLocal_2274[2] = { 2553.8848f, 4945.6606f, 47.493053f };
			uLocal_2274[3] = { 2515.5452f, 4936.428f, 42.883816f };
			uLocal_2274[4] = { 2497.3184f, 4967.818f, 43.595566f };
			uLocal_2274[5] = { 2481.3762f, 4951.766f, 43.99859f };
			uLocal_2274[6] = { 2522.0444f, 4956.3716f, 43.71605f };
			uLocal_2274[7] = { 2529.048f, 4985.6274f, 43.868477f };
			uLocal_2274[8] = { 2502.5034f, 4987.245f, 46.62669f };
			uLocal_2274[9] = { 2464.891f, 4939.9487f, 44.256462f };
			uLocal_2274[10] = { 2447.1602f, 4940.2725f, 44.15766f };
			uLocal_2274[11] = { 2376.5369f, 4946.3994f, 41.772324f };
			uLocal_2274[12] = { 2395.232f, 4995.63f, 44.689095f };
			uLocal_2274[13] = { 2419.819f, 4991.9355f, 45.369762f };
			uLocal_2274[14] = { 2436.3193f, 5011.725f, 45.846943f };
			uLocal_2274[15] = { 2407.7646f, 5023.0786f, 47.770912f };
			uLocal_2274[16] = { 2479.0159f, 5028.829f, 42.98806f };
			uLocal_2274[17] = { 2434.704f, 5042.713f, 45.34462f };
			uLocal_2274[18] = { 2513.93f, 5039.3325f, 51.021214f };
			uLocal_2274[19] = { 2477.8823f, 4986.437f, 44.995113f };
			uLocal_2274[20] = { 2450.058f, 5011.858f, 44.890316f };
			func_209(&iLocal_1619, &uLocal_2708, sLocal_2338, 12f, 2482.1965f, 4975.3667f, 44.7288f, 121f, 1);
...
void func_372(int iParam0) // Position - 0x284D9
{
	...
	PATHFIND::SET_ROADS_BACK_TO_ORIGINAL({ 44.8113f, 4961.045f, 2469.9854f } - Vector3( 100f, 100f, 100f ), { 44.8113f, 4961.045f, 2469.9854f } + Vector3( 100f, 100f, 100f ), 1);
...
void func_384(var uParam0, const char* sParam1, int iParam2, char* sParam3, int iParam4, Ped pedParam5) // Position - 0x29296
{
	...
	*uParam0 = _GET_CURRENT_PLAYER_CHARACTER();
	...
	for (j = CHAR_MICHAEL; j < CHAR_MULTIPLAYER; j = j + 1)
	{
		...
		for (i = 0; i < 44; i = i + 1)
		{
			uParam0->f_812[j][i] = { Global_113648.f_2365.f_539.f_298[j][i] };
		}
	
		for (i = 0; i < 51; i = i + 1)
		{
			uParam0->f_812[j].f_221[i] = { Global_113648.f_2365.f_539.f_298[j].f_221[i] };
		}
		...
		uParam0->f_25[0][j] = { Global_113648.f_2365.f_539.f_2407[0][j] };
		uParam0->f_25[1][j] = { Global_113648.f_2365.f_539.f_2407[1][j] };
