...
void func_3() // Position - 0x1A1
{
	...
	{
		if (iLocal_2515[i].f_1 == 1)
		{
			switch (iLocal_2515[i])
			{
				case 0:
					switch (iLocal_2515[i].f_2)
					{
						case 0:
							if (CUTSCENE::IS_CUTSCENE_PLAYING())
								iLocal_2515[i].f_2 = iLocal_2515[i].f_2 + 1;
							break;
				...
				case 3:
					...
					switch (iLocal_2515[i].f_2)
					{
						case 0:
							...
							iLocal_2888 = 0;
							iLocal_2515[i].f_5 = MISC::GET_GAME_TIMER() + 3000;
							break;
						...
						case 1:
							if (!_CONVERSATION_IS_DIALOGUE_IN_PROGRESS())
							{
								if (!func_34())
								{
									...
									{
										if (MISC::GET_GAME_TIMER() > iLocal_2515[i].f_5)
										{
											if (iLocal_2888 < 13)
											{
												if (func_35("DRI1", 2, PLAYER::PLAYER_PED_ID(), "Trevor", -1, 0, 0, -1, 0, 0, -1, 0, 0, 8))
												{
													...
													iLocal_2515[i].f_5 = MISC::GET_GAME_TIMER() + MISC::GET_RANDOM_INT_IN_RANGE(4000, 10000);
												}
											}
											else
											{
					...
					switch (iLocal_2515[i].f_2)
					{
						...
						case -15:
							if (STREAMING::HAS_MODEL_LOADED(joaat("dubsta")))
							{
								func_32(22, 0);
								func_32(8, 0);
								PATHFIND::SET_ROADS_IN_AREA(Vector3(44.8113f, 4961.045f, 2469.9854f) - Vector3( 100f, 100f, 100f ), Vector3(44.8113f, 4961.045f, 2469.9854f) + Vector3( 100f, 100f, 100f ), false, true);
								iLocal_2515[i].f_2 = 1;
							}
							break;
						...
						case 1:
							...
							if (MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), 2460.0728f, 4964.176f, 46.2405f, true) > 300f)
							{
								...
								PATHFIND::SET_ROADS_IN_AREA(Vector3(44.8113f, 4961.045f, 2469.9854f) - Vector3( 100f, 100f, 100f ), Vector3(44.8113f, 4961.045f, 2469.9854f) + Vector3( 100f, 100f, 100f ), true, true);
								func_31(22, true);
								func_31(8, true);
				...
				case 7:
					if (iLocal_2515[i].f_2 == 0)
					{
						num = func_18(8);
					
						if (num != -1)
						{
							if (!PED::IS_PED_INJURED(iLocal_755[num]))
							{
								if (TASK::GET_SCRIPT_TASK_STATUS(iLocal_755[num], SCRIPT_TASK_SYNCHRONIZED_SCENE) == 7)
								{
									num = func_18(9);
				...
				case 8:
					switch (iLocal_2515[i].f_2)
					{
						...
						case 0:
							PED::ADD_SCENARIO_BLOCKING_AREA(Vector3(58.617897f, 4972.8975f, 2445.654f) - Vector3( 100f, 100f, 100f ), Vector3(58.617897f, 4972.8975f, 2445.654f) + Vector3( 100f, 100f, 100f ), false, true, true, true);
							iLocal_2515[i].f_2 = iLocal_2515[i].f_2 + 1;
							break;
				...
				case 14:
					...
					{
						case 0:
							iLocal_2515[i].f_5 = MISC::GET_GAME_TIMER() + 7000;
							iLocal_2515[i].f_2 = iLocal_2515[i].f_2 + 1;
							break;
				...
				case 17:
					if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 2447.6714f, 4951.4385f, 43.255756f, 2454.6638f, 4957.856f, 47.891174f, 6.8125f, false, true, 0) && MISC::GET_GAME_TIMER() > iLocal_2515[i].f_5)
					{
						if (HUD::DOES_BLIP_EXIST(blLocal_2677))
							HUD::REMOVE_BLIP(&blLocal_2677);
						...
						switch (iLocal_2515[i].f_2)
						{
							case 0:
								if (!_CONVERSATION_IS_DIALOGUE_IN_PROGRESS())
								{
									...
									iLocal_2515[i].f_5 = MISC::GET_GAME_TIMER() + 2000;
				...
				case 20:
					if (!IS_BIT_SET(iLocal_2515[i].f_5, 0))
					{
						iLocal_2885 = func_18(4);
					
						if (iLocal_2885 != -1)
							MISC::SET_BIT(&(iLocal_2515[i].f_5), 0);
					}
					else if (!IS_BIT_SET(iLocal_2515[i].f_5, 1))
					{
						if (!PED::IS_PED_INJURED(iLocal_755[iLocal_2885]) && ENTITY::DOES_ENTITY_EXIST(iLocal_755[iLocal_2885].f_20))
							if (ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_755[iLocal_2885], "misschinese2_barrelroll", "barrel_roll_loop_B", 3) && ENTITY::IS_ENTITY_ATTACHED(iLocal_755[iLocal_2885].f_20))
								MISC::SET_BIT(&(iLocal_2515[i].f_5), 1);
					}
					else if (!IS_BIT_SET(iLocal_2515[i].f_5, 2))
					{
						if (PED::IS_PED_INJURED(iLocal_755[iLocal_2885]))
							MISC::SET_BIT(&(iLocal_2515[i].f_5), 2);
					
						if (!PED::IS_PED_INJURED(iLocal_755[iLocal_2885]))
						{
							if (!ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_755[iLocal_2885], "misschinese2_barrelroll", "barrel_roll_loop_B", 3))
								MISC::SET_BIT(&(iLocal_2515[i].f_5), 2);
						
							if (TASK::GET_SCRIPT_TASK_STATUS(iLocal_755[iLocal_2885], SCRIPT_TASK_PLAY_ANIM) == 2 || TASK::GET_SCRIPT_TASK_STATUS(iLocal_755[iLocal_2885], SCRIPT_TASK_PLAY_ANIM) == 7)
								MISC::SET_BIT(&(iLocal_2515[i].f_5), 2);
						
							if (PED::IS_PED_IN_COMBAT(iLocal_755[iLocal_2885], PLAYER::PLAYER_PED_ID()) || iLocal_1619[iLocal_2885].f_3 > 3)
								MISC::SET_BIT(&(iLocal_2515[i].f_5), 2);
						}
					}
					else if (ENTITY::DOES_ENTITY_EXIST(iLocal_755[iLocal_2885].f_20) && ENTITY::IS_ENTITY_ATTACHED(iLocal_755[iLocal_2885].f_20))
					{
						ENTITY::DETACH_ENTITY(iLocal_755[iLocal_2885].f_20, false, false);
					}
				
					if (!IS_BIT_SET(iLocal_2515[i].f_5, 4))
					{
						iLocal_2886 = func_18(5);
					
						if (iLocal_2886 != -1)
							MISC::SET_BIT(&(iLocal_2515[i].f_5), 4);
					}
					else if (!IS_BIT_SET(iLocal_2515[i].f_5, 5))
					{
						if (!PED::IS_PED_INJURED(iLocal_755[iLocal_2886]))
							if (ENTITY::DOES_ENTITY_EXIST(iLocal_755[iLocal_2886].f_20))
								if (ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_755[iLocal_2886], "misschinese2_barrelroll", "barrel_roll_loop_A", 3))
									if (ENTITY::IS_ENTITY_ATTACHED(iLocal_755[iLocal_2886].f_20))
										MISC::SET_BIT(&(iLocal_2515[i].f_5), 5);
					}
					else if (!IS_BIT_SET(iLocal_2515[i].f_5, 6))
					{
						if (PED::IS_PED_INJURED(iLocal_755[iLocal_2886]))
							MISC::SET_BIT(&(iLocal_2515[i].f_5), 6);
						...
						if (!PED::IS_PED_INJURED(iLocal_755[iLocal_2886]))
						{
							...
							if (TASK::GET_SCRIPT_TASK_STATUS(iLocal_755[iLocal_2886], SCRIPT_TASK_PLAY_ANIM) == 2 || TASK::GET_SCRIPT_TASK_STATUS(iLocal_755[iLocal_2886], SCRIPT_TASK_PLAY_ANIM) == 7)
								MISC::SET_BIT(&(iLocal_2515[i].f_5), 6);
						
							if (PED::IS_PED_IN_COMBAT(iLocal_755[iLocal_2886], PLAYER::PLAYER_PED_ID()) || iLocal_1619[iLocal_2886].f_3 > 3)
								MISC::SET_BIT(&(iLocal_2515[i].f_5), 6);
						}
					}
					else if (ENTITY::DOES_ENTITY_EXIST(iLocal_755[iLocal_2886].f_20) && ENTITY::IS_ENTITY_ATTACHED(iLocal_755[iLocal_2886].f_20))
					{
						ENTITY::DETACH_ENTITY(iLocal_755[iLocal_2886].f_20, false, false);
					}
					break;
				...
				case 24:
					...
					if (!IS_BIT_SET(iLocal_2515[i].f_5, 1))
					{
					...
					if (IS_BIT_SET(iLocal_2515[i].f_5, 0) && IS_BIT_SET(iLocal_2515[i].f_5, 1) || iLocal_2511 == 6)
					{
						if (ENTITY::DOES_ENTITY_EXIST(obLocal_2680))
							ENTITY::FREEZE_ENTITY_POSITION(obLocal_2680, false);
				...
				case 26:
					...
					{
						case -1:
							if (ENTITY::DOES_ENTITY_EXIST(iLocal_755[12]))
								PED::DELETE_PED(&iLocal_755[12]);
						
							if (ENTITY::DOES_ENTITY_EXIST(iLocal_755[13]))
								PED::DELETE_PED(&iLocal_755[13]);
						
							if (ENTITY::DOES_ENTITY_EXIST(iLocal_755[14]))
								PED::DELETE_PED(&iLocal_755[14]);
						...
						case 1:
							if (STREAMING::HAS_ANIM_DICT_LOADED("MISSChinese2_crystalMazeMCS1_IG"))
							{
								...
								{
									if (ENTITY::DOES_ENTITY_EXIST(iLocal_755[13]) && !PED::IS_PED_INJURED(iLocal_755[13]))
										ENTITY::SET_ENTITY_COORDS(iLocal_755[13], 1986.0602f, 3051.7085f, 46.2151f, true, false, false, true);
								
									if (ENTITY::DOES_ENTITY_EXIST(iLocal_755[14]) && !PED::IS_PED_INJURED(iLocal_755[14]))
										ENTITY::SET_ENTITY_COORDS(iLocal_755[14], 1986.1051f, 3051.6592f, 46.2151f, true, false, false, true);
						...
						case 2:
							...
							{
								if (!ENTITY::DOES_ENTITY_EXIST(iLocal_755[13]))
									iLocal_755[13] = PED::CREATE_PED(PED_TYPE_MISSION, joaat("IG_Old_Man1A"), 1987.231f, 3052.741f, 46.214f, 0, true, true);
							
								if (!ENTITY::DOES_ENTITY_EXIST(iLocal_755[14]))
									iLocal_755[14] = PED::CREATE_PED(PED_TYPE_MISSION, joaat("IG_Old_Man2"), 1987.231f, 3052.741f, 46.214f, 0, true, true);
							
								if (!ENTITY::DOES_ENTITY_EXIST(iLocal_755[12]))
									iLocal_755[12] = PED::CREATE_PED(PED_TYPE_MISSION, joaat("IG_Janet"), 1987.231f, 3052.741f, 46.214f, 0, true, true);
							
								MISC::SET_BIT(&(iLocal_2515[i].f_5), 1);
								TASK::TASK_USE_NEAREST_SCENARIO_TO_COORD_WARP(iLocal_755[14], 1984.89f, 3052.46f, 46.98f, 0.3f, 0);
								PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(iLocal_755[14], true, true);
								PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_755[14], false);
								MISC::SET_BIT(&(iLocal_2515[i].f_5), 0);
								TASK::TASK_USE_NEAREST_SCENARIO_TO_COORD_WARP(iLocal_755[13], 1985.3221f, 3053.0872f, 46.98f, 0.3f, 0);
								PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(iLocal_755[13], true, true);
								PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_755[13], false);
							
								if (!PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_2515[i].f_5))
								{
									iLocal_2515[i].f_5 = PED::CREATE_SYNCHRONIZED_SCENE(1987.231f, 3052.741f, 46.214f, 0f, 0f, 57.6f, 2);
									PED::SET_SYNCHRONIZED_SCENE_LOOPED(iLocal_2515[i].f_5, true);
								}
							
								TASK::TASK_SYNCHRONIZED_SCENE(iLocal_755[12], iLocal_2515[i].f_5, "MISSChinese2_crystalMazeMCS1_IG", "bar_peds_action_janet", 1000f, -1000f, 1, 0, 1148846080, 0);
								PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(iLocal_755[12], true, true);
								PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_755[12], false);
								iLocal_2515[i].f_5 = 0;
								iLocal_2515[i].f_2 = iLocal_2515[i].f_2 + 1;
							}
							break;
						...
						case 3:
							...
							if (!PED::IS_PED_INJURED(iLocal_755[13]) && !PED::IS_PED_INJURED(iLocal_755[14]))
							{
								PED::SET_PED_CONFIG_FLAG(iLocal_755[13], 152, true);
								PED::SET_PED_CONFIG_FLAG(iLocal_755[14], 152, true);
							
								if (IS_BIT_SET(iLocal_2515[i].f_5, 0) && IS_BIT_SET(iLocal_2515[i].f_5, 1))
								{
									iLocal_2515[i].f_2 = iLocal_2515[i].f_2 + 1;
								}
								else
								{
									if (TASK::GET_SCRIPT_TASK_STATUS(iLocal_755[13], SCRIPT_TASK_START_SCENARIO_IN_PLACE) != 1)
									{
										if (TASK::DOES_SCENARIO_EXIST_IN_AREA(1984.89f, 3052.46f, 46.98f, 0.3f, true))
										{
											MISC::SET_BIT(&(iLocal_2515[i].f_5), 0);
											TASK::TASK_USE_NEAREST_SCENARIO_TO_COORD_WARP(iLocal_755[13], 1984.89f, 3052.46f, 46.98f, 0.3f, 0);
											PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_755[13], false);
										}
									}
									else
									...
									if (TASK::GET_SCRIPT_TASK_STATUS(iLocal_755[14], SCRIPT_TASK_START_SCENARIO_IN_PLACE) != 1)
									{
										if (TASK::DOES_SCENARIO_EXIST_IN_AREA(1985.3221f, 3053.0872f, 46.98f, 0.3f, true))
										{
											MISC::SET_BIT(&(iLocal_2515[i].f_5), 1);
											TASK::TASK_USE_NEAREST_SCENARIO_TO_COORD_WARP(iLocal_755[14], 1985.3221f, 3053.0872f, 46.98f, 0.3f, 0);
											PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_755[14], false);
										}
									}
									else
						...
						case 6:
							if (!PED::IS_PED_INJURED(iLocal_755[12]))
							{
								TASK::TASK_SMART_FLEE_PED(iLocal_755[12], PLAYER::PLAYER_PED_ID(), 100f, -1, false, false);
								PED::SET_PED_KEEP_TASK(iLocal_755[12], true);
								ENTITY::SET_PED_AS_NO_LONGER_NEEDED(&iLocal_755[12]);
							}
						
							if (!PED::IS_PED_INJURED(iLocal_755[13]))
							{
								TASK::TASK_SMART_FLEE_PED(iLocal_755[13], PLAYER::PLAYER_PED_ID(), 100f, -1, false, false);
								PED::SET_PED_KEEP_TASK(iLocal_755[13], true);
								ENTITY::SET_PED_AS_NO_LONGER_NEEDED(&iLocal_755[13]);
							}
						
							if (!PED::IS_PED_INJURED(iLocal_755[14]))
							{
								TASK::TASK_SMART_FLEE_PED(iLocal_755[14], PLAYER::PLAYER_PED_ID(), 100f, -1, false, false);
								PED::SET_PED_KEEP_TASK(iLocal_755[14], true);
								ENTITY::SET_PED_AS_NO_LONGER_NEEDED(&iLocal_755[14]);
							}
...
void func_9(int iParam0, int iParam1, BOOL bParam2) // Position - 0x24EE
{
	...
	for (i = 0; i < Global_75457; i = i + 1)
	{
		...
		{
			if (bParam2)
				Global_75458[i].f_1 = iParam1;
			else
				Global_75458[i].f_1 = Global_75458[i].f_1 + iParam1;
...
void func_12(int iParam0) // Position - 0x267C
{
	...
	if (iParam0 == 1)
	{
		if (bLocal_262 == false)
		{
			...
			{
				if (HUD::DOES_BLIP_EXIST(iLocal_444[i].f_3))
					if (HUD::GET_BLIP_ALPHA(iLocal_444[i].f_3) < 255)
						HUD::REMOVE_BLIP(&(iLocal_444[i].f_3));
					else
						HUD::SET_BLIP_ALPHA(iLocal_444[i].f_3, 0);
			}
	...
	else if (bLocal_262)
	{
		for (i = 0; i < iLocal_444; i = i + 1)
		{
			if (HUD::DOES_BLIP_EXIST(iLocal_444[i].f_3))
			{
				HUD::SET_BLIP_ALPHA(iLocal_444[i].f_3, 255);
			}
			else
			{
				iLocal_444[i].f_3 = func_5(iLocal_444[i], false);
				HUD::SET_BLIP_HIDDEN_ON_LEGEND(iLocal_444[i].f_3, true);
				HUD::SET_BLIP_SCALE(iLocal_444[i].f_3, 0.4f);
				HUD::SET_BLIP_ALPHA(iLocal_444[i].f_3, 0);
				HUD::SET_BLIP_COLOUR(iLocal_444[i].f_3, 5);
				HUD::SHOW_HEIGHT_ON_BLIP(iLocal_444[i].f_3, false);
			}
		}
...
void func_17(Vehicle veParam0, int iParam1) // Position - 0x286E
{
	...
	for (i = 0; i < Global_75457; i = i + 1)
	{
		...
		{
			if (Global_75458[i].f_6 != veParam0)
			{
				Global_75458[i].f_6 = veParam0;
...
void func_27() // Position - 0x6C5E
{
	...
	if (iLocal_2511 == 7)
	{
		...
		iLocal_755[15] = PED::CREATE_PED(PED_TYPE_MISSION, joaat("A_M_Y_MethHead_01"), 2436.9011f, 4959.0996f, 45.8106f, 209.7559f, true, true);
		TASK::TASK_PLAY_ANIM(iLocal_755[15], "DEAD", "DEAD_C", 1000f, -1000f, -1, 1, 0, false, false, false);
		PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(iLocal_755[15], true, false);
		AUDIO::DISABLE_PED_PAIN_AUDIO(iLocal_755[15], true);
		iLocal_755[16] = PED::CREATE_PED(PED_TYPE_MISSION, joaat("A_M_M_Hillbilly_01"), 2440.266f, 4970.705f, 45.8306f, 15.7982f, true, true);
		TASK::TASK_PLAY_ANIM(iLocal_755[16], "DEAD", "DEAD_D", 1000f, -1000f, -1, 1, 0, false, false, false);
		PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(iLocal_755[16], true, false);
		AUDIO::DISABLE_PED_PAIN_AUDIO(iLocal_755[16], true);
		iLocal_755[17] = PED::CREATE_PED(PED_TYPE_MISSION, joaat("A_M_M_Hillbilly_02"), 2443.4197f, 4974.5234f, 45.8106f, 121.834f, true, true);
		TASK::TASK_PLAY_ANIM(iLocal_755[17], "DEAD", "DEAD_E", 1000f, -1000f, -1, 1, 0, false, false, false);
		PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(iLocal_755[17], true, false);
		AUDIO::DISABLE_PED_PAIN_AUDIO(iLocal_755[17], true);
		iLocal_755[18] = PED::CREATE_PED(PED_TYPE_MISSION, joaat("A_M_Y_MethHead_01"), 2448.8877f, 4971.5605f, 45.8106f, 194.7676f, true, true);
		TASK::TASK_PLAY_ANIM(iLocal_755[18], "DEAD", "DEAD_G", 1000f, -1000f, -1, 1, 0, false, false, false);
		PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(iLocal_755[18], true, false);
		AUDIO::DISABLE_PED_PAIN_AUDIO(iLocal_755[18], true);
	
		while (!ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_755[15], "DEAD", "DEAD_C", 3) || !ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_755[16], "DEAD", "DEAD_D", 3) || !ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_755[17], "DEAD", "DEAD_E", 3) || !ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_755[18], "DEAD", "DEAD_G", 3))
		{
			func_28(54343, 1);
			!PED::IS_PED_INJURED(iLocal_755[15]) && !PED::IS_PED_INJURED(iLocal_755[16]) && !PED::IS_PED_INJURED(iLocal_755[17]) && !PED::IS_PED_INJURED(iLocal_755[18]);
		}
	
		ENTITY::SET_ENTITY_HEALTH(iLocal_755[15], 0, 0);
		ENTITY::SET_ENTITY_HEALTH(iLocal_755[16], 0, 0);
		ENTITY::SET_ENTITY_HEALTH(iLocal_755[17], 0, 0);
		ENTITY::SET_ENTITY_HEALTH(iLocal_755[18], 0, 0);
...
void func_29(int iParam0, int iParam1, int iParam2) // Position - 0x71F8
{
	...
	num = iParam2;
	iLocal_755[num].f_1 = iParam0;
	iLocal_755[num].f_3 = iParam1;
	iLocal_755[num].f_2 = iParam2;
	iLocal_755[num].f_5 = 0;
	return;
}
...
int func_32(int iParam0, int iParam1) // Position - 0x72B0
{
	...
	for (i = 0; i < iLocal_2515; i = i + 1)
	{
		if (iLocal_2515[i].f_1 == 0)
		{
			iLocal_2515[i].f_1 = 1;
			iLocal_2515[i] = iParam0;
			iLocal_2515[i].f_2 = 0;
			iLocal_2515[i].f_3 = iParam1;
			iLocal_2515[i].f_4 = 0;
			iLocal_2515[i].f_5 = 0;
			return 1;
		}
...
BOOL func_35(char* sParam0, int iParam1, Ped pedParam2, char* sParam3, int iParam4, Ped pedParam5, char* sParam6, int iParam7, Ped pedParam8, char* sParam9, int iParam10, Ped pedParam11, char* sParam12, int iParam13) // Position - 0x73E0
{
	...
	{
		bLocal_3687 = true;
		uLocal_3478[0] = iParam1;
		uLocal_3478[0].f_1 = pedParam2;
		uLocal_3478[0].f_2 = sParam3;
		uLocal_3478[1] = iParam4;
		uLocal_3478[1].f_1 = pedParam5;
		uLocal_3478[1].f_2 = sParam6;
		uLocal_3478[2] = iParam7;
		uLocal_3478[2].f_1 = pedParam8;
		uLocal_3478[2].f_2 = sParam9;
		uLocal_3478[3] = iParam10;
		uLocal_3478[3].f_1 = pedParam11;
		uLocal_3478[3].f_2 = sParam12;
...
BOOL func_80(Vehicle veParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, float fParam7) // Position - 0x87C5
{
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(veParam0, false))
	{
		...
		num = Vector3(func_82(uParam1 - uParam4));
		unk3 = Vector3(num);
		unk18 = 4;
		num = -unk3.f_1;
		num.f_1 = unk3;
...
void func_85() // Position - 0x8C69
{
	...
	{
		if (!PED::IS_PED_INJURED(iLocal_755[i]) && !PED::IS_PED_DEAD_OR_DYING(iLocal_755[i], true) || iLocal_1619[i].f_3 == 1)
		{
			switch (iLocal_1619[i].f_3)
			{
				case 1:
					switch (iLocal_755[i].f_1)
					{
						case 1:
							switch (iLocal_755[i].f_2)
							{
								case 2:
									if (func_107(i, joaat("A_M_M_Hillbilly_01"), 2451.8179f, 4985.704f, 50.5678f, 227.842f, joaat("WEAPON_ASSAULTRIFLE"), true, 0))
									{
										func_106(&iLocal_1619, i, iLocal_755[i], 0, 1, 0);
										func_105(i, 5, 0, 0);
									}
									break;
								...
								case 6:
									...
									{
										func_106(&iLocal_1619, i, iLocal_755[i], 0, 0, 0);
										func_105(i, 7, 0, 0);
										iLocal_755[i].f_4 = 7;
									}
									break;
								...
								case 3:
									...
									{
										func_106(&iLocal_1619, i, iLocal_755[i], 1, 0, 0);
										func_105(i, 16, 0, 0);
									}
									break;
								...
								case 0:
									...
									{
										func_106(&iLocal_1619, i, iLocal_755[i], 1, 1, 0);
										func_105(i, 15, 0, 0);
									}
									break;
								...
								case 4:
									if (iLocal_2511 == 3)
									{
										...
										{
											iLocal_755[i].f_20 = OBJECT::CREATE_OBJECT(joaat("prop_cs_fertilizer"), 2460.098f, 4957.2827f, 44.1304f, true, true, false);
											iLocal_755[i].f_5 = 1;
											func_105(i, 3, 0, 0);
										}
									}
									...
									{
										func_106(&iLocal_1619, i, iLocal_755[i], 0, 0, 0);
										iLocal_755[i].f_20 = OBJECT::CREATE_OBJECT(joaat("prop_cs_fertilizer"), 2478.4443f, 4976.9214f, 44.5614f, true, true, false);
										iLocal_755[i].f_5 = 1;
										func_105(i, 2, 0, 0);
									}
									break;
								...
								case 5:
									if (iLocal_2511 == 3)
									{
										...
										{
											iLocal_755[i].f_20 = OBJECT::CREATE_OBJECT(joaat("prop_cs_fertilizer"), 2455.7527f, 4952.7188f, 44.1445f, true, true, false);
											iLocal_755[i].f_5 = 1;
											func_105(i, 3, 0, 0);
										}
									}
									...
									{
										func_106(&iLocal_1619, i, iLocal_755[i], 0, 0, 0);
										iLocal_755[i].f_20 = OBJECT::CREATE_OBJECT(joaat("prop_cs_fertilizer"), 2476.5815f, 4978.4917f, 44.5734f, true, true, false);
										iLocal_755[i].f_5 = iLocal_755[i].f_5 + 1;
										func_105(i, 2, 0, 0);
									}
									break;
								...
								case 8:
									...
									{
										func_106(&iLocal_1619, i, iLocal_755[i], 0, 0, 0);
										iLocal_755[i].f_14 = PED::CREATE_SYNCHRONIZED_SCENE(2505.451f, 4970.663f, 43.548f, 0f, 0f, 88.725f, 2);
										func_104(iLocal_755[i], 20f, 5f, 90f, -90f, 60f);
										AUDIO::SET_AMBIENT_VOICE_NAME(iLocal_755[i], "A_M_M_HillBilly_02_WHITE_MINI_02");
										TASK::TASK_SYNCHRONIZED_SCENE(iLocal_755[i], iLocal_755[i].f_14, "misschinese2_bank5", "peds_shootcans_a", 1000f, -4f, 1, 0, 1148846080, 0);
										PED::SET_SYNCHRONIZED_SCENE_LOOPED(iLocal_755[i].f_14, true);
										PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(iLocal_755[i], false, false);
										func_105(i, 4, 0, iLocal_755[i].f_14);
										func_32(7, 0);
									}
									break;
								...
								case 9:
									...
									{
										iLocal_755[i].f_14 = PED::CREATE_SYNCHRONIZED_SCENE(2507.879f, 4970.188f, 43.5f, 0f, 0f, 93.42f, 2);
										PED::SET_SYNCHRONIZED_SCENE_LOOPED(iLocal_755[i].f_14, true);
										func_106(&iLocal_1619, i, iLocal_755[i], 0, 0, 0);
										TASK::TASK_SYNCHRONIZED_SCENE(iLocal_755[i], iLocal_755[i].f_14, "misschinese2_bank5", "peds_shootcans_b", 1000f, -4f, 1, 0, 1148846080, 0);
										PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(iLocal_755[i], false, false);
										func_105(i, 4, 0, iLocal_755[i].f_14);
									}
									break;
							...
							if (ENTITY::DOES_ENTITY_EXIST(iLocal_755[i]))
							{
								ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(iLocal_755[i], true, 1);
								PED::SET_PED_TO_LOAD_COVER(iLocal_755[i], true);
							}
							break;
						...
						case 2:
							switch (iLocal_755[i].f_2)
							{
								...
								case 17:
									...
									{
										PED::SET_PED_ACCURACY(iLocal_755[i], 5);
										func_105(i, 25, 0, 0);
										func_106(&iLocal_1619, i, iLocal_755[i], 0, 1, 0);
									}
									break;
							...
							if (!PED::IS_PED_INJURED(iLocal_755[i]))
								ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(iLocal_755[i], true, 1);
							break;
					...
					if (!PED::IS_PED_INJURED(iLocal_755[i]))
					{
						ENTITY::SET_ENTITY_SHOULD_FREEZE_WAITING_ON_COLLISION(iLocal_755[i], true);
						iLocal_1619[i].f_3 = 3;
						i = i - 1;
					}
					break;
				...
				case 3:
					if (iLocal_1619[i].f_3 <= 3)
					{
						switch (iLocal_755[i].f_3)
						{
							case 3:
								switch (iLocal_755[i].f_5)
								{
									case 0:
										if (ENTITY::DOES_ENTITY_EXIST(iLocal_755[i].f_20))
										{
											if (ENTITY::DOES_ENTITY_HAVE_DRAWABLE(iLocal_755[i].f_20) && ENTITY::DOES_ENTITY_HAVE_PHYSICS(iLocal_755[i].f_20))
											{
												ENTITY::ATTACH_ENTITY_TO_ENTITY(iLocal_755[i].f_20, iLocal_755[i], PED::GET_PED_BONE_INDEX(iLocal_755[i], 60309), 0f, 0f, 0f, 0f, 0f, 0f, true, true, false, false, 2, true, 0);
												iLocal_755[i].f_5 = iLocal_755[i].f_5 + 1;
											}
										
											if (ENTITY::DOES_ENTITY_EXIST(iLocal_755[i].f_20))
											{
												if (iLocal_755[i].f_2 == 4)
													TASK::TASK_PLAY_ANIM(iLocal_755[i], "misschinese2_barrelroll", "barrel_roll_loop_B", 1000f, -1f, -1, 1, 0, false, false, false);
												else
													TASK::TASK_PLAY_ANIM(iLocal_755[i], "misschinese2_barrelroll", "barrel_roll_loop_A", 1000f, -1f, -1, 1, 0, false, false, false);
							...
							case 2:
								if (iLocal_755[i].f_5 < 7)
									func_103(iLocal_755[i], &(iLocal_755[i].f_25), -1, 0, true, false, -1082130432, 0, -1, -1, true, false, false);
							
								if (ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_755[i], "misschinese2_barrelroll", "barrel_roll_loop_B", 3))
									ENTITY::SET_ENTITY_ANIM_SPEED(iLocal_755[i], "misschinese2_barrelroll", "barrel_roll_loop_B", 1.4f);
							
								if (ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_755[i], "misschinese2_barrelroll", "barrel_roll_loop_A", 3))
									ENTITY::SET_ENTITY_ANIM_SPEED(iLocal_755[i], "misschinese2_barrelroll", "barrel_roll_loop_A", 1.4f);
							
								if (ENTITY::DOES_ENTITY_EXIST(iLocal_755[i].f_20))
								{
									if (iLocal_755[i].f_5 > 2 && iLocal_755[i].f_5 <= 6)
									{
										if (ENTITY::IS_ENTITY_ATTACHED(iLocal_755[i].f_20))
										{
											iLocal_755[i].f_12 = func_102(ENTITY::GET_ENTITY_COORDS(iLocal_755[i], true), iLocal_755[i].f_6, 1) - ENTITY::GET_ENTITY_HEADING(iLocal_755[i]);
											iLocal_755[i].f_12 = func_101(iLocal_755[i].f_12 / 4f, -15f, 15f);
										
											if (!PED::IS_PED_RAGDOLL(iLocal_755[i]))
												ENTITY::SET_ENTITY_HEADING(iLocal_755[i], ENTITY::GET_ENTITY_HEADING(iLocal_755[i]) + (SYSTEM::TIMESTEP() * iLocal_755[i].f_12));
										}
									}
								}
								...
								switch (iLocal_755[i].f_5)
								{
									...
									case 1:
										if (ENTITY::DOES_ENTITY_EXIST(iLocal_755[i].f_20))
										{
											if (func_73(iLocal_755[i], 2495.7786f, 5004.715f, 43.873367f, true) < 99f)
											{
												if (iLocal_755[i].f_2 == 4)
													TASK::TASK_PLAY_ANIM(iLocal_755[i], "misschinese2_barrelroll", "barrel_roll_loop_B", 1000f, -1f, -1, 1, 0, false, false, false);
												else
									...
									case 2:
										if (ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_755[i], "misschinese2_barrelroll", "barrel_roll_loop_B", 3) || ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_755[i], "misschinese2_barrelroll", "barrel_roll_loop_A", 3))
										{
											iLocal_755[i].f_6 = Vector3(2466.9026f, 4996.254f, 45.5443f);
											iLocal_755[i].f_5 = iLocal_755[i].f_5 + 1;
										}
										break;
								
									case 3:
										if (ENTITY::IS_ENTITY_AT_COORD(iLocal_755[i], iLocal_755[i].f_6, 1.5f, 1.5f, 2f, false, true, 0))
										{
											iLocal_755[i].f_6 = Vector3(2461.3323f, 4998.94f, 45.359f);
											iLocal_755[i].f_5 = iLocal_755[i].f_5 + 1;
										}
										break;
									...
									case 4:
										if (ENTITY::IS_ENTITY_AT_COORD(iLocal_755[i], iLocal_755[i].f_6, 1.5f, 1.5f, 2f, false, true, 0))
										{
											iLocal_755[i].f_6 = Vector3(2455.9841f, 4997.4043f, 45.2645f);
											iLocal_755[i].f_5 = iLocal_755[i].f_5 + 1;
										}
										break;
									...
									case 5:
										if (ENTITY::IS_ENTITY_AT_COORD(iLocal_755[i], iLocal_755[i].f_6, 1.5f, 1.5f, 2f, false, true, 0))
										{
											if (iLocal_755[i].f_2 == 5)
											{
												iLocal_755[i].f_6 = Vector3(2452.0906f, 4993.674f, 45.1404f);
												iLocal_755[i].f_5 = iLocal_755[i].f_5 + 1;
											}
											else
											{
												iLocal_755[i].f_6 = Vector3(2454.0906f, 4995.674f, 45.1404f);
												iLocal_755[i].f_5 = iLocal_755[i].f_5 + 1;
											}
										}
										break;
									...
									case 6:
										...
										{
											if (ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_755[i], "misschinese2_barrelroll", "barrel_roll_loop_B", 3))
												TASK::STOP_ANIM_TASK(iLocal_755[i], "misschinese2_barrelroll", "barrel_roll_loop_B", -1.5f);
										
											if (ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_755[i], "misschinese2_barrelroll", "barrel_roll_loop_A", 3))
												TASK::STOP_ANIM_TASK(iLocal_755[i], "misschinese2_barrelroll", "barrel_roll_loop_A", -1.5f);
										
											iLocal_755[i].f_6 = Vector3( 0f, 0f, 0f );
										
											if (ENTITY::DOES_ENTITY_EXIST(iLocal_755[i].f_20))
												ENTITY::DETACH_ENTITY(iLocal_755[i].f_20, false, true);
										
											if (func_74(veLocal_2507))
											{
												if (iLocal_755[i].f_2 == 4)
												{
													PED::SET_PED_MOVEMENT_CLIPSET(iLocal_755[i], "move_m@gangster@var_e", 1048576000);
													TASK::TASK_ENTER_VEHICLE(iLocal_755[i], veLocal_2507, -1, -1, 1f, 1, 0);
													func_105(func_18(6), 14, 0, 0);
													func_105(func_18(7), 33, 0, 0);
												}
												else
												{
													PED::SET_PED_MOVEMENT_CLIPSET(iLocal_755[i], "move_m@gangster@var_f", 1048576000);
													TASK::TASK_ENTER_VEHICLE(iLocal_755[i], veLocal_2507, -1, 0, 1f, 1, 0);
												}
											}
									...
									case 7:
										...
										if (PED::IS_PED_IN_ANY_VEHICLE(iLocal_755[i], false))
										{
											ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(iLocal_755[i], false, 1);
											iLocal_755[i].f_5 = iLocal_755[i].f_5 + 1;
										}
										break;
												...
												if (iLocal_755[i].f_2 == 4)
												{
													if (!VEHICLE::IS_VEHICLE_SEAT_FREE(veLocal_2507, 0, false))
													{
														...
														if (num >= 0)
														{
															if (!PED::IS_PED_INJURED(iLocal_755[num]))
															{
																if (PED::IS_PED_SITTING_IN_ANY_VEHICLE(iLocal_755[num]))
																{
																	func_99();
							...
							case 5:
								switch (iLocal_755[i].f_5)
								{
									...
									case 1:
										if (TASK::GET_SCRIPT_TASK_STATUS(iLocal_755[i], SCRIPT_TASK_PERFORM_SEQUENCE) == 7)
										{
											func_105(i, 7, 0, 9000);
											num2 = 1;
							...
							case 6:
								if (TASK::GET_SCRIPT_TASK_STATUS(iLocal_755[i], SCRIPT_TASK_START_SCENARIO_IN_PLACE) == 7 && iLocal_755[i].f_5 > 1)
									iLocal_755[i].f_5 = 0;
							
								switch (iLocal_755[i].f_5)
								{
									case 0:
										WEAPON::SET_CURRENT_PED_WEAPON(iLocal_755[i], joaat("WEAPON_UNARMED"), true);
										TASK::TASK_ACHIEVE_HEADING(iLocal_755[i], 219f, 1500);
										iLocal_755[i].f_5 = iLocal_755[i].f_5 + 1;
										break;
								
									case 1:
										if (TASK::GET_SCRIPT_TASK_STATUS(iLocal_755[i], SCRIPT_TASK_ACHIEVE_HEADING) == 7)
										{
											TASK::TASK_START_SCENARIO_IN_PLACE(iLocal_755[i], "WORLD_HUMAN_GUARD_STAND_ARMY", 0, false);
											iLocal_755[i].f_5 = iLocal_755[i].f_5 + 1;
										}
										break;
								}
							...
							case 32:
								if (!PED::IS_PED_INJURED(iLocal_755[i]))
								{
									if (iLocal_755[i].f_1 == 1 || func_4(PLAYER::PLAYER_PED_ID(), iLocal_755[i], true) < 20f)
										func_103(iLocal_755[i], &(iLocal_755[i].f_25), -1, 0, true, false, -1082130432, 0, -1, -1, true, false, false);
									...
									{
										case 0:
											TASK::TASK_START_SCENARIO_IN_PLACE(iLocal_755[i], "WORLD_HUMAN_AA_SMOKE", iLocal_755[i].f_14, false);
											iLocal_755[i].f_5 = iLocal_755[i].f_5 + 1;
											break;
									
										case 1:
											if (func_4(PLAYER::PLAYER_PED_ID(), iLocal_755[i], true) < 10f)
											{
												randomIntInRange = MISC::GET_RANDOM_INT_IN_RANGE(0, 3);
											
												if (randomIntInRange == 0)
													AUDIO::PLAY_PED_AMBIENT_SPEECH_WITH_VOICE_NATIVE(iLocal_755[i], "GENERIC_CURSE_MED", "A_M_M_Hillbilly_01_White_mini_03", "SPEECH_PARAMS_FORCE_SHOUTED", false);
												else if (randomIntInRange == 1)
													AUDIO::PLAY_PED_AMBIENT_SPEECH_WITH_VOICE_NATIVE(iLocal_755[i], "GENERIC_INSULT_MED", "A_M_M_Hillbilly_01_White_mini_03", "SPEECH_PARAMS_FORCE_SHOUTED", false);
												else
													AUDIO::PLAY_PED_AMBIENT_SPEECH_WITH_VOICE_NATIVE(iLocal_755[i], "CHAT_STATE", "A_M_M_Hillbilly_01_White_mini_03", "SPEECH_PARAMS_FORCE_SHOUTED", false);
											
												iLocal_755[i].f_5 = iLocal_755[i].f_5 + 1;
												iLocal_755[i].f_14 = MISC::GET_GAME_TIMER() + MISC::GET_RANDOM_INT_IN_RANGE(5000, 10000);
											}
											break;
									
										case 2:
											if (MISC::GET_GAME_TIMER() > iLocal_755[i].f_14)
												iLocal_755[i].f_5 = 1;
											break;
									
										case 10:
											if (func_35("CHI2_hear", 8, iLocal_755[i], "ONEILGUARD1", -1, 0, 0, -1, 0, 0, -1, 0, 0, 8))
											{
												iLocal_755[i].f_5 = iLocal_755[i].f_5 + 1;
												iLocal_755[i].f_14 = MISC::GET_GAME_TIMER() + 1000;
											}
											break;
										...
										case 11:
											if (MISC::GET_GAME_TIMER() > iLocal_755[i].f_14)
											{
												TASK::TASK_TURN_PED_TO_FACE_COORD(iLocal_755[i], ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), 5000);
												iLocal_755[i].f_5 = iLocal_755[i].f_5 + 1;
												iLocal_755[i].f_14 = MISC::GET_GAME_TIMER() + 5000;
											}
											break;
									
										case 12:
											if (PLAYER::CAN_PED_HEAR_PLAYER(PLAYER::PLAYER_ID(), iLocal_755[i]) && func_73(iLocal_755[i], 2448.0027f, 4982.305f, 45.8519f, true) < 10f)
											{
												if (MISC::GET_GAME_TIMER() > iLocal_755[i].f_14 - 3000)
												{
													TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(iLocal_755[i], ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), 1f, 20000, 1048576000, 0, 1193033728);
													iLocal_755[i].f_5 = 15;
												}
											}
											else if (MISC::GET_GAME_TIMER() > iLocal_755[i].f_14)
											{
												if (func_35("CHI2_nope", 8, iLocal_755[i], "ONEILGUARD1", -1, 0, 0, -1, 0, 0, -1, 0, 0, 8))
													iLocal_755[i].f_5 = iLocal_755[i].f_5 + 1;
											}
											break;
										...
										case 13:
											...
											func_98(&iLocal_755[i], false);
											iLocal_755[i].f_14 = MISC::GET_GAME_TIMER() + 3000;
											iLocal_755[i].f_5 = iLocal_755[i].f_5 + 1;
											break;
									
										case 14:
											if (MISC::GET_GAME_TIMER() > iLocal_755[i].f_14 || TASK::GET_SCRIPT_TASK_STATUS(iLocal_755[i], SCRIPT_TASK_PERFORM_SEQUENCE) == 7)
												iLocal_755[i].f_5 = 0;
											break;
										...
										case 16:
											if (TASK::GET_SCRIPT_TASK_STATUS(iLocal_755[i], SCRIPT_TASK_FOLLOW_NAV_MESH_TO_COORD) == 7)
											{
												iLocal_755[i].f_14 = MISC::GET_GAME_TIMER() + 3000;
												iLocal_755[i].f_5 = 12;
											}
								...
								switch (iLocal_755[i].f_5)
								{
									...
									case 1:
										if (MISC::GET_GAME_TIMER() > iLocal_755[i].f_14)
										{
											if (func_74(veLocal_2507))
											{
												TASK::TASK_ENTER_VEHICLE(iLocal_755[i], veLocal_2507, 20000, 1, 1f, 1, 0);
												iLocal_755[i].f_5 = iLocal_755[i].f_5 + 1;
												iLocal_755[i].f_14 = 0;
												iLocal_755[i].f_15 = 0;
											}
							...
							case 7:
								...
								switch (iLocal_755[i].f_5)
								{
									case 0:
										...
										if (WEAPON::GET_CURRENT_PED_WEAPON(iLocal_755[i], &weaponHash, true))
											TASK::TASK_SWAP_WEAPON(iLocal_755[i], false);
									...
									case 1:
										if (!WEAPON::GET_CURRENT_PED_WEAPON(iLocal_755[i], &weaponHash, true))
										{
											...
											if (i == 1)
												if (!PED::IS_PED_INJURED(iLocal_755[2]))
													TASK::TASK_TURN_PED_TO_FACE_ENTITY(0, iLocal_755[2], 2000);
											else if (i == 2)
												if (!PED::IS_PED_INJURED(iLocal_755[1]))
													TASK::TASK_TURN_PED_TO_FACE_ENTITY(0, iLocal_755[1], 2000);
											else if (i == 6)
												if (!PED::IS_PED_INJURED(iLocal_755[7]))
													TASK::TASK_TURN_PED_TO_FACE_ENTITY(0, iLocal_755[7], 2000);
											else if (i == 7)
												if (!PED::IS_PED_INJURED(iLocal_755[6]))
													TASK::TASK_TURN_PED_TO_FACE_ENTITY(0, iLocal_755[6], 2000);
										
											if (iLocal_755[i].f_14 != 0)
												TASK::TASK_START_SCENARIO_IN_PLACE(0, "WORLD_HUMAN_HANG_OUT_STREET", iLocal_755[i].f_14, false);
											else
												TASK::TASK_START_SCENARIO_IN_PLACE(0, "WORLD_HUMAN_HANG_OUT_STREET", 0, false);
										
											func_98(&iLocal_755[i], false);
											iLocal_755[i].f_5 = iLocal_755[i].f_5 + 1;
											iLocal_755[i].f_15 = MISC::GET_GAME_TIMER() + 15000;
										}
										break;
								
									case 2:
										if (TASK::GET_SCRIPT_TASK_STATUS(iLocal_755[i], SCRIPT_TASK_PERFORM_SEQUENCE) == 7 || MISC::GET_GAME_TIMER() > iLocal_755[i].f_15)
										{
											TASK::CLEAR_PED_TASKS(iLocal_755[i]);
											iLocal_755[i].f_5 = iLocal_755[i].f_5 + 1;
										}
										break;
									...
									case 3:
										if (TASK::GET_SCRIPT_TASK_STATUS(iLocal_755[i], SCRIPT_TASK_PERFORM_SEQUENCE) == 7)
										{
											if (iLocal_755[i].f_4 == 5)
											{
												TASK::TASK_SWAP_WEAPON(iLocal_755[i], true);
												iLocal_755[i].f_5 = iLocal_755[i].f_5 + 1;
											}
											else
											{
									...
									case 4:
										if (TASK::GET_SCRIPT_TASK_STATUS(iLocal_755[i], SCRIPT_TASK_SWAP_WEAPON) == 7)
											if (iLocal_755[i].f_4 == 5)
												func_105(i, iLocal_755[i].f_4, 2, 0);
											else
												func_105(i, iLocal_755[i].f_4, 0, 0);
										break;
								}
								break;
							...
							case 13:
								...
								{
									case 0:
										TASK::TASK_START_SCENARIO_IN_PLACE(iLocal_755[i], "WORLD_HUMAN_GUARD_STAND", 0, false);
										PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(iLocal_755[i], false, false);
										iLocal_755[i].f_5 = iLocal_755[i].f_5 + 1;
										break;
								}
							...
							case 14:
								...
								{
									case 0:
										TASK::TASK_START_SCENARIO_IN_PLACE(iLocal_755[i], "WORLD_HUMAN_AA_SMOKE", 0, false);
										PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(iLocal_755[i], false, false);
										iLocal_755[i].f_5 = iLocal_755[i].f_5 + 1;
										break;
								
									case 1:
										if (TASK::GET_SCRIPT_TASK_STATUS(iLocal_755[i], SCRIPT_TASK_START_SCENARIO_IN_PLACE) == 7)
											iLocal_755[i].f_5 = 0;
										break;
								}
								break;
							...
							case 15:
								...
								{
									case 0:
										TASK::TASK_START_SCENARIO_IN_PLACE(iLocal_755[i], "WORLD_HUMAN_BINOCULARS", 0, false);
										PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(iLocal_755[i], false, false);
										iLocal_755[i].f_5 = iLocal_755[i].f_5 + 1;
										break;
								}
							...
							case 16:
								...
								{
									case 0:
										TASK::TASK_START_SCENARIO_IN_PLACE(iLocal_755[i], "WORLD_HUMAN_DRINKING", 0, false);
										PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(iLocal_755[i], false, false);
										iLocal_755[i].f_5 = iLocal_755[i].f_5 + 1;
										break;
								}
							...
							case 17:
								if (iLocal_755[i].f_5 < 10)
									if (PLAYER::CAN_PED_HEAR_PLAYER(PLAYER::PLAYER_ID(), iLocal_755[i]))
										iLocal_755[i].f_5 = 10;
								...
								switch (iLocal_755[i].f_5)
								{
									...
									case 1:
										...
										{
											TASK::TASK_START_SCENARIO_IN_PLACE(iLocal_755[i], "WORLD_HUMAN_DRINKING", 0, true);
											iLocal_755[i].f_5 = iLocal_755[i].f_5 + 1;
										}
										break;
								
									case 2:
										if (func_4(PLAYER::PLAYER_PED_ID(), iLocal_755[i], true) < 21.6f)
										{
											TASK::TASK_PLAY_ANIM(iLocal_755[i], "misscarsteal2peeing", "peeing_loop", 8f, -8f, 25000, 1, 0, false, false, false);
											iLocal_755[i].f_5 = iLocal_755[i].f_5 + 1;
											iLocal_755[i].f_14 = MISC::GET_GAME_TIMER() + 23000;
										}
										break;
							...
							case 25:
								switch (iLocal_755[i].f_5)
								{
									case 0:
										switch (iLocal_755[i].f_2)
										{
											case 12:
												...
												{
													TASK::TASK_USE_NEAREST_SCENARIO_TO_COORD_WARP(iLocal_755[i], 2433.04f, 4967.87f, 46.28f, 0.8f, 0);
													iLocal_755[i].f_5 = iLocal_755[i].f_5 + 1;
												}
												break;
											...
											case 13:
												...
												{
													TASK::TASK_USE_NEAREST_SCENARIO_TO_COORD_WARP(iLocal_755[i], 2432.56f, 4968.38f, 46.27f, 0.8f, 0);
													iLocal_755[i].f_5 = iLocal_755[i].f_5 + 1;
												}
												break;
											...
											case 14:
												...
												{
													TASK::TASK_USE_NEAREST_SCENARIO_TO_COORD_WARP(iLocal_755[i], 2433.12f, 4965.59f, 46.27f, 0.8f, 0);
													iLocal_755[i].f_5 = iLocal_755[i].f_5 + 1;
												}
												break;
											...
											case 15:
												...
												{
													TASK::TASK_USE_NEAREST_SCENARIO_TO_COORD_WARP(iLocal_755[i], 2439.697f, 4960.996f, 46.28f, 0.4f, 0);
													iLocal_755[i].f_5 = iLocal_755[i].f_5 + 1;
												}
												break;
											...
											case 16:
												...
												{
													TASK::TASK_USE_NEAREST_SCENARIO_TO_COORD_WARP(iLocal_755[i], 2440.16f, 4962.99f, 46.27f, 0.4f, 0);
													iLocal_755[i].f_5 = iLocal_755[i].f_5 + 1;
												}
												break;
											...
											case 17:
												...
												{
													TASK::TASK_USE_NEAREST_SCENARIO_TO_COORD_WARP(iLocal_755[i], 2438.23f, 4962.25f, 46.27f, 0.4f, 0);
													iLocal_755[i].f_5 = iLocal_755[i].f_5 + 1;
												}
												break;
										}
									...
									case 1:
										if (TASK::GET_SCRIPT_TASK_STATUS(iLocal_755[i], SCRIPT_TASK_USE_NEAREST_SCENARIO_TO_POS) == 7)
											iLocal_755[i].f_5 = 0;
										break;
								}
								break;
							...
							case 28:
								...
								{
									case 0:
										if (PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), iLocal_755[i]) || func_96(ENTITY::GET_ENTITY_COORDS(iLocal_755[i], true), 1f, 1120403456) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 2448.5833f, 4969.292f, 45.185604f, 2439.5383f, 4978.061f, 46.827618f, 5.75f, false, true, 0))
										{
											TASK::TASK_HANDS_UP(iLocal_755[i], 20000, 0, -1, 0);
											iLocal_755[i].f_5 = 2;
										}
										break;
								
									case 2:
										if (func_35("WRK1", 1, iLocal_755[i], "CHIN2Goon2", -1, 0, 0, -1, 0, 0, -1, 0, 0, 8))
											iLocal_755[i].f_5 = iLocal_755[i].f_5 + 1;
										break;
									...
									case 3:
										if (PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), iLocal_755[i]) || func_96(ENTITY::GET_ENTITY_COORDS(iLocal_755[i], true), 1f, 1120403456) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 2448.5833f, 4969.292f, 45.185604f, 2439.5383f, 4978.061f, 46.827618f, 5.75f, false, true, 0))
										{
											...
											{
												iLocal_755[i].f_5 = iLocal_755[i].f_5 + 1;
												iLocal_755[i].f_14 = MISC::GET_GAME_TIMER() + 2000;
											}
										}
										else
										{
									...
									case 4:
										if (MISC::GET_GAME_TIMER() > iLocal_755[i].f_14)
										{
											TASK::TASK_SMART_FLEE_PED(iLocal_755[i], PLAYER::PLAYER_PED_ID(), 200f, 200000, false, false);
											PED::SET_PED_KEEP_TASK(iLocal_755[i], true);
											ENTITY::SET_PED_AS_NO_LONGER_NEEDED(&iLocal_755[i]);
											iLocal_755[i].f_5 = iLocal_755[i].f_5 + 1;
										}
										break;
								}
							...
							case 30:
								if (!PED::IS_PED_INJURED(iLocal_755[i]))
								{
									if (iLocal_755[i].f_5 < 8)
									{
										if (WEAPON::HAS_PED_BEEN_DAMAGED_BY_WEAPON(iLocal_755[i], 0, 2))
										{
											if (!WEAPON::HAS_PED_GOT_WEAPON(iLocal_755[i], 0, 2))
											{
												WEAPON::GIVE_WEAPON_TO_PED(iLocal_755[i], joaat("WEAPON_PISTOL"), -1, false, true);
												TASK::TASK_COMBAT_PED(iLocal_755[i], PLAYER::PLAYER_PED_ID(), 0, 16);
												func_94();
												PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_755[i], false);
												TASK::TASK_COMBAT_PED(iLocal_755[i], PLAYER::PLAYER_PED_ID(), 0, 16);
												PED::SET_PED_RELATIONSHIP_GROUP_HASH(iLocal_755[i], hLocal_1616);
												iLocal_755[i].f_5 = 999;
											}
										}
									}
								}
								...
								switch (iLocal_755[i].f_5)
								{
									case 0:
										...
										PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_755[i], true);
										PED::SET_PED_RELATIONSHIP_GROUP_HASH(iLocal_755[i], hLocal_1616);
										iLocal_755[i].f_5 = iLocal_755[i].f_5 + 1;
										break;
									...
									case 1:
										if (STREAMING::HAS_ANIM_DICT_LOADED("misschinese2_crystalmaze") && WEAPON::HAS_WEAPON_ASSET_LOADED(joaat("WEAPON_SAWNOFFSHOTGUN")))
										{
											if (!PED::IS_PED_INJURED(iLocal_755[i]))
											{
												...
												TASK::TASK_SYNCHRONIZED_SCENE(iLocal_755[i], iLocal_2875, "misschinese2_crystalmaze", "_cower_loop", 1000f, -8f, 0, 0, 1148846080, 0);
												...
												TASK::TASK_LOOK_AT_ENTITY(iLocal_755[i], PLAYER::PLAYER_PED_ID(), -1, 0, 2);
												iLocal_755[i].f_5 = iLocal_755[i].f_5 + 1;
											}
										}
										break;
									...
									case 3:
										...
										TASK::TASK_SYNCHRONIZED_SCENE(iLocal_755[i], iLocal_2874, "misschinese2_crystalmaze", "_cower_to_stand", 4f, -8f, 0, 0, 1148846080, 0);
										TASK::TASK_LOOK_AT_ENTITY(iLocal_755[i], PLAYER::PLAYER_PED_ID(), -1, 0, 2);
										iLocal_755[i].f_5 = iLocal_755[i].f_5 + 1;
										break;
								
									case 4:
										if (func_35("CHI2_DALE", 4, iLocal_755[i], "ONEIL" /*O'Neil Way*/, -1, 0, 0, -1, 0, 0, -1, 0, 0, 8))
											iLocal_755[i].f_5 = iLocal_755[i].f_5 + 1;
									...
									case 5:
										if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_2874) && PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_2874) > 0.98f || !PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_2874))
										{
											...
											TASK::TASK_SYNCHRONIZED_SCENE(iLocal_755[i], iLocal_2873, "misschinese2_crystalmaze", "_stand_loop", 4f, -8f, 0, 0, 1148846080, 0);
											iLocal_755[i].f_5 = iLocal_755[i].f_5 + 1;
											iLocal_755[i].f_14 = MISC::GET_GAME_TIMER() + MISC::GET_RANDOM_INT_IN_RANGE(1000, 2000);
										}
										break;
										...
										if (!PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_2876) || iLocal_2876 == 0)
										{
											if (MISC::GET_GAME_TIMER() > iLocal_755[i].f_14)
											{
												...
												if (MISC::GET_RANDOM_INT_IN_RANGE(0, 2) == 1)
													TASK::TASK_SYNCHRONIZED_SCENE(iLocal_755[i], iLocal_2876, "misschinese2_crystalmaze", "_stand_loop_a", 4f, -8f, 0, 0, 1148846080, 0);
												else
													TASK::TASK_SYNCHRONIZED_SCENE(iLocal_755[i], iLocal_2876, "misschinese2_crystalmaze", "_stand_loop_b", 4f, -8f, 0, 0, 1148846080, 0);
											}
										}
									...
									case 7:
										if (func_35("CHI2_DALEG", 4, iLocal_755[i], "ONEIL" /*O'Neil Way*/, -1, 0, 0, -1, 0, 0, -1, 0, 0, 8))
											iLocal_755[i].f_5 = iLocal_755[i].f_5 + 1;
										break;
								
									case 8:
										iLocal_2877 = PED::CREATE_SYNCHRONIZED_SCENE(2435.312f, 4967.087f, 41.35f, 0f, 0f, 11.4f, 2);
										TASK::TASK_SYNCHRONIZED_SCENE(iLocal_755[i], iLocal_2877, "misschinese2_crystalmaze", "_stand_to_aim", 4f, -8f, 0, 0, 1148846080, 0);
										WEAPON::GIVE_WEAPON_OBJECT_TO_PED(obLocal_2878, iLocal_755[i]);
										iLocal_755[i].f_5 = iLocal_755[i].f_5 + 1;
										break;
									...
									case 9:
										...
										{
											PED::SET_PED_TARGET_LOSS_RESPONSE(iLocal_755[i], 1);
											TASK::CLEAR_PED_TASKS(iLocal_755[i]);
											TASK::TASK_AIM_GUN_AT_ENTITY(iLocal_755[i], PLAYER::PLAYER_PED_ID(), -1, true);
											iLocal_755[i].f_5 = iLocal_755[i].f_5 + 1;
										}
										break;
									...
									case 10:
										if (!_CONVERSATION_IS_DIALOGUE_IN_PROGRESS())
										{
											if (func_35("CHI2_DALEA", 4, iLocal_755[i], "ONEIL" /*O'Neil Way*/, -1, 0, 0, -1, 0, 0, -1, 0, 0, 8))
											{
												PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_755[i], false);
												TASK::TASK_COMBAT_PED(iLocal_755[i], PLAYER::PLAYER_PED_ID(), 0, 16);
												iLocal_755[i].f_14 = MISC::GET_GAME_TIMER() + MISC::GET_RANDOM_INT_IN_RANGE(3000, 4000);
												iLocal_755[i].f_15 = 0;
												iLocal_755[i].f_5 = iLocal_755[i].f_5 + 1;
											}
										}
									...
									case 11:
										if (MISC::GET_GAME_TIMER() > iLocal_755[i].f_14)
										{
											if (iLocal_755[i].f_15 < 4)
											{
												if (func_35("CHI2_DALEA", 4, iLocal_755[i], "ONEIL" /*O'Neil Way*/, -1, 0, 0, -1, 0, 0, -1, 0, 0, 8))
												{
													iLocal_755[i].f_5 = iLocal_755[i].f_5 + 1;
													iLocal_755[i].f_14 = MISC::GET_GAME_TIMER() + MISC::GET_RANDOM_INT_IN_RANGE(3000, 4000);
													iLocal_755[i].f_15 = iLocal_755[i].f_15 + 1;
												}
											}
										}
										break;
							...
							case 31:
								if (!PED::IS_PED_INJURED(iLocal_755[i]))
									if (MISC::IS_BULLET_IN_AREA(ENTITY::GET_ENTITY_COORDS(iLocal_755[i], true), 2f, true))
										iLocal_755[i].f_5 = 5;
								...
								switch (iLocal_755[i].f_5)
								{
									...
									case 1:
										if (func_35("WRK2", 1, iLocal_755[i], "oneilcook", 2, PLAYER::PLAYER_PED_ID(), "trevor", -1, 0, 0, -1, 0, 0, 8))
										{
											iLocal_755[i].f_5 = iLocal_755[i].f_5 + 1;
											iLocal_755[i].f_14 = MISC::GET_GAME_TIMER() + 1300;
										}
										break;
									...
									case 5:
										TASK::TASK_SMART_FLEE_PED(iLocal_755[i], PLAYER::PLAYER_PED_ID(), 50f, 1000, false, false);
										iLocal_755[i].f_5 = iLocal_755[i].f_5 + 1;
										break;
							...
							case 27:
								switch (iLocal_755[i].f_5)
								{
									case 0:
										...
										if (HUD::DOES_BLIP_EXIST(iLocal_755[i].f_19))
											HUD::REMOVE_BLIP(&(iLocal_755[i].f_19));
							...
							case 4:
								if (iLocal_2881 == 1)
								{
									if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_755[i].f_14))
										PED::SET_SYNCHRONIZED_SCENE_PHASE(iLocal_755[i].f_14, 0.69f);
								...
								{
									if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_755[i].f_14))
										PED::SET_SYNCHRONIZED_SCENE_PHASE(iLocal_755[i].f_14, 0f);
								...
								if (iLocal_755[i].f_2 == 8)
								{
									if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_755[i].f_14))
									{
										if (iLocal_755[i].f_5 == 0)
										{
											if (!func_30(23) || iLocal_2511 == 3)
											{
												if (TASK::GET_SCRIPT_TASK_STATUS(iLocal_755[i], SCRIPT_TASK_SYNCHRONIZED_SCENE) == 1)
												{
													if (PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_755[i].f_14) > 0.024f && PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_755[i].f_14) < 0.033f)
													{
														num3 = 0;
														...
														if (!PED::IS_PED_INJURED(iLocal_755[i]))
														{
															...
															if (WEAPON::GET_CURRENT_PED_WEAPON(iLocal_755[i], &weaponHash2, true))
															{
																PED::SET_PED_ACCURACY(iLocal_755[i], 100);
															
																if (weaponHash2 == joaat("WEAPON_PISTOL"))
																{
																	if (func_86(&num3))
																	{
																		WEAPON::SET_AMMO_IN_CLIP(iLocal_755[i], joaat("WEAPON_PISTOL"), 12);
																		PED::SET_PED_SHOOTS_AT_COORD(iLocal_755[i], ENTITY::GET_ENTITY_COORDS(iLocal_2657[num3], true), false);
																		func_103(iLocal_755[i], &(iLocal_755[i].f_25), -1, 0, true, false, -1082130432, 0, -1, -1, true, false, false);
																		iLocal_755[i].f_5 = 1;
																	}
																	else
																	{
																		WEAPON::SET_AMMO_IN_CLIP(iLocal_755[i], joaat("WEAPON_PISTOL"), 12);
																		PED::SET_PED_SHOOTS_AT_COORD(iLocal_755[i], 2493.1f, 4971f, 44.9f, false);
																		func_103(iLocal_755[i], &(iLocal_755[i].f_25), -1, 0, true, false, -1082130432, 0, -1, -1, true, false, false);
																		iLocal_755[i].f_5 = 1;
																	}
																}
										...
										else if (iLocal_755[i].f_5 == 1)
										{
											if (PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_755[i].f_14) > 0.04f)
											{
												iLocal_755[i].f_5 = 2;
											
												if (iLocal_2879 == 0)
													AUDIO::PLAY_PED_AMBIENT_SPEECH_WITH_VOICE_NATIVE(iLocal_755[i], "generic_cheer", "A_M_M_Hillbilly_01_White_mini_02", "SPEECH_PARAMS_FORCE_SHOUTED", false);
											}
										}
										else if (iLocal_755[i].f_5 == 2)
										{
											if (PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_755[i].f_14) > 0.6f)
												iLocal_755[i].f_5 = 0;
										}
									}
								}
							
								if (iLocal_755[i].f_5 == 3)
									if (TASK::GET_SCRIPT_TASK_STATUS(iLocal_755[i], SCRIPT_TASK_GO_STRAIGHT_TO_COORD) == 7)
										func_105(i, 7, 0, 0);
								break;
						}
					}
				...
				case 6:
					if (iLocal_1619[i].f_20)
					{
						switch (iLocal_755[i].f_2)
						{
							...
							case 13:
							case 14:
								switch (iLocal_1619[i].f_4)
								{
									case 1:
										PED::SET_PED_ANGLED_DEFENSIVE_AREA(iLocal_755[i], 2431.704f, 4961.6196f, 45.331356f, 2455.3765f, 4985.9336f, 48.68555f, 13.5625f, false, false);
										TASK::TASK_COMBAT_PED(iLocal_755[i], PLAYER::PLAYER_PED_ID(), 0, 16);
										PED::SET_PED_TARGET_LOSS_RESPONSE(iLocal_755[i], 1);
										PED::SET_PED_COMBAT_ATTRIBUTES(iLocal_755[i], BF_CanCharge, true);
										iLocal_1619[i].f_4 = iLocal_1619[i].f_4 + 1;
										break;
								}
								break;
							...
							case 15:
								...
								{
									case 1:
										PED::SET_PED_ANGLED_DEFENSIVE_AREA(iLocal_755[i], 2437.982f, 4959.021f, 45.310574f, 2432.93f, 4961.9414f, 48.692562f, 3.1875f, false, false);
										TASK::TASK_COMBAT_PED(iLocal_755[i], PLAYER::PLAYER_PED_ID(), 0, 16);
										PED::SET_PED_TARGET_LOSS_RESPONSE(iLocal_755[i], 1);
										iLocal_1619[i].f_4 = iLocal_1619[i].f_4 + 1;
										break;
									...
									case 2:
										if (func_93(18))
										{
											PED::REMOVE_PED_DEFENSIVE_AREA(iLocal_755[i], false);
											iLocal_1619[i].f_4 = iLocal_1619[i].f_4 + 1;
										}
										break;
								}
							...
							case 11:
								switch (iLocal_1619[i].f_4)
								{
									case 1:
										...
										{
											PED::REMOVE_PED_DEFENSIVE_AREA(iLocal_755[i], false);
											PED::SET_PED_SPHERE_DEFENSIVE_AREA(iLocal_755[i], 2451.6775f, 4954.2515f, 44.988f, 3f, false, false);
											iLocal_1614 = iLocal_1614 + 1;
											iLocal_1619[i].f_4 = iLocal_1619[i].f_4 + 1;
										}
										else
										{
											iLocal_1619[i].f_4 = MISC::GET_GAME_TIMER() + (iLocal_1614 * 4000);
											iLocal_1614 = iLocal_1614 + 1;
										}
									...
									case 2:
										if (func_73(iLocal_755[i], 2451.6775f, 4954.2515f, 44.988f, true) < 3f)
										{
											PED::REMOVE_PED_DEFENSIVE_AREA(iLocal_755[i], false);
											iLocal_1619[i].f_4 = iLocal_1619[i].f_4 + 1;
										}
									...
									default:
										if (MISC::GET_GAME_TIMER() > iLocal_1619[i].f_4)
										{
											PED::REMOVE_PED_DEFENSIVE_AREA(iLocal_755[i], false);
											PED::SET_PED_SPHERE_DEFENSIVE_AREA(iLocal_755[i], 2451.6775f, 4954.2515f, 44.988f, 3f, false, false);
											iLocal_1619[i].f_4 = 2;
							...
							case 1:
								...
								{
									case 1:
										PED::SET_PED_ANGLED_DEFENSIVE_AREA(iLocal_755[i], 2453.084f, 4969.897f, 50.442852f, 2460.9956f, 4977.822f, 53.380352f, 2.9375f, false, false);
										TASK::TASK_COMBAT_PED(iLocal_755[i], PLAYER::PLAYER_PED_ID(), 0, 16);
										PED::SET_PED_TARGET_LOSS_RESPONSE(iLocal_755[i], 1);
										iLocal_1619[i].f_4 = iLocal_1619[i].f_4 + 1;
										break;
							...
							case 0:
								...
								{
									case 1:
										PED::SET_PED_ANGLED_DEFENSIVE_AREA(iLocal_755[i], 2442.9634f, 4964.2173f, 50.442852f, 2449.2507f, 4970.534f, 53.380352f, 2f, false, false);
										TASK::TASK_COMBAT_PED(iLocal_755[i], PLAYER::PLAYER_PED_ID(), 0, 16);
										PED::SET_PED_TARGET_LOSS_RESPONSE(iLocal_755[i], 1);
										iLocal_1619[i].f_4 = iLocal_1619[i].f_4 + 1;
										break;
							...
							case 2:
								...
								{
									case 1:
										PED::SET_PED_ANGLED_DEFENSIVE_AREA(iLocal_755[i], 2461.3623f, 4976.084f, 50.442852f, 2448.7432f, 4988.7744f, 53.601433f, 2f, false, false);
										TASK::TASK_COMBAT_PED(iLocal_755[i], PLAYER::PLAYER_PED_ID(), 0, 16);
										PED::SET_PED_TARGET_LOSS_RESPONSE(iLocal_755[i], 1);
										iLocal_1619[i].f_4 = iLocal_1619[i].f_4 + 1;
										break;
...
BOOL func_93(int iParam0) // Position - 0xC5B6
{
	...
	num = iParam0 - iLocal_3120[0];

	if (num >= 0 && num < iLocal_3120)
		if (iLocal_3120[num] == iParam0)
			if (iLocal_3120[num].f_2)
				return true;
		else
			iLocal_3120[num] != 0;
...
{
	iLocal_755[iParam0].f_15 = iLocal_755[iParam0].f_15 + SYSTEM::FLOOR(SYSTEM::TIMESTEP() * 1000f);

	switch (iLocal_755[iParam0].f_2)
	{
		case 7:
			if (iLocal_755[iParam0].f_15 > 2000 && !IS_BIT_SET(iLocal_755[iParam0].f_14, 0))
			{
				TASK::TASK_LOOK_AT_COORD(iLocal_755[iParam0], 2505.6335f, 4996.9937f, 46.6624f, 4000, 0, 2);
				MISC::SET_BIT(&(iLocal_755[iParam0].f_14), 0);
			}
			else if (iLocal_755[iParam0].f_15 > 8000 && !IS_BIT_SET(iLocal_755[iParam0].f_14, 1))
			{
				TASK::TASK_LOOK_AT_COORD(iLocal_755[iParam0], 2472.2966f, 4962.6865f, 47.2297f, 6000, 0, 2);
				MISC::SET_BIT(&(iLocal_755[iParam0].f_14), 1);
			}
			break;
	
		case 5:
			if (iLocal_755[iParam0].f_15 > 3000 && !IS_BIT_SET(iLocal_755[iParam0].f_14, 0))
			{
				if (!PED::IS_PED_INJURED(iLocal_755[6]))
				{
					TASK::TASK_LOOK_AT_ENTITY(iLocal_755[iParam0], iLocal_755[6], 4000, 0, 2);
					MISC::SET_BIT(&(iLocal_755[iParam0].f_14), 0);
				}
			}
			else if (iLocal_755[iParam0].f_15 > 11000 && !IS_BIT_SET(iLocal_755[iParam0].f_14, 1))
			{
				TASK::TASK_LOOK_AT_COORD(iLocal_755[iParam0], 2494.6335f, 5001.9937f, 46.6624f, 7000, 0, 2);
				MISC::SET_BIT(&(iLocal_755[iParam0].f_14), 1);
			}
			else if (iLocal_755[iParam0].f_15 > 20000 && !IS_BIT_SET(iLocal_755[iParam0].f_14, 2))
			{
				TASK::TASK_LOOK_AT_COORD(iLocal_755[iParam0], 2477.6335f, 4966.9937f, 46.6624f, 7000, 0, 2);
				MISC::SET_BIT(&(iLocal_755[iParam0].f_14), 2);
			}
			break;
		...
		case 4:
			if (iLocal_755[iParam0].f_15 > 3000 && !IS_BIT_SET(iLocal_755[iParam0].f_14, 0))
			{
				TASK::TASK_LOOK_AT_COORD(iLocal_755[iParam0], 2505.6335f, 4996.9937f, 46.6624f, 5000, 0, 2);
				MISC::SET_BIT(&(iLocal_755[iParam0].f_14), 0);
			}
			else if (iLocal_755[iParam0].f_15 > 10000 && !IS_BIT_SET(iLocal_755[iParam0].f_14, 1))
			{
				TASK::TASK_LOOK_AT_COORD(iLocal_755[iParam0], 2461.4495f, 4977.4805f, 51.7483f, 6000, 0, 2);
				MISC::SET_BIT(&(iLocal_755[iParam0].f_14), 1);
			}
			else if (iLocal_755[iParam0].f_15 > 18000 && !IS_BIT_SET(iLocal_755[iParam0].f_14, 2))
			{
				TASK::TASK_LOOK_AT_COORD(iLocal_755[iParam0], 2505.6335f, 4996.9937f, 46.6624f, 6000, 0, 2);
				MISC::SET_BIT(&(iLocal_755[iParam0].f_14), 2);
			}
			break;
	}
...
{
	if (!PED::IS_PED_INJURED(iLocal_755[iParam0]))
	{
		if (iParam0 >= 0)
		{
			iLocal_755[iParam0].f_4 = iLocal_755[iParam0].f_3;
			iLocal_755[iParam0].f_3 = iParam1;
			iLocal_755[iParam0].f_5 = iParam2;
			iLocal_755[iParam0].f_6 = Vector3( 0f, 0f, 0f );
			iLocal_755[iParam0].f_9 = Vector3( 0f, 0f, 0f );
			iLocal_755[iParam0].f_12 = 0f;
			iLocal_755[iParam0].f_13 = 0f;
			iLocal_755[iParam0].f_14 = iParam3;
			iLocal_755[iParam0].f_15 = 0;
			iLocal_1619[iParam0].f_3 = 3;
		}
	}
...
BOOL func_107(int iParam0, int iParam1, float fParam2, float fParam3, float fParam4, float fParam5, Hash hParam6, BOOL bParam7, int iParam8) // Position - 0xCD72
{
	...
	if (iLocal_755[iParam0].f_1 != 1 && iLocal_755[iParam0].f_1 != 0)
	{
	...
	{
		case 0:
			iLocal_755[iParam0] = PED::CREATE_PED(PED_TYPE_MISSION, joaat("A_M_M_Hillbilly_01"), fParam2, fParam5, true, true);
			PED::SET_PED_DEFAULT_COMPONENT_VARIATION(iLocal_755[iParam0]);
			PED::SET_PED_COMPONENT_VARIATION(iLocal_755[iParam0], PV_COMP_HEAD, 0, 1, 0);
			PED::SET_PED_COMPONENT_VARIATION(iLocal_755[iParam0], PV_COMP_HAIR, 0, 1, 0);
			PED::SET_PED_COMPONENT_VARIATION(iLocal_755[iParam0], PV_COMP_UPPR, 1, 1, 0);
			PED::SET_PED_COMPONENT_VARIATION(iLocal_755[iParam0], PV_COMP_LOWR, 1, 1, 0);
			break;
	
		case 1:
			iLocal_755[iParam0] = PED::CREATE_PED(PED_TYPE_MISSION, joaat("A_M_M_Hillbilly_02"), fParam2, fParam5, true, true);
			PED::SET_PED_DEFAULT_COMPONENT_VARIATION(iLocal_755[iParam0]);
			PED::SET_PED_COMPONENT_VARIATION(iLocal_755[iParam0], PV_COMP_HAIR, 1, 0, 0);
			PED::SET_PED_COMPONENT_VARIATION(iLocal_755[iParam0], PV_COMP_LOWR, 0, 1, 0);
			break;
	
		case 2:
			iLocal_755[iParam0] = PED::CREATE_PED(PED_TYPE_MISSION, joaat("A_M_Y_MethHead_01"), fParam2, fParam5, true, true);
			PED::SET_PED_DEFAULT_COMPONENT_VARIATION(iLocal_755[iParam0]);
			PED::SET_PED_COMPONENT_VARIATION(iLocal_755[iParam0], PV_COMP_HEAD, 0, 1, 0);
			PED::SET_PED_COMPONENT_VARIATION(iLocal_755[iParam0], PV_COMP_UPPR, 1, 0, 0);
			break;
	
		case 3:
			iLocal_755[iParam0] = PED::CREATE_PED(PED_TYPE_MISSION, joaat("A_M_M_Hillbilly_01"), fParam2, fParam5, true, true);
			PED::SET_PED_DEFAULT_COMPONENT_VARIATION(iLocal_755[iParam0]);
			PED::SET_PED_COMPONENT_VARIATION(iLocal_755[iParam0], PV_COMP_HEAD, 0, 2, 0);
			PED::SET_PED_COMPONENT_VARIATION(iLocal_755[iParam0], PV_COMP_HAIR, 1, 2, 0);
			PED::SET_PED_COMPONENT_VARIATION(iLocal_755[iParam0], PV_COMP_UPPR, 1, 0, 0);
			PED::SET_PED_COMPONENT_VARIATION(iLocal_755[iParam0], PV_COMP_LOWR, 1, 0, 0);
			break;
		...
		case 5:
			iLocal_755[iParam0] = PED::CREATE_PED(PED_TYPE_MISSION, joaat("A_M_Y_MethHead_01"), fParam2, fParam5, true, true);
			PED::SET_PED_DEFAULT_COMPONENT_VARIATION(iLocal_755[iParam0]);
			PED::SET_PED_COMPONENT_VARIATION(iLocal_755[iParam0], PV_COMP_LOWR, 1, 2, 0);
			break;
		...
		case 6:
			...
			PED::SET_PED_DEFAULT_COMPONENT_VARIATION(iLocal_755[iParam0]);
			PED::SET_PED_COMPONENT_VARIATION(iLocal_755[iParam0], PV_COMP_HAIR, 1, 0, 0);
			PED::SET_PED_COMPONENT_VARIATION(iLocal_755[iParam0], PV_COMP_UPPR, 0, 1, 0);
			PED::SET_PED_COMPONENT_VARIATION(iLocal_755[iParam0], PV_COMP_LOWR, 0, 1, 0);
			break;
		...
		case 7:
			...
			PED::SET_PED_DEFAULT_COMPONENT_VARIATION(iLocal_755[iParam0]);
			PED::SET_PED_COMPONENT_VARIATION(iLocal_755[iParam0], PV_COMP_HEAD, 0, 1, 0);
			PED::SET_PED_COMPONENT_VARIATION(iLocal_755[iParam0], PV_COMP_HAIR, 2, 0, 0);
			PED::SET_PED_COMPONENT_VARIATION(iLocal_755[iParam0], PV_COMP_UPPR, 2, 0, 0);
			PED::SET_PED_COMPONENT_VARIATION(iLocal_755[iParam0], PV_COMP_LOWR, 0, 2, 0);
			break;
		...
		case 9:
			...
			PED::SET_PED_DEFAULT_COMPONENT_VARIATION(iLocal_755[iParam0]);
			PED::SET_PED_COMPONENT_VARIATION(iLocal_755[iParam0], PV_COMP_HEAD, 0, 2, 0);
			PED::SET_PED_COMPONENT_VARIATION(iLocal_755[iParam0], PV_COMP_UPPR, 1, 2, 0);
			break;
		...
		case 11:
			...
			PED::SET_PED_DEFAULT_COMPONENT_VARIATION(iLocal_755[iParam0]);
			PED::SET_PED_COMPONENT_VARIATION(iLocal_755[iParam0], PV_COMP_HAIR, 2, 0, 0);
			PED::SET_PED_COMPONENT_VARIATION(iLocal_755[iParam0], PV_COMP_UPPR, 2, 2, 0);
			break;
		...
		case 12:
			...
			PED::SET_PED_DEFAULT_COMPONENT_VARIATION(iLocal_755[iParam0]);
			PED::SET_PED_COMPONENT_VARIATION(iLocal_755[iParam0], PV_COMP_HEAD, 0, 2, 0);
			PED::SET_PED_COMPONENT_VARIATION(iLocal_755[iParam0], PV_COMP_HAIR, 0, 2, 0);
			PED::SET_PED_COMPONENT_VARIATION(iLocal_755[iParam0], PV_COMP_UPPR, 1, 2, 0);
			PED::SET_PED_COMPONENT_VARIATION(iLocal_755[iParam0], PV_COMP_LOWR, 1, 2, 0);
			break;
		...
		case 14:
			...
			PED::SET_PED_DEFAULT_COMPONENT_VARIATION(iLocal_755[iParam0]);
			PED::SET_PED_COMPONENT_VARIATION(iLocal_755[iParam0], PV_COMP_HEAD, 0, 1, 0);
			PED::SET_PED_COMPONENT_VARIATION(iLocal_755[iParam0], PV_COMP_UPPR, 0, 2, 0);
			PED::SET_PED_COMPONENT_VARIATION(iLocal_755[iParam0], PV_COMP_LOWR, 0, 2, 0);
			break;
	...
	{
		iLocal_755[iParam0] = PED::CREATE_PED(PED_TYPE_MISSION, joaat("A_M_Y_MethHead_01"), fParam2, fParam5, true, true);
		PED::SET_PED_RANDOM_COMPONENT_VARIATION(iLocal_755[iParam0], 0);
	}

	iLocal_751 = iLocal_751 + 1;

	if (iLocal_755[iParam0].f_1 == 5)
	{
		PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_755[iParam0], true);
		PED::SET_PED_RELATIONSHIP_GROUP_HASH(iLocal_755[iParam0], hLocal_1617);
	}
	else
	{
		WEAPON::GIVE_WEAPON_TO_PED(iLocal_755[iParam0], hParam6, 3000, bParam7, true);
		PED::SET_PED_RELATIONSHIP_GROUP_HASH(iLocal_755[iParam0], hLocal_1616);
		PED::SET_PED_AS_ENEMY(iLocal_755[iParam0], true);
		PED::SET_PED_COMBAT_ATTRIBUTES(iLocal_755[iParam0], BF_0xEE326AAD, true);
		PED::SET_PED_HEARING_RANGE(iLocal_755[iParam0], 120f);
		PED::SET_PED_SEEING_RANGE(iLocal_755[iParam0], 22f);
		PED::SET_PED_ID_RANGE(iLocal_755[iParam0], 22f);
		PED::SET_PED_CONFIG_FLAG(iLocal_755[iParam0], 118, false);
		PED::SET_COMBAT_FLOAT(iLocal_755[iParam0], 14, 3f);
	
		if (iLocal_755[iParam0].f_1 == 2)
			PED::SET_PED_ACCURACY(iLocal_755[iParam0], 12);
		else
			PED::SET_PED_ACCURACY(iLocal_755[iParam0], 45);
	
		PED::SET_PED_DIES_WHEN_INJURED(iLocal_755[iParam0], true);
		ENTITY::SET_ENTITY_ONLY_DAMAGED_BY_PLAYER(iLocal_755[iParam0], true);
		PED::SET_PED_COMBAT_ATTRIBUTES(iLocal_755[iParam0], BF_HasRadio, false);
		PED::SET_PED_COMBAT_ATTRIBUTES(iLocal_755[iParam0], BF_AlwaysFlee, false);
		func_108(iLocal_755[iParam0], true);
	}

	PED::STOP_PED_WEAPON_FIRING_WHEN_DROPPED(iLocal_755[iParam0]);
	ENTITY::SET_ENTITY_SHOULD_FREEZE_WAITING_ON_COLLISION(iLocal_755[iParam0], true);
	PED::SET_PED_SHOULD_PLAY_DIRECTED_NORMAL_SCENARIO_EXIT(iLocal_755[iParam0], 0f, 0f, 0f);
	PED::SET_PED_SHOULD_IGNORE_SCENARIO_NAV_CHECKS(iLocal_755[iParam0], true);
	PED::SET_PED_SHOULD_PROBE_FOR_SCENARIO_EXITS_IN_ONE_FRAME(iLocal_755[iParam0], true);
	ENTITY::SET_ENTITY_HEALTH(iLocal_755[iParam0], 150, 0);
	return true;
}
		...
		if (bLocal_77)
		{
			...
			switch (iLocal_67)
			{
				case 1:
					if (iLocal_61 > -1)
					{
						if (!PED::IS_PED_DEAD_OR_DYING(uParam0->[iLocal_61], true))
						{
							switch (iLocal_60)
							{
								case 8:
									if (!bLocal_53)
									{
										if (!bLocal_56)
										{
											if (!bLocal_76)
											{
												if (!func_88(sParam13.f_1))
												{
													...
													if (func_111(sParam13.f_1, sParam13.f_2, uParam0->[iLocal_61], sParam13, -1, 0, 0, -1, 0, 0, -1, 0, 0, 8))
														iLocal_67 = 2;
												}
											}
											else
										...
										else if (!func_88(sParam10.f_1))
										{
											...
											if (func_111(sParam10.f_1, sParam10.f_2, uParam0->[iLocal_61], sParam10, -1, 0, 0, -1, 0, 0, -1, 0, 0, 8))
												iLocal_67 = 2;
										}
									}
									else
								...
								case 7:
									...
									if (func_111(sParam1.f_1, sParam1.f_2, uParam0->[iLocal_61], sParam1, -1, 0, 0, -1, 0, 0, -1, 0, 0, 8))
										iLocal_67 = 2;
									break;
								...
								case 5:
									...
									if (func_111(sParam16.f_1, sParam16.f_2, uParam0->[iLocal_61], sParam16, -1, 0, 0, -1, 0, 0, -1, 0, 0, 8))
										iLocal_67 = 2;
									break;
								...
								case 3:
									if (!bLocal_53 && !bLocal_76)
									{
										...
										if (func_111(sParam19.f_1, sParam19.f_2, uParam0->[iLocal_61], sParam19, -1, 0, 0, -1, 0, 0, -1, 0, 0, 8))
											iLocal_67 = 2;
									}
									else
									{
								...
								case 6:
									if (!bLocal_56)
									{
										if (!func_88(sParam4.f_1) && !func_88(sParam7.f_1) && !func_88(sParam10.f_1) && !func_88(sParam13.f_1))
										{
											...
											if (func_111(sParam4.f_1, sParam4.f_2, uParam0->[iLocal_61], sParam4, -1, 0, 0, -1, 0, 0, -1, 0, 0, 8))
												iLocal_67 = 2;
										}
									}
									else
								...
								case 9:
									if (!bLocal_56)
									{
										if (!func_88(sParam4.f_1) && !func_88(sParam7.f_1) && !func_88(sParam10.f_1) && !func_88(sParam13.f_1))
										{
											...
											if (func_111(sParam7.f_1, sParam7.f_2, uParam0->[iLocal_61], sParam7, -1, 0, 0, -1, 0, 0, -1, 0, 0, 8))
												iLocal_67 = 2;
										}
									}
									else
									...
									if (!PED::IS_PED_USING_SCENARIO(uParam0->[i], "PROP_HUMAN_SEAT_CHAIR") && !PED::IS_PED_USING_SCENARIO(uParam0->[i], "PROP_HUMAN_SEAT_ARMCHAIR"))
									{
										if (PED::IS_PED_IN_ANY_VEHICLE(uParam0->[i], false))
										{
											...
											if (VEHICLE::IS_VEHICLE_DRIVEABLE(vehiclePedIsUsing, false))
											{
												...
												{
													entityVelocity = Vector3(ENTITY::GET_ENTITY_VELOCITY(vehiclePedIsUsing));
													...
													switch (uParam0->[i].f_5)
													{
														case 0:
															if (iLocal_65 == 0)
															{
																if (!PED::IS_PED_IN_ANY_VEHICLE(uParam0->[i], true))
																{
																	entityCoords = Vector3(ENTITY::GET_ENTITY_COORDS(uParam0->[i], true));
	...
	switch (uParam1->[iParam0].f_5)
	{
		case 0:
			if (!MISC::ARE_STRINGS_EQUAL("chi2_hear", sParam3.f_1))
			{
				...
				{
					uParam1->[iParam0].f_12 = Vector3(ENTITY::GET_ENTITY_COORDS(uParam1->[iParam0], true));
		...
		case 2:
			if (!MISC::ARE_STRINGS_EQUAL("chi2_hear", sParam3.f_1))
			{
				if (PLAYER::CAN_PED_HEAR_PLAYER(PLAYER::PLAYER_ID(), uParam1->[iParam0]) || iLocal_75 == 1 && func_73(uParam1->[iParam0], uParam1->[iParam0].f_12, true) < uParam1->[iParam0].f_19)
				{
					if (MISC::GET_GAME_TIMER() > uParam1->[iParam0].f_11 - 3000)
					{
						...
						uParam1->[iParam0].f_15 = Vector3(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true));
...
float func_117(Entity eParam0, Entity eParam1, int iParam2) // Position - 0xF112
{
	...
	entityCoords = Vector3(ENTITY::GET_ENTITY_COORDS(eParam0, false));
	entityCoords2 = Vector3(ENTITY::GET_ENTITY_COORDS(eParam1, false));
...
void func_121(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12) // Position - 0xF398
{
	...
	if (!bLocal_53 == true)
	{
		...
		for (j = 4; j > 0; j = j - 1)
		{
			if (!PED::IS_PED_DEAD_OR_DYING(uParam0->[iLocal_58], true))
			{
					...
					for (i = 0; i < *uParam0; i = i + 1)
					{
						if (!PED::IS_PED_DEAD_OR_DYING(uParam0->[i], true))
						{
							if (i != iLocal_58)
							{
								if (uParam0->[i].f_3 <= 4)
								{
									if (func_4(uParam0->[i], uParam0->[iLocal_58], true) < 8f)
									{
										if (INTERIOR::GET_INTERIOR_FROM_ENTITY(uParam0->[iLocal_58]) != 0 && INTERIOR::GET_INTERIOR_FROM_ENTITY(uParam0->[i]) != 0 || INTERIOR::GET_INTERIOR_FROM_ENTITY(uParam0->[iLocal_58]) == 0 && INTERIOR::GET_INTERIOR_FROM_ENTITY(uParam0->[i]) == 0)
										{
											entityCoords = Vector3(ENTITY::GET_ENTITY_COORDS(uParam0->[i], true));
											entityCoords2 = Vector3(ENTITY::GET_ENTITY_COORDS(uParam0->[iLocal_58], false));
										
											if (MISC::ABSF(entityCoords.f_2 - entityCoords2.f_2) < 2f)
											{
												uParam0->[i].f_7 = 1;
												uParam0->[i].f_10 = iLocal_58;
											}
										}
									}
								}
				...
				else
				{
					...
					for (i = 0; i < *uParam0; i = i + 1)
					{
						if (i != iLocal_58)
						{
							...
							{
								num4 = func_4(uParam0->[i], uParam0->[iLocal_58], true);
							
								if (num4 < 10f)
								{
									num5 = func_119(uParam0->[iLocal_58], uParam0->[i]);
		...
		if (!PED::IS_PED_DEAD_OR_DYING(uParam0->[i], true))
		{
			if (uParam0->[i].f_3 != 7)
			{
				...
				if (uParam0->[i].f_3 <= 4)
				{
					...
					if (!bLocal_258 && !PED::IS_PED_RAGDOLL(uParam0->[i]))
					{
				...
				if (uParam0->[i].f_1 > iLocal_60)
				{
					iLocal_60 = uParam0->[i].f_1;
					iLocal_61 = i;
				}
			}
			else
	...
	else if (PED::IS_PED_DEAD_OR_DYING(uParam0->[iLocal_62], true))
	{
		iLocal_62 = -1;
	}
...
void func_123() // Position - 0xFC8D
{
	if (bLocal_3491)
	{
		if (MISC::IS_STRING_NULL_OR_EMPTY(&uLocal_3498))
		{
			if (_CONVERSATION_IS_DIALOGUE_IN_PROGRESS())
			{
				if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
				{
					if (!HUD::IS_MESSAGE_BEING_DISPLAYED())
					{
						uLocal_3492 = Vector3(func_124());
						uLocal_3498 = Vector3(func_89());
		...
		else
		{
			...
			if (!MISC::IS_STRING_NULL_OR_EMPTY(&uLocal_3498))
				uLocal_3478[0] = Vector3(uLocal_3478[0]);
		}
	}
...
struct<6> func_124() // Position - 0xFD75
{
	...
	if (Global_21725 == 4)
	{
		...
		{
			if (HUD::DOES_TEXT_LABEL_EXIST(&Global_20593[num]))
			{
				return Global_20593[num];
			}
			else
			{
				for (i = num; i < 70; i = i + 1)
				{
					if (HUD::DOES_TEXT_LABEL_EXIST(&Global_20593[i]))
					{
						return Global_20593[i];
						i = 70;
					}
				}
...
void func_126() // Position - 0xFE45
{
	...
	outPosition = Vector3( 0f, 0f, 0f );

	if (bLocal_437 == false)
	{
		if (FIRE::GET_CLOSEST_FIRE_POS(&outPosition, iLocal_444[0]))
		{
			num = 0f;
			num3 = 999999f;
			...
			{
				if (i > 0)
					num = num + MISC::GET_DISTANCE_BETWEEN_COORDS(iLocal_444[i - 1], iLocal_444[i], true);
			
				if (iLocal_444[i].f_4)
				{
					if (FIRE::GET_CLOSEST_FIRE_POS(&outPosition, iLocal_444[i]))
					{
						distanceBetweenCoords = MISC::GET_DISTANCE_BETWEEN_COORDS(iLocal_444[i], outPosition, true);
			...
			if (num3 < fLocal_272)
			{
				...
				num4 = num4;
				uLocal_277 = Vector3(iLocal_444[num2]);
				iLocal_280 = num2;
				iLocal_440 = num2 * 2;
	...
	if (bLocal_437 == true)
	{
		...
		{
			if (MISC::GET_GAME_TIMER() - iLocal_281[i].f_4 > 1000)
				GRAPHICS::FADE_DECALS_IN_RANGE(iLocal_281[i].f_1, 0.4f, 1f);
		
			if (MISC::GET_GAME_TIMER() - iLocal_281[i].f_4 > 6000)
				FIRE::REMOVE_SCRIPT_FIRE(iLocal_281[i]);
		}
	}
...
void func_127(int iParam0, BOOL bParam1) // Position - 0x100AB
{
	...
	if (iParam0 >= 0)
	{
		if (iParam0 % 2 == 1)
		{
			...
			if (num + 1 < 61)
				func_128(((iLocal_444[iParam0 / 2] + iLocal_444[(iParam0 / 2) + 1]) / Vector3( 2f, 2f, 2f )) + Vector3(fLocal_273, fLocal_273, fLocal_273), bParam1);
		}
		else if (iParam0 / 2 < 61)
		{
			func_128(iLocal_444[iParam0 / 2] + Vector3(fLocal_273, fLocal_273, fLocal_273), bParam1);
		}
	}
...
void func_128(Vector3 vParam0, var uParam1, var uParam2, BOOL bParam3) // Position - 0x10119
{
	...
	FIRE::REMOVE_SCRIPT_FIRE(iLocal_281[iLocal_441]);

	if (iLocal_281[iLocal_441].f_4 != 0)
		GRAPHICS::FADE_DECALS_IN_RANGE(iLocal_281[iLocal_441].f_1, 0.4f, 1f);

	iLocal_281[iLocal_441].f_4 = MISC::GET_GAME_TIMER();
	iLocal_281[iLocal_441].f_1 = Vector3(vParam0);
	iLocal_281[iLocal_441] = FIRE::START_SCRIPT_FIRE(vParam0, iLocal_270, bParam3);
		...
		if (weaponHash == joaat("WEAPON_PETROLCAN"))
		{
			if (PAD::IS_CONTROL_PRESSED(PLAYER_CONTROL, INPUT_ATTACK) && PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
			{
				...
				if (MISC::GET_GAME_TIMER() > iLocal_271)
				{
					...
					{
						num = 9999.9f;
						uLocal_274 = Vector3(func_130());
					
						for (i = 0; i < iLocal_444; i = i + 1)
						{
							if (HUD::DOES_BLIP_EXIST(iLocal_444[i].f_3))
							{
								distanceBetweenCoords = MISC::GET_DISTANCE_BETWEEN_COORDS(uLocal_274, HUD::GET_BLIP_COORDS(iLocal_444[i].f_3), true);
								distanceBetweenCoords2 = MISC::GET_DISTANCE_BETWEEN_COORDS(iLocal_444[i], HUD::GET_BLIP_COORDS(iLocal_444[i].f_3), true);
							
								if (distanceBetweenCoords2 == 0f || distanceBetweenCoords < distanceBetweenCoords2)
									if (distanceBetweenCoords < 2f)
										iLocal_444[i] = Vector3(uLocal_274);
							...
							if (iLocal_267 != -1)
							{
								...
								if (MISC::ABSI(iLocal_268 - num2) < 3 && MISC::ABSI(iLocal_268 - num2) > 0)
								{
									if (iLocal_268 < num2)
									{
										...
										{
											if (HUD::DOES_BLIP_EXIST(iLocal_444[j].f_3))
											{
												if (HUD::GET_BLIP_ALPHA(iLocal_444[j].f_3) > 0)
												{
													HUD::SET_BLIP_ALPHA(iLocal_444[j].f_3, 0);
													iLocal_444[j].f_4 = 1;
								...
								if (num2 == 0)
								{
									if (HUD::DOES_BLIP_EXIST(iLocal_444[num2].f_3))
									{
										if (HUD::GET_BLIP_ALPHA(iLocal_444[num2].f_3) > 0)
										{
											HUD::SET_BLIP_ALPHA(iLocal_444[num2].f_3, 0);
											iLocal_444[num2].f_4 = 1;
											iLocal_269 = iLocal_269 - 1;
										}
									}
								}
								...
								if (num2 < 60)
								{
									if (_IS_NULL_VECTOR(iLocal_444[num2 + 1]))
									{
										if (HUD::DOES_BLIP_EXIST(iLocal_444[num2].f_3))
										{
											if (HUD::GET_BLIP_ALPHA(iLocal_444[num2].f_3) > 0)
...
Vector3 func_130() // Position - 0x104B5
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(currentPedWeaponEntityIndex))
	{
		...
		worldPositionOfEntityBone = Vector3(ENTITY::GET_WORLD_POSITION_OF_ENTITY_BONE(currentPedWeaponEntityIndex, entityBoneIndexByName));
		worldPositionOfEntityBone = Vector3(OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(worldPositionOfEntityBone, ENTITY::GET_ENTITY_HEADING(currentPedWeaponEntityIndex), 0.35f, 0f, -0.15f));
		MISC::GET_GROUND_Z_FOR_3D_COORD(worldPositionOfEntityBone, &groundZ, false, false);
		unk3 = Vector3(worldPositionOfEntityBone, worldPositionOfEntityBone.f_1, groundZ);
	}
	...
	if (iLocal_2511 >= 4)
	{
		for (i = 0; i < iLocal_755; i = i + 1)
		{
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_755[i]))
			{
				...
				if (PED::GET_PED_RELATIONSHIP_GROUP_HASH(iLocal_755[i]) == hLocal_1616)
					func_103(iLocal_755[i], &(iLocal_755[i].f_25), -1, 0, false, false, -1082130432, 0, -1, -1, true, false, false);
			}
			else if (iLocal_755[i] != 0)
			{
				func_134(&(iLocal_755[i].f_25));
				iLocal_755[i] = 0;
			}
		}
	}
...
{
	if (iLocal_2917[iParam0] == iParam1)
		if (iLocal_2917[iParam0].f_3 == 1)
			return true;
...
void func_155(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7) // Position - 0x11CFE
{
	...
	if (iLocal_3337[iParam0] != iParam1)
	{
		iLocal_3337[iParam0].f_1 = 0;
		iLocal_3337[iParam0] = iParam1;
	}

	if (!iLocal_3337[iParam0].f_1)
	{
		if (func_158(iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, 1, 0))
		{
			switch (iLocal_3337[iParam0])
			{
				case 0:
					break;
				...
				case 3:
					switch (iLocal_3337[iParam0].f_2)
					{
						case 0:
				...
				case 11:
					switch (iLocal_3337[iParam0].f_2)
					{
						case 0:
							...
							{
								iLocal_3337[iParam0].f_3 = MISC::GET_GAME_TIMER() + 1000;
								iLocal_3337[iParam0].f_2 = iLocal_3337[iParam0].f_2 + 1;
							}
							break;
					
						case 1:
							if (MISC::GET_GAME_TIMER() > iLocal_3337[iParam0].f_3)
							{
								if (PAD::IS_USING_KEYBOARD_AND_MOUSE(PLAYER_CONTROL))
				...
				case 6:
					switch (iLocal_3337[iParam0].f_2)
					{
						case 0:
							...
							{
								iLocal_3337[iParam0].f_3 = MISC::GET_GAME_TIMER() + 4000;
								iLocal_3337[iParam0].f_2 = iLocal_3337[iParam0].f_2 + 1;
							}
							break;
...
void func_163(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9) // Position - 0x124B5
{
	...
	if (iLocal_3358[iParam0] != iParam1)
	{
		iLocal_3358[iParam0].f_1 = 0;
		iLocal_3358[iParam0] = iParam1;
	}

	if (!iLocal_3358[iParam0].f_1)
	{
		if (func_158(iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8, iParam9))
		{
			if (!iLocal_3358[iParam0].f_2)
				iLocal_3358[iParam0].f_2 = 1;
		
			switch (iLocal_3358[iParam0])
			{
				case 0:
					break;
				...
				case 1:
					if (func_35("TRV_WTF", 1, PLAYER::PLAYER_PED_ID(), "TREVOR", -1, 0, 0, -1, 0, 0, -1, 0, 0, 8))
						iLocal_3358[iParam0].f_1 = 1;
					break;
			
				case 2:
					switch (iLocal_3358[iParam0].f_3)
					{
						case 0:
							iLocal_3358[iParam0].f_4 = MISC::GET_GAME_TIMER() + 2000;
							iLocal_3358[iParam0].f_3 = iLocal_3358[iParam0].f_3 + 1;
							break;
					
						case 1:
							if (MISC::GET_GAME_TIMER() > iLocal_3358[iParam0].f_4)
							{
								if (_CONVERSATION_IS_DIALOGUE_IN_PROGRESS())
								{
									iLocal_3358[iParam0].f_4 = MISC::GET_GAME_TIMER() + 2000;
								...
								else
								{
									...
									if (func_165(&num, 2, 1))
										if (func_35("RAGE", 1, PLAYER::PLAYER_PED_ID(), "Trevor", -1, 0, 0, -1, 0, 0, -1, 0, 0, 8))
											iLocal_3358[iParam0].f_4 = MISC::GET_GAME_TIMER() + MISC::GET_RANDOM_INT_IN_RANGE(8000, 14000);
									else
										iLocal_3358[iParam0].f_1 = 1;
								}
							}
				...
				case 4:
					iLocal_3358[iParam0].f_4 = func_18(23);
				
					if (iLocal_3358[iParam0].f_4 != -1)
						if (!PED::IS_PED_INJURED(iLocal_755[iLocal_3358[iParam0].f_4]))
							if (func_35("COOKSEE", 3, iLocal_755[iLocal_3358[iParam0].f_4], "ONEILCOOK", -1, 0, 0, -1, 0, 0, -1, 0, 0, 8))
								iLocal_3358[iParam0].f_1 = 1;
						else
							iLocal_3358[iParam0].f_1 = 1;
					break;
				...
				case 3:
					...
					{
						case 0:
							iLocal_3358[iParam0].f_4 = func_18(15);
							iLocal_3358[iParam0].f_5 = func_18(16);
						
							if (iLocal_3358[iParam0].f_4 != -1 && iLocal_3358[iParam0].f_5 != -1)
								iLocal_3358[iParam0].f_3 = iLocal_3358[iParam0].f_3 + 1;
							break;
						...
						case 1:
							if (PED::IS_PED_INJURED(iLocal_755[iLocal_3358[iParam0].f_4]))
							{
								iLocal_3358[iParam0].f_4 = iLocal_3358[iParam0].f_5;
						...
						case 2:
							if (!PED::IS_PED_INJURED(iLocal_755[iLocal_3358[iParam0].f_4]))
								if (func_35("ONEILGUARD8", 5, iLocal_755[iLocal_3358[iParam0].f_4], "ONEILGUARD1", -1, 0, 0, -1, 0, 0, -1, 0, 0, 8))
									iLocal_3358[iParam0].f_3 = iLocal_3358[iParam0].f_3 + 1;
							else
								iLocal_3358[iParam0].f_1 = 1;
							break;
						...
						case 3:
							if (!PED::IS_PED_INJURED(iLocal_755[iLocal_3358[iParam0].f_4]))
								if (func_35("ONEILGUARD9", 5, iLocal_755[iLocal_3358[iParam0].f_4], "ONEILGUARD1", -1, 0, 0, -1, 0, 0, -1, 0, 0, 8))
									iLocal_3358[iParam0].f_3 = iLocal_3358[iParam0].f_3 + 1;
							else
								iLocal_3358[iParam0].f_1 = 1;
							break;
						...
						case 4:
							if (func_165(&unk, 2, 1))
							{
								if (unk != iLocal_3358[iParam0].f_4)
								{
									iLocal_3358[iParam0].f_4 = unk;
									iLocal_3358[iParam0].f_3 = iLocal_3358[iParam0].f_3 + 1;
								}
								else
								{
						...
						case 5:
							if (!PED::IS_PED_INJURED(iLocal_755[iLocal_3358[iParam0].f_4]))
								if (func_35("ONEILGUARD10", 5, iLocal_755[iLocal_3358[iParam0].f_4], "ONEILGUARD2", -1, 0, 0, -1, 0, 0, -1, 0, 0, 8))
									iLocal_3358[iParam0].f_1 = 1;
							else
								iLocal_3358[iParam0].f_1 = 1;
							break;
				...
				case 5:
					...
					if (iLocal_3358[iParam0].f_4 != -1)
						if (!PED::IS_PED_INJURED(iLocal_755[iLocal_3358[iParam0].f_4]))
							if (func_35("ONEILGUARD11", 6, iLocal_755[iLocal_3358[iParam0].f_4], "ONEILGUARD2", -1, 0, 0, -1, 0, 0, -1, 0, 0, 8))
								iLocal_3358[iParam0].f_1 = 1;
						else
							iLocal_3358[iParam0].f_1 = 1;
					break;
				...
				case 6:
					...
					if (iLocal_3358[iParam0].f_4 != -1)
						if (!PED::IS_PED_INJURED(iLocal_755[iLocal_3358[iParam0].f_4]))
							if (func_35("ONEILGUARD12", 6, iLocal_755[iLocal_3358[iParam0].f_4], "ONEILGUARD2", -1, 0, 0, -1, 0, 0, -1, 0, 0, 8))
								iLocal_3358[iParam0].f_1 = 1;
						else
							iLocal_3358[iParam0].f_1 = 1;
					break;
				...
				case 9:
					switch (iLocal_3358[iParam0].f_3)
					{
						case 0:
							if (!PED::IS_PED_INJURED(iLocal_755[iLocal_3358[iParam0].f_4]))
								iLocal_3358[iParam0].f_3 = MISC::GET_RANDOM_INT_IN_RANGE(1, 3);
							break;
					
						case 1:
							if (func_35("SEETREVOR", 3, iLocal_755[iLocal_3358[iParam0].f_4], "CHIN2goon1", -1, 0, 0, -1, 0, 0, -1, 0, 0, 8))
								iLocal_3358[iParam0].f_1 = 1;
							break;
					
						case 2:
							if (func_35("GOON2TREV", 4, iLocal_755[iLocal_3358[iParam0].f_4], "CHIN2goon2", -1, 0, 0, -1, 0, 0, -1, 0, 0, 8))
								iLocal_3358[iParam0].f_1 = 1;
							break;
					}
					break;
				...
				case 10:
					switch (iLocal_3358[iParam0].f_3)
					{
						case 0:
							if (MISC::GET_GAME_TIMER() > iLocal_3358[iParam0].f_4)
								if (func_165(&(iLocal_3358[iParam0].f_5), 1, 1))
									iLocal_3358[iParam0].f_3 = iLocal_3358[iParam0].f_3 + 1;
							break;
					
						case 1:
							if (!PED::IS_PED_INJURED(iLocal_755[iLocal_3358[iParam0].f_5]))
							{
								if (iLocal_3358[iParam0].f_6 < 3)
								{
									if (func_35("ONEILGUARD5", 5, iLocal_755[iLocal_3358[iParam0].f_5], "ONEILGUARD1", -1, 0, 0, -1, 0, 0, -1, 0, 0, 8))
									{
										iLocal_3358[iParam0].f_4 = MISC::GET_GAME_TIMER() + MISC::GET_RANDOM_INT_IN_RANGE(7000, 12000);
										iLocal_3358[iParam0].f_6 = iLocal_3358[iParam0].f_6 + 1;
										iLocal_3358[iParam0].f_3 = 0;
									}
								}
								else if (iLocal_3358[iParam0].f_6 < 6)
								{
									if (func_35("ONEILGUARD6", 6, iLocal_755[iLocal_3358[iParam0].f_5], "ONEILGUARD2", -1, 0, 0, -1, 0, 0, -1, 0, 0, 8))
									{
										iLocal_3358[iParam0].f_4 = MISC::GET_GAME_TIMER() + MISC::GET_RANDOM_INT_IN_RANGE(7000, 12000);
										iLocal_3358[iParam0].f_6 = iLocal_3358[iParam0].f_6 + 1;
										iLocal_3358[iParam0].f_3 = 0;
				...
				case 11:
					switch (iLocal_3358[iParam0].f_3)
					{
						...
						case 1:
							if (!PED::IS_PED_INJURED(iLocal_755[iLocal_3358[iParam0].f_5]))
							{
								switch (iLocal_3358[iParam0].f_6)
								{
									case 0:
									case 2:
									case 5:
									case 9:
										if (func_35("COOKATT", 3, iLocal_755[iLocal_3358[iParam0].f_5], "oneilcook", -1, 0, 0, -1, 0, 0, -1, 0, 0, 8))
										{
											iLocal_3358[iParam0].f_4 = MISC::GET_GAME_TIMER() + MISC::GET_RANDOM_INT_IN_RANGE(7000, 12000);
											iLocal_3358[iParam0].f_6 = iLocal_3358[iParam0].f_6 + 1;
											iLocal_3358[iParam0].f_3 = 0;
									...
									case 8:
									case 11:
										if (func_35("GOONATT", 3, iLocal_755[iLocal_3358[iParam0].f_5], "chin2goon1", -1, 0, 0, -1, 0, 0, -1, 0, 0, 8))
										{
											iLocal_3358[iParam0].f_4 = MISC::GET_GAME_TIMER() + MISC::GET_RANDOM_INT_IN_RANGE(7000, 12000);
											iLocal_3358[iParam0].f_6 = iLocal_3358[iParam0].f_6 + 1;
											iLocal_3358[iParam0].f_3 = 0;
									...
									case 7:
									case 10:
										if (func_35("GOON2ATTO", 4, iLocal_755[iLocal_3358[iParam0].f_5], "chin2goon2", -1, 0, 0, -1, 0, 0, -1, 0, 0, 8))
										{
											iLocal_3358[iParam0].f_4 = MISC::GET_GAME_TIMER() + MISC::GET_RANDOM_INT_IN_RANGE(7000, 12000);
											iLocal_3358[iParam0].f_6 = iLocal_3358[iParam0].f_6 + 1;
											iLocal_3358[iParam0].f_3 = 0;
				...
				case 12:
					switch (iLocal_3358[iParam0].f_3)
					{
						case 0:
							if (MISC::GET_GAME_TIMER() > iLocal_3358[iParam0].f_4)
								if (func_165(&(iLocal_3358[iParam0].f_5), 2, 1))
									iLocal_3358[iParam0].f_3 = iLocal_3358[iParam0].f_3 + 1;
							break;
						...
						case 1:
							if (!PED::IS_PED_INJURED(iLocal_755[iLocal_3358[iParam0].f_5]))
							{
								switch (iLocal_3358[iParam0].f_6)
								{
									...
									case 5:
									case 9:
										if (func_35("GOONIN", 3, iLocal_755[iLocal_3358[iParam0].f_5], "chin2goon1", -1, 0, 0, -1, 0, 0, -1, 0, 0, 8))
										{
											iLocal_3358[iParam0].f_4 = MISC::GET_GAME_TIMER() + MISC::GET_RANDOM_INT_IN_RANGE(6000, 10000);
											iLocal_3358[iParam0].f_6 = iLocal_3358[iParam0].f_6 + 1;
											iLocal_3358[iParam0].f_3 = 0;
										}
										break;
									...
									case 8:
									case 11:
										if (func_35("GOON2ATTI", 4, iLocal_755[iLocal_3358[iParam0].f_5], "chin2goon2", -1, 0, 0, -1, 0, 0, -1, 0, 0, 8))
										{
											iLocal_3358[iParam0].f_4 = MISC::GET_GAME_TIMER() + MISC::GET_RANDOM_INT_IN_RANGE(6000, 10000);
											iLocal_3358[iParam0].f_6 = iLocal_3358[iParam0].f_6 + 1;
											iLocal_3358[iParam0].f_3 = 0;
									...
									case 7:
									case 10:
										if (func_35("ATTACKIN", 3, iLocal_755[iLocal_3358[iParam0].f_5], "ONEILCOOK", -1, 0, 0, -1, 0, 0, -1, 0, 0, 8))
										{
											iLocal_3358[iParam0].f_4 = MISC::GET_GAME_TIMER() + MISC::GET_RANDOM_INT_IN_RANGE(6000, 10000);
											iLocal_3358[iParam0].f_6 = iLocal_3358[iParam0].f_6 + 1;
											iLocal_3358[iParam0].f_3 = 0;
				...
				case 14:
					switch (iLocal_3358[iParam0].f_3)
					{
						case 0:
							for (i = 0; i < iLocal_755; i = i + 1)
							{
								if (iLocal_755[i].f_1 == 2)
								{
									if (!PED::IS_PED_INJURED(iLocal_755[i]))
									{
										if (PED::IS_PED_IN_COMBAT(iLocal_755[i], 0))
										{
											if (PED::CAN_PED_IN_COMBAT_SEE_TARGET(iLocal_755[i], PLAYER::PLAYER_PED_ID()))
											{
												iLocal_3358[iParam0].f_4 = i;
												iLocal_3358[iParam0].f_3 = iLocal_3358[iParam0].f_3 + 1;
											}
										}
									}
						...
						case 1:
							if (func_35("G2TREVIN", 4, iLocal_755[iLocal_3358[iParam0].f_4], "chin2goon2", -1, 0, 0, -1, 0, 0, -1, 0, 0, 8))
								iLocal_3358[iParam0].f_1 = 1;
							break;
					}
					break;
				...
				case 15:
					switch (iLocal_3358[iParam0].f_3)
					{
						case 0:
							if (!PED::IS_PED_INJURED(iLocal_755[iLocal_3358[iParam0].f_4]))
								if (func_35("ONEILGUARD3", 5, iLocal_755[iLocal_3358[iParam0].f_4], "ONEILGUARD1", -1, 0, 0, -1, 0, 0, -1, 0, 0, 8))
									iLocal_3358[iParam0].f_3 = iLocal_3358[iParam0].f_3 + 1;
							break;
					
						case 1:
							if (!PED::IS_PED_INJURED(iLocal_755[iLocal_3358[iParam0].f_4]))
								if (func_35("ONEILGUARD1", 5, iLocal_755[iLocal_3358[iParam0].f_4], "ONEILGUARD1", -1, 0, 0, -1, 0, 0, -1, 0, 0, 8))
									iLocal_3358[iParam0].f_1 = 1;
							break;
					}
					break;
				...
				case 16:
					...
					{
						case 0:
							if (func_165(&(iLocal_3358[iParam0].f_4), 1, 1))
								iLocal_3358[iParam0].f_3 = iLocal_3358[iParam0].f_3 + 1;
							break;
					
						case 1:
							if (func_35("ONEILGUARD7", 5, iLocal_755[iLocal_3358[iParam0].f_4], "oneilguard2", -1, 0, 0, -1, 0, 0, -1, 0, 0, 8))
								iLocal_3358[iParam0].f_3 = iLocal_3358[iParam0].f_3 + 1;
							break;
				...
				case 20:
					...
					{
						case 0:
							if (MISC::GET_GAME_TIMER() > iLocal_3358[iParam0].f_5)
							{
								num2 = 999f;
								iLocal_3358[iParam0].f_4 = -1;
							
								for (j = 0; j < iLocal_755; j = j + 1)
								{
									if (iLocal_755[j].f_1 == 2)
									{
										if (!PED::IS_PED_INJURED(iLocal_755[j]))
										{
											num3 = func_4(PLAYER::PLAYER_PED_ID(), iLocal_755[j], true);
										
											if (num3 < num2)
											{
												num2 = num3;
												iLocal_3358[iParam0].f_4 = j;
											}
										}
									}
								}
						...
						case 1:
							if (!PED::IS_PED_INJURED(iLocal_755[iLocal_3358[iParam0].f_4]))
							{
								if (func_35("CHI2_outs", 5, iLocal_755[iLocal_3358[iParam0].f_4], "Oneilguard1", -1, 0, 0, -1, 0, 0, -1, 0, 0, 8))
									iLocal_3358[iParam0].f_1 = 1;
							}
							else
							{
								iLocal_3358[iParam0].f_5 = MISC::GET_GAME_TIMER() + 6000;
								iLocal_3358[iParam0].f_3 = 0;
							}
							break;
					}
				...
				case 18:
					switch (iLocal_3358[iParam0].f_3)
					{
						case 0:
							...
							{
								if (iLocal_755[k].f_2 == 8)
									iLocal_3358[iParam0].f_4 = k;
							
								if (iLocal_755[k].f_2 == 9)
									iLocal_3358[iParam0].f_5 = k;
							}
						...
						case 1:
							if (!_CONVERSATION_IS_DIALOGUE_IN_PROGRESS())
								if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_755[iLocal_3358[iParam0].f_4].f_14))
									if (PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_755[iLocal_3358[iParam0].f_4].f_14) > 0.15f)
										if (PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_755[iLocal_3358[iParam0].f_4].f_14) < 0.65f)
											if (func_4(iLocal_755[iLocal_3358[iParam0].f_4], PLAYER::PLAYER_PED_ID(), true) < 30f)
												iLocal_3358[iParam0].f_3 = 3;
							break;
						...
						case 2:
							if (!PED::IS_PED_INJURED(iLocal_755[iLocal_3358[iParam0].f_4]))
								...
								iLocal_3358[iParam0].f_3 = 1;
							break;
					
						case 3:
							if (!PED::IS_PED_INJURED(iLocal_755[iLocal_3358[iParam0].f_5]))
							{
								AUDIO::PLAY_PED_AMBIENT_SPEECH_WITH_VOICE_NATIVE(iLocal_755[iLocal_3358[iParam0].f_5], "generic_cheer", "A_M_M_Hillbilly_01_White_mini_03", "SPEECH_PARAMS_FORCE_SHOUTED", false);
								iLocal_3358[iParam0].f_3 = iLocal_3358[iParam0].f_3 + 1;
							}
							else
							{
						...
						case 4:
							if (!PED::IS_PED_INJURED(iLocal_755[iLocal_3358[iParam0].f_4]))
								if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_755[iLocal_3358[iParam0].f_4].f_14))
									if (PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_755[iLocal_3358[iParam0].f_4].f_14) > 0.75f)
										iLocal_3358[iParam0].f_3 = 1;
							break;
					}
					break;
				...
				case 22:
					...
					{
						case 0:
							iLocal_3358[iParam0].f_4 = 2500;
							iLocal_3358[iParam0].f_5 = 0;
							iLocal_3358[iParam0].f_3 = 1;
							break;
					
						case 1:
							iLocal_3358[iParam0].f_4 = iLocal_3358[iParam0].f_4 - SYSTEM::FLOOR(SYSTEM::TIMESTEP() * 1000f);
						
							if (iLocal_3358[iParam0].f_4 <= 0)
								iLocal_3358[iParam0].f_3 = 2;
							break;
					
						case 2:
							if (iLocal_3358[iParam0].f_5 < 14)
							{
								if (func_35("CHI2_pour", 1, PLAYER::PLAYER_PED_ID(), "TREVOR", -1, 0, 0, -1, 0, 0, -1, 0, 0, 8))
								{
									iLocal_3358[iParam0].f_3 = 1;
									iLocal_3358[iParam0].f_4 = 12000 + MISC::GET_RANDOM_INT_IN_RANGE(3000, 5000);
									iLocal_3358[iParam0].f_5 = iLocal_3358[iParam0].f_5 + 1;
								}
							}
							break;
					}
...
BOOL func_165(var uParam0, int iParam1, int iParam2) // Position - 0x1393A
{
	...
	*uParam0 = -1;
	...
	for (i = 0; i < iLocal_755; i = i + 1)
	{
		if (iLocal_755[i].f_1 == iParam1)
		{
			if (iParam2 == 0 || iParam2 == 1 && !PED::IS_PED_INJURED(iLocal_755[i]))
			{
				num = func_4(PLAYER::PLAYER_PED_ID(), iLocal_755[i], true);
...
void func_166(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10) // Position - 0x139C0
{
	...
	if (iLocal_2917[iParam0] != iParam1 || iLocal_2917[iParam0].f_1 == 0)
	{
		iLocal_2917[iParam0] = iParam1;
		iLocal_2917[iParam0].f_1 = 1;
		iLocal_2917[iParam0].f_3 = 0;
		iLocal_2917[iParam0].f_6 = 0;
		iLocal_2917[iParam0].f_4 = 0;
		iLocal_2917[iParam0].f_7 = 0;
		iLocal_2917[iParam0].f_8 = 0;
		iLocal_2917[iParam0].f_9 = 0f;
	}

	if (iLocal_2917[iParam0].f_2 && iParam2 == 0)
		flag = true;
	else
		flag = func_158(iParam3, iParam4, iParam5, iParam6, iParam7, iParam8, iParam9, iParam10);

	if (iParam2 == 1 && !flag)
		iLocal_2917[iParam0].f_2 = 0;

	if (iLocal_2917[iParam0].f_3 == 0 || iLocal_2917[iParam0].f_6 == -1)
	{
		if (flag == true)
		{
			if (!iLocal_2917[iParam0].f_2)
				iLocal_2917[iParam0].f_2 = 1;
		
			switch (iLocal_2917[iParam0])
			{
				case 1:
					break;
			
				case 2:
					switch (iLocal_2917[iParam0].f_6)
					{
						case 0:
							AUDIO::START_AUDIO_SCENE("CHI_2_DRIVE_TO_FARMHOUSE");
							iLocal_2917[iParam0].f_6 = iLocal_2917[iParam0].f_6 + 1;
							break;
				...
				case 3:
					...
					{
						if (ENTITY::DOES_ENTITY_EXIST(iLocal_755[11]))
							PED::DELETE_PED(&iLocal_755[11]);
					
						if (ENTITY::DOES_ENTITY_EXIST(iLocal_755[10]))
							PED::DELETE_PED(&iLocal_755[10]);
				...
				case 7:
					if (!PED::IS_PED_INJURED(iLocal_755[12]) && !PED::IS_PED_INJURED(iLocal_755[13]) && !PED::IS_PED_INJURED(iLocal_755[14]))
					{
						if (func_175(6, 6) < 2)
						{
							...
							{
								if (TASK::GET_SCRIPT_TASK_STATUS(iLocal_755[12], SCRIPT_TASK_LOOK_AT_ENTITY) == 7)
								{
									TASK::TASK_LOOK_AT_ENTITY(iLocal_755[13], PLAYER::PLAYER_PED_ID(), -1, 0, 2);
									TASK::TASK_LOOK_AT_ENTITY(iLocal_755[14], PLAYER::PLAYER_PED_ID(), -1, 0, 2);
									TASK::TASK_LOOK_AT_ENTITY(iLocal_755[12], PLAYER::PLAYER_PED_ID(), -1, 0, 2);
								}
							}
						}
					}
				...
				case 9:
					...
					else if (iLocal_2917[iParam0].f_6 == 1)
					{
						STREAMING::REMOVE_ANIM_DICT("missrampageintrooutro");
						iLocal_2917[iParam0].f_3 = 1;
					}
				...
				case 6:
					switch (iLocal_2917[iParam0].f_6)
					{
						case 0:
							if (!PED::IS_PED_INJURED(iLocal_755[12]) && !PED::IS_PED_INJURED(iLocal_755[13]) && !PED::IS_PED_INJURED(iLocal_755[14]))
							{
								PED::SET_PED_RELATIONSHIP_GROUP_HASH(iLocal_755[12], hLocal_2636);
								PED::SET_PED_RELATIONSHIP_GROUP_HASH(iLocal_755[13], hLocal_2636);
								PED::SET_PED_RELATIONSHIP_GROUP_HASH(iLocal_755[14], hLocal_2636);
								PED::SET_PED_COMBAT_ATTRIBUTES(iLocal_755[12], BF_AlwaysFlee, true);
								PED::SET_PED_COMBAT_ATTRIBUTES(iLocal_755[13], BF_AlwaysFlee, true);
								PED::SET_PED_COMBAT_ATTRIBUTES(iLocal_755[14], BF_AlwaysFlee, true);
								ENTITY::CLEAR_ENTITY_LAST_DAMAGE_ENTITY(iLocal_755[12]);
								ENTITY::CLEAR_ENTITY_LAST_DAMAGE_ENTITY(iLocal_755[13]);
								ENTITY::CLEAR_ENTITY_LAST_DAMAGE_ENTITY(iLocal_755[14]);
								iLocal_2917[iParam0].f_6 = iLocal_2917[iParam0].f_6 + 1;
							}
							break;
						...
						case 1:
							...
							if (!PED::IS_PED_INJURED(iLocal_755[12]))
								if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ANY_PED(iLocal_755[12]))
									iLocal_2917[iParam0].f_6 = 2;
						
							if (!PED::IS_PED_INJURED(iLocal_755[13]))
								if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ANY_PED(iLocal_755[13]))
									iLocal_2917[iParam0].f_6 = 2;
						
							if (!PED::IS_PED_INJURED(iLocal_755[14]))
								if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ANY_PED(iLocal_755[14]))
									iLocal_2917[iParam0].f_6 = 2;
							break;
				...
				case 11:
					...
					{
						case 1:
							if (MISC::GET_GAME_TIMER() > iLocal_2917[iParam0].f_7)
							{
								if (INTERIOR::IS_VALID_INTERIOR(INTERIOR::GET_INTERIOR_FROM_ENTITY(PLAYER::PLAYER_PED_ID())))
								{
									FIRE::ADD_EXPLOSION(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true) + Vector3(0f, MISC::GET_RANDOM_FLOAT_IN_RANGE(0f, 4f), MISC::GET_RANDOM_FLOAT_IN_RANGE(0f, 4f)), 16, 1.5f, true, false, 1065353216, false);
									iLocal_2917[iParam0].f_9 = iLocal_2917[iParam0].f_9 - 1f;
									iLocal_2917[iParam0].f_7 = MISC::GET_GAME_TIMER() + MISC::GET_RANDOM_INT_IN_RANGE(250, 520);
								}
								else
								{
									iLocal_2917[iParam0].f_6 = 2;
						...
						default:
							...
							{
								if (!IS_BIT_SET(iLocal_2917[iParam0].f_7, i))
								{
									if (FIRE::IS_EXPLOSION_IN_SPHERE(-1, iLocal_2889[i], 5f))
									{
										MISC::SET_BIT(&(iLocal_2917[iParam0].f_7), i);
									
										if (iLocal_2917[iParam0].f_6 == 0)
											iLocal_2917[iParam0].f_6 = MISC::GET_GAME_TIMER() + 1500;
									}
								}
							}
						
							if (MISC::GET_GAME_TIMER() > iLocal_2917[iParam0].f_8)
							{
								iLocal_2917[iParam0].f_8 = 0;
							
								for (i = 0; i < iLocal_2889; i = i + 1)
								{
									if (!IS_BIT_SET(iLocal_2917[iParam0].f_7, i + 9) && IS_BIT_SET(iLocal_2917[iParam0].f_7, i))
									{
										FIRE::ADD_EXPLOSION(iLocal_2889[i], 16, 1.5f, true, false, 1065353216, false);
										MISC::SET_BIT(&(iLocal_2917[iParam0].f_7), i + 9);
										i = 8;
										iLocal_2917[iParam0].f_8 = MISC::GET_GAME_TIMER() + MISC::GET_RANDOM_INT_IN_RANGE(150, 320);
									}
								}
							}
							...
							if (iLocal_2917[iParam0].f_6 != 0)
							{
								if (MISC::GET_GAME_TIMER() > iLocal_2917[iParam0].f_6)
								{
									iLocal_2917[iParam0].f_6 = 1;
									iLocal_2917[iParam0].f_7 = MISC::GET_GAME_TIMER() + 300;
									iLocal_2917[iParam0].f_9 = 16f;
								}
							}
							break;
					}
						...
						case 4:
							if (func_74(veLocal_2506))
							{
								if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), veLocal_2506, false))
								{
									if (VEHICLE::GET_IS_VEHICLE_ENGINE_RUNNING(veLocal_2506))
									{
										iLocal_2917[iParam0].f_7 = iLocal_2917[iParam0].f_7 + MISC::GET_GAME_TIMER() + 7000;
										iLocal_2917[iParam0].f_6 = iLocal_2917[iParam0].f_6 + 1;
									}
								}
							}
								...
								if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), veLocal_2506, false))
									if (MISC::GET_GAME_TIMER() > iLocal_2917[iParam0].f_7)
										if (AUDIO::GET_PLAYER_RADIO_STATION_GENRE() != 6 && AUDIO::GET_PLAYER_RADIO_STATION_GENRE() != 0)
											...
											iLocal_2917[iParam0].f_7 = MISC::GET_GAME_TIMER() + 5000;
							break;
				...
				case 50:
					switch (iLocal_2917[iParam0].f_6)
					{
						case 0:
							...
							{
								iLocal_2917[iParam0].f_7 = WEAPON::GET_AMMO_IN_PED_WEAPON(PLAYER::PLAYER_PED_ID(), joaat("WEAPON_PETROLCAN"));
								iLocal_2917[iParam0].f_6 = iLocal_2917[iParam0].f_6 + 1;
							}
							break;
						...
						case 1:
							if (WEAPON::HAS_PED_GOT_WEAPON(PLAYER::PLAYER_PED_ID(), joaat("WEAPON_PETROLCAN"), false))
							{
								...
								if (ammoInPedWeapon > iLocal_2917[iParam0].f_7)
								{
									iLocal_2917[iParam0].f_7 = ammoInPedWeapon;
								}
								else if (ammoInPedWeapon < iLocal_2917[iParam0].f_7)
								{
									func_9(158, iLocal_2917[iParam0].f_7 - ammoInPedWeapon, false);
									iLocal_2917[iParam0].f_7 = ammoInPedWeapon;
								}
							}
							...
							if (WEAPON::GET_CURRENT_PED_WEAPON(PLAYER::PLAYER_PED_ID(), &weaponHash, true))
							{
								if (weaponHash == joaat("WEAPON_PETROLCAN"))
								{
									if (PAD::IS_CONTROL_PRESSED(PLAYER_CONTROL, INPUT_ATTACK))
									{
										if (iLocal_2917[iParam0].f_8 == 0)
										{
											func_10(157, false);
											iLocal_2917[iParam0].f_8 = 1;
										}
									}
									else if (iLocal_2917[iParam0].f_8 == 1)
									{
										func_11(false, 157);
										iLocal_2917[iParam0].f_8 = 0;
									}
						...
						case 1:
							if (WEAPON::GET_CURRENT_PED_WEAPON(PLAYER::PLAYER_PED_ID(), &weaponHash2, true))
							{
								if (weaponHash2 == joaat("WEAPON_PETROLCAN"))
								{
									if (PAD::IS_CONTROL_PRESSED(PLAYER_CONTROL, INPUT_ATTACK))
									{
										if (iLocal_2917[iParam0].f_7 == -1)
											iLocal_2917[iParam0].f_7 = WEAPON::GET_AMMO_IN_PED_WEAPON(PLAYER::PLAYER_PED_ID(), joaat("WEAPON_PETROLCAN"));
									
										if (iLocal_269 == 0)
											iLocal_2917[iParam0].f_9 = iLocal_2917[iParam0].f_9 + (SYSTEM::TIMESTEP() * 2f);
										else if (iLocal_269 < 30 && iLocal_2917[iParam0].f_9 < 70f)
											iLocal_2917[iParam0].f_9 = iLocal_2917[iParam0].f_9 + (SYSTEM::TIMESTEP() * 1.5f);
										else
											iLocal_2917[iParam0].f_9 = iLocal_2917[iParam0].f_9 + SYSTEM::TIMESTEP();
									
										ammo = SYSTEM::FLOOR((float)iLocal_2917[iParam0].f_7 * (1f - (iLocal_2917[iParam0].f_9 / 90f)));
				...
				case 56:
					...
					{
						case 0:
							if (ENTITY::DOES_ENTITY_EXIST(iLocal_755[4].f_20))
								ENTITY::SET_OBJECT_AS_NO_LONGER_NEEDED(&(iLocal_755[4].f_20));
						
							if (ENTITY::DOES_ENTITY_EXIST(iLocal_755[5].f_20))
								ENTITY::SET_OBJECT_AS_NO_LONGER_NEEDED(&(iLocal_755[5].f_20));
						...
						case 1:
							if (PED::IS_PED_INJURED(iLocal_755[23]))
							{
								if (ENTITY::DOES_ENTITY_EXIST(obLocal_2878))
								{
				...
				case 47:
					if (!PED::IS_PED_INJURED(iLocal_755[11]))
					{
						if (!AUDIO::IS_AMBIENT_SPEECH_PLAYING(iLocal_755[11]))
						{
							if (MISC::GET_GAME_TIMER() > iLocal_2917[iParam0].f_7)
							{
								if (!PED::IS_PED_INJURED(iLocal_755[11]))
								{
									AUDIO::PLAY_PED_AMBIENT_SPEECH_WITH_VOICE_NATIVE(iLocal_755[11], "WHIMPER", "WAVELOAD_PAIN_MALE", "SPEECH_PARAMS_FORCE_NORMAL", false);
									iLocal_2917[iParam0].f_7 = MISC::GET_GAME_TIMER() + MISC::GET_RANDOM_INT_IN_RANGE(3500, 5000);
								}
							}
						}
					}
				...
				case 41:
					switch (iLocal_2917[iParam0].f_6)
					{
						...
						case 1:
							if (STREAMING::HAS_ANIM_DICT_LOADED("misschinese2_crystalmaze") && STREAMING::HAS_MODEL_LOADED(joaat("IG_TaoCheng")) && STREAMING::HAS_MODEL_LOADED(joaat("IG_TaosTranslator")))
							{
								if (!ENTITY::DOES_ENTITY_EXIST(iLocal_755[11]))
								{
									iLocal_755[11] = PED::CREATE_PED(PED_TYPE_MISSION, joaat("IG_TaoCheng"), 1991.988f, 3054.51f, 46.215f, 0, true, true);
									PED::SET_PED_RELATIONSHIP_GROUP_HASH(iLocal_755[11], hLocal_1618);
									PED::SET_PED_CAN_BE_TARGETTED(iLocal_755[11], false);
								}
								else if (!PED::IS_PED_INJURED(iLocal_755[11]))
								{
									PED::SET_PED_RELATIONSHIP_GROUP_HASH(iLocal_755[11], hLocal_1618);
									PED::SET_PED_CAN_BE_TARGETTED(iLocal_755[11], false);
								}
								...
								if (!ENTITY::DOES_ENTITY_EXIST(iLocal_755[10]))
								{
									iLocal_755[10] = PED::CREATE_PED(PED_TYPE_MISSION, joaat("IG_TaosTranslator"), 1991.988f, 3054.51f, 46.215f, 0, true, true);
									PED::SET_PED_RELATIONSHIP_GROUP_HASH(iLocal_755[10], hLocal_1618);
									PED::SET_PED_CAN_BE_TARGETTED(iLocal_755[10], false);
									PED::SET_PED_PROP_INDEX(iLocal_755[10], 1, 0, 1, false, 1);
								}
								else if (!PED::IS_PED_INJURED(iLocal_755[10]))
								{
									PED::SET_PED_RELATIONSHIP_GROUP_HASH(iLocal_755[10], hLocal_1618);
									PED::SET_PED_CAN_BE_TARGETTED(iLocal_755[10], false);
								}
								...
								if (!PED::IS_PED_INJURED(iLocal_755[11]))
								{
									if (!PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_2917[iParam0].f_7))
									{
										iLocal_2917[iParam0].f_7 = PED::CREATE_SYNCHRONIZED_SCENE(1991.988f, 3054.51f, 46.215f, 0f, 0f, 50.76f, 2);
										PED::SET_SYNCHRONIZED_SCENE_HOLD_LAST_FRAME(iLocal_2917[iParam0].f_7, true);
									}
								
									TASK::TASK_SYNCHRONIZED_SCENE(iLocal_755[11], iLocal_2917[iParam0].f_7, "misschinese2_crystalmaze", "2int_Loop_A_TaoCheng", 1000f, -4f, 257, 16, 1148846080, 0);
								}
							
								if (!PED::IS_PED_INJURED(iLocal_755[10]))
								{
									if (!PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_2917[iParam0].f_7))
									{
										iLocal_2917[iParam0].f_7 = PED::CREATE_SYNCHRONIZED_SCENE(1991.988f, 3054.51f, 46.215f, 0f, 0f, 50.76f, 2);
									...
									TASK::TASK_SYNCHRONIZED_SCENE(iLocal_755[10], iLocal_2917[iParam0].f_7, "misschinese2_crystalmaze", "2int_Loop_A_taotranslator", 1000f, -4f, 257, 16, 1148846080, 0);
								}
						...
						case 2:
							if (!PED::IS_PED_INJURED(iLocal_755[10]) && !PED::IS_PED_INJURED(iLocal_755[11]))
							{
								PED::SET_PED_COMPONENT_VARIATION(iLocal_755[10], PV_COMP_HEAD, 0, 0, 0);
								PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_755[11], true);
								PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_755[10], true);
								...
								PED::SET_PED_CONFIG_FLAG(iLocal_755[11], 118, false);
								PED::SET_PED_CONFIG_FLAG(iLocal_755[11], 208, true);
								PED::SET_PED_CONFIG_FLAG(iLocal_755[10], 118, false);
								PED::SET_PED_CONFIG_FLAG(iLocal_755[10], 208, true);
								iLocal_2917[iParam0].f_6 = 900;
							}
							break;
						...
						case 900:
							if (!PED::IS_PED_INJURED(iLocal_755[11]))
							{
								if (!PED::IS_PED_RAGDOLL(iLocal_755[11]))
								{
									if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_2917[iParam0].f_7))
									{
										if (PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_2917[iParam0].f_7) == 1f)
										{
											iLocal_2917[iParam0].f_7 = PED::CREATE_SYNCHRONIZED_SCENE(1991.988f, 3054.51f, 46.215f, 0f, 0f, 50.76f, 2);
											PED::SET_SYNCHRONIZED_SCENE_HOLD_LAST_FRAME(iLocal_2917[iParam0].f_7, true);
											...
											{
												TASK::TASK_SYNCHRONIZED_SCENE(iLocal_755[11], iLocal_2917[iParam0].f_7, "misschinese2_crystalmaze", "2int_Loop_Base_TaoCheng", 1000f, -4f, 257, 16, 1148846080, 0);
											
												if (!PED::IS_PED_INJURED(iLocal_755[10]))
													if (!PED::IS_PED_RAGDOLL(iLocal_755[10]))
														if (!IS_BIT_SET(iLocal_2917[iParam0].f_8, 0))
															TASK::TASK_SYNCHRONIZED_SCENE(iLocal_755[10], iLocal_2917[iParam0].f_7, "misschinese2_crystalmaze", "2int_Loop_Base_taotranslator", 1000f, -4f, 257, 16, 1148846080, 0);
											}
											else
											{
												TASK::TASK_SYNCHRONIZED_SCENE(iLocal_755[11], iLocal_2917[iParam0].f_7, "misschinese2_crystalmaze", "2int_Loop_A_TaoCheng", 1000f, -4f, 257, 16, 1148846080, 0);
							...
							if (!PED::IS_PED_INJURED(iLocal_755[10]))
							{
								if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_755[10], PLAYER::PLAYER_PED_ID(), true) || PED::IS_PED_RAGDOLL(iLocal_755[10]) || PED::IS_PED_INJURED(iLocal_755[11]) || !PED::IS_PED_INJURED(iLocal_755[10]) && TASK::GET_SCRIPT_TASK_STATUS(iLocal_755[10], SCRIPT_TASK_SYNCHRONIZED_SCENE) == 2)
								{
									if (!IS_BIT_SET(iLocal_2917[iParam0].f_8, 0))
									{
										TASK::CLEAR_PED_TASKS(iLocal_755[10]);
										func_99();
										TASK::TASK_SMART_FLEE_PED(0, PLAYER::PLAYER_PED_ID(), 30f, 20000, false, false);
										TASK::TASK_COWER(0, -1);
										func_98(&iLocal_755[10], false);
										MISC::SET_BIT(&(iLocal_2917[iParam0].f_8), 0);
									}
								}
							}
							...
							if (!PED::IS_PED_INJURED(iLocal_755[11]))
							{
								if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_755[11], PLAYER::PLAYER_PED_ID(), true) || PED::IS_PED_RAGDOLL(iLocal_755[11]) || IS_BIT_SET(iLocal_2917[iParam0].f_8, 1) || !PED::IS_PED_INJURED(iLocal_755[11]) && TASK::GET_SCRIPT_TASK_STATUS(iLocal_755[11], SCRIPT_TASK_SYNCHRONIZED_SCENE) == 2)
								{
									ENTITY::SET_ENTITY_HEALTH(iLocal_755[11], 0, 0);
									!PED::IS_PED_RAGDOLL(iLocal_755[11]);
								}
							}
						
							if (func_73(PLAYER::PLAYER_PED_ID(), 1991.988f, 3054.51f, 46.215f, true) > 200f)
							{
								if (ENTITY::DOES_ENTITY_EXIST(iLocal_755[11]) && ENTITY::DOES_ENTITY_EXIST(iLocal_755[10]))
								{
									PED::DELETE_PED(&iLocal_755[11]);
									PED::DELETE_PED(&iLocal_755[10]);
								}
					...
					{
						if (!PED::IS_PED_INJURED(iLocal_755[11]))
							if (TASK::GET_SCRIPT_TASK_STATUS(iLocal_755[11], SCRIPT_TASK_LOOK_AT_ENTITY) != 1)
								TASK::TASK_LOOK_AT_ENTITY(iLocal_755[11], PLAYER::PLAYER_PED_ID(), 4000, SLF_WIDEST_YAW_LIMIT | 32 | 2048, 2);
					
						if (!PED::IS_PED_INJURED(iLocal_755[10]))
							if (TASK::GET_SCRIPT_TASK_STATUS(iLocal_755[10], SCRIPT_TASK_LOOK_AT_ENTITY) != 1)
								TASK::TASK_LOOK_AT_ENTITY(iLocal_755[10], PLAYER::PLAYER_PED_ID(), 4000, SLF_WIDEST_YAW_LIMIT | 32 | 2048, 2);
					}
					break;
				...
				case 13:
					...
					for (k = 0; k < iLocal_755; k = k + 1)
					{
						if (ENTITY::DOES_ENTITY_EXIST(iLocal_755[k]))
						{
							if (PED::IS_PED_INJURED(iLocal_755[k]))
							{
								if (iLocal_755[k].f_21 == 0)
								{
									if (PED::GET_PED_CAUSE_OF_DEATH(iLocal_755[k]) == joaat("WEAPON_ASSAULTSNIPER") || PED::GET_PED_CAUSE_OF_DEATH(iLocal_755[k]) == joaat("WEAPON_HEAVYSNIPER") || PED::GET_PED_CAUSE_OF_DEATH(iLocal_755[k]) == joaat("WEAPON_REMOTESNIPER") || PED::GET_PED_CAUSE_OF_DEATH(iLocal_755[k]) == joaat("WEAPON_SNIPERRIFLE"))
				...
				case 20:
					...
					{
						case 0:
							iLocal_2917[iParam0].f_7 = MISC::GET_GAME_TIMER() + 4000;
							iLocal_2917[iParam0].f_6 = iLocal_2917[iParam0].f_6 + 1;
							break;
						...
						case 1:
							if (MISC::GET_GAME_TIMER() > iLocal_2917[iParam0].f_7)
							{
								...
								while (iLocal_2917[iParam0].f_7 < iLocal_755)
								{
									if (!PED::IS_PED_INJURED(iLocal_755[iLocal_2917[iParam0].f_7]))
									{
										if (INTERIOR::GET_INTERIOR_FROM_ENTITY(iLocal_755[iLocal_2917[iParam0].f_7]) == 0)
										{
											iLocal_755[iLocal_2917[iParam0].f_7].f_1 = 5;
											iLocal_1619[iLocal_2917[iParam0].f_7].f_3 = 7;
											iLocal_1619[iLocal_2917[iParam0].f_7].f_4 = 0;
											iLocal_1619[iLocal_2917[iParam0].f_7].f_5 = 0;
											func_105(iLocal_2917[iParam0].f_7, 27, 0, 0);
											PED::SET_PED_RELATIONSHIP_GROUP_HASH(iLocal_755[iLocal_2917[iParam0].f_7], hLocal_1617);
											func_134(&(iLocal_755[iLocal_2917[iParam0].f_7].f_25));
										}
									}
								
									iLocal_2917[iParam0].f_7 = iLocal_2917[iParam0].f_7 + 1;
								}
							}
							break;
					}
				...
				case 21:
					...
					{
						if (!PED::IS_PED_INJURED(iLocal_755[iLocal_2917[iParam0].f_7]))
							if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(iLocal_755[iLocal_2917[iParam0].f_7], 2457.8848f, 4981.1694f, 50.00518f, 2441.5798f, 4965.0884f, 56.240055f, 34.3125f, false, true, 0))
								PED::DELETE_PED(&iLocal_755[iLocal_2917[iParam0].f_7]);
				...
				case 23:
					...
					{
						if (!PED::IS_PED_INJURED(iLocal_755[l]))
						{
							if (INTERIOR::GET_ROOM_KEY_FROM_ENTITY(iLocal_755[l]) != MISC::GET_HASH_KEY("V_8_BasementRm"))
							{
								func_105(l, 27, 0, 0);
								iLocal_755[l].f_1 = 5;
								iLocal_1619[l].f_3 = 7;
				...
				case 24:
					...
					{
						case 0:
							iLocal_2917[iParam0].f_7 = func_18(10);
						...
						case 1:
							if (!PED::IS_PED_INJURED(iLocal_755[iLocal_2917[iParam0].f_7]))
							{
								func_105(iLocal_2917[iParam0].f_7, 18, 0, 0);
								iLocal_2917[iParam0].f_3 = 1;
							}
							else
							{
				...
				case 45:
					if (func_93(9) || !PED::IS_PED_INJURED(iLocal_755[8]) && PED::IS_PED_IN_COMBAT(iLocal_755[8], 0) || !PED::IS_PED_INJURED(iLocal_755[9]) && PED::IS_PED_IN_COMBAT(iLocal_755[9], 0))
					{
						if (!PED::IS_PED_INJURED(iLocal_755[8]))
							PED::SET_PED_ACCURACY(iLocal_755[8], 45);
					
						if (!PED::IS_PED_INJURED(iLocal_755[9]))
							PED::SET_PED_ACCURACY(iLocal_755[9], 45);
				...
				case 29:
					if (func_93(9))
					{
						...
						{
							if (!PED::IS_PED_INJURED(iLocal_755[iLocal_2917[iParam0].f_7]))
								PED::SET_PED_SEEING_RANGE(iLocal_755[iLocal_2917[iParam0].f_7], 60f);
						...
						switch (iLocal_2917[iParam0].f_6)
						{
							case 0:
								if (func_93(12))
								{
									...
									{
										if (!PED::IS_PED_INJURED(iLocal_755[iLocal_2917[iParam0].f_7]))
											if (iLocal_755[iLocal_2917[iParam0].f_7].f_1 == 1)
												PED::SET_PED_SEEING_RANGE(iLocal_755[iLocal_2917[iParam0].f_7], 5f);
							...
							case 1:
								if (func_162(12))
								{
									...
									while (iLocal_2917[iParam0].f_7 < iLocal_755)
									{
										if (!PED::IS_PED_INJURED(iLocal_755[iLocal_2917[iParam0].f_7]))
											if (iLocal_755[iLocal_2917[iParam0].f_7].f_1 == 1)
												PED::SET_PED_SEEING_RANGE(iLocal_755[iLocal_2917[iParam0].f_7], 30f);
					...
					switch (iLocal_2917[iParam0].f_6)
					{
						...
						case 1:
							if (STREAMING::HAS_ANIM_DICT_LOADED("misschinese2_crystalmaze"))
							{
								if (!PED::IS_PED_INJURED(iLocal_755[23]))
								{
									iLocal_2917[iParam0].f_7 = PED::CREATE_SYNCHRONIZED_SCENE(2435.312f, 4967.087f, 41.35f, 0f, 0f, 11.4f, 2);
									PED::SET_SYNCHRONIZED_SCENE_LOOPED(iLocal_2917[iParam0].f_7, true);
									TASK::TASK_SYNCHRONIZED_SCENE(iLocal_755[iLocal_2917[iParam0].f_7], iLocal_2917[iParam0].f_8, "misschinese2_crystalmaze", "_stand_to_aim", 1000f, -8f, 0, 0, 1148846080, 0);
									iLocal_2917[iParam0].f_6 = iLocal_2917[iParam0].f_6 + 1;
								}
							}
							break;
				...
				case 39:
					...
					{
						case 0:
							iLocal_2917[iParam0].f_7 = func_18(4);
							iLocal_2917[iParam0].f_6 = iLocal_2917[iParam0].f_6 + 1;
							break;
					
						case 1:
							if (func_73(iLocal_755[iLocal_2917[iParam0].f_7], 2454.8953f, 4950.8945f, 44.1488f, true) > 100f && func_4(iLocal_755[iLocal_2917[iParam0].f_7], PLAYER::PLAYER_PED_ID(), true) > 100f)
							{
								num5 = func_18(4);
								func_134(&(iLocal_755[num5].f_25));
							
								if (!PED::IS_PED_INJURED(iLocal_755[num5]))
								{
									PED::SET_PED_KEEP_TASK(iLocal_755[num5], true);
									ENTITY::SET_PED_AS_NO_LONGER_NEEDED(&iLocal_755[num5]);
								}
				...
				case 40:
					...
					{
						PED::SET_PED_ACCURACY(iLocal_755[24], 100);
					
						if (!PED::IS_PED_INJURED(iLocal_755[15]))
							PED::SET_PED_ACCURACY(iLocal_755[15], 100);
					
						if (!PED::IS_PED_INJURED(iLocal_755[16]))
							PED::SET_PED_ACCURACY(iLocal_755[16], 100);
					
						if (!PED::IS_PED_INJURED(iLocal_755[17]))
							PED::SET_PED_ACCURACY(iLocal_755[17], 100);
					
						TASK::TASK_COMBAT_PED(iLocal_755[24], PLAYER::PLAYER_PED_ID(), 0, 16);
						PED::SET_PED_TARGET_LOSS_RESPONSE(iLocal_755[24], 1);
						ENTITY::SET_ENTITY_HEALTH(iLocal_755[24], 200, 0);
						iLocal_2917[iParam0].f_3 = 1;
					}
					break;
			}
		
			if (iLocal_2917[iParam0].f_6 == -1)
			{
				iLocal_2917[iParam0].f_3 = 1;
				iLocal_2917[iParam0].f_6 = 0;
				iLocal_2917[iParam0].f_1 = 0;
			}
		}
	}
...
void func_167() // Position - 0x1648B
{
	...
	for (i = 0; i < iLocal_444; i = i + 1)
	{
		if (!func_168(iLocal_444[i], 0f, 0f, 0f, false))
		{
			FIRE::STOP_FIRE_IN_RANGE(iLocal_444[i], 4f);
			MISC::CLEAR_AREA(iLocal_444[i], 2f, true, false, false, false);
		
			for (j = 0; j < iLocal_755; j = j + 1)
			{
				if (ENTITY::DOES_ENTITY_EXIST(iLocal_755[j]))
				{
					entityCoords = Vector3(ENTITY::GET_ENTITY_COORDS(iLocal_755[j], false));
				
					if (SYSTEM::VDIST2(entityCoords, iLocal_444[i]) < 2f && entityCoords.f_2 > 43.9f)
						PED::DELETE_PED(&iLocal_755[j]);
				}
			}
		}
	}
...
void func_169(BOOL bParam0) // Position - 0x16585
{
	...
	for (i = 0; i < iLocal_444; i = i + 1)
	{
		GRAPHICS::REMOVE_DECALS_IN_RANGE(iLocal_444[i], 1f);
		...
		{
			iLocal_444[i] = Vector3(HUD::GET_BLIP_COORDS(iLocal_444[i].f_3));
	...
	for (i = 0; i < iLocal_281; i = i + 1)
	{
		iLocal_281[i].f_1 = Vector3( 0f, 0f, 0f );
		iLocal_281[i].f_4 = 0;
	}
...
{
	if (iLocal_2917[iParam0] == iParam1)
		return iLocal_2917[iParam0].f_6;
...
void func_176(int iParam0, int iParam1) // Position - 0x16845
{
	...
	if (iLocal_3120[0] != iParam0 && iLocal_3120[num] != iParam1)
	{
		num2 = 0;
	...
	{
		switch (iLocal_3120[j])
		{
			case 2:
				if (!iLocal_3120[j].f_2)
					if (iLocal_3120[j].f_4 == 0)
			...
			case 7:
				if (!iLocal_3120[j].f_2)
				{
					switch (iLocal_3120[j].f_4)
					{
						case 0:
							iLocal_3120[j].f_5 = func_18(8);
							iLocal_3120[j].f_6 = func_18(9);
							iLocal_3120[j].f_4 = iLocal_3120[j].f_4 + 1;
							break;
					
						case 1:
							if (iLocal_3120[j].f_5 != -1 && iLocal_3120[j].f_6 != -1)
								if (ENTITY::DOES_ENTITY_EXIST(iLocal_755[iLocal_3120[j].f_5]) && ENTITY::DOES_ENTITY_EXIST(iLocal_755[iLocal_3120[j].f_6]))
									if (PED::IS_PED_INJURED(iLocal_755[iLocal_3120[j].f_5]) || PED::IS_PED_INJURED(iLocal_755[iLocal_3120[j].f_6]))
										iLocal_3120[j].f_2 = 1;
							break;
					}
				}
			...
			case 15:
				...
				{
					case 0:
						iLocal_3120[j].f_5 = func_18(17);
					
						if (iLocal_3120[j].f_5 != -1)
							iLocal_3120[j].f_4 = iLocal_3120[j].f_4 + 1;
						break;
				
					case 1:
						if (ENTITY::DOES_ENTITY_EXIST(iLocal_755[iLocal_3120[j].f_5]))
						{
							if (PED::IS_PED_INJURED(iLocal_755[iLocal_3120[j].f_5]))
							{
								if (func_73(iLocal_755[iLocal_3120[j].f_5], 2427.8506f, 4964.9717f, 43.1704f, true) < 3f)
								{
									iLocal_3120[j].f_2 = 1;
									iLocal_3120[j].f_4 = iLocal_3120[j].f_4 + 1;
								}
			...
			case 26:
				...
				{
					if (!PED::IS_PED_INJURED(iLocal_755[15]))
						if (func_73(iLocal_755[15], 2439.386f, 4962.0493f, 45.904697f, true) < 3f)
							iLocal_3120[j].f_2 = 1;
				
					if (!PED::IS_PED_INJURED(iLocal_755[16]))
						if (func_73(iLocal_755[16], 2439.386f, 4962.0493f, 45.904697f, true) < 3f)
							iLocal_3120[j].f_2 = 1;
				
					if (!PED::IS_PED_INJURED(iLocal_755[17]))
						if (func_73(iLocal_755[17], 2439.386f, 4962.0493f, 45.904697f, true) < 3f)
							iLocal_3120[j].f_2 = 1;
			...
			case 27:
				...
				{
					case 0:
						if (!PED::IS_PED_INJURED(iLocal_755[4]) && PED::IS_PED_SITTING_IN_ANY_VEHICLE(iLocal_755[4]))
							iLocal_3120[j].f_4 = iLocal_3120[j].f_4 + 1;
					
						if (!PED::IS_PED_INJURED(iLocal_755[5]) && PED::IS_PED_SITTING_IN_ANY_VEHICLE(iLocal_755[5]))
							iLocal_3120[j].f_4 = iLocal_3120[j].f_4 + 1;
					
						if (!PED::IS_PED_INJURED(iLocal_755[7]) && PED::IS_PED_SITTING_IN_ANY_VEHICLE(iLocal_755[7]))
							iLocal_3120[j].f_4 = iLocal_3120[j].f_4 + 1;
					
						iLocal_3120[j].f_5 = MISC::GET_GAME_TIMER() + 8000;
						break;
				
					case 1:
						if (VEHICLE::IS_VEHICLE_DRIVEABLE(veLocal_2507, false))
							if (func_96(ENTITY::GET_ENTITY_COORDS(veLocal_2507, true), 5f, 150f))
								iLocal_3120[j].f_6 = iLocal_3120[j].f_6 + SYSTEM::FLOOR(SYSTEM::TIMESTEP() * 1000f);
					
						if (iLocal_3120[j].f_6 > 1500)
							iLocal_3120[j].f_2 = 1;
					
						if (MISC::GET_GAME_TIMER() > iLocal_3120[j].f_5)
							iLocal_3120[j].f_4 = iLocal_3120[j].f_4 + 1;
						break;
				}
				break;
			...
			case 29:
				...
				switch (iLocal_3120[j].f_5)
				{
					case 0:
						if (WEAPON::HAS_PED_GOT_WEAPON(PLAYER::PLAYER_PED_ID(), joaat("WEAPON_PETROLCAN"), false))
							iLocal_3120[j].f_5 = 10;
						else
							iLocal_3120[j].f_5 = 20;
						break;
				}
			...
			case 47:
				...
				{
					case 0:
						iLocal_3120[j].f_5 = MISC::GET_GAME_TIMER() + 30000;
						iLocal_3120[j].f_4 = iLocal_3120[j].f_4 + 1;
						break;
...
{
	if (FIRE::GET_NUMBER_OF_FIRES_IN_RANGE(iLocal_444[iParam0], 0.6f) > 0)
		return true;
...
BOOL func_180() // Position - 0x17820
{
	...
	for (i = iLocal_444 - 1; i >= 0; i = i + -1)
	{
		if (iLocal_444[i].f_4)
		{
			if (FIRE::GET_NUMBER_OF_FIRES_IN_RANGE(iLocal_444[i], 0.6f) > 0)
			{
				uLocal_277 = Vector3(iLocal_444[i]);
				iLocal_280 = i;
				return true;
			}
		}
...
void func_181() // Position - 0x1787F
{
	...
	switch (iLocal_2512)
	{
		case 0:
			...
			for (i = 49; i <= 55; i = i + 1)
			{
				iLocal_444[i] = Vector3(iLocal_444[i] + Vector3(0.6f, 0f, 0f));
			}
			...
			for (j = 0; j < iLocal_755; j = j + 1)
			{
				...
				if (ENTITY::DOES_ENTITY_EXIST(iLocal_755[j].f_20))
					OBJECT::DELETE_OBJECT(&(iLocal_755[j].f_20));
			}
	...
	for (k = 0; k < iLocal_2380; k = k + 1)
	{
		...
		{
			uLocal_2455[k] = 0;
			iLocal_2380[k] = Vector3(CAM::GET_CAM_COORD(CAM::GET_RENDERING_CAM()));
			iLocal_2380[k].f_3 = Vector3(CAM::GET_CAM_ROT(CAM::GET_RENDERING_CAM(), 2));
			iLocal_2380[k].f_14 = CAM::GET_CAM_FOV(CAM::GET_RENDERING_CAM());
		}
	
		if (uLocal_2460[k])
		{
			uLocal_2460[k] = 0;
			iLocal_2380[k].f_6 = Vector3(CAM::GET_CAM_COORD(CAM::GET_RENDERING_CAM()));
			iLocal_2380[k].f_9 = Vector3(CAM::GET_CAM_ROT(CAM::GET_RENDERING_CAM(), 2));
			iLocal_2380[k].f_15 = CAM::GET_CAM_FOV(CAM::GET_RENDERING_CAM());
		}
	}
	...
	if (bLocal_2341)
	{
		...
		if (iLocal_2454 == -1 || iLocal_2454 != -1 && iLocal_2454 < 4 && fLocal_2453 > iLocal_2380[iLocal_2454].f_13 / 1000f)
		{
			...
			{
				CAM::DESTROY_ALL_CAMS(false);
				caLocal_2637 = CAM::CREATE_CAM_WITH_PARAMS("DEFAULT_SCRIPTED_CAMERA", iLocal_2380[iLocal_2454], iLocal_2380[iLocal_2454].f_3, iLocal_2380[iLocal_2454].f_14, true, 2);
				CAM::SET_CAM_PARAMS(caLocal_2637, iLocal_2380[iLocal_2454].f_6, iLocal_2380[iLocal_2454].f_9, iLocal_2380[iLocal_2454].f_15, SYSTEM::FLOOR(iLocal_2380[iLocal_2454].f_12), iLocal_2380[iLocal_2454].f_16, 1, 2);
				CAM::RENDER_SCRIPT_CAMS(true, false, 3000, true, false, 0);
			
				if (iLocal_2454 < 2)
					func_189(iLocal_2380[iLocal_2454].f_17, true, 1);
				else
					func_189(iLocal_2380[iLocal_2454].f_17, true, 0);
		...
		for (l = 0; l < iLocal_2343; l = l + 1)
		{
			if (!iLocal_2343[l])
			{
				if (iLocal_2454 == iLocal_2343[l].f_1 && fLocal_2453 > iLocal_2343[l].f_2 / 1000f)
				{
					switch (l)
					{
						case 0:
							switch (iLocal_2343[l].f_4)
							{
								case 0:
									iLocal_2505 = 0;
								
									if (MISC::GET_GAME_TIMER() > iLocal_2343[l].f_5)
									{
										func_128(uLocal_2465[iLocal_2505], false);
										iLocal_2343[l].f_5 = MISC::GET_GAME_TIMER() + 200;
										iLocal_2343[l].f_4 = iLocal_2343[l].f_4 + 1;
									}
									break;
								...
								case 1:
									if (MISC::GET_GAME_TIMER() > iLocal_2343[l].f_5)
									{
										func_128((uLocal_2465[iLocal_2505] + uLocal_2465[iLocal_2505 + 1]) / Vector3( 2f, 2f, 2f ), false);
										iLocal_2505 = iLocal_2505 + 1;
									
										if (iLocal_2505 >= 12)
										{
											iLocal_2343[l].f_4 = 10;
											iLocal_2343[l] = 1;
										}
										else
										{
								...
								case 3:
									...
									{
										func_128((uLocal_2465[iLocal_2505] + uLocal_2465[iLocal_2505 + 1]) / Vector3( 2f, 2f, 2f ), false);
										func_128((uLocal_2465[iLocal_2505] + uLocal_2465[iLocal_2505 + 2]) / Vector3( 2f, 2f, 2f ), false);
										iLocal_2343[l].f_5 = MISC::GET_GAME_TIMER() + 200;
										iLocal_2343[l].f_4 = 4;
										iLocal_2505 = 3;
									}
								...
								case 4:
									...
									{
										func_128(uLocal_2465[iLocal_2505], false);
										func_128(uLocal_2465[iLocal_2505 + 1], false);
										iLocal_2343[l].f_5 = MISC::GET_GAME_TIMER() + 200;
										iLocal_2343[l].f_4 = 5;
									}
									break;
								...
								case 5:
									...
									{
										func_128((uLocal_2465[iLocal_2505] + uLocal_2465[iLocal_2505 + 2]) / Vector3( 2f, 2f, 2f ), false);
										func_128((uLocal_2465[iLocal_2505 + 1] + uLocal_2465[iLocal_2505 + 3]) / Vector3( 2f, 2f, 2f ), false);
										iLocal_2343[l].f_5 = MISC::GET_GAME_TIMER() + 200;
										iLocal_2343[l].f_4 = 6;
										iLocal_2505 = 5;
									}
						...
						case 5:
							switch (iLocal_2343[l].f_4)
							{
								case 0:
									fLocal_2674 = 1f;
									iLocal_2343[l].f_4 = iLocal_2343[l].f_4 + 1;
									iLocal_2343[l].f_5 = MISC::GET_GAME_TIMER() + 1300;
...
void func_184() // Position - 0x186A7
{
	...
	{
		if (iLocal_2917[i].f_4)
		{
			iLocal_2917[i].f_1 = 1;
			iLocal_2917[i].f_6 = -1;
			func_166(i, iLocal_2917[i], 0, 0, 0, 1, 0, 1, 0, 1, 0);
		}
	...
	switch (iLocal_2512)
	{
		case 0:
			if (STREAMING::IS_SRL_LOADED())
			{
				...
				if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
				{
					...
					uLocal_752 = Vector3(ENTITY::GET_ENTITY_VELOCITY(veLocal_260));
				...
				if (iLocal_2512 == 1)
				{
					...
					caLocal_2637 = CAM::CREATE_CAM("DEFAULT_SPLINE_CAMERA", true);
				...
				else
				{
					switch (iLocal_2512)
					{
						...
						case 4:
							...
							CAM::ADD_CAM_SPLINE_NODE(caLocal_2637, Vector3(47.5f, 4889.7f, 2403.6f) + Vector3(0.07f, 2.15f, 0.8f), 3.4f, 0f, -19.5f, 6000, 3, 2);
						...
						case 5:
							...
							CAM::ADD_CAM_SPLINE_NODE(caLocal_2637, Vector3(45.7f, 4934.8f, 2493.4f) + Vector3( 0f, 1f, -1f ), 5.2f, 0f, 48f, 6000, 3, 2);
							CAM::SET_CAM_FOV(caLocal_2637, 28.5f);
							CAM::SET_CAM_SPLINE_SMOOTHING_STYLE(caLocal_2637, 0);
							break;
				...
				{
					if (!PED::IS_PED_INJURED(iLocal_755[i]))
						AUDIO::STOP_PED_SPEAKING(iLocal_755[i], true);
				}
		...
		case 11:
			...
			if (CAM::IS_SCREEN_FADED_OUT() && !CUTSCENE::IS_CUTSCENE_PLAYING() || CUTSCENE::IS_CUTSCENE_ACTIVE() && CUTSCENE::CAN_SET_EXIT_STATE_FOR_CAMERA(true))
			{
				...
				{
					if (!PED::IS_PED_INJURED(iLocal_755[iLocal_2885]))
						PED::DELETE_PED(&iLocal_755[iLocal_2885]);
				
					if (ENTITY::DOES_ENTITY_EXIST(iLocal_755[iLocal_2885].f_20))
						OBJECT::DELETE_OBJECT(&(iLocal_755[iLocal_2885].f_20));
				
					iLocal_1619[iLocal_2885].f_3 = 1;
					iLocal_755[iLocal_2885].f_5 = 0;
					iLocal_755[iLocal_2885].f_14 = 0;
					iLocal_755[iLocal_2885].f_3 = 2;
				}
				...
				{
					if (!PED::IS_PED_INJURED(iLocal_755[iLocal_2886]))
						PED::DELETE_PED(&iLocal_755[iLocal_2886]);
				
					if (ENTITY::DOES_ENTITY_EXIST(iLocal_755[iLocal_2886].f_20))
						OBJECT::DELETE_OBJECT(&(iLocal_755[iLocal_2886].f_20));
				
					iLocal_1619[iLocal_2886].f_3 = 1;
					iLocal_755[iLocal_2886].f_5 = 0;
					iLocal_755[iLocal_2886].f_14 = 0;
					iLocal_755[iLocal_2886].f_3 = 2;
				}
				...
				{
					if (!PED::IS_PED_INJURED(iLocal_755[j]))
						AUDIO::STOP_PED_SPEAKING(iLocal_755[j], false);
				}
...
void func_208() // Position - 0x1A4B0
{
	...
	{
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_755[i]))
			PED::DELETE_PED(&iLocal_755[i]);
	
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_755[i].f_20))
			OBJECT::DELETE_OBJECT(&(iLocal_755[i].f_20));
	
		iLocal_755[i].f_3 = 0;
		iLocal_755[i].f_4 = 0;
		iLocal_755[i].f_6 = Vector3( 0f, 0f, 0f );
		iLocal_755[i].f_9 = Vector3( 0f, 0f, 0f );
		iLocal_755[i].f_2 = 25;
		iLocal_755[i].f_5 = 0;
		iLocal_755[i].f_12 = 0f;
		iLocal_755[i].f_13 = 0f;
		iLocal_755[i].f_14 = 0;
		iLocal_755[i].f_15 = 0;
		iLocal_755[i].f_17 = 0;
		iLocal_755[i].f_16 = 0;
...
void func_209(var uParam0, var uParam1, char* sParam2, float fParam3, float fParam4, float fParam5, float fParam6, float fParam7, int iParam8) // Position - 0x1A644
{
	...
	bLocal_57 = bLocal_57;
	fLocal_70 = fParam3;
	uLocal_71 = Vector3(fParam4);
	fLocal_74 = fParam7;
	uLocal_89 = Vector3(*uParam1);
	sLocal_254 = sParam2;
	...
	for (i = 0; i < *uParam0; i = i + 1)
	{
		...
		uParam0->[i].f_10 = 0;
		uParam0->[i].f_11 = 0;
		uParam0->[i].f_12 = Vector3( 0f, 0f, 0f );
		uParam0->[i].f_15 = Vector3( 0f, 0f, 0f );
		uParam0->[i].f_18 = 0f;
	}
			...
			if (ENTITY::DOES_ENTITY_EXIST(pblParam0->f_17[i]))
			{
				if (!PED::IS_PED_INJURED(pblParam0->f_17[i]))
				{
					...
					else if (VEHICLE::IS_VEHICLE_DRIVEABLE(veParam10, false))
					{
						if (!PED::IS_PED_SITTING_IN_VEHICLE(pblParam0->f_17[i], veParam10))
						{
							if (ENTITY::IS_ENTITY_AT_ENTITY(pblParam0->f_17[i], veParam10, 20f, 20f, 5f, false, true, 0) && !IS_BIT_SET(pblParam0->f_13, 11) && !(bParam17 && PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0) && !PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), veParam10, false)))
							{
								...
								else
								{
									...
									{
										if (!PED::IS_PED_JUMPING_OUT_OF_VEHICLE(pblParam0->f_17[i]) && !PED::IS_PED_JUMPING_OUT_OF_VEHICLE(PLAYER::PLAYER_PED_ID()) && !func_253(pblParam0->f_17[i], 2f) && !PED::IS_PED_RAGDOLL(pblParam0->f_17[i]) && !TASK::IS_PED_GETTING_UP(pblParam0->f_17[i]) && !FIRE::IS_ENTITY_ON_FIRE(veParam10))
										{
											PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(pblParam0->f_17[i], true);
						...
						else if (PED::IS_PED_GROUP_MEMBER(pblParam0->f_17[i], func_219()) && !FIRE::IS_ENTITY_ON_FIRE(veParam10))
						{
							PED::REMOVE_PED_FROM_GROUP(pblParam0->f_17[i]);
						}
					}
	...
	switch (iLocal_2512)
	{
		case 0:
			...
			if (func_210())
			{
				...
				{
					iLocal_755[14] = Global_97178.f_9[2];
					iLocal_755[13] = Global_97178.f_9[1];
					iLocal_755[11] = Global_97178.f_9[4];
					iLocal_755[10] = Global_97178.f_9[3];
					iLocal_755[12] = Global_97178.f_9[0];
					ENTITY::SET_ENTITY_AS_MISSION_ENTITY(iLocal_755[14], true, true);
					ENTITY::SET_ENTITY_AS_MISSION_ENTITY(iLocal_755[13], true, true);
					ENTITY::SET_ENTITY_AS_MISSION_ENTITY(iLocal_755[11], true, true);
					ENTITY::SET_ENTITY_AS_MISSION_ENTITY(iLocal_755[10], true, true);
					ENTITY::SET_ENTITY_AS_MISSION_ENTITY(iLocal_755[12], true, true);
				
					if (!PED::IS_PED_INJURED(iLocal_755[13]))
						CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(iLocal_755[13], "Old_Man1A", 0, joaat("IG_Old_Man1A"), 0);
				
					if (!PED::IS_PED_INJURED(iLocal_755[14]))
						CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(iLocal_755[14], "Old_Man2", 0, joaat("IG_Old_Man2"), 0);
				
					if (!PED::IS_PED_INJURED(iLocal_755[11]))
						CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(iLocal_755[11], "tao", 0, joaat("IG_TaoCheng"), 0);
				
					if (!PED::IS_PED_INJURED(iLocal_755[10]))
						CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(iLocal_755[10], "Taos_Translator", 0, joaat("IG_TaosTranslator"), 0);
				
					if (!PED::IS_PED_INJURED(iLocal_755[12]))
						CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(iLocal_755[12], "Janet", 0, joaat("IG_Janet"), 0);
				}
				else
				{
					iLocal_755[13] = PED::CREATE_PED(PED_TYPE_MISSION, joaat("IG_Old_Man1A"), 1987.231f, 3052.741f, 46.214f, 0, true, true);
					...
					if (ENTITY::DOES_ENTITY_EXIST(iLocal_755[11]))
						...
						CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(iLocal_755[11], "tao", 2, joaat("IG_TaoCheng"), 0);
				
					CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(iLocal_755[10], "Taos_Translator", 2, joaat("IG_TaosTranslator"), 0);
					iLocal_755[12] = PED::CREATE_PED(PED_TYPE_MISSION, joaat("IG_Janet"), 1987.231f, 3052.741f, 46.214f, 0, true, true);
					CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(iLocal_755[12], "Janet", 0, joaat("IG_Janet"), 0);
				}
				...
				PED::ADD_SCENARIO_BLOCKING_AREA(Vector3(50.277412f, 3054.8843f, 1991.2196f) - Vector3( 40f, 40f, 40f ), Vector3(50.277412f, 3054.8843f, 1991.2196f) + Vector3( 40f, 40f, 40f ), false, true, true, true);
				PED::SET_PED_NON_CREATION_AREA(Vector3(50.277412f, 3054.8843f, 1991.2196f) - Vector3( 40f, 40f, 40f ), Vector3(50.277412f, 3054.8843f, 1991.2196f) + Vector3( 0f, 40f, 40f ));
				func_32(0, 0);
				func_32(26, 0);
				iLocal_3689 = 0;
				iLocal_2512 = iLocal_2512 + 1;
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(iLocal_755[13]))
				if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Old_Man1A", 0))
					iLocal_755[13] = ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(CUTSCENE::GET_ENTITY_INDEX_OF_REGISTERED_ENTITY("Old_Man1A", 0));
		
			if (!ENTITY::DOES_ENTITY_EXIST(iLocal_755[14]))
				if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Old_Man2", 0))
					iLocal_755[14] = ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(CUTSCENE::GET_ENTITY_INDEX_OF_REGISTERED_ENTITY("Old_Man2", 0));
		
			if (!ENTITY::DOES_ENTITY_EXIST(iLocal_755[11]))
				if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("tao", 0))
					iLocal_755[11] = ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(CUTSCENE::GET_ENTITY_INDEX_OF_REGISTERED_ENTITY("tao", 0));
		
			if (!ENTITY::DOES_ENTITY_EXIST(iLocal_755[10]))
				if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Taos_Translator", 0))
					iLocal_755[10] = ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(CUTSCENE::GET_ENTITY_INDEX_OF_REGISTERED_ENTITY("Taos_Translator", 0));
		
			if (!ENTITY::DOES_ENTITY_EXIST(iLocal_755[12]))
				if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Janet", 0))
					iLocal_755[12] = ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(CUTSCENE::GET_ENTITY_INDEX_OF_REGISTERED_ENTITY("Janet", 0));
			...
			if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("tao", 0))
			{
				if (!PED::IS_PED_INJURED(iLocal_755[11]))
				{
					...
					TASK::TASK_SYNCHRONIZED_SCENE(iLocal_755[11], scene, "misschinese2_crystalmaze", "2int_Loop_A_TaoCheng", 1000f, -4f, 1, 16, 1148846080, 0);
				}
			}
			...
			if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Taos_Translator", 0))
			{
				if (!PED::IS_PED_INJURED(iLocal_755[10]))
				{
					...
					TASK::TASK_SYNCHRONIZED_SCENE(iLocal_755[10], scene2, "misschinese2_crystalmaze", "2int_Loop_A_taotranslator", 1000f, -4f, 1, 16, 1148846080, 0);
				}
			}
...
void func_272() // Position - 0x1E126
{
	...
	switch (iLocal_2512)
	{
		case 0:
			...
			iLocal_2889[0] = Vector3(2428.47f, 4968.91f, 42.11f);
			iLocal_2889[1] = Vector3(2431.14f, 4972.06f, 42.19f);
			iLocal_2889[2] = Vector3(2433.05f, 4969.22f, 42.26f);
			iLocal_2889[3] = Vector3(2437.71f, 4968.13f, 42.45f);
			iLocal_2889[4] = Vector3(2436.12f, 4964.76f, 42.19f);
			iLocal_2889[5] = Vector3(2432.13f, 4961.97f, 41.35f);
			iLocal_2889[6] = Vector3(2430.07f, 4963.78f, 41.35f);
			iLocal_2889[7] = Vector3(2434f, 4963.04f, 41.53f);
			iLocal_2889[8] = Vector3(2435.6372f, 4969.699f, 42.19639f);
			iLocal_444[0] = Vector3(2450.3765f, 4955.8296f, 43.9394f);
			iLocal_444[1] = Vector3(2449.815f, 4956.678f, 43.9894f);
			iLocal_444[2] = Vector3(2449.606f, 4957.6753f, 44.0646f);
			iLocal_444[3] = Vector3(2449.739f, 4958.7314f, 44.1544f);
			iLocal_444[4] = Vector3(2450.1409f, 4959.745f, 44.2487f);
			iLocal_444[5] = Vector3(2450.685f, 4960.5815f, 44.3219f);
			iLocal_444[6] = Vector3(2451.4924f, 4961.333f, 44.4439f);
			iLocal_444[7] = Vector3(2452.1736f, 4962.0986f, 44.5787f);
			iLocal_444[8] = Vector3(2452.7166f, 4962.906f, 44.9141f);
			iLocal_444[9] = Vector3(2453.3499f, 4963.5786f, 45.3558f);
			iLocal_444[10] = Vector3(2453.754f, 4964.5654f, 45.5766f);
			iLocal_444[11] = Vector3(2453.2256f, 4965.539f, 45.5766f);
			iLocal_444[12] = Vector3(2452.4724f, 4966.293f, 45.5766f);
			iLocal_444[13] = Vector3(2451.8691f, 4967.104f, 45.5766f);
			iLocal_444[14] = Vector3(2451.529f, 4968.0825f, 45.5766f);
			iLocal_444[15] = Vector3(2452.3271f, 4968.7124f, 45.5766f);
			iLocal_444[16] = Vector3(2452.7961f, 4969.6426f, 45.8107f);
			iLocal_444[17] = Vector3(2453.2607f, 4970.541f, 45.8106f);
			iLocal_444[18] = Vector3(2453.5803f, 4971.5483f, 45.8104f);
			iLocal_444[19] = Vector3(2452.8076f, 4972.2666f, 45.8306f);
			iLocal_444[20] = Vector3(2452.0493f, 4972.928f, 45.8306f);
			iLocal_444[21] = Vector3(2451.2407f, 4973.599f, 45.8306f);
			iLocal_444[22] = Vector3(2450.248f, 4973.8887f, 45.8306f);
			iLocal_444[23] = Vector3(2449.2073f, 4973.7837f, 45.8105f);
			iLocal_444[24] = Vector3(2448.1724f, 4973.814f, 45.8106f);
			iLocal_444[25] = Vector3(2447.1526f, 4973.7715f, 45.8106f);
			iLocal_444[26] = Vector3(2446.138f, 4973.724f, 45.8106f);
			iLocal_444[27] = Vector3(2445.1282f, 4973.6895f, 45.8106f);
			iLocal_444[28] = Vector3(2444.2559f, 4973.0557f, 45.8106f);
			iLocal_444[29] = Vector3(2443.6694f, 4972.194f, 45.8106f);
			iLocal_444[30] = Vector3(2443.1191f, 4971.275f, 45.8106f);
			iLocal_444[31] = Vector3(2442.6606f, 4970.3594f, 45.8106f);
			iLocal_444[32] = Vector3(2442.2668f, 4969.4253f, 45.8106f);
			iLocal_444[33] = Vector3(2441.7085f, 4968.5024f, 45.8306f);
			iLocal_444[34] = Vector3(2441.2637f, 4967.5337f, 45.8106f);
			iLocal_444[35] = Vector3(2440.8728f, 4966.5376f, 45.8106f);
			iLocal_444[36] = Vector3(2440.3818f, 4965.6343f, 45.8106f);
			iLocal_444[37] = Vector3(2439.7104f, 4964.8823f, 45.8106f);
			iLocal_444[38] = Vector3(2438.9329f, 4964.1455f, 45.8106f);
			iLocal_444[39] = Vector3(2438.1663f, 4963.5024f, 45.8106f);
			iLocal_444[40] = Vector3(2437.5554f, 4962.7095f, 45.8106f);
			iLocal_444[41] = Vector3(2436.9011f, 4961.95f, 45.8106f);
			iLocal_444[42] = Vector3(2436.0752f, 4961.2573f, 45.8106f);
			iLocal_444[43] = Vector3(2435.0796f, 4961.004f, 45.8118f);
			iLocal_444[44] = Vector3(2434.0664f, 4960.7134f, 45.8181f);
			iLocal_444[45] = Vector3(2433.045f, 4960.5938f, 45.8192f);
			iLocal_444[46] = Vector3(2432.0647f, 4960.2495f, 45.813f);
			iLocal_444[47] = Vector3(2431.233f, 4960.809f, 45.8089f);
			iLocal_444[48] = Vector3(2430.5747f, 4961.5737f, 45.5917f);
			iLocal_444[49] = Vector3(2429.8887f, 4962.028f, 44.9345f);
			iLocal_444[50] = Vector3(2429.26f, 4962.5947f, 44.2774f);
			iLocal_444[51] = Vector3(2428.6914f, 4963.2793f, 43.6202f);
			iLocal_444[52] = Vector3(2428.073f, 4963.9106f, 42.9631f);
			iLocal_444[53] = Vector3(2428.2388f, 4964.922f, 42.9631f);
			iLocal_444[54] = Vector3(2428.9614f, 4965.4546f, 42.3059f);
			iLocal_444[55] = Vector3(2429.45f, 4966.2236f, 41.8679f);
			iLocal_444[56] = Vector3(2430.0728f, 4966.82f, 41.3476f);
			iLocal_444[57] = Vector3(2431.097f, 4967.043f, 41.3476f);
			iLocal_444[58] = Vector3(2431.8904f, 4966.403f, 41.3476f);
			iLocal_444[59] = Vector3(2432.7676f, 4965.902f, 41.3476f);
			iLocal_444[60] = Vector3(2433.7761f, 4965.6133f, 41.3476f);
			iLocal_2343[0].f_3 = "Table Flames";
			iLocal_2343[0] = 0;
			iLocal_2343[1].f_3 = "Table Explosion";
			iLocal_2343[1] = 0;
			iLocal_2343[2].f_3 = "House Explosion";
			iLocal_2343[2] = 0;
			iLocal_2343[3].f_3 = "Cam Shake";
			iLocal_2343[3] = 0;
			iLocal_2343[4].f_3 = "Position player";
			iLocal_2343[4] = 0;
			iLocal_2343[5].f_3 = "Slow mo";
			iLocal_2343[5] = 0;
			iLocal_2343[0].f_1 = 2;
			iLocal_2343[0].f_2 = 1000f;
			iLocal_2343[1].f_1 = 2;
			iLocal_2343[1].f_2 = 4200f;
			iLocal_2343[2].f_1 = 3;
			iLocal_2343[2].f_2 = 0f;
			iLocal_2343[3].f_1 = 3;
			iLocal_2343[3].f_2 = 0f;
			iLocal_2343[4].f_1 = 3;
			iLocal_2343[4].f_2 = 3200f;
			iLocal_2343[5].f_1 = 3;
			iLocal_2343[5].f_2 = 700f;
			iLocal_2380[0] = Vector3(2454.83f, 4974.96f, 46.4489f);
			iLocal_2380[0].f_3 = Vector3(2.9627f, 0.077f, 115.874f);
			iLocal_2380[0].f_14 = 39.703f;
			iLocal_2380[0].f_6 = Vector3(2454.41f, 4974.93f, 46.4691f);
			iLocal_2380[0].f_9 = Vector3(2.6238f, 0.077f, 114.001f);
			iLocal_2380[0].f_15 = 39.703f;
			iLocal_2380[0].f_12 = 2500f;
			iLocal_2380[0].f_13 = 2500f;
			iLocal_2380[0].f_16 = 0;
			iLocal_2380[0].f_17 = 18;
			iLocal_2380[1] = Vector3(2435.41f, 4960.94f, 45.9568f);
			iLocal_2380[1].f_3 = Vector3(6.677f, 0f, -49.4853f);
			iLocal_2380[1].f_14 = 58.9114f;
			iLocal_2380[1].f_6 = Vector3(2435.11f, 4960.62f, 45.9441f);
			iLocal_2380[1].f_9 = Vector3(6.3596f, 0f, -44.8248f);
			iLocal_2380[1].f_15 = 58.9114f;
			iLocal_2380[1].f_12 = 3200f;
			iLocal_2380[1].f_13 = 1900f;
			iLocal_2380[1].f_16 = 0;
			iLocal_2380[1].f_17 = 34;
			iLocal_2380[2] = Vector3(2434.77f, 4969.56f, 42.3654f);
			iLocal_2380[2].f_3 = Vector3(5.2773f, -0.1511f, 132.167f);
			iLocal_2380[2].f_14 = 35.1297f;
			iLocal_2380[2].f_6 = Vector3(2434.66f, 4969.68f, 42.3657f);
			iLocal_2380[2].f_9 = Vector3(5.2773f, -0.1511f, 132.167f);
			iLocal_2380[2].f_15 = 35.1297f;
			iLocal_2380[2].f_12 = 3500f;
			iLocal_2380[2].f_13 = 4500f;
			iLocal_2380[2].f_16 = 3;
			iLocal_2380[2].f_17 = 49;
			iLocal_2380[3] = Vector3(2472.1f, 4943.1f, 45.3f);
			iLocal_2380[3].f_3 = Vector3(6f, 0f, 25.3f);
			iLocal_2380[3].f_14 = 33.1297f;
			iLocal_2380[3].f_6 = Vector3(2472.1f, 4943.1f, 45.3f);
			iLocal_2380[3].f_9 = Vector3(5.5f, 0f, 35.6f);
			iLocal_2380[3].f_15 = 33.1297f;
			iLocal_2380[3].f_12 = 3500f;
			iLocal_2380[3].f_13 = 3500f;
			iLocal_2380[3].f_16 = 0;
			iLocal_2380[3].f_17 = -1;
			fLocal_2639 = 0.06f;
			func_172(true);
			uLocal_2465[0] = Vector3(2432.74f, 4963.43f, 41.35f);
			uLocal_2465[1] = Vector3(2432.02f, 4962.61f, 41.35f);
			uLocal_2465[2] = Vector3(2431.06f, 4961.83f, 41.35f);
			uLocal_2465[3] = Vector3(2430.84f, 4961.08f, 42.09f);
			uLocal_2465[4] = Vector3(2430.53f, 4962.47f, 42f);
			uLocal_2465[5] = Vector3(2430.81f, 4961.1f, 42.8f);
			uLocal_2465[6] = Vector3(2429.74f, 4961.98f, 42.32f);
			uLocal_2465[7] = Vector3(2433.5f, 4966.76f, 41.35f);
			uLocal_2465[8] = Vector3(2433.24f, 4967.42f, 41.35f);
			uLocal_2465[9] = Vector3(2433.15f, 4967.43f, 42.19f);
			uLocal_2465[10] = Vector3(2432.53f, 4967.89f, 42.4f);
			uLocal_2465[11] = Vector3(2432.48f, 4969.07f, 42.19f);
			uLocal_2465[12] = Vector3(2433.36f, 4969.44f, 42.31f);
			uLocal_2274[0] = Vector3(2552.6924f, 4978.5664f, 45.32309f);
			uLocal_2274[1] = Vector3(2562.5337f, 5013.502f, 47.463024f);
			uLocal_2274[2] = Vector3(2553.8848f, 4945.6606f, 47.493053f);
			uLocal_2274[3] = Vector3(2515.5452f, 4936.428f, 42.883816f);
			uLocal_2274[4] = Vector3(2497.3184f, 4967.818f, 43.595566f);
			uLocal_2274[5] = Vector3(2481.3762f, 4951.766f, 43.99859f);
			uLocal_2274[6] = Vector3(2522.0444f, 4956.3716f, 43.71605f);
			uLocal_2274[7] = Vector3(2529.048f, 4985.6274f, 43.868477f);
			uLocal_2274[8] = Vector3(2502.5034f, 4987.245f, 46.62669f);
			uLocal_2274[9] = Vector3(2464.891f, 4939.9487f, 44.256462f);
			uLocal_2274[10] = Vector3(2447.1602f, 4940.2725f, 44.15766f);
			uLocal_2274[11] = Vector3(2376.5369f, 4946.3994f, 41.772324f);
			uLocal_2274[12] = Vector3(2395.232f, 4995.63f, 44.689095f);
			uLocal_2274[13] = Vector3(2419.819f, 4991.9355f, 45.369762f);
			uLocal_2274[14] = Vector3(2436.3193f, 5011.725f, 45.846943f);
			uLocal_2274[15] = Vector3(2407.7646f, 5023.0786f, 47.770912f);
			uLocal_2274[16] = Vector3(2479.0159f, 5028.829f, 42.98806f);
			uLocal_2274[17] = Vector3(2434.704f, 5042.713f, 45.34462f);
			uLocal_2274[18] = Vector3(2513.93f, 5039.3325f, 51.021214f);
			uLocal_2274[19] = Vector3(2477.8823f, 4986.437f, 44.995113f);
			uLocal_2274[20] = Vector3(2450.058f, 5011.858f, 44.890316f);
			func_209(&iLocal_1619, &uLocal_2708, sLocal_2338, 12f, 2482.1965f, 4975.3667f, 44.7288f, 121f, 1);
...
void func_273(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x1F102
{
	...
	switch (iParam0)
	{
		...
		case 1:
			...
			while (!func_369(&iLocal_755[11], CHAR_CHENG, 1985.6656f, 3052.6606f, 46.2151f, 0, true))
			{
				SYSTEM::WAIT(0);
			}
			...
			PED::SET_PED_COMPONENT_VARIATION(iLocal_755[11], PV_COMP_TASK, 1, 0, 0);
			break;
...
{
	iLocal_3337[iParam0].f_1 = iParam2;
	iLocal_3337[iParam0] = iParam1;
	return;
}
...
{
	iLocal_3358[iParam0].f_1 = iParam2;
	iLocal_3358[iParam0] = iParam1;
	return;
}
...
BOOL IS_PLAYSTATION_PLATFORM() // Position - 0x248E3
{
	return MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION();
}

BOOL IS_XBOX_PLATFORM() // Position - 0x248F9
{
...
void func_315(int iParam0) // Position - 0x24CFC
{
	...
	if (func_319(&Global_77348.f_555[0], iParam0))
	{
		...
		{
			if (iParam0 == 24 && func_314(iParam0, 0) && Global_78257.f_66 == 0 && Global_113648.f_32751.f_1958[Global_77348.f_555[0].f_14] != 0 && Global_113648.f_32751.f_1958[Global_77348.f_555[0].f_14] > 3 && !func_317(0, Global_77348.f_555[0].f_12) || !func_317(1, Global_77348.f_555[0].f_12))
			{
				func_316(&Global_113648.f_32751.f_69[Global_77348.f_555[0].f_14], &Global_78257);
...
BOOL func_317(int iParam0, int iParam1) // Position - 0x24F37
{
	...
	if (iParam0 < 0 || iParam0 >= func_318(&Global_113648.f_32751.f_5038[num]))
		return false;

	return func_296(Global_113648.f_32751.f_5038[num][iParam0].f_66, false, -1);
}
...
BOOL func_319(var uParam0, int iParam1) // Position - 0x24FB5
{
	...
	*uParam0 = Vector3( 0f, 0f, 0f );
	...
	if (IS_BIT_SET(uParam0->f_9, 10))
	{
		...
		if (!func_168(Global_113648.f_32751.f_1864[uParam0->f_14], 0f, 0f, 0f, false))
	...
	{
		if (!func_168(Global_113648.f_2365.f_539.f_3588[1][uParam0->f_12], 0f, 0f, 0f, false))
		{
	...
	{
		if (!func_168(Global_113648.f_2365.f_539.f_3588[0][uParam0->f_12], 0f, 0f, 0f, false))
		{
...
{
	if (!func_340() && VEHICLE::IS_VEHICLE_MOD_GEN9_EXCLUSIVE(veParam0, iParam1, iParam2))
		return true;
...
void func_354(Vector3 vParam0, var uParam1, var uParam2, float fParam3, BOOL bParam4) // Position - 0x28127
{
	...
	for (i = 0; i < 68; i = i + 1)
	{
		if (func_319(&Global_77348.f_555[0], i))
...
void func_372(int iParam0) // Position - 0x284D9
{
	...
	PATHFIND::SET_ROADS_BACK_TO_ORIGINAL(Vector3(44.8113f, 4961.045f, 2469.9854f) - Vector3( 100f, 100f, 100f ), Vector3(44.8113f, 4961.045f, 2469.9854f) + Vector3( 100f, 100f, 100f ), 1);
	...
	for (i = 0; i < iLocal_755; i = i + 1)
	{
		...
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_755[i]))
		{
			if (!PED::IS_PED_INJURED(iLocal_755[i]))
				if (iParam0 == 3)
					TASK::CLEAR_PED_TASKS_IMMEDIATELY(iLocal_755[i]);
		...
		PED::REMOVE_RELATIONSHIP_GROUP(iLocal_755[i].f_24);
	}
	...
	for (i = 0; i < iLocal_2515; i = i + 1)
	{
		if (iLocal_2515[i].f_1 == 1 && iLocal_2515[i].f_3 == 0 || iLocal_2515[i].f_3 == 0)
		{
			iLocal_2515[i].f_2 = -1;
			iLocal_2515[i].f_4 = 0;
			iLocal_2515[i].f_5 = 0;
...
BOOL func_375(int iParam0, int iParam1) // Position - 0x28D97
{
	...
	if (Global_100718 > 0)
	{
		for (i = 0; i < 44; i = i + 1)
		{
			if (Global_107196.f_812[iParam0][i] == iParam1)
				if (Global_107196.f_812[iParam0][i].f_1 > 0)
					return true;
		}
	
		for (i = 0; i < 51; i = i + 1)
		{
			if (Global_107196.f_812[iParam0].f_221[i] == iParam1)
				if (Global_107196.f_812[iParam0].f_221[i].f_1 > 0)
					return true;
		}
	}
	else
	{
		for (i = 0; i < 44; i = i + 1)
		{
			if (Global_104212.f_812[iParam0][i] == iParam1)
				if (Global_104212.f_812[iParam0][i].f_1 > 0)
					return true;
		}
	
		for (i = 0; i < 51; i = i + 1)
		{
			if (Global_104212.f_812[iParam0].f_221[i] == iParam1)
				if (Global_104212.f_812[iParam0].f_221[i].f_1 > 0)
					return true;
		}
	}
	...
	if (num == 1)
	{
		...
		else
		{
			...
			if (num4 != -1)
			{
				...
				TEXT_LABEL_COPY(&unk3, Vector3(func_446(num4)), 4);
...
void func_384(var uParam0, const char* sParam1, int iParam2, char* sParam3, int iParam4, Ped pedParam5) // Position - 0x29296
{
	...
	*uParam0 = _GET_CURRENT_PLAYER_CHARACTER();
	...
	for (j = CHAR_MICHAEL; j < CHAR_MULTIPLAYER; j = j + 1)
	{
		...
		{
			func_393(PLAYER::PLAYER_PED_ID(), &uParam0->f_616[j], 1, -1);
		}
		else
		{
			for (i = 0; i < 12; i = i + 1)
...
int _MPCHAR_STAT_GET_INT(eMPStat empsParam0, int iParam1, int iParam2) // Position - 0x2A6B2
{
	...
	{
		iParam2 == 0;
		statHash = Global_2805029[empsParam0][func_395(iParam1)];
...
BOOL func_396(int iParam0, int iParam1) // Position - 0x2A723
{
	...
	statHash = Global_2848282[iParam0][func_395(iParam1)];
...
void func_400(Ped pedParam0, BOOL bParam1) // Position - 0x2AEF2
{
	...
	if (func_50(character) && !PED::IS_PED_INJURED(pedParam0))
	{
		if (pedParam0 == PLAYER::PLAYER_PED_ID())
		{
			func_401(pedParam0, &Global_113648.f_2365.f_539.f_298[character]);
...
BOOL func_422(int iParam0, int iParam1, var uParam2, int iParam3, BOOL bParam4) // Position - 0x2E1BD
{
	...
	if (!bParam4)
		unk12 = Vector3(func_425(iParam0));
	else
		unk12 = Vector3(func_424(iParam0));

	vector2 = Vector3(unk12 - unk);
	vector2 = Vector3(func_423(vector2, -unk.f_3.f_2));
	vector2 = Vector3(func_423(vector2, vector.f_3.f_2));
