...
void main() // Position - 0x0
{
	...
	fLocal_300 = 160f;
	iLocal_304 = 55000;
	uLocal_311 = Vector3(30f, 30f, 5f);
	iLocal_352 = -1;
	uLocal_523 = Vector3(-458.4085f, -984.6459f, 22.5892f);
	fLocal_526 = Vector3(-458.1934f, -995.4897f, 22.7427f);
	uLocal_305 = Vector3(uScriptParam_571.f_1[0]);
...
void func_1() // Position - 0x1CF
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(uLocal_327[0]) || ENTITY::DOES_ENTITY_EXIST(uLocal_327[1]))
		if (!CAM::IS_SPHERE_VISIBLE(uLocal_308 + Vector3(20f, 0f, 0f), 30f) && !ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), uLocal_308, 80f, 80f, 80f, false, true, 0))
			func_180();
...
void func_14() // Position - 0x6C1
{
	...
	if (bLocal_222 == false)
	{
		if (FIRE::GET_CLOSEST_FIRE_POS(&outPosition, iLocal_229[0]))
		{
			num = 0f;
			num3 = 999999f;
			...
			{
				if (i > 0)
					num = num + MISC::GET_DISTANCE_BETWEEN_COORDS(iLocal_229[i - 1], iLocal_229[i], true);
			
				if (iLocal_229[i].f_4)
				{
					if (FIRE::GET_CLOSEST_FIRE_POS(&outPosition, iLocal_229[i]))
					{
						distanceBetweenCoords = MISC::GET_DISTANCE_BETWEEN_COORDS(iLocal_229[i], outPosition, true);
			...
			if (num3 < fLocal_57)
			{
				...
				num4 = num4;
				uLocal_62 = Vector3(iLocal_229[num2]);
				iLocal_65 = num2;
				iLocal_225 = num2 * 2;
	...
	if (bLocal_222 == true)
	{
		...
		{
			if (MISC::GET_GAME_TIMER() - iLocal_66[i].f_4 > 1000)
				GRAPHICS::FADE_DECALS_IN_RANGE(iLocal_66[i].f_1, 0.4f, 1f);
		
			if (MISC::GET_GAME_TIMER() - iLocal_66[i].f_4 > 6000)
				FIRE::REMOVE_SCRIPT_FIRE(iLocal_66[i]);
		}
	}
...
void func_15(int iParam0, BOOL bParam1) // Position - 0x8F9
{
	...
	if (iParam0 >= 0)
	{
		if (iParam0 % 2 == 1)
		{
			...
			if (num + 1 < 14)
				func_16(((iLocal_229[iParam0 / 2] + iLocal_229[(iParam0 / 2) + 1]) / Vector3(2f, 2f, 2f)) + Vector3(fLocal_58, fLocal_58, fLocal_58), bParam1);
		}
		else if (iParam0 / 2 < 14)
		{
			func_16(iLocal_229[iParam0 / 2] + Vector3(fLocal_58, fLocal_58, fLocal_58), bParam1);
		}
	}
...
void func_16(Vector3 vParam0, var uParam1, var uParam2, BOOL bParam3) // Position - 0x962
{
	...
	FIRE::REMOVE_SCRIPT_FIRE(iLocal_66[iLocal_226]);

	if (iLocal_66[iLocal_226].f_4 != 0)
		GRAPHICS::FADE_DECALS_IN_RANGE(iLocal_66[iLocal_226].f_1, 0.4f, 1f);

	iLocal_66[iLocal_226].f_4 = MISC::GET_GAME_TIMER();
	iLocal_66[iLocal_226].f_1 = Vector3(vParam0);
	iLocal_66[iLocal_226] = FIRE::START_SCRIPT_FIRE(vParam0, iLocal_55, bParam3);
		...
		if (weaponHash == joaat("WEAPON_PETROLCAN"))
		{
			if (PAD::IS_CONTROL_PRESSED(PLAYER_CONTROL, INPUT_ATTACK) && PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
			{
				...
				if (MISC::GET_GAME_TIMER() > iLocal_56)
				{
					...
					{
						num = 9999.9f;
						uLocal_59 = Vector3(func_19());
					
						for (i = 0; i < iLocal_229; i = i + 1)
						{
							if (HUD::DOES_BLIP_EXIST(iLocal_229[i].f_3))
							{
								distanceBetweenCoords = MISC::GET_DISTANCE_BETWEEN_COORDS(uLocal_59, HUD::GET_BLIP_COORDS(iLocal_229[i].f_3), true);
								distanceBetweenCoords2 = MISC::GET_DISTANCE_BETWEEN_COORDS(iLocal_229[i], HUD::GET_BLIP_COORDS(iLocal_229[i].f_3), true);
							
								if (distanceBetweenCoords2 == 0f || distanceBetweenCoords < distanceBetweenCoords2)
									if (distanceBetweenCoords < 2f)
										iLocal_229[i] = Vector3(uLocal_59);
							...
							if (iLocal_52 != -1)
							{
								...
								if (MISC::ABSI(iLocal_53 - num2) < 3 && MISC::ABSI(iLocal_53 - num2) > 0)
								{
									if (iLocal_53 < num2)
									{
										...
										{
											if (HUD::DOES_BLIP_EXIST(iLocal_229[j].f_3))
											{
												if (HUD::GET_BLIP_ALPHA(iLocal_229[j].f_3) > 0)
												{
													HUD::SET_BLIP_ALPHA(iLocal_229[j].f_3, 0);
													iLocal_229[j].f_4 = 1;
								...
								if (num2 == 0)
								{
									if (HUD::DOES_BLIP_EXIST(iLocal_229[num2].f_3))
									{
										if (HUD::GET_BLIP_ALPHA(iLocal_229[num2].f_3) > 0)
										{
											HUD::SET_BLIP_ALPHA(iLocal_229[num2].f_3, 0);
											iLocal_229[num2].f_4 = 1;
											iLocal_54 = iLocal_54 - 1;
										}
									}
								}
								...
								if (num2 < 13)
								{
									if (_IS_NULL_VECTOR(iLocal_229[num2 + 1]))
									{
										if (HUD::DOES_BLIP_EXIST(iLocal_229[num2].f_3))
										{
											if (HUD::GET_BLIP_ALPHA(iLocal_229[num2].f_3) > 0)
	...
	switch (iLocal_302)
	{
		...
		case 1:
			...
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				if (!ENTITY::IS_ENTITY_DEAD(veLocal_319, false))
				{
					if (FIRE::IS_ENTITY_ON_FIRE(veLocal_319))
					{
						for (iLocal_347 = 0; iLocal_347 < 11; iLocal_347 = iLocal_347 + 1)
						{
							if (ENTITY::DOES_ENTITY_EXIST(uLocal_327[iLocal_347]))
...
void func_49() // Position - 0x202A
{
	...
	{
		case 0:
			GRAPHICS::ADD_PETROL_DECAL(fLocal_526 + Vector3(0f, 1f, 0f), 1f, 1f, 1f);
			SYSTEM::WAIT(0);
			GRAPHICS::START_PETROL_TRAIL_DECALS(1f);
			GRAPHICS::ADD_PETROL_TRAIL_DECAL_INFO(uLocal_523, 1f);
			SYSTEM::WAIT(0);
			GRAPHICS::ADD_PETROL_TRAIL_DECAL_INFO(uLocal_523 - Vector3(0f, 4f, 0f), 1f);
			SYSTEM::WAIT(0);
			GRAPHICS::ADD_PETROL_TRAIL_DECAL_INFO(uLocal_523 - Vector3(0f, 8f, 0f), 1f);
			SYSTEM::WAIT(0);
		...
		case 3:
			if (ENTITY::DOES_ENTITY_EXIST(veLocal_319))
				!FIRE::IS_ENTITY_ON_FIRE(veLocal_319);
	...
	switch (iLocal_348)
	{
		...
		case 5:
			if (MISC::GET_GAME_TIMER() - iLocal_351 > 3000)
			{
				...
				if (!PED::IS_PED_INJURED(pedLocal_317))
				{
					...
					PED::SET_PED_CAN_RAGDOLL(pedLocal_317, true);
		...
		case 6:
			if (!PED::IS_PED_INJURED(pedLocal_317))
			{
				...
				{
					vector = Vector3(-477.2774f, -990.0638f, 23.5497f);
					...
					if (ENTITY::DOES_ENTITY_EXIST(PLAYER::GET_PLAYERS_LAST_VEHICLE()))
						if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::GET_PLAYERS_LAST_VEHICLE(), -477.2774f, -990.0638f, 23.5497f, 3f, 3f, 3f, false, true, 0))
							vector = Vector3(-477.7884f, -996.3974f, 23.5503f);
...
void _STAT_SET_PACKED_BOOL(int iParam0, BOOL bParam1, int iParam2) // Position - 0x2FF5
{
	if (iParam2 == -1)
		iParam2 = func_6();
	...
	switch (iLocal_303)
	{
		...
		case 6:
			if (MISC::GET_GAME_TIMER() - iLocal_354 > 500)
			{
				...
				if (!PED::IS_PED_INJURED(pedLocal_317))
					TASK::TASK_LOOK_AT_COORD(pedLocal_317, ENTITY::GET_ENTITY_COORDS(pedLocal_317, true) - Vector3(10f, 0f, 2f), 30000, SLF_WIDEST_PITCH_LIMIT | 2048, 2);
...
void func_115() // Position - 0x5493
{
	...
	if (func_104(&uLocal_537))
	{
		...
		PED::ADD_SCENARIO_BLOCKING_AREA(uLocal_305 + Vector3(50f, 50f, 50f), uLocal_305 - Vector3(50f, 50f, 50f), false, true, true, true);
		uLocal_308 = Vector3(-455.6561f, -985.8071f, 22.4868f);
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					...
					case 4:
						if (func_172() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0 || func_43(8, -1) || func_167() || func_166() || G_SomeGlobalState.MessageCallStates.f_919[character] == 5)
							return false;
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
							if (PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0 || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || func_172() || Global_32166 || func_171() || func_43(8, -1) || func_169() || func_168() || func_167() || G_SomeGlobalState.MessageCallStates.f_919[character] == 5)
								return false;
						break;
				
					case 7:
						if (PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || !CAM::IS_SCREEN_FADED_IN() || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_172() || func_169() || Global_112695 || Global_32166 || func_171() || Global_44446 || func_43(8, -1) || func_168() || func_166() || func_167() || G_SomeGlobalState.MessageCallStates.f_919[character] == 5)
							return false;
						break;
...
BOOL IS_PLAYSTATION_PLATFORM() // Position - 0xD973
{
	return MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION();
}

BOOL IS_XBOX_PLATFORM() // Position - 0xD989
{
