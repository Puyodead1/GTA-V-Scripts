		...
		case 4:
			...
			else
			{
				...
				else
				{
					...
					if (Global_113810.f_14054[Global_20500].f_18 == 1 || Global_113810.f_14054[Global_20500].f_17 == 1 || bLocal_80 == true || Global_22904 != 0)
					{
						while (!GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(Global_20481) && Global_20483 == 0)
						{
							SYSTEM::WAIT(0);
...
void func_24() // Position - 0x1384
{
	...
	switch (Global_20500.f_1)
	{
		...
		case 9:
			...
			{
				func_29();
				func_35(Global_20481, "SET_THEME", SYSTEM::TO_FLOAT(Global_113810.f_14054[Global_20500].f_6), -1082130432, -1082130432, -1082130432, -1082130432);
...
void func_55() // Position - 0x30E1
{
	if (IS_BIT_SET(Global_8370, 1))
	{
		func_58();
		func_56();
		Global_113810.f_14054[Global_20500].f_18 = 1;
...
void func_56() // Position - 0x317A
{
	...
	if (Global_78689)
		Global_113810.f_14054[3].f_10 = func_128(1198, -1);
...
void func_58() // Position - 0x321D
{
	...
	{
		TEXT_LABEL_ASSIGN_STRING(&string1, HUD::GET_FILENAME_FOR_AUDIO_CONVERSATION(&(Global_2058[Global_113810.f_14144[Global_22912].f_17].f_7)), 64);
	
		if (Global_113810.f_14144[Global_22912].f_17 == CHAR_COMIC_STORE)
	...
	if (Global_113810.f_14144[Global_22912].f_32 == 4 || Global_113810.f_14144[Global_22912].f_32 == 5 || Global_113810.f_14144[Global_22912].f_32 == 6 || Global_113810.f_14144[Global_22912].f_32 == 7 || Global_113810.f_14144[Global_22912].f_32 == 8 || Global_113810.f_14144[Global_22912].f_32 == 9 || Global_113810.f_14144[Global_22912].f_32 == 10 || Global_113810.f_14144[Global_22912].f_32 == 11 || Global_113810.f_14144[Global_22912].f_32 == 12)
	{
		num = 0;
		num2 = func_59(9, Global_113810.f_14144[Global_22912].f_49);
		...
		HUD::ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(&Global_113810.f_14144[Global_22912]);
	
		while (num < num2)
		{
			switch (Global_113810.f_14144[Global_22912].f_32)
			{
				case 4:
					HUD::ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(&Global_2794162.f_1762[num]);
					break;
		...
		TEXT_LABEL_ASSIGN_STRING(&sender, HUD::GET_FILENAME_FOR_AUDIO_CONVERSATION(&(Global_2058[Global_113810.f_14144[Global_22912].f_17].f_3)), 64);
	...
	{
		HUD::BEGIN_TEXT_COMMAND_THEFEED_POST(&Global_113810.f_14144[Global_22912]);
		...
		switch (Global_113810.f_14144[Global_22912].f_32)
		{
			...
			case 1:
				HUD::ADD_TEXT_COMPONENT_SUBSTRING_PLAYER_NAME(&(Global_113810.f_14144[Global_22912].f_33));
			
				if (Global_113810.f_14144[Global_22912].f_66 == 1 && !MISC::ARE_STRINGS_EQUAL(&(Global_113810.f_14144[Global_22912].f_67), "NULL"))
					HUD::ADD_TEXT_COMPONENT_SUBSTRING_PLAYER_NAME(&(Global_113810.f_14144[Global_22912].f_67));
			
				if (Global_113810.f_14144[Global_22912].f_66 == 2 && !MISC::ARE_STRINGS_EQUAL(&(Global_113810.f_14144[Global_22912].f_67), "NULL") && !MISC::ARE_STRINGS_EQUAL(&(Global_113810.f_14144[Global_22912].f_83), "NULL"))
				{
					if (HUD::DOES_TEXT_LABEL_EXIST(&(Global_113810.f_14144[Global_22912].f_67)))
						HUD::ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(&(Global_113810.f_14144[Global_22912].f_67));
					else
						HUD::ADD_TEXT_COMPONENT_SUBSTRING_PLAYER_NAME(&(Global_113810.f_14144[Global_22912].f_67));
				
					if (HUD::DOES_TEXT_LABEL_EXIST(&(Global_113810.f_14144[Global_22912].f_83)))
						HUD::ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(&(Global_113810.f_14144[Global_22912].f_83));
					else
						HUD::ADD_TEXT_COMPONENT_SUBSTRING_PLAYER_NAME(&(Global_113810.f_14144[Global_22912].f_83));
				}
				break;
		
			case 2:
				HUD::ADD_TEXT_COMPONENT_INTEGER(Global_113810.f_14144[Global_22912].f_49);
				break;
		...
		if (Global_113810.f_14144[Global_22912].f_17 == _CHAR_NULL)
		{
			TEXT_LABEL_ASSIGN_STRING(&sender2, "<C>", 64);
			TEXT_LABEL_APPEND_STRING(&sender2, &Global_9058, 64);
			TEXT_LABEL_APPEND_STRING(&sender2, "</C>", 64);
		...
		{
			TEXT_LABEL_ASSIGN_STRING(&sender3, HUD::GET_FILENAME_FOR_AUDIO_CONVERSATION(&(Global_2058[Global_113810.f_14144[Global_22912].f_17].f_3)), 64);
		
			if (Global_113810.f_14144[Global_22912].f_17 == CHAR_SOCIAL_CLUB)
			{
				TEXT_LABEL_ASSIGN_STRING(&sender4, "~HUD_COLOUR_SOCIAL_CLUB~", 64);
				TEXT_LABEL_APPEND_STRING(&sender4, &sender3, 64);
	...
	Global_113810.f_14144[Global_22912].f_16 = iLocal_62;
	return;
}
...
void func_62() // Position - 0x39BF
{
	...
	if (Global_78689 == false)
	{
		if (!func_52())
		{
			if (iLocal_67 == 0)
			{
				if (Global_113810.f_14144[21].f_24 != 0 || Global_113810.f_14144[22].f_24 != 0 || Global_113810.f_14144[23].f_24 != 0)
				{
					switch (Global_20500)
					{
						case CHAR_MICHAEL:
							if (Global_113810.f_14144[21].f_24 != 0)
							{
								iLocal_40 = 21;
								iLocal_67 = 1;
								SYSTEM::SETTIMERA(0);
						...
						case CHAR_FRANKLIN:
							if (Global_113810.f_14144[22].f_24 != 0)
							{
								iLocal_40 = 22;
								iLocal_67 = 1;
								SYSTEM::SETTIMERA(0);
						...
						case CHAR_TREVOR:
							if (Global_113810.f_14144[23].f_24 != 0)
							{
								iLocal_40 = 23;
								iLocal_67 = 1;
								SYSTEM::SETTIMERA(0);
			...
			else if (SYSTEM::TIMERA() > 15000)
			{
				...
				if (Global_113810.f_14144[iLocal_40].f_24 != 0 && num == 0)
					if (!func_34(14))
						if (_SEND_TEXT_MESSAGE_FROM_CHARACTER_2(Global_113810.f_14144[iLocal_40].f_17, &Global_113810.f_14144[iLocal_40], Global_113810.f_14144[iLocal_40].f_24, Global_113810.f_14144[iLocal_40].f_25, Global_113810.f_14144[iLocal_40].f_26, Global_113810.f_14144[iLocal_40].f_29, 0, true, Global_113810.f_14144[iLocal_40].f_31, Global_113810.f_14144[iLocal_40].f_30))
							Global_113810.f_14144[iLocal_40].f_24 = 0;
			}
...
int func_67(eCharacter echParam0, char* sParam1, int iParam2, int iParam3, char* sParam4, char* sParam5, int iParam6, int iParam7, var uParam8, var uParam9, BOOL bParam10, var uParam11, var uParam12, int iParam13, char* sParam14, char* sParam15, int iParam16) // Position - 0x3EBF
{
	...
	Global_113810.f_14144[Global_22912].f_26 = uParam8;
	Global_113810.f_14144[Global_22912].f_29 = uParam9;
	Global_113810.f_14144[Global_22912].f_30 = uParam12;
	Global_113810.f_14144[Global_22912].f_31 = uParam11;
...
void func_77() // Position - 0x459B
{
	...
	while (num3 < num2)
	{
		if (!func_78(Global_113810.f_14144[num3].f_18, Global_113810.f_14144[Global_22912].f_18))
			Global_22912 = num3;
...
int func_79() // Position - 0x4751
{
	...
	while (i < num2)
	{
		if (Global_113810.f_14144[i].f_24 == 0 || Global_113810.f_14144[i].f_24 == 1)
			if (!func_78(Global_113810.f_14144[i].f_18, Global_113810.f_14144[Global_22912].f_18))
				Global_22912 = i;
