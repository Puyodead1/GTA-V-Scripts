...
void func_5() // Position - 0x949
{
	...
	if (Global_78689)
	{
		...
		if (func_6(&(Global_2657704[PLAYER::PLAYER_ID()].f_442), 0))
		...
		case 4:
			...
			else
			{
				...
				if (Global_21855 || Global_21856)
				{
					...
					while (!GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(G_Scaleform) && Global_20483 == 0)
					{
						SYSTEM::WAIT(0);
				...
				else
				{
					...
					if (G_MissionStats.f_14054[Global_20500].f_18 == 1 || G_MissionStats.f_14054[Global_20500].f_17 == 1 || bLocal_80 == true || Global_22904 != 0)
					{
						while (!GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(G_Scaleform) && Global_20483 == 0)
						{
							SYSTEM::WAIT(0);
...
void func_24() // Position - 0x1384
{
	...
	{
		case 6:
			func_35(G_Scaleform, "SET_DATA_SLOT_EMPTY", 1f, -1082130432, -1082130432, -1082130432, -1082130432);
			func_33(Global_8975);
		
			if (Global_8975 == 1)
			{
				func_35(G_Scaleform, "DISPLAY_VIEW", 1f, SYSTEM::TO_FLOAT(Global_20504), -1082130432, -1082130432, -1082130432);
				Global_20480 = Global_20504;
			}
			else
			{
				func_35(G_Scaleform, "DISPLAY_VIEW", 1f, SYSTEM::TO_FLOAT(Global_20505), -1082130432, -1082130432, -1082130432);
				Global_20480 = Global_20505;
			}
		
			if (Global_20488)
			{
				func_32(G_Scaleform, "SET_SOFT_KEYS", 2f, 1f, 2f, -1f, -1f, "CELL_205" /*SELECT*/, 0, 0, 0, 0);
				func_32(G_Scaleform, "SET_SOFT_KEYS", 3f, 1f, 4f, -1f, -1f, "CELL_206" /*BACK*/, 0, 0, 0, 0);
			}
			else
			{
				func_32(G_Scaleform, "SET_SOFT_KEYS", 2f, 1f, 2f, -1f, -1f, 0, 0, 0, 0, 0);
				func_32(G_Scaleform, "SET_SOFT_KEYS", 3f, 1f, 4f, -1f, -1f, 0, 0, 0, 0, 0);
			}
		
			if (Global_20706 == 0)
			{
				func_32(G_Scaleform, "SET_SOFT_KEYS", 1f, 0f, 1f, -1f, -1f, 0, 0, 0, 0, 0);
			...
			else
			{
				if (Global_20705 == true)
					if (Global_20488)
						func_32(G_Scaleform, "SET_SOFT_KEYS", 1f, 1f, 20f, -1f, -1f, "CELL_225" /*NEXT*/, 0, 0, 0, 0);
					else
						func_32(G_Scaleform, "SET_SOFT_KEYS", 1f, 1f, 20f, -1f, -1f, 0, 0, 0, 0, 0);
				else if (Global_20488)
					func_32(G_Scaleform, "SET_SOFT_KEYS", 1f, 1f, 3f, -1f, -1f, "CELL_225" /*NEXT*/, 0, 0, 0, 0);
				else
					func_32(G_Scaleform, "SET_SOFT_KEYS", 1f, 1f, 3f, -1f, -1f, 0, 0, 0, 0, 0);
		...
		case 10:
			func_35(G_Scaleform, "DISPLAY_VIEW", 4f, -1082130432, -1082130432, -1082130432, -1082130432);
			func_32(G_Scaleform, "SET_SOFT_KEYS", 2f, 0f, 1f, -1f, -1f, 0, 0, 0, 0, 0);
			func_32(G_Scaleform, "SET_SOFT_KEYS", 1f, 0f, 1f, -1f, -1f, 0, 0, 0, 0, 0);
			MISC::CLEAR_BIT(&Global_8370, 17);
		
			if (IS_BIT_SET(Global_8370, 20))
			{
				func_32(G_Scaleform, "SET_SOFT_KEYS", 3f, 0f, 1f, -1f, -1f, 0, 0, 0, 0, 0);
			}
			else if (Global_20488)
			{
				func_32(G_Scaleform, "SET_SOFT_KEYS", 3f, 1f, 6f, -1f, -1f, "CELL_202" /*END CALL*/, 0, 0, 0, 0);
			
				if (Global_20443)
					func_32(G_Scaleform, "SET_SOFT_KEYS", 3f, 1f, 6f, -1f, -1f, 0, 0, 0, 0, 0);
			}
			else
			{
				func_32(G_Scaleform, "SET_SOFT_KEYS", 3f, 1f, 6f, -1f, -1f, 0, 0, 0, 0, 0);
		...
		case 9:
			...
			{
				func_29();
				func_35(G_Scaleform, "SET_THEME", SYSTEM::TO_FLOAT(G_MissionStats.f_14054[Global_20500].f_6), -1082130432, -1082130432, -1082130432, -1082130432);
				...
				{
					func_32(G_Scaleform, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(4), SYSTEM::TO_FLOAT(0), SYSTEM::TO_FLOAT(2), -1f, -1f, &(Global_117[Global_7685].f_4), "CELL_300" /*CHAR_DEFAULT*/, "CELL_217" /*INCOMING CALL*/, "CELL_195" /*Unknown*/, 0);
				}
				else
				{
					func_32(G_Scaleform, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(4), SYSTEM::TO_FLOAT(0), SYSTEM::TO_FLOAT(2), -1f, -1f, &(Global_2058[Global_7685].f_3), &(Global_2058[Global_7685].f_7), "CELL_217" /*INCOMING CALL*/, &(Global_2058[Global_7685].f_3), 0);
				}
			...
			else if (Global_21845 == 4 || Global_21845 == 3)
			{
				...
				else
				{
					...
					{
						func_35(G_Scaleform, "SET_DATA_SLOT_EMPTY", 4f, -1082130432, -1082130432, -1082130432, -1082130432);
						func_32(G_Scaleform, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(4), SYSTEM::TO_FLOAT(0), SYSTEM::TO_FLOAT(3), -1f, -1f, &(Global_117[Global_7685].f_4), "CELL_300" /*CHAR_DEFAULT*/, &unk, "CELL_195" /*Unknown*/, 0);
					}
					else
					{
						func_35(G_Scaleform, "SET_DATA_SLOT_EMPTY", 4f, -1082130432, -1082130432, -1082130432, -1082130432);
						func_32(G_Scaleform, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(4), SYSTEM::TO_FLOAT(0), SYSTEM::TO_FLOAT(3), -1f, -1f, &(Global_2058[Global_7685].f_3), &(Global_2058[Global_7685].f_7), &unk, &(Global_2058[Global_7685].f_3), 0);
					}
				}
...
void func_25() // Position - 0x1969
{
	if (GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(G_Scaleform))
	{
		...
		{
			if (Global_20488)
				func_32(G_Scaleform, "SET_SOFT_KEYS", 2f, 1f, 5f, -1f, -1f, "CELL_203" /*ANSWER*/, 0, 0, 0, 0);
			else
				func_32(G_Scaleform, "SET_SOFT_KEYS", 2f, 1f, 5f, -1f, -1f, 0, 0, 0, 0, 0);
		
			if (Global_21892)
				func_32(G_Scaleform, "SET_SOFT_KEYS", 3f, 0f, 6f, -1f, -1f, 0, 0, 0, 0, 0);
			else if (IS_BIT_SET(Global_8370, 20))
				func_32(G_Scaleform, "SET_SOFT_KEYS", 3f, 0f, 1f, -1f, -1f, 0, 0, 0, 0, 0);
			else if (Global_20488)
				func_32(G_Scaleform, "SET_SOFT_KEYS", 3f, 1f, 6f, -1f, -1f, "CELL_204" /*REJECT*/, 0, 0, 0, 0);
			else
				func_32(G_Scaleform, "SET_SOFT_KEYS", 3f, 1f, 6f, -1f, -1f, 0, 0, 0, 0, 0);
...
void func_26() // Position - 0x1AF7
{
	if (Global_78689)
	{
		func_32(G_Scaleform, "SET_SOFT_KEYS", 1f, 0f, 9f, -1f, -1f, 0, 0, 0, 0, 0);
		MISC::CLEAR_BIT(&Global_8370, 17);
	}
...
void func_30() // Position - 0x1DDB
{
	if (Global_78689)
	{
		...
		func_32(G_Scaleform, "SET_SOFT_KEYS", 1f, 1f, 9f, -1f, -1f, 0, 0, 0, 0, 0);
		MISC::SET_BIT(&Global_8370, 17);
	}
				...
				if (iParam0 == Global_8377[num].f_11)
				{
					if (i == Global_8377[num].f_4)
					{
						if (Global_8939[i] == 0)
						{
							...
							if (Global_2694571)
								if (num == 14)
									func_32(G_Scaleform, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(i), SYSTEM::TO_FLOAT(Global_8377[num].f_10), SYSTEM::TO_FLOAT(Global_22908), -1f, &Global_8377[num], 0, 0, 0, 0);
					...
					if (i == Global_8377[num].f_4)
					{
						if (Global_8939[i] == 0)
						{
							...
							if (num == 1)
							{
								...
								func_32(G_Scaleform, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(i), SYSTEM::TO_FLOAT(Global_8377[num].f_10), SYSTEM::TO_FLOAT(Global_22913), -1f, &Global_8377[num], 0, 0, 0, 0);
							}
							else if (num == 7)
							{
								if (Global_78689)
								{
									...
									func_32(G_Scaleform, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(i), SYSTEM::TO_FLOAT(Global_8377[num].f_10), SYSTEM::TO_FLOAT(value2), -1f, &Global_8377[num], 0, 0, 0, 0);
								}
								else
								{
									switch (Global_20500)
									...
									func_32(G_Scaleform, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(i), SYSTEM::TO_FLOAT(Global_8377[num].f_10), SYSTEM::TO_FLOAT(value3), -1f, &Global_8377[num], 0, 0, 0, 0);
								}
							}
							else if (num == 14)
							{
							...
							else if (Global_8377[num].f_10 == 57 && num == 23)
							{
								...
								func_32(G_Scaleform, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(i), SYSTEM::TO_FLOAT(Global_8377[num].f_10), SYSTEM::TO_FLOAT(value6), -1f, &Global_8377[num], 0, 0, 0, 0);
							}
							else
							{
								func_32(G_Scaleform, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(i), SYSTEM::TO_FLOAT(Global_8377[num].f_10), SYSTEM::TO_FLOAT(0), -1f, &Global_8377[num], 0, 0, 0, 0);
							}
...
void func_47() // Position - 0x2879
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (_GET_CHARACTER_MODEL(G_MissionStats.f_2366.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			{
				if (G_MissionStats.f_2366.f_539.f_4321 != character && func_48(G_MissionStats.f_2366.f_539.f_4321))
...
void func_53() // Position - 0x2A1A
{
	...
	{
		TEXT_LABEL_ASSIGN_STRING(&string1, HUD::GET_FILENAME_FOR_AUDIO_CONVERSATION(&(Global_2058[Global_4541037[Global_4542286].f_17].f_7)), 64);
		Global_22914[Global_4542286] = 0;
	}
	...
	if (Global_4541037[Global_4542286].f_32 == 4 || Global_4541037[Global_4542286].f_32 == 5 || Global_4541037[Global_4542286].f_32 == 6 || Global_4541037[Global_4542286].f_32 == 7 || Global_4541037[Global_4542286].f_32 == 8 || Global_4541037[Global_4542286].f_32 == 9 || Global_4541037[Global_4542286].f_32 == 10 || Global_4541037[Global_4542286].f_32 == 11)
	{
		num = 0;
	
		switch (Global_4541037[Global_4542286].f_49)
		{
			case 1:
		...
		HUD::ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(&Global_4541037[Global_4542286]);
	
		while (num < Global_4541037[Global_4542286].f_49)
		{
			switch (Global_4541037[Global_4542286].f_32)
			{
				case 4:
		...
		TEXT_LABEL_ASSIGN_STRING(&sender, HUD::GET_FILENAME_FOR_AUDIO_CONVERSATION(&(Global_2058[Global_4541037[Global_4542286].f_17].f_3)), 64);
	...
	{
		HUD::BEGIN_TEXT_COMMAND_THEFEED_POST(&Global_4541037[Global_4542286]);
		...
		switch (Global_4541037[Global_4542286].f_32)
		{
			...
			case 1:
				HUD::ADD_TEXT_COMPONENT_SUBSTRING_PLAYER_NAME(&(Global_4541037[Global_4542286].f_33));
			
				if (Global_4541037[Global_4542286].f_66 == 1 && !MISC::ARE_STRINGS_EQUAL(&(Global_4541037[Global_4542286].f_67), "NULL"))
					HUD::ADD_TEXT_COMPONENT_SUBSTRING_PLAYER_NAME(&(Global_4541037[Global_4542286].f_67));
			
				if (Global_4541037[Global_4542286].f_66 == 2 && !MISC::ARE_STRINGS_EQUAL(&(Global_4541037[Global_4542286].f_67), "NULL") && !MISC::ARE_STRINGS_EQUAL(&(Global_4541037[Global_4542286].f_83), "NULL"))
				{
					if (HUD::DOES_TEXT_LABEL_EXIST(&(Global_4541037[Global_4542286].f_67)))
						HUD::ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(&(Global_4541037[Global_4542286].f_67));
					else
						HUD::ADD_TEXT_COMPONENT_SUBSTRING_PLAYER_NAME(&(Global_4541037[Global_4542286].f_67));
				
					if (HUD::DOES_TEXT_LABEL_EXIST(&(Global_4541037[Global_4542286].f_83)))
						HUD::ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(&(Global_4541037[Global_4542286].f_83));
					else
						HUD::ADD_TEXT_COMPONENT_SUBSTRING_PLAYER_NAME(&(Global_4541037[Global_4542286].f_83));
				}
				break;
		
			case 2:
				HUD::ADD_TEXT_COMPONENT_INTEGER(Global_4541037[Global_4542286].f_49);
				break;
		...
		if (Global_4541037[Global_4542286].f_17 == 145)
		{
		...
		{
			TEXT_LABEL_ASSIGN_STRING(&sender3, HUD::GET_FILENAME_FOR_AUDIO_CONVERSATION(&(Global_2058[Global_4541037[Global_4542286].f_17].f_3)), 64);
		
			if (Global_4541037[Global_4542286].f_17 == 98)
			{
	...
	Global_4541037[Global_4542286].f_16 = iLocal_62;
	return;
}
...
void func_55() // Position - 0x30E1
{
	if (IS_BIT_SET(Global_8370, 1))
	{
		func_58();
		func_56();
		G_MissionStats.f_14054[Global_20500].f_18 = 1;
...
void func_56() // Position - 0x317A
{
	...
	if (Global_78689)
		G_MissionStats.f_14054[3].f_10 = func_128(1198, -1);
...
void func_58() // Position - 0x321D
{
	...
	{
		TEXT_LABEL_ASSIGN_STRING(&string1, HUD::GET_FILENAME_FOR_AUDIO_CONVERSATION(&(Global_2058[G_MissionStats.f_14144[Global_22912].f_17].f_7)), 64);
	
		if (G_MissionStats.f_14144[Global_22912].f_17 == CHAR_COMIC_STORE)
	...
	if (G_MissionStats.f_14144[Global_22912].f_32 == 4 || G_MissionStats.f_14144[Global_22912].f_32 == 5 || G_MissionStats.f_14144[Global_22912].f_32 == 6 || G_MissionStats.f_14144[Global_22912].f_32 == 7 || G_MissionStats.f_14144[Global_22912].f_32 == 8 || G_MissionStats.f_14144[Global_22912].f_32 == 9 || G_MissionStats.f_14144[Global_22912].f_32 == 10 || G_MissionStats.f_14144[Global_22912].f_32 == 11 || G_MissionStats.f_14144[Global_22912].f_32 == 12)
	{
		num = 0;
		num2 = func_59(9, G_MissionStats.f_14144[Global_22912].f_49);
		...
		HUD::ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(&G_MissionStats.f_14144[Global_22912]);
	
		while (num < num2)
		{
			switch (G_MissionStats.f_14144[Global_22912].f_32)
			{
				case 4:
					HUD::ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(&Global_2794162.f_1762[num]);
					break;
		...
		TEXT_LABEL_ASSIGN_STRING(&sender, HUD::GET_FILENAME_FOR_AUDIO_CONVERSATION(&(Global_2058[G_MissionStats.f_14144[Global_22912].f_17].f_3)), 64);
	...
	{
		HUD::BEGIN_TEXT_COMMAND_THEFEED_POST(&G_MissionStats.f_14144[Global_22912]);
		...
		switch (G_MissionStats.f_14144[Global_22912].f_32)
		{
			...
			case 1:
				HUD::ADD_TEXT_COMPONENT_SUBSTRING_PLAYER_NAME(&(G_MissionStats.f_14144[Global_22912].f_33));
			
				if (G_MissionStats.f_14144[Global_22912].f_66 == 1 && !MISC::ARE_STRINGS_EQUAL(&(G_MissionStats.f_14144[Global_22912].f_67), "NULL"))
					HUD::ADD_TEXT_COMPONENT_SUBSTRING_PLAYER_NAME(&(G_MissionStats.f_14144[Global_22912].f_67));
			
				if (G_MissionStats.f_14144[Global_22912].f_66 == 2 && !MISC::ARE_STRINGS_EQUAL(&(G_MissionStats.f_14144[Global_22912].f_67), "NULL") && !MISC::ARE_STRINGS_EQUAL(&(G_MissionStats.f_14144[Global_22912].f_83), "NULL"))
				{
					if (HUD::DOES_TEXT_LABEL_EXIST(&(G_MissionStats.f_14144[Global_22912].f_67)))
						HUD::ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(&(G_MissionStats.f_14144[Global_22912].f_67));
					else
						HUD::ADD_TEXT_COMPONENT_SUBSTRING_PLAYER_NAME(&(G_MissionStats.f_14144[Global_22912].f_67));
				
					if (HUD::DOES_TEXT_LABEL_EXIST(&(G_MissionStats.f_14144[Global_22912].f_83)))
						HUD::ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(&(G_MissionStats.f_14144[Global_22912].f_83));
					else
						HUD::ADD_TEXT_COMPONENT_SUBSTRING_PLAYER_NAME(&(G_MissionStats.f_14144[Global_22912].f_83));
				}
				break;
		
			case 2:
				HUD::ADD_TEXT_COMPONENT_INTEGER(G_MissionStats.f_14144[Global_22912].f_49);
				break;
		...
		if (G_MissionStats.f_14144[Global_22912].f_17 == _CHAR_NULL)
		{
			TEXT_LABEL_ASSIGN_STRING(&sender2, "<C>", 64);
			TEXT_LABEL_APPEND_STRING(&sender2, &Global_9058, 64);
			TEXT_LABEL_APPEND_STRING(&sender2, "</C>", 64);
		...
		{
			TEXT_LABEL_ASSIGN_STRING(&sender3, HUD::GET_FILENAME_FOR_AUDIO_CONVERSATION(&(Global_2058[G_MissionStats.f_14144[Global_22912].f_17].f_3)), 64);
		
			if (G_MissionStats.f_14144[Global_22912].f_17 == CHAR_SOCIAL_CLUB)
			{
				TEXT_LABEL_ASSIGN_STRING(&sender4, "~HUD_COLOUR_SOCIAL_CLUB~", 64);
				TEXT_LABEL_APPEND_STRING(&sender4, &sender3, 64);
	...
	G_MissionStats.f_14144[Global_22912].f_16 = iLocal_62;
	return;
}
...
void func_62() // Position - 0x39BF
{
	...
	if (Global_78689 == false)
	{
		if (!func_52())
		{
			if (iLocal_67 == 0)
			{
				if (G_MissionStats.f_14144[21].f_24 != 0 || G_MissionStats.f_14144[22].f_24 != 0 || G_MissionStats.f_14144[23].f_24 != 0)
				{
					switch (Global_20500)
					{
						case CHAR_MICHAEL:
							if (G_MissionStats.f_14144[21].f_24 != 0)
							{
								iLocal_40 = 21;
								iLocal_67 = 1;
								SYSTEM::SETTIMERA(0);
						...
						case CHAR_FRANKLIN:
							if (G_MissionStats.f_14144[22].f_24 != 0)
							{
								iLocal_40 = 22;
								iLocal_67 = 1;
								SYSTEM::SETTIMERA(0);
						...
						case CHAR_TREVOR:
							if (G_MissionStats.f_14144[23].f_24 != 0)
							{
								iLocal_40 = 23;
								iLocal_67 = 1;
								SYSTEM::SETTIMERA(0);
			...
			else if (SYSTEM::TIMERA() > 15000)
			{
				...
				if (G_MissionStats.f_14144[iLocal_40].f_24 != 0 && num == 0)
					if (!func_34(14))
						if (_SEND_TEXT_MESSAGE_FROM_CHARACTER_2(G_MissionStats.f_14144[iLocal_40].f_17, &G_MissionStats.f_14144[iLocal_40], G_MissionStats.f_14144[iLocal_40].f_24, G_MissionStats.f_14144[iLocal_40].f_25, G_MissionStats.f_14144[iLocal_40].f_26, G_MissionStats.f_14144[iLocal_40].f_29, 0, true, G_MissionStats.f_14144[iLocal_40].f_31, G_MissionStats.f_14144[iLocal_40].f_30))
							G_MissionStats.f_14144[iLocal_40].f_24 = 0;
			}
			...
			else
			{
				...
				if (iLocal_77 > 7000)
				{
					...
					{
						Global_8980[1] = { Global_9029[Global_20500] };
...
int func_67(eCharacter echParam0, char* sParam1, int iParam2, int iParam3, char* sParam4, char* sParam5, int iParam6, int iParam7, var uParam8, var uParam9, BOOL bParam10, var uParam11, var uParam12, int iParam13, char* sParam14, char* sParam15, int iParam16) // Position - 0x3EBF
{
	...
	G_MissionStats.f_14144[Global_22912].f_26 = uParam8;
	G_MissionStats.f_14144[Global_22912].f_29 = uParam9;
	G_MissionStats.f_14144[Global_22912].f_30 = uParam12;
	G_MissionStats.f_14144[Global_22912].f_31 = uParam11;
	...
	if (!Global_20705)
	{
		if (Global_20500.f_1 == 6)
		{
			func_35(G_Scaleform, "SET_DATA_SLOT_EMPTY", 1f, -1082130432, -1082130432, -1082130432, -1082130432);
			func_33(1);
			func_35(G_Scaleform, "DISPLAY_VIEW", 1f, SYSTEM::TO_FLOAT(Global_20480), -1082130432, -1082130432, -1082130432);
		}
	}
...
void func_77() // Position - 0x459B
{
	...
	while (num3 < num2)
	{
		if (!func_78(G_MissionStats.f_14144[num3].f_18, G_MissionStats.f_14144[Global_22912].f_18))
			Global_22912 = num3;
...
int func_79() // Position - 0x4751
{
	...
	while (i < num2)
	{
		if (G_MissionStats.f_14144[i].f_24 == 0 || G_MissionStats.f_14144[i].f_24 == 1)
			if (!func_78(G_MissionStats.f_14144[i].f_18, G_MissionStats.f_14144[Global_22912].f_18))
				Global_22912 = i;
...
BOOL func_86(int iParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0x4D8C
{
	...
	if (SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(Global_8377[iParam0].f_9) == 0)
	{
		Global_8976 = 0;
		Global_20500.f_1 = 7;
		func_87(&(Global_8377[iParam0].f_5));
	
		if (bParam3)
			if (SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(Global_8377[iParam0].f_9) == 0)
				Global_20498 = SYSTEM::START_NEW_SCRIPT(&(Global_8377[iParam0].f_5), CONTACTS_APP);
		else if (SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(Global_8377[iParam0].f_9) == 0)
			Global_20498 = SYSTEM::START_NEW_SCRIPT(&(Global_8377[iParam0].f_5), CELLPHONE);
	
		SCRIPT::SET_SCRIPT_AS_NO_LONGER_NEEDED(&(Global_8377[iParam0].f_5));
		return true;
	}
...
void func_132() // Position - 0x9C02
{
	if (Global_78689 == false)
	{
		Global_8377[14].f_4 = -99;
		Global_8377[4].f_4 = -99;
...
{
	TEXT_LABEL_ASSIGN_STRING(&Global_8377[iParam0], sParam1, 16);
	Global_8377[iParam0].f_4 = iParam2;
	TEXT_LABEL_ASSIGN_STRING(&(Global_8377[iParam0].f_5), sParam3, 16);
	Global_8377[iParam0].f_9 = MISC::GET_HASH_KEY(sParam3);
	Global_8377[iParam0].f_10 = iParam4;
	Global_8377[iParam0].f_11 = iParam5;
	Global_8377[iParam0].f_12 = iParam6;
	Global_8377[iParam0].f_13 = iParam7;
	Global_8377[iParam0].f_14 = iParam8;

	if (Global_8377[iParam0].f_12 == 0)
		Global_8377[iParam0].f_12 = 0;

	if (Global_8377[iParam0].f_13 == 0)
		Global_8377[iParam0].f_13 = 0;

	if (Global_8377[iParam0].f_14 == 0)
		Global_8377[iParam0].f_14 = 0;
...
void func_134() // Position - 0x9D46
{
	...
	if (Global_78689 == false)
	{
		...
		if (G_MissionStats.f_14054.f_89 == true)
			func_133(17, "CELL_28" /*Trackify*/, 8, "appTrackify", 42, 1, 1, 0, 0);
	
		if (G_MissionStats.f_14054.f_88 == 1)
