...
void main() // Position - 0x0
{
	...
	iLocal_41 = 49;
	iLocal_42 = 64;
	uLocal_128 = Vector3(-824.1719f, -187.654f, 36.5707f);
	uLocal_131 = Vector3(-1202.94f, -779.74f, 17.33f);
	uLocal_50 = Vector3(uScriptParam_397.f_1[0]);
	func_248();
							...
							case 0:
								...
								else
								{
									...
									if (func_168())
									{
										func_161(true);
										SYSTEM::SETTIMERA(0);
										EVENT::ADD_SHOCKING_EVENT_AT_POSITION(EVENT_SHOCKING_GUN_FIGHT, uLocal_194, 15000f);
										iLocal_46 = 1;
									}
								}
								break;
							...
							case 1:
								...
								switch (iLocal_47)
								{
									...
									case 2:
										...
										if (MISC::IS_PROJECTILE_IN_AREA(uLocal_194 - Vector3(20f, 20f, 20f), uLocal_194 + Vector3(20f, 20f, 20f), false))
										{
										...
										if (iLocal_49 == 1)
										{
											...
											if (bLocal_162 && !bLocal_224)
											{
												...
												{
													if (!ENTITY::IS_ENTITY_AT_COORD(veLocal_175, uLocal_55[0], 20f, 20f, 10f, false, true, 0))
													{
												...
												for (l = 0; l <= iLocal_111 - 1; l = l + 1)
												{
													...
													if (!uLocal_144[l])
													{
														if (VEHICLE::IS_VEHICLE_DRIVEABLE(veLocal_175, false))
														{
															if (!PED::IS_PED_INJURED(iLocal_114[l]))
															{
																if (PED::IS_PED_INJURED(pedLocal_184) || VEHICLE::IS_VEHICLE_SEAT_FREE(veLocal_175, -1, false) || FIRE::IS_ENTITY_ON_FIRE(iLocal_114[l]))
																{
...
void func_1() // Position - 0x122B
{
	...
	if (bLocal_181)
	{
		if (!bLocal_183)
		{
			...
			uLocal_198 = Vector3(ENTITY::GET_ENTITY_COORDS(iLocal_117[0], false));
		
			if (iLocal_49 == 1)
			{
				uLocal_198 = Vector3(-820.77f, -186.514f, 36.569f);
				uLocal_204 = Vector3(0f, 0f, -60f);
				fLocal_217 = 0.855f;
			...
			{
				uLocal_198 = Vector3(-1198.295f, -776.533f, 16.326f);
				uLocal_204 = Vector3(0f, 0f, -60.25f);
				fLocal_217 = 0.785f;
				sLocal_211 = "random@robbery";
			...
			caLocal_210 = CAM::CREATE_CAM("DEFAULT_ANIMATED_CAMERA", false);
...
void func_16(int iParam0) // Position - 0x251E
{
	...
	else if (IS_BIT_SET(Global_113648.f_20566.f_471, iParam0) || IS_BIT_SET(Global_2359296[func_18()].f_681.f_10, iParam0))
	{
		flag = true;
		MISC::CLEAR_BIT(&(Global_113648.f_20566.f_471), iParam0);
		MISC::CLEAR_BIT(&(Global_2359296[func_18()].f_681.f_10), iParam0);
	}
...
void _STAT_SET_PACKED_BOOL(int iParam0, BOOL bParam1, int iParam2) // Position - 0x27AE
{
	if (iParam2 == -1)
		iParam2 = func_6();
...
BOOL func_21(int iParam0) // Position - 0x27EC
{
	...
	return IS_BIT_SET(Global_2359296[func_18()].f_681.f_10, iParam0);
}

BOOL _STAT_GET_PACKED_BOOL(int iParam0, int iParam1) // Position - 0x2992
{
	if (iParam1 == -1)
		iParam1 = func_6();
...
void func_76(int iParam0) // Position - 0x45E5
{
	...
	vector = Vector3(func_95(iParam0));
...
void func_81(int iParam0, var uParam1) // Position - 0x4DC7
{
	...
	switch (iParam0)
	{
		...
		case 71:
		case 72:
			if (!func_82(iParam0) && SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(Global_91469[26].f_6) == 0)
			{
				Global_113648.f_7263[iParam0] = 1;
				OBJECT::DOOR_SYSTEM_SET_DOOR_STATE(uParam1->f_5, Global_113648.f_7263[iParam0], true, true);
			}
		...
		if (!bLocal_161)
			if (ENTITY::IS_ENTITY_DEAD(iLocal_114[0], false))
				if (ENTITY::DOES_ENTITY_EXIST(iLocal_114[0]))
					uLocal_107 = Vector3(PED::GET_DEAD_PED_PICKUP_COORDS(iLocal_114[0], 1067030938, 1069547520));
			else
				uLocal_107 = Vector3(OBJECT::GET_SAFE_PICKUP_COORDS(ENTITY::GET_ENTITY_COORDS(iLocal_114[0], true), 1067030938, 1069547520));
		else if (ENTITY::DOES_ENTITY_EXIST(veLocal_175))
			uLocal_107 = Vector3(OBJECT::GET_SAFE_PICKUP_COORDS(ENTITY::GET_ENTITY_COORDS(veLocal_175, false), 1067030938, 1069547520));
	
		uLocal_107 = Vector3(uLocal_107, uLocal_107.f_1, uLocal_107.f_2 + 0.25f);
...
void func_149() // Position - 0x9E10
{
	...
	entityCoords = Vector3(ENTITY::GET_ENTITY_COORDS(obLocal_167, true));
	entityRotation = Vector3(ENTITY::GET_ENTITY_ROTATION(obLocal_167, 2));
	OBJECT::DELETE_OBJECT(&obLocal_167);
...
void func_154() // Position - 0xA58C
{
	switch (iLocal_227)
	{
		case 0:
			...
			caLocal_226 = CAM::CREATE_CAM("DEFAULT_ANIMATED_CAMERA", false);
...
void func_156() // Position - 0xA6A3
{
	...
	if (!bLocal_136 && func_159(true, false, true))
	{
		...
		else if (iLocal_49 == 2)
		{
			...
			uLocal_201 = Vector3(-1199.369f, -776.1991f, 16.3235f);
			uLocal_207 = Vector3(0f, 0f, -60f);
			iLocal_216 = PED::CREATE_SYNCHRONIZED_SCENE(uLocal_201, uLocal_207, 2);
	...
	else if (STREAMING::HAS_MODEL_LOADED(model))
	{
		if (func_158())
			if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(veLocal_171, -828.3692f, -194.46695f, 36.413845f, -824.58014f, -201.13535f, 39.394363f, 4.3125f, false, true, 0))
				uLocal_172 = Vector3(-822.1784f, -205.811f, 36.3444f);
			else
				uLocal_172 = Vector3(-826.2828f, -197.8547f, 36.3995f);
		else
			uLocal_172 = Vector3(-826.2828f, -197.8547f, 36.3995f);
...
BOOL func_170() // Position - 0xB32D
{
	...
	if (FIRE::IS_EXPLOSION_IN_AREA(-1, uLocal_194 - Vector3(20f, 20f, 20f), uLocal_194 + Vector3(20f, 20f, 20f)))
		return true;
	...
	if (!PED::IS_PED_INJURED(iLocal_114[0]) && !PED::IS_PED_INJURED(iLocal_114[1]))
		if (PED::IS_PED_SHOOTING_IN_AREA(PLAYER::PLAYER_PED_ID(), ENTITY::GET_ENTITY_COORDS(iLocal_114[1], true) - Vector3(12f, 12f, 12f), ENTITY::GET_ENTITY_COORDS(iLocal_114[1], true) + Vector3(12f, 12f, 12f), false, true) && !WEAPON::IS_PED_CURRENT_WEAPON_SILENCED(PLAYER::PLAYER_PED_ID()) || MISC::IS_BULLET_IN_AREA(ENTITY::GET_ENTITY_COORDS(iLocal_114[0], true), 3f, true) || MISC::IS_BULLET_IN_AREA(ENTITY::GET_ENTITY_COORDS(iLocal_114[1], true), 3f, true))
			return true;
...
void func_176() // Position - 0xB949
{
	...
	for (i = 0; i <= iLocal_111 - 1; i = i + 1)
	{
		iLocal_114[i] = PED::CREATE_PED(PED_TYPE_MISSION, hLocal_222, uLocal_55[i], uLocal_62[i], true, true);
	...
	if (iLocal_49 == 1)
	{
		PED::ADD_SCENARIO_BLOCKING_AREA(uLocal_128 - Vector3(20f, 20f, 20f), uLocal_128 + Vector3(20f, 20f, 20f), false, true, true, true);
		...
		uLocal_168[1] = OBJECT::CREATE_OBJECT(joaat("prop_anim_cash_pile_01"), uLocal_97 - Vector3(0.1f, 0f, 0f), true, true, false);
		...
		uLocal_201 = Vector3(-821.565f, -186.467f, 36.6f);
		uLocal_207 = Vector3(0f, 0f, -59.96f);
		iLocal_216 = PED::CREATE_SYNCHRONIZED_SCENE(uLocal_201, uLocal_207, 2);
		...
		{
			iLocal_117[i] = PED::CREATE_PED(PED_TYPE_MISSION, hLocal_219, uLocal_65[i], uLocal_75[i], true, true);
		...
		iLocal_121[0] = PED::CREATE_PED(PED_TYPE_MISSION, hLocal_220, uLocal_79[0], uLocal_92[0], true, true);
		...
		for (i = 1; i <= 2; i = i + 1)
		{
			iLocal_121[i] = PED::CREATE_PED(PED_TYPE_MISSION, hLocal_221, uLocal_79[i], uLocal_92[i], true, true);
	...
	{
		PED::ADD_SCENARIO_BLOCKING_AREA(uLocal_131 - Vector3(20f, 20f, 20f), uLocal_131 + Vector3(20f, 20f, 20f), false, true, true, true);
		ENTITY::SET_ENTITY_ROTATION(obLocal_167, uLocal_100, 2, true);
		iLocal_117[0] = PED::CREATE_PED(PED_TYPE_MISSION, hLocal_219, uLocal_65[0], uLocal_75[0], true, true);
		PED::SET_PED_NAME_DEBUG(iLocal_117[0], "pedWorker[0]");
		...
		iLocal_117[1] = PED::CREATE_PED(PED_TYPE_MISSION, hLocal_218, uLocal_65[1], uLocal_75[1], true, true);
		PED::SET_PED_NAME_DEBUG(iLocal_117[1], "pedWorker[1]");
		...
		iLocal_121[0] = PED::CREATE_PED(PED_TYPE_MISSION, hLocal_220, uLocal_79[0], uLocal_92[0], true, true);
		PED::SET_PED_NAME_DEBUG(iLocal_121[0], "pedShopper[0]");
		iLocal_121[1] = PED::CREATE_PED(PED_TYPE_MISSION, hLocal_221, uLocal_79[1], uLocal_92[1], true, true);
		PED::SET_PED_NAME_DEBUG(iLocal_121[1], "pedShopper[1]");
		...
		PED::SET_PED_KEEP_TASK(iLocal_121[1], true);
		uLocal_201 = Vector3(-1192.01f, -768.929f, 16.358f);
		uLocal_207 = Vector3(0f, 0f, -59.5f);
		iLocal_216 = PED::CREATE_SYNCHRONIZED_SCENE(uLocal_201, uLocal_207, 2);
		PED::SET_SYNCHRONIZED_SCENE_LOOPED(iLocal_216, true);
...
void func_182() // Position - 0xC975
{
	if (!bLocal_135)
	{
		inLocal_153 = INTERIOR::GET_INTERIOR_AT_COORDS(uLocal_55[0]);
...
void func_184() // Position - 0xCABE
{
	...
	if (iLocal_49 == 1)
	{
		...
		iLocal_112 = 3;
		iLocal_113 = 3;
		uLocal_55[0] = Vector3(-821.4461f, -184.84744f, 37.566795f);
		uLocal_62[0] = 252.381f;
		uLocal_55[1] = Vector3(-819.4664f, -186.8146f, 36.5671f);
		uLocal_62[1] = -153.95622f;
		uLocal_65[0] = Vector3(-821.941f, -183.3325f, 36.5689f);
		uLocal_75[0] = 203.3684f;
		uLocal_65[1] = Vector3(-813.6672f, -185.5652f, 36.5689f);
		uLocal_75[1] = 90.1761f;
		uLocal_65[2] = Vector3(-816.1049f, -183.9966f, 36.5689f);
		uLocal_75[2] = 192.7338f;
		uLocal_79[0] = Vector3(-813.008f, -184.931f, 37.869f);
		uLocal_92[0] = 337.68f;
		uLocal_79[1] = Vector3(-817.5606f, -190.8273f, 37.3114f);
		uLocal_92[1] = 25.8399f;
		uLocal_79[2] = Vector3(-816.1862f, -182.897f, 37.6304f);
		uLocal_92[2] = 30f;
		uLocal_97 = Vector3(-822.2148f, -184.0822f, 37.7027f);
		uLocal_100 = Vector3(-1.8236f, 0.6172f, 75.8024f);
		uLocal_103 = Vector3(-808.5918f, -180.0378f, 36.5689f);
		hLocal_188 = joaat("prop_cs_duffel_01");
		iLocal_189 = 2000;
		uLocal_194 = Vector3(-822.8538f, -187.7645f, 36.5792f);
	}
	else if (iLocal_49 == 2)
	{
		...
		iLocal_112 = 2;
		iLocal_113 = 2;
		uLocal_55[0] = Vector3(-1193.045f, -769.304f, 16.321f);
		uLocal_62[0] = -85.5f;
		uLocal_55[1] = Vector3(-1199.0454f, -778.8358f, 16.3277f);
		uLocal_62[1] = 329.1899f;
		uLocal_65[0] = Vector3(-1193.8021f, -766.8922f, 16.331f);
		uLocal_75[0] = 221.3152f;
		uLocal_65[1] = Vector3(-1193.8497f, -771.4392f, 16.3227f);
		uLocal_75[1] = 247.1149f;
		uLocal_79[0] = Vector3(-1184.3588f, -767.0463f, 16.3468f);
		uLocal_92[0] = 103.3015f;
		uLocal_79[1] = Vector3(-1185.9325f, -770.624f, 16.344f);
		uLocal_92[1] = 43.215f;
		uLocal_97 = Vector3(-1192.9675f, -767.0651f, 17.2968f);
		uLocal_100 = Vector3(0f, 0f, -128.52f);
		uLocal_103 = Vector3(-1180.4567f, -763.9163f, 16.3267f);
		hLocal_188 = joaat("prop_cs_duffel_01");
		iLocal_189 = 2000;
		uLocal_194 = Vector3(-1201.0062f, -777.4955f, 16.3235f);
	}
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_224() || Global_112695 || Global_32166 || func_223() || func_129(8, -1) || func_222() || func_221() || func_220() || func_219() || G_SomeGlobalState.MessageCallStates.f_919[character] == 5)
							return false;
						break;
				
					case 1:
						if (PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_224() || Global_32166 || func_223() || func_129(8, -1) || func_220() || func_222() || func_221() || func_219() || G_SomeGlobalState.MessageCallStates.f_919[character] == 5)
							return false;
						break;
					...
					case 3:
						if (PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_224() || Global_112695 || Global_32166 || func_223() || func_129(8, -1) || func_222() || func_221() || func_219() || G_SomeGlobalState.MessageCallStates.f_919[character] == 5)
							return false;
						break;
				
					case 4:
						if (func_224() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0 || func_129(8, -1) || func_219() || func_218() || G_SomeGlobalState.MessageCallStates.f_919[character] == 5)
							return false;
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
							if (PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0 || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || func_224() || Global_32166 || func_223() || func_129(8, -1) || func_221() || func_220() || func_219() || G_SomeGlobalState.MessageCallStates.f_919[character] == 5)
								return false;
						break;
