...
void main() // Position - 0x0
{
	...
	uLocal_48 = { uScriptParam_395.f_1[0] };
	func_250();
									...
									case 2:
										...
										if (iLocal_47 == 1)
										{
											...
											if (bLocal_160 && !bLocal_222)
											{
												...
												{
													if (!ENTITY::IS_ENTITY_AT_COORD(veLocal_173, uLocal_53[0], 20f, 20f, 10f, false, true, 0))
													{
...
void func_17(int iParam0) // Position - 0x2523
{
	...
	else if (IS_BIT_SET(G_MissionStats.f_20567.f_471, iParam0) || IS_BIT_SET(Global_2359296[func_19()].f_681.f_10, iParam0))
	{
		flag = true;
		MISC::CLEAR_BIT(&(G_MissionStats.f_20567.f_471), iParam0);
		MISC::CLEAR_BIT(&(Global_2359296[func_19()].f_681.f_10), iParam0);
	}
...
BOOL func_22(int iParam0) // Position - 0x27EB
{
	...
	return IS_BIT_SET(Global_2359296[func_19()].f_681.f_10, iParam0);
}
...
void func_60() // Position - 0x3594
{
	...
	if (value > 0f && SYSTEM::FLOOR(value) < SYSTEM::FLOOR(G_MissionStats.f_10197.f_3853))
		func_39(13, SYSTEM::FLOOR(G_MissionStats.f_10197.f_3853));
...
void func_82(int iParam0, var uParam1) // Position - 0x4DBF
{
	...
	switch (iParam0)
	{
		...
		case 71:
		case 72:
			if (!func_83(iParam0) && SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(Global_91601[26].f_6) == 0)
			{
				G_MissionStats.f_7264[iParam0] = 1;
				OBJECT::DOOR_SYSTEM_SET_DOOR_STATE(uParam1->f_5, G_MissionStats.f_7264[iParam0], true, true);
			}
...
void func_178() // Position - 0xB971
{
	...
	for (i = 0; i <= iLocal_109 - 1; i = i + 1)
	{
		iLocal_112[i] = PED::CREATE_PED(PED_TYPE_MISSION, hLocal_220, uLocal_53[i], uLocal_60[i], true, true);
	...
	if (iLocal_47 == 1)
	{
		...
		{
			iLocal_115[i] = PED::CREATE_PED(PED_TYPE_MISSION, hLocal_217, uLocal_63[i], uLocal_73[i], true, true);
		...
		iLocal_119[0] = PED::CREATE_PED(PED_TYPE_MISSION, hLocal_218, uLocal_77[0], uLocal_90[0], true, true);
		...
		for (i = 1; i <= 2; i = i + 1)
		{
			iLocal_119[i] = PED::CREATE_PED(PED_TYPE_MISSION, hLocal_219, uLocal_77[i], uLocal_90[i], true, true);
	...
	else if (iLocal_47 == 2)
	{
		...
		iLocal_115[0] = PED::CREATE_PED(PED_TYPE_MISSION, hLocal_217, uLocal_63[0], uLocal_73[0], true, true);
		PED::SET_PED_NAME_DEBUG(iLocal_115[0], "pedWorker[0]");
		...
		iLocal_115[1] = PED::CREATE_PED(PED_TYPE_MISSION, hLocal_216, uLocal_63[1], uLocal_73[1], true, true);
		PED::SET_PED_NAME_DEBUG(iLocal_115[1], "pedWorker[1]");
		...
		iLocal_119[0] = PED::CREATE_PED(PED_TYPE_MISSION, hLocal_218, uLocal_77[0], uLocal_90[0], true, true);
		PED::SET_PED_NAME_DEBUG(iLocal_119[0], "pedShopper[0]");
		iLocal_119[1] = PED::CREATE_PED(PED_TYPE_MISSION, hLocal_219, uLocal_77[1], uLocal_90[1], true, true);
		PED::SET_PED_NAME_DEBUG(iLocal_119[1], "pedShopper[1]");
...
void func_184() // Position - 0xC99D
{
	if (!bLocal_133)
	{
		inLocal_151 = INTERIOR::GET_INTERIOR_AT_COORDS(uLocal_53[0]);
...
void func_186() // Position - 0xCAE6
{
	...
	if (iLocal_47 == 1)
	{
		...
		iLocal_110 = 3;
		iLocal_111 = 3;
		uLocal_53[0] = { -821.4461f, -184.84744f, 37.566795f };
		uLocal_60[0] = 252.381f;
		uLocal_53[1] = { -819.4664f, -186.8146f, 36.5671f };
		uLocal_60[1] = -153.95622f;
		uLocal_63[0] = { -821.941f, -183.3325f, 36.5689f };
		uLocal_73[0] = 203.3684f;
		uLocal_63[1] = { -813.6672f, -185.5652f, 36.5689f };
		uLocal_73[1] = 90.1761f;
		uLocal_63[2] = { -816.1049f, -183.9966f, 36.5689f };
		uLocal_73[2] = 192.7338f;
		uLocal_77[0] = { -813.008f, -184.931f, 37.869f };
		uLocal_90[0] = 337.68f;
		uLocal_77[1] = { -817.5606f, -190.8273f, 37.3114f };
		uLocal_90[1] = 25.8399f;
		uLocal_77[2] = { -816.1862f, -182.897f, 37.6304f };
		uLocal_90[2] = 30f;
	...
	else if (iLocal_47 == 2)
	{
		...
		iLocal_110 = 2;
		iLocal_111 = 2;
		uLocal_53[0] = { -1193.045f, -769.304f, 16.321f };
		uLocal_60[0] = -85.5f;
		uLocal_53[1] = { -1199.0454f, -778.8358f, 16.3277f };
		uLocal_60[1] = 329.1899f;
		uLocal_63[0] = { -1193.8021f, -766.8922f, 16.331f };
		uLocal_73[0] = 221.3152f;
		uLocal_63[1] = { -1193.8497f, -771.4392f, 16.3227f };
		uLocal_73[1] = 247.1149f;
		uLocal_77[0] = { -1184.3588f, -767.0463f, 16.3468f };
		uLocal_90[0] = 103.3015f;
		uLocal_77[1] = { -1185.9325f, -770.624f, 16.344f };
		uLocal_90[1] = 43.215f;
...
BOOL func_204(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6) // Position - 0xEB42
{
	...
	if (!flag)
	{
		...
		if (!func_228(G_MissionStats.f_24998.f_43[iParam3]))
			return false;
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_226() || Global_112857 || Global_32286 || func_225() || func_130(8, -1) || func_224() || func_223() || func_222() || func_221() || G_MissionStats.f_7691.f_919[character] == 5)
							return false;
						break;
				
					case 1:
						if (PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_226() || Global_32286 || func_225() || func_130(8, -1) || func_222() || func_224() || func_223() || func_221() || G_MissionStats.f_7691.f_919[character] == 5)
							return false;
						break;
				
					case 2:
						if (!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_226() || Global_112857 || Global_32286 || func_225() || func_130(8, -1) || func_222() || func_224() || func_223() || func_221() || G_MissionStats.f_7691.f_919[character] == 5 || Global_43924 != -1)
							return false;
						break;
				
					case 3:
						if (PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_226() || Global_112857 || Global_32286 || func_225() || func_130(8, -1) || func_224() || func_223() || func_221() || G_MissionStats.f_7691.f_919[character] == 5)
							return false;
						break;
				
					case 4:
						if (func_226() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0 || func_130(8, -1) || func_221() || func_220() || G_MissionStats.f_7691.f_919[character] == 5)
							return false;
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
							if (PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0 || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || func_226() || Global_32286 || func_225() || func_130(8, -1) || func_223() || func_222() || func_221() || G_MissionStats.f_7691.f_919[character] == 5)
								return false;
						break;
				
					case 7:
						if (PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || !CAM::IS_SCREEN_FADED_IN() || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_226() || func_223() || Global_112857 || Global_32286 || func_225() || Global_44569 || func_130(8, -1) || func_222() || func_220() || func_221() || G_MissionStats.f_7691.f_919[character] == 5)
							return false;
						break;
