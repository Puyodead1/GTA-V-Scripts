...
void main() // Position - 0x0
{
	...
	unk63 = 15;
	func_322(&num);
	vector = Vector3(uScriptParam_111.f_1[0]);
	num2.f_1 = -1;
	unk124 = 7;
	unk124[0] = 37;
	unk124[1] = 38;
	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (num != -1)
		{
			if (Global_112735[num].f_9 != -1)
			{
				...
				func_320(&(Global_112735[num].f_9));
			}
		}
...
BOOL IS_PLAYSTATION_PLATFORM() // Position - 0x8DDC
{
	return MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION();
}

BOOL IS_XBOX_PLATFORM() // Position - 0x8DF2
{
	return MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION();
}

void func_112(char* sParam0, Any anParam1, int iParam2) // Position - 0x8E08
{
...
BOOL func_163(int iParam0) // Position - 0xB7BB
{
	...
	num = func_165(&(Global_112735[iParam0].f_9), 1, 4, false, 0);
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_192() || Global_112695 || Global_32166 || func_191() || func_190(8, -1) || func_96() || func_189() || func_188() || func_187() || G_SomeGlobalState.MessageCallStates.f_919[character] == 5)
							return false;
						break;
				
					case 1:
						if (PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_192() || Global_32166 || func_191() || func_190(8, -1) || func_188() || func_96() || func_189() || func_187() || G_SomeGlobalState.MessageCallStates.f_919[character] == 5)
							return false;
						break;
				
					case 2:
						if (!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_192() || Global_112695 || Global_32166 || func_191() || func_190(8, -1) || func_188() || func_96() || func_189() || func_187() || G_SomeGlobalState.MessageCallStates.f_919[character] == 5 || LastDispatchedMessageOrCall != -1)
							return false;
						break;
				
					case 3:
						if (PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_192() || Global_112695 || Global_32166 || func_191() || func_190(8, -1) || func_96() || func_189() || func_187() || G_SomeGlobalState.MessageCallStates.f_919[character] == 5)
							return false;
						break;
				
					case 4:
						if (func_192() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0 || func_190(8, -1) || func_187() || func_186() || G_SomeGlobalState.MessageCallStates.f_919[character] == 5)
							return false;
						break;
...
BOOL func_231(Ped pedParam0, Ped pedParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xEEAC
{
	...
	if (num == -1)
	{
		...
		iLocal_49[num].f_1 = pedParam0;
		iLocal_49[num].f_2 = pedParam1;
	}

	pedBoneCoords = Vector3(PED::GET_PED_BONE_COORDS(pedParam0, 31086, 0f, 0f, 0f));
	flag = func_232(&iLocal_49[num], pedBoneCoords, pedParam1, &(iLocal_49[num].f_3), pedParam0, iParam5);
	return flag || MISC::GET_GAME_TIMER() - iLocal_49[num].f_3 < iParam4;
}
...
BOOL func_232(var uParam0, Vector3 vParam1, var uParam2, var uParam3, Ped pedParam4, var uParam5, Ped pedParam6, int iParam7) // Position - 0xEF6D
{
	...
	if (*uParam0 == 0)
	{
		endCoords = Vector3(func_233(pedParam4, iParam7));
...
int func_234() // Position - 0xF15E
{
	...
	{
		if (iLocal_49[i] == 0 && iLocal_49[i].f_1 == 0 && iLocal_49[i].f_2 == 0)
			return i;
	}
...
BOOL func_235(Ped pedParam0, Ped pedParam1, int iParam2, int iParam3) // Position - 0xF1A8
{
	...
	unk = Vector3(func_237(ENTITY::GET_ENTITY_COORDS(pedParam1, true) - ENTITY::GET_ENTITY_COORDS(pedParam0, true)));
	...
	if (iParam3 == 0)
		...
		entityForwardVector = Vector3(func_237(PED::GET_PED_BONE_COORDS(pedParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(pedParam0, 31086, 0f, 0f, 0f)));
...
int func_239(Ped pedParam0, Ped pedParam1) // Position - 0xF2B4
{
	...
	for (i = 0; i < iLocal_49; i = i + 1)
	{
		if (iLocal_49[i].f_1 == pedParam0 && iLocal_49[i].f_2 == pedParam1)
			return i;
	}
...
BOOL func_244(Ped pedParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0xF5B7
{
	...
	unk = Vector3(func_237(uParam1 - ENTITY::GET_ENTITY_COORDS(pedParam0, true)));
...
BOOL func_257(var uParam0, var uParam1) // Position - 0xFBC5
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(*uParam1) && STREAMING::HAS_MODEL_LOADED(hLocal_94))
	{
		*uParam0 = PED::CREATE_PED(PED_TYPE_MISSION, joaat("U_M_M_Aldinapoli"), -59.7094f, -1330.1289f, 32.1963f, 0, true, true);
		...
		offsetFromEntityInWorldCoords = Vector3(ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(*uParam1, -0.2f, -1.8f, -1f));
		num = -90f + ENTITY::GET_ENTITY_HEADING(*uParam1);
		vector = Vector3(0f, 0f, num);
...
void func_268(BOOL bParam0) // Position - 0x10570
{
	...
	vector = Vector3(-1212.164f, 634.82306f, 100.50546f);
	vector2 = Vector3(-1010.0827f, 830.9487f, 250.4705f);
...
BOOL func_275(var uParam0) // Position - 0x10D44
{
	...
	switch (iLocal_91)
	{
		case 0:
			uParam0->f_16 = 5;
			uParam0->f_17[0] = Vector3(-650.55585f, -217.06265f, 35.55435f);
			uParam0->f_17[1] = Vector3(-601.40985f, -300.3887f, 64.24574f);
			uParam0->f_24 = 35f;
			uParam0->f_27 = 1;
...
BOOL func_276(var uParam0) // Position - 0x11072
{
	...
	switch (iLocal_91)
	{
		case 0:
			uParam0->f_16 = 5;
			uParam0->f_17[0] = Vector3(-1065.1202f, 366.34378f, 97.59101f);
			uParam0->f_17[1] = Vector3(-1020.77454f, 364.75955f, 65.23878f);
			uParam0->f_24 = 40f;
			uParam0->f_27 = 1;
...
BOOL func_280(var uParam0) // Position - 0x1165D
{
	...
	switch (iLocal_91)
	{
		case 0:
			uParam0->f_16 = 5;
			uParam0->f_17[0] = Vector3(-565.5146f, 269.61392f, 81.020805f);
			uParam0->f_17[1] = Vector3(-562.2337f, 306.5382f, 94.13258f);
			uParam0->f_24 = 30f;
			uParam0->f_27 = 1;
			func_281(4, false);
...
void func_284(int iParam0, BOOL bParam1) // Position - 0x11CD0
{
	...
	offset = Vector3(func_283(iParam0));
...
char* func_285(int iParam0, var uParam1) // Position - 0x11D13
{
	...
	vector = Vector3(func_286(iParam0));
...
struct<5> func_286(int iParam0) // Position - 0x11D38
{
	...
	switch (iParam0)
	{
		...
		case 33:
			unk6 = Vector3(func_287(35, false));
			unk = { unk6 + Vector3(1f, 0f, 0f) };
			unk.f_3 = "hei_dlc_apart_high_new";
		...
		case 34:
			unk6 = Vector3(func_287(36, false));
			unk = { unk6 + Vector3(1f, 0f, 0f) };
			unk.f_3 = "hei_dlc_apart_high_new";
		...
		case 35:
			unk6 = Vector3(func_287(37, false));
			unk = { unk6 + Vector3(1f, 0f, 0f) };
			unk.f_3 = "hei_dlc_apart_high_new";
		...
		case 36:
			unk6 = Vector3(func_287(38, false));
		...
		case 37:
			unk6 = Vector3(func_287(39, false));
			unk = { unk6 + Vector3(1f, 0f, 0f) };
			unk.f_3 = "hei_dlc_apart_high_new";
		...
		case 38:
			unk6 = Vector3(func_287(40, false));
			unk = { unk6 + Vector3(1f, 0f, 0f) };
			unk.f_3 = "hei_dlc_apart_high_new";
		...
		case 39:
			unk6 = Vector3(func_287(41, false));
			unk = { unk6 + Vector3(1f, 0f, 0f) };
			unk.f_3 = "hei_dlc_apart_high_new";
		...
		case 40:
			unk6 = Vector3(func_287(42, false));
			unk = { unk6 + Vector3(1f, 0f, 0f) };
			unk.f_3 = "hei_dlc_apart_high_new";
		...
		case 41:
			unk6 = Vector3(func_287(43, false));
			unk = { unk6 + Vector3(1f, 0f, 0f) };
			unk.f_3 = "hei_dlc_apart_high_new";
	...
	switch (iParam0)
	{
		...
		case 83:
			unk6 = Vector3(func_287(87, false));
			unk = { unk6 + Vector3(1f, 0f, 0f) };
		...
		case 92:
			unk6 = Vector3(func_287(88, false));
			unk = { unk6 + Vector3(1f, 0f, 0f) };
			unk.f_3 = "ex_int_office_01a_dlc";
			unk.f_4 = unk.f_3;
			break;
		...
		case 101:
			unk6 = Vector3(func_287(89, false));
			unk = { unk6 + Vector3(1f, 0f, 0f) };
			unk.f_3 = "ex_int_office_01a_dlc";
			unk.f_4 = unk.f_3;
			break;
		...
		case 110:
			unk6 = Vector3(func_287(90, false));
			unk = { unk6 + Vector3(1f, 0f, 0f) };
			unk.f_3 = "ex_int_office_01a_dlc";
			unk.f_4 = unk.f_3;
			break;
		...
		case 119:
			unk6 = Vector3(func_287(91, false));
			unk = { unk6 + Vector3(1f, 0f, 0f) };
		...
		case 120:
			unk6 = Vector3(func_287(97, false));
			unk = { unk6 + Vector3(1f, 0f, 0f) };
		...
		case 121:
			unk6 = Vector3(func_287(103, false));
			unk = { unk6 + Vector3(1f, 0f, 0f) };
		...
		case 122:
			unk6 = Vector3(func_287(104, false));
			unk = { unk6 + Vector3(1f, 0f, 0f) };
			unk.f_3 = "imp_impexp_int_01";
			unk.f_4 = unk.f_3;
			break;
		...
		case 123:
			unk6 = Vector3(func_287(105, false));
			unk = { unk6 + Vector3(1f, 0f, 0f) };
			unk.f_3 = "imp_impexp_int_01";
			unk.f_4 = unk.f_3;
			break;
		...
		case 124:
			unk6 = Vector3(func_287(106, false));
			unk = { unk6 + Vector3(1f, 0f, 0f) };
			unk.f_3 = "imp_impexp_int_01";
			unk.f_4 = unk.f_3;
			break;
		...
		case 125:
			unk6 = Vector3(func_287(107, false));
			unk = { unk6 + Vector3(1f, 0f, 0f) };
			unk.f_3 = "imp_impexp_int_01";
			unk.f_4 = unk.f_3;
			break;
		...
		case 126:
			unk6 = Vector3(func_287(108, false));
			unk = { unk6 + Vector3(1f, 0f, 0f) };
			unk.f_3 = "imp_impexp_int_01";
			unk.f_4 = unk.f_3;
			break;
		...
		case 127:
			unk6 = Vector3(func_287(109, false));
			unk = { unk6 + Vector3(1f, 0f, 0f) };
			unk.f_3 = "imp_impexp_int_01";
			unk.f_4 = unk.f_3;
			break;
		...
		case 128:
			unk6 = Vector3(func_287(110, false));
			unk = { unk6 + Vector3(1f, 0f, 0f) };
			unk.f_3 = "imp_impexp_int_01";
			unk.f_4 = unk.f_3;
			break;
		...
		case 129:
			unk6 = Vector3(func_287(111, false));
			unk = { unk6 + Vector3(1f, 0f, 0f) };
			unk.f_3 = "imp_impexp_int_01";
			unk.f_4 = unk.f_3;
			break;
		...
		case 130:
			unk6 = Vector3(func_287(112, false));
			unk = { unk6 + Vector3(1f, 0f, 0f) };
			unk.f_3 = "imp_impexp_int_01";
			unk.f_4 = unk.f_3;
			break;
		...
		case 131:
			unk6 = Vector3(func_287(113, false));
			unk = { unk6 + Vector3(1f, 0f, 0f) };
			unk.f_3 = "imp_impexp_int_01";
			unk.f_4 = unk.f_3;
			break;
		...
		case 132:
			unk6 = Vector3(func_287(114, false));
			unk = { unk6 + Vector3(1f, 0f, 0f) };
			unk.f_3 = "imp_impexp_int_01";
			unk.f_4 = unk.f_3;
			break;
		...
		case 133:
			unk6 = Vector3(func_287(103, true));
			unk = { unk6 + Vector3(1f, 0f, 0f) };
		...
		case 134:
			unk6 = Vector3(func_287(106, true));
			unk = { unk6 + Vector3(1f, 0f, 0f) };
			unk.f_3 = "imp_imptexp_mod_int_01";
			unk.f_4 = unk.f_3;
			break;
		...
		case 135:
			unk6 = Vector3(func_287(109, true));
			unk = { unk6 + Vector3(1f, 0f, 0f) };
			unk.f_3 = "imp_imptexp_mod_int_01";
			unk.f_4 = unk.f_3;
			break;
		...
		case 136:
			unk6 = Vector3(func_287(112, true));
			unk = { unk6 + Vector3(1f, 0f, 0f) };
			unk.f_3 = "imp_imptexp_mod_int_01";
			unk.f_4 = unk.f_3;
			break;
