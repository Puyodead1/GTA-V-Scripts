	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (num != -1)
		{
			if (Global_112897[num].f_9 != -1)
			{
				...
				func_325(&(Global_112897[num].f_9));
			}
		}
...
BOOL func_236(Ped pedParam0, Ped pedParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xEF9C
{
	...
	flag = func_237(&iLocal_47[num], pedBoneCoords, pedParam1, &(iLocal_47[num].f_3), pedParam0, iParam5);
...
BOOL func_280(var uParam0) // Position - 0x10E35
{
	...
	switch (iLocal_89)
	{
		case 0:
			uParam0->f_16 = 5;
			uParam0->f_17[0] = { -650.55585f, -217.06265f, 35.55435f };
			uParam0->f_17[1] = { -601.40985f, -300.3887f, 64.24574f };
			uParam0->f_24 = 35f;
			uParam0->f_27 = 1;
...
BOOL func_281(var uParam0) // Position - 0x11163
{
	...
	switch (iLocal_89)
	{
		case 0:
			uParam0->f_16 = 5;
			uParam0->f_17[0] = { -1065.1202f, 366.34378f, 97.59101f };
			uParam0->f_17[1] = { -1020.77454f, 364.75955f, 65.23878f };
			uParam0->f_24 = 40f;
			uParam0->f_27 = 1;
...
BOOL func_285(var uParam0) // Position - 0x1174E
{
	...
	switch (iLocal_89)
	{
		case 0:
			uParam0->f_16 = 5;
			uParam0->f_17[0] = { -565.5146f, 269.61392f, 81.020805f };
