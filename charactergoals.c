		...
		switch (iLocal_18)
		{
			case 0:
				if (uLocal_19[0])
				{
					...
					{
						Global_22844[3].f_27[0] = _GET_PLAYER_CASH(CHAR_TREVOR);
						func_49(2, 32, Global_22844[3].f_27[0]);
					}
				
					TEXT_LABEL_ASSIGN_STRING(&Global_22844[3], "PA_TREV1" /*Earn one million dollars.*/, 16);
					TEXT_LABEL_ASSIGN_STRING(&(Global_22844[3].f_4), "PA_TREV1" /*Earn one million dollars.*/, 16);
					Global_22844[3].f_8 = 0;
					Global_22844[3].f_9 = 1;
					TEXT_LABEL_ASSIGN_STRING(&Global_22844[3].f_10[1], "PA_TREV1A" /*Current wealth $~1~.*/, 16);
					Global_22844[3].f_37[1] = 0;
				
					if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
						Global_22844[3].f_27[1] = _GET_PLAYER_CASH(CHAR_TREVOR);
				
					func_42(2, 3, true, 1);
					func_39("PA_TREV1A" /*Current wealth $~1~.*/, Global_22844[3].f_27[1]);
					iLocal_18 = 1;
				}
				break;
			...
			case 1:
				if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
				{
					...
					if (func_38(CHAR_TREVOR, 999999))
					{
						...
						Global_22844[3].f_37[1] = 1;
						Global_22844[3].f_8 = 1;
...
void func_5(int iParam0) // Position - 0xB82
{
	...
	else if (IS_BIT_SET(Global_113648.f_20566.f_471, iParam0) || IS_BIT_SET(Global_2359296[func_7()].f_681.f_10, iParam0))
	{
		flag = true;
		MISC::CLEAR_BIT(&(Global_113648.f_20566.f_471), iParam0);
		MISC::CLEAR_BIT(&(Global_2359296[func_7()].f_681.f_10), iParam0);
	}
...
void _STAT_SET_PACKED_BOOL(int iParam0, BOOL bParam1, int iParam2) // Position - 0xE70
{
	if (iParam2 == -1)
		iParam2 = func_10();
...
BOOL func_13(int iParam0) // Position - 0xEAE
{
	...
	return IS_BIT_SET(Global_2359296[func_7()].f_681.f_10, iParam0);
}
...
BOOL _STAT_GET_PACKED_BOOL(int iParam0, int iParam1) // Position - 0x1091
{
	if (iParam1 == -1)
		iParam1 = func_10();
...
int func_46() // Position - 0x17CC
{
	...
	while (i < 2)
	{
		if (Global_23013[i].f_8 == 0 || Global_23013[i].f_8 == 1)
			if (!func_47(Global_23013[i].f_2, Global_23013[Global_22843].f_2))
				Global_22843 = i;
