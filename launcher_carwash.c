...
void main() // Position - 0x0
{
	...
	if (Global_2883694)
	{
		if (SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(-949873222) == 0)
		{
			...
			SYSTEM::START_NEW_SCRIPT_WITH_NAME_HASH_AND_ARGS(-949873222, &uScriptParam_118, 23, DEFAULT);
		}
	...
	while (true)
	{
		...
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
		{
			...
			flag = func_61(vehiclePedIsIn) || func_60(vehiclePedIsIn);
	...
	switch (uParam1->f_13)
	{
		case 0:
			...
			if (func_46(uParam1->f_16))
			{
				for (i = 0; i < *uParam0; i = i + 1)
				{
					if (func_43(&uParam0->[i]) && uParam0->[i])
					{
						uParam1->f_12 = i;
						...
						if (uParam0->[i].f_7 || MISC::GET_MISSION_FLAG() && uParam1->f_16 == 0)
							...
							func_42(uParam1, 2);
						else if (func_30() < uParam0->[uParam1->f_12].f_9)
							func_42(uParam1, 1);
						else if (func_25())
							func_42(uParam1, 7);
						else
		...
		case 2:
			...
			if (func_18(&uParam0->[uParam1->f_12]) || uParam0->[i].f_8 == 0)
			{
				func_42(uParam1, 0);
				return false;
			}
		...
		case 1:
			if (!uParam1->f_9)
				func_13(uParam1, uParam1->f_2, uParam0->[uParam1->f_12].f_9);
		
			if (func_18(&uParam0->[uParam1->f_12]) || func_30() >= uParam0->[uParam1->f_12].f_9)
			{
				func_42(uParam1, 0);
				return false;
			}
		...
		case 6:
			...
			if (func_18(&uParam0->[uParam1->f_12]) || !func_46(uParam1->f_16))
			{
				func_42(uParam1, 0);
				return false;
			}
		...
		case 3:
			...
			if (func_18(&uParam0->[uParam1->f_12]) || bParam2 == false || !func_46(uParam1->f_16))
			{
				func_42(uParam1, 0);
				return false;
			}
		...
		case 8:
			...
			if (func_18(&uParam0->[uParam1->f_12]) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) == 0)
			{
				func_42(uParam1, 0);
				return false;
			}
		...
		case 9:
			...
			if (func_18(&uParam0->[uParam1->f_12]) || func_9(&uParam0->[uParam1->f_12]))
			{
				func_42(uParam1, 0);
				return false;
			}
		...
		case 4:
			...
			if (func_30() < uParam0->[uParam1->f_12].f_9)
			{
				func_42(uParam1, 1);
				return false;
			}
			...
			if (!uParam1->f_9)
				func_13(uParam1, *uParam1, uParam0->[uParam1->f_12].f_9);
			...
			if (PAD::IS_CONTROL_JUST_PRESSED(FRONTEND_CONTROL, INPUT_CONTEXT) && uParam1->f_9 == 1)
				if (!func_9(&uParam0->[uParam1->f_12]))
					func_42(uParam1, 9);
				else
					func_42(uParam1, 5);
			break;
...
struct<8> func_19(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, float fParam8) // Position - 0xE4B
{
	...
	unk = 2;
	unk9 = { func_20(uParam0[1] - uParam0[0]) * { fParam8, fParam8, fParam8 } };
...
void func_33() // Position - 0x118A
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (_GET_CHARACTER_MODEL(G_MissionStats.f_2366.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_34(character) && !func_6(14) || Global_112760)
			{
...
BOOL func_41(Player plParam0) // Position - 0x1378
{
	Player player;
...
BOOL func_46(int iParam0) // Position - 0x14A5
{
	if (iParam0 == 0)
		if (func_52())
			return false;
...
BOOL func_47(Player plParam0) // Position - 0x1511
{
	if (func_50(plParam0))
		return true;
...
BOOL func_48(Player plParam0) // Position - 0x1534
{
	Player player;
...
BOOL func_49(Player plParam0, int iParam1) // Position - 0x1552
{
	return IS_BIT_SET(Global_1895156[plParam0].f_10.f_4, iParam1);
}

BOOL func_50(Player plParam0) // Position - 0x156A
{
	Player player;
...
BOOL func_51(int iParam0) // Position - 0x158D
{
	if (iParam0 == 1)
...
void func_54(var uParam0, var uParam1, var uParam2, var uParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8) // Position - 0x162E
{
	int i;
	float num;
	float num2;
...
{
	func_56(uParam0->[0], uParam0->[1], uParam0->f_7, iParam1, iParam2, iParam3, iParam4);
	return;
}

void func_56(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, int iParam7, int iParam8, int iParam9, int iParam10) // Position - 0x1709
{
	var unk;
	var unk2;
	float unk3;
...
Vector3 func_57(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5) // Position - 0x1919
{
...
void func_58(int iParam0) // Position - 0x1952
{
	...
	if (!func_43(&iLocal_38[iParam0]))
	{
		iLocal_38[iParam0].f_8 = 0;
	...
	if (uLocal_115[iParam0] == 0)
	{
		if (MISC::GET_GAME_TIMER() > uLocal_112[iParam0])
			uLocal_115[iParam0] = SHAPETEST::START_SHAPE_TEST_SWEPT_SPHERE(uLocal_105[iParam0], uLocal_105[iParam0] + { 1f, 0f, 0f }, 2f, 2, PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false), 4);
	}
	else
	{
...
int func_60(Vehicle veParam0) // Position - 0x1A50
{
...
int func_61(Vehicle veParam0) // Position - 0x1ABB
{
	var minimum;
	float unk;
...
BOOL func_62(Vehicle veParam0) // Position - 0x1C4C
{
	Hash entityModel;
...
BOOL func_63(Hash hParam0) // Position - 0x1E73
{
...
BOOL func_64(Vehicle veParam0, BOOL bParam1) // Position - 0x209C
{
	if (Global_78689)
...
float func_65(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x20EA
{
...
{
	func_72(&iLocal_38[0], 1, "Carwash1", func_73(156), 15, "", 0, 4f);
	func_72(&iLocal_38[1], 1, "Carwash2", func_73(157), 15, "", 0, 4f);
	func_70(&iLocal_38[0], -1f, 0f, 0f, 360f);
	func_70(&iLocal_38[1], 0f, -1f, 0f, 360f);
	func_67(&uLocal_87, 0);
	uLocal_105[0] = { 47.6f, -1392f, 29.4f };
	uLocal_105[1] = { -700f, -925.3f, 19f };
	return;
}
...
BOOL IS_XBOX_PLATFORM() // Position - 0x2247
{
	return MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION();
}

BOOL IS_PLAYSTATION_PLATFORM() // Position - 0x225D
{
	return MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION();
}

void func_70(var uParam0, float fParam1, float fParam2, float fParam3, float fParam4) // Position - 0x2273
{
...
void func_72(var uParam0, int iParam1, char* sParam2, var uParam3, var uParam4, var uParam5, int iParam6, char* sParam7, int iParam8, float fParam9) // Position - 0x22C3
{
	uParam0->f_5 = sParam2;
	uParam0->f_1 = { uParam3 };
	uParam0->f_4 = sParam7;
...
BOOL func_74(Vehicle veParam0) // Position - 0x2350
{
	if (!ENTITY::DOES_ENTITY_EXIST(veParam0))
		return false;
