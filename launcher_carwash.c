...
void main() // Position - 0x0
{
	...
	fLocal_35 = 180f;
	iLocal_38 = 3;
	unk = Vector3(uScriptParam_120.f_1[0]);
	...
	if (Global_2883694)
	{
		if (SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(-949873222) == 0)
		{
			...
			SYSTEM::START_NEW_SCRIPT_WITH_NAME_HASH_AND_ARGS(-949873222, &uScriptParam_120, 23, DEFAULT);
		}
	...
	switch (uParam1->f_13)
	{
		case 0:
			...
			if (func_45(uParam1->f_16))
			{
				for (i = 0; i < *uParam0; i = i + 1)
				{
					if (func_42(&uParam0->[i]) && uParam0->[i])
					{
						uParam1->f_12 = i;
		...
		case 6:
			...
			if (func_18(&uParam0->[uParam1->f_12]) || !func_45(uParam1->f_16))
			{
				func_41(uParam1, 0);
				return false;
			}
		...
		case 3:
			...
			if (func_18(&uParam0->[uParam1->f_12]) || bParam2 == false || !func_45(uParam1->f_16))
			{
				func_41(uParam1, 0);
				return false;
			}
...
BOOL func_18(var uParam0) // Position - 0xDA7
{
	...
	unk = Vector3(func_19(uParam0->f_16, 2f));
...
void func_55(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, int iParam7, int iParam8, int iParam9, int iParam10) // Position - 0x16EA
{
	...
	unk = Vector3(func_20(uParam3 - uParam0));
	unk4 = Vector3(func_56(unk, 0f, 0f, 1f));
	num = fParam6 / 2f;
	unk13 = 8;
...
void func_57(int iParam0) // Position - 0x1933
{
	...
	if (!func_42(&iLocal_40[iParam0]))
	{
		iLocal_40[iParam0].f_8 = 0;
	...
	if (uLocal_117[iParam0] == 0)
	{
		if (MISC::GET_GAME_TIMER() > uLocal_114[iParam0])
			uLocal_117[iParam0] = SHAPETEST::START_SHAPE_TEST_SWEPT_SPHERE(uLocal_107[iParam0], uLocal_107[iParam0] + Vector3(1f, 0f, 0f), 2f, 2, PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false), 4);
	}
	else
	{
...
{
	func_71(&iLocal_40[0], 1, "Carwash1", func_72(156), 15, "", 0, 4f);
	func_71(&iLocal_40[1], 1, "Carwash2", func_72(157), 15, "", 0, 4f);
	func_69(&iLocal_40[0], -1f, 0f, 0f, 360f);
	func_69(&iLocal_40[1], 0f, -1f, 0f, 360f);
	func_66(&uLocal_89, 0);
	uLocal_107[0] = Vector3(47.6f, -1392f, 29.4f);
	uLocal_107[1] = Vector3(-700f, -925.3f, 19f);
	return;
}
...
BOOL IS_XBOX_PLATFORM() // Position - 0x221C
{
	return MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION();
}

BOOL IS_PLAYSTATION_PLATFORM() // Position - 0x2232
{
