		...
		if (iLocal_287 != -1)
		{
			if (!func_230())
			{
				*panParam0 = func_229(iLocal_287);
				...
				MISC::SET_BIT(&G_MissionStats.f_18577[*panParam0], 0);
				MISC::SET_BIT(&G_MissionStats.f_18577[*panParam0], 2);
				MISC::CLEAR_BIT(&G_MissionStats.f_18577[*panParam0], 3);
				Global_112897[*panParam0].f_1 = 0;
			
				if (!_IS_MISSION_REPEAT_ACTIVE(false))
					Global_112897[*panParam0].f_3 = 0;
...
void func_28(var uParam0, char* sParam1, int iParam2, char* sParam3, int iParam4, Ped pedParam5) // Position - 0x1A5F
{
	...
	*uParam0 = _GET_CURRENT_PLAYER_CHARACTER_0();
	...
	for (j = CHAR_MICHAEL; j < CHAR_MULTIPLAYER; j = j + 1)
	{
		...
		{
			func_51(PLAYER::PLAYER_PED_ID(), &uParam0->f_616[j], 1, -1);
		}
		else
		{
			for (i = 0; i < 12; i = i + 1)
...
void func_63(Ped pedParam0, BOOL bParam1) // Position - 0x42C4
{
	...
	if (func_39(character) && !PED::IS_PED_INJURED(pedParam0))
	{
		if (pedParam0 == PLAYER::PLAYER_PED_ID())
		{
			func_64(pedParam0, &G_MissionStats.f_2366.f_539.f_298[character]);
...
BOOL func_173(Vehicle veParam0, Ped pedParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xC318
{
	...
	flag = func_174(&iLocal_35[num], pedBoneCoords, pedParam1, &(iLocal_35[num].f_3), veParam0, iParam5);
...
BOOL func_213(int iParam0) // Position - 0xD442
{
	...
	num = func_215(&(Global_112897[iParam0].f_9), 1, 4, false, 0);
...
BOOL func_220(int iParam0) // Position - 0xD73E
{
	...
	if (Global_112897[iParam0].f_3 == true)
		return false;
...
int func_236(float fParam0) // Position - 0xDC7C
{
	...
	for (i = 0; i < 5; i = i + 1)
	{
		vector = { Global_32663[iLocal_285 + i][0] };
...
BOOL func_259(Any* panParam0, int iParam1) // Position - 0xEF6F
{
	switch (panParam0->f_16)
	{
		...
		case 3:
			if (MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), panParam0->f_17[0], true) < panParam0->f_15)
			{
				if (func_264(2))
				{
					if (func_263(panParam0->f_27))
		...
		case 4:
			if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), panParam0->f_17[0], panParam0->f_17[1], false, true, 0))
			{
				if (func_264(2))
				{
					if (func_263(panParam0->f_27))
		...
		case 5:
			...
			if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), panParam0->f_17[0], panParam0->f_17[1], panParam0->f_24, false, true, 0))
			{
				if (*panParam0 == 45)
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_232() || Global_112857 || Global_32286 || func_270() || func_251(8, -1) || func_103() || func_269() || func_268() || func_267() || G_MissionStats.f_7691.f_919[character] == 5)
							return false;
						break;
				
					case 1:
						if (PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_232() || Global_32286 || func_270() || func_251(8, -1) || func_268() || func_103() || func_269() || func_267() || G_MissionStats.f_7691.f_919[character] == 5)
							return false;
						break;
				
					case 2:
						if (!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_232() || Global_112857 || Global_32286 || func_270() || func_251(8, -1) || func_268() || func_103() || func_269() || func_267() || G_MissionStats.f_7691.f_919[character] == 5 || Global_43924 != -1)
							return false;
						break;
				
					case 3:
						if (PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_232() || Global_112857 || Global_32286 || func_270() || func_251(8, -1) || func_103() || func_269() || func_267() || G_MissionStats.f_7691.f_919[character] == 5)
							return false;
						break;
				
					case 4:
						if (func_232() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0 || func_251(8, -1) || func_267() || func_266() || G_MissionStats.f_7691.f_919[character] == 5)
							return false;
						break;
...
{
	return Global_112897[iParam0].f_1;
}
...
{
	return G_MissionStats.f_19150[echParam1].f_3[iParam0].f_3;
}
