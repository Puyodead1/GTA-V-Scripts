...
BOOL func_14(Player plParam0, int iParam1) // Position - 0x3C2
{
	if (func_15(plParam0, false))
		return func_16(Global_1894573[plParam0].f_10.f_33) == iParam1;
...
int _MPCHAR_STAT_GET_INT(eMPStat empsParam0, int iParam1, int iParam2) // Position - 0x11CC
{
	...
	{
		iParam2 == 0;
		statHash = Global_2805029[empsParam0][func_53(iParam1)];
...
{
	if (plParam0 != -1)
		return Global_1981514[plParam0].f_27.f_4;
	...
	if (IS_BIT_SET(iLocal_131, 4))
	{
		if (GRAPHICS::IS_SCALEFORM_MOVIE_METHOD_RETURN_VALUE_READY(iLocal_153))
		{
			...
			switch (scaleformMovieMethodReturnValueInt)
			{
				...
				case 216:
					func_315();
					MISC::SET_BIT(&(Global_2657589[PLAYER::PLAYER_ID()].f_321.f_1), 22);
					func_326(3);
					break;
...
BOOL func_75(int iParam0) // Position - 0x1859
{
	...
	else
	{
		...
		func_84(&(Global_2683864.f_781), 0, 0, unk11, &unk8, unk11, true, false, &unk8, &num3, num3, false, address);
		func_76(false, 0);
...
void func_84(var uParam0, int iParam1, int iParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, BOOL bParam10, BOOL bParam11, var uParam12, var uParam13, int iParam14, BOOL bParam15, int iParam16) // Position - 0x1AA7
{
	...
	if (func_144(iParam1))
	{
		*uParam6 = Vector3(func_143(iParam1, iParam2));
		finalRenderedCamRot = Vector3(func_142(iParam1, iParam2));
	...
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		if (_IS_NULL_VECTOR(entityCoords))
		{
			if (_NETWORK_IS_PLAYER_IN_SCTV(PLAYER::PLAYER_ID(), 0))
			{
				...
				{
					entityCoords = Vector3(ENTITY::GET_ENTITY_COORDS(func_137(), true));
					finalRenderedCamRot = Vector3(0f, 0f, ENTITY::GET_ENTITY_HEADING(func_137()));
				
					if (func_136(Global_1853910[PLAYER::PLAYER_ID()].f_802, true, false))
					{
	...
	else if (IS_BIT_SET(iParam16, 5))
	{
		...
		entityCoords = Vector3(OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(func_125(num), func_124(num), 3.5688f, 7.9792f, 4.1641f));
		finalRenderedCamRot = Vector3(-21.6791f, 0f, func_124(num) + 40.237f);
	...
	{
		func_108();
		func_107(&unk5, 144, Global_1853910[PLAYER::PLAYER_ID()].f_267.f_33);
	
		if (!_IS_NULL_VECTOR(unk5))
			entityCoords = Vector3(unk5);
	
		func_101(&unk5, 144, Global_1853910[PLAYER::PLAYER_ID()].f_267.f_33);
...
void func_102(int iParam0, int iParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x2778
{
	...
	unk = 2;
	unk[0] = Vector3(func_106(uParam3, bParam4));
	unk[1] = Vector3(func_106(iParam0, bParam4));
	*uParam2 = Vector3(func_104(iParam1, uParam3));
	vector = Vector3(*uParam2 - unk[0]);
	vector = Vector3(func_103(vector, -unk[0].f_3.f_2));
	vector = Vector3(func_103(vector, unk[1].f_3.f_2));
	...
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2657589[plParam0].f_321.f_7 != -1 && Global_2657589[plParam0].f_321.f_10 != _INVALID_PLAYER_INDEX())
				return func_132(Global_2657589[plParam0].f_321.f_7) == 25;
	...
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2657589[plParam0].f_321.f_7 != -1)
				return func_132(Global_2657589[plParam0].f_321.f_7) == 6;
...
BOOL func_135(Player plParam0) // Position - 0x5513
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2657589[plParam0].f_321.f_7 != -1 && Global_2657589[plParam0].f_321.f_10 != _INVALID_PLAYER_INDEX())
				return func_132(Global_2657589[plParam0].f_321.f_7) == 5;
...
BOOL IS_PLAYSTATION_PLATFORM() // Position - 0x5EB6
{
	return MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION();
}

BOOL IS_XBOX_PLATFORM() // Position - 0x5ECC
{
...
{
	MISC::SET_BIT(&(Global_1890444[PLAYER::PLAYER_ID()].f_29), 29);
	return;
}
...
Vector3 func_201(Player plParam0) // Position - 0x6884
{
	...
	if (HUD::DOES_BLIP_EXIST(Global_2646729[plParam0]))
		vector = Vector3(func_259(Global_2646729[plParam0]));
	else if (HUD::DOES_BLIP_EXIST(Global_2646729.f_33[plParam0]) && !(plParam0 == Global_2672505))
		vector = Vector3(func_259(Global_2646729.f_33[plParam0]));
...
Vector3 func_202(Player plParam0) // Position - 0x68F8
{
	...
	if (Global_2644534)
	{
		...
		{
			vector = Vector3(func_257(plParam0));
	...
	{
		vector = Vector3(func_255(func_256(Global_1853910[PLAYER::PLAYER_ID()].f_267.f_33)));
	...
	else
	{
		...
		if (num > 0)
		{
			vector = Vector3(func_255(func_256(num)));
	...
	{
		vector = Vector3(func_205(plParam0));
...
Vector3 func_205(Player plParam0) // Position - 0x6B30
{
		...
		if (player != _INVALID_PLAYER_INDEX())
		{
			if (!func_249(player))
			{
				if (ENTITY::DOES_ENTITY_EXIST(Global_2672505.f_254[player][1]))
					...
					return Global_2657589[func_250(plParam0)].f_321.f_12;
			}
			else
			{
				num = func_246(player);
		...
		if (player5 != _INVALID_PLAYER_INDEX())
		{
			if (!func_232(player5))
			{
				if (ENTITY::DOES_ENTITY_EXIST(Global_2672505.f_351[player5]))
					...
					return Global_2657589[func_233(plParam0)].f_321.f_20;
			}
			else
			{
		...
		if (player8 != _INVALID_PLAYER_INDEX())
		{
			if (!func_215(player8))
			{
				if (ENTITY::DOES_ENTITY_EXIST(Global_2672505.f_384[player8]))
					...
					return Global_1894573[func_216(plParam0)].f_590;
			}
			else
			{
	...
	if (func_230(plParam0))
		return func_224(Global_2657589[plParam0].f_321.f_7);
...
{
	if (func_210(plParam0) || func_209(plParam0) || func_208(plParam0) || _IS_PLAYER_IN_MUSIC_LOCKER(plParam0))
		return true;

	return false;
}

BOOL _IS_PLAYER_IN_MUSIC_LOCKER(Player plParam0) // Position - 0x7059
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2657589[plParam0].f_321.f_7 != -1)
				return func_132(Global_2657589[plParam0].f_321.f_7) == 19;
...
BOOL func_208(Player plParam0) // Position - 0x70A0
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2657589[plParam0].f_321.f_7 != -1)
				return func_132(Global_2657589[plParam0].f_321.f_7) == 15;
...
BOOL func_209(Player plParam0) // Position - 0x70E7
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2657589[plParam0].f_321.f_7 != -1)
				return func_132(Global_2657589[plParam0].f_321.f_7) == 16;
...
BOOL func_210(Player plParam0) // Position - 0x712E
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2657589[plParam0].f_321.f_7 != -1)
				return func_132(Global_2657589[plParam0].f_321.f_7) == 14;
...
BOOL func_213(Player plParam0) // Position - 0x7273
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2657589[plParam0].f_321.f_7 != -1)
				return func_132(Global_2657589[plParam0].f_321.f_7) == 20;
...
BOOL func_214(Player plParam0) // Position - 0x730A
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2657589[plParam0].f_321.f_7 != -1)
				return func_132(Global_2657589[plParam0].f_321.f_7) == 13;
...
BOOL func_217(Player plParam0, BOOL bParam1) // Position - 0x739A
{
	...
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2657589[plParam0].f_321.f_7 != -1 && Global_2657589[plParam0].f_321.f_10 != _INVALID_PLAYER_INDEX())
				return func_132(Global_2657589[plParam0].f_321.f_7) == 12;
...
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (func_223(plParam0) && Global_2657589[plParam0].f_321.f_10 == plParam0)
			return true;
...
BOOL func_223(Player plParam0) // Position - 0x7551
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2657589[plParam0].f_321.f_7 != -1)
				return func_132(Global_2657589[plParam0].f_321.f_7) == 11;
...
BOOL func_231(Player plParam0) // Position - 0x7811
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2657589[plParam0].f_321.f_7 != -1)
				return func_132(Global_2657589[plParam0].f_321.f_7) == 10;
...
BOOL func_234(Player plParam0) // Position - 0x78A1
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2657589[plParam0].f_321.f_7 != -1 && Global_2657589[plParam0].f_321.f_10 != _INVALID_PLAYER_INDEX())
				return func_132(Global_2657589[plParam0].f_321.f_7) == 8;
...
BOOL func_240(Player plParam0) // Position - 0x7A2E
{
	...
	if (func_241(plParam0) && Global_2657589[plParam0].f_321.f_10 == plParam0)
		return true;
...
BOOL func_241(Player plParam0) // Position - 0x7A67
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2657589[plParam0].f_321.f_7 != -1)
				return func_132(Global_2657589[plParam0].f_321.f_7) == 9;
...
BOOL func_242(Player plParam0) // Position - 0x7AAE
{
	...
	if (func_243(plParam0) && Global_2657589[plParam0].f_321.f_10 == plParam0)
		return true;
...
BOOL func_243(Player plParam0) // Position - 0x7AE7
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2657589[plParam0].f_321.f_7 != -1)
				return func_132(Global_2657589[plParam0].f_321.f_7) == 4;
...
Hash func_261(int iParam0) // Position - 0x920D
{
	switch (iParam0)
	{
		case 0:
...
{
	if (plParam0 != -1)
		return IS_BIT_SET(Global_1981514[plParam0].f_27, 5);
...
{
	if (plParam0 != -1)
		return IS_BIT_SET(Global_1981514[plParam0].f_27, 1);
...
{
	if (plParam0 != -1)
		if (NETWORK::GET_CLOUD_TIME_AS_INT() < Global_1981514[plParam0].f_27.f_5)
			return 1;
...
BOOL _STAT_GET_PACKED_BOOL(int iParam0, int iParam1) // Position - 0x9A5B
{
	if (iParam1 == -1)
		iParam1 = func_11();
...
{
	if (plParam0 != -1)
		return IS_BIT_SET(Global_1981514[plParam0].f_27, 0);
...
{
	if (plParam0 != -1)
		return IS_BIT_SET(Global_1981514[plParam0].f_27, 4);
...
int func_295(Player plParam0, int iParam1) // Position - 0x9B90
{
	if (plParam0 != -1)
		if (iParam1 >= 0 && iParam1 < 3)
			return Global_1981514[plParam0].f_27.f_17[iParam1];
...
{
	if (plParam0 != -1)
		return Global_1981514[plParam0].f_27.f_16;
...
{
	if (plParam0 != -1)
		return Global_1981514[plParam0].f_27.f_9[iParam1];
...
int func_305(Player plParam0, int iParam1) // Position - 0x9EAA
{
	if (plParam0 != -1)
		if (iParam1 >= 0 && iParam1 < 3)
			return Global_1981514[plParam0].f_27.f_17[iParam1].f_1;
...
int func_306(int iParam0) // Position - 0x9EE4
{
	if (iParam0 >= 0 && iParam0 < 3)
		return Global_1981423.f_20[iParam0].f_2;
...
void func_316() // Position - 0xA2EE
{
	...
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_152, methodName);
	GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
	func_267(0);
...
void _MPCHAR_STAT_SET_INT(eMPStat empsParam0, int iParam1, int iParam2, BOOL bParam3, BOOL bParam4) // Position - 0xA4E7
{
	...
	bParam4;
	statName = Global_2805029[empsParam0][func_53(iParam2)];
...
void func_364() // Position - 0xB2B7
{
	...
	if (!IS_BIT_SET(iLocal_131, 8) && !_CONVERSATION_IS_DIALOGUE_IN_PROGRESS())
	{
		...
		else if (func_28() == 1 && func_286() && !(func_374(319, -1) && _STAT_GET_PACKED_BOOL(32312, -1)))
		{
			if (func_290(false) && func_288(false))
			{
				if (func_282(false))
...
{
	if (func_374(316, -1) && func_374(317, -1) && func_374(318, -1) && func_374(319, -1) && func_374(320, -1) && func_374(321, -1) && func_374(322, -1) && func_374(323, -1) && func_374(324, -1) && func_374(325, -1) && func_374(326, -1) && func_374(327, -1) && func_374(328, -1) && func_374(329, -1) && _STAT_GET_PACKED_BOOL(32312, -1))
		return true;
...
void _STAT_SET_PACKED_BOOL(int iParam0, BOOL bParam1, int iParam2) // Position - 0xB8D9
{
	if (iParam2 == -1)
		iParam2 = func_11();
...
void func_371(int iParam0, BOOL bParam1, int iParam2, BOOL bParam3) // Position - 0xB8F7
{
	...
	if (func_372())
	{
		statName = Global_2848282[iParam0][func_53(iParam2)];
...
BOOL func_374(int iParam0, int iParam1) // Position - 0xB942
{
	...
	statHash = Global_2848282[iParam0][func_53(iParam1)];
...
void func_419(BOOL bParam0, BOOL bParam1) // Position - 0xC85A
{
	...
	HUD::THEFEED_RESUME();
	func_266();
	MISC::CLEAR_BIT(&(Global_2657589[PLAYER::PLAYER_ID()].f_321.f_1), 22);
	Global_77329 = false;
