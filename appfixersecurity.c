...
void func_102(int iParam0, int iParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0x2778
{
	...
	unk = 2;
	unk[0] = { func_106(uParam3, bParam4) };
	unk[1] = { func_106(iParam0, bParam4) };
	*uParam2 = { func_104(iParam1, uParam3) };
	vector = { *uParam2 - unk[0] };
	vector = { func_103(vector, -unk[0].f_3.f_2) };
	vector = { func_103(vector, unk[1].f_3.f_2) };
...
Vector3 func_202(Player plParam0) // Position - 0x68F8
{
	...
	{
		vector = { func_255(func_256(Global_1853910[PLAYER::PLAYER_ID()].f_267.f_33)) };
