...
void main() // Position - 0x0
{
	...
	iLocal_43 = 64;
	fLocal_47 = -1f;
	uLocal_107 = Vector3(154.92f, 6841.12f, 19.14f);
	iLocal_125 = 200;
	uLocal_139 = Vector3(-1161.1992f, 934.5912f, 196.7591f);
	uLocal_142 = Vector3(-1034.6f, 4918.6f, 205.9f);
	...
	if (func_170(uScriptParam_344.f_1[0], -1, 0, false, false))
		func_167(-1);
	else
								...
								if (!func_133(iLocal_54[0], &iLocal_128, &uLocal_127, iLocal_126, bLocal_129, 7f, 0) && !func_133(iLocal_54[1], &iLocal_128, &uLocal_127, iLocal_126, bLocal_129, 7f, 0) && !func_132())
								{
									switch (iLocal_50)
									{
										case 0:
											...
											{
												if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 281.9148f, 6816.3447f, 4.3197f, 48.3924f, 6885.9214f, 43.0037f, 226.5f, false, true, 0) || ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), uLocal_88 - Vector3(0f, 0f, 7f), 20f, 15f, 50f, false, true, 0))
												{
													func_128();
...
BOOL func_54(char* sParam0) // Position - 0x341D
{
	...
	if (_CONVERSATION_IS_DIALOGUE_IN_PROGRESS())
	{
		TEXT_LABEL_COPY(&string2, Vector3(func_55()), 4);
...
BOOL func_56(char* sParam0) // Position - 0x3469
{
	...
	if (_CONVERSATION_IS_DIALOGUE_IN_PROGRESS())
	{
		TEXT_LABEL_COPY(&string2, Vector3(func_57()), 4);
...
void func_87(BOOL bParam0) // Position - 0x44D3
{
	...
	{
		uLocal_156 = Vector3(func_55());
		uLocal_150 = Vector3(func_57());
		func_88();
		bLocal_149 = true;
	}
			...
			if (func_49(true, false, true))
			{
				...
				if (!bLocal_115)
				{
					...
					if (ENTITY::DOES_ENTITY_EXIST(PLAYER::GET_PLAYERS_LAST_VEHICLE()))
					{
						...
						{
							ENTITY::SET_ENTITY_COORDS(PLAYER::GET_PLAYERS_LAST_VEHICLE(), ENTITY::GET_ENTITY_COORDS(pedLocal_53, true) - Vector3(0f, 3f, 5f), false, false, false, true);
					...
					if (!PED::IS_PED_INJURED(pedLocal_53))
					{
						...
						if (!ENTITY::IS_ENTITY_DEAD(veLocal_169, false))
						{
							...
							ENTITY::SET_ENTITY_COORDS(veLocal_169, ENTITY::GET_ENTITY_COORDS(pedLocal_53, true) + Vector3(0f, 5f, 5f), true, false, false, true);
						}
					}
...
BOOL func_132() // Position - 0x6A7C
{
	if (!bLocal_129)
	{
		...
		if (!bLocal_75)
		{
			if (!PED::IS_PED_INJURED(iLocal_54[0]) && !PED::IS_PED_INJURED(iLocal_54[1]))
			{
				if (PED::CAN_PED_SEE_HATED_PED(iLocal_54[0], PLAYER::PLAYER_PED_ID()) || PED::CAN_PED_SEE_HATED_PED(iLocal_54[1], PLAYER::PLAYER_PED_ID()) || PLAYER::CAN_PED_HEAR_PLAYER(PLAYER::PLAYER_ID(), iLocal_54[0]) || PLAYER::CAN_PED_HEAR_PLAYER(PLAYER::PLAYER_ID(), iLocal_54[1]) || ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), uLocal_88 - Vector3(0f, 0f, 7f), 20f, 15f, 35f, false, true, 0))
				{
					if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), uLocal_88 - Vector3(0f, 0f, 7f), 28f, 18f, 35f, false, true, 0))
					{
						iLocal_51 = 1;
						return true;
					}
	...
	if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false))
	{
		if (!ENTITY::IS_ENTITY_DEAD(pedParam0, false) && !bParam4)
		{
			...
			if (!IS_BIT_SET(iParam3, 1))
			{
				...
				if (MISC::IS_PROJECTILE_IN_AREA(entityCoords2 - Vector3(fParam5 / 2f, fParam5 / 2f, fParam5 / 2f), entityCoords2 + Vector3(fParam5 / 2f, fParam5 / 2f, fParam5 / 2f), false))
				{
					func_138("FUNC BOOL HAS_PLAYER_AGGROED_PED\\n");
					func_138("	aggroReason = EAggro_ShotNear\\n");
					*uParam1 = 1;
...
void func_140() // Position - 0x720B
{
	...
	func_142(43, true);
	func_142(44, true);
	PED::ADD_SCENARIO_BLOCKING_AREA(uLocal_139 - Vector3(20f, 40f, 40f), uLocal_139 + Vector3(20f, 40f, 40f), false, true, true, true);
	PED::ADD_SCENARIO_BLOCKING_AREA(uLocal_78 - Vector3(20f, 50f, 60f), uLocal_78 + Vector3(20f, 50f, 50f), false, true, true, true);
	...
	for (iLocal_64 = 0; iLocal_64 <= 1; iLocal_64 = iLocal_64 + 1)
	{
		iLocal_54[iLocal_64] = PED::CREATE_PED(PED_TYPE_MISSION, hLocal_103, uLocal_81[iLocal_64], uLocal_98[iLocal_64], true, true);
	...
	uLocal_61[1] = OBJECT::CREATE_OBJECT(joaat("p_arm_bind_cut_s"), uLocal_107 + Vector3(1f, 1f, 1f), true, true, false);
	...
	vector = Vector3(uLocal_78);
	vector2 = Vector3(-2f, -4f, 18f);
...
void _MPCHAR_STAT_SET_INT(eMPStat empsParam0, int iParam1, int iParam2, BOOL bParam3, BOOL bParam4) // Position - 0x7860
{
	...
	bParam4;
	statName = Global_2805029[empsParam0][func_145(iParam2)];
...
int _MPCHAR_STAT_GET_INT(eMPStat empsParam0, int iParam1, int iParam2) // Position - 0x78C4
{
	...
	{
		iParam2 == 0;
		statHash = Global_2805029[empsParam0][func_145(iParam1)];
...
void func_152() // Position - 0x7EF1
{
	...
	uLocal_78 = Vector3(163.4486f, 6839.993f, 18.86f);
	fLocal_97 = 0f;
	uLocal_81[0] = Vector3(162.8193f, 6837.257f, 18.9614f);
	uLocal_98[0] = 297.0056f;
	uLocal_81[1] = Vector3(162.5046f, 6841.6797f, 18.8426f);
	uLocal_98[1] = 193.3866f;
	uLocal_88 = Vector3(169.3462f, 6837.8047f, 19.1421f);
	fLocal_101 = 265.6862f;
	uLocal_91 = Vector3(164.08965f, 6836.923f, 19.03899f);
	uLocal_94 = Vector3(168.9638f, 6834.3022f, 24.99057f);
	bLocal_66 = true;
	return;
}
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_204() || Global_112695 || Global_32166 || func_203() || func_84(8, -1) || func_202() || func_201() || func_200() || func_199() || G_SomeGlobalState.MessageCallStates.f_919[character] == 5)
							return false;
						break;
				
					case 1:
						if (PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_204() || Global_32166 || func_203() || func_84(8, -1) || func_200() || func_202() || func_201() || func_199() || G_SomeGlobalState.MessageCallStates.f_919[character] == 5)
							return false;
						break;
				
					case 2:
						if (!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_204() || Global_112695 || Global_32166 || func_203() || func_84(8, -1) || func_200() || func_202() || func_201() || func_199() || G_SomeGlobalState.MessageCallStates.f_919[character] == 5 || LastDispatchedMessageOrCall != -1)
							return false;
						break;
				
					case 3:
						if (PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_204() || Global_112695 || Global_32166 || func_203() || func_84(8, -1) || func_202() || func_201() || func_199() || G_SomeGlobalState.MessageCallStates.f_919[character] == 5)
							return false;
						break;
				
					case 4:
						if (func_204() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0 || func_84(8, -1) || func_199() || func_198() || G_SomeGlobalState.MessageCallStates.f_919[character] == 5)
							return false;
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
							if (PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0 || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || func_204() || Global_32166 || func_203() || func_84(8, -1) || func_201() || func_200() || func_199() || G_SomeGlobalState.MessageCallStates.f_919[character] == 5)
								return false;
						break;
				
					case 7:
						if (PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || !CAM::IS_SCREEN_FADED_IN() || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_204() || func_201() || Global_112695 || Global_32166 || func_203() || Global_44446 || func_84(8, -1) || func_200() || func_198() || func_199() || G_SomeGlobalState.MessageCallStates.f_919[character] == 5)
							return false;
						break;
