...
void main() // Position - 0x0
{
	...
	iLocal_171 = 3;
	uLocal_124 = { uScriptParam_172.f_1[0] };

	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(11))
	{
		if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_88[0]))
			VEHICLE::SET_VEHICLE_DOORS_LOCKED(uLocal_88[0], 2);
...
void func_2() // Position - 0x1F1
{
	func_59(64, true);
	func_59(65, true);
	func_32(uLocal_88[0], _CHAR_NULL);
	func_6(-1, 0);
	func_3();
	func_202(true, false);
	return;
...
void func_9() // Position - 0x498
{
	...
	if (value > 0f && SYSTEM::FLOOR(value) < SYSTEM::FLOOR(G_MissionStats.f_10197.f_3853))
		func_11(13, SYSTEM::FLOOR(G_MissionStats.f_10197.f_3853));
...
void func_21() // Position - 0x1112
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (_GET_CHARACTER_MODEL(G_MissionStats.f_2366.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			{
				if (G_MissionStats.f_2366.f_539.f_4321 != character && func_23(G_MissionStats.f_2366.f_539.f_4321))
...
void func_32(Vehicle veParam0, eCharacter echParam1) // Position - 0x159D
{
	...
	func_33(veParam0, &(G_MissionStats.f_32752.f_5510));
	return;
}
...
void func_62() // Position - 0x79F6
{
	...
	var unk5;
	int unk6;
	int offsetFromCoordAndHeadingInWorldCoords;
	...
	switch (iLocal_46)
	{
		...
		case 1:
			switch (iLocal_153)
			{
				...
				case 2:
					if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_88[3]) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_47[0]) && func_97())
					{
						offsetFromEntityGivenWorldCoords = { ENTITY::GET_OFFSET_FROM_ENTITY_GIVEN_WORLD_COORDS(uLocal_88[3], ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true)) };
						...
						{
							if (func_96(ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uLocal_88[3], 0f, 10f, 0f), 1.25f) || func_96(ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uLocal_88[3], 0f, 12.5f, 0f), 1.5f) || func_96(ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uLocal_88[3], 0f, 15f, 0f), 1.75f) || func_96(ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uLocal_88[3], 0f, 17.5f, 0f), 2f) || func_96(ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uLocal_88[3], 0f, 20f, 0f), 2.25f))
							{
								func_91(3, 0, 4, 1);
								iLocal_153 = 4;
							}
					...
					if (!func_156(8) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_88[4]) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_47[1]) && func_97())
					{
						offsetFromEntityGivenWorldCoords = { ENTITY::GET_OFFSET_FROM_ENTITY_GIVEN_WORLD_COORDS(uLocal_88[4], ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true)) };
						...
						{
							if (func_96(ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uLocal_88[4], 0f, 10f, 0f), 1.5f) || func_96(ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uLocal_88[4], 0f, 12.5f, 0f), 1.75f) || func_96(ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uLocal_88[4], 0f, 15f, 0f), 2f) || func_96(ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uLocal_88[4], 0f, 17.5f, 0f), 2.25f) || func_96(ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uLocal_88[4], 0f, 20f, 0f), 2.5f))
							{
								func_91(4, 1, 3, 0);
								iLocal_153 = 4;
							}
					...
					if (!func_156(8) && func_89())
					{
						...
						if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_47[0]))
						{
							PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uLocal_47[0], false);
							TASK::TASK_COMBAT_PED(uLocal_47[0], PLAYER::PLAYER_PED_ID(), 0, 16);
							uLocal_47[0].f_3 = 3;
						}
					
						if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_47[1]))
						{
							PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uLocal_47[1], false);
							TASK::TASK_COMBAT_PED(uLocal_47[1], PLAYER::PLAYER_PED_ID(), 0, 16);
							uLocal_47[1].f_3 = 3;
						}
					
						if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_88[3]))
							VEHICLE::SET_VEHICLE_DOORS_LOCKED(uLocal_88[3], 1);
					
						if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_88[4]))
							VEHICLE::SET_VEHICLE_DOORS_LOCKED(uLocal_88[4], 1);
				...
				case 3:
					if (!_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_47[0]) || HUD::DOES_BLIP_EXIST(uLocal_47[0].f_1) && !_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_47[1]) || HUD::DOES_BLIP_EXIST(uLocal_47[1].f_1))
						iLocal_153 = iLocal_153 + 1;
					break;
				...
				case 8:
					if (!_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_47[0]) && !_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_47[1]))
				...
				case 9:
					if (func_97() || _DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_88[0]) && func_82(PLAYER::PLAYER_PED_ID(), uLocal_88[0], true) <= 35f)
					{
						...
						if (PATHFIND::GET_NTH_CLOSEST_VEHICLE_NODE(entityCoords, randomIntInRange, &outPosition, 1, 5f, 0))
						{
							...
							if (flags & 4 == 0 && !func_81() || flags & 8 == 0 && func_80() || flags & 1 == 0 && !func_79(outPosition, 1084227584))
							{
								...
								{
									func_77(uLocal_88[5], outPosition);
									func_77(uLocal_88[6], offsetFromCoordAndHeadingInWorldCoords);
									func_77(uLocal_88[7], offsetFromCoordAndHeadingInWorldCoords2);
									iLocal_147 = MISC::GET_GAME_TIMER();
								
									for (i = 2; i <= 7; i = i + 1)
									{
										if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_47[i]))
										{
											uLocal_47[i].f_1 = func_74(uLocal_47[i], true, 145);
										
											if (PED::IS_PED_IN_ANY_VEHICLE(uLocal_47[i], false))
											{
												if (_GET_VEHICLE_SEAT_PED_IS_IN(uLocal_47[i], false) == -1)
												{
													HUD::SET_BLIP_SCALE(uLocal_47[i].f_1, 1f);
												}
												else
												{
													HUD::SET_BLIP_ALPHA(uLocal_47[i].f_1, 0);
													HUD::SET_BLIP_HIDDEN_ON_LEGEND(uLocal_47[i].f_1, true);
												}
											}
										}
									}
				...
				case 10:
					if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_47[2]) || _DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_47[3]) || _DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_47[4]) || _DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_47[5]) || _DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_47[6]) || _DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_47[7]))
					{
						if (func_156(7))
						{
							if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_88[5]))
								func_65(5, PED::GET_VEHICLE_PED_IS_USING(PLAYER::PLAYER_PED_ID()), &uLocal_148);
						
							if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_88[6]))
								func_65(6, PED::GET_VEHICLE_PED_IS_USING(PLAYER::PLAYER_PED_ID()), &uLocal_149);
						
							if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_88[7]))
								func_65(7, PED::GET_VEHICLE_PED_IS_USING(PLAYER::PLAYER_PED_ID()), &uLocal_150);
						}
					}
					else if (!_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_47[0]) && !_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_47[1]))
					{
						if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_88[0]))
							iLocal_46 = 2;
						else
...
void func_65(int iParam0, Vehicle veParam1, var uParam2) // Position - 0x82F2
{
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(uLocal_88[iParam0], false))
	{
		if (ENTITY::DOES_ENTITY_EXIST(veParam1) && uLocal_88[iParam0] != veParam1 && !VEHICLE::IS_THIS_MODEL_A_BOAT(ENTITY::GET_ENTITY_MODEL(veParam1)) && !VEHICLE::IS_THIS_MODEL_A_PLANE(ENTITY::GET_ENTITY_MODEL(veParam1)) && !VEHICLE::IS_THIS_MODEL_A_HELI(ENTITY::GET_ENTITY_MODEL(veParam1)) && !VEHICLE::IS_THIS_MODEL_A_TRAIN(ENTITY::GET_ENTITY_MODEL(veParam1)) && func_71(uLocal_88[iParam0]))
		{
			...
			if (!ENTITY::IS_ENTITY_OCCLUDED(uLocal_88[iParam0]))
			{
				*uParam2 = MISC::GET_GAME_TIMER();
			}
			else if (MISC::GET_GAME_TIMER() - *uParam2 > num3 && MISC::GET_GAME_TIMER() - iLocal_147 > 1500 && func_82(uLocal_88[iParam0], veParam1, true) > func_83(veParam1, uLocal_143, true) && func_70(iParam0) && func_83(veParam1, uLocal_143, true) >= num && func_82(uLocal_88[iParam0], veParam1, true) >= num2 && func_69(uLocal_88[iParam0], uLocal_143, 1153138688) && func_68(uLocal_88[iParam0], veParam1, uLocal_143) && !_IS_NULL_VECTOR(uLocal_143) && !CAM::IS_SPHERE_VISIBLE(uLocal_143, 4f) && !func_79(uLocal_143, 1084227584))
			{
				...
				if (iParam0 == 3 || iParam0 == 4)
				{
					VEHICLE::DETACH_VEHICLE_FROM_TRAILER(uLocal_88[iParam0]);
				...
				ENTITY::SET_ENTITY_COORDS(uLocal_88[iParam0], uLocal_143, true, false, false, true);
				VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(uLocal_88[iParam0], 1084227584);
				ENTITY::SET_ENTITY_HEADING(uLocal_88[iParam0], fLocal_146);
				VEHICLE::SET_VEHICLE_ENGINE_ON(uLocal_88[iParam0], true, true, false);
				VEHICLE::SET_VEHICLE_FORWARD_SPEED(uLocal_88[iParam0], ENTITY::GET_ENTITY_SPEED(veParam1) * 1.2f);
				*uParam2 = MISC::GET_GAME_TIMER();
				uLocal_88[iParam0].f_2 = MISC::GET_GAME_TIMER();
				iLocal_147 = MISC::GET_GAME_TIMER();
			}
		}
		else
...
{
	MISC::SET_BIT(&(uLocal_47[iParam0].f_2), iParam1);
	return;
}
...
BOOL func_68(Entity eParam0, Vehicle veParam1, Vector3 vParam2, var uParam3, var uParam4) // Position - 0x85C9
{
	...
	if (eParam0 == uLocal_88[3] && !HUD::DOES_BLIP_EXIST(uLocal_47[0].f_1))
		return true;

	if (eParam0 == uLocal_88[4] && !HUD::DOES_BLIP_EXIST(uLocal_47[1].f_1))
		return true;
...
BOOL func_69(Vehicle veParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0x8660
{
	...
	if (veParam0 == uLocal_88[3] && !HUD::DOES_BLIP_EXIST(uLocal_47[0].f_1))
		return true;

	if (veParam0 == uLocal_88[4] && !HUD::DOES_BLIP_EXIST(uLocal_47[1].f_1))
		return true;
...
BOOL func_70(int iParam0) // Position - 0x86BE
{
	...
	{
		if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_88[i]))
		{
			if ((float)num3 == -1f || MISC::GET_GAME_TIMER() - uLocal_88[i].f_2 > num3)
			{
				num3 = MISC::GET_GAME_TIMER() - uLocal_88[i].f_2;
				num4 = i;
			}
		
			if (num5 == -1f || func_82(uLocal_88[i], PLAYER::PLAYER_PED_ID(), true) > num5)
			{
				num5 = func_82(uLocal_88[i], PLAYER::PLAYER_PED_ID(), true);
				num6 = i;
			}
		}
	}
...
BOOL func_79(Vector3 vParam0, var uParam1, var uParam2, int iParam3) // Position - 0x8A53
{
	...
	for (i = 0; i < 8; i = i + 1)
	{
		if (ENTITY::DOES_ENTITY_EXIST(uLocal_88[i]) && ENTITY::IS_ENTITY_AT_COORD(uLocal_88[i], vParam0, iParam3, iParam3, iParam3, false, true, 0))
			num = 1;
	}
...
int func_84(int iParam0, BOOL bParam1, var uParam2, var uParam3, var uParam4, int iParam5) // Position - 0x8BAC
{
	...
	if (!ENTITY::DOES_ENTITY_EXIST(uLocal_47[iParam0]))
	{
		...
		{
			uLocal_47[iParam0] = PED::CREATE_PED_INSIDE_VEHICLE(ped, PED_TYPE_MISSION, model, seat, true, true);
		}
		else
		{
			uLocal_47[iParam0] = PED::CREATE_PED(PED_TYPE_MISSION, model, vector, heading, true, true);
			ENTITY::SET_ENTITY_COLLISION(uLocal_47[iParam0], toggle6, false);
			ENTITY::SET_ENTITY_COMPLETELY_DISABLE_COLLISION(uLocal_47[iParam0], !flag6, false);
		}
	
		if (flag2)
			ENTITY::SET_ENTITY_COORDS_NO_OFFSET(uLocal_47[iParam0], vector, false, false, true);
	
		if (bParam1)
			if (hash == hLocal_169)
				uLocal_47[iParam0].f_1 = func_74(uLocal_47[iParam0], true, 145);
			else
				uLocal_47[iParam0].f_1 = func_74(uLocal_47[iParam0], false, 145);
	
		WEAPON::SET_PED_DROPS_WEAPONS_WHEN_DEAD(uLocal_47[iParam0], toggle11);
		PED::SET_PED_CONFIG_FLAG(uLocal_47[iParam0], 213, value2);
		PED::SET_PED_CONFIG_FLAG(uLocal_47[iParam0], 212, value3);
		PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uLocal_47[iParam0], toggle);
		PED::SET_PED_KEEP_TASK(uLocal_47[iParam0], toggle2);
		PED::SET_PED_DIES_WHEN_INJURED(uLocal_47[iParam0], toggle3);
		PED::SET_PED_CONFIG_FLAG(uLocal_47[iParam0], 188, value7);
		PED::SET_PED_CONFIG_FLAG(uLocal_47[iParam0], 42, !flag);
		PED::SET_PED_COMBAT_ATTRIBUTES(uLocal_47[iParam0], BF_0xEE326AAD, enabled);
		PED::SET_PED_COMBAT_ATTRIBUTES(uLocal_47[iParam0], BF_CanLeaveVehicle, enabled2);
		PED::SET_PED_CONFIG_FLAG(uLocal_47[iParam0], 342, value8);
		ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(uLocal_47[iParam0], toggle4, 1);
		PED::SET_PED_ARMOUR(uLocal_47[iParam0], amount);
		PED::SET_PED_COMBAT_ATTRIBUTES(uLocal_47[iParam0], BF_0xB4A13A5A, enabled3);
		ENTITY::SET_ENTITY_VISIBLE(uLocal_47[iParam0], toggle5, false);
		ENTITY::SET_ENTITY_INVINCIBLE(uLocal_47[iParam0], toggle7);
		WEAPON::GIVE_WEAPON_TO_PED(uLocal_47[iParam0], weaponHash, -1, isHidden, isHidden);
		PED::SET_PED_COMBAT_ATTRIBUTES(uLocal_47[iParam0], BF_CanDoDrivebys, enabled4);
		PED::SET_PED_COMBAT_ATTRIBUTES(uLocal_47[iParam0], BF_CanUseVehicles, enabled5);
		PED::SET_PED_COMBAT_ATTRIBUTES(uLocal_47[iParam0], BF_0x6562F017, enabled6);
		PED::SET_PED_COMBAT_ATTRIBUTES(uLocal_47[iParam0], BF_Aggressive, enabled12);
		PED::SET_PED_SUFFERS_CRITICAL_HITS(uLocal_47[iParam0], toggle8);
		PED::SET_PED_CAN_BE_TARGETTED(uLocal_47[iParam0], toggle9);
		PED::SET_PED_CONFIG_FLAG(uLocal_47[iParam0], 118, value4);
		PED::SET_PED_CONFIG_FLAG(uLocal_47[iParam0], 115, value5);
		PED::SET_PED_COMBAT_ATTRIBUTES(uLocal_47[iParam0], BF_BlindFireWhenInCover, enabled7);
		PED::SET_PED_COMBAT_ATTRIBUTES(uLocal_47[iParam0], BF_0xD5265533, enabled8);
		PED::SET_PED_COMBAT_ATTRIBUTES(uLocal_47[iParam0], BF_0xA5715184, enabled9);
		PED::SET_PED_COMBAT_ATTRIBUTES(uLocal_47[iParam0], BF_0x3D131AC1, enabled10);
		PED::SET_PED_CONFIG_FLAG(uLocal_47[iParam0], 185, value6);
		PED::SET_PED_TO_LOAD_COVER(uLocal_47[iParam0], toggle10);
		PED::SET_PED_COMBAT_ATTRIBUTES(uLocal_47[iParam0], BF_AlwaysFlee, enabled11);
		AUDIO::DISABLE_PED_PAIN_AUDIO(uLocal_47[iParam0], toggle12);
		AUDIO::STOP_PED_SPEAKING(uLocal_47[iParam0], shaking);
		func_87(uLocal_47[iParam0], num, num2, num3, num4, num5, 1101004800, 1125515264);
		ENTITY::FREEZE_ENTITY_POSITION(uLocal_47[iParam0], toggle13);
		PED::SET_PED_CONFIG_FLAG(uLocal_47[iParam0], 203, value9);
		PED::SET_PED_IS_AVOIDED_BY_OTHERS(uLocal_47[iParam0], !value9);
		PED::SET_PED_CONFIG_FLAG(uLocal_47[iParam0], 366, value10);
		PED::SET_PED_CONFIG_FLAG(uLocal_47[iParam0], 134, value11);
	
		if (!flag3)
			func_66(iParam0, 2);
	
		if (!MISC::IS_STRING_NULL_OR_EMPTY(scenarioName))
			TASK::TASK_START_SCENARIO_IN_PLACE(uLocal_47[iParam0], scenarioName, -1, false);
	
		if (value > 0)
		{
			if (value > ENTITY::GET_ENTITY_MAX_HEALTH(uLocal_47[iParam0]) || flag4)
				ENTITY::SET_ENTITY_MAX_HEALTH(uLocal_47[iParam0], value);
		
			ENTITY::SET_ENTITY_HEALTH(uLocal_47[iParam0], value, 0);
		}
	
		if (accuracy > 0)
			PED::SET_PED_ACCURACY(uLocal_47[iParam0], accuracy);
	
		if (xBias > 0f || yBias > 0f)
			WEAPON::SET_PED_CHANCE_OF_FIRING_BLANKS(uLocal_47[iParam0], xBias, yBias);
	
		PED::SET_PED_RELATIONSHIP_GROUP_HASH(uLocal_47[iParam0], hash);
	
		if (ENTITY::DOES_ENTITY_EXIST(entity2))
		{
			ENTITY::ATTACH_ENTITY_TO_ENTITY(uLocal_47[iParam0], entity2, -1, vector2, vector3, true, true, true, false, 2, true, 0);
			PED::SET_PED_CAN_RAGDOLL(uLocal_47[iParam0], false);
			func_66(iParam0, 1);
		}
		...
		if (componentHash != 0)
		{
			WEAPON::GIVE_WEAPON_COMPONENT_TO_PED(uLocal_47[iParam0], weaponHash, componentHash);
			WEAPON::SET_CURRENT_PED_WEAPON(uLocal_47[iParam0], weaponHash, true);
		}
	
		PED::SET_PED_COMBAT_ABILITY(uLocal_47[iParam0], abilityLevel);
	
		if (flag5)
			PED::SET_PED_STEALTH_MOVEMENT(uLocal_47[iParam0], true, "DEFAULT_ACTION");
...
{
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_47[iParam0]))
	{
		switch (iParam0)
		{
			case 2:
...
void func_86(int iParam0) // Position - 0x9216
{
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_47[iParam0]))
	{
		...
		{
			case 0:
				PED::SET_PED_COMPONENT_VARIATION(uLocal_47[iParam0], PV_COMP_HEAD, 0, 0, 0);
				PED::SET_PED_COMPONENT_VARIATION(uLocal_47[iParam0], PV_COMP_HAIR, 0, 0, 0);
				PED::SET_PED_COMPONENT_VARIATION(uLocal_47[iParam0], PV_COMP_UPPR, 0, 0, 0);
				PED::SET_PED_COMPONENT_VARIATION(uLocal_47[iParam0], PV_COMP_LOWR, 0, 0, 0);
				break;
		
			case 1:
				PED::SET_PED_COMPONENT_VARIATION(uLocal_47[iParam0], PV_COMP_HEAD, 0, 1, 0);
				PED::SET_PED_COMPONENT_VARIATION(uLocal_47[iParam0], PV_COMP_HAIR, 1, 1, 0);
				PED::SET_PED_COMPONENT_VARIATION(uLocal_47[iParam0], PV_COMP_UPPR, 1, 1, 0);
				PED::SET_PED_COMPONENT_VARIATION(uLocal_47[iParam0], PV_COMP_LOWR, 1, 1, 0);
				break;
			...
			case 3:
				PED::SET_PED_COMPONENT_VARIATION(uLocal_47[iParam0], PV_COMP_HEAD, 0, 1, 0);
				PED::SET_PED_COMPONENT_VARIATION(uLocal_47[iParam0], PV_COMP_HAIR, 0, 1, 0);
				PED::SET_PED_COMPONENT_VARIATION(uLocal_47[iParam0], PV_COMP_UPPR, 1, 0, 0);
				PED::SET_PED_COMPONENT_VARIATION(uLocal_47[iParam0], PV_COMP_LOWR, 0, 2, 0);
				break;
		
			case 4:
				PED::SET_PED_COMPONENT_VARIATION(uLocal_47[iParam0], PV_COMP_HEAD, 0, 2, 0);
				PED::SET_PED_COMPONENT_VARIATION(uLocal_47[iParam0], PV_COMP_HAIR, 1, 2, 0);
				PED::SET_PED_COMPONENT_VARIATION(uLocal_47[iParam0], PV_COMP_UPPR, 0, 2, 0);
				PED::SET_PED_COMPONENT_VARIATION(uLocal_47[iParam0], PV_COMP_LOWR, 0, 2, 0);
				break;
		
			case 5:
				PED::SET_PED_COMPONENT_VARIATION(uLocal_47[iParam0], PV_COMP_HEAD, 1, 2, 0);
				PED::SET_PED_COMPONENT_VARIATION(uLocal_47[iParam0], PV_COMP_HAIR, 1, 0, 0);
				PED::SET_PED_COMPONENT_VARIATION(uLocal_47[iParam0], PV_COMP_UPPR, 1, 1, 0);
				PED::SET_PED_COMPONENT_VARIATION(uLocal_47[iParam0], PV_COMP_LOWR, 0, 1, 0);
				break;
		
			case 6:
				PED::SET_PED_COMPONENT_VARIATION(uLocal_47[iParam0], PV_COMP_HEAD, 1, 1, 0);
				PED::SET_PED_COMPONENT_VARIATION(uLocal_47[iParam0], PV_COMP_HAIR, 2, 0, 0);
				PED::SET_PED_COMPONENT_VARIATION(uLocal_47[iParam0], PV_COMP_UPPR, 2, 2, 0);
				PED::SET_PED_COMPONENT_VARIATION(uLocal_47[iParam0], PV_COMP_LOWR, 0, 1, 0);
				break;
			...
			case 7:
				PED::SET_PED_COMPONENT_VARIATION(uLocal_47[iParam0], PV_COMP_HEAD, 0, 2, 0);
				PED::SET_PED_COMPONENT_VARIATION(uLocal_47[iParam0], PV_COMP_HAIR, 0, 0, 0);
				PED::SET_PED_COMPONENT_VARIATION(uLocal_47[iParam0], PV_COMP_UPPR, 1, 2, 0);
				PED::SET_PED_COMPONENT_VARIATION(uLocal_47[iParam0], PV_COMP_LOWR, 0, 0, 0);
				break;
		}
	}
...
BOOL func_89() // Position - 0x94CF
{
	...
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_47[0]) && func_82(PLAYER::PLAYER_PED_ID(), uLocal_47[0], true) >= 200f && _DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_47[1]) && func_82(PLAYER::PLAYER_PED_ID(), uLocal_47[1], true) >= 200f)
		return true;

	if (func_156(10) && !_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_47[0]) || func_156(11) && !_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_47[1]))
		return true;

	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_47[0]) && PED::IS_PED_IN_COMBAT(uLocal_47[0], PLAYER::PLAYER_PED_ID()) || !PED::IS_PED_IN_ANY_VEHICLE(uLocal_47[0], false) || _DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_47[1]) && PED::IS_PED_IN_COMBAT(uLocal_47[1], PLAYER::PLAYER_PED_ID()) || !PED::IS_PED_IN_ANY_VEHICLE(uLocal_47[1], false))
		return true;

	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_88[1]) && ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(uLocal_88[1], PLAYER::PLAYER_PED_ID(), true) || _DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_88[2]) && ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(uLocal_88[2], PLAYER::PLAYER_PED_ID(), true))
		return true;

	if (func_90(uLocal_88[3]) || func_90(uLocal_88[4]))
		return true;
	...
	if (PED::IS_PED_TRYING_TO_ENTER_A_LOCKED_VEHICLE(PLAYER::PLAYER_PED_ID()))
	{
		...
		if (vehicle == uLocal_88[3] && _DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_47[0]) || vehicle == uLocal_88[4] && _DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_47[1]))
			return true;
	}
...
{
	func_112(8);
	VEHICLE::SET_VEHICLE_FORWARD_SPEED(uLocal_88[iParam0], 5f);
	uLocal_47[iParam1].f_1 = func_74(uLocal_47[iParam1], true, 145);
	PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uLocal_47[iParam1], true);
	func_95();
	TASK::TASK_VEHICLE_DRIVE_TO_COORD(0, uLocal_88[iParam0], ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uLocal_88[iParam0], 0f, 20f, 0f), 30f, 0, 0, 262144, 4f, -1f);
	TASK::TASK_SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(0, false);
	TASK::TASK_COMBAT_PED(0, PLAYER::PLAYER_PED_ID(), 0, 16);
	func_94(uLocal_47[iParam1]);
	func_92(uLocal_47[iParam1], "GENERIC_INSULT_HIGH", 13);
	uLocal_47[iParam1].f_3 = 3;

	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_88[iParam2]))
	{
		if (iParam0 == 3)
		...
		if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_47[iParam3]))
		{
			PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uLocal_47[iParam3], true);
			TASK::TASK_VEHICLE_MISSION(uLocal_47[iParam3], uLocal_88[iParam2], uLocal_88[0], 2, 30f, 262144, -1f, -1f, true);
		}
	
		uLocal_47[iParam3].f_3 = uLocal_47[iParam3].f_3 + 1;
	}
...
{
	return _DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_88[0]) && PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), uLocal_88[0], false);
}
...
int func_108(int iParam0, var uParam1, var uParam2, var uParam3, int iParam4, BOOL bParam5) // Position - 0xA080
{
	...
	if (!ENTITY::DOES_ENTITY_EXIST(uLocal_88[iParam0]))
	{
		doorLockStatus = 0;
		toggle = true;
		toggle2 = true;
		...
		uLocal_88[iParam0] = VEHICLE::CREATE_VEHICLE(model, vector, heading, true, true, false);
		func_111(iParam0);
		func_110(iParam0);
		ENTITY::SET_ENTITY_VISIBLE(uLocal_88[iParam0], toggle2, false);
	
		if (ENTITY::DOES_ENTITY_EXIST(entity2))
			ENTITY::ATTACH_ENTITY_TO_ENTITY(uLocal_88[iParam0], entity2, -1, vector2, vector3, false, false, false, false, 2, true, 0);
		else
			ENTITY::SET_ENTITY_COLLISION(uLocal_88[iParam0], toggle, false);
	
		VEHICLE::SET_VEHICLE_STRONG(uLocal_88[iParam0], toggle3);
		ENTITY::FREEZE_ENTITY_POSITION(uLocal_88[iParam0], toggle4);
		VEHICLE::SET_VEHICLE_ENGINE_ON(uLocal_88[iParam0], value, true, false);
		ENTITY::SET_ENTITY_INVINCIBLE(uLocal_88[iParam0], toggle5);
		ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(uLocal_88[iParam0], toggle6, 1);
		VEHICLE::SET_VEHICLE_CAN_BE_TARGETTED(uLocal_88[iParam0], flag3);
		VEHICLE::SET_FORCE_VEHICLE_ENGINE_DAMAGE_BY_BULLET(uLocal_88[iParam0], flag4);
		VEHICLE::SET_VEHICLE_AUTOMATICALLY_ATTACHES(uLocal_88[iParam0], flag5, 0);
		VEHICLE::SET_VEHICLE_DISABLE_TOWING(uLocal_88[iParam0], toggle7);
		ENTITY::SET_ENTITY_ONLY_DAMAGED_BY_PLAYER(uLocal_88[iParam0], toggle8);
		VEHICLE::SET_VEHICLE_TYRES_CAN_BURST(uLocal_88[iParam0], toggle9);
		VEHICLE::SET_VEHICLE_NEEDS_TO_BE_HOTWIRED(uLocal_88[iParam0], toggle10);
		ENTITY::SET_ENTITY_COMPLETELY_DISABLE_COLLISION(uLocal_88[iParam0], !flag6, false);
	
		if (!MISC::IS_STRING_NULL_OR_EMPTY(plateText))
			VEHICLE::SET_VEHICLE_NUMBER_PLATE_TEXT(uLocal_88[iParam0], plateText);
	
		if (speed > 0f)
			VEHICLE::SET_VEHICLE_FORWARD_SPEED(uLocal_88[iParam0], speed);
	
		if (flag)
			VEHICLE::SET_HELI_BLADES_FULL_SPEED(uLocal_88[iParam0]);
	
		if (multiplier >= 0f)
			VEHICLE::SET_PLANE_TURBULENCE_MULTIPLIER(uLocal_88[iParam0], multiplier);
	
		if (num >= 0f)
			VEHICLE::SET_HELI_TURBULENCE_SCALAR(uLocal_88[iParam0], num);
	
		if (doorLockStatus != 0)
			VEHICLE::SET_VEHICLE_DOORS_LOCKED(uLocal_88[iParam0], doorLockStatus);
	
		if (bParam5)
			uLocal_88[iParam0].f_1 = func_109(uLocal_88[iParam0], flag2, false);
	}
...
{
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_88[iParam0]))
	{
		switch (iParam0)
		{
			case 5:
			...
			case 3:
			case 4:
				VEHICLE::SET_VEHICLE_DIRT_LEVEL(uLocal_88[iParam0], 15f);
				break;
		}
	}
...
void func_111(int iParam0) // Position - 0xA47B
{
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_88[iParam0]))
	{
		...
		{
			case 5:
				VEHICLE::SET_VEHICLE_COLOURS(uLocal_88[iParam0], 48, 48);
				VEHICLE::SET_VEHICLE_EXTRA_COLOURS(uLocal_88[iParam0], 8, 156);
				break;
		
			case 6:
				VEHICLE::SET_VEHICLE_COLOURS(uLocal_88[iParam0], 58, 58);
				VEHICLE::SET_VEHICLE_EXTRA_COLOURS(uLocal_88[iParam0], 8, 156);
				break;
		
			case 7:
				VEHICLE::SET_VEHICLE_COLOURS(uLocal_88[iParam0], 94, 94);
				VEHICLE::SET_VEHICLE_EXTRA_COLOURS(uLocal_88[iParam0], 8, 156);
				break;
		
			case 3:
			case 4:
				VEHICLE::SET_VEHICLE_COLOURS(uLocal_88[iParam0], 0, 0);
				VEHICLE::SET_VEHICLE_EXTRA_COLOURS(uLocal_88[iParam0], 61, 156);
				break;
		}
	}
...
void func_125() // Position - 0xABB8
{
	...
	if (func_156(5) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_88[iLocal_171]) && MISC::GET_GAME_TIMER() < iLocal_155)
		AUDIO::SET_HORN_PERMANENTLY_ON(uLocal_88[iLocal_171]);
	...
	if (func_156(9) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_88[0]) && func_82(PLAYER::PLAYER_PED_ID(), uLocal_88[0], true) <= 35f)
	{
		if (!func_156(10))
		{
			if (!CAM::IS_SPHERE_VISIBLE(uLocal_130, 7f))
			{
				if (MISC::GET_GAME_TIMER() - iLocal_160 >= 1000 && !func_79(uLocal_130, 7f) && func_83(PLAYER::PLAYER_PED_ID(), uLocal_130, true) >= 50f)
				{
					...
					VEHICLE::ATTACH_VEHICLE_TO_TRAILER(uLocal_88[3], uLocal_88[1], 1065353216);
		...
		if (!func_156(11))
		{
			if (!CAM::IS_SPHERE_VISIBLE(uLocal_133, 7f))
			{
				if (MISC::GET_GAME_TIMER() - iLocal_161 >= 1000 && !func_79(uLocal_133, 7f) && func_83(PLAYER::PLAYER_PED_ID(), uLocal_133, true) >= 50f)
				{
					...
					VEHICLE::ATTACH_VEHICLE_TO_TRAILER(uLocal_88[4], uLocal_88[2], 1065353216);
...
void func_126() // Position - 0xAEA0
{
	...
	for (i = 0; i < 8; i = i + 1)
	{
		if (ENTITY::DOES_ENTITY_EXIST(uLocal_47[i]) && HUD::DOES_BLIP_EXIST(uLocal_47[i].f_1))
		{
			if (PED::IS_PED_IN_ANY_VEHICLE(uLocal_47[i], false))
			{
				if (!func_130(i, 0))
				...
				if (_GET_VEHICLE_SEAT_PED_IS_IN(uLocal_47[i], false) != -1)
				{
					if (func_129(i))
					{
						if (HUD::GET_BLIP_ALPHA(uLocal_47[i].f_1) > 0)
						{
							HUD::SET_BLIP_ALPHA(uLocal_47[i].f_1, 0);
							HUD::SET_BLIP_HIDDEN_ON_LEGEND(uLocal_47[i].f_1, true);
						}
					}
					else if (HUD::GET_BLIP_ALPHA(uLocal_47[i].f_1) == 0)
					{
						HUD::SET_BLIP_ALPHA(uLocal_47[i].f_1, 255);
						HUD::SET_BLIP_HIDDEN_ON_LEGEND(uLocal_47[i].f_1, false);
					}
				}
			}
			else if (func_130(i, 0))
			{
				HUD::SET_BLIP_SCALE(uLocal_47[i].f_1, 0.7f);
				func_128(i, 0);
			...
			if (PED::IS_PED_INJURED(uLocal_47[i]))
				func_127(&(uLocal_47[i].f_1));
		}
	}

	for (i = 0; i < 8; i = i + 1)
	{
		if (ENTITY::DOES_ENTITY_EXIST(uLocal_88[i]) && HUD::DOES_BLIP_EXIST(uLocal_88[i].f_1))
			if (!VEHICLE::IS_VEHICLE_DRIVEABLE(uLocal_88[i], false))
				func_127(&(uLocal_88[i].f_1));
	}
...
{
	MISC::CLEAR_BIT(&(uLocal_47[iParam0].f_2), iParam1);
	return;
}
...
{
	if (iParam0 == 3)
		if (!_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_47[2]))
			return false;

	if (iParam0 == 5)
		if (!_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_47[4]))
			return false;

	if (iParam0 == 7)
		if (!_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_47[6]))
			return false;
...
{
	return IS_BIT_SET(uLocal_47[iParam0].f_2, iParam1);
}
...
void func_131() // Position - 0xB0C2
{
	...
	for (i = 0; i < 8; i = i + 1)
	{
		if (ENTITY::DOES_ENTITY_EXIST(uLocal_88[i]))
			func_132(i);
	}
...
void func_132(int iParam0) // Position - 0xB0F0
{
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_88[iParam0]))
	{
		...
		{
			case 5:
				if (!_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_47[2]) && !_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_47[3]) || !VEHICLE::IS_VEHICLE_DRIVEABLE(uLocal_88[iParam0], false))
					func_133(iParam0, false);
				break;
		
			case 6:
				if (!_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_47[4]) && !_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_47[5]) || !VEHICLE::IS_VEHICLE_DRIVEABLE(uLocal_88[iParam0], false))
					func_133(iParam0, false);
				break;
		
			case 7:
				if (!_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_47[6]) && !_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_47[7]) || !VEHICLE::IS_VEHICLE_DRIVEABLE(uLocal_88[iParam0], false))
					func_133(iParam0, false);
				break;
		
			case 3:
				if (!_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_47[0]) || !VEHICLE::IS_VEHICLE_DRIVEABLE(uLocal_88[iParam0], false))
					if (func_82(PLAYER::PLAYER_PED_ID(), uLocal_88[iParam0], true) >= 50f)
						func_133(iParam0, false);
			...
			case 4:
				if (!_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_47[1]) || !VEHICLE::IS_VEHICLE_DRIVEABLE(uLocal_88[iParam0], false))
					if (func_82(PLAYER::PLAYER_PED_ID(), uLocal_88[iParam0], true) >= 50f)
						func_133(iParam0, false);
			...
			case 1:
				if (!_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_88[3]) || func_82(uLocal_88[3], uLocal_88[iParam0], true) >= 150f)
					func_133(iParam0, false);
				break;
		
			case 2:
				if (!_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_88[4]) || func_82(uLocal_88[4], uLocal_88[iParam0], true) >= 150f)
					func_133(iParam0, false);
				break;
		
			case 0:
				switch (uLocal_88[iParam0].f_3)
				{
					case 0:
						if (func_97())
						{
							func_112(1);
							func_127(&(uLocal_88[iParam0].f_1));
							uLocal_88[iParam0].f_3 = uLocal_88[iParam0].f_3 + 1;
						}
						break;
				}
				break;
	...
	else if (ENTITY::IS_ENTITY_VISIBLE(uLocal_88[iParam0]))
	{
		func_133(iParam0, false);
	}
	else
...
void func_133(int iParam0, BOOL bParam1) // Position - 0xB360
{
	if (ENTITY::DOES_ENTITY_EXIST(uLocal_88[iParam0]))
	{
		...
		if (VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(uLocal_88[iParam0]))
			VEHICLE::STOP_PLAYBACK_RECORDED_VEHICLE(uLocal_88[iParam0]);
	
		if (func_134(&uLocal_88[iParam0]))
			if (bParam1)
				VEHICLE::DELETE_VEHICLE(&uLocal_88[iParam0]);
			else
				ENTITY::SET_VEHICLE_AS_NO_LONGER_NEEDED(&uLocal_88[iParam0]);
	
		uLocal_88[iParam0] = 0;
		uLocal_88[iParam0].f_2 = 0;
		uLocal_88[iParam0].f_3 = 0;
	}
...
void func_136(int iParam0) // Position - 0xB424
{
	...
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_47[iParam0]))
	{
		switch (iParam0)
		{
			...
			case 1:
				...
				switch (uLocal_47[iParam0].f_3)
				{
					case 0:
						uLocal_47[iParam0].f_4 = MISC::GET_GAME_TIMER();
					
						if (func_82(uLocal_47[iParam0], PLAYER::PLAYER_PED_ID(), true) <= 15f)
							PED::SET_IK_TARGET(uLocal_47[iParam0], 1, PLAYER::PLAYER_PED_ID(), 31086, uLocal_121, 0, -1, -1);
						break;
				
					case 1:
						if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_88[num]))
						{
							VEHICLE::SET_VEHICLE_USE_MORE_RESTRICTIVE_SPAWN_CHECKS(uLocal_88[num], true);
						
							if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_88[0]) && !ENTITY::IS_ENTITY_TOUCHING_ENTITY(uLocal_88[num], uLocal_88[0]))
							{
								if (MISC::GET_GAME_TIMER() >= iLocal_159 && !func_156(12) && !ENTITY::IS_ENTITY_AT_COORD(uLocal_88[num], uLocal_136, 7f, 7f, 7f, false, true, 0) && func_83(PLAYER::PLAYER_PED_ID(), uLocal_136, true) < func_82(uLocal_88[num], PLAYER::PLAYER_PED_ID(), true) && !CAM::IS_SPHERE_VISIBLE(uLocal_136, 7f) && !CAM::IS_SPHERE_VISIBLE(ENTITY::GET_ENTITY_COORDS(uLocal_88[num], true), 7f) && !func_79(uLocal_136, 8f))
								{
									...
									ENTITY::SET_ENTITY_COORDS(uLocal_88[num], uLocal_136, true, false, false, true);
									VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(uLocal_88[num], 1084227584);
									ENTITY::SET_ENTITY_HEADING(uLocal_88[num], heading);
									VEHICLE::SET_VEHICLE_ENGINE_ON(uLocal_88[num], true, true, false);
									VEHICLE::SET_VEHICLE_FORWARD_SPEED(uLocal_88[num], 30f);
									func_112(5);
									iLocal_171 = num;
									iLocal_155 = MISC::GET_GAME_TIMER() + 5000;
								}
							
								if (!func_156(12) && ENTITY::IS_ENTITY_AT_COORD(uLocal_88[num], uLocal_136, 7f, 7f, 7f, false, true, 0))
									func_112(12);
							
								if (MISC::GET_GAME_TIMER() >= iLocal_159 && ENTITY::IS_ENTITY_OCCLUDED(uLocal_88[num]) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_88[num2]) && func_82(uLocal_88[num], uLocal_88[num2], true) >= 20f)
								{
									offsetFromEntityGivenWorldCoords = { ENTITY::GET_OFFSET_FROM_ENTITY_GIVEN_WORLD_COORDS(uLocal_88[num], ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true)) };
								
									if (offsetFromEntityGivenWorldCoords < -3.5f || offsetFromEntityGivenWorldCoords > 3.5f)
									{
										entitySpeed = ENTITY::GET_ENTITY_SPEED(uLocal_88[num]);
										entitySpeed = func_139(entitySpeed, 20f, 50f);
										ENTITY::SET_ENTITY_HEADING(uLocal_88[num], func_78(ENTITY::GET_ENTITY_COORDS(uLocal_88[num], true), ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true)));
										VEHICLE::SET_VEHICLE_FORWARD_SPEED(uLocal_88[num], entitySpeed);
									}
								}
							
								if (func_130(iParam0, 3) || func_82(uLocal_47[iParam0], PLAYER::PLAYER_PED_ID(), true) <= 15f || _DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_88[num2]) && func_82(uLocal_88[num], uLocal_88[num2], true) <= 15f)
								{
									if (func_82(uLocal_47[iParam0], PLAYER::PLAYER_PED_ID(), true) <= 15f)
									{
										if (!HUD::DOES_BLIP_EXIST(uLocal_47[iParam0].f_1))
										{
											uLocal_47[iParam0].f_1 = func_74(uLocal_47[iParam0], true, 145);
											func_92(uLocal_47[iParam0], "GENERIC_INSULT_HIGH", 13);
										}
									}
								
									uLocal_47[iParam0].f_3 = uLocal_47[iParam0].f_3 + 1;
								}
							}
							else
							{
					...
					case 2:
						if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_88[num]))
						{
							PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uLocal_47[iParam0], false);
							TASK::TASK_COMBAT_PED(uLocal_47[iParam0], PLAYER::PLAYER_PED_ID(), 0, 16);
							uLocal_47[iParam0].f_3 = uLocal_47[iParam0].f_3 + 1;
						}
						break;
					...
					case 3:
						if (!HUD::DOES_BLIP_EXIST(uLocal_47[iParam0].f_1))
							if (func_82(PLAYER::PLAYER_PED_ID(), uLocal_47[iParam0], true) <= 85f)
								uLocal_47[iParam0].f_1 = func_74(uLocal_47[iParam0], true, 145);
					
						if (func_156(6) || func_156(8))
							if (!PED::IS_PED_IN_ANY_VEHICLE(uLocal_47[iParam0], false) && func_82(uLocal_47[iParam0], PLAYER::PLAYER_PED_ID(), true) >= 250f)
								func_138(iParam0, false);
						else if (func_82(uLocal_47[iParam0], PLAYER::PLAYER_PED_ID(), true) >= 250f)
							func_138(iParam0, false);
						break;
				}
				break;
			...
			case 7:
				if (func_156(7))
					if (!PED::IS_PED_IN_COMBAT(uLocal_47[iParam0], PLAYER::PLAYER_PED_ID()) && !func_137(uLocal_47[iParam0], SCRIPT_TASK_VEHICLE_CHASE, true))
						TASK::TASK_COMBAT_PED(uLocal_47[iParam0], PLAYER::PLAYER_PED_ID(), 0, 16);
			
				if (func_156(7))
					if (!PED::IS_PED_IN_ANY_VEHICLE(uLocal_47[iParam0], false) && func_82(uLocal_47[iParam0], PLAYER::PLAYER_PED_ID(), true) >= 250f)
						func_138(iParam0, false);
				else if (func_156(2) && func_82(uLocal_47[iParam0], PLAYER::PLAYER_PED_ID(), true) >= 250f)
					func_138(iParam0, false);
				break;
		}
	}
	else
	{
		...
		{
			PED::SET_PED_CAN_RAGDOLL(uLocal_47[iParam0], true);
			ENTITY::DETACH_ENTITY(uLocal_47[iParam0], true, false);
			func_128(iParam0, 1);
		}
	
		if (!func_130(iParam0, 2))
			if (ENTITY::IS_ENTITY_VISIBLE(uLocal_47[iParam0]))
				func_138(iParam0, false);
			else
...
void func_138(int iParam0, BOOL bParam1) // Position - 0xBA60
{
	if (ENTITY::DOES_ENTITY_EXIST(uLocal_47[iParam0]))
	{
		func_127(&(uLocal_47[iParam0].f_1));
	
		if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_47[iParam0]) && ENTITY::IS_ENTITY_ATTACHED(uLocal_47[iParam0]) && !PED::IS_PED_IN_ANY_VEHICLE(uLocal_47[iParam0], true) && !PED::IS_PED_SITTING_IN_ANY_VEHICLE(uLocal_47[iParam0]) && !PED::IS_PED_GETTING_INTO_A_VEHICLE(uLocal_47[iParam0]))
			ENTITY::DETACH_ENTITY(uLocal_47[iParam0], true, true);
	
		if (bParam1)
			PED::DELETE_PED(&uLocal_47[iParam0]);
		else
			ENTITY::SET_PED_AS_NO_LONGER_NEEDED(&uLocal_47[iParam0]);
	
		uLocal_47[iParam0].f_2 = 0;
	}
...
void func_140() // Position - 0xBB26
{
	if (func_156(1) || iLocal_153 > 2 && func_141())
		if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_88[0]) && func_82(PLAYER::PLAYER_PED_ID(), uLocal_88[0], true) >= 250f)
			func_64();

	if (func_141())
		if (ENTITY::DOES_ENTITY_EXIST(uLocal_88[0]) && !_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_88[0]))
			func_64();
...
BOOL func_141() // Position - 0xBB98
{
	...
	for (i = 0; i < 8; i = i + 1)
	{
		if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_47[i]) && HUD::DOES_BLIP_EXIST(uLocal_47[i].f_1))
		{
			num = 0;
			i = 8;
		}
...
BOOL func_160(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6) // Position - 0xD867
{
	...
	if (!flag)
	{
		...
		if (!func_197(G_MissionStats.f_24998.f_43[iParam3]))
			return false;
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_194() || Global_112857 || Global_32286 || func_193() || func_192(8, -1) || func_191() || func_190() || func_189() || func_188() || G_MissionStats.f_7691.f_919[character] == 5)
							return false;
						break;
				
					case 1:
						if (PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_194() || Global_32286 || func_193() || func_192(8, -1) || func_189() || func_191() || func_190() || func_188() || G_MissionStats.f_7691.f_919[character] == 5)
							return false;
						break;
				
					case 2:
						if (!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_194() || Global_112857 || Global_32286 || func_193() || func_192(8, -1) || func_189() || func_191() || func_190() || func_188() || G_MissionStats.f_7691.f_919[character] == 5 || Global_43924 != -1)
							return false;
						break;
				
					case 3:
						if (PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_194() || Global_112857 || Global_32286 || func_193() || func_192(8, -1) || func_191() || func_190() || func_188() || G_MissionStats.f_7691.f_919[character] == 5)
							return false;
						break;
				
					case 4:
						if (func_194() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0 || func_192(8, -1) || func_188() || func_187() || G_MissionStats.f_7691.f_919[character] == 5)
							return false;
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
							if (PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0 || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || func_194() || Global_32286 || func_193() || func_192(8, -1) || func_190() || func_189() || func_188() || G_MissionStats.f_7691.f_919[character] == 5)
								return false;
						break;
				
					case 7:
						if (PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || !CAM::IS_SCREEN_FADED_IN() || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_194() || func_190() || Global_112857 || Global_32286 || func_193() || Global_44569 || func_192(8, -1) || func_189() || func_187() || func_188() || G_MissionStats.f_7691.f_919[character] == 5)
							return false;
						break;
...
void func_202(BOOL bParam0, BOOL bParam1) // Position - 0xEEB5
{
	...
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_88[0]))
		VEHICLE::SET_VEHICLE_TYRES_CAN_BURST(uLocal_88[0], true);
