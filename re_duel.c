...
void main() // Position - 0x0
{
	...
	{
		if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_90[0]))
			VEHICLE::SET_VEHICLE_DOORS_LOCKED(uLocal_90[0], 2);
...
void func_2() // Position - 0x1F1
{
	func_58(64, true);
	func_58(65, true);
	func_32(uLocal_90[0], _CHAR_NULL);
	func_6(-1, 0);
	func_3();
	func_200(true, false);
	return;
...
BOOL IS_PLAYSTATION_PLATFORM() // Position - 0x58DC
{
	return MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION();
}

BOOL IS_XBOX_PLATFORM() // Position - 0x58F2
{
			...
			switch (iLocal_155)
			{
				...
				case 2:
					if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_90[3]) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_49[0]) && func_96())
					{
						...
						{
							if (func_95(ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uLocal_90[3], 0f, 10f, 0f), 1.25f) || func_95(ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uLocal_90[3], 0f, 12.5f, 0f), 1.5f) || func_95(ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uLocal_90[3], 0f, 15f, 0f), 1.75f) || func_95(ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uLocal_90[3], 0f, 17.5f, 0f), 2f) || func_95(ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uLocal_90[3], 0f, 20f, 0f), 2.25f))
							{
								func_90(3, 0, 4, 1);
								iLocal_155 = 4;
							}
					...
					if (!func_154(8) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_90[4]) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_49[1]) && func_96())
					{
						...
						{
							if (func_95(ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uLocal_90[4], 0f, 10f, 0f), 1.5f) || func_95(ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uLocal_90[4], 0f, 12.5f, 0f), 1.75f) || func_95(ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uLocal_90[4], 0f, 15f, 0f), 2f) || func_95(ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uLocal_90[4], 0f, 17.5f, 0f), 2.25f) || func_95(ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uLocal_90[4], 0f, 20f, 0f), 2.5f))
							{
								func_90(4, 1, 3, 0);
								iLocal_155 = 4;
							}
					...
					if (!func_154(8) && func_88())
					{
						...
						if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_49[0]))
						{
							PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uLocal_49[0], false);
							TASK::TASK_COMBAT_PED(uLocal_49[0], PLAYER::PLAYER_PED_ID(), 0, 16);
							uLocal_49[0].f_3 = 3;
						}
					
						if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_49[1]))
						{
							PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uLocal_49[1], false);
							TASK::TASK_COMBAT_PED(uLocal_49[1], PLAYER::PLAYER_PED_ID(), 0, 16);
							uLocal_49[1].f_3 = 3;
						}
					
						if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_90[3]))
							VEHICLE::SET_VEHICLE_DOORS_LOCKED(uLocal_90[3], 1);
					
						if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_90[4]))
							VEHICLE::SET_VEHICLE_DOORS_LOCKED(uLocal_90[4], 1);
				...
				case 3:
					if (!_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_49[0]) || HUD::DOES_BLIP_EXIST(uLocal_49[0].f_1) && !_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_49[1]) || HUD::DOES_BLIP_EXIST(uLocal_49[1].f_1))
						iLocal_155 = iLocal_155 + 1;
					break;
				...
				case 8:
					if (!_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_49[0]) && !_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_49[1]))
					...
					if (func_96() || _DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_90[0]) && func_81(PLAYER::PLAYER_PED_ID(), uLocal_90[0], true) <= 35f)
					{
						...
						if (PATHFIND::GET_NTH_CLOSEST_VEHICLE_NODE(entityCoords, randomIntInRange, &outPosition, 1, 5f, 0))
						{
							...
							if (flags & 4 == 0 && !func_80() || flags & 8 == 0 && func_79() || flags & 1 == 0 && !func_78(outPosition, 1084227584))
							{
								...
								{
									func_76(uLocal_90[5], outPosition);
									func_76(uLocal_90[6], offsetFromCoordAndHeadingInWorldCoords);
									func_76(uLocal_90[7], offsetFromCoordAndHeadingInWorldCoords2);
									iLocal_149 = MISC::GET_GAME_TIMER();
								
									for (i = 2; i <= 7; i = i + 1)
									{
										if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_49[i]))
										{
											uLocal_49[i].f_1 = func_73(uLocal_49[i], true, 145);
										
											if (PED::IS_PED_IN_ANY_VEHICLE(uLocal_49[i], false))
											{
												if (_GET_VEHICLE_SEAT_PED_IS_IN(uLocal_49[i], false) == -1)
												{
													HUD::SET_BLIP_SCALE(uLocal_49[i].f_1, 1f);
												}
												else
												{
													HUD::SET_BLIP_ALPHA(uLocal_49[i].f_1, 0);
													HUD::SET_BLIP_HIDDEN_ON_LEGEND(uLocal_49[i].f_1, true);
												}
											}
										}
									}
				...
				case 10:
					if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_49[2]) || _DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_49[3]) || _DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_49[4]) || _DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_49[5]) || _DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_49[6]) || _DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_49[7]))
					{
						if (func_154(7))
						{
							if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_90[5]))
								func_64(5, PED::GET_VEHICLE_PED_IS_USING(PLAYER::PLAYER_PED_ID()), &uLocal_150);
						
							if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_90[6]))
								func_64(6, PED::GET_VEHICLE_PED_IS_USING(PLAYER::PLAYER_PED_ID()), &uLocal_151);
						
							if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_90[7]))
								func_64(7, PED::GET_VEHICLE_PED_IS_USING(PLAYER::PLAYER_PED_ID()), &uLocal_152);
						}
					}
					else if (!_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_49[0]) && !_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_49[1]))
					{
						if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_90[0]))
							iLocal_48 = 2;
						else
...
void func_64(int iParam0, Vehicle veParam1, var uParam2) // Position - 0x6730
{
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(uLocal_90[iParam0], false))
	{
		if (ENTITY::DOES_ENTITY_EXIST(veParam1) && uLocal_90[iParam0] != veParam1 && !VEHICLE::IS_THIS_MODEL_A_BOAT(ENTITY::GET_ENTITY_MODEL(veParam1)) && !VEHICLE::IS_THIS_MODEL_A_PLANE(ENTITY::GET_ENTITY_MODEL(veParam1)) && !VEHICLE::IS_THIS_MODEL_A_HELI(ENTITY::GET_ENTITY_MODEL(veParam1)) && !VEHICLE::IS_THIS_MODEL_A_TRAIN(ENTITY::GET_ENTITY_MODEL(veParam1)) && func_70(uLocal_90[iParam0]))
		{
			...
			if (!ENTITY::IS_ENTITY_OCCLUDED(uLocal_90[iParam0]))
			{
				*uParam2 = MISC::GET_GAME_TIMER();
			}
			else if (MISC::GET_GAME_TIMER() - *uParam2 > num3 && MISC::GET_GAME_TIMER() - iLocal_149 > 1500 && func_81(uLocal_90[iParam0], veParam1, true) > func_82(veParam1, uLocal_145, true) && func_69(iParam0) && func_82(veParam1, uLocal_145, true) >= num && func_81(uLocal_90[iParam0], veParam1, true) >= num2 && func_68(uLocal_90[iParam0], uLocal_145, 1153138688) && func_67(uLocal_90[iParam0], veParam1, uLocal_145) && !_IS_NULL_VECTOR(uLocal_145) && !CAM::IS_SPHERE_VISIBLE(uLocal_145, 4f) && !func_78(uLocal_145, 1084227584))
			{
				...
				if (iParam0 == 3 || iParam0 == 4)
				{
					VEHICLE::DETACH_VEHICLE_FROM_TRAILER(uLocal_90[iParam0]);
				...
				ENTITY::SET_ENTITY_COORDS(uLocal_90[iParam0], uLocal_145, true, false, false, true);
				VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(uLocal_90[iParam0], 1084227584);
				ENTITY::SET_ENTITY_HEADING(uLocal_90[iParam0], fLocal_148);
				VEHICLE::SET_VEHICLE_ENGINE_ON(uLocal_90[iParam0], true, true, false);
				VEHICLE::SET_VEHICLE_FORWARD_SPEED(uLocal_90[iParam0], ENTITY::GET_ENTITY_SPEED(veParam1) * 1.2f);
				*uParam2 = MISC::GET_GAME_TIMER();
				uLocal_90[iParam0].f_2 = MISC::GET_GAME_TIMER();
				iLocal_149 = MISC::GET_GAME_TIMER();
			}
		}
		else
...
{
	MISC::SET_BIT(&(uLocal_49[iParam0].f_2), iParam1);
	return;
}
...
BOOL func_67(Entity eParam0, Vehicle veParam1, Vector3 vParam2, var uParam3, var uParam4) // Position - 0x6A07
{
	...
	if (eParam0 == uLocal_90[3] && !HUD::DOES_BLIP_EXIST(uLocal_49[0].f_1))
		return true;

	if (eParam0 == uLocal_90[4] && !HUD::DOES_BLIP_EXIST(uLocal_49[1].f_1))
		return true;
...
BOOL func_68(Vehicle veParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0x6A9E
{
	...
	if (veParam0 == uLocal_90[3] && !HUD::DOES_BLIP_EXIST(uLocal_49[0].f_1))
		return true;

	if (veParam0 == uLocal_90[4] && !HUD::DOES_BLIP_EXIST(uLocal_49[1].f_1))
		return true;
...
BOOL func_69(int iParam0) // Position - 0x6AFC
{
	...
	{
		if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_90[i]))
		{
			if ((float)num3 == -1f || MISC::GET_GAME_TIMER() - uLocal_90[i].f_2 > num3)
			{
				num3 = MISC::GET_GAME_TIMER() - uLocal_90[i].f_2;
				num4 = i;
			}
		
			if (num5 == -1f || func_81(uLocal_90[i], PLAYER::PLAYER_PED_ID(), true) > num5)
			{
				num5 = func_81(uLocal_90[i], PLAYER::PLAYER_PED_ID(), true);
				num6 = i;
			}
		}
	}
...
BOOL func_78(Vector3 vParam0, var uParam1, var uParam2, int iParam3) // Position - 0x6E91
{
	...
	for (i = 0; i < 8; i = i + 1)
	{
		if (ENTITY::DOES_ENTITY_EXIST(uLocal_90[i]) && ENTITY::IS_ENTITY_AT_COORD(uLocal_90[i], vParam0, iParam3, iParam3, iParam3, false, true, 0))
			num = 1;
	}
...
int func_83(int iParam0, BOOL bParam1, var uParam2, var uParam3, var uParam4, int iParam5) // Position - 0x6FEA
{
	...
	if (!ENTITY::DOES_ENTITY_EXIST(uLocal_49[iParam0]))
	{
		...
		{
			uLocal_49[iParam0] = PED::CREATE_PED_INSIDE_VEHICLE(ped, PED_TYPE_MISSION, model, seat, true, true);
		}
		else
		{
			uLocal_49[iParam0] = PED::CREATE_PED(PED_TYPE_MISSION, model, vector, heading, true, true);
			ENTITY::SET_ENTITY_COLLISION(uLocal_49[iParam0], toggle6, false);
			ENTITY::SET_ENTITY_COMPLETELY_DISABLE_COLLISION(uLocal_49[iParam0], !flag6, false);
		}
	
		if (flag2)
			ENTITY::SET_ENTITY_COORDS_NO_OFFSET(uLocal_49[iParam0], vector, false, false, true);
	
		if (bParam1)
			if (hash == hLocal_171)
				uLocal_49[iParam0].f_1 = func_73(uLocal_49[iParam0], true, 145);
			else
				uLocal_49[iParam0].f_1 = func_73(uLocal_49[iParam0], false, 145);
	
		WEAPON::SET_PED_DROPS_WEAPONS_WHEN_DEAD(uLocal_49[iParam0], toggle11);
		PED::SET_PED_CONFIG_FLAG(uLocal_49[iParam0], 213, value2);
		PED::SET_PED_CONFIG_FLAG(uLocal_49[iParam0], 212, value3);
		PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uLocal_49[iParam0], toggle);
		PED::SET_PED_KEEP_TASK(uLocal_49[iParam0], toggle2);
		PED::SET_PED_DIES_WHEN_INJURED(uLocal_49[iParam0], toggle3);
		PED::SET_PED_CONFIG_FLAG(uLocal_49[iParam0], 188, value7);
		PED::SET_PED_CONFIG_FLAG(uLocal_49[iParam0], 42, !flag);
		PED::SET_PED_COMBAT_ATTRIBUTES(uLocal_49[iParam0], BF_0xEE326AAD, enabled);
		PED::SET_PED_COMBAT_ATTRIBUTES(uLocal_49[iParam0], BF_CanLeaveVehicle, enabled2);
		PED::SET_PED_CONFIG_FLAG(uLocal_49[iParam0], 342, value8);
		ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(uLocal_49[iParam0], toggle4, 1);
		PED::SET_PED_ARMOUR(uLocal_49[iParam0], amount);
		PED::SET_PED_COMBAT_ATTRIBUTES(uLocal_49[iParam0], BF_0xB4A13A5A, enabled3);
		ENTITY::SET_ENTITY_VISIBLE(uLocal_49[iParam0], toggle5, false);
		ENTITY::SET_ENTITY_INVINCIBLE(uLocal_49[iParam0], toggle7);
		WEAPON::GIVE_WEAPON_TO_PED(uLocal_49[iParam0], weaponHash, -1, isHidden, isHidden);
		PED::SET_PED_COMBAT_ATTRIBUTES(uLocal_49[iParam0], BF_CanDoDrivebys, enabled4);
		PED::SET_PED_COMBAT_ATTRIBUTES(uLocal_49[iParam0], BF_CanUseVehicles, enabled5);
		PED::SET_PED_COMBAT_ATTRIBUTES(uLocal_49[iParam0], BF_0x6562F017, enabled6);
		PED::SET_PED_COMBAT_ATTRIBUTES(uLocal_49[iParam0], BF_Aggressive, enabled12);
		PED::SET_PED_SUFFERS_CRITICAL_HITS(uLocal_49[iParam0], toggle8);
		PED::SET_PED_CAN_BE_TARGETTED(uLocal_49[iParam0], toggle9);
		PED::SET_PED_CONFIG_FLAG(uLocal_49[iParam0], 118, value4);
		PED::SET_PED_CONFIG_FLAG(uLocal_49[iParam0], 115, value5);
		PED::SET_PED_COMBAT_ATTRIBUTES(uLocal_49[iParam0], BF_BlindFireWhenInCover, enabled7);
		PED::SET_PED_COMBAT_ATTRIBUTES(uLocal_49[iParam0], BF_0xD5265533, enabled8);
		PED::SET_PED_COMBAT_ATTRIBUTES(uLocal_49[iParam0], BF_0xA5715184, enabled9);
		PED::SET_PED_COMBAT_ATTRIBUTES(uLocal_49[iParam0], BF_0x3D131AC1, enabled10);
		PED::SET_PED_CONFIG_FLAG(uLocal_49[iParam0], 185, value6);
		PED::SET_PED_TO_LOAD_COVER(uLocal_49[iParam0], toggle10);
		PED::SET_PED_COMBAT_ATTRIBUTES(uLocal_49[iParam0], BF_AlwaysFlee, enabled11);
		AUDIO::DISABLE_PED_PAIN_AUDIO(uLocal_49[iParam0], toggle12);
		AUDIO::STOP_PED_SPEAKING(uLocal_49[iParam0], shaking);
		func_86(uLocal_49[iParam0], num, num2, num3, num4, num5);
		ENTITY::FREEZE_ENTITY_POSITION(uLocal_49[iParam0], toggle13);
		PED::SET_PED_CONFIG_FLAG(uLocal_49[iParam0], 203, value9);
		PED::SET_PED_IS_AVOIDED_BY_OTHERS(uLocal_49[iParam0], !value9);
		PED::SET_PED_CONFIG_FLAG(uLocal_49[iParam0], 366, value10);
		PED::SET_PED_CONFIG_FLAG(uLocal_49[iParam0], 134, value11);
	
		if (!flag3)
			func_65(iParam0, 2);
	
		if (!MISC::IS_STRING_NULL_OR_EMPTY(scenarioName))
			TASK::TASK_START_SCENARIO_IN_PLACE(uLocal_49[iParam0], scenarioName, -1, false);
	
		if (value > 0)
		{
			if (value > ENTITY::GET_ENTITY_MAX_HEALTH(uLocal_49[iParam0]) || flag4)
				ENTITY::SET_ENTITY_MAX_HEALTH(uLocal_49[iParam0], value);
		
			ENTITY::SET_ENTITY_HEALTH(uLocal_49[iParam0], value, 0);
		}
	
		if (accuracy > 0)
			PED::SET_PED_ACCURACY(uLocal_49[iParam0], accuracy);
	
		if (xBias > 0f || yBias > 0f)
			WEAPON::SET_PED_CHANCE_OF_FIRING_BLANKS(uLocal_49[iParam0], xBias, yBias);
	
		PED::SET_PED_RELATIONSHIP_GROUP_HASH(uLocal_49[iParam0], hash);
	
		if (ENTITY::DOES_ENTITY_EXIST(entity2))
		{
			ENTITY::ATTACH_ENTITY_TO_ENTITY(uLocal_49[iParam0], entity2, -1, vector2, vector3, true, true, true, false, 2, true, 0);
			PED::SET_PED_CAN_RAGDOLL(uLocal_49[iParam0], false);
			func_65(iParam0, 1);
		}
		...
		if (componentHash != 0)
		{
			WEAPON::GIVE_WEAPON_COMPONENT_TO_PED(uLocal_49[iParam0], weaponHash, componentHash);
			WEAPON::SET_CURRENT_PED_WEAPON(uLocal_49[iParam0], weaponHash, true);
		}
	
		PED::SET_PED_COMBAT_ABILITY(uLocal_49[iParam0], abilityLevel);
	
		if (flag5)
			PED::SET_PED_STEALTH_MOVEMENT(uLocal_49[iParam0], true, "DEFAULT_ACTION");
...
{
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_49[iParam0]))
	{
		switch (iParam0)
		{
			case 2:
...
void func_85(int iParam0) // Position - 0x764A
{
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_49[iParam0]))
	{
		...
		{
			case 0:
				PED::SET_PED_COMPONENT_VARIATION(uLocal_49[iParam0], PV_COMP_HEAD, 0, 0, 0);
				PED::SET_PED_COMPONENT_VARIATION(uLocal_49[iParam0], PV_COMP_HAIR, 0, 0, 0);
				PED::SET_PED_COMPONENT_VARIATION(uLocal_49[iParam0], PV_COMP_UPPR, 0, 0, 0);
				PED::SET_PED_COMPONENT_VARIATION(uLocal_49[iParam0], PV_COMP_LOWR, 0, 0, 0);
				break;
		
			case 1:
				PED::SET_PED_COMPONENT_VARIATION(uLocal_49[iParam0], PV_COMP_HEAD, 0, 1, 0);
				PED::SET_PED_COMPONENT_VARIATION(uLocal_49[iParam0], PV_COMP_HAIR, 1, 1, 0);
				PED::SET_PED_COMPONENT_VARIATION(uLocal_49[iParam0], PV_COMP_UPPR, 1, 1, 0);
				PED::SET_PED_COMPONENT_VARIATION(uLocal_49[iParam0], PV_COMP_LOWR, 1, 1, 0);
				break;
			...
			case 3:
				PED::SET_PED_COMPONENT_VARIATION(uLocal_49[iParam0], PV_COMP_HEAD, 0, 1, 0);
				PED::SET_PED_COMPONENT_VARIATION(uLocal_49[iParam0], PV_COMP_HAIR, 0, 1, 0);
				PED::SET_PED_COMPONENT_VARIATION(uLocal_49[iParam0], PV_COMP_UPPR, 1, 0, 0);
				PED::SET_PED_COMPONENT_VARIATION(uLocal_49[iParam0], PV_COMP_LOWR, 0, 2, 0);
				break;
		
			case 4:
				PED::SET_PED_COMPONENT_VARIATION(uLocal_49[iParam0], PV_COMP_HEAD, 0, 2, 0);
				PED::SET_PED_COMPONENT_VARIATION(uLocal_49[iParam0], PV_COMP_HAIR, 1, 2, 0);
				PED::SET_PED_COMPONENT_VARIATION(uLocal_49[iParam0], PV_COMP_UPPR, 0, 2, 0);
				PED::SET_PED_COMPONENT_VARIATION(uLocal_49[iParam0], PV_COMP_LOWR, 0, 2, 0);
				break;
		
			case 5:
				PED::SET_PED_COMPONENT_VARIATION(uLocal_49[iParam0], PV_COMP_HEAD, 1, 2, 0);
				PED::SET_PED_COMPONENT_VARIATION(uLocal_49[iParam0], PV_COMP_HAIR, 1, 0, 0);
				PED::SET_PED_COMPONENT_VARIATION(uLocal_49[iParam0], PV_COMP_UPPR, 1, 1, 0);
				PED::SET_PED_COMPONENT_VARIATION(uLocal_49[iParam0], PV_COMP_LOWR, 0, 1, 0);
				break;
		
			case 6:
				PED::SET_PED_COMPONENT_VARIATION(uLocal_49[iParam0], PV_COMP_HEAD, 1, 1, 0);
				PED::SET_PED_COMPONENT_VARIATION(uLocal_49[iParam0], PV_COMP_HAIR, 2, 0, 0);
				PED::SET_PED_COMPONENT_VARIATION(uLocal_49[iParam0], PV_COMP_UPPR, 2, 2, 0);
				PED::SET_PED_COMPONENT_VARIATION(uLocal_49[iParam0], PV_COMP_LOWR, 0, 1, 0);
				break;
			...
			case 7:
				PED::SET_PED_COMPONENT_VARIATION(uLocal_49[iParam0], PV_COMP_HEAD, 0, 2, 0);
				PED::SET_PED_COMPONENT_VARIATION(uLocal_49[iParam0], PV_COMP_HAIR, 0, 0, 0);
				PED::SET_PED_COMPONENT_VARIATION(uLocal_49[iParam0], PV_COMP_UPPR, 1, 2, 0);
				PED::SET_PED_COMPONENT_VARIATION(uLocal_49[iParam0], PV_COMP_LOWR, 0, 0, 0);
				break;
		}
	}
...
BOOL func_88() // Position - 0x78F1
{
	...
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_49[0]) && func_81(PLAYER::PLAYER_PED_ID(), uLocal_49[0], true) >= 200f && _DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_49[1]) && func_81(PLAYER::PLAYER_PED_ID(), uLocal_49[1], true) >= 200f)
		return true;

	if (func_154(10) && !_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_49[0]) || func_154(11) && !_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_49[1]))
		return true;

	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_49[0]) && PED::IS_PED_IN_COMBAT(uLocal_49[0], PLAYER::PLAYER_PED_ID()) || !PED::IS_PED_IN_ANY_VEHICLE(uLocal_49[0], false) || _DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_49[1]) && PED::IS_PED_IN_COMBAT(uLocal_49[1], PLAYER::PLAYER_PED_ID()) || !PED::IS_PED_IN_ANY_VEHICLE(uLocal_49[1], false))
		return true;

	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_90[1]) && ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(uLocal_90[1], PLAYER::PLAYER_PED_ID(), true) || _DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_90[2]) && ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(uLocal_90[2], PLAYER::PLAYER_PED_ID(), true))
		return true;

	if (func_89(uLocal_90[3]) || func_89(uLocal_90[4]))
		return true;
	...
	if (PED::IS_PED_TRYING_TO_ENTER_A_LOCKED_VEHICLE(PLAYER::PLAYER_PED_ID()))
	{
		...
		if (vehicle == uLocal_90[3] && _DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_49[0]) || vehicle == uLocal_90[4] && _DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_49[1]))
			return true;
	}
...
{
	func_111(8);
	VEHICLE::SET_VEHICLE_FORWARD_SPEED(uLocal_90[iParam0], 5f);
	uLocal_49[iParam1].f_1 = func_73(uLocal_49[iParam1], true, 145);
	PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uLocal_49[iParam1], true);
	func_94();
	TASK::TASK_VEHICLE_DRIVE_TO_COORD(0, uLocal_90[iParam0], ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uLocal_90[iParam0], 0f, 20f, 0f), 30f, 0, 0, 262144, 4f, -1f);
	TASK::TASK_SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(0, false);
	TASK::TASK_COMBAT_PED(0, PLAYER::PLAYER_PED_ID(), 0, 16);
	func_93(uLocal_49[iParam1]);
	func_91(uLocal_49[iParam1], "GENERIC_INSULT_HIGH", 13);
	uLocal_49[iParam1].f_3 = 3;
	...
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_90[iParam2]))
	{
		...
		if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_49[iParam3]))
		{
			PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uLocal_49[iParam3], true);
			TASK::TASK_VEHICLE_MISSION(uLocal_49[iParam3], uLocal_90[iParam2], uLocal_90[0], 2, 30f, 262144, -1f, -1f, true);
		}
	
		uLocal_49[iParam3].f_3 = uLocal_49[iParam3].f_3 + 1;
	}
...
{
	return _DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_90[0]) && PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), uLocal_90[0], false);
}
...
int func_107(int iParam0, var uParam1, var uParam2, var uParam3, int iParam4, BOOL bParam5) // Position - 0x84A3
{
	...
	if (!ENTITY::DOES_ENTITY_EXIST(uLocal_90[iParam0]))
	{
		doorLockStatus = 0;
		toggle = true;
		toggle2 = true;
		...
		uLocal_90[iParam0] = VEHICLE::CREATE_VEHICLE(model, vector, heading, true, true, false);
		func_110(iParam0);
		func_109(iParam0);
		ENTITY::SET_ENTITY_VISIBLE(uLocal_90[iParam0], toggle2, false);
	
		if (ENTITY::DOES_ENTITY_EXIST(entity2))
			ENTITY::ATTACH_ENTITY_TO_ENTITY(uLocal_90[iParam0], entity2, -1, vector2, vector3, false, false, false, false, 2, true, 0);
		else
			ENTITY::SET_ENTITY_COLLISION(uLocal_90[iParam0], toggle, false);
	
		VEHICLE::SET_VEHICLE_STRONG(uLocal_90[iParam0], toggle3);
		ENTITY::FREEZE_ENTITY_POSITION(uLocal_90[iParam0], toggle4);
		VEHICLE::SET_VEHICLE_ENGINE_ON(uLocal_90[iParam0], value, true, false);
		ENTITY::SET_ENTITY_INVINCIBLE(uLocal_90[iParam0], toggle5);
		ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(uLocal_90[iParam0], toggle6, 1);
		VEHICLE::SET_VEHICLE_CAN_BE_TARGETTED(uLocal_90[iParam0], flag3);
		VEHICLE::SET_FORCE_VEHICLE_ENGINE_DAMAGE_BY_BULLET(uLocal_90[iParam0], flag4);
		VEHICLE::SET_VEHICLE_AUTOMATICALLY_ATTACHES(uLocal_90[iParam0], flag5, 0);
		VEHICLE::SET_VEHICLE_DISABLE_TOWING(uLocal_90[iParam0], toggle7);
		ENTITY::SET_ENTITY_ONLY_DAMAGED_BY_PLAYER(uLocal_90[iParam0], toggle8);
		VEHICLE::SET_VEHICLE_TYRES_CAN_BURST(uLocal_90[iParam0], toggle9);
		VEHICLE::SET_VEHICLE_NEEDS_TO_BE_HOTWIRED(uLocal_90[iParam0], toggle10);
		ENTITY::SET_ENTITY_COMPLETELY_DISABLE_COLLISION(uLocal_90[iParam0], !flag6, false);
	
		if (!MISC::IS_STRING_NULL_OR_EMPTY(plateText))
			VEHICLE::SET_VEHICLE_NUMBER_PLATE_TEXT(uLocal_90[iParam0], plateText);
	
		if (speed > 0f)
			VEHICLE::SET_VEHICLE_FORWARD_SPEED(uLocal_90[iParam0], speed);
	
		if (flag)
			VEHICLE::SET_HELI_BLADES_FULL_SPEED(uLocal_90[iParam0]);
	
		if (multiplier >= 0f)
			VEHICLE::SET_PLANE_TURBULENCE_MULTIPLIER(uLocal_90[iParam0], multiplier);
	
		if (num >= 0f)
			VEHICLE::SET_HELI_TURBULENCE_SCALAR(uLocal_90[iParam0], num);
	
		if (doorLockStatus != 0)
			VEHICLE::SET_VEHICLE_DOORS_LOCKED(uLocal_90[iParam0], doorLockStatus);
	
		if (bParam5)
			uLocal_90[iParam0].f_1 = func_108(uLocal_90[iParam0], flag2, false);
	}
...
{
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_90[iParam0]))
	{
		switch (iParam0)
		{
			case 5:
			...
			case 3:
			case 4:
				VEHICLE::SET_VEHICLE_DIRT_LEVEL(uLocal_90[iParam0], 15f);
				break;
		}
	}
...
void func_110(int iParam0) // Position - 0x889E
{
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_90[iParam0]))
	{
		...
		{
			case 5:
				VEHICLE::SET_VEHICLE_COLOURS(uLocal_90[iParam0], 48, 48);
				VEHICLE::SET_VEHICLE_EXTRA_COLOURS(uLocal_90[iParam0], 8, 156);
				break;
		
			case 6:
				VEHICLE::SET_VEHICLE_COLOURS(uLocal_90[iParam0], 58, 58);
				VEHICLE::SET_VEHICLE_EXTRA_COLOURS(uLocal_90[iParam0], 8, 156);
				break;
		
			case 7:
				VEHICLE::SET_VEHICLE_COLOURS(uLocal_90[iParam0], 94, 94);
				VEHICLE::SET_VEHICLE_EXTRA_COLOURS(uLocal_90[iParam0], 8, 156);
				break;
		
			case 3:
			case 4:
				VEHICLE::SET_VEHICLE_COLOURS(uLocal_90[iParam0], 0, 0);
				VEHICLE::SET_VEHICLE_EXTRA_COLOURS(uLocal_90[iParam0], 61, 156);
				break;
		}
	}
...
void _MPCHAR_STAT_SET_INT(eMPStat empsParam0, int iParam1, int iParam2, BOOL bParam3, BOOL bParam4) // Position - 0x8AB2
{
	...
	bParam4;
	statName = Global_2805029[empsParam0][func_117(iParam2)];
...
int _MPCHAR_STAT_GET_INT(eMPStat empsParam0, int iParam1, int iParam2) // Position - 0x8B16
{
	...
	{
		iParam2 == 0;
		statHash = Global_2805029[empsParam0][func_117(iParam1)];
...
void func_123() // Position - 0x8FD7
{
	...
	if (func_154(5) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_90[iLocal_173]) && MISC::GET_GAME_TIMER() < iLocal_157)
		AUDIO::SET_HORN_PERMANENTLY_ON(uLocal_90[iLocal_173]);
	...
	if (func_154(9) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_90[0]) && func_81(PLAYER::PLAYER_PED_ID(), uLocal_90[0], true) <= 35f)
	{
		if (!func_154(10))
		{
			if (!CAM::IS_SPHERE_VISIBLE(uLocal_132, 7f))
			{
				if (MISC::GET_GAME_TIMER() - iLocal_162 >= 1000 && !func_78(uLocal_132, 7f) && func_82(PLAYER::PLAYER_PED_ID(), uLocal_132, true) >= 50f)
				{
					...
					VEHICLE::ATTACH_VEHICLE_TO_TRAILER(uLocal_90[3], uLocal_90[1], 1065353216);
		...
		if (!func_154(11))
		{
			if (!CAM::IS_SPHERE_VISIBLE(uLocal_135, 7f))
			{
				if (MISC::GET_GAME_TIMER() - iLocal_163 >= 1000 && !func_78(uLocal_135, 7f) && func_82(PLAYER::PLAYER_PED_ID(), uLocal_135, true) >= 50f)
				{
					...
					VEHICLE::ATTACH_VEHICLE_TO_TRAILER(uLocal_90[4], uLocal_90[2], 1065353216);
...
void func_124() // Position - 0x92BF
{
	...
	for (i = 0; i < 8; i = i + 1)
	{
		if (ENTITY::DOES_ENTITY_EXIST(uLocal_49[i]) && HUD::DOES_BLIP_EXIST(uLocal_49[i].f_1))
		{
			if (PED::IS_PED_IN_ANY_VEHICLE(uLocal_49[i], false))
			{
				if (!func_128(i, 0))
				...
				if (_GET_VEHICLE_SEAT_PED_IS_IN(uLocal_49[i], false) != -1)
				{
					if (func_127(i))
					{
						if (HUD::GET_BLIP_ALPHA(uLocal_49[i].f_1) > 0)
						{
							HUD::SET_BLIP_ALPHA(uLocal_49[i].f_1, 0);
							HUD::SET_BLIP_HIDDEN_ON_LEGEND(uLocal_49[i].f_1, true);
						}
					}
					else if (HUD::GET_BLIP_ALPHA(uLocal_49[i].f_1) == 0)
					{
						HUD::SET_BLIP_ALPHA(uLocal_49[i].f_1, 255);
						HUD::SET_BLIP_HIDDEN_ON_LEGEND(uLocal_49[i].f_1, false);
					}
				}
			}
			else if (func_128(i, 0))
			{
				HUD::SET_BLIP_SCALE(uLocal_49[i].f_1, 0.7f);
				func_126(i, 0);
			...
			if (PED::IS_PED_INJURED(uLocal_49[i]))
				func_125(&(uLocal_49[i].f_1));
		}
	}

	for (i = 0; i < 8; i = i + 1)
	{
		if (ENTITY::DOES_ENTITY_EXIST(uLocal_90[i]) && HUD::DOES_BLIP_EXIST(uLocal_90[i].f_1))
			if (!VEHICLE::IS_VEHICLE_DRIVEABLE(uLocal_90[i], false))
				func_125(&(uLocal_90[i].f_1));
	}
...
{
	MISC::CLEAR_BIT(&(uLocal_49[iParam0].f_2), iParam1);
	return;
}
...
{
	if (iParam0 == 3)
		if (!_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_49[2]))
			return false;

	if (iParam0 == 5)
		if (!_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_49[4]))
			return false;

	if (iParam0 == 7)
		if (!_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_49[6]))
			return false;
...
{
	return IS_BIT_SET(uLocal_49[iParam0].f_2, iParam1);
}
...
void func_129() // Position - 0x94E1
{
	...
	for (i = 0; i < 8; i = i + 1)
	{
		if (ENTITY::DOES_ENTITY_EXIST(uLocal_90[i]))
			func_130(i);
	}
...
void func_130(int iParam0) // Position - 0x950F
{
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_90[iParam0]))
	{
		...
		{
			case 5:
				if (!_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_49[2]) && !_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_49[3]) || !VEHICLE::IS_VEHICLE_DRIVEABLE(uLocal_90[iParam0], false))
					func_131(iParam0, false);
				break;
		
			case 6:
				if (!_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_49[4]) && !_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_49[5]) || !VEHICLE::IS_VEHICLE_DRIVEABLE(uLocal_90[iParam0], false))
					func_131(iParam0, false);
				break;
		
			case 7:
				if (!_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_49[6]) && !_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_49[7]) || !VEHICLE::IS_VEHICLE_DRIVEABLE(uLocal_90[iParam0], false))
					func_131(iParam0, false);
				break;
		
			case 3:
				if (!_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_49[0]) || !VEHICLE::IS_VEHICLE_DRIVEABLE(uLocal_90[iParam0], false))
					if (func_81(PLAYER::PLAYER_PED_ID(), uLocal_90[iParam0], true) >= 50f)
						func_131(iParam0, false);
			...
			case 4:
				if (!_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_49[1]) || !VEHICLE::IS_VEHICLE_DRIVEABLE(uLocal_90[iParam0], false))
					if (func_81(PLAYER::PLAYER_PED_ID(), uLocal_90[iParam0], true) >= 50f)
						func_131(iParam0, false);
			...
			case 1:
				if (!_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_90[3]) || func_81(uLocal_90[3], uLocal_90[iParam0], true) >= 150f)
					func_131(iParam0, false);
				break;
		
			case 2:
				if (!_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_90[4]) || func_81(uLocal_90[4], uLocal_90[iParam0], true) >= 150f)
					func_131(iParam0, false);
				break;
		
			case 0:
				switch (uLocal_90[iParam0].f_3)
				{
					case 0:
						if (func_96())
						{
							func_111(1);
							func_125(&(uLocal_90[iParam0].f_1));
							uLocal_90[iParam0].f_3 = uLocal_90[iParam0].f_3 + 1;
						}
						break;
				}
				break;
	...
	else if (ENTITY::IS_ENTITY_VISIBLE(uLocal_90[iParam0]))
	{
		func_131(iParam0, false);
	}
	else
...
void func_131(int iParam0, BOOL bParam1) // Position - 0x977F
{
	if (ENTITY::DOES_ENTITY_EXIST(uLocal_90[iParam0]))
	{
		...
		if (VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(uLocal_90[iParam0]))
			VEHICLE::STOP_PLAYBACK_RECORDED_VEHICLE(uLocal_90[iParam0]);
	
		if (func_132(&uLocal_90[iParam0]))
			if (bParam1)
				VEHICLE::DELETE_VEHICLE(&uLocal_90[iParam0]);
			else
				ENTITY::SET_VEHICLE_AS_NO_LONGER_NEEDED(&uLocal_90[iParam0]);
	
		uLocal_90[iParam0] = 0;
		uLocal_90[iParam0].f_2 = 0;
		uLocal_90[iParam0].f_3 = 0;
	}
...
void func_134(int iParam0) // Position - 0x9843
{
	...
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_49[iParam0]))
	{
		switch (iParam0)
		{
			...
			case 1:
				...
				switch (uLocal_49[iParam0].f_3)
				{
					case 0:
						uLocal_49[iParam0].f_4 = MISC::GET_GAME_TIMER();
					
						if (func_81(uLocal_49[iParam0], PLAYER::PLAYER_PED_ID(), true) <= 15f)
							PED::SET_IK_TARGET(uLocal_49[iParam0], 1, PLAYER::PLAYER_PED_ID(), 31086, uLocal_123, 0, -1, -1);
						break;
				
					case 1:
						if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_90[num]))
						{
							VEHICLE::SET_VEHICLE_USE_MORE_RESTRICTIVE_SPAWN_CHECKS(uLocal_90[num], true);
						
							if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_90[0]) && !ENTITY::IS_ENTITY_TOUCHING_ENTITY(uLocal_90[num], uLocal_90[0]))
							{
								if (MISC::GET_GAME_TIMER() >= iLocal_161 && !func_154(12) && !ENTITY::IS_ENTITY_AT_COORD(uLocal_90[num], uLocal_138, 7f, 7f, 7f, false, true, 0) && func_82(PLAYER::PLAYER_PED_ID(), uLocal_138, true) < func_81(uLocal_90[num], PLAYER::PLAYER_PED_ID(), true) && !CAM::IS_SPHERE_VISIBLE(uLocal_138, 7f) && !CAM::IS_SPHERE_VISIBLE(ENTITY::GET_ENTITY_COORDS(uLocal_90[num], true), 7f) && !func_78(uLocal_138, 8f))
								{
									...
									ENTITY::SET_ENTITY_COORDS(uLocal_90[num], uLocal_138, true, false, false, true);
									VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(uLocal_90[num], 1084227584);
									ENTITY::SET_ENTITY_HEADING(uLocal_90[num], heading);
									VEHICLE::SET_VEHICLE_ENGINE_ON(uLocal_90[num], true, true, false);
									VEHICLE::SET_VEHICLE_FORWARD_SPEED(uLocal_90[num], 30f);
									func_111(5);
									iLocal_173 = num;
									iLocal_157 = MISC::GET_GAME_TIMER() + 5000;
								}
							
								if (!func_154(12) && ENTITY::IS_ENTITY_AT_COORD(uLocal_90[num], uLocal_138, 7f, 7f, 7f, false, true, 0))
									func_111(12);
								...
								if (MISC::GET_GAME_TIMER() >= iLocal_161 && ENTITY::IS_ENTITY_OCCLUDED(uLocal_90[num]) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_90[num2]) && func_81(uLocal_90[num], uLocal_90[num2], true) >= 20f)
								{
									...
									{
										entitySpeed = ENTITY::GET_ENTITY_SPEED(uLocal_90[num]);
										entitySpeed = func_137(entitySpeed, 20f, 50f);
										ENTITY::SET_ENTITY_HEADING(uLocal_90[num], func_77(ENTITY::GET_ENTITY_COORDS(uLocal_90[num], true), ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true)));
										VEHICLE::SET_VEHICLE_FORWARD_SPEED(uLocal_90[num], entitySpeed);
									}
								}
							
								if (func_128(iParam0, 3) || func_81(uLocal_49[iParam0], PLAYER::PLAYER_PED_ID(), true) <= 15f || _DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_90[num2]) && func_81(uLocal_90[num], uLocal_90[num2], true) <= 15f)
								{
									if (func_81(uLocal_49[iParam0], PLAYER::PLAYER_PED_ID(), true) <= 15f)
									{
										if (!HUD::DOES_BLIP_EXIST(uLocal_49[iParam0].f_1))
										{
											uLocal_49[iParam0].f_1 = func_73(uLocal_49[iParam0], true, 145);
											func_91(uLocal_49[iParam0], "GENERIC_INSULT_HIGH", 13);
										}
									}
								
									uLocal_49[iParam0].f_3 = uLocal_49[iParam0].f_3 + 1;
								}
							}
							else
							{
					...
					case 2:
						if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_90[num]))
						{
							PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uLocal_49[iParam0], false);
							TASK::TASK_COMBAT_PED(uLocal_49[iParam0], PLAYER::PLAYER_PED_ID(), 0, 16);
							uLocal_49[iParam0].f_3 = uLocal_49[iParam0].f_3 + 1;
						}
						break;
					...
					case 3:
						if (!HUD::DOES_BLIP_EXIST(uLocal_49[iParam0].f_1))
							if (func_81(PLAYER::PLAYER_PED_ID(), uLocal_49[iParam0], true) <= 85f)
								uLocal_49[iParam0].f_1 = func_73(uLocal_49[iParam0], true, 145);
					
						if (func_154(6) || func_154(8))
							if (!PED::IS_PED_IN_ANY_VEHICLE(uLocal_49[iParam0], false) && func_81(uLocal_49[iParam0], PLAYER::PLAYER_PED_ID(), true) >= 250f)
								func_136(iParam0, false);
						else if (func_81(uLocal_49[iParam0], PLAYER::PLAYER_PED_ID(), true) >= 250f)
							func_136(iParam0, false);
						break;
				}
				break;
			...
			case 7:
				if (func_154(7))
					if (!PED::IS_PED_IN_COMBAT(uLocal_49[iParam0], PLAYER::PLAYER_PED_ID()) && !func_135(uLocal_49[iParam0], SCRIPT_TASK_VEHICLE_CHASE, true))
						TASK::TASK_COMBAT_PED(uLocal_49[iParam0], PLAYER::PLAYER_PED_ID(), 0, 16);
			
				if (func_154(7))
					if (!PED::IS_PED_IN_ANY_VEHICLE(uLocal_49[iParam0], false) && func_81(uLocal_49[iParam0], PLAYER::PLAYER_PED_ID(), true) >= 250f)
						func_136(iParam0, false);
				else if (func_154(2) && func_81(uLocal_49[iParam0], PLAYER::PLAYER_PED_ID(), true) >= 250f)
					func_136(iParam0, false);
				break;
		}
	}
	else
	{
		...
		{
			PED::SET_PED_CAN_RAGDOLL(uLocal_49[iParam0], true);
			ENTITY::DETACH_ENTITY(uLocal_49[iParam0], true, false);
			func_126(iParam0, 1);
		}
	
		if (!func_128(iParam0, 2))
			if (ENTITY::IS_ENTITY_VISIBLE(uLocal_49[iParam0]))
				func_136(iParam0, false);
			else
...
void func_136(int iParam0, BOOL bParam1) // Position - 0x9E7F
{
	if (ENTITY::DOES_ENTITY_EXIST(uLocal_49[iParam0]))
	{
		func_125(&(uLocal_49[iParam0].f_1));
	
		if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_49[iParam0]) && ENTITY::IS_ENTITY_ATTACHED(uLocal_49[iParam0]) && !PED::IS_PED_IN_ANY_VEHICLE(uLocal_49[iParam0], true) && !PED::IS_PED_SITTING_IN_ANY_VEHICLE(uLocal_49[iParam0]) && !PED::IS_PED_GETTING_INTO_A_VEHICLE(uLocal_49[iParam0]))
			ENTITY::DETACH_ENTITY(uLocal_49[iParam0], true, true);
	
		if (bParam1)
			PED::DELETE_PED(&uLocal_49[iParam0]);
		else
			ENTITY::SET_PED_AS_NO_LONGER_NEEDED(&uLocal_49[iParam0]);
	
		uLocal_49[iParam0].f_2 = 0;
	}
...
void func_138() // Position - 0x9F45
{
	if (func_154(1) || iLocal_155 > 2 && func_139())
		if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_90[0]) && func_81(PLAYER::PLAYER_PED_ID(), uLocal_90[0], true) >= 250f)
			func_63();

	if (func_139())
		if (ENTITY::DOES_ENTITY_EXIST(uLocal_90[0]) && !_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_90[0]))
			func_63();
...
BOOL func_139() // Position - 0x9FB7
{
	...
	for (i = 0; i < 8; i = i + 1)
	{
		if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_49[i]) && HUD::DOES_BLIP_EXIST(uLocal_49[i].f_1))
		{
			num = 0;
			i = 8;
		}
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					...
					case 1:
						if (PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_192() || Global_32166 || func_191() || func_190(8, -1) || func_187() || func_189() || func_188() || func_186() || G_SomeGlobalState.MessageCallStates.f_919[character] == 5)
							return false;
						break;
				
					case 2:
						if (!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_192() || Global_112695 || Global_32166 || func_191() || func_190(8, -1) || func_187() || func_189() || func_188() || func_186() || G_SomeGlobalState.MessageCallStates.f_919[character] == 5 || LastDispatchedMessageOrCall != -1)
							return false;
						break;
					...
					case 4:
						if (func_192() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0 || func_190(8, -1) || func_186() || func_185() || G_SomeGlobalState.MessageCallStates.f_919[character] == 5)
							return false;
						break;
...
void func_200(BOOL bParam0, BOOL bParam1) // Position - 0xD2D8
{
	...
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_90[0]))
		VEHICLE::SET_VEHICLE_TYRES_CAN_BURST(uLocal_90[0], true);
