...
{
	Global_113810.f_243[func_92()].f_2[iParam0].f_1 = iParam1;
	return;
}
...
void func_98(int iParam0) // Position - 0x4213
{
	...
	else if (IS_BIT_SET(Global_113810.f_20567.f_471, iParam0) || IS_BIT_SET(Global_2359296[func_82()].f_681.f_10, iParam0))
	{
		flag = true;
		MISC::CLEAR_BIT(&(Global_113810.f_20567.f_471), iParam0);
