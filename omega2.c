...
void func_19() // Position - 0x97D
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (_GET_CHARACTER_MODEL(G_MissionStats.f_2366.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			{
				if (G_MissionStats.f_2366.f_539.f_4321 != character && func_20(G_MissionStats.f_2366.f_539.f_4321))
...
int func_65(Ped pedParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x17E1
{
	...
	if (iParam5 == 0)
	{
		Global_78472[1] = { func_118(entityModel, iParam1, iParam2, -1) };
	...
	if (iParam1 == 12)
	{
		...
		for (i = 0; i <= 14; i = i + 1)
		{
			if (unk[i] != -99)
			{
				Global_78472[1] = { func_118(entityModel, i, unk[i], -1) };
				...
				if (IS_BIT_SET(Global_78472[1].f_6, 0))
				{
					if (i == 13)
					{
						...
						for (j = 0; j <= 8; j = j + 1)
						{
							Global_78472[1] = { func_118(entityModel, 14, unk18[j], -1) };
							func_85(pedParam0, Global_78472[1].f_12, Global_78472[1].f_3, Global_78472[1].f_4);
							func_108(14);
					...
					else if (i != 14 && i != 12)
					{
						...
						if (iParam4 == -1)
							PED::SET_PED_COMPONENT_VARIATION(pedParam0, func_75(i), Global_78472[1].f_3, Global_78472[1].f_4, PED::GET_PED_PALETTE_VARIATION(pedParam0, func_75(i)));
						else
							PED::SET_PED_COMPONENT_VARIATION(pedParam0, func_75(i), Global_78472[1].f_3, Global_78472[1].f_4, iParam4);
			...
			{
				Global_78472[1] = { func_118(entityModel, i, func_74(pedParam0, i, PV_COMP_INVALID), -1) };
	...
	else if (iParam1 == 13)
	{
		...
		for (j = 0; j <= 8; j = j + 1)
		{
			Global_78472[1] = { func_118(entityModel, 14, unk59[j], -1) };
			func_85(pedParam0, Global_78472[1].f_12, Global_78472[1].f_3, Global_78472[1].f_4);
			func_108(14);
	...
	{
		if (iParam4 == -1)
			PED::SET_PED_COMPONENT_VARIATION(pedParam0, func_75(iParam1), Global_78472[1].f_3, Global_78472[1].f_4, PED::GET_PED_PALETTE_VARIATION(pedParam0, func_75(iParam1)));
		else
			PED::SET_PED_COMPONENT_VARIATION(pedParam0, func_75(iParam1), Global_78472[1].f_3, Global_78472[1].f_4, iParam4);
...
BOOL func_66(Ped pedParam0, Hash hParam1, var uParam2) // Position - 0x1FF2
{
	...
	{
		if (!func_182(pedParam0, G_MissionStats.f_2366.f_539[num].f_64, G_MissionStats.f_2366.f_539[num].f_63))
		{
...
{
	Global_78472[1] = { func_118(hParam0, iParam1, iParam2, -1) };
...
BOOL func_73(Ped pedParam0, Hash hParam1, var uParam2, int iParam3) // Position - 0x28E6
{
	...
	{
		if (!func_182(pedParam0, G_MissionStats.f_2366.f_539[num].f_61, G_MissionStats.f_2366.f_539[num].f_60) || iParam3 == 1)
		{
...
void func_108(int iParam0) // Position - 0x873F
{
	if (IS_BIT_SET(Global_78472[1].f_6, 1) && !IS_BIT_SET(Global_78472[1].f_6, 6))
		func_116(iParam0, Global_78472[1].f_5, Global_78472[1].f_2, 2, Global_78472[1].f_1, 1, 0);
...
void func_120(int iParam0) // Position - 0xC309
{
	...
	func_121(&Global_78472[0], num6, iParam0, &unk, num2, num3, num, flag, num4, num5, false);
	return;
}
...
void func_127(int iParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0xE5EA
{
	...
	if (iParam0 == 12)
	{
		...
		if (outfitIndex >= 0)
		{
			...
			if (num3 > outfitIndex)
			{
				...
				func_121(&Global_78472[0], iParam0, iParam1, &(outfit.f_7), 0, 0, outfit.f_2, false, -1, 2, true);
				return;
			}
		}
	}
	...
	{
		func_121(&Global_78472[0], iParam0, iParam1, "NO_LABEL", 0, 0, 0, true, -1, 2, true);
	}
	else if (iParam0 == 14)
	{
		FILES::INIT_SHOP_PED_PROP(&outProp);
		...
		if (componentId >= 0)
		{
			...
			if (num5 > componentId)
			{
				...
				func_121(&Global_78472[0], iParam0, iParam1, &(outProp.f_9), outProp.f_3, outProp.f_4, outProp.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(outProp.f_1, joaat("OUTFIT_ONLY"), 0), num4, 2, outProp.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (hParam3 != -1 && Global_78670)
		{
			...
			func_121(&Global_78472[0], iParam0, iParam1, &(outComponent.f_9), outComponent.f_3, outComponent.f_4, outComponent.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(outComponent.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, outComponent.f_1 != 0);
			return;
		}
...
BOOL func_182(Ped pedParam0, int iParam1, int iParam2) // Position - 0x1F975
{
			...
			if (unk[i] != -99 && i != 12 && i != 14)
			{
				if (!func_182(pedParam0, i, unk[i]))
				{
					if (i == 13)
					{
						...
						for (j = 0; j <= 8; j = j + 1)
						{
							if (!func_182(pedParam0, 14, unk18[j]))
							{
								for (k = 0; k <= 19; k = k + 1)
								{
									Global_78472[2] = { func_118(entityModel, 14, k, -1) };
								
									if (Global_78472[2].f_12 == j)
										if (func_182(pedParam0, 14, k))
											if (!func_71(entityModel, iParam2, 14, k, &unk, &Global_78472[2]))
												return false;
								}
							}
						}
					...
					else
					{
						...
						Global_78472[2] = { func_118(entityModel, i, num, -1) };
					
						if (!func_71(entityModel, iParam2, i, num, &unk, &Global_78472[2]))
							return false;
					}
				}
			}
	...
	else if (Global_78472[1].f_3 == PED::GET_PED_DRAWABLE_VARIATION(pedParam0, func_75(iParam1)) && Global_78472[1].f_4 == PED::GET_PED_TEXTURE_VARIATION(pedParam0, func_75(iParam1)))
	{
		return true;
	}
...
BOOL func_198(Vehicle veParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, float fParam7) // Position - 0x20463
{
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(veParam0, false))
	{
		...
		if (func_199(unk18[0], unk18[1], unk6, unk9) || func_199(unk18[0], unk18[1], unk9, unk15) || func_199(unk18[0], unk18[1], unk12, unk15) || func_199(unk18[0], unk18[1], unk6, unk12) || func_199(unk18[1], unk18[3], unk6, unk9) || func_199(unk18[1], unk18[3], unk9, unk15) || func_199(unk18[1], unk18[3], unk12, unk15) || func_199(unk18[1], unk18[3], unk6, unk12) || func_199(unk18[3], unk18[2], unk6, unk9) || func_199(unk18[3], unk18[2], unk9, unk15) || func_199(unk18[3], unk18[2], unk12, unk15) || func_199(unk18[3], unk18[2], unk6, unk12) || func_199(unk18[2], unk18[0], unk6, unk9) || func_199(unk18[2], unk18[0], unk9, unk15) || func_199(unk18[2], unk18[0], unk12, unk15) || func_199(unk18[2], unk18[0], unk6, unk12))
			return true;
	}
...
BOOL func_228(Ped pedParam0, Ped pedParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0x22A0A
{
	...
	flag = func_229(&iLocal_35[num], pedBoneCoords, pedParam1, &(iLocal_35[num].f_3), pedParam0, iParam5);
...
BOOL func_273(var uParam0) // Position - 0x241AC
{
	...
	switch (iLocal_77)
	{
		case 0:
			uParam0->f_16 = 5;
			uParam0->f_17[0] = { 2337.3762f, 2585.722f, 45.110653f };
			uParam0->f_17[1] = { 2302.158f, 2586.5054f, 47.999573f };
			uParam0->f_24 = 26f;
			uParam0->f_27 = 0;
...
void func_287(int iParam0, BOOL bParam1) // Position - 0x24719
{
	...
	{
		func_328(&(Global_112897[num].f_9));
	}
...
void func_290() // Position - 0x2497E
{
	...
	if (value > 0f && SYSTEM::FLOOR(value) < SYSTEM::FLOOR(G_MissionStats.f_10197.f_3853))
		func_292(13, SYSTEM::FLOOR(G_MissionStats.f_10197.f_3853));
...
void func_304(var uParam0) // Position - 0x2506B
{
	...
	*uParam0 = 145;
	...
	for (j = 0; j < 3; j = j + 1)
	{
		...
		uParam0->f_17[j] = 0;
		uParam0->f_21[j] = 0;
		func_309(&uParam0->f_25[0][j]);
		func_309(&uParam0->f_25[1][j]);
...
BOOL func_314(Ped pedParam0, int iParam1, int iParam2) // Position - 0x25958
{
	...
	{
		unk28 = { func_98(entityModel, 0) };
		Global_78472[1] = { func_118(entityModel, iParam1, unk28[iParam1], -1) };
	
		if (PED::GET_NUMBER_OF_PED_DRAWABLE_VARIATIONS(pedParam0, func_75(iParam1)) > 0 && PED::GET_NUMBER_OF_PED_TEXTURE_VARIATIONS(pedParam0, func_75(iParam1), Global_78472[1].f_3) > 0)
			PED::SET_PED_COMPONENT_VARIATION(pedParam0, func_75(iParam1), Global_78472[1].f_3, Global_78472[1].f_4, 0);
	}
...
void func_322() // Position - 0x25D28
{
	...
	{
		func_19();
		GRAPHICS::SET_NEXT_PLAYER_TCMODIFIER(func_323(G_MissionStats.f_2366.f_539.f_4321));
	}
	else
	{
...
void func_331(int iParam0) // Position - 0x2632D
{
	...
	G_MissionStats.f_18577[iParam0].f_3 = func_332();
