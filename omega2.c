...
void main() // Position - 0x0
{
	...
	uLocal_160 = Vector3(2328.6006f, 2570.337f, 46.808f);
	uLocal_163 = Vector3(90f, 0f, -45.358f);
...
int func_65(Ped pedParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x17E1
{
	...
	if (iParam5 == 0)
	{
		Global_78341[1] = Vector3(func_117(entityModel, iParam1, iParam2, -1));
	...
	if (iParam1 == 12)
	{
		...
		if (iParam5 == 1)
			...
			unk = Vector3(func_98(entityModel, iParam2));
	
		for (i = 0; i <= 14; i = i + 1)
		{
			if (unk[i] != -99)
			{
				Global_78341[1] = Vector3(func_117(entityModel, i, unk[i], -1));
				...
				if (IS_BIT_SET(Global_78341[1].f_6, 0))
				{
					if (i == 13)
					{
						...
						if (iParam5 == 1)
							...
							unk18 = Vector3(func_95(entityModel, unk[i]));
					
						for (j = 0; j <= 8; j = j + 1)
						{
							Global_78341[1] = Vector3(func_117(entityModel, 14, unk18[j], -1));
							func_85(pedParam0, Global_78341[1].f_12, Global_78341[1].f_3, Global_78341[1].f_4);
							func_108(14);
			...
			{
				Global_78341[1] = Vector3(func_117(entityModel, i, func_74(pedParam0, i, PV_COMP_INVALID), -1));
				...
				if (IS_BIT_SET(Global_78341[1].f_6, 3))
				{
					...
					{
						unk28 = Vector3(func_98(entityModel, 0));
		...
		if (iParam7 == 1)
		{
			unk45 = Vector3(func_117(entityModel, 8, num3, -1));
			...
			unk45 = Vector3(func_117(entityModel, 9, num4, -1));
			...
			unk45 = Vector3(func_117(entityModel, 14, num5, -1));
			...
			unk45 = Vector3(func_117(entityModel, 14, num6, -1));
			...
			unk45 = Vector3(func_117(entityModel, 14, num7, -1));
	...
	{
		unk59 = Vector3(func_95(entityModel, iParam2));
	
		for (j = 0; j <= 8; j = j + 1)
		{
			Global_78341[1] = Vector3(func_117(entityModel, 14, unk59[j], -1));
			func_85(pedParam0, Global_78341[1].f_12, Global_78341[1].f_3, Global_78341[1].f_4);
			func_108(14);
...
BOOL func_66(Ped pedParam0, Hash hParam1, var uParam2) // Position - 0x1FF2
{
	...
	{
		if (!func_181(pedParam0, Global_113648.f_2365.f_539[num].f_64, Global_113648.f_2365.f_539[num].f_63))
		{
...
{
	Global_78341[1] = Vector3(func_117(hParam0, iParam1, iParam2, -1));
...
BOOL func_71(Hash hParam0, int iParam1, int iParam2, int iParam3, var uParam4, int iParam5) // Position - 0x2249
{
	...
	if (iParam2 == 14)
	{
		unk = Vector3(func_95(hParam0, uParam4->[13]));
...
BOOL func_73(Ped pedParam0, Hash hParam1, var uParam2, int iParam3) // Position - 0x28E6
{
	...
	{
		if (!func_181(pedParam0, Global_113648.f_2365.f_539[num].f_61, Global_113648.f_2365.f_539[num].f_60) || iParam3 == 1)
		{
...
void func_108(int iParam0) // Position - 0x873F
{
	if (IS_BIT_SET(Global_78341[1].f_6, 1) && !IS_BIT_SET(Global_78341[1].f_6, 6))
		func_115(iParam0, Global_78341[1].f_5, Global_78341[1].f_2, 2, Global_78341[1].f_1, 1, 0);
...
void _MPCHAR_STAT_SET_INT(eMPStat empsParam0, int iParam1, int iParam2, BOOL bParam3, BOOL bParam4) // Position - 0x8835
{
	...
	bParam4;
	statName = Global_2805029[empsParam0][func_111(iParam2)];
...
int _MPCHAR_STAT_GET_INT(eMPStat empsParam0, int iParam1, int iParam2) // Position - 0x88A5
{
	...
	{
		iParam2 == 0;
		statHash = Global_2805029[empsParam0][func_111(iParam1)];
...
void func_119(int iParam0) // Position - 0xC122
{
	...
	func_120(&Global_78341[0], num6, iParam0, &unk, num2, num3, num, flag, num4, num5, false);
	return;
}
...
void func_126(int iParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0xE407
{
	...
	if (iParam0 == 12)
	{
		...
		if (outfitIndex >= 0)
		{
			...
			if (num3 > outfitIndex)
			{
				...
				func_120(&Global_78341[0], iParam0, iParam1, &(outfit.f_7), 0, 0, outfit.f_2, false, -1, 2, true);
				return;
			}
		}
	}
	...
	{
		func_120(&Global_78341[0], iParam0, iParam1, "NO_LABEL", 0, 0, 0, true, -1, 2, true);
	}
	else if (iParam0 == 14)
	{
		FILES::INIT_SHOP_PED_PROP(&outProp);
		...
		if (componentId >= 0)
		{
			...
			if (num5 > componentId)
			{
				...
				func_120(&Global_78341[0], iParam0, iParam1, &(outProp.f_9), outProp.f_3, outProp.f_4, outProp.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(outProp.f_1, joaat("OUTFIT_ONLY"), 0), num4, 2, outProp.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (hParam3 != -1 && Global_78539)
		{
			...
			func_120(&Global_78341[0], iParam0, iParam1, &(outComponent.f_9), outComponent.f_3, outComponent.f_4, outComponent.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(outComponent.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, outComponent.f_1 != 0);
			return;
		}
...
BOOL func_181(Ped pedParam0, int iParam1, int iParam2) // Position - 0x1F683
{
			...
			if (unk[i] != -99 && i != 12 && i != 14)
			{
				if (!func_181(pedParam0, i, unk[i]))
				{
					if (i == 13)
					{
						...
						for (j = 0; j <= 8; j = j + 1)
						{
							if (!func_181(pedParam0, 14, unk18[j]))
							{
								for (k = 0; k <= 19; k = k + 1)
								{
									Global_78341[2] = Vector3(func_117(entityModel, 14, k, -1));
								
									if (Global_78341[2].f_12 == j)
										if (func_181(pedParam0, 14, k))
											if (!func_71(entityModel, iParam2, 14, k, &unk, &Global_78341[2]))
												return false;
								}
							}
						}
					...
					else
					{
						...
						Global_78341[2] = Vector3(func_117(entityModel, i, num, -1));
					
						if (!func_71(entityModel, iParam2, i, num, &unk, &Global_78341[2]))
							return false;
					}
				}
			}
	...
	{
		unk28 = Vector3(func_95(entityModel, iParam2));
...
BOOL func_196(Vehicle veParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, float fParam7) // Position - 0x20141
{
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(veParam0, false))
	{
		...
		num = Vector3(func_198(uParam1 - uParam4));
		unk3 = Vector3(num);
		unk18 = 4;
		num = -unk3.f_1;
		num.f_1 = unk3;
		...
		if (func_197(unk18[0], unk18[1], unk6, unk9) || func_197(unk18[0], unk18[1], unk9, unk15) || func_197(unk18[0], unk18[1], unk12, unk15) || func_197(unk18[0], unk18[1], unk6, unk12) || func_197(unk18[1], unk18[3], unk6, unk9) || func_197(unk18[1], unk18[3], unk9, unk15) || func_197(unk18[1], unk18[3], unk12, unk15) || func_197(unk18[1], unk18[3], unk6, unk12) || func_197(unk18[3], unk18[2], unk6, unk9) || func_197(unk18[3], unk18[2], unk9, unk15) || func_197(unk18[3], unk18[2], unk12, unk15) || func_197(unk18[3], unk18[2], unk6, unk12) || func_197(unk18[2], unk18[0], unk6, unk9) || func_197(unk18[2], unk18[0], unk9, unk15) || func_197(unk18[2], unk18[0], unk12, unk15) || func_197(unk18[2], unk18[0], unk6, unk12))
			return true;
	}
...
BOOL func_230(Ped pedParam0, Ped pedParam1, int iParam2, int iParam3) // Position - 0x229E4
{
	...
	unk = Vector3(func_198(ENTITY::GET_ENTITY_COORDS(pedParam1, true) - ENTITY::GET_ENTITY_COORDS(pedParam0, true)));
	...
	if (iParam3 == 0)
		...
		entityForwardVector = Vector3(func_198(PED::GET_PED_BONE_COORDS(pedParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(pedParam0, 31086, 0f, 0f, 0f)));
...
BOOL func_239(Ped pedParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0x22DFB
{
	...
	unk = Vector3(func_198(uParam1 - ENTITY::GET_ENTITY_COORDS(pedParam0, true)));
...
void func_241() // Position - 0x22ED1
{
	...
	else if (!bLocal_169)
	{
		if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_81.f_35[0]))
		{
			entityCoords = Vector3(ENTITY::GET_ENTITY_COORDS(uLocal_81.f_35[0], true));
	...
	if (Global_78813 != 6)
	{
		...
		else
		{
			...
			if (value < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				text = Vector3(func_255(Global_78814, Global_78816, iParam10));
				y == -0.014f;
...
struct<2> func_255(int iParam0, int iParam1, int iParam2) // Position - 0x235C6
{
	...
	switch (iParam1)
	{
		...
		case 3:
			...
			{
				case 0:
					unk = Vector3(func_262(iParam2));
					break;
			
				case 8:
					unk = Vector3(func_261(iParam2));
					break;
			
				case 7:
					unk = Vector3(func_260(iParam2));
					break;
			
				case 10:
					unk = Vector3(func_259(iParam2));
					break;
			
				case 5:
					unk = Vector3(func_258(iParam2));
					break;
			
				case 4:
					unk = Vector3(func_257(iParam2));
					break;
...
{
	if (!func_266(0) || G_TextMessageConfig || Global_78817 == 1 || !CAM::IS_SCREEN_FADED_IN())
		return false;
...
void func_285(int iParam0, BOOL bParam1) // Position - 0x243F8
{
	...
	{
		func_326(&(Global_112735[num].f_9));
	}
	...
	func_315(0, 0);
	TEXT_LABEL_COPY(&unk, Vector3(func_206(num)), 4);
...
void _STAT_SET_PACKED_BOOL(int iParam0, BOOL bParam1, int iParam2) // Position - 0x24B77
{
	if (iParam2 == -1)
		iParam2 = func_112();
...
void func_302(var uParam0) // Position - 0x24D4A
{
	...
	*uParam0 = 145;
	...
	for (j = 0; j < 3; j = j + 1)
	{
		...
		uParam0->f_17[j] = 0;
		uParam0->f_21[j] = 0;
		func_307(&uParam0->f_25[0][j]);
		func_307(&uParam0->f_25[1][j]);
...
BOOL func_312(Ped pedParam0, int iParam1, int iParam2) // Position - 0x25637
{
	...
	{
		unk18 = Vector3(func_95(entityModel, iParam2));
	...
	{
		unk28 = Vector3(func_98(entityModel, 0));
		Global_78341[1] = Vector3(func_117(entityModel, iParam1, unk28[iParam1], -1));
...
void func_317(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x25972
{
	...
	if (iParam0 != -1)
	{
		...
		TEXT_LABEL_COPY(&unk33, Vector3(func_207(iParam0)), 4);
...
BOOL IS_PLAYSTATION_PLATFORM() // Position - 0x25A8B
{
	return MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION();
}

BOOL IS_XBOX_PLATFORM() // Position - 0x25AA1
{
...
void func_327(int iParam0, BOOL bParam1) // Position - 0x25B08
{
	...
	func_345(iParam0, G_TextMessageConfig);
...
void func_329(int iParam0) // Position - 0x2600C
{
	...
	Global_113648.f_18576[iParam0].f_3 = func_330();
