...
BOOL func_145(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9) // Position - 0x6221
{
	...
	else
	{
		...
		num2 = 0;
		func_151(&num2);
		num3 = func_150(unk10, Global_113810.f_7691.f_765[num2]);
	
		if (num3 == 2)
		{
			func_148(Global_113810.f_7691.f_765[num2]);
		...
		else if (num3 == 1)
		{
			...
			{
				if (!func_146(Global_113810.f_7691.f_765[num2]))
				{
					Global_113810.f_7691.f_765[num2] = { unk10 };
					func_147(&unk10);
					return true;
...
void func_151(var uParam0) // Position - 0x64F5
{
	...
	*uParam0 = 0;
	...
	{
		if (func_150(Global_113810.f_7691.f_765[i], Global_113810.f_7691.f_765[*uParam0]) == 0)
			*uParam0 = i;
	}
