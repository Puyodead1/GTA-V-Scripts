...
void main() // Position - 0x0
{
	...
	uLocal_50 = { uScriptParam_341.f_1[0] };
...
void func_128() // Position - 0x52A0
{
	...
	if (value > 0f && SYSTEM::FLOOR(value) < SYSTEM::FLOOR(G_MissionStats.f_10197.f_3853))
		func_130(13, SYSTEM::FLOOR(G_MissionStats.f_10197.f_3853));
...
BOOL func_145(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9) // Position - 0x6221
{
	...
	else
	{
		...
		num2 = 0;
		func_151(&num2);
		num3 = func_150(unk10, G_MissionStats.f_7691.f_765[num2]);
	
		if (num3 == 2)
		{
			func_148(G_MissionStats.f_7691.f_765[num2]);
		...
		else if (num3 == 1)
		{
			...
			{
				if (!func_146(G_MissionStats.f_7691.f_765[num2]))
				{
					G_MissionStats.f_7691.f_765[num2] = { unk10 };
					func_147(&unk10);
					return true;
...
void func_151(var uParam0) // Position - 0x64F5
{
	...
	*uParam0 = 0;
	...
	{
		if (func_150(G_MissionStats.f_7691.f_765[i], G_MissionStats.f_7691.f_765[*uParam0]) == 0)
			*uParam0 = i;
	}
...
BOOL func_196(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6) // Position - 0x99E8
{
	...
	if (!flag)
	{
		...
		if (!func_231(G_MissionStats.f_24998.f_43[iParam3]))
			return false;
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
							if (PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0 || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || func_229() || Global_32286 || func_228() || func_61(8, -1) || func_226() || func_225() || func_224() || G_MissionStats.f_7691.f_919[character] == 5)
								return false;
						break;
				
					case 7:
						if (PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || !CAM::IS_SCREEN_FADED_IN() || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_229() || func_226() || Global_112857 || Global_32286 || func_228() || Global_44569 || func_61(8, -1) || func_225() || func_223() || func_224() || G_MissionStats.f_7691.f_919[character] == 5)
							return false;
						break;
