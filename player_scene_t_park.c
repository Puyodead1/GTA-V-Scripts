...
BOOL func_2() // Position - 0x10E
{
	...
	if (!MISC::IS_STRING_NULL_OR_EMPTY(&uLocal_90))
	{
		...
		{
			unk = Vector3(Vector3(32.856f, 3819.65f, 1971.62f) - uLocal_83);
...
int func_3(Object* pobParam0, int iParam1) // Position - 0x3E7
{
	...
	switch (iParam1)
	{
		case 0:
			...
			{
				entityCoords = Vector3(ENTITY::GET_ENTITY_COORDS(*pobParam0, true));
				entityRotation = Vector3(ENTITY::GET_ENTITY_ROTATION(*pobParam0, 2));
				ENTITY::SET_ENTITY_COORDS(*pobParam0, entityCoords + Vector3(0.1f, 0f, 0f), true, false, false, true);
		...
		case 4:
			entityCoords2 = Vector3(ENTITY::GET_ENTITY_COORDS(*pobParam0, true));
			entityRotation2 = Vector3(ENTITY::GET_ENTITY_ROTATION(*pobParam0, 2));
			model = 0;
			...
			switch (ENTITY::GET_ENTITY_MODEL(*pobParam0))
			{
				...
				case joaat("prop_toiletfoot_static"):
					vector = Vector3(1971.669f, 3819.449f, 32.766f);
					vector2 = Vector3(0f, 0f, 53.6f);
		...
		case 8:
			entityCoords3 = Vector3(ENTITY::GET_ENTITY_COORDS(*pobParam0, true));
			entityRotation3 = Vector3(ENTITY::GET_ENTITY_ROTATION(*pobParam0, 2));
			effectName = "";
		...
		case 9:
			entityCoords4 = Vector3(ENTITY::GET_ENTITY_COORDS(*pobParam0, true));
			entityRotation4 = Vector3(ENTITY::GET_ENTITY_ROTATION(*pobParam0, 2));
			effectName2 = "";
...
void func_17(Ped pedParam0, Cam caParam1, int iParam2, int iParam3, int iParam4) // Position - 0x2671
{
	...
	if (!func_34(pedParam0))
	{
		...
		if (num3 == -1)
		{
			...
			if (!(num4 == -1))
				Global_44232[num4].f_4 = Global_44232[num4].f_4 + iParam2;
		}
	}
	else
	{
		...
		if (num5 == -1)
		{
			...
			if (!(num6 == -1))
				Global_44232[num6].f_4 = Global_44232[num6].f_4 + iParam2;
		}
...
void func_19(int iParam0, int iParam1, int iParam2, Ped pedParam3, int iParam4, int iParam5) // Position - 0x27FA
{
	...
	Global_44313[num].f_3 = pedParam3;
...
void func_24(Ped pedParam0, int iParam1) // Position - 0x2941
{
	...
	if (num == -1)
	{
		...
		if (!(num2 == -1))
		{
			Global_44206[num2].f_3 = Global_44206[num2].f_3 + iParam1;
			Global_44206[num2].f_2 = Global_44206[num2].f_2 + iParam1;
		}
...
int func_32(Ped pedParam0, int iParam1, BOOL bParam2) // Position - 0x2BF5
{
	...
	Global_44206[num3] = 0;
	Global_44206[num3].f_1 = pedParam0;
	Global_44206[num3].f_2 = iParam1;
	Global_44206[num3].f_3 = iParam1;
	Global_44206[num3].f_4 = 0;
	...
	if (!(hLocal_73 == 0))
	{
		if (!ENTITY::DOES_ENTITY_EXIST(obLocal_72))
		{
			...
			else
			{
				...
				ENTITY::SET_ENTITY_ROTATION(obLocal_72, Vector3(fLocal_86, 0f, 0f) + uLocal_77, 2, true);
...
void func_54() // Position - 0x3365
{
	...
	switch (iLocal_70)
	{
		...
		case 274:
			...
			if (iLocal_70 == 273)
				uLocal_138 = Vector3(Vector3(34.97325f + 0.25f, -441.7662f, -118.32176f) - uLocal_83);
			else if (iLocal_70 == 274)
				uLocal_138 = Vector3(0.125f, -1.1486f, 0.0588f + 0.1f);
			else
				uLocal_138 = Vector3(-0.125f, 1.1486f, -0.0588f);
			break;
		...
		case 310:
			...
			uLocal_74 = Vector3(0f, 0f, -0.045f);
			uLocal_77 = Vector3(0f, 180f, 0f);
			iLocal_80 = 28422;
			fLocal_81 = 0.7f;
			iLocal_82 = 0;
			break;
		...
		case 315:
			...
			uLocal_74 = Vector3(-0.54f, 0.08f, -0.13f);
			uLocal_77 = Vector3(0f, 0f, -12f);
			iLocal_80 = -1;
			fLocal_81 = 0.7f;
			iLocal_82 = -1;
			break;
		...
		case 124:
			...
			uLocal_74 = Vector3(-0.72f, 0.9f, 0.21f);
			uLocal_77 = Vector3(0f, 0f, 9f);
			iLocal_80 = -1;
			fLocal_81 = 0.7f;
			iLocal_82 = -1;
			break;
	...
	switch (uParam0.f_2)
	{
		...
		case 80:
			*uParam109 = Vector3(uParam0);
			uParam109->f_109 = joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE");
			uParam109->f_110 = joaat("SCRIPT_TASK_SYNCHRONIZED_SCENE");
			func_56(uParam109, 17, joaat("SCRIPT_TASK_PLAY_ANIM"), joaat("SCRIPT_TASK_PLAY_ANIM"), Vector3(2.6407f, 8.164f, -14.1564f) + Vector3(-1f, 0.03f, -2.16f), -66f + -56f);
