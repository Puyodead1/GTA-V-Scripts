...
void main() // Position - 0x0
{
	...
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		while (iLocal_37 == 0)
		{
			...
			{
				iLocal_37.f_1 = func_46(uScriptParam_2391);
				iLocal_37.f_2 = func_45();
				iLocal_37 = 1;
			}
			else
			{
	...
	while (true)
	{
		...
		if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS() || _SHOULD_NETWORK_SCRIPT_TERMINATE() || Global_1579688 == 0 || func_28())
			func_25();
...
void func_1() // Position - 0xE4
{
	...
	if (iLocal_36 == 1)
	{
		...
		if (num > -1)
		{
			if (ENTITY::DOES_ENTITY_EXIST(uLocal_40[num]) && !ENTITY::IS_ENTITY_DEAD(uLocal_40[num], false))
			{
				AUDIO::PLAY_STREAM_FROM_PED(uLocal_40[num]);
				iLocal_36 = iLocal_36 + 1;
			}
		}
	}
	...
	if (iLocal_36 == 2)
	{
		...
		{
			num2 = SYSTEM::TO_FLOAT(iLocal_37.f_1) / 5f;
...
int func_2() // Position - 0x16F
{
	...
	for (i = 0; i < 50; i = i + 1)
	{
		if (uLocal_40[i].f_46 <= iLocal_37.f_1)
		{
			num2 = SYSTEM::VDIST(uLocal_40[i].f_40, 945f, 15f, 117f);
...
void func_3() // Position - 0x1D4
{
	...
	for (i = 0; i < 50; i = i + 1)
	{
		if (func_22(&uLocal_40[i]))
		{
			if (!ENTITY::DOES_ENTITY_EXIST(uLocal_40[i]))
				func_12(&uLocal_40[i]);
			else if (ENTITY::IS_ENTITY_DEAD(uLocal_40[i], false))
				func_11(&uLocal_40[i]);
		...
		if (func_20(uParam0))
		{
			*uParam0 = PED::CREATE_PED(PED_TYPE_MISSION, func_19(uParam0), uParam0->f_40, uParam0->f_43, false, false);
			...
			if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
			{
				...
				{
					PED::SET_PED_COMPONENT_VARIATION(*uParam0, i, uParam0->f_3[i], uParam0->f_3[i].f_1, 0);
				}
...
void func_42(var uParam0, int iParam1) // Position - 0x15AF
{
	switch (iParam1)
	{
		case 0:
			...
			uParam0->f_3[9].f_1 = 0;
			uParam0->f_3[10] = 0;
			uParam0->f_3[10].f_1 = 0;
			uParam0->f_3[11] = 0;
			uParam0->f_3[11].f_1 = 0;
			uParam0->f_44 = 39;
			uParam0->f_46 = 4;
			break;
		...
		case 3:
			...
			uParam0->f_3[9].f_1 = 0;
			uParam0->f_3[10] = 0;
			uParam0->f_3[10].f_1 = 1;
			uParam0->f_3[11] = 1;
			uParam0->f_3[11].f_1 = 2;
			uParam0->f_28[0] = 1;
			uParam0->f_32[0] = 1;
			uParam0->f_36[0] = 1;
			uParam0->f_44 = 36;
...
{
	if (uParam0 >= Global_262145.f_27240)
		return 5;
	else if (uParam0 >= Global_262145.f_27239)
		return 4;
	else if (uParam0 >= Global_262145.f_27238)
		return 3;
	else if (uParam0 >= Global_262145.f_27237)
		return 2;
...
void func_47() // Position - 0x8430
{
	...
	Global_1579703 = Global_1579703 + 1;
	_NETWORK_ENSURE_SCRIPT_IS_NETWORKED(0, -1, false);
	NETWORK::NETWORK_REGISTER_HOST_BROADCAST_VARIABLES(&iLocal_37, 3, 0);
	return;
}
