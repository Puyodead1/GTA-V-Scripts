...
void main() // Position - 0x0
{
	...
	bLocal_263 = 1;
	fLocal_65 = Vector3(uScriptParam_299.f_1[0]);
		...
		if (!PED::IS_PED_INJURED(pedLocal_55))
		{
			switch (iLocal_52)
			{
					...
					if (SYSTEM::TIMERA() > 2000)
					{
						if (flag || bLocal_278 == true)
						{
							if (!_CONVERSATION_IS_DIALOGUE_IN_PROGRESS())
							{
								...
								fLocal_68 = Vector3(ENTITY::GET_ENTITY_COORDS(pedLocal_55, true));
				...
				case 2:
					...
					{
						vector = Vector3(0f, 0f, ENTITY::GET_ENTITY_HEADING(pedLocal_55) * 3f);
													...
													if (_CONVERSATION_ADD_LINE(&uLocal_78, "REARRAU", "REARR_INCAR", 4, iLocal_254, 0, 0))
													{
														if (func_72(pedLocal_54, veLocal_57) == 2)
															if (PED::IS_PED_FACING_PED(pedLocal_56, pedLocal_55, 180f))
																fLocal_295 = Vector3(2.978f, -0.75f, 1f);
															else
																fLocal_295 = Vector3(2.978f, 0.75f, 1f);
				...
				case 7:
					if (!PED::IS_PED_INJURED(pedLocal_54))
					{
						...
						if (VEHICLE::IS_VEHICLE_DRIVEABLE(veLocal_57, false))
						{
							...
							{
								if (func_72(pedLocal_54, veLocal_57) == 2)
									fLocal_295 = Vector3(1.578f, -0.5f, 1f);
								else
									fLocal_295 = Vector3(-1.578f, -0.5f, 1f);
	...
	if (STREAMING::HAS_MODEL_LOADED(model))
	{
		if (PATHFIND::GET_NTH_CLOSEST_VEHICLE_NODE(ENTITY::GET_ENTITY_COORDS(pedLocal_54, false), 1, &entityCoords, 1, 1077936128, 0))
		{
			if (VEHICLE::GENERATE_VEHICLE_CREATION_POS_FROM_PATHS(&entityCoords, &vector, &outVec1, 0f, 180f, 50f, 1, 1, 1))
			{
				...
				entityCoords = Vector3(ENTITY::GET_ENTITY_COORDS(veLocal_57, true));
				dx = Vector3(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true) - entityCoords);
				...
				if (MISC::GET_DISTANCE_BETWEEN_COORDS(entityCoords, 2528.5625f, 2639.1147f, 36.9446f, true) < 75f)
					entityCoords = Vector3(2473.6006f, 2496.7646f, 40.87f);
...
void func_19(int iParam0) // Position - 0x2674
{
	...
	else if (IS_BIT_SET(Global_113648.f_20566.f_471, iParam0) || IS_BIT_SET(Global_2359296[func_21()].f_681.f_10, iParam0))
	{
		flag = true;
		MISC::CLEAR_BIT(&(Global_113648.f_20566.f_471), iParam0);
...
void _STAT_SET_PACKED_BOOL(int iParam0, BOOL bParam1, int iParam2) // Position - 0x2974
{
	if (iParam2 == -1)
		iParam2 = func_24();
...
BOOL _STAT_GET_PACKED_BOOL(int iParam0, int iParam1) // Position - 0x2B95
{
	if (iParam1 == -1)
		iParam1 = func_24();
...
BOOL func_61() // Position - 0x3891
{
	...
	vector = Vector3(vector + PED::GET_PED_BONE_COORDS(pedLocal_54, 31086, 0f, 0f, 0f));
	vector2 = Vector3(vector2 + PED::GET_PED_BONE_COORDS(pedLocal_54, 31086, 0f, 0f, 0f));
...
int func_72(Ped pedParam0, Vehicle veParam1) // Position - 0x3FC0
{
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(veParam1, false))
	{
		...
		offsetFromEntityInWorldCoords = Vector3(ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(veParam1, 1f, -0.5f, 0f));
		vector = Vector3(offsetFromEntityInWorldCoords - entityCoords);
		offsetFromEntityInWorldCoords2 = Vector3(ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(veParam1, -1f, -0.5f, 0f));
...
BOOL func_96(int iParam0) // Position - 0x4A04
{
	...
	num = 0;
	vector = Vector3(iParam0, iParam0, 50f);
...
BOOL func_112() // Position - 0x5259
{
	...
	if (iLocal_53 == 1)
	{
		vector = Vector3(2429.822f, 4952.938f, 44.8892f);
		heading = 218.3434f;
		vector2 = Vector3(2431.685f, 4945.31f, 44.6996f);
		heading2 = 220.0087f;
		uLocal_279 = Vector3(2378.2844f, 4863.027f, 32.508835f);
		uLocal_282 = Vector3(2512.7974f, 4998.5864f, 90.12283f);
	...
	{
		vector = Vector3(2592.637f, 2540.0503f, 30.4162f);
		heading = 90.5639f;
		vector2 = Vector3(2586.0051f, 2541.4102f, 31.0379f);
		heading2 = 75.5943f;
		uLocal_279 = Vector3(2543.1345f, 2683.9172f, 0.307461f);
		uLocal_282 = Vector3(2597.6025f, 2408.885f, 121.90103f);
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_168() || Global_112695 || Global_32166 || func_167() || func_87(8, -1) || func_166() || func_165() || func_164() || func_163() || G_SomeGlobalState.MessageCallStates.f_919[character] == 5)
							return false;
						break;
				
					case 1:
						if (PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_168() || Global_32166 || func_167() || func_87(8, -1) || func_164() || func_166() || func_165() || func_163() || G_SomeGlobalState.MessageCallStates.f_919[character] == 5)
							return false;
						break;
				
					case 2:
						if (!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_168() || Global_112695 || Global_32166 || func_167() || func_87(8, -1) || func_164() || func_166() || func_165() || func_163() || G_SomeGlobalState.MessageCallStates.f_919[character] == 5 || LastDispatchedMessageOrCall != -1)
							return false;
						break;
				
					case 3:
						if (PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_168() || Global_112695 || Global_32166 || func_167() || func_87(8, -1) || func_166() || func_165() || func_163() || G_SomeGlobalState.MessageCallStates.f_919[character] == 5)
							return false;
						break;
				
					case 4:
						if (func_168() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0 || func_87(8, -1) || func_163() || func_162() || G_SomeGlobalState.MessageCallStates.f_919[character] == 5)
							return false;
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
							if (PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0 || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || func_168() || Global_32166 || func_167() || func_87(8, -1) || func_165() || func_164() || func_163() || G_SomeGlobalState.MessageCallStates.f_919[character] == 5)
								return false;
						break;
				
					case 7:
						if (PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || !CAM::IS_SCREEN_FADED_IN() || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_168() || func_165() || Global_112695 || Global_32166 || func_167() || Global_44446 || func_87(8, -1) || func_164() || func_162() || func_163() || G_SomeGlobalState.MessageCallStates.f_919[character] == 5)
							return false;
						break;
