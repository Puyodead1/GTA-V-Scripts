...
void main() // Position - 0x0
{
	...
	while (true)
	{
		...
		if (IS_BIT_SET(G_SleepModeOffOn11, 1))
		{
			if (!IS_BIT_SET(G_SleepModeOnOn25, 20))
			{
				if (AUDIO::IS_MOBILE_PHONE_CALL_ONGOING())
				{
					...
					MISC::CLEAR_BIT(&G_SleepModeOffOn11, 1);
				}
			}
		}
		...
		if (!PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()) && !IS_BIT_SET(Global_MissionData1.missionGenMenubs7, 4) && !func_112() && SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(joaat("fm_mission_controller_2020")) == 0)
			if (Global_21725 != 0)
...
void func_2() // Position - 0x26D
{
	...
	MISC::CLEAR_BIT(&G_SleepModeOffOn11, 23);
	MISC::CLEAR_BIT(&Global_8255, 0);
	MISC::CLEAR_BIT(&G_SleepModeOffOn11, 9);
	MISC::CLEAR_BIT(&G_SleepModeOffOn11, 31);
...
void func_7() // Position - 0x4D6
{
	...
	if (AUDIO::IS_MOBILE_PHONE_CALL_ONGOING() == false && Global_21738 == false)
	{
		if (Global_21778 == true)
			MISC::SET_BIT(&G_SleepModeOffOn11, 23);
		else
			MISC::CLEAR_BIT(&G_SleepModeOffOn11, 23);
				...
				else
				{
					if (iLocal_30 == 0)
					{
						...
						if (Global_21780)
						{
							iLocal_30 = 1;
							Global_22740 = 1;
							func_121(Global_20364, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(4), SYSTEM::TO_FLOAT(0), SYSTEM::TO_FLOAT(4), -1f, -1f, &Global_21867, &(Global_2028[Global_7568].f_7), &(Global_2028[Global_7568].f_3), &(Global_2028[Global_7568].f_3), 0);
						...
						else
						{
							...
							{
								func_121(Global_20364, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(4), SYSTEM::TO_FLOAT(0), SYSTEM::TO_FLOAT(4), -1f, -1f, &Global_21867, "CELL_300" /*CHAR_DEFAULT*/, &(Global_117[Global_7568].f_4), "CELL_195" /*Unknown*/, 0);
								func_51(Global_20364, "DISPLAY_VIEW", 4f, -1082130432, -1082130432, -1082130432, -1082130432);
							}
							else
							{
					...
					if (func_49(FRONTEND_CONTROL, Global_20352, 0))
					{
						...
						else if (Global_21723 > 0)
						{
							...
							if (IS_BIT_SET(G_SleepModeOffOn11, 9))
							{
								for (i = 0; i < Global_22709 + 1; i = i + 1)
								{
									uLocal_111[i] = func_44(&Global_21984[i]);
									uLocal_142[i] = func_44(&Global_22346[i]);
								}
							...
							{
								func_25(&Global_21014, Global_7568, &Global_21801, &Global_21879[0], &Global_21931[0], &Global_21879[1], &Global_21931[1], 9, 0, 0, 0, false);
							}
					...
					if (func_49(FRONTEND_CONTROL, Global_20353, 0) || IS_BIT_SET(G_SleepModeOnOn25, 24))
					{
						...
						else if (Global_21723 > 0)
						{
							...
							if (IS_BIT_SET(G_SleepModeOffOn11, 9))
							{
								...
								{
									uLocal_173[j] = func_44(&Global_22165[j]);
									uLocal_204[j] = func_44(&Global_22527[j]);
								}
							...
							{
								func_25(&Global_21014, Global_7568, &Global_21801, &Global_21892[0], &Global_21944[0], &Global_21892[1], &Global_21944[1], 9, 0, 0, 0, false);
							}
...
void func_8() // Position - 0xE17
{
	...
	switch (Global_20383.f_1)
	{
		...
		case 9:
			...
			{
				func_10();
				func_51(Global_20364, "SET_THEME", SYSTEM::TO_FLOAT(Global_113648.f_14053[Global_20383].f_6), -1082130432, -1082130432, -1082130432, -1082130432);
				...
				{
					func_121(Global_20364, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(4), SYSTEM::TO_FLOAT(0), SYSTEM::TO_FLOAT(2), -1f, -1f, &(Global_117[Global_7568].f_4), "CELL_300" /*CHAR_DEFAULT*/, "CELL_217" /*INCOMING CALL*/, "CELL_195" /*Unknown*/, 0);
				}
				else
				{
					func_121(Global_20364, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(4), SYSTEM::TO_FLOAT(0), SYSTEM::TO_FLOAT(2), -1f, -1f, &(Global_2028[Global_7568].f_3), &(Global_2028[Global_7568].f_7), "CELL_217" /*INCOMING CALL*/, &(Global_2028[Global_7568].f_3), 0);
				}
			...
			else if (Global_21725 == 4 || Global_21725 == 3)
			{
				...
				else
				{
					...
					if (func_50(Global_7568, Global_20383) == 0)
					{
						...
						func_121(Global_20364, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(4), SYSTEM::TO_FLOAT(0), SYSTEM::TO_FLOAT(3), -1f, -1f, &(Global_117[Global_7568].f_4), "CELL_300" /*CHAR_DEFAULT*/, &unk, "CELL_195" /*Unknown*/, 0);
					}
					else
					{
						func_51(Global_20364, "SET_DATA_SLOT_EMPTY", 4f, -1082130432, -1082130432, -1082130432, -1082130432);
						func_121(Global_20364, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(4), SYSTEM::TO_FLOAT(0), SYSTEM::TO_FLOAT(3), -1f, -1f, &(Global_2028[Global_7568].f_3), &(Global_2028[Global_7568].f_7), &unk, &(Global_2028[Global_7568].f_3), 0);
					}
				}
				...
				if (iParam0 == Global_8260[num].f_11)
				{
					if (i == Global_8260[num].f_4)
					{
						if (Global_8822[i] == 0)
						{
							...
							if (Global_2694521)
								if (num == 14)
									func_121(Global_20364, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(i), SYSTEM::TO_FLOAT(Global_8260[num].f_10), SYSTEM::TO_FLOAT(Global_22788), -1f, &Global_8260[num], 0, 0, 0, 0);
					...
					if (i == Global_8260[num].f_4)
					{
						if (Global_8822[i] == 0)
						{
							...
							if (num == 1)
							{
								...
								func_121(Global_20364, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(i), SYSTEM::TO_FLOAT(Global_8260[num].f_10), SYSTEM::TO_FLOAT(Global_22793), -1f, &Global_8260[num], 0, 0, 0, 0);
							}
							else if (num == 7)
							{
								if (Global_78558)
								{
									...
									func_121(Global_20364, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(i), SYSTEM::TO_FLOAT(Global_8260[num].f_10), SYSTEM::TO_FLOAT(value2), -1f, &Global_8260[num], 0, 0, 0, 0);
								}
								else
								{
									switch (Global_20383)
									...
									func_121(Global_20364, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(i), SYSTEM::TO_FLOAT(Global_8260[num].f_10), SYSTEM::TO_FLOAT(value3), -1f, &Global_8260[num], 0, 0, 0, 0);
								}
							}
							else if (num == 14)
							{
							...
							else if (Global_8260[num].f_10 == 57 && num == 23)
							{
								...
								func_121(Global_20364, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(i), SYSTEM::TO_FLOAT(Global_8260[num].f_10), SYSTEM::TO_FLOAT(value6), -1f, &Global_8260[num], 0, 0, 0, 0);
							}
							else
							{
								func_121(Global_20364, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(i), SYSTEM::TO_FLOAT(Global_8260[num].f_10), SYSTEM::TO_FLOAT(0), -1f, &Global_8260[num], 0, 0, 0, 0);
							}
...
void func_15() // Position - 0x1C27
{
	...
	switch (Global_20385)
	{
		...
		case 6:
			if (IS_BIT_SET(G_SleepModeOffOn11, 5))
			{
				Global_20385 = 6;
...
void func_60() // Position - 0x2F43
{
	if (func_49(FRONTEND_CONTROL, Global_20360, 0))
	{
		if (Global_22736 == 0)
		{
			if (Global_21731)
			{
				if (IS_BIT_SET(G_SleepModeOffOn11, 17))
				{
				}
				else
				{
			...
			if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
			{
				if (PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()))
				{
					...
					else
					{
						...
						if (!Global_21736)
							MISC::SET_BIT(&G_SleepModeOffOn11, 5);
...
void func_67() // Position - 0x347C
{
	if (GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(Global_20364))
	{
		if (!Global_21733)
		{
			...
			{
				func_121(Global_20364, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(4), SYSTEM::TO_FLOAT(0), SYSTEM::TO_FLOAT(3), -1f, -1f, &(Global_117[Global_7568].f_4), "CELL_300" /*CHAR_DEFAULT*/, "CELL_219" /*CONNECTED*/, "CELL_195" /*Unknown*/, 0);
			}
			else
			{
				func_121(Global_20364, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(4), SYSTEM::TO_FLOAT(0), SYSTEM::TO_FLOAT(3), -1f, -1f, &(Global_2028[Global_7568].f_3), &(Global_2028[Global_7568].f_7), "CELL_219" /*CONNECTED*/, &(Global_2028[Global_7568].f_3), 0);
			}
		}
	...
	while (iLocal_92 < Global_21721)
	{
		...
		while (num3 < 70 && iLocal_29 == 0)
		{
			...
			if (HUD::DOES_TEXT_LABEL_EXIST(&uLocal_38))
			{
				...
				if (HUD::DOES_TEXT_LABEL_EXIST(&Global_20593[num3]))
				{
					if (MISC::ARE_STRINGS_EQUAL(&Global_20593[num3], &Global_21344.f_187[iLocal_92]))
					{
						num4 > 36 || num5 > 36;
						AUDIO::ADD_LINE_TO_CONVERSATION(num4, &uLocal_50, &Global_20593[num3], num5, num6, false, flag, flag2, flag3, num7, p10, p11, p12);
					}
				}
			...
			else if (HUD::DOES_TEXT_LABEL_EXIST(&uLocal_44))
			{
				...
				p11 = func_76(0);
				p12 = func_75(0);
				AUDIO::ADD_LINE_TO_CONVERSATION(num4, &uLocal_50, &Global_21344.f_6[iLocal_92], num5, num6, true, flag, flag2, flag3, num7, p10, p11, p12);
				TEXT_LABEL_ASSIGN_STRING(&Global_20593[num3], "END", 24);
				iLocal_29 = 1;
			}
			else
			{
	...
	while (num3 < 70 && iLocal_29 == 0)
	{
		...
		if (HUD::DOES_TEXT_LABEL_EXIST(&uLocal_38))
		{
			...
			if (HUD::DOES_TEXT_LABEL_EXIST(&Global_20593[num3]))
			{
				...
				else if (MISC::ARE_STRINGS_EQUAL(&Global_20593[num3], &Global_22723))
				{
					num4 > 36 || num5 > 36;
					AUDIO::ADD_LINE_TO_CONVERSATION(num4, &uLocal_50, &Global_20593[num3], num5, num6, false, flag, flag2, flag3, num7, p10, p11, p12);
					Global_22735 = num3;
...
void func_94() // Position - 0x45EB
{
	...
	for (i = 0; i <= 15; i = i + 1)
	{
		if (Global_21014[i].f_7 == 1)
		{
			if (ENTITY::DOES_ENTITY_EXIST(Global_21014[i]) || Global_21014[i] == 0)
				AUDIO::ADD_PED_TO_CONVERSATION(i, Global_21014[i], &(Global_21014[i].f_1));
	...
	if (Global_4542485 == 1)
	{
		...
		for (i = 0; i <= 19; i = i + 1)
		{
			if (Global_4542304[i].f_7 == 1)
				if (ENTITY::DOES_ENTITY_EXIST(Global_4542304[i]) || Global_4542304[i] == 0)
					AUDIO::ADD_PED_TO_CONVERSATION(Global_4542304[i].f_8, Global_4542304[i], &(Global_4542304[i].f_1));
		}
	}
...
BOOL IS_XBOX_PLATFORM() // Position - 0x4C57
{
	return MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION();
}

BOOL IS_PLAYSTATION_PLATFORM() // Position - 0x4C6D
{
...
void func_105() // Position - 0x4DE8
{
	...
	if (IS_BIT_SET(G_SleepModeOnOn25, 20))
		MISC::SET_BIT(&G_SleepModeOffOn11, 1);
	else
		MISC::CLEAR_BIT(&G_SleepModeOffOn11, 1);
...
void func_107() // Position - 0x5288
{
	...
	num = func_108(Global_20336[Global_20328], Global_20329[Global_20328], Global_20343, Global_20314, 350f, false);
...
void func_121(int iParam0, char* sParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6, const char* sParam7, const char* sParam8, const char* sParam9, const char* sParam10, const char* sParam11) // Position - 0x5895
{
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iParam0, sParam1);
	GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(SYSTEM::ROUND(fParam2));
