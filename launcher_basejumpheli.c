...
void main() // Position - 0x0
{
	...
	fLocal_115 = 4f;
	bLocal_116 = true;
	uLocal_88 = { uScriptParam_467.f_1[0] };
	uLocal_88 = { uLocal_88 };
	...
	while (true)
	{
		...
		if (ENTITY::DOES_ENTITY_EXIST(pedLocal_83) && !ENTITY::IS_ENTITY_DEAD(pedLocal_83, false))
		{
			...
			fLocal_91 = SYSTEM::VDIST2(uLocal_85, uScriptParam_467.f_1[0]);
			fLocal_91 = fLocal_91;
			uLocal_109 = { uLocal_85 };
			uLocal_112 = { uScriptParam_467.f_1[0] };
			uLocal_109.f_2 = 0f;
			uLocal_112.f_2 = 0f;
			...
			switch (iLocal_93)
			{
				case 0:
					...
					else
					{
						...
						uLocal_85.f_2 - uScriptParam_467.f_1[0].f_2 > 500f;
					}
					break;
				...
				case 3:
					...
					else
					{
						...
						if (!func_140(3) && !Global_100867)
						{
							...
							{
								if (!func_162(iLocal_92, 1) || !ENTITY::DOES_ENTITY_EXIST(func_139()) && !Global_100867)
								{
									func_155(10);
									break;
								}
					...
					if (!SCRIPT::IS_THREAD_ACTIVE(iLocal_50))
					{
						...
						if (iLocal_97 != -1)
						{
							if (func_162(Global_112460, 0))
							{
								...
								func_6(func_22(iLocal_97), 0, Global_100870, true, false);
							}
							else
							{
								STATS::PLAYSTATS_MISSION_CHECKPOINT(func_22(iLocal_97), 0, Global_100870, 0);
								func_6(func_22(iLocal_97), 0, Global_100870, false, false);
							}
						}
...
int func_29() // Position - 0xFDF
{
	...
	G_MissionStats.f_18970 = iLocal_119;
...
void func_93() // Position - 0x6EC1
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (_GET_CHARACTER_MODEL(G_MissionStats.f_2366.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_94(character) && !func_142(14) || Global_112760)
			{
...
void func_100(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0x70E9
{
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_137() || Global_112857 || Global_32286 || func_136() || func_122(8, -1) || func_135() || func_134() || func_133() || func_124() || G_MissionStats.f_7691.f_919[character] == 5)
							return false;
						break;
				
					case 1:
						if (PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_137() || Global_32286 || func_136() || func_122(8, -1) || func_133() || func_135() || func_134() || func_124() || G_MissionStats.f_7691.f_919[character] == 5)
							return false;
						break;
				
					case 2:
						if (!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_137() || Global_112857 || Global_32286 || func_136() || func_122(8, -1) || func_133() || func_135() || func_134() || func_124() || G_MissionStats.f_7691.f_919[character] == 5 || Global_43924 != -1)
							return false;
						break;
				
					case 3:
						if (PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_137() || Global_112857 || Global_32286 || func_136() || func_122(8, -1) || func_135() || func_134() || func_124() || G_MissionStats.f_7691.f_919[character] == 5)
							return false;
						break;
				
					case 4:
						if (func_137() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0 || func_122(8, -1) || func_124() || func_132() || G_MissionStats.f_7691.f_919[character] == 5)
							return false;
						break;
...
Entity func_139() // Position - 0x8516
{
	return Global_96645;
}
