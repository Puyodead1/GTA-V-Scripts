#region Local Var
	...
	var uScriptParam_954 = 0;
	var uScriptParam_955 = 0;
	var uScriptParam_956 = 2;
	...
	var uScriptParam_998 = 0;
	var uScriptParam_999 = 0;
#endregion
...
void main() // Position - 0x0
{
	...
	fLocal_875 = 0.05f;
	fLocal_876 = -0.05f;
	uLocal_878 = Vector3(uScriptParam_939);
	func_489(&uLocal_878);
...
void func_51(int iParam0, BOOL bParam1) // Position - 0x1293
{
	...
	{
		func_215(&(Global_112735[num].f_9));
	}
	...
	func_200(0, 0);
	TEXT_LABEL_COPY(&unk, Vector3(func_198(num)), 4);
...
void _STAT_SET_PACKED_BOOL(int iParam0, BOOL bParam1, int iParam2) // Position - 0x1A12
{
	if (iParam2 == -1)
		iParam2 = func_58();
...
BOOL func_79(Ped pedParam0, int iParam1, int iParam2) // Position - 0x24E3
{
	...
	entityModel = ENTITY::GET_ENTITY_MODEL(pedParam0);
	Global_78341[1] = Vector3(func_131(entityModel, iParam1, iParam2, -1));
	...
	if (iParam1 == 12)
	{
		unk = Vector3(func_127(entityModel, iParam2));
	...
	{
		unk18 = Vector3(func_124(entityModel, iParam2));
	...
	{
		unk28 = Vector3(func_127(entityModel, 0));
		Global_78341[1] = Vector3(func_131(entityModel, iParam1, unk28[iParam1], -1));
	
		if (PED::GET_NUMBER_OF_PED_DRAWABLE_VARIATIONS(pedParam0, func_123(iParam1)) > 0 && PED::GET_NUMBER_OF_PED_TEXTURE_VARIATIONS(pedParam0, func_123(iParam1), Global_78341[1].f_3) > 0)
			PED::SET_PED_COMPONENT_VARIATION(pedParam0, func_123(iParam1), Global_78341[1].f_3, Global_78341[1].f_4, 0);
	}
...
BOOL func_80(Ped pedParam0, Hash hParam1, var uParam2) // Position - 0x26A0
{
	...
	{
		if (!func_195(pedParam0, Global_113648.f_2365.f_539[num].f_64, Global_113648.f_2365.f_539[num].f_63))
		{
...
int func_82(Ped pedParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x2767
{
	...
	if (iParam1 == 12)
	{
		...
		for (i = 0; i <= 14; i = i + 1)
		{
			if (unk[i] != -99)
			{
				Global_78341[1] = Vector3(func_131(entityModel, i, unk[i], -1));
				...
				if (IS_BIT_SET(Global_78341[1].f_6, 0))
				{
					if (i == 13)
					{
						...
						if (iParam5 == 1)
							...
							unk18 = Vector3(func_124(entityModel, unk[i]));
					
						for (j = 0; j <= 8; j = j + 1)
						{
							Global_78341[1] = Vector3(func_131(entityModel, 14, unk18[j], -1));
							func_98(pedParam0, Global_78341[1].f_12, Global_78341[1].f_3, Global_78341[1].f_4);
							func_114(14);
					...
					else if (i != 14 && i != 12)
					{
						...
						if (iParam4 == -1)
							PED::SET_PED_COMPONENT_VARIATION(pedParam0, func_123(i), Global_78341[1].f_3, Global_78341[1].f_4, PED::GET_PED_PALETTE_VARIATION(pedParam0, func_123(i)));
						else
							PED::SET_PED_COMPONENT_VARIATION(pedParam0, func_123(i), Global_78341[1].f_3, Global_78341[1].f_4, iParam4);
			...
			{
				Global_78341[1] = Vector3(func_131(entityModel, i, func_88(pedParam0, i, PV_COMP_INVALID), -1));
		...
		if (iParam7 == 1)
		{
			unk45 = Vector3(func_131(entityModel, 8, num3, -1));
			...
			unk45 = Vector3(func_131(entityModel, 9, num4, -1));
			...
			unk45 = Vector3(func_131(entityModel, 14, num5, -1));
			...
			unk45 = Vector3(func_131(entityModel, 14, num6, -1));
			...
			unk45 = Vector3(func_131(entityModel, 14, num7, -1));
	...
	{
		unk59 = Vector3(func_124(entityModel, iParam2));
	
		for (j = 0; j <= 8; j = j + 1)
		{
			Global_78341[1] = Vector3(func_131(entityModel, 14, unk59[j], -1));
			func_98(pedParam0, Global_78341[1].f_12, Global_78341[1].f_3, Global_78341[1].f_4);
			func_114(14);
	...
	{
		if (iParam4 == -1)
			PED::SET_PED_COMPONENT_VARIATION(pedParam0, func_123(iParam1), Global_78341[1].f_3, Global_78341[1].f_4, PED::GET_PED_PALETTE_VARIATION(pedParam0, func_123(iParam1)));
		else
			PED::SET_PED_COMPONENT_VARIATION(pedParam0, func_123(iParam1), Global_78341[1].f_3, Global_78341[1].f_4, iParam4);
...
{
	Global_78341[1] = Vector3(func_131(hParam0, iParam1, iParam2, -1));
...
BOOL func_86(Hash hParam0, int iParam1, int iParam2, int iParam3, var uParam4, int iParam5) // Position - 0x3108
{
	...
	if (iParam2 == 14)
	{
		unk = Vector3(func_124(hParam0, uParam4->[13]));
...
void func_114(int iParam0) // Position - 0x690F
{
	if (IS_BIT_SET(Global_78341[1].f_6, 1) && !IS_BIT_SET(Global_78341[1].f_6, 6))
		func_120(iParam0, Global_78341[1].f_5, Global_78341[1].f_2, 2, Global_78341[1].f_1, 1, 0);
...
BOOL func_122(Ped pedParam0, Hash hParam1, var uParam2, int iParam3) // Position - 0xA210
{
	...
	{
		if (!func_195(pedParam0, Global_113648.f_2365.f_539[num].f_61, Global_113648.f_2365.f_539[num].f_60) || iParam3 == 1)
		{
...
void func_133(int iParam0) // Position - 0xD0A4
{
	...
	func_134(&Global_78341[0], num6, iParam0, &unk, num2, num3, num, flag, num4, num5, false);
	return;
}
...
void func_140(int iParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0xF3CE
{
	...
	if (iParam0 == 12)
	{
		...
		if (outfitIndex >= 0)
		{
			...
			if (num3 > outfitIndex)
			{
				...
				func_134(&Global_78341[0], iParam0, iParam1, &(outfit.f_7), 0, 0, outfit.f_2, false, -1, 2, true);
				return;
			}
		}
	}
	...
	{
		func_134(&Global_78341[0], iParam0, iParam1, "NO_LABEL", 0, 0, 0, true, -1, 2, true);
	}
	else if (iParam0 == 14)
	{
		FILES::INIT_SHOP_PED_PROP(&outProp);
		...
		if (componentId >= 0)
		{
			...
			if (num5 > componentId)
			{
				...
				func_134(&Global_78341[0], iParam0, iParam1, &(outProp.f_9), outProp.f_3, outProp.f_4, outProp.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(outProp.f_1, joaat("OUTFIT_ONLY"), 0), num4, 2, outProp.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (hParam3 != -1 && Global_78539)
		{
			...
			func_134(&Global_78341[0], iParam0, iParam1, &(outComponent.f_9), outComponent.f_3, outComponent.f_4, outComponent.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(outComponent.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, outComponent.f_1 != 0);
			return;
		}
		...
		if (componentId2 >= 0)
		{
			num6 = FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(num2, 10, -1, false, -1, func_123(iParam0));
...
BOOL func_195(Ped pedParam0, int iParam1, int iParam2) // Position - 0x208C3
{
			...
			if (unk[i] != -99 && i != 12 && i != 14)
			{
				if (!func_195(pedParam0, i, unk[i]))
				{
					if (i == 13)
					{
						...
						for (j = 0; j <= 8; j = j + 1)
						{
							if (!func_195(pedParam0, 14, unk18[j]))
							{
								for (k = 0; k <= 19; k = k + 1)
								{
									Global_78341[2] = Vector3(func_131(entityModel, 14, k, -1));
								
									if (Global_78341[2].f_12 == j)
										if (func_195(pedParam0, 14, k))
											if (!func_86(entityModel, iParam2, 14, k, &unk, &Global_78341[2]))
												return false;
								}
							}
						}
					...
					else
					{
						...
						Global_78341[2] = Vector3(func_131(entityModel, i, num, -1));
					
						if (!func_86(entityModel, iParam2, i, num, &unk, &Global_78341[2]))
							return false;
					}
				}
			}
	...
	{
		unk28 = Vector3(func_124(entityModel, iParam2));
	...
	else if (Global_78341[1].f_3 == PED::GET_PED_DRAWABLE_VARIATION(pedParam0, func_123(iParam1)) && Global_78341[1].f_4 == PED::GET_PED_TEXTURE_VARIATION(pedParam0, func_123(iParam1)))
	{
		return true;
	}
...
void func_202(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x2111F
{
	...
	if (iParam0 != -1)
	{
		...
		TEXT_LABEL_COPY(&unk33, Vector3(func_199(iParam0)), 4);
...
BOOL IS_PLAYSTATION_PLATFORM() // Position - 0x22859
{
	return MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION();
}

BOOL IS_XBOX_PLATFORM() // Position - 0x2286F
{
...
void func_216(int iParam0, BOOL bParam1) // Position - 0x2290E
{
	...
	func_234(iParam0, G_TextMessageConfig);
...
void func_218(int iParam0) // Position - 0x22E13
{
	...
	Global_113648.f_18576[iParam0].f_3 = func_219();
	...
	else
	{
		...
		if (iLocal_851 == 0)
		{
			...
			if (pedLocal_165.f_14 == 5)
			{
				HUD::GET_HUD_COLOUR(HUD_COLOUR_WHITE, &r, &g, &b, &a);
				iLocal_44 = 180;
				vector = Vector3(279.85f, 946.37f, 209.82f);
				vector = Vector3(vector + Vector3(7.5f, 0f, 0f));
...
void func_281() // Position - 0x29A61
{
	...
	if (func_29(uLocal_136[0]) && func_29(uLocal_136[1]))
	{
		if (ENTITY::IS_ENTITY_TOUCHING_ENTITY(uLocal_136[0], uLocal_136[1]))
		{
			vector = Vector3(-ENTITY::GET_OFFSET_FROM_ENTITY_GIVEN_WORLD_COORDS(uLocal_136[1], ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true)));
	...
	if (iLocal_490 < 5)
	{
		if (bLocal_857 == false)
		{
			if (func_274())
			{
				...
				{
					offsetFromEntityInWorldCoords = Vector3(ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false), 0f, 8f, 0f));
...
Blip func_290(Vector3 vParam0, var uParam1, var uParam2, BOOL bParam3) // Position - 0x2A4BB
{
	Blip blip;
...
BOOL func_303(BOOL bParam0, BOOL bParam1, BOOL bParam2) // Position - 0x2AC15
{
	...
	if (func_310() || func_309(*Global_MissionData1.missionGenAdverm) || func_308())
	{
...
void func_325() // Position - 0x2B7C2
{
	...
	else
	{
		...
		if (MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), uLocal_180.f_4[pedLocal_165.f_9], true) > 130f)
			if (pedLocal_165.f_9 + 1 <= uLocal_180.f_126)
				if (MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), uLocal_180.f_4[pedLocal_165.f_9 + 1], true) < 100f)
					func_249(10);
				else
					func_249(9);
			else
...
BOOL func_330(Ped pedParam0, Ped pedParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0x2BB60
{
	...
	if (num == -1)
	{
		...
		iLocal_58[num].f_1 = pedParam0;
		iLocal_58[num].f_2 = pedParam1;
	}

	pedBoneCoords = Vector3(PED::GET_PED_BONE_COORDS(pedParam0, 31086, 0f, 0f, 0f));
	flag = func_331(&iLocal_58[num], pedBoneCoords, pedParam1, &(iLocal_58[num].f_3), pedParam0, iParam5);
	return flag || MISC::GET_GAME_TIMER() - iLocal_58[num].f_3 < iParam4;
}
...
BOOL func_331(var uParam0, Vector3 vParam1, var uParam2, var uParam3, Ped pedParam4, var uParam5, Ped pedParam6, int iParam7) // Position - 0x2BC21
{
	...
	if (*uParam0 == 0)
	{
		endCoords = Vector3(func_332(pedParam4, iParam7));
...
int func_333() // Position - 0x2BE12
{
	...
	{
		if (iLocal_58[i] == 0 && iLocal_58[i].f_1 == 0 && iLocal_58[i].f_2 == 0)
			return i;
	}
...
BOOL func_334(Ped pedParam0, Ped pedParam1, int iParam2, int iParam3) // Position - 0x2BE5C
{
	...
	unk = Vector3(func_336(ENTITY::GET_ENTITY_COORDS(pedParam1, true) - ENTITY::GET_ENTITY_COORDS(pedParam0, true)));
	...
	if (iParam3 == 0)
		...
		entityForwardVector = Vector3(func_336(PED::GET_PED_BONE_COORDS(pedParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(pedParam0, 31086, 0f, 0f, 0f)));
...
int func_338(Ped pedParam0, Ped pedParam1) // Position - 0x2BF68
{
	...
	for (i = 0; i < iLocal_58; i = i + 1)
	{
		if (iLocal_58[i].f_1 == pedParam0 && iLocal_58[i].f_2 == pedParam1)
			return i;
	}
...
BOOL func_344(Ped pedParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0x2C2B3
{
	...
	unk = Vector3(func_336(uParam1 - ENTITY::GET_ENTITY_COORDS(pedParam0, true)));
...
void func_350() // Position - 0x2C945
{
	...
	if (func_274())
	{
		if (func_29(uLocal_136[0]) && PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
		{
			if (ENTITY::GET_ENTITY_SPEED(PLAYER::PLAYER_PED_ID()) > 5f)
			{
				offsetFromEntityInWorldCoords = Vector3(ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false), 0f, 6f, 0f));
...
void func_354() // Position - 0x2CB9C
{
	...
	if (ENTITY::IS_ENTITY_AT_COORD(uLocal_878.f_28[0], uLocal_180.f_4[iLocal_853], 6f, 6f, 6f, false, true, 0))
	{
	...
	else
	{
		...
		{
			if (func_274())
				distanceBetweenCoords = MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), uLocal_180.f_4[pedLocal_165.f_9], true);
		
			if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_878.f_28[0]))
				distanceBetweenCoords2 = MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(uLocal_878.f_28[0], true), uLocal_180.f_4[iLocal_853], true);
...
int func_359(int iParam0, var uParam1) // Position - 0x2D162
{
	...
	num2 = 140f;
	num3 = 80f;
	unk = Vector3(uParam1->f_4[iParam0]);

	if (iParam0 + 1 == uParam1->f_126 - 1)
		unk4 = Vector3(uParam1->f_4[0]);
	else
		unk4 = Vector3(uParam1->f_4[iParam0 + 1]);

	if (iParam0 - 1 >= 0)
		unk7 = Vector3(uParam1->f_4[iParam0 - 1]);
...
void func_360(var uParam0, var uParam1) // Position - 0x2D246
{
	...
	if (HUD::DOES_BLIP_EXIST(uParam0->f_2))
	{
		...
		iLocal_44 = 180;
		vector = Vector3(uParam1->f_4[uParam0->f_9 - 1]);
		vector = Vector3(vector + Vector3(7.5f, 0f, 0f));
	
		if (uParam0->f_9 == uParam1->f_126 - 1)
		{
			uParam0->f_5 = GRAPHICS::CREATE_CHECKPOINT(num2, vector, uParam1->f_4[uParam0->f_9], diameter, r2, g2, b2, iLocal_44, 0);
		...
		{
			uParam0->f_5 = GRAPHICS::CREATE_CHECKPOINT(func_359(uParam0->f_9 - 1, uParam1), vector, uParam1->f_4[uParam0->f_9], diameter, r2, g2, b2, iLocal_44, 0);
			GRAPHICS::SET_CHECKPOINT_CYLINDER_HEIGHT(uParam0->f_5, 3f, 3f, 100f);
			GRAPHICS::SET_CHECKPOINT_RGBA(uParam0->f_5, r2, g2, b2, iLocal_44);
			GRAPHICS::SET_CHECKPOINT_RGBA2(uParam0->f_5, r2, g2, b2, iLocal_44);
		}
	...
	if (!HUD::DOES_BLIP_EXIST(uParam0->f_2))
	{
		...
		vector = Vector3(uParam1->f_4[uParam0->f_9]);
		vector = Vector3(vector + Vector3(7.5f, 0f, 0f));
...
BOOL func_361(var uParam0, var uParam1) // Position - 0x2D8EE
{
	...
	if (uParam0->f_9 > -1)
		if (ENTITY::IS_ENTITY_AT_COORD(*uParam0, uParam1->f_4[uParam0->f_9], fLocal_43, fLocal_43, fLocal_43, false, true, 0))
			return true;
	else
		return true;
...
void func_375() // Position - 0x2E4FD
{
	...
	if (func_251())
	{
		...
		uLocal_180 = Vector3(uLocal_141[0]);
...
void func_380(var uParam0) // Position - 0x2EABA
{
	...
	switch (uParam0->f_129)
	{
		case 1:
			uParam0->f_130 = 8;
			*uParam0 = Vector3(-331.1481f, 4753.729f, 227.6643f);
			uParam0->f_3 = 229f;
			uParam0->f_128 = 2;
		...
		case 2:
			uParam0->f_130 = 8;
			*uParam0 = Vector3(376.5668f, 1058.3768f, 236.1919f);
			uParam0->f_3 = 2.9613f;
			uParam0->f_128 = 1;
		...
		case 3:
			uParam0->f_130 = 8;
			*uParam0 = Vector3(857.7981f, 1278.2418f, 358.1998f);
		...
		case 5:
			uParam0->f_130 = 8;
			*uParam0 = Vector3(500.677f, 5598.262f, 794.8943f);
...
{
	uParam0->f_4[uParam0->f_126] = Vector3(fParam1);
...
void func_391(int iParam0) // Position - 0x2FDD2
{
	...
	else if (iParam0 == 4)
	{
		...
		for (i = 0; i < 2; i = i + 1)
		{
			if (func_29(uLocal_136[i]))
			{
				ENTITY::SET_ENTITY_COORDS(uLocal_136[i], uLocal_151[i], true, false, false, true);
			...
			{
				func_347(&uLocal_136[i], hLocal_140, uLocal_151[i], uLocal_158[i], i, 0);
				VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(uLocal_136[i], 1084227584);
...
void func_398() // Position - 0x305EC
{
	...
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uLocal_878.f_28[1]))
	{
		...
		entityCoords = Vector3(ENTITY::GET_ENTITY_COORDS(uLocal_878.f_28[1], true));
...
void func_400() // Position - 0x306FA
{
	...
	for (i = 0; i < 2; i = i + 1)
	{
		if (func_29(uLocal_136[i]))
		{
			ENTITY::SET_ENTITY_COORDS(uLocal_136[i], uLocal_141[i], true, false, false, true);
		...
		{
			func_347(&uLocal_136[i], hLocal_140, uLocal_141[i], uLocal_148[i], i, 0);
			func_270("Bike doesn't exist, recreate: ", i);
			VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(uLocal_136[i], 1084227584);
...
BOOL func_407(Vehicle veParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, float fParam7) // Position - 0x31048
{
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(veParam0, false))
	{
		...
		num = Vector3(func_336(uParam1 - uParam4));
		unk3 = Vector3(num);
		unk18 = 4;
		num = -unk3.f_1;
		num.f_1 = unk3;
...
void func_420() // Position - 0x31B8C
{
	...
	uLocal_141[0] = Vector3(808.8217f, 1276.9392f, 359.4989f);
	uLocal_148[0] = 261.78f;
	uLocal_141[1] = Vector3(820.96f, 1274.52f, 359.47f);
	uLocal_148[1] = 268.5713f;
	uLocal_151[0] = Vector3(280.9698f, 948.4752f, 209.7963f);
	uLocal_158[0] = 167.6198f;
	uLocal_151[1] = Vector3(284.93f, 968.38f, 210.09f);
	...
	if (Global_78813 != 6)
	{
		...
		else
		{
			...
			if (value < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				text = Vector3(func_429(Global_78814, Global_78816, iParam10));
				y == -0.014f;
...
struct<2> func_429(int iParam0, int iParam1, int iParam2) // Position - 0x32868
{
	...
	{
		case 1:
			unk = Vector3(func_437(iParam0));
			break;
	
		case 7:
			unk = Vector3(func_198(iParam0));
			break;
		...
		case 3:
			...
			{
				case 0:
					unk = Vector3(func_436(iParam2));
					break;
			
				case 8:
					unk = Vector3(func_435(iParam2));
					break;
			
				case 7:
					unk = Vector3(func_434(iParam2));
					break;
			
				case 10:
					unk = Vector3(func_433(iParam2));
					break;
			
				case 5:
					unk = Vector3(func_432(iParam2));
					break;
			
				case 4:
					unk = Vector3(func_431(iParam2));
					break;
...
{
	if (!func_440(0) || G_TextMessageConfig || Global_78817 == 1 || !CAM::IS_SCREEN_FADED_IN())
		return false;
