...
BOOL func_79(Ped pedParam0, int iParam1, int iParam2) // Position - 0x24E3
{
	...
	entityModel = ENTITY::GET_ENTITY_MODEL(pedParam0);
	Global_78341[1] = { func_131(entityModel, iParam1, iParam2, -1) };
	...
	else
	{
		...
		Global_78341[1] = { func_131(entityModel, iParam1, unk28[iParam1], -1) };
...
int func_82(Ped pedParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x2767
{
	...
	if (iParam1 == 12)
	{
		...
		for (i = 0; i <= 14; i = i + 1)
		{
			if (unk[i] != -99)
			{
				Global_78341[1] = { func_131(entityModel, i, unk[i], -1) };
				...
				if (IS_BIT_SET(Global_78341[1].f_6, 0))
				{
					if (i == 13)
					{
						...
						for (j = 0; j <= 8; j = j + 1)
						{
							Global_78341[1] = { func_131(entityModel, 14, unk18[j], -1) };
			...
			{
				Global_78341[1] = { func_131(entityModel, i, func_88(pedParam0, i, PV_COMP_INVALID), -1) };
	...
	else if (iParam1 == 13)
	{
		...
		for (j = 0; j <= 8; j = j + 1)
		{
			Global_78341[1] = { func_131(entityModel, 14, unk59[j], -1) };
			func_98(pedParam0, Global_78341[1].f_12, Global_78341[1].f_3, Global_78341[1].f_4);
			func_114(14);
...
{
	Global_78341[1] = { func_131(hParam0, iParam1, iParam2, -1) };
			...
			if (unk[i] != -99 && i != 12 && i != 14)
			{
				if (!func_195(pedParam0, i, unk[i]))
				{
					if (i == 13)
					{
						...
						for (j = 0; j <= 8; j = j + 1)
						{
							if (!func_195(pedParam0, 14, unk18[j]))
							{
								for (k = 0; k <= 19; k = k + 1)
								{
									Global_78341[2] = { func_131(entityModel, 14, k, -1) };
					...
					else
					{
						...
						Global_78341[2] = { func_131(entityModel, i, num, -1) };
...
void func_420() // Position - 0x31B8C
{
	...
	uLocal_141[0] = { 808.8217f, 1276.9392f, 359.4989f };
	uLocal_148[0] = 261.78f;
	uLocal_141[1] = { 820.96f, 1274.52f, 359.47f };
	uLocal_148[1] = 268.5713f;
	uLocal_151[0] = { 280.9698f, 948.4752f, 209.7963f };
	uLocal_158[0] = 167.6198f;
	uLocal_151[1] = { 284.93f, 968.38f, 210.09f };
