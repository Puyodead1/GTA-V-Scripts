...
BOOL func_7(Player plParam0) // Position - 0x2B3
{
	Player player;
...
Ped func_23() // Position - 0xD4D
{
	return Global_2621446.f_2;
}

BOOL func_24(Player plParam0) // Position - 0xD5B
{
...
BOOL func_26(Player plParam0, int iParam1) // Position - 0xDA8
{
	BOOL flag;
