...
void main() // Position - 0x0
{
	...
	while (true)
	{
		...
		if (func_130())
		{
			...
			for (i = 0; i < 63; i = i + 1)
			{
				if (i % 60 == iLocal_47 || Global_112897[i].f_2)
					func_83(i);
			}
...
void func_1() // Position - 0x121
{
	...
	for (j = 0; j < 63; j = j + 1)
	{
		...
		if (Global_112897[num].f_8 != -1)
		{
			func_3(uLocal_72[Global_112897[num].f_8], false, false);
			func_2(&(Global_112897[num].f_8));
		}
	
		Global_112897[num].f_7 = 0;
	}
					...
					else if (func_23(iLocal_94))
					{
						...
						for (i = 243; i <= 262; i = i + 1)
						{
							...
							if (func_16(unk.f_6, func_17(num, 0), false))
							{
								if (HUD::DOES_BLIP_EXIST(Global_32663[num].f_19))
								{
									HUD::SET_BLIP_FLASHES(Global_32663[num].f_19, true);
									HUD::SET_BLIP_FLASH_TIMER(Global_32663[num].f_19, 10000);
...
{
	if (!func_45(39))
		if (IS_BIT_SET(G_MissionStats.f_18577[27], 3))
...
void func_54() // Position - 0x2DF1
{
	if (_IS_EXCLUSIVE_CONTENT_UNLOCKED())
	{
		if (!func_43(114))
		{
			if (IS_BIT_SET(G_MissionStats.f_18577[46], 3))
			{
		...
		{
			if (IS_BIT_SET(G_MissionStats.f_18577[51], 3))
			{
...
void func_61(int iParam0) // Position - 0x32C6
{
	...
	for (i = 0; i < G_MissionStats.f_7691.f_198; i = i + 1)
	{
		if (G_MissionStats.f_7691.f_137[i] == iParam0)
		{
			func_62(G_MissionStats.f_7691.f_137[i].f_6);
...
void func_76() // Position - 0x3997
{
	...
	{
		if (!IS_BIT_SET(G_MissionStats.f_18577.f_390[iLocal_50], iLocal_49))
		{
			func_18(num, &unk);
		
			if (num == 58)
				MISC::SET_BIT(&G_MissionStats.f_18577.f_390[iLocal_50], iLocal_49);
			else if (HUD::GET_MINIMAP_FOW_COORDINATE_IS_REVEALED(unk.f_6))
				MISC::SET_BIT(&G_MissionStats.f_18577.f_390[iLocal_50], iLocal_49);
			else if (Global_112897[num].f_8 != -1)
				if (uLocal_51[Global_112897[num].f_8])
					if (IS_BIT_SET(Global_32663[uLocal_72[Global_112897[num].f_8]].f_11, 6))
						func_81(uLocal_72[Global_112897[num].f_8]);
		}
		else if (Global_112897[num].f_8 != -1)
		{
			if (uLocal_51[Global_112897[num].f_8])
				if (!IS_BIT_SET(Global_32663[uLocal_72[Global_112897[num].f_8]].f_11, 6))
					func_77(uLocal_72[Global_112897[num].f_8]);
		}
	}
...
void func_78(int iParam0, BOOL bParam1) // Position - 0x3AFE
{
	...
	if (bParam1 == IS_BIT_SET(Global_32663[num].f_11, 4))
		return;

	if (bParam1)
		MISC::SET_BIT(&(Global_32663[num].f_11), 4);
	else
		MISC::CLEAR_BIT(&(Global_32663[num].f_11), 4);
...
void func_79(int iParam0, BOOL bParam1) // Position - 0x3B81
{
	...
	if (bParam1 == IS_BIT_SET(Global_32663[num].f_11, 5))
		return;

	if (bParam1)
		MISC::SET_BIT(&(Global_32663[num].f_11), 5);
	else
		MISC::CLEAR_BIT(&(Global_32663[num].f_11), 5);
...
void func_80(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x3C04
{
	...
	if (bParam1 == IS_BIT_SET(Global_32663[num].f_11, 6))
		return;

	if (bParam1)
		MISC::SET_BIT(&(Global_32663[num].f_11), 6);
	else
		MISC::CLEAR_BIT(&(Global_32663[num].f_11), 6);

	if (bParam2)
		MISC::SET_BIT(&(Global_32663[num].f_11), 11);
	else
		MISC::CLEAR_BIT(&(Global_32663[num].f_11), 11);
...
void func_83(int iParam0) // Position - 0x3D0C
{
	...
	func_18(iParam0, &unk);
	Global_112897[iParam0].f_2 = 0;

	if (!IS_BIT_SET(G_MissionStats.f_18577[iParam0], 1))
		if (!unk.f_23)
			MISC::SET_BIT(&G_MissionStats.f_18577[iParam0], 1);

	if (IS_BIT_SET(G_MissionStats.f_18577[iParam0], 0) && !IS_BIT_SET(G_MissionStats.f_18577[iParam0], 3))
	{
		if (!G_MissionStats.f_18577[iParam0].f_1)
		{
			unk33 = func_42();
			...
			G_MissionStats.f_18577[iParam0].f_2 = unk33;
			G_MissionStats.f_18577[iParam0].f_1 = 1;
		}
		...
		if (IS_BIT_SET(G_MissionStats.f_18577[iParam0], 1))
		{
			if (!IS_BIT_SET(G_MissionStats.f_18577[iParam0], 2))
			{
				...
				if (unk.f_15 > 0 && flag)
				{
					if (!func_23(G_MissionStats.f_18577[iParam0].f_2))
					{
						func_122(G_MissionStats.f_18577[iParam0].f_2, &unk34, &unk35, &unk36, &num, &num2, &num3);
					
						if (num3 > 0 || num2 > 0 || num > 10)
						{
							unk53 = { func_21(iParam0) };
							G_MissionStats.f_18577[iParam0].f_2 = func_42();
							func_34(&(G_MissionStats.f_18577[iParam0].f_2), 0, 0, unk.f_15, 0, 0, 0);
						}
				...
				if (flag)
				{
					MISC::SET_BIT(&G_MissionStats.f_18577[iParam0], 2);
					Global_112897[iParam0].f_4 = 0;
	...
	if (IS_BIT_SET(G_MissionStats.f_18577[iParam0], 2) && !IS_BIT_SET(G_MissionStats.f_18577[iParam0], 3))
	{
		flag2 = true;
		...
		if (!flag2)
			MISC::CLEAR_BIT(&G_MissionStats.f_18577[iParam0], 2);
	}

	flag3 = true;

	if (Global_112897[iParam0].f_1)
	{
		Global_112897[iParam0].f_2 = 1;
		Global_112897[iParam0].f_1 = 0;
		Global_112897[iParam0].f_3 = 1;
	}
	else if (Global_112897[iParam0].f_3)
	{
		...
		{
			if (iParam0 == 10 && G_MissionStats.f_7264[109] != 1)
				func_107(109, 1);
	...
	if (flag3 && !IS_BIT_SET(G_MissionStats.f_18577[iParam0], 3) && IS_BIT_SET(G_MissionStats.f_18577[iParam0], 0) && IS_BIT_SET(G_MissionStats.f_18577[iParam0], 1) && IS_BIT_SET(G_MissionStats.f_18577[iParam0], 2))
	{
	...
	if (Global_112897[iParam0].f_7 != num5)
	{
		if (func_105(&(Global_112897[iParam0].f_8)))
		{
			...
			{
				num6 = uLocal_72[Global_112897[iParam0].f_8];
			
				if (num5 == 0)
				{
					func_3(num6, false, false);
					func_104(num6, false);
					func_2(&(Global_112897[iParam0].f_8));
				}
				else if (num5 == 2)
				{
					if (func_103(iParam0))
			...
			Global_112897[iParam0].f_7 = num5;
		}
	}

	if (!IS_BIT_SET(G_MissionStats.f_18577[iParam0], 4))
	{
		if (MISC::GET_HASH_KEY(&(unk.f_10)) == MISC::GET_HASH_KEY(""))
		{
			MISC::SET_BIT(&G_MissionStats.f_18577[iParam0], 4);
		}
		else if (num5 == 2)
		{
	...
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		if (!func_45(35))
		{
			if (IS_BIT_SET(G_MissionStats.f_18577[iParam0], 2) && !IS_BIT_SET(G_MissionStats.f_18577[iParam0], 3))
			{
				if (!func_94(unk.f_26, _GET_CURRENT_PLAYER_CHARACTER()) && !func_103(iParam0) && !func_82(iParam0) && !func_86(iParam0) && !func_85(iParam0) && !Global_112897[iParam0].f_3)
				{
					if (SYSTEM::VDIST2(unk.f_6, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true)) < 81f)
					{
						...
						if (!MISC::IS_STRING_NULL_OR_EMPTY(str))
						{
							switch (func_47(str))
							{
								...
								case 1:
									func_5(35);
									TEXT_LABEL_ASSIGN_STRING(&Global_112452, "", 16);
									break;
							}
						}
					}
...
{
	if (iParam0 == 2)
		if (IS_BIT_SET(G_MissionStats.f_18577[3], 3) && Global_112897[3].f_3 == true)
			return true;
	else if (iParam0 == 3)
		if (IS_BIT_SET(G_MissionStats.f_18577[2], 3) && Global_112897[2].f_3 == true)
			return true;
...
BOOL func_86(int iParam0) // Position - 0x457E
{
	if (iParam0 == 2 || iParam0 == 3)
		if (IS_BIT_SET(G_MissionStats.f_18577[2], 0) && IS_BIT_SET(G_MissionStats.f_18577[3], 0))
...
BOOL func_88(int iParam0) // Position - 0x461A
{
	...
	flag = IS_BIT_SET(Global_32663[num].f_11, 0);
	flag2 = IS_BIT_SET(Global_32663[num].f_11, 15);
...
void func_90(int iParam0, int iParam1) // Position - 0x468F
{
	...
	if (Global_32663[num].f_16 == iParam1)
		return;

	Global_32663[num].f_16 = iParam1;

	switch (iParam1)
	{
		case 1:
			Global_32663[num].f_12[0] = 40;
			break;
	
		case 3:
			Global_32663[num].f_12[0] = 60;
			break;
	}
...
BOOL func_91(int iParam0) // Position - 0x472C
{
	...
	if (G_MissionStats.f_2355[num2] >= 1)
		return true;
...
void func_93(int iParam0, BOOL bParam1, int iParam2, BOOL bParam3) // Position - 0x47B3
{
	...
	if (bParam1)
	{
		if (!bParam3)
		{
			Global_32663[num].f_17 = iParam2;
		
			if (bParam1 != IS_BIT_SET(Global_32663[num].f_11, 8))
				MISC::SET_BIT(&(Global_32663[num].f_11), 18);
		
			MISC::SET_BIT(&(Global_32663[num].f_11), 8);
		}
		else
		{
			Global_32663[num].f_18 = iParam2;
		
			if (bParam1 != IS_BIT_SET(Global_32663[num].f_11, 10))
				MISC::SET_BIT(&(Global_32663[num].f_11), 18);
		
			MISC::SET_BIT(&(Global_32663[num].f_11), 10);
		}
...
void func_95(int iParam0) // Position - 0x48A5
{
	...
	if (IS_BIT_SET(Global_32663[num].f_11, 8) || IS_BIT_SET(Global_32663[num].f_11, 10))
		MISC::SET_BIT(&(Global_32663[num].f_11), 18);

	MISC::CLEAR_BIT(&(Global_32663[num].f_11), 8);
	MISC::CLEAR_BIT(&(Global_32663[num].f_11), 10);
	MISC::SET_BIT(&(Global_32663[num].f_11), 18);
	return;
}
...
void func_96(int iParam0, int iParam1) // Position - 0x4930
{
	...
	{
		if (IS_BIT_SET(G_MissionStats.f_18577[2], 3) || IS_BIT_SET(G_MissionStats.f_18577[3], 3) || IS_BIT_SET(G_MissionStats.f_18577[4], 3))
		{
...
void func_97(int iParam0, char* sParam1) // Position - 0x4C94
{
	...
	TEXT_LABEL_ASSIGN_STRING(&(Global_32663[num].f_20), sParam1, 8);

	if (HUD::DOES_BLIP_EXIST(Global_32663[num].f_19))
		HUD::SET_BLIP_NAME_FROM_TEXT_FILE(Global_32663[num].f_19, sParam1);
...
void func_98(int iParam0, int iParam1) // Position - 0x4CEE
{
	...
	MISC::SET_BITS_IN_RANGE(&(Global_32663[num].f_11), 21, 26, iParam1);
...
void func_99(int iParam0, int iParam1) // Position - 0x4D4C
{
	...
	if (Global_32663[num].f_12[0] == iParam1)
		return;

	Global_32663[num].f_12[0] = iParam1;
...
void func_102(int iParam0, BOOL bParam1) // Position - 0x4E9E
{
	...
	if (bParam1)
		MISC::SET_BIT(&(Global_32663[num].f_11), 28);
	else
		MISC::CLEAR_BIT(&(Global_32663[num].f_11), 28);
...
void func_114(int iParam0, var uParam1) // Position - 0x597B
{
	...
	switch (iParam0)
	{
		...
		case 71:
		case 72:
			if (!func_115(iParam0) && SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(Global_91601[26].f_6) == 0)
			{
				G_MissionStats.f_7264[iParam0] = 1;
				OBJECT::DOOR_SYSTEM_SET_DOOR_STATE(uParam1->f_5, G_MissionStats.f_7264[iParam0], true, true);
			}
...
void func_135(int iParam0, int iParam1) // Position - 0x9724
{
	...
	MISC::SET_BIT(&(Global_32663[num].f_11), 16);
	Global_32663[num].f_22 = iParam1;
...
void func_136() // Position - 0x978A
{
	...
	for (i = 0; i < 63; i = i + 1)
	{
		Global_112897[i].f_5 = 0;
		Global_112897[i].f_6 = 0;
		Global_112897[i].f_4 = 0;
		Global_112897[i].f_7 = 0;
		Global_112897[i].f_8 = -1;
		Global_112897[i].f_9 = -1;
	}
