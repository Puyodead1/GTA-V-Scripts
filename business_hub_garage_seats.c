...
BOOL func_82() // Position - 0x23C8
{
	if (Global_2657589[PLAYER::PLAYER_ID()].f_321.f_10 != _INVALID_PLAYER_INDEX())
	{
		if (NETWORK::NETWORK_IS_SCRIPT_ACTIVE("business_hub_garage_seats", Global_2657589[PLAYER::PLAYER_ID()].f_321.f_10, true, 0))
			return false;
...
void func_84(int iParam0, var uParam1, int iParam2, int iParam3) // Position - 0x2497
{
	...
	uParam1->[iParam2].f_1 = Vector3(func_86(func_87(), num) + unk);
	uParam1->[iParam2].f_1.f_3 = Vector3(func_86(func_85(), num) + unk);
...
void func_88(int iParam0, var uParam1, var uParam2) // Position - 0x257C
{
	if (func_12())
	{
		...
		{
			case 0:
				*uParam1 = Vector3(-1504.624f, -3006.91f, -82.557f);
				*uParam2 = 180f;
				break;
		
			case 1:
				*uParam1 = Vector3(-1505.624f, -3006.91f, -82.557f);
				*uParam2 = 180f;
				break;
		
			case 2:
				*uParam1 = Vector3(-1506.624f, -3006.91f, -82.557f);
				*uParam2 = 180f;
				break;
		
			case 3:
				*uParam1 = Vector3(-1507.624f, -3006.91f, -82.557f);
				*uParam2 = 180f;
				break;
		
			case 4:
				*uParam1 = Vector3(-1508.624f, -3006.91f, -82.557f);
				*uParam2 = 180f;
				break;
		
			case 5:
				*uParam1 = Vector3(-1509.624f, -3006.91f, -82.557f);
				*uParam2 = 180f;
				break;
		
			case 6:
				*uParam1 = Vector3(-1510.624f, -3006.91f, -82.557f);
				*uParam2 = 180f;
				break;
		
			case 7:
				*uParam1 = Vector3(-1503.524f, -3006.145f, -82.557f);
				*uParam2 = 235f;
				break;
		
			case 8:
				*uParam1 = Vector3(-1511.724f, -3006.145f, -82.557f);
				*uParam2 = 125f;
				break;
		}
	}
	else
	{
		...
		{
			case 0:
				*uParam1 = Vector3(-1504.624f, -3006.91f, -82.577f);
				*uParam2 = 180f;
				break;
		
			case 1:
				*uParam1 = Vector3(-1505.624f, -3006.91f, -82.577f);
				*uParam2 = 180f;
				break;
		
			case 2:
				*uParam1 = Vector3(-1506.624f, -3006.91f, -82.577f);
				*uParam2 = 180f;
				break;
		
			case 3:
				*uParam1 = Vector3(-1507.624f, -3006.91f, -82.577f);
				*uParam2 = 180f;
				break;
		
			case 4:
				*uParam1 = Vector3(-1508.624f, -3006.91f, -82.577f);
				*uParam2 = 180f;
				break;
		
			case 5:
				*uParam1 = Vector3(-1509.624f, -3006.91f, -82.577f);
				*uParam2 = 180f;
				break;
		
			case 6:
				*uParam1 = Vector3(-1510.624f, -3006.91f, -82.577f);
				*uParam2 = 180f;
				break;
		
			case 7:
				*uParam1 = Vector3(-1503.524f, -3006.145f, -82.577f);
				*uParam2 = 235f;
				break;
		
			case 8:
				*uParam1 = Vector3(-1511.724f, -3006.145f, -82.577f);
				*uParam2 = 125f;
				break;
		}
	}
